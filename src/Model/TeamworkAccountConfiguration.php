...
class TeamworkAccountConfiguration extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("onPremisesCalendarSyncConfiguration", $this->_propDict) && !is_null($this->_propDict["onPremisesCalendarSyncConfiguration"])) {
     
            if (is_a($this->_propDict["onPremisesCalendarSyncConfiguration"], "\Beta\Microsoft\Graph\Model\TeamworkOnPremisesCalendarSyncConfiguration")) {
    ...
    */
    ...
    {
        if (array_key_exists("supportedClient", $this->_propDict) && !is_null($this->_propDict["supportedClient"])) {
     
            if (is_a($this->_propDict["supportedClient"], "\Beta\Microsoft\Graph\Model\TeamworkSupportedClient")) {
