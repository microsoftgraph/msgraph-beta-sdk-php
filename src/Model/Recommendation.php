...
class Recommendation extends Entity
{
     ...
     *
     * @return ActionStep[]|null The actionSteps
     */
    public function getActionSteps()
    {
        if (array_key_exists('actionSteps', $this->_propDict) && !is_null($this->_propDict['actionSteps'])) {
            $actionSteps = [];
            if (count($this->_propDict['actionSteps']) > 0 && is_a($this->_propDict['actionSteps'][0], 'ActionStep')) {
                return $this->_propDict['actionSteps'];
            }
            foreach ($this->_propDict['actionSteps'] as $singleValue) {
                $actionSteps []= new ActionStep($singleValue);
            }
            $this->_propDict['actionSteps'] = $actionSteps;
            return $this->_propDict['actionSteps'];
        }
        return null;
    }
    ...
    */
    public function getCategory()
    {
        if (array_key_exists("category", $this->_propDict) && !is_null($this->_propDict["category"])) {
            if (is_a($this->_propDict["category"], "\Beta\Microsoft\Graph\Model\RecommendationCategory")) {
    ...
    */
    ...
    {
        if (array_key_exists("impactStartDateTime", $this->_propDict) && !is_null($this->_propDict["impactStartDateTime"])) {
            if (is_a($this->_propDict["impactStartDateTime"], "\DateTime")) {
    ...
    */
    ...
    {
        if (array_key_exists("lastCheckedDateTime", $this->_propDict) && !is_null($this->_propDict["lastCheckedDateTime"])) {
            if (is_a($this->_propDict["lastCheckedDateTime"], "\DateTime")) {
    ...
    */
    ...
    {
        if (array_key_exists("postponeUntilDateTime", $this->_propDict) && !is_null($this->_propDict["postponeUntilDateTime"])) {
            if (is_a($this->_propDict["postponeUntilDateTime"], "\DateTime")) {
    ...
    */
    public function getPriority()
    {
        if (array_key_exists("priority", $this->_propDict) && !is_null($this->_propDict["priority"])) {
            if (is_a($this->_propDict["priority"], "\Beta\Microsoft\Graph\Model\RecommendationPriority")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict) && !is_null($this->_propDict["status"])) {
            if (is_a($this->_propDict["status"], "\Beta\Microsoft\Graph\Model\RecommendationStatus")) {
