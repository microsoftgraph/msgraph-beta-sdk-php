...
class GroupPolicySettingMapping extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("mdmSupportedState", $this->_propDict) && !is_null($this->_propDict["mdmSupportedState"])) {
    ...
    */
    ...
    {
        if (array_key_exists("settingType", $this->_propDict) && !is_null($this->_propDict["settingType"])) {
