...
class TeamworkDevice extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("activityState", $this->_propDict) && !is_null($this->_propDict["activityState"])) {
            if (is_a($this->_propDict["activityState"], "\Beta\Microsoft\Graph\Model\TeamworkDeviceActivityState")) {
    ...
    */
    ...
    {
        if (array_key_exists("currentUser", $this->_propDict) && !is_null($this->_propDict["currentUser"])) {
            if (is_a($this->_propDict["currentUser"], "\Beta\Microsoft\Graph\Model\TeamworkUserIdentity")) {
    ...
    */
    public function getDeviceType()
    {
        if (array_key_exists("deviceType", $this->_propDict) && !is_null($this->_propDict["deviceType"])) {
            if (is_a($this->_propDict["deviceType"], "\Beta\Microsoft\Graph\Model\TeamworkDeviceType")) {
    ...
    */
    ...
    {
        if (array_key_exists("hardwareDetail", $this->_propDict) && !is_null($this->_propDict["hardwareDetail"])) {
            if (is_a($this->_propDict["hardwareDetail"], "\Beta\Microsoft\Graph\Model\TeamworkHardwareDetail")) {
    ...
    */
    public function getHealthStatus()
    {
        if (array_key_exists("healthStatus", $this->_propDict) && !is_null($this->_propDict["healthStatus"])) {
            if (is_a($this->_propDict["healthStatus"], "\Beta\Microsoft\Graph\Model\TeamworkDeviceHealthStatus")) {
    ...
    */
    public function getActivity()
    {
        if (array_key_exists("activity", $this->_propDict) && !is_null($this->_propDict["activity"])) {
            if (is_a($this->_propDict["activity"], "\Beta\Microsoft\Graph\Model\TeamworkDeviceActivity")) {
    ...
    */
    public function getConfiguration()
    {
        if (array_key_exists("configuration", $this->_propDict) && !is_null($this->_propDict["configuration"])) {
            if (is_a($this->_propDict["configuration"], "\Beta\Microsoft\Graph\Model\TeamworkDeviceConfiguration")) {
    ...
    */
    ...
    {
        if (array_key_exists("health", $this->_propDict) && !is_null($this->_propDict["health"])) {
            if (is_a($this->_propDict["health"], "\Beta\Microsoft\Graph\Model\TeamworkDeviceHealth")) {
    ...
    * The async operations on the device.
     *
     * @return TeamworkDeviceOperation[]|null The operations
     */
    public function getOperations()
    {
        if (array_key_exists('operations', $this->_propDict) && !is_null($this->_propDict['operations'])) {
            $operations = [];
            if (count($this->_propDict['operations']) > 0 && is_a($this->_propDict['operations'][0], 'TeamworkDeviceOperation')) {
                return $this->_propDict['operations'];
            }
            foreach ($this->_propDict['operations'] as $singleValue) {
                $operations []= new TeamworkDeviceOperation($singleValue);
            }
