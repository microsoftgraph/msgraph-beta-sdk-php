...
class AuthoredNote extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("author", $this->_propDict) && !is_null($this->_propDict["author"])) {
            if (is_a($this->_propDict["author"], "\Beta\Microsoft\Graph\Model\Identity")) {
    ...
    */
    public function getContent()
    {
        if (array_key_exists("content", $this->_propDict) && !is_null($this->_propDict["content"])) {
            if (is_a($this->_propDict["content"], "\Beta\Microsoft\Graph\Model\ItemBody")) {
