...
class TeamworkHardwareConfiguration extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("compute", $this->_propDict) && !is_null($this->_propDict["compute"])) {
     
            if (is_a($this->_propDict["compute"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheral")) {
    ...
    */
    ...
    {
        if (array_key_exists("hdmiIngest", $this->_propDict) && !is_null($this->_propDict["hdmiIngest"])) {
     
            if (is_a($this->_propDict["hdmiIngest"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheral")) {
