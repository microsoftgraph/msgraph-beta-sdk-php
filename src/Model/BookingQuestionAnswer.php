...
class BookingQuestionAnswer extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("answerInputType", $this->_propDict) && !is_null($this->_propDict["answerInputType"])) {
     
            if (is_a($this->_propDict["answerInputType"], "\Beta\Microsoft\Graph\Model\AnswerInputType")) {
