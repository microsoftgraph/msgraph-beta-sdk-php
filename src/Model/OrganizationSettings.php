...
class OrganizationSettings extends Entity
{
    ...
    */
    public function getItemInsights()
    {
        if (array_key_exists("itemInsights", $this->_propDict) && !is_null($this->_propDict["itemInsights"])) {
            if (is_a($this->_propDict["itemInsights"], "\Beta\Microsoft\Graph\Model\InsightsSettings")) {
    ...
    */
    ...
    {
        if (array_key_exists("peopleInsights", $this->_propDict) && !is_null($this->_propDict["peopleInsights"])) {
            if (is_a($this->_propDict["peopleInsights"], "\Beta\Microsoft\Graph\Model\InsightsSettings")) {
