...
class PrinterStatus extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("processingStateReasons", $this->_propDict) && !is_null($this->_propDict["processingStateReasons"])) {
       
            if (count($this->_propDict['processingStateReasons']) > 0 && is_a($this->_propDict['processingStateReasons'][0], 'PrinterProcessingStateReason')) {
               return $this->_propDict['processingStateReasons'];
            }
            $processingStateReasons = [];
            foreach ($this->_propDict['processingStateReasons'] as $singleValue) {
               $processingStateReasons []= new PrinterProcessingStateReason($singleValue);
            }
            $this->_propDict['processingStateReasons'] = $processingStateReasons;
            return $this->_propDict['processingStateReasons'];
            }
        return null;
    }
