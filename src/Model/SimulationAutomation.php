...
class SimulationAutomation extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("nextRunDateTime", $this->_propDict) && !is_null($this->_propDict["nextRunDateTime"])) {
            if (is_a($this->_propDict["nextRunDateTime"], "\DateTime")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict) && !is_null($this->_propDict["status"])) {
            if (is_a($this->_propDict["status"], "\Beta\Microsoft\Graph\Model\SimulationAutomationStatus")) {
    ...
    */
     ...
     * Gets the runs
     *
     * @return SimulationAutomationRun[]|null The runs
     */
    public function getRuns()
    {
        if (array_key_exists('runs', $this->_propDict) && !is_null($this->_propDict['runs'])) {
            $runs = [];
            if (count($this->_propDict['runs']) > 0 && is_a($this->_propDict['runs'][0], 'SimulationAutomationRun')) {
                return $this->_propDict['runs'];
            }
            foreach ($this->_propDict['runs'] as $singleValue) {
                $runs []= new SimulationAutomationRun($singleValue);
            }
            $this->_propDict['runs'] = $runs;
            return $this->_propDict['runs'];
        }
        return null;
    }
