...
class MessageEvent extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("eventType", $this->_propDict) && !is_null($this->_propDict["eventType"])) {
            if (is_a($this->_propDict["eventType"], "\Beta\Microsoft\Graph\Model\MessageEventType")) {
