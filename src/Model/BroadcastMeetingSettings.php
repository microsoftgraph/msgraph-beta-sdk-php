...
class BroadcastMeetingSettings extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("captions", $this->_propDict) && !is_null($this->_propDict["captions"])) {
     
            if (is_a($this->_propDict["captions"], "\Beta\Microsoft\Graph\Model\BroadcastMeetingCaptionSettings")) {
