...
class WindowsUpdateRolloutSettings extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("offerEndDateTimeInUTC", $this->_propDict) && !is_null($this->_propDict["offerEndDateTimeInUTC"])) {
     
            if (is_a($this->_propDict["offerEndDateTimeInUTC"], "\DateTime")) {
    ...
    */
    ...
    {
        if (array_key_exists("offerStartDateTimeInUTC", $this->_propDict) && !is_null($this->_propDict["offerStartDateTimeInUTC"])) {
     
            if (is_a($this->_propDict["offerStartDateTimeInUTC"], "\DateTime")) {
