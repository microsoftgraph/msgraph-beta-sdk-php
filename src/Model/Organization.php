...
class Organization extends DirectoryObject
{
    ...
    */
    ...
    {
        if (array_key_exists("directorySizeQuota", $this->_propDict) && !is_null($this->_propDict["directorySizeQuota"])) {
    ...
    */
    ...
    {
        if (array_key_exists("certificateConnectorSetting", $this->_propDict) && !is_null($this->_propDict["certificateConnectorSetting"])) {
