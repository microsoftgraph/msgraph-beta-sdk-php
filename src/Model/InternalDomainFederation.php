...
class InternalDomainFederation extends SamlOrWsFedProvider
{
    ...
    */
    ...
    {
        if (array_key_exists("federatedIdpMfaBehavior", $this->_propDict) && !is_null($this->_propDict["federatedIdpMfaBehavior"])) {
            if (is_a($this->_propDict["federatedIdpMfaBehavior"], "\Beta\Microsoft\Graph\Model\FederatedIdpMfaBehavior")) {
    ...
    */
    ...
    {
        if (array_key_exists("promptLoginBehavior", $this->_propDict) && !is_null($this->_propDict["promptLoginBehavior"])) {
            if (is_a($this->_propDict["promptLoginBehavior"], "\Beta\Microsoft\Graph\Model\PromptLoginBehavior")) {
    ...
    */
    ...
    {
        if (array_key_exists("signingCertificateUpdateStatus", $this->_propDict) && !is_null($this->_propDict["signingCertificateUpdateStatus"])) {
            if (is_a($this->_propDict["signingCertificateUpdateStatus"], "\Beta\Microsoft\Graph\Model\SigningCertificateUpdateStatus")) {
