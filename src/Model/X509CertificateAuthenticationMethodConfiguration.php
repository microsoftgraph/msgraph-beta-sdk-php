...
class X509CertificateAuthenticationMethodConfiguration extends AuthenticationMethodConfiguration
{
    ...
    */
    ...
    {
        if (array_key_exists("authenticationModeConfiguration", $this->_propDict) && !is_null($this->_propDict["authenticationModeConfiguration"])) {
            if (is_a($this->_propDict["authenticationModeConfiguration"], "\Beta\Microsoft\Graph\Model\X509CertificateAuthenticationModeConfiguration")) {
    ...
    */
     ...
     *
     * @return X509CertificateUserBinding[]|null The certificateUserBindings
     */
    public function getCertificateUserBindings()
    {
        if (array_key_exists('certificateUserBindings', $this->_propDict) && !is_null($this->_propDict['certificateUserBindings'])) {
            $certificateUserBindings = [];
            if (count($this->_propDict['certificateUserBindings']) > 0 && is_a($this->_propDict['certificateUserBindings'][0], 'X509CertificateUserBinding')) {
                return $this->_propDict['certificateUserBindings'];
            }
            foreach ($this->_propDict['certificateUserBindings'] as $singleValue) {
                $certificateUserBindings []= new X509CertificateUserBinding($singleValue);
            }
            $this->_propDict['certificateUserBindings'] = $certificateUserBindings;
            return $this->_propDict['certificateUserBindings'];
        }
        return null;
    }
