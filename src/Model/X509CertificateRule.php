...
class X509CertificateRule extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("x509CertificateAuthenticationMode", $this->_propDict) && !is_null($this->_propDict["x509CertificateAuthenticationMode"])) {
     
            if (is_a($this->_propDict["x509CertificateAuthenticationMode"], "\Beta\Microsoft\Graph\Model\X509CertificateAuthenticationMode")) {
    ...
    */
    ...
    {
        if (array_key_exists("x509CertificateRuleType", $this->_propDict) && !is_null($this->_propDict["x509CertificateRuleType"])) {
     
            if (is_a($this->_propDict["x509CertificateRuleType"], "\Beta\Microsoft\Graph\Model\X509CertificateRuleType")) {
