...
class UserSettings extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("contactMergeSuggestions", $this->_propDict) && !is_null($this->_propDict["contactMergeSuggestions"])) {
            if (is_a($this->_propDict["contactMergeSuggestions"], "\Beta\Microsoft\Graph\Model\ContactMergeSuggestions")) {
