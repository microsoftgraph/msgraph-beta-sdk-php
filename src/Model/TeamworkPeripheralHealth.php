...
class TeamworkPeripheralHealth extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("connection", $this->_propDict) && !is_null($this->_propDict["connection"])) {
     
            if (is_a($this->_propDict["connection"], "\Beta\Microsoft\Graph\Model\TeamworkConnection")) {
    ...
    */
    ...
    {
        if (array_key_exists("peripheral", $this->_propDict) && !is_null($this->_propDict["peripheral"])) {
     
            if (is_a($this->_propDict["peripheral"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheral")) {
