...
class Application extends DirectoryObject
{
    ...
    */
    ...
    {
        if (array_key_exists("certification", $this->_propDict) && !is_null($this->_propDict["certification"])) {
            if (is_a($this->_propDict["certification"], "\Beta\Microsoft\Graph\Model\Certification")) {
