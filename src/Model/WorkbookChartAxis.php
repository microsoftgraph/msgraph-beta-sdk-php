...
class WorkbookChartAxis extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("majorGridlines", $this->_propDict) && !is_null($this->_propDict["majorGridlines"])) {
    ...
    */
    ...
    {
        if (array_key_exists("minorGridlines", $this->_propDict) && !is_null($this->_propDict["minorGridlines"])) {
