...
class TeamworkTeamsClientConfiguration extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("accountConfiguration", $this->_propDict) && !is_null($this->_propDict["accountConfiguration"])) {
     
            if (is_a($this->_propDict["accountConfiguration"], "\Beta\Microsoft\Graph\Model\TeamworkAccountConfiguration")) {
    ...
    */
    ...
    {
        if (array_key_exists("featuresConfiguration", $this->_propDict) && !is_null($this->_propDict["featuresConfiguration"])) {
     
            if (is_a($this->_propDict["featuresConfiguration"], "\Beta\Microsoft\Graph\Model\TeamworkFeaturesConfiguration")) {
