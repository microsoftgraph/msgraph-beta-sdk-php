...
class CloudPcSnapshot extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("lastRestoredDateTime", $this->_propDict) && !is_null($this->_propDict["lastRestoredDateTime"])) {
            if (is_a($this->_propDict["lastRestoredDateTime"], "\DateTime")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict) && !is_null($this->_propDict["status"])) {
            if (is_a($this->_propDict["status"], "\Beta\Microsoft\Graph\Model\CloudPcSnapshotStatus")) {
