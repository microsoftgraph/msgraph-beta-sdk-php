...
class CrossTenantAccessPolicyB2BSetting extends Entity
{
    ...
    */
    public function getApplications()
    {
        if (array_key_exists("applications", $this->_propDict) && !is_null($this->_propDict["applications"])) {
            ...
            if (is_a($this->_propDict["applications"], "\Beta\Microsoft\Graph\Model\CrossTenantAccessPolicyTargetConfiguration")) {
    ...
    */
    ...
    {
        if (array_key_exists("usersAndGroups", $this->_propDict) && !is_null($this->_propDict["usersAndGroups"])) {
     
            if (is_a($this->_propDict["usersAndGroups"], "\Beta\Microsoft\Graph\Model\CrossTenantAccessPolicyTargetConfiguration")) {
