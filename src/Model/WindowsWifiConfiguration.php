...
class WindowsWifiConfiguration extends DeviceConfiguration
{
    ...
    */
    ...
    {
        if (array_key_exists("meteredConnectionLimit", $this->_propDict) && !is_null($this->_propDict["meteredConnectionLimit"])) {
    ...
    */
    ...
    {
        if (array_key_exists("proxySetting", $this->_propDict) && !is_null($this->_propDict["proxySetting"])) {
