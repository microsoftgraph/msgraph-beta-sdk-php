...
class InferenceClassificationOverride extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("classifyAs", $this->_propDict) && !is_null($this->_propDict["classifyAs"])) {
    ...
    */
    ...
    {
        if (array_key_exists("senderEmailAddress", $this->_propDict) && !is_null($this->_propDict["senderEmailAddress"])) {
