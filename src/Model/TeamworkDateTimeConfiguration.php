...
class TeamworkDateTimeConfiguration extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("officeHoursEndTime", $this->_propDict) && !is_null($this->_propDict["officeHoursEndTime"])) {
     
            if (is_a($this->_propDict["officeHoursEndTime"], "\Beta\Microsoft\Graph\Model\TimeOfDay")) {
    ...
    */
    ...
    {
        if (array_key_exists("officeHoursStartTime", $this->_propDict) && !is_null($this->_propDict["officeHoursStartTime"])) {
     
            if (is_a($this->_propDict["officeHoursStartTime"], "\Beta\Microsoft\Graph\Model\TimeOfDay")) {
