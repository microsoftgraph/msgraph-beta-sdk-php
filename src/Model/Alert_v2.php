...
class Alert_v2 extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("firstActivityDateTime", $this->_propDict) && !is_null($this->_propDict["firstActivityDateTime"])) {
            if (is_a($this->_propDict["firstActivityDateTime"], "\DateTime")) {
    ...
    */
    ...
    {
        if (array_key_exists("resolvedDateTime", $this->_propDict) && !is_null($this->_propDict["resolvedDateTime"])) {
            if (is_a($this->_propDict["resolvedDateTime"], "\DateTime")) {
    ...
    */
    ...
    {
        if (array_key_exists("serviceSource", $this->_propDict) && !is_null($this->_propDict["serviceSource"])) {
            if (is_a($this->_propDict["serviceSource"], "\Beta\Microsoft\Graph\Model\ServiceSource")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict) && !is_null($this->_propDict["status"])) {
            if (is_a($this->_propDict["status"], "\Beta\Microsoft\Graph\Model\AlertStatus_v2")) {
