...
class SalesQuote extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("acceptedDate", $this->_propDict) && !is_null($this->_propDict["acceptedDate"])) {
    ...
    */
    ...
    {
        if (array_key_exists("documentDate", $this->_propDict) && !is_null($this->_propDict["documentDate"])) {
    ...
    */
    ...
    {
        if (array_key_exists("sentDate", $this->_propDict) && !is_null($this->_propDict["sentDate"])) {
    ...
    */
    ...
    {
        if (array_key_exists("validUntilDate", $this->_propDict) && !is_null($this->_propDict["validUntilDate"])) {
