...
class StrongAuthenticationPhoneAppDetail extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("lastAuthenticatedDateTime", $this->_propDict) && !is_null($this->_propDict["lastAuthenticatedDateTime"])) {
            if (is_a($this->_propDict["lastAuthenticatedDateTime"], "\DateTime")) {
    ...
    */
    ...
    {
        if (array_key_exists("oathTokenMetadata", $this->_propDict) && !is_null($this->_propDict["oathTokenMetadata"])) {
            if (is_a($this->_propDict["oathTokenMetadata"], "\Beta\Microsoft\Graph\Model\OathTokenMetadata")) {
