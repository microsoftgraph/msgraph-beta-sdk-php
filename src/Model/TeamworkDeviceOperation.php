...
class TeamworkDeviceOperation extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("lastActionBy", $this->_propDict) && !is_null($this->_propDict["lastActionBy"])) {
            if (is_a($this->_propDict["lastActionBy"], "\Beta\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getOperationType()
    {
        if (array_key_exists("operationType", $this->_propDict) && !is_null($this->_propDict["operationType"])) {
            if (is_a($this->_propDict["operationType"], "\Beta\Microsoft\Graph\Model\TeamworkDeviceOperationType")) {
