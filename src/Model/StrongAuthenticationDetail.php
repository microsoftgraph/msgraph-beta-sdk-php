...
class StrongAuthenticationDetail extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("encryptedPinHashHistory", $this->_propDict) && !is_null($this->_propDict["encryptedPinHashHistory"])) {
            if (is_a($this->_propDict["encryptedPinHashHistory"], "\GuzzleHttp\Psr7\Stream")) {
