...
class PlannerPlanContextDetails extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("displayLinkType", $this->_propDict) && !is_null($this->_propDict["displayLinkType"])) {
    ...
    */
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict) && !is_null($this->_propDict["state"])) {
            ...
            if (is_a($this->_propDict["state"], "\Beta\Microsoft\Graph\Model\PlannerContextState")) {
