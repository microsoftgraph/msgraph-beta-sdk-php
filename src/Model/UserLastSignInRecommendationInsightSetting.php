...
class UserLastSignInRecommendationInsightSetting extends AccessReviewRecommendationInsightSetting
{
    ...
    */
    ...
    {
        if (array_key_exists("signInScope", $this->_propDict) && !is_null($this->_propDict["signInScope"])) {
     
            if (is_a($this->_propDict["signInScope"], "\Beta\Microsoft\Graph\Model\UserSignInRecommendationScope")) {
