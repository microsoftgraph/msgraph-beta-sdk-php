...
class ManagedAppProtection extends ManagedAppPolicy
{
    ...
    */
    ...
    {
        if (array_key_exists("gracePeriodToBlockAppsDuringOffClockHours", $this->_propDict) && !is_null($this->_propDict["gracePeriodToBlockAppsDuringOffClockHours"])) {
            if (is_a($this->_propDict["gracePeriodToBlockAppsDuringOffClockHours"], "\DateInterval")) {
    ...
    */
    public function getPinRequiredInsteadOfBiometricTimeout()
    {
        if (array_key_exists("pinRequiredInsteadOfBiometricTimeout", $this->_propDict) && !is_null($this->_propDict["pinRequiredInsteadOfBiometricTimeout"])) {
            if (is_a($this->_propDict["pinRequiredInsteadOfBiometricTimeout"], "\DateInterval")) {
