...
class TeamworkDeviceHealth extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("hardwareHealth", $this->_propDict) && !is_null($this->_propDict["hardwareHealth"])) {
            if (is_a($this->_propDict["hardwareHealth"], "\Beta\Microsoft\Graph\Model\TeamworkHardwareHealth")) {
    ...
    */
    ...
    {
        if (array_key_exists("loginStatus", $this->_propDict) && !is_null($this->_propDict["loginStatus"])) {
            if (is_a($this->_propDict["loginStatus"], "\Beta\Microsoft\Graph\Model\TeamworkLoginStatus")) {
    ...
    */
    ...
    {
        if (array_key_exists("peripheralsHealth", $this->_propDict) && !is_null($this->_propDict["peripheralsHealth"])) {
            if (is_a($this->_propDict["peripheralsHealth"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheralsHealth")) {
    ...
    */
    ...
    {
        if (array_key_exists("softwareUpdateHealth", $this->_propDict) && !is_null($this->_propDict["softwareUpdateHealth"])) {
            if (is_a($this->_propDict["softwareUpdateHealth"], "\Beta\Microsoft\Graph\Model\TeamworkSoftwareUpdateHealth")) {
