...
class TeamworkHardwareHealth extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("computeHealth", $this->_propDict) && !is_null($this->_propDict["computeHealth"])) {
     
            if (is_a($this->_propDict["computeHealth"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheralHealth")) {
    ...
    */
    ...
    {
        if (array_key_exists("hdmiIngestHealth", $this->_propDict) && !is_null($this->_propDict["hdmiIngestHealth"])) {
     
            if (is_a($this->_propDict["hdmiIngestHealth"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheralHealth")) {
