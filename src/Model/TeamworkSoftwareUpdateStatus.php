...
class TeamworkSoftwareUpdateStatus extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("softwareFreshness", $this->_propDict) && !is_null($this->_propDict["softwareFreshness"])) {
     
            if (is_a($this->_propDict["softwareFreshness"], "\Beta\Microsoft\Graph\Model\TeamworkSoftwareFreshness")) {
