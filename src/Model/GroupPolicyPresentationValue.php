...
class GroupPolicyPresentationValue extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("definitionValue", $this->_propDict) && !is_null($this->_propDict["definitionValue"])) {
    ...
    */
    ...
    {
        if (array_key_exists("presentation", $this->_propDict) && !is_null($this->_propDict["presentation"])) {
