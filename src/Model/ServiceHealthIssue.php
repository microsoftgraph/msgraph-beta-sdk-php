    ...
    */
    public function getClassification()
    {
        if (array_key_exists("classification", $this->_propDict) && !is_null($this->_propDict["classification"])) {
            if (is_a($this->_propDict["classification"], "\Beta\Microsoft\Graph\Model\ServiceHealthClassificationType")) {
    ...
    */
    public function getOrigin()
    {
        if (array_key_exists("origin", $this->_propDict) && !is_null($this->_propDict["origin"])) {
            if (is_a($this->_propDict["origin"], "\Beta\Microsoft\Graph\Model\ServiceHealthOrigin")) {
