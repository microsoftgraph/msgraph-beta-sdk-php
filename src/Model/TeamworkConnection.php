...
class TeamworkConnection extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("connectionStatus", $this->_propDict) && !is_null($this->_propDict["connectionStatus"])) {
     
            if (is_a($this->_propDict["connectionStatus"], "\Beta\Microsoft\Graph\Model\TeamworkConnectionStatus")) {
