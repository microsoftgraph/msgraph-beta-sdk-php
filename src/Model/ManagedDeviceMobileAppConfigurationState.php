...
class ManagedDeviceMobileAppConfigurationState extends Entity
{
    ...
    */
     ...
     *
     * @return ManagedDeviceMobileAppConfigurationSettingState[]|null The settingStates
     */
    public function getSettingStates()
    {
        if (array_key_exists('settingStates', $this->_propDict) && !is_null($this->_propDict['settingStates'])) {
           $settingStates = [];
           if (count($this->_propDict['settingStates']) > 0 && is_a($this->_propDict['settingStates'][0], 'ManagedDeviceMobileAppConfigurationSettingState')) {
              return $this->_propDict['settingStates'];
           }
           foreach ($this->_propDict['settingStates'] as $singleValue) {
              $settingStates []= new ManagedDeviceMobileAppConfigurationSettingState($singleValue);
           }
