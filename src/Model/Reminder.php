...
class Reminder extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("eventEndTime", $this->_propDict) && !is_null($this->_propDict["eventEndTime"])) {
    ...
    */
    ...
    {
        if (array_key_exists("eventLocation", $this->_propDict) && !is_null($this->_propDict["eventLocation"])) {
    ...
    */
    ...
    {
        if (array_key_exists("eventStartTime", $this->_propDict) && !is_null($this->_propDict["eventStartTime"])) {
    ...
    */
    ...
    {
        if (array_key_exists("reminderFireTime", $this->_propDict) && !is_null($this->_propDict["reminderFireTime"])) {
