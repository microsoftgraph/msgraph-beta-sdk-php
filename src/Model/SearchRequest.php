...
class SearchRequest extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("queryAlterationOptions", $this->_propDict) && !is_null($this->_propDict["queryAlterationOptions"])) {
     
            if (is_a($this->_propDict["queryAlterationOptions"], "\Beta\Microsoft\Graph\Model\SearchAlterationOptions")) {
    ...
    */
    public function getResultTemplateOptions()
    {
        if (array_key_exists("resultTemplateOptions", $this->_propDict) && !is_null($this->_propDict["resultTemplateOptions"])) {
            ...
            if (is_a($this->_propDict["resultTemplateOptions"], "\Beta\Microsoft\Graph\Model\ResultTemplateOption")) {
