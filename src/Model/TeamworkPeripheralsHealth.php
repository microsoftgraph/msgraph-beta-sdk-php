...
class TeamworkPeripheralsHealth extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("communicationSpeakerHealth", $this->_propDict) && !is_null($this->_propDict["communicationSpeakerHealth"])) {
     
            if (is_a($this->_propDict["communicationSpeakerHealth"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheralHealth")) {
    ...
    */
    ...
    {
        if (array_key_exists("contentCameraHealth", $this->_propDict) && !is_null($this->_propDict["contentCameraHealth"])) {
     
            if (is_a($this->_propDict["contentCameraHealth"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheralHealth")) {
    ...
    */
    ...
    {
        if (array_key_exists("displayHealthCollection", $this->_propDict) && !is_null($this->_propDict["displayHealthCollection"])) {
       
            if (count($this->_propDict['displayHealthCollection']) > 0 && is_a($this->_propDict['displayHealthCollection'][0], 'TeamworkPeripheralHealth')) {
                return $this->_propDict['displayHealthCollection'];
            }
            $displayHealthCollection = [];
            foreach ($this->_propDict['displayHealthCollection'] as $singleValue) {
                $displayHealthCollection []= new TeamworkPeripheralHealth($singleValue);
            }
            $this->_propDict['displayHealthCollection'] = $displayHealthCollection;
            return $this->_propDict['displayHealthCollection'];
            }
        return null;
    }
    ...
    */
    ...
    {
        if (array_key_exists("microphoneHealth", $this->_propDict) && !is_null($this->_propDict["microphoneHealth"])) {
     
            if (is_a($this->_propDict["microphoneHealth"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheralHealth")) {
    ...
    */
    ...
    {
        if (array_key_exists("roomCameraHealth", $this->_propDict) && !is_null($this->_propDict["roomCameraHealth"])) {
     
            if (is_a($this->_propDict["roomCameraHealth"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheralHealth")) {
    ...
    */
    ...
    {
        if (array_key_exists("speakerHealth", $this->_propDict) && !is_null($this->_propDict["speakerHealth"])) {
     
            if (is_a($this->_propDict["speakerHealth"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheralHealth")) {
