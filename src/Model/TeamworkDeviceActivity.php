...
class TeamworkDeviceActivity extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("activePeripherals", $this->_propDict) && !is_null($this->_propDict["activePeripherals"])) {
            if (is_a($this->_propDict["activePeripherals"], "\Beta\Microsoft\Graph\Model\TeamworkActivePeripherals")) {
