...
class Certification extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("certificationExpirationDateTime", $this->_propDict) && !is_null($this->_propDict["certificationExpirationDateTime"])) {
     
            if (is_a($this->_propDict["certificationExpirationDateTime"], "\DateTime")) {
    ...
    */
    ...
    {
        if (array_key_exists("lastCertificationDateTime", $this->_propDict) && !is_null($this->_propDict["lastCertificationDateTime"])) {
     
            if (is_a($this->_propDict["lastCertificationDateTime"], "\DateTime")) {
