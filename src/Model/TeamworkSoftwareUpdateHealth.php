...
class TeamworkSoftwareUpdateHealth extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("adminAgentSoftwareUpdateStatus", $this->_propDict) && !is_null($this->_propDict["adminAgentSoftwareUpdateStatus"])) {
     
            if (is_a($this->_propDict["adminAgentSoftwareUpdateStatus"], "\Beta\Microsoft\Graph\Model\TeamworkSoftwareUpdateStatus")) {
    ...
    */
    ...
    {
        if (array_key_exists("companyPortalSoftwareUpdateStatus", $this->_propDict) && !is_null($this->_propDict["companyPortalSoftwareUpdateStatus"])) {
     
            if (is_a($this->_propDict["companyPortalSoftwareUpdateStatus"], "\Beta\Microsoft\Graph\Model\TeamworkSoftwareUpdateStatus")) {
    ...
    */
    ...
    {
        if (array_key_exists("firmwareSoftwareUpdateStatus", $this->_propDict) && !is_null($this->_propDict["firmwareSoftwareUpdateStatus"])) {
     
            if (is_a($this->_propDict["firmwareSoftwareUpdateStatus"], "\Beta\Microsoft\Graph\Model\TeamworkSoftwareUpdateStatus")) {
    ...
    */
    ...
    {
        if (array_key_exists("operatingSystemSoftwareUpdateStatus", $this->_propDict) && !is_null($this->_propDict["operatingSystemSoftwareUpdateStatus"])) {
     
            if (is_a($this->_propDict["operatingSystemSoftwareUpdateStatus"], "\Beta\Microsoft\Graph\Model\TeamworkSoftwareUpdateStatus")) {
    ...
    */
    ...
    {
        if (array_key_exists("partnerAgentSoftwareUpdateStatus", $this->_propDict) && !is_null($this->_propDict["partnerAgentSoftwareUpdateStatus"])) {
     
            if (is_a($this->_propDict["partnerAgentSoftwareUpdateStatus"], "\Beta\Microsoft\Graph\Model\TeamworkSoftwareUpdateStatus")) {
    ...
    */
    ...
    {
        if (array_key_exists("teamsClientSoftwareUpdateStatus", $this->_propDict) && !is_null($this->_propDict["teamsClientSoftwareUpdateStatus"])) {
     
            if (is_a($this->_propDict["teamsClientSoftwareUpdateStatus"], "\Beta\Microsoft\Graph\Model\TeamworkSoftwareUpdateStatus")) {
