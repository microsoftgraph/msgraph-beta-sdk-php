...
class AndroidDeviceOwnerGeneralDeviceConfiguration extends DeviceConfiguration
{
    ...
    * A list of managed apps that will have their data cleared during a global sign-out in AAD shared device mode. This collection can contain a maximum of 500 elements.
     *
     * @return AppListItem[]|null The azureAdSharedDeviceDataClearApps
     */
    public function getAzureAdSharedDeviceDataClearApps()
    {
        if (array_key_exists('azureAdSharedDeviceDataClearApps', $this->_propDict) && !is_null($this->_propDict['azureAdSharedDeviceDataClearApps'])) {
            $azureAdSharedDeviceDataClearApps = [];
            if (count($this->_propDict['azureAdSharedDeviceDataClearApps']) > 0 && is_a($this->_propDict['azureAdSharedDeviceDataClearApps'][0], 'AppListItem')) {
                return $this->_propDict['azureAdSharedDeviceDataClearApps'];
            }
            foreach ($this->_propDict['azureAdSharedDeviceDataClearApps'] as $singleValue) {
                $azureAdSharedDeviceDataClearApps []= new AppListItem($singleValue);
            }
            $this->_propDict['azureAdSharedDeviceDataClearApps'] = $azureAdSharedDeviceDataClearApps;
            return $this->_propDict['azureAdSharedDeviceDataClearApps'];
        }
        return null;
    }
    ...
    */
    ...
    {
        if (array_key_exists("crossProfilePoliciesAllowDataSharing", $this->_propDict) && !is_null($this->_propDict["crossProfilePoliciesAllowDataSharing"])) {
            if (is_a($this->_propDict["crossProfilePoliciesAllowDataSharing"], "\Beta\Microsoft\Graph\Model\AndroidDeviceOwnerCrossProfileDataSharing")) {
    ...
    * Policy applied to applications in the personal profile. This collection can contain a maximum of 500 elements.
     *
     * @return AppListItem[]|null The personalProfilePersonalApplications
     */
    public function getPersonalProfilePersonalApplications()
    {
        if (array_key_exists('personalProfilePersonalApplications', $this->_propDict) && !is_null($this->_propDict['personalProfilePersonalApplications'])) {
            $personalProfilePersonalApplications = [];
            if (count($this->_propDict['personalProfilePersonalApplications']) > 0 && is_a($this->_propDict['personalProfilePersonalApplications'][0], 'AppListItem')) {
                return $this->_propDict['personalProfilePersonalApplications'];
            }
            foreach ($this->_propDict['personalProfilePersonalApplications'] as $singleValue) {
                $personalProfilePersonalApplications []= new AppListItem($singleValue);
            }
            $this->_propDict['personalProfilePersonalApplications'] = $personalProfilePersonalApplications;
            return $this->_propDict['personalProfilePersonalApplications'];
        }
        return null;
    }
    ...
    */
    ...
    {
        if (array_key_exists("personalProfilePlayStoreMode", $this->_propDict) && !is_null($this->_propDict["personalProfilePlayStoreMode"])) {
            if (is_a($this->_propDict["personalProfilePlayStoreMode"], "\Beta\Microsoft\Graph\Model\PersonalProfilePersonalPlayStoreMode")) {
    ...
    * Indicates the annually repeating time periods during which system updates are postponed. This collection can contain a maximum of 500 elements.
     *
     * @return AndroidDeviceOwnerSystemUpdateFreezePeriod[]|null The systemUpdateFreezePeriods
     */
    public function getSystemUpdateFreezePeriods()
    {
        if (array_key_exists('systemUpdateFreezePeriods', $this->_propDict) && !is_null($this->_propDict['systemUpdateFreezePeriods'])) {
            $systemUpdateFreezePeriods = [];
            if (count($this->_propDict['systemUpdateFreezePeriods']) > 0 && is_a($this->_propDict['systemUpdateFreezePeriods'][0], 'AndroidDeviceOwnerSystemUpdateFreezePeriod')) {
                return $this->_propDict['systemUpdateFreezePeriods'];
            }
            foreach ($this->_propDict['systemUpdateFreezePeriods'] as $singleValue) {
                $systemUpdateFreezePeriods []= new AndroidDeviceOwnerSystemUpdateFreezePeriod($singleValue);
            }
            $this->_propDict['systemUpdateFreezePeriods'] = $systemUpdateFreezePeriods;
            return $this->_propDict['systemUpdateFreezePeriods'];
        }
        return null;
    }
