...
class LocateDeviceActionResult extends DeviceActionResult
{
    ...
    */
    ...
    {
        if (array_key_exists("deviceLocation", $this->_propDict) && !is_null($this->_propDict["deviceLocation"])) {
     
            if (is_a($this->_propDict["deviceLocation"], "\Beta\Microsoft\Graph\Model\DeviceGeoLocation")) {
