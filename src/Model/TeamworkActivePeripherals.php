...
class TeamworkActivePeripherals extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("communicationSpeaker", $this->_propDict) && !is_null($this->_propDict["communicationSpeaker"])) {
     
            if (is_a($this->_propDict["communicationSpeaker"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheral")) {
    ...
    */
    ...
    {
        if (array_key_exists("contentCamera", $this->_propDict) && !is_null($this->_propDict["contentCamera"])) {
     
            if (is_a($this->_propDict["contentCamera"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheral")) {
    ...
    */
    ...
    {
        if (array_key_exists("microphone", $this->_propDict) && !is_null($this->_propDict["microphone"])) {
     
            if (is_a($this->_propDict["microphone"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheral")) {
    ...
    */
    ...
    {
        if (array_key_exists("roomCamera", $this->_propDict) && !is_null($this->_propDict["roomCamera"])) {
     
            if (is_a($this->_propDict["roomCamera"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheral")) {
    ...
    */
    ...
    {
        if (array_key_exists("speaker", $this->_propDict) && !is_null($this->_propDict["speaker"])) {
     
            if (is_a($this->_propDict["speaker"], "\Beta\Microsoft\Graph\Model\TeamworkPeripheral")) {
