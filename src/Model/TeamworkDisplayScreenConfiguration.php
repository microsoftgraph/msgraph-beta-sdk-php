...
class TeamworkDisplayScreenConfiguration extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("backlightTimeout", $this->_propDict) && !is_null($this->_propDict["backlightTimeout"])) {
     
            if (is_a($this->_propDict["backlightTimeout"], "\DateInterval")) {
    ...
    */
    ...
    {
        if (array_key_exists("screensaverTimeout", $this->_propDict) && !is_null($this->_propDict["screensaverTimeout"])) {
     
            if (is_a($this->_propDict["screensaverTimeout"], "\DateInterval")) {
