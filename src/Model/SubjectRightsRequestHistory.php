...
class SubjectRightsRequestHistory extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("changedBy", $this->_propDict) && !is_null($this->_propDict["changedBy"])) {
     
            if (is_a($this->_propDict["changedBy"], "\Beta\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getStage()
    {
        if (array_key_exists("stage", $this->_propDict) && !is_null($this->_propDict["stage"])) {
            ...
            if (is_a($this->_propDict["stage"], "\Beta\Microsoft\Graph\Model\SubjectRightsRequestStage")) {
    ...
    */
    ...
    {
        if (array_key_exists("stageStatus", $this->_propDict) && !is_null($this->_propDict["stageStatus"])) {
     
            if (is_a($this->_propDict["stageStatus"], "\Beta\Microsoft\Graph\Model\SubjectRightsRequestStageStatus")) {
