...
class TeamworkSystemConfiguration extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("dateTimeConfiguration", $this->_propDict) && !is_null($this->_propDict["dateTimeConfiguration"])) {
     
            if (is_a($this->_propDict["dateTimeConfiguration"], "\Beta\Microsoft\Graph\Model\TeamworkDateTimeConfiguration")) {
    ...
    */
    ...
    {
        if (array_key_exists("deviceLockTimeout", $this->_propDict) && !is_null($this->_propDict["deviceLockTimeout"])) {
     
            if (is_a($this->_propDict["deviceLockTimeout"], "\DateInterval")) {
    ...
    */
    ...
    {
        if (array_key_exists("networkConfiguration", $this->_propDict) && !is_null($this->_propDict["networkConfiguration"])) {
     
            if (is_a($this->_propDict["networkConfiguration"], "\Beta\Microsoft\Graph\Model\TeamworkNetworkConfiguration")) {
