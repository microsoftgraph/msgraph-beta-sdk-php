...
class TeamworkLoginStatus extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("exchangeConnection", $this->_propDict) && !is_null($this->_propDict["exchangeConnection"])) {
     
            if (is_a($this->_propDict["exchangeConnection"], "\Beta\Microsoft\Graph\Model\TeamworkConnection")) {
    ...
    */
    ...
    {
        if (array_key_exists("skypeConnection", $this->_propDict) && !is_null($this->_propDict["skypeConnection"])) {
     
            if (is_a($this->_propDict["skypeConnection"], "\Beta\Microsoft\Graph\Model\TeamworkConnection")) {
    ...
    */
    ...
    {
        if (array_key_exists("teamsConnection", $this->_propDict) && !is_null($this->_propDict["teamsConnection"])) {
     
            if (is_a($this->_propDict["teamsConnection"], "\Beta\Microsoft\Graph\Model\TeamworkConnection")) {
