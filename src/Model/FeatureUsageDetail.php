...
class FeatureUsageDetail extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("lastConfiguredDateTime", $this->_propDict) && !is_null($this->_propDict["lastConfiguredDateTime"])) {
    ...
    */
    ...
    {
        if (array_key_exists("lastUsedDateTime", $this->_propDict) && !is_null($this->_propDict["lastUsedDateTime"])) {
    ...
    */
    ...
    {
        if (array_key_exists("licenseRequired", $this->_propDict) && !is_null($this->_propDict["licenseRequired"])) {
