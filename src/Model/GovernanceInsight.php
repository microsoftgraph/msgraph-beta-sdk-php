...
class GovernanceInsight extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("insightCreatedDateTime", $this->_propDict) && !is_null($this->_propDict["insightCreatedDateTime"])) {
            if (is_a($this->_propDict["insightCreatedDateTime"], "\DateTime")) {
