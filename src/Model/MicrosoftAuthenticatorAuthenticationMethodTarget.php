...
class MicrosoftAuthenticatorAuthenticationMethodTarget extends AuthenticationMethodTarget
{
    ...
    */
    ...
    {
        if (array_key_exists("displayLocationInformationRequiredState", $this->_propDict) && !is_null($this->_propDict["displayLocationInformationRequiredState"])) {
            if (is_a($this->_propDict["displayLocationInformationRequiredState"], "\Beta\Microsoft\Graph\Model\AdvancedConfigState")) {
