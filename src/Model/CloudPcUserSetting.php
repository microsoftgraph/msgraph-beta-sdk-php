...
class CloudPcUserSetting extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("restorePointSetting", $this->_propDict) && !is_null($this->_propDict["restorePointSetting"])) {
            if (is_a($this->_propDict["restorePointSetting"], "\Beta\Microsoft\Graph\Model\CloudPcRestorePointSetting")) {
