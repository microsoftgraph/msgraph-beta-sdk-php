...
class CloudPC extends Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("lastLoginResult", $this->_propDict) && !is_null($this->_propDict["lastLoginResult"])) {
            if (is_a($this->_propDict["lastLoginResult"], "\Beta\Microsoft\Graph\Model\CloudPcLoginResult")) {
    ...
    */
    ...
    {
        if (array_key_exists("lastRemoteActionResult", $this->_propDict) && !is_null($this->_propDict["lastRemoteActionResult"])) {
            if (is_a($this->_propDict["lastRemoteActionResult"], "\Beta\Microsoft\Graph\Model\CloudPcRemoteActionResult")) {
    ...
    */
    ...
    {
        if (array_key_exists("osVersion", $this->_propDict) && !is_null($this->_propDict["osVersion"])) {
            if (is_a($this->_propDict["osVersion"], "\Beta\Microsoft\Graph\Model\CloudPcOperatingSystem")) {
    ...
    */
    ...
    {
        if (array_key_exists("servicePlanType", $this->_propDict) && !is_null($this->_propDict["servicePlanType"])) {
            if (is_a($this->_propDict["servicePlanType"], "\Beta\Microsoft\Graph\Model\CloudPcServicePlanType")) {
    ...
    */
    public function getUserAccountType()
    {
        if (array_key_exists("userAccountType", $this->_propDict) && !is_null($this->_propDict["userAccountType"])) {
            if (is_a($this->_propDict["userAccountType"], "\Beta\Microsoft\Graph\Model\CloudPcUserAccountType")) {
