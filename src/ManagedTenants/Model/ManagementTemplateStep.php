...
class ManagementTemplateStep extends \Beta\Microsoft\Graph\Model\Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("provider", $this->_propDict) && !is_null($this->_propDict["provider"])) {
            if (is_a($this->_propDict["provider"], "\Beta\Microsoft\Graph\ManagedTenants\Model\ManagementProvider")) {
    ...
    */
    ...
    {
        if (array_key_exists("managementTemplate", $this->_propDict) && !is_null($this->_propDict["managementTemplate"])) {
            if (is_a($this->_propDict["managementTemplate"], "\Beta\Microsoft\Graph\ManagedTenants\Model\ManagementTemplate")) {
    ...
    */
     ...
     *
     * @return ManagementTemplateStepVersion[]|null The stepVersions
     */
    public function getStepVersions()
    {
        if (array_key_exists('stepVersions', $this->_propDict) && !is_null($this->_propDict['stepVersions'])) {
            $stepVersions = [];
            if (count($this->_propDict['stepVersions']) > 0 && is_a($this->_propDict['stepVersions'][0], 'ManagementTemplateStepVersion')) {
                return $this->_propDict['stepVersions'];
            }
            foreach ($this->_propDict['stepVersions'] as $singleValue) {
                $stepVersions []= new ManagementTemplateStepVersion($singleValue);
            }
            $this->_propDict['stepVersions'] = $stepVersions;
            return $this->_propDict['stepVersions'];
        }
        return null;
    }
