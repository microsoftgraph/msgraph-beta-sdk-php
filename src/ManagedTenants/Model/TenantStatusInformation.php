...
class TenantStatusInformation extends \Beta\Microsoft\Graph\Model\Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("tenantOnboardingEligibilityReason", $this->_propDict) && !is_null($this->_propDict["tenantOnboardingEligibilityReason"])) {
     
            if (is_a($this->_propDict["tenantOnboardingEligibilityReason"], "\Beta\Microsoft\Graph\ManagedTenants\Model\TenantOnboardingEligibilityReason")) {
