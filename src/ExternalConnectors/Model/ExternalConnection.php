...
class ExternalConnection extends \Beta\Microsoft\Graph\Model\Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("searchSettings", $this->_propDict) && !is_null($this->_propDict["searchSettings"])) {
            if (is_a($this->_propDict["searchSettings"], "\Beta\Microsoft\Graph\ExternalConnectors\Model\SearchSettings")) {
    ...
    */
    public function getQuota()
    {
        if (array_key_exists("quota", $this->_propDict) && !is_null($this->_propDict["quota"])) {
            if (is_a($this->_propDict["quota"], "\Beta\Microsoft\Graph\ExternalConnectors\Model\ConnectionQuota")) {
