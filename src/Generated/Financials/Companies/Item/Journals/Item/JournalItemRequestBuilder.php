...
use Microsoft\Graph\Beta\Generated\Financials\Companies\Item\Journals\Item\MicrosoftGraphPost\PostRequestBuilder;
...
class JournalItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $journalId key: id of journal
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $journalId = null) {
