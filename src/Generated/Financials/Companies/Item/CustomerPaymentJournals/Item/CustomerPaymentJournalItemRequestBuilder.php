...
class CustomerPaymentJournalItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $customerPaymentJournalId key: id of customerPaymentJournal
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $customerPaymentJournalId = null) {
        ...
        $urlTplParams['customerPaymentJournalId'] = $customerPaymentJournalId;
