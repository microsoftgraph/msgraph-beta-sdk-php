...
class CustomerPaymentItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/financials/companies/{company_id}/customerPaymentJournals/{customerPaymentJournal_id}/customerPayments/{customerPayment_id}{?select,expand}';
