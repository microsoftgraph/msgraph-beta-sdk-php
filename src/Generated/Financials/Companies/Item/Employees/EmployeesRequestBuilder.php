...
*/
class EmployeesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/financials/companies/{company%2Did}/employees{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<EmployeeCollectionResponse|null>
     * @throws Exception
    */
    ...
    */
    public function toPostRequestInformation(Employee $body, ?EmployeesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/financials/companies/{company%2Did}/employees';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return EmployeesRequestBuilder
    */
    public function withUrl(string $rawUrl): EmployeesRequestBuilder {
        return new EmployeesRequestBuilder($rawUrl, $this->requestAdapter);
    }
