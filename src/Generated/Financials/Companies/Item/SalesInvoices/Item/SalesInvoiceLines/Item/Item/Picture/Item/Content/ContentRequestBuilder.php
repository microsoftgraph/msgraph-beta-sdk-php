...
class ContentRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/financials/companies/{company_id}/salesInvoices/{salesInvoice_id}/salesInvoiceLines/{salesInvoiceLine_id}/item/picture/{picture_id}/content';
