...
class SalesInvoiceLineItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $salesInvoiceLineId key: id of salesInvoiceLine
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $salesInvoiceLineId = null) {
        ...
        $urlTplParams['salesInvoiceLineId'] = $salesInvoiceLineId;
