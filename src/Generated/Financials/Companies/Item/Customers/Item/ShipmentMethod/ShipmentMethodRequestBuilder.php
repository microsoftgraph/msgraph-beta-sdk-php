...
class ShipmentMethodRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/financials/companies/{company%2Did}/customers/{customer%2Did}/shipmentMethod');
    ...
    */
    public function toGetRequestInformation(?ShipmentMethodRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/financials/companies/{company%2Did}/customers/{customer%2Did}/shipmentMethod{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
