...
class CustomerItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $customerId key: id of customer
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $customerId = null) {
