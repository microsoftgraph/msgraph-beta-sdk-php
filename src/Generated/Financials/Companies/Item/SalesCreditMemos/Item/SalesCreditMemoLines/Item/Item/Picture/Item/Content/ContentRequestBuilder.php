...
class ContentRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/financials/companies/{company_id}/salesCreditMemos/{salesCreditMemo_id}/salesCreditMemoLines/{salesCreditMemoLine_id}/item/picture/{picture_id}/content';
