...
class SalesCreditMemoItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $salesCreditMemoId key: id of salesCreditMemo
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $salesCreditMemoId = null) {
        ...
        $urlTplParams['salesCreditMemoId'] = $salesCreditMemoId;
