...
class SalesOrderLineItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $salesOrderLineId key: id of salesOrderLine
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $salesOrderLineId = null) {
        ...
        $urlTplParams['salesOrderLineId'] = $salesOrderLineId;
