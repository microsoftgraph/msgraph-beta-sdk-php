...
class GeneralLedgerEntryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $generalLedgerEntryId key: id of generalLedgerEntry
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $generalLedgerEntryId = null) {
        ...
        $urlTplParams['generalLedgerEntryId'] = $generalLedgerEntryId;
