...
class PaymentTermItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $paymentTermId key: id of paymentTerm
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $paymentTermId = null) {
        ...
        $urlTplParams['paymentTermId'] = $paymentTermId;
