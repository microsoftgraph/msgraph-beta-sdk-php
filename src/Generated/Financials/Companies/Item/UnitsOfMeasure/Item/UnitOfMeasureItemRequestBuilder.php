...
class UnitOfMeasureItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $unitOfMeasureId key: id of unitOfMeasure
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $unitOfMeasureId = null) {
        ...
        $urlTplParams['unitOfMeasureId'] = $unitOfMeasureId;
