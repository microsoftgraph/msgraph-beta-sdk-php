...
class SalesOrderItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $salesOrderId key: id of salesOrder
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $salesOrderId = null) {
