...
class DimensionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $dimensionId key: id of dimension
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $dimensionId = null) {
