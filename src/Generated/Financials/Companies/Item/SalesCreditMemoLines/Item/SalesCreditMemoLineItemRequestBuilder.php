...
class SalesCreditMemoLineItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $salesCreditMemoLineId key: id of salesCreditMemoLine
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $salesCreditMemoLineId = null) {
        ...
        $urlTplParams['salesCreditMemoLineId'] = $salesCreditMemoLineId;
