...
namespace Microsoft\Graph\Beta\Generated\Financials\Companies\Item\Items\Item\Picture\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/financials/companies/{company%2Did}/items/{item%2Did}/picture/$count{?%24search,%24filter}");
