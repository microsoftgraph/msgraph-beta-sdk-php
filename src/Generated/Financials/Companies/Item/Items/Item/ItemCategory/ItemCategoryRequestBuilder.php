...
class ItemCategoryRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/financials/companies/{company%2Did}/items/{item%2Did}/itemCategory');
    ...
    */
    public function toGetRequestInformation(?ItemCategoryRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/financials/companies/{company%2Did}/items/{item%2Did}/itemCategory{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
