...
class PictureItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $pictureId key: id of picture
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $pictureId = null) {
        ...
        $urlTplParams['pictureId'] = $pictureId;
