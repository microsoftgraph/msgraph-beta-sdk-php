...
use Microsoft\Graph\Beta\Generated\Financials\Companies\Item\PurchaseInvoices\Item\MicrosoftGraphPost\PostRequestBuilder;
...
class PurchaseInvoiceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $purchaseInvoiceId key: id of purchaseInvoice
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $purchaseInvoiceId = null) {
        ...
        $urlTplParams['purchaseInvoiceId'] = $purchaseInvoiceId;
