...
class TaxAreaItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $taxAreaId key: id of taxArea
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $taxAreaId = null) {
        $this->urlTemplate = '{+baseurl}/financials/companies/{company%2Did}/taxAreas/{taxArea%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['taxAreaId'] = $taxAreaId;
