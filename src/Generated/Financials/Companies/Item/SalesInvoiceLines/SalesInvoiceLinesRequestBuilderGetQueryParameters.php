...
*/
class SalesInvoiceLinesRequestBuilderGetQueryParameters 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SalesInvoiceLinesRequestBuilderGetQueryParameters and sets the default values.
