...
class CompanyInformationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $companyInformationId key: id of companyInformation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $companyInformationId = null) {
        ...
        $urlTplParams['companyInformationId'] = $companyInformationId;
