...
class CompanyInformationItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/financials/companies/{company%2Did}/companyInformation/{companyInformation%2Did}{?%24expand,%24select}');
     ...
     * @return Promise<CompanyInformation|null>
     * @throws Exception
    */
    ...
    */
    public function withUrl(string $rawUrl): CompanyInformationItemRequestBuilder {
        return new CompanyInformationItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
