...
class ShipmentMethodItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $shipmentMethodId key: id of shipmentMethod
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $shipmentMethodId = null) {
        ...
        $urlTplParams['shipmentMethodId'] = $shipmentMethodId;
