...
class VendorItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $vendorId key: id of vendor
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $vendorId = null) {
        $this->urlTemplate = '{+baseurl}/financials/companies/{company%2Did}/vendors/{vendor%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['vendorId'] = $vendorId;
