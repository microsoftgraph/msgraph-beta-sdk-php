...
class SalesQuoteLineItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $salesQuoteLineId key: id of salesQuoteLine
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $salesQuoteLineId = null) {
        ...
        $urlTplParams['salesQuoteLineId'] = $salesQuoteLineId;
