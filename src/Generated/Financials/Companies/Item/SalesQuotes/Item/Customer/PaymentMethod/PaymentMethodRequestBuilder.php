...
class PaymentMethodRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/financials/companies/{company%2Did}/salesQuotes/{salesQuote%2Did}/customer/paymentMethod');
    ...
    */
    public function toGetRequestInformation(?PaymentMethodRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/financials/companies/{company%2Did}/salesQuotes/{salesQuote%2Did}/customer/paymentMethod{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
