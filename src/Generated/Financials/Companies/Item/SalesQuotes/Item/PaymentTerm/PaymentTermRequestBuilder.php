...
class PaymentTermRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/financials/companies/{company%2Did}/salesQuotes/{salesQuote%2Did}/paymentTerm');
    ...
    */
    public function toGetRequestInformation(?PaymentTermRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/financials/companies/{company%2Did}/salesQuotes/{salesQuote%2Did}/paymentTerm{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
