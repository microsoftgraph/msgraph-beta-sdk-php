...
class CreateRemoteHelpSessionPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getSessionType(): ?string {
        return $this->getBackingStore()->get('sessionType');
    }
    ...
    */
    public function setSessionType(?string $value): void {
        $this->getBackingStore()->set('sessionType', $value);
    }
