...
class SecurityBaselineStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $securityBaselineStateId key: id of securityBaselineState
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $securityBaselineStateId = null) {
    ...
    */
    public function settingStatesById(string $id): SecurityBaselineSettingStateItemRequestBuilder {
        ...
        return new SecurityBaselineSettingStateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
