...
class SecurityBaselineStateItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $securityBaselineStateId = null) {
        ...
        $urlTplParams['securityBaselineStateId'] = $securityBaselineStateId;
