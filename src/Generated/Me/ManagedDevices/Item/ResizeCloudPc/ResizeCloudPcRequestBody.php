...
class ResizeCloudPcRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return ResizeCloudPcRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ResizeCloudPcRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'targetServicePlanId' => function (self $o, ParseNode $n) { $o->setTargetServicePlanId($n->getStringValue()); },
        ];
    }
