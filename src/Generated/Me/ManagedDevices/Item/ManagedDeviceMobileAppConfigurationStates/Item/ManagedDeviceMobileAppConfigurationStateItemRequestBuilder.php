...
class ManagedDeviceMobileAppConfigurationStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedDeviceMobileAppConfigurationStateId key: id of managedDeviceMobileAppConfigurationState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedDeviceMobileAppConfigurationStateId = null) {
        ...
        $urlTplParams['managedDeviceMobileAppConfigurationStateId'] = $managedDeviceMobileAppConfigurationStateId;
