...
class GetCloudPcRemoteActionResultsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/me/managedDevices/{managedDevice_id}/microsoft.graph.getCloudPcRemoteActionResults()';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, GetCloudPcRemoteActionResultsResponse::class, $responseHandler);
        } catch(Exception $ex) {
