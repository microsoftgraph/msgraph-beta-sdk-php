...
class MobileAppTroubleshootingEventItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $mobileAppTroubleshootingEventId = null) {
        ...
        $urlTplParams['mobileAppTroubleshootingEventId'] = $mobileAppTroubleshootingEventId;
