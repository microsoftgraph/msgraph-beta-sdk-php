...
class MobileAppTroubleshootingEventItemRequestBuilder 
{
    ...
    */
    public function appLogCollectionRequestsById(string $id): AppLogCollectionRequestItemRequestBuilder {
        ...
        return new AppLogCollectionRequestItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $mobileAppTroubleshootingEventId key: id of mobileAppTroubleshootingEvent
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $mobileAppTroubleshootingEventId = null) {
        $this->urlTemplate = '{+baseurl}/me/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}{?%24select,%24expand}';
