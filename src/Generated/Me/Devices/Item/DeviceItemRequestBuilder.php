...
class DeviceItemRequestBuilder 
{
    ...
    */
     ...
     * Provides operations to manage the memberOf property of the microsoft.graph.device entity.
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Beta\Generated\Me\Devices\Item\MemberOf\Item\DirectoryObjectItemRequestBuilder|null
    */
    ...
    */
     ...
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Beta\Generated\Me\Devices\Item\RegisteredOwners\Item\DirectoryObjectItemRequestBuilder|null
    */
     ...
     * Provides operations to manage the registeredUsers property of the microsoft.graph.device entity.
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Beta\Generated\Me\Devices\Item\RegisteredUsers\Item\DirectoryObjectItemRequestBuilder|null
    */
     ...
     * Provides operations to manage the transitiveMemberOf property of the microsoft.graph.device entity.
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Beta\Generated\Me\Devices\Item\TransitiveMemberOf\Item\DirectoryObjectItemRequestBuilder|null
    */
