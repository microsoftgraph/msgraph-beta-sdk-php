...
namespace Microsoft\Graph\Beta\Generated\Me\Devices\Item\RegisteredOwners\GraphServicePrincipal;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Me\Devices\Item\RegisteredOwners\GraphServicePrincipal\Count\CountRequestBuilder;
...
class GraphServicePrincipalRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/devices/{device%2Did}/registeredOwners/graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
