...
namespace Microsoft\Graph\Beta\Generated\Me\Devices\Item\RegisteredOwners\GraphEndpoint\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/devices/{device%2Did}/registeredOwners/graph.endpoint/$count{?%24search,%24filter}");
