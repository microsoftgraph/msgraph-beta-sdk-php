...
namespace Microsoft\Graph\Beta\Generated\Me\Devices\Item\RegisteredUsers\GraphUser\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/devices/{device%2Did}/registeredUsers/graph.user/$count{?%24search,%24filter}");
