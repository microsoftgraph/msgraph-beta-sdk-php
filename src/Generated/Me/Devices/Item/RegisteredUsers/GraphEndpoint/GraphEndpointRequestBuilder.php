...
namespace Microsoft\Graph\Beta\Generated\Me\Devices\Item\RegisteredUsers\GraphEndpoint;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Me\Devices\Item\RegisteredUsers\GraphEndpoint\Count\CountRequestBuilder;
...
class GraphEndpointRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/devices/{device%2Did}/registeredUsers/graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}");
