...
namespace Microsoft\Graph\Beta\Generated\Me\Devices\Item\MemberOf\MicrosoftGraphDevice;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Me\Devices\Item\MemberOf\MicrosoftGraphDevice\Count\CountRequestBuilder;
...
class DeviceRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/me/devices/{device%2Did}/memberOf/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}';
