...
class UsageRightItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $usageRightId key: id of usageRight
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $usageRightId = null) {
        $this->urlTemplate = '{+baseurl}/me/devices/{device%2Did}/usageRights/{usageRight%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['usageRightId'] = $usageRightId;
