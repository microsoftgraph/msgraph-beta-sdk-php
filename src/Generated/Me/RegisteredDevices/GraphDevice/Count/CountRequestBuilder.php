...
namespace Microsoft\Graph\Beta\Generated\Me\RegisteredDevices\GraphDevice\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/registeredDevices/graph.device/$count{?%24search,%24filter}");
