...
namespace Microsoft\Graph\Beta\Generated\Me\Todo\Lists\Item\Tasks\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/$count{?%24search,%24filter}");
