...
namespace Microsoft\Graph\Beta\Generated\Me\DeviceEnrollmentConfigurations;
...
*/
class DeviceEnrollmentConfigurationsRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    /**
    ...
    */
     ...
     * @return DeviceEnrollmentConfigurationsRequestBuilderGetQueryParameters
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): DeviceEnrollmentConfigurationsRequestBuilderGetQueryParameters {
        return new DeviceEnrollmentConfigurationsRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
