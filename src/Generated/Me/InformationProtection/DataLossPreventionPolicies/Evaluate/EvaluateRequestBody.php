...
class EvaluateRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'evaluationInput' => function (self $o, ParseNode $n) { $o->setEvaluationInput($n->getObjectValue(DlpEvaluationInput::class)); },
            'notificationInfo' => function (self $o, ParseNode $n) { $o->setNotificationInfo($n->getObjectValue(DlpNotification::class)); },
