...
namespace Microsoft\Graph\Beta\Generated\Me\InformationProtection\Policy\Labels\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/informationProtection/policy/labels/$count{?%24search,%24filter}");
