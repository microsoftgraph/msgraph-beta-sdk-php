...
namespace Microsoft\Graph\Beta\Generated\Me\ReminderViewWithStartDateTimeWithEndDateTime;
...
class ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $endDateTime = null, ?string $startDateTime = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/me/reminderView(StartDateTime=\'{StartDateTime}\',EndDateTime=\'{EndDateTime}\'){?%24top,%24skip,%24search,%24filter,%24count}');
    ...
    */
    public function get(?ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [ReminderViewWithStartDateTimeWithEndDateTimeResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
