...
class WipeManagedAppRegistrationByDeviceTagRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return WipeManagedAppRegistrationByDeviceTagRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): WipeManagedAppRegistrationByDeviceTagRequestBody {
