...
namespace Microsoft\Graph\Beta\Generated\Me\SendMail;
...
class SendMailRequestBuilder 
{
    ...
    */
     ...
     * @param SendMailPostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(SendMailPostRequestBody $body, ?SendMailRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(SendMailPostRequestBody $body, ?SendMailRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
