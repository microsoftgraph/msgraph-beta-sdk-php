...
class ItemPhoneItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $itemPhoneId key: id of itemPhone
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $itemPhoneId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/phones/{itemPhone%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['itemPhoneId'] = $itemPhoneId;
