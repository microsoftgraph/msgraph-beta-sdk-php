...
class WebAccountItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $webAccountId key: id of webAccount
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $webAccountId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/webAccounts/{webAccount%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['webAccountId'] = $webAccountId;
