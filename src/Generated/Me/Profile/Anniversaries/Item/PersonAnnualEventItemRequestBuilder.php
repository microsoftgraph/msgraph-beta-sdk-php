...
class PersonAnnualEventItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $personAnnualEventId key: id of personAnnualEvent
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $personAnnualEventId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/anniversaries/{personAnnualEvent%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['personAnnualEventId'] = $personAnnualEventId;
