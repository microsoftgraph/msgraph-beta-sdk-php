...
class PersonAnnotationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $personAnnotationId key: id of personAnnotation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $personAnnotationId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/notes/{personAnnotation%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['personAnnotationId'] = $personAnnotationId;
