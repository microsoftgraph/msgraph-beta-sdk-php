...
class SkillProficiencyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $skillProficiencyId key: id of skillProficiency
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $skillProficiencyId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/skills/{skillProficiency%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['skillProficiencyId'] = $skillProficiencyId;
