...
class WorkPositionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $workPositionId key: id of workPosition
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $workPositionId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/positions/{workPosition%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['workPositionId'] = $workPositionId;
