...
class LanguageProficiencyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $languageProficiencyId key: id of languageProficiency
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $languageProficiencyId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/languages/{languageProficiency%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['languageProficiencyId'] = $languageProficiencyId;
