...
class ItemAddressItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $itemAddressId key: id of itemAddress
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $itemAddressId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/addresses/{itemAddress%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['itemAddressId'] = $itemAddressId;
