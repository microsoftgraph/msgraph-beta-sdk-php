...
class PersonCertificationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $personCertificationId key: id of personCertification
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $personCertificationId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/certifications/{personCertification%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['personCertificationId'] = $personCertificationId;
