...
class PersonNameItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $personNameId key: id of personName
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $personNameId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/names/{personName%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['personNameId'] = $personNameId;
