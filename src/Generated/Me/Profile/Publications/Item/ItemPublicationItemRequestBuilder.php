...
class ItemPublicationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $itemPublicationId key: id of itemPublication
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $itemPublicationId = null) {
        $this->urlTemplate = '{+baseurl}/me/profile/publications/{itemPublication%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['itemPublicationId'] = $itemPublicationId;
