...
namespace Microsoft\Graph\Beta\Generated\Me\ManagedAppRegistrations\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/managedAppRegistrations/$count{?%24search,%24filter}");
