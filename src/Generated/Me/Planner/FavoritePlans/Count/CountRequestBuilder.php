...
namespace Microsoft\Graph\Beta\Generated\Me\Planner\FavoritePlans\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/planner/favoritePlans/$count{?%24search,%24filter}");
