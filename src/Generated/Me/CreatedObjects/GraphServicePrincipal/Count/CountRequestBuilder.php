...
namespace Microsoft\Graph\Beta\Generated\Me\CreatedObjects\GraphServicePrincipal\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/createdObjects/graph.servicePrincipal/$count{?%24search,%24filter}");
