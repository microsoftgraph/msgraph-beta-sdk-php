...
class MobileAppIntentAndStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $mobileAppIntentAndStateId key: id of mobileAppIntentAndState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $mobileAppIntentAndStateId = null) {
        $this->urlTemplate = '{+baseurl}/me/mobileAppIntentAndStates/{mobileAppIntentAndState%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['mobileAppIntentAndStateId'] = $mobileAppIntentAndStateId;
    ...
    */
     ...
     * @return Promise
    */
    public function get(?MobileAppIntentAndStateItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
