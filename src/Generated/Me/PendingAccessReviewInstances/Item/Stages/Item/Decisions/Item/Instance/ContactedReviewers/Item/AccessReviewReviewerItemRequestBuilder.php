...
class AccessReviewReviewerItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessReviewReviewerId key: id of accessReviewReviewer
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $accessReviewReviewerId = null) {
        ...
        $urlTplParams['accessReviewReviewerId'] = $accessReviewReviewerId;
