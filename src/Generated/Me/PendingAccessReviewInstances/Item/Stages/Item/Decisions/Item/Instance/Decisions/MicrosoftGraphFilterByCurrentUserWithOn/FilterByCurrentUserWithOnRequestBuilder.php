...
namespace Microsoft\Graph\Beta\Generated\Me\PendingAccessReviewInstances\Item\Stages\Item\Decisions\Item\Instance\Decisions\MicrosoftGraphFilterByCurrentUserWithOn;
...
class FilterByCurrentUserWithOnRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $on = null) {
        $this->urlTemplate = '{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/decisions/microsoft.graph.filterByCurrentUser(on=\'{on}\'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}';
