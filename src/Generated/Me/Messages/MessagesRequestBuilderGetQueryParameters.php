...
namespace Microsoft\Graph\Beta\Generated\Me\Messages;
...
class MessagesRequestBuilderGetQueryParameters 
{
    ...
    */
    public function __construct(?bool $count = null, ?array $expand = null, ?string $filter = null, ?string $includeHiddenMessages = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null) {
        $this->count = $count;
        $this->expand = $expand;
        $this->filter = $filter;
