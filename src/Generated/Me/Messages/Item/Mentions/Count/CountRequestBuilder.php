...
namespace Microsoft\Graph\Beta\Generated\Me\Messages\Item\Mentions\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/messages/{message%2Did}/mentions/$count{?%24filter}");
