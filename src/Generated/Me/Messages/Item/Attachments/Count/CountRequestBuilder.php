...
namespace Microsoft\Graph\Beta\Generated\Me\Messages\Item\Attachments\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/messages/{message%2Did}/attachments/$count{?%24filter}");
