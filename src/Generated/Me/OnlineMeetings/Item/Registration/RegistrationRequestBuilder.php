...
class RegistrationRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/me/onlineMeetings/{onlineMeeting_id}/registration{?select,expand}';
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.me.onlineMeetings.item.registration.customQuestions.item collection
