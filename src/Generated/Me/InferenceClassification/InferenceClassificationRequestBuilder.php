...
namespace Microsoft\Graph\Beta\Generated\Me\InferenceClassification;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Me\InferenceClassification\Overrides\Item\InferenceClassificationOverrideItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Me\InferenceClassification\Overrides\OverridesRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\InferenceClassification;
    ...
    */
    public function get(?InferenceClassificationRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(InferenceClassification::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.me.inferenceClassification.overrides.item collection
