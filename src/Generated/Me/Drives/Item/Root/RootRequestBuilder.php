...
class RootRequestBuilder 
{
    ...
    */
     ...
     * @return Promise
    */
    public function delete(?RootRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return Promise
    */
    public function patch(DriveItem $body, ?RootRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toDeleteRequestInformation(?RootRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(DriveItem $body, ?RootRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
