...
namespace Microsoft\Graph\Beta\Generated\Me\Tasks\Alltasks\Item\Move;
...
class MovePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getDestinationTaskListId(): ?string {
        return $this->getBackingStore()->get('destinationTaskListId');
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'destinationTaskListId' => fn(ParseNode $n) => $o->setDestinationTaskListId($n->getStringValue()),
        ];
    }
    ...
    */
    public function setDestinationTaskListId(?string $value): void {
        $this->getBackingStore()->set('destinationTaskListId', $value);
    }
