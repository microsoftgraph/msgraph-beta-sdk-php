...
class WindowsInformationProtectionDeviceRegistrationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $windowsInformationProtectionDeviceRegistrationId key: id of windowsInformationProtectionDeviceRegistration
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsInformationProtectionDeviceRegistrationId = null) {
        ...
        $urlTplParams['windowsInformationProtectionDeviceRegistrationId'] = $windowsInformationProtectionDeviceRegistrationId;
