...
class SingleValueLegacyExtendedPropertyItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder_id}/tasks/{outlookTask_id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty_id}{?select,expand}';
