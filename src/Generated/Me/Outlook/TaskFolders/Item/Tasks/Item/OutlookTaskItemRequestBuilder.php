...
use Microsoft\Graph\Beta\Generated\Me\Outlook\TaskFolders\Item\Tasks\Item\MicrosoftGraphComplete\CompleteRequestBuilder;
...
class OutlookTaskItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphComplete(): CompleteRequestBuilder {
    ...
    */
     ...
     * @param string|null $outlookTaskId key: id of outlookTask
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $outlookTaskId = null) {
        $this->urlTemplate = '{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}{?%24select}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['outlookTaskId'] = $outlookTaskId;
