...
namespace Microsoft\Graph\Beta\Generated\Me\Chats\Item\PermissionGrants;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Me\Chats\Item\PermissionGrants\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Me\Chats\Item\PermissionGrants\GetByIds\GetByIdsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Me\Chats\Item\PermissionGrants\GetUserOwnedObjects\GetUserOwnedObjectsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Me\Chats\Item\PermissionGrants\ValidateProperties\ValidatePropertiesRequestBuilder;
...
class PermissionGrantsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/me/chats/{chat%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}';
    ...
    */
    public function get(?PermissionGrantsRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [ResourceSpecificPermissionGrantCollectionResponse::class, 'createFromDiscriminatorValue'], $responseHandler, $errorMappings);
        } catch(Exception $ex) {
