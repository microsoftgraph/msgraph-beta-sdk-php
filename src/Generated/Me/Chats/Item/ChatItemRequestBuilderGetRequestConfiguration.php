...
namespace Microsoft\Graph\Beta\Generated\Me\Chats\Item;
...
*/
class ChatItemRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ChatItemRequestBuilderGetQueryParameters.
     * @param array<string>|null $expand Expand related entities
     * @param array<string>|null $select Select properties to be returned
     * @return ChatItemRequestBuilderGetQueryParameters
    */
    public static function createQueryParameters(?array $expand = null, ?array $select = null): ChatItemRequestBuilderGetQueryParameters {
        return new ChatItemRequestBuilderGetQueryParameters($expand, $select);
    }
