...
namespace Microsoft\Graph\Beta\Generated\Me\MailFolders\Item\MessageRules\Item;
...
class MessageRuleItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $messageRuleId key: id of messageRule
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $messageRuleId = null) {
        $this->urlTemplate = '{+baseurl}/me/mailFolders/{mailFolder%2Did}/messageRules/{messageRule%2Did}{?%24select}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['messageRuleId'] = $messageRuleId;
