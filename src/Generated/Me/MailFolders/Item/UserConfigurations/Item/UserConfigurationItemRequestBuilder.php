...
class UserConfigurationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userConfigurationId key: id of userConfiguration
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userConfigurationId = null) {
        ...
        $urlTplParams['userConfigurationId'] = $userConfigurationId;
