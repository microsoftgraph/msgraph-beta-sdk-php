...
namespace Microsoft\Graph\Beta\Generated\Me\MailFolders\Item\UserConfigurations\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/me/mailFolders/{mailFolder%2Did}/userConfigurations/$count{?%24filter}");
