...
namespace Microsoft\Graph\Beta\Generated\Me\MailFolders\Item\ChildFolders\Item\Messages\Item\MarkAsJunk;
...
class MarkAsJunkPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MarkAsJunkPostRequestBody {
    ...
    */
    public function getMoveToJunk(): ?bool {
        return $this->getBackingStore()->get('moveToJunk');
    }
