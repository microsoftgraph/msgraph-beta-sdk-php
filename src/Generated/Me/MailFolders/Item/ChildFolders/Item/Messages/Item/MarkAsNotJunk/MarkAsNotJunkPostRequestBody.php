...
class MarkAsNotJunkPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MarkAsNotJunkPostRequestBody {
    ...
    */
    public function getMoveToInbox(): ?bool {
        return $this->getBackingStore()->get('moveToInbox');
    }
