...
class MentionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $mentionId key: id of mention
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $mentionId = null) {
        ...
        $urlTplParams['mentionId'] = $mentionId;
