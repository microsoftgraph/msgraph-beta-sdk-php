...
namespace Microsoft\Graph\Beta\Generated\Me\MailFolders;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Me\MailFolders\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Me\MailFolders\Delta\DeltaRequestBuilder;
    ...
    */
    public function get(?MailFoldersRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(MailFolderCollectionResponse::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
