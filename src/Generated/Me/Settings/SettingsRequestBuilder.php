...
namespace Microsoft\Graph\Beta\Generated\Me\Settings;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Me\Settings\ContactMergeSuggestions\ContactMergeSuggestionsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Me\Settings\ItemInsights\ItemInsightsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Me\Settings\RegionalAndLanguageSettings\RegionalAndLanguageSettingsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Me\Settings\ShiftPreferences\ShiftPreferencesRequestBuilder;
...
class SettingsRequestBuilder 
{
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(UserSettings $body, ?SettingsRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?SettingsRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(UserSettings::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
     ...
     * @return Promise
    */
    public function patch(UserSettings $body, ?SettingsRequestBuilderPatchRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
