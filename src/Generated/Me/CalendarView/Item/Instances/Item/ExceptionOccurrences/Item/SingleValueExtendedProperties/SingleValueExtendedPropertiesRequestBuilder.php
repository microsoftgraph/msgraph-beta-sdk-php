...
namespace Microsoft\Graph\Beta\Generated\Me\CalendarView\Item\Instances\Item\ExceptionOccurrences\Item\SingleValueExtendedProperties;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Me\CalendarView\Item\Instances\Item\ExceptionOccurrences\Item\SingleValueExtendedProperties\Count\CountRequestBuilder;
...
class SingleValueExtendedPropertiesRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/me/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}';
