...
namespace Microsoft\Graph\Beta\Generated\Me\MicrosoftGraphInvalidateAllRefreshTokens;
...
class MicrosoftGraphInvalidateAllRefreshTokensRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/me/microsoft.graph.invalidateAllRefreshTokens';
     ...
     * @param MicrosoftGraphInvalidateAllRefreshTokensRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/user-invalidateallrefreshtokens?view=graph-rest-1.0 Find more info here
    */
    public function post(?MicrosoftGraphInvalidateAllRefreshTokensRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?MicrosoftGraphInvalidateAllRefreshTokensRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
