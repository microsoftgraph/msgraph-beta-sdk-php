...
class DirectorySettingTemplateItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/directorySettingTemplates/{directorySettingTemplate%2Did}');
    ...
    */
    public function toGetRequestInformation(?DirectorySettingTemplateItemRequestBuilderGetRequestCon_54c7bcc8 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/directorySettingTemplates/{directorySettingTemplate%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
