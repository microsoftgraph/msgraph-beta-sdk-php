...
class PrivilegedOperationEventItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedOperationEventId key: id of privilegedOperationEvent
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $privilegedOperationEventId = null) {
        $this->urlTemplate = '{+baseurl}/privilegedOperationEvents/{privilegedOperationEvent%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['privilegedOperationEventId'] = $privilegedOperationEventId;
