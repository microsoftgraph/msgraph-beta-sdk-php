...
class PrivilegedOperationEventItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/privilegedOperationEvents/{privilegedOperationEvent%2Did}');
    ...
    */
    public function toGetRequestInformation(?PrivilegedOperationEventItemRequestBuilderGetRequestCon_7f60de01 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/privilegedOperationEvents/{privilegedOperationEvent%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
