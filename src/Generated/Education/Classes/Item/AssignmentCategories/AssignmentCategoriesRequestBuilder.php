...
namespace Microsoft\Graph\Beta\Generated\Education\Classes\Item\AssignmentCategories;
...
class AssignmentCategoriesRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?AssignmentCategoriesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(EducationCategory $body, ?AssignmentCategoriesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
     ...
     * @return Promise
    */
    public function get(?AssignmentCategoriesRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
     ...
     * @return Promise
    */
    public function post(EducationCategory $body, ?AssignmentCategoriesRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
