...
namespace Microsoft\Graph\Beta\Generated\Education\Classes\Item\AssignmentSettings\GradingCategories\Item;

use Microsoft\Kiota\Abstractions\BaseRequestConfiguration;
use Microsoft\Kiota\Abstractions\RequestOption;

/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: EducationGradingCategoryItemRequestBuilderGetRequestConfiguration
*/
class EducationGradingCategoryItemRequestBuilderGetRequestCon_def654be extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EducationGradingCategoryItemRequestBuilderGetRequestCon_def654be and sets the default values.
