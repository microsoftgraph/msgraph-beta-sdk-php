...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: EducationSubmissionResourceItemRequestBuilderGetRequestConfiguration
*/
class EducationSubmissionResourceItemRequestBuilderGetRequest_9a05f9a7 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EducationSubmissionResourceItemRequestBuilderGetRequest_9a05f9a7 and sets the default values.
