...
class EducationSynchronizationErrorItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $educationSynchronizationErrorId key: id of educationSynchronizationError
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $educationSynchronizationErrorId = null) {
        ...
        $urlTplParams['educationSynchronizationErrorId'] = $educationSynchronizationErrorId;
