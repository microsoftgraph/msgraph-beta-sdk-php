...
class EducationSynchronizationProfileItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $educationSynchronizationProfileId = null) {
        ...
        $urlTplParams['educationSynchronizationProfileId'] = $educationSynchronizationProfileId;
