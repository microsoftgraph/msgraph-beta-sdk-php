...
namespace Microsoft\Graph\Beta\Generated\Education\Me\Assignments\Item\Submissions\Item\MicrosoftGraphSetUpResourcesFolder;
...
class MicrosoftGraphSetUpResourcesFolderRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphSetUpResourcesFolderRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/educationsubmission-setupresourcesfolder?view=graph-rest-1.0 Find more info here
    */
    public function post(?MicrosoftGraphSetUpResourcesFolderRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?MicrosoftGraphSetUpResourcesFolderRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
