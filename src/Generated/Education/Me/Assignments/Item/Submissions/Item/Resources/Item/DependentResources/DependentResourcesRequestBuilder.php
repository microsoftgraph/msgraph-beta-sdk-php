...
namespace Microsoft\Graph\Beta\Generated\Education\Me\Assignments\Item\Submissions\Item\Resources\Item\DependentResources;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Education\Me\Assignments\Item\Submissions\Item\Resources\Item\DependentResources\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Education\Me\Assignments\Item\Submissions\Item\Resources\Item\DependentResources\Item\EducationSubmissionResourceItemRequestBuilder;
...
class DependentResourcesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/education/me/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/resources/{educationSubmissionResource%2Did}/dependentResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function toPostRequestInformation(EducationSubmissionResource $body, ?DependentResourcesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/education/me/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/resources/{educationSubmissionResource%2Did}/dependentResources';
        $requestInfo->pathParameters = $this->pathParameters;
