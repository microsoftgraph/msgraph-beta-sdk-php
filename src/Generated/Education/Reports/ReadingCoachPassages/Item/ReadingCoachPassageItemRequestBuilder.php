...
namespace Microsoft\Graph\Beta\Generated\Education\Reports\ReadingCoachPassages\Item;
...
class ReadingCoachPassageItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/education/reports/readingCoachPassages/{readingCoachPassage%2Did}');
    ...
    */
    public function toGetRequestInformation(?ReadingCoachPassageItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/education/reports/readingCoachPassages/{readingCoachPassage%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
