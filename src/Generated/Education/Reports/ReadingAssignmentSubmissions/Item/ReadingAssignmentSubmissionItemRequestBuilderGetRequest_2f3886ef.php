...
namespace Microsoft\Graph\Beta\Generated\Education\Reports\ReadingAssignmentSubmissions\Item;

use Microsoft\Kiota\Abstractions\BaseRequestConfiguration;
use Microsoft\Kiota\Abstractions\RequestOption;

/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ReadingAssignmentSubmissionItemRequestBuilderGetRequestConfiguration
*/
class ReadingAssignmentSubmissionItemRequestBuilderGetRequest_2f3886ef extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ReadingAssignmentSubmissionItemRequestBuilderGetRequest_2f3886ef and sets the default values.
