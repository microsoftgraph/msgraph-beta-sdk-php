...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: SpeakerAssignmentSubmissionItemRequestBuilderGetRequestConfiguration
*/
class SpeakerAssignmentSubmissionItemRequestBuilderGetRequest_d45cb119 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SpeakerAssignmentSubmissionItemRequestBuilderGetRequest_d45cb119 and sets the default values.
