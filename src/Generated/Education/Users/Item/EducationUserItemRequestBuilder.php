...
class EducationUserItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/educationuser-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/educationuser-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<EducationUser|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/relatedcontact-update?view=graph-rest-beta Find more info here
    */
