...
namespace Microsoft\Graph\Beta\Generated\Education\Users\Item\Assignments\Delta;
...
class DeltaResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EducationAssignment>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(EducationAssignment::class)); },
        ];
    }
