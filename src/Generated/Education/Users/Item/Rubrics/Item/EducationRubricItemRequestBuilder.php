...
class EducationRubricItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $educationRubricId key: id of educationRubric
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $educationRubricId = null) {
        ...
        $urlTplParams['educationRubricId'] = $educationRubricId;
