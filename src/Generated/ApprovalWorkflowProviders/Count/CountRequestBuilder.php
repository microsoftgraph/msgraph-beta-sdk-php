...
namespace Microsoft\Graph\Beta\Generated\ApprovalWorkflowProviders\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/approvalWorkflowProviders/$count{?%24search,%24filter}");
