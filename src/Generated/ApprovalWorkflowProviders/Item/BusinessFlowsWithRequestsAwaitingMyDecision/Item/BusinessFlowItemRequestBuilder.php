...
class BusinessFlowItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider_id}/businessFlowsWithRequestsAwaitingMyDecision/{businessFlow_id}{?select,expand}';
