...
class ApprovalWorkflowProviderItemRequestBuilder 
{
    ...
    */
    public function businessFlowsById(string $id): \Microsoft\Graph\Beta\Generated\ApprovalWorkflowProviders\Item\BusinessFlows\Item\BusinessFlowItemRequestBuilder {
        ...
        return new \Microsoft\Graph\Beta\Generated\ApprovalWorkflowProviders\Item\BusinessFlows\Item\BusinessFlowItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function businessFlowsWithRequestsAwaitingMyDecisionById(string $id): \Microsoft\Graph\Beta\Generated\ApprovalWorkflowProviders\Item\BusinessFlowsWithRequestsAwaitingMyDecision\Item\BusinessFlowItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['businessFlow%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\ApprovalWorkflowProviders\Item\BusinessFlowsWithRequestsAwaitingMyDecision\Item\BusinessFlowItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $approvalWorkflowProviderId key: id of approvalWorkflowProvider
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $approvalWorkflowProviderId = null) {
    ...
    */
    public function policyTemplatesById(string $id): GovernancePolicyTemplateItemRequestBuilder {
        ...
        return new GovernancePolicyTemplateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
