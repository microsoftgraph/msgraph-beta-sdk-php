...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: GovernancePolicyTemplateItemRequestBuilderGetRequestConfiguration
*/
class GovernancePolicyTemplateItemRequestBuilderGetRequestCon_84774ca6 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GovernancePolicyTemplateItemRequestBuilderGetRequestCon_84774ca6 and sets the default values.
