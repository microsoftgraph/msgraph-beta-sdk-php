...
class GovernancePolicyTemplateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $governancePolicyTemplateId key: id of governancePolicyTemplate
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $governancePolicyTemplateId = null) {
        ...
        $urlTplParams['governancePolicyTemplateId'] = $governancePolicyTemplateId;
