...
use Microsoft\Graph\Beta\Generated\ApprovalWorkflowProviders\Item\BusinessFlows\Item\MicrosoftGraphRecordDecisions\RecordDecisionsRequestBuilder;
...
class BusinessFlowItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphRecordDecisions(): RecordDecisionsRequestBuilder {
    ...
    */
     ...
     * @param string|null $businessFlowId key: id of businessFlow
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $businessFlowId = null) {
        ...
        $urlTplParams['businessFlowId'] = $businessFlowId;
