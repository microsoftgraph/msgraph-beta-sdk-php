...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ApprovalWorkflowProviderItemRequestBuilderGetRequestConfiguration
*/
class ApprovalWorkflowProviderItemRequestBuilderGetRequestCon_9d1ef552 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ApprovalWorkflowProviderItemRequestBuilderGetRequestCon_9d1ef552 and sets the default values.
