...
class TrustFrameworkPolicyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $trustFrameworkPolicyId key: id of trustFrameworkPolicy
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $trustFrameworkPolicyId = null) {
        $this->urlTemplate = '{+baseurl}/trustFramework/policies/{trustFrameworkPolicy%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['trustFrameworkPolicyId'] = $trustFrameworkPolicyId;
