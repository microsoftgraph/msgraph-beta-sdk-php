...
class TrustFrameworkPolicyItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/trustFramework/policies/{trustFrameworkPolicy%2Did}{?%24select,%24expand}');
     ...
     * @return Promise
     * @link https://learn.microsoft.com/graph/api/trustframeworkpolicy-delete?view=graph-rest-1.0 Find more info here
    */
