...
class ContentRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/trustFramework/policies/{trustFrameworkPolicy%2Did}/$value{?%24format*}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/trustframework-list-trustframeworkpolicies?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function toPutRequestInformation(StreamInterface $body, ?ContentRequestBuilderPutRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/trustFramework/policies/{trustFrameworkPolicy%2Did}/$value';
        $requestInfo->pathParameters = $this->pathParameters;
