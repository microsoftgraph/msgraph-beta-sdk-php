...
class GenerateKeyRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GenerateKeyRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GenerateKeyRequestBody {
