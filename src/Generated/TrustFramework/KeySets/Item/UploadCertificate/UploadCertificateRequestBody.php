...
class UploadCertificateRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UploadCertificateRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UploadCertificateRequestBody {
