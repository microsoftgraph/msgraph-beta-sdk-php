...
namespace Microsoft\Graph\Beta\Generated\Workbooks\Item\Preview;
...
class PreviewRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'allowEdit' => function (self $o, ParseNode $n) { $o->setAllowEdit($n->getBooleanValue()); },
            'chromeless' => function (self $o, ParseNode $n) { $o->setChromeless($n->getBooleanValue()); },
            'page' => function (self $o, ParseNode $n) { $o->setPage($n->getStringValue()); },
            'viewer' => function (self $o, ParseNode $n) { $o->setViewer($n->getStringValue()); },
