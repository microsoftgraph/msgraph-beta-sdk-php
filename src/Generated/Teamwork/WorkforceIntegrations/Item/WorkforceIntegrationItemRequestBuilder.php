...
class WorkforceIntegrationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $workforceIntegrationId key: id of workforceIntegration
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $workforceIntegrationId = null) {
        $this->urlTemplate = '{+baseurl}/teamwork/workforceIntegrations/{workforceIntegration%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['workforceIntegrationId'] = $workforceIntegrationId;
