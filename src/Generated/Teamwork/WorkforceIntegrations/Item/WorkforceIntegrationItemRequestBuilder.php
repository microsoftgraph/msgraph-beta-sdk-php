...
class WorkforceIntegrationItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teamwork/workforceIntegrations/{workforceIntegration%2Did}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/workforceintegration-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/workforceintegration-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<WorkforceIntegration|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/workforceintegration-update?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?WorkforceIntegrationItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/teamwork/workforceIntegrations/{workforceIntegration%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
