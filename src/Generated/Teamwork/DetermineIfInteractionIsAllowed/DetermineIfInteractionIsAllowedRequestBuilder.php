...
*/
class DetermineIfInteractionIsAllowedRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new DetermineIfInteractionIsAllowedRequestBuilder and sets the default values.
     * @param array<string, mixed>|string $pathParametersOrRawUrl Path parameters for the request or a String representing the raw URL.
     * @param RequestAdapter $requestAdapter The request adapter to use to execute the requests.
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teamwork/determineIfInteractionIsAllowed');
    ...
    */
    public function post(DetermineIfInteractionIsAllowedPostRequestBody $body, ?DetermineIfInteractionIsAllowedRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DetermineIfInteractionIsAllowedPostResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
     ...
     * @return DetermineIfInteractionIsAllowedRequestBuilder
    */
    public function withUrl(string $rawUrl): DetermineIfInteractionIsAllowedRequestBuilder {
        return new DetermineIfInteractionIsAllowedRequestBuilder($rawUrl, $this->requestAdapter);
    }
