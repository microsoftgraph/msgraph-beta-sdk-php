...
use Microsoft\Graph\Beta\Generated\Teamwork\MicrosoftGraphSendActivityNotificationToRecipients\MicrosoftGraphSendActivityNotificationToRecipientsRequestBuilder;
...
class TeamworkRequestBuilder 
{
    ...
    */
    public function deletedTeamsById(string $id): DeletedTeamItemRequestBuilder {
        ...
        return new DeletedTeamItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function devicesById(string $id): TeamworkDeviceItemRequestBuilder {
        ...
        return new TeamworkDeviceItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function teamTemplatesById(string $id): TeamTemplateItemRequestBuilder {
        ...
        return new TeamTemplateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
