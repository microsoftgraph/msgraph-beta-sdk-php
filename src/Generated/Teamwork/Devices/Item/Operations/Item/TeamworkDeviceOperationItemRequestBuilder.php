...
class TeamworkDeviceOperationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $teamworkDeviceOperationId key: id of teamworkDeviceOperation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $teamworkDeviceOperationId = null) {
        ...
        $urlTplParams['teamworkDeviceOperationId'] = $teamworkDeviceOperationId;
