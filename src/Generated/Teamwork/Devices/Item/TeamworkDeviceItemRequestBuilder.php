...
use Microsoft\Graph\Beta\Generated\Teamwork\Devices\Item\MicrosoftGraphRestart\MicrosoftGraphRestartRequestBuilder;
use Microsoft\Graph\Beta\Generated\Teamwork\Devices\Item\MicrosoftGraphRunDiagnostics\MicrosoftGraphRunDiagnosticsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Teamwork\Devices\Item\MicrosoftGraphUpdateSoftware\MicrosoftGraphUpdateSoftwareRequestBuilder;
...
class TeamworkDeviceItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphRunDiagnostics(): MicrosoftGraphRunDiagnosticsRequestBuilder {
        return new MicrosoftGraphRunDiagnosticsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the updateSoftware method.
    */
    public function microsoftGraphUpdateSoftware(): MicrosoftGraphUpdateSoftwareRequestBuilder {
        return new MicrosoftGraphUpdateSoftwareRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function operationsById(string $id): TeamworkDeviceOperationItemRequestBuilder {
        ...
        return new TeamworkDeviceOperationItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
