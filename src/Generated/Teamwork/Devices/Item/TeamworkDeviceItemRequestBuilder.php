...
class TeamworkDeviceItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $teamworkDeviceId = null) {
        $this->urlTemplate = '{+baseurl}/teamwork/devices/{teamworkDevice%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['teamworkDeviceId'] = $teamworkDeviceId;
