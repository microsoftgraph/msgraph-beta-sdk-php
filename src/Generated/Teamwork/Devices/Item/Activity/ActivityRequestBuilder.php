...
class ActivityRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teamwork/devices/{teamworkDevice%2Did}/activity');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/teamworkdeviceactivity-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?ActivityRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/teamwork/devices/{teamworkDevice%2Did}/activity{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
