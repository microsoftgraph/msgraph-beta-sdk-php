...
*/
class UpdateSoftwareRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teamwork/devices/{teamworkDevice%2Did}/updateSoftware');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/teamworkdevice-updatesoftware?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @return UpdateSoftwareRequestBuilder
    */
    public function withUrl(string $rawUrl): UpdateSoftwareRequestBuilder {
        return new UpdateSoftwareRequestBuilder($rawUrl, $this->requestAdapter);
    }
