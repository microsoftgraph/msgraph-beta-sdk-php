...
class UpdateSoftwareRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UpdateSoftwareRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UpdateSoftwareRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'softwareType' => function (self $o, ParseNode $n) { $o->setSoftwareType($n->getEnumValue(TeamworkSoftwareType::class)); },
            'softwareVersion' => function (self $o, ParseNode $n) { $o->setSoftwareVersion($n->getStringValue()); },
        ];
    }
