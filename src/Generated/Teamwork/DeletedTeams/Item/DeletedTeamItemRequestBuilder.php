...
class DeletedTeamItemRequestBuilder 
{
    ...
    */
    public function channelsById(string $id): ChannelItemRequestBuilder {
        ...
        return new ChannelItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $deletedTeamId key: id of deletedTeam
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deletedTeamId = null) {
