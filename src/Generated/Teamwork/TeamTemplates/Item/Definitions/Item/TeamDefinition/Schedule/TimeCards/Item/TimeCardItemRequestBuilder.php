...
namespace Microsoft\Graph\Beta\Generated\Teamwork\TeamTemplates\Item\Definitions\Item\TeamDefinition\Schedule\TimeCards\Item;
...
use Microsoft\Graph\Beta\Generated\Teamwork\TeamTemplates\Item\Definitions\Item\TeamDefinition\Schedule\TimeCards\Item\MicrosoftGraphClockOut\MicrosoftGraphClockOutRequestBuilder;
use Microsoft\Graph\Beta\Generated\Teamwork\TeamTemplates\Item\Definitions\Item\TeamDefinition\Schedule\TimeCards\Item\MicrosoftGraphConfirm\MicrosoftGraphConfirmRequestBuilder;
use Microsoft\Graph\Beta\Generated\Teamwork\TeamTemplates\Item\Definitions\Item\TeamDefinition\Schedule\TimeCards\Item\MicrosoftGraphEndBreak\MicrosoftGraphEndBreakRequestBuilder;
use Microsoft\Graph\Beta\Generated\Teamwork\TeamTemplates\Item\Definitions\Item\TeamDefinition\Schedule\TimeCards\Item\MicrosoftGraphStartBreak\MicrosoftGraphStartBreakRequestBuilder;
...
class TimeCardItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphClockOut(): MicrosoftGraphClockOutRequestBuilder {
        return new MicrosoftGraphClockOutRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the confirm method.
    */
    public function microsoftGraphConfirm(): MicrosoftGraphConfirmRequestBuilder {
        return new MicrosoftGraphConfirmRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the endBreak method.
    */
    public function microsoftGraphEndBreak(): MicrosoftGraphEndBreakRequestBuilder {
        return new MicrosoftGraphEndBreakRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the startBreak method.
    */
    public function microsoftGraphStartBreak(): MicrosoftGraphStartBreakRequestBuilder {
        return new MicrosoftGraphStartBreakRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}{?%24select,%24expand}';
