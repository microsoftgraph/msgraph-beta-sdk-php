...
use Microsoft\Graph\Beta\Generated\Teamwork\TeamTemplates\Item\Definitions\Item\TeamDefinition\PrimaryChannel\DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalName\DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder;
...
class PrimaryChannelRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.teamwork.teamTemplates.item.definitions.item.teamDefinition.primaryChannel.members.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.teamwork.teamTemplates.item.definitions.item.teamDefinition.primaryChannel.messages.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.teamwork.teamTemplates.item.definitions.item.teamDefinition.primaryChannel.sharedWithTeams.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.teamwork.teamTemplates.item.definitions.item.teamDefinition.primaryChannel.tabs.item collection
     * @param string $id Unique identifier of the item
