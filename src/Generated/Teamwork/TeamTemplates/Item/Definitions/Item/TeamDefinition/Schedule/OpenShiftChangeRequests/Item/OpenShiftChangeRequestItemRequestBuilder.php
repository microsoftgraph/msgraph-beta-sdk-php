...
class OpenShiftChangeRequestItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $openShiftChangeRequestId key: id of openShiftChangeRequest
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $openShiftChangeRequestId = null) {
        ...
        $urlTplParams['openShiftChangeRequestId'] = $openShiftChangeRequestId;
