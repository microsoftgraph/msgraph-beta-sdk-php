...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ChatMessageHostedContentItemRequestBuilderGetRequestConfiguration
*/
class ChatMessageHostedContentItemRequestBuilderGetRequestCon_96800328 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ChatMessageHostedContentItemRequestBuilderGetRequestCon_96800328 and sets the default values.
