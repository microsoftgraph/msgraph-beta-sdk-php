...
namespace Microsoft\\Graph\\Beta\\Generated\Teamwork\TeamTemplates\Item\Definitions\Item\TeamDefinition\Channels\Item\Messages\ReplyWithQuote;
...
*/
class ReplyWithQuoteRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/messages/replyWithQuote');
    ...
    */
    public function toPostRequestInformation(ReplyWithQuotePostRequestBody $body, ?ReplyWithQuoteRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return ReplyWithQuoteRequestBuilder
    */
    public function withUrl(string $rawUrl): ReplyWithQuoteRequestBuilder {
        return new ReplyWithQuoteRequestBuilder($rawUrl, $this->requestAdapter);
    }
