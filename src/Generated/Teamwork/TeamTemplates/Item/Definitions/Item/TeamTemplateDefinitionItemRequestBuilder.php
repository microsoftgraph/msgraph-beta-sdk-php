...
class TeamTemplateDefinitionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $teamTemplateDefinitionId key: id of teamTemplateDefinition
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $teamTemplateDefinitionId = null) {
        ...
        $urlTplParams['teamTemplateDefinitionId'] = $teamTemplateDefinitionId;
