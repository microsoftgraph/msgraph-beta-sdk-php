...
class ProgramControlItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $programControlId1 key: id of programControl
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $programControlId1 = null) {
        ...
        $urlTplParams['programControlId1'] = $programControlId1;
