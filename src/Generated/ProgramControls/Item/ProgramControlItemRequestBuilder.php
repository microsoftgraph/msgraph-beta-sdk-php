...
class ProgramControlItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $programControlId key: id of programControl
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $programControlId = null) {
        $this->urlTemplate = '{+baseurl}/programControls/{programControl%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['programControlId'] = $programControlId;
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/programcontrol-delete?view=graph-rest-1.0 Find more info here
    */
