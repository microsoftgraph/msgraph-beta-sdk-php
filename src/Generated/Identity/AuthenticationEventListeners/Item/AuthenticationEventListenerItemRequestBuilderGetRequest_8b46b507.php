...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: AuthenticationEventListenerItemRequestBuilderGetRequestConfiguration
*/
class AuthenticationEventListenerItemRequestBuilderGetRequest_8b46b507 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AuthenticationEventListenerItemRequestBuilderGetRequest_8b46b507 and sets the default values.
