...
class AuthenticationEventListenerItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $authenticationEventListenerId key: id of authenticationEventListener
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $authenticationEventListenerId = null) {
        ...
        $urlTplParams['authenticationEventListenerId'] = $authenticationEventListenerId;
