...
class B2cIdentityUserFlowItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $b2cIdentityUserFlowId key: id of b2cIdentityUserFlow
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $b2cIdentityUserFlowId = null) {
        $this->urlTemplate = '{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['b2cIdentityUserFlowId'] = $b2cIdentityUserFlowId;
