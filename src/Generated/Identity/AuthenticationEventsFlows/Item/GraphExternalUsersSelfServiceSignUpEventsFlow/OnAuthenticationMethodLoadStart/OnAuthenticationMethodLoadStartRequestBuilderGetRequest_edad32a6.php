...
namespace Microsoft\Graph\Beta\Generated\Identity\AuthenticationEventsFlows\Item\GraphExternalUsersSelfServiceSignUpEventsFlow\OnAuthenticationMethodLoadStart;

use Microsoft\Kiota\Abstractions\BaseRequestConfiguration;
use Microsoft\Kiota\Abstractions\RequestOption;

/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: onAuthenticationMethodLoadStartRequestBuilderGetRequestConfiguration
*/
class OnAuthenticationMethodLoadStartRequestBuilderGetRequest_edad32a6 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OnAuthenticationMethodLoadStartRequestBuilderGetRequest_edad32a6 and sets the default values.
