...
class ContinuousAccessEvaluationPolicyRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identity/continuousAccessEvaluationPolicy{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?ContinuousAccessEvaluationPolicyRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/identity/continuousAccessEvaluationPolicy';
