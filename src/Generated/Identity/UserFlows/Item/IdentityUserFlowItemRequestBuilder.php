...
class IdentityUserFlowItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $identityUserFlowId key: id of identityUserFlow
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $identityUserFlowId = null) {
        $this->urlTemplate = '{+baseurl}/identity/userFlows/{identityUserFlow%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['identityUserFlowId'] = $identityUserFlowId;
