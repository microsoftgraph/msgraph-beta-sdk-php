...
namespace Microsoft\Graph\Beta\Generated\Identity\VerifiedId\Profiles;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Identity\VerifiedId\Profiles\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Identity\VerifiedId\Profiles\Item\VerifiedIdProfileItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\VerifiedIdProfile;
use Microsoft\Graph\Beta\Generated\Models\VerifiedIdProfileCollectionResponse;
...
class ProfilesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/identityverifiedidroot-list-profiles?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/identityverifiedidroot-post-profiles?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?ProfilesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/identity/verifiedId/profiles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(VerifiedIdProfile $body, ?ProfilesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identity/verifiedId/profiles';
        $requestInfo->pathParameters = $this->pathParameters;
