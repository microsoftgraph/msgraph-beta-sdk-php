...
namespace Microsoft\Graph\Beta\Generated\Identity\B2xUserFlows\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/identity/b2xUserFlows/$count{?%24search,%24filter}");
