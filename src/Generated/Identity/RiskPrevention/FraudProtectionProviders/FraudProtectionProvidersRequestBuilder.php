...
use Microsoft\Graph\Beta\Generated\Identity\RiskPrevention\FraudProtectionProviders\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Identity\RiskPrevention\FraudProtectionProviders\Item\FraudProtectionProviderItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\FraudProtectionProvider;
use Microsoft\Graph\Beta\Generated\Models\FraudProtectionProviderCollectionResponse;
...
class FraudProtectionProvidersRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/riskpreventioncontainer-post-fraudprotectionproviders?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?FraudProtectionProvidersRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/identity/riskPrevention/fraudProtectionProviders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(FraudProtectionProvider $body, ?FraudProtectionProvidersRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identity/riskPrevention/fraudProtectionProviders';
        $requestInfo->pathParameters = $this->pathParameters;
