...
class AuthenticationStrengthPolicyItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $authenticationStrengthPolicyId = null) {
        ...
        $urlTplParams['authenticationStrengthPolicyId'] = $authenticationStrengthPolicyId;
