...
class AuthenticationMethodModeDetailItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $authenticationMethodModeDetailId key: id of authenticationMethodModeDetail
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $authenticationMethodModeDetailId = null) {
        $this->urlTemplate = '{+baseurl}/identity/conditionalAccess/authenticationStrength/authenticationMethodModes/{authenticationMethodModeDetail%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['authenticationMethodModeDetailId'] = $authenticationMethodModeDetailId;
