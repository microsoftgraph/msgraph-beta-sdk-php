...
class NamedLocationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $namedLocationId key: id of namedLocation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $namedLocationId = null) {
        $this->urlTemplate = '{+baseurl}/identity/conditionalAccess/namedLocations/{namedLocation%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['namedLocationId'] = $namedLocationId;
