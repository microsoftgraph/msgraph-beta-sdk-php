...
class ConditionalAccessPolicyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $conditionalAccessPolicyId key: id of conditionalAccessPolicy
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $conditionalAccessPolicyId = null) {
        ...
        $urlTplParams['conditionalAccessPolicyId'] = $conditionalAccessPolicyId;
