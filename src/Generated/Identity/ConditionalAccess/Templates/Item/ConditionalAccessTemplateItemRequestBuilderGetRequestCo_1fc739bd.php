...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ConditionalAccessTemplateItemRequestBuilderGetRequestConfiguration
*/
class ConditionalAccessTemplateItemRequestBuilderGetRequestCo_1fc739bd extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ConditionalAccessTemplateItemRequestBuilderGetRequestCo_1fc739bd and sets the default values.
