...
use Microsoft\Graph\Beta\Generated\Identity\ConditionalAccess\DeletedItems\Policies\Item\Restore\RestoreRequestBuilder;
...
class ConditionalAccessPolicyItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identity/conditionalAccess/deletedItems/policies/{conditionalAccessPolicy%2Did}');
    ...
    */
    public function toGetRequestInformation(?ConditionalAccessPolicyItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identity/conditionalAccess/deletedItems/policies/{conditionalAccessPolicy%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
