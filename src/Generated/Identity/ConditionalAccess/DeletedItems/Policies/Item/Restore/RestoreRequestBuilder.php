...
namespace Microsoft\Graph\Beta\Generated\Identity\ConditionalAccess\DeletedItems\Policies\Item\Restore;
...
class RestoreRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identity/conditionalAccess/deletedItems/policies/{conditionalAccessPolicy%2Did}/restore');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/conditionalaccesspolicy-restore?view=graph-rest-beta Find more info here
    */
