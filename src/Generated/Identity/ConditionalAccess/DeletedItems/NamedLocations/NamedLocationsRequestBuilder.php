...
namespace Microsoft\Graph\Beta\Generated\Identity\ConditionalAccess\DeletedItems\NamedLocations;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Identity\ConditionalAccess\DeletedItems\NamedLocations\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Identity\ConditionalAccess\DeletedItems\NamedLocations\Item\NamedLocationItemRequestBuilder;
...
class NamedLocationsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?NamedLocationsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/identity/conditionalAccess/deletedItems/namedLocations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(NamedLocation $body, ?NamedLocationsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identity/conditionalAccess/deletedItems/namedLocations';
        $requestInfo->pathParameters = $this->pathParameters;
