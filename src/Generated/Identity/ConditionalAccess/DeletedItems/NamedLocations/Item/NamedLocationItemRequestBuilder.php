...
namespace Microsoft\Graph\Beta\Generated\Identity\ConditionalAccess\DeletedItems\NamedLocations\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Identity\ConditionalAccess\DeletedItems\NamedLocations\Item\Restore\RestoreRequestBuilder;
...
class NamedLocationItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identity/conditionalAccess/deletedItems/namedLocations/{namedLocation%2Did}');
    ...
    */
    public function toGetRequestInformation(?NamedLocationItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identity/conditionalAccess/deletedItems/namedLocations/{namedLocation%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
