...
use Microsoft\Graph\Beta\Generated\Places\Item\GraphRoomList\Workspaces\Item\CheckIns\CheckInsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Places\Item\GraphRoomList\Workspaces\Item\Children\ChildrenRequestBuilder;
...
class WorkspaceItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/places/{place%2Did}/graph.roomList/workspaces/{workspace%2Did}');
    ...
    */
    public function toGetRequestInformation(?WorkspaceItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/places/{place%2Did}/graph.roomList/workspaces/{workspace%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
