...
namespace Microsoft\Graph\Beta\Generated\Places\Item\GraphRoom\CheckIns;
...
use Microsoft\Graph\Beta\Generated\Places\Item\GraphRoom\CheckIns\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Places\Item\GraphRoom\CheckIns\Item\CheckInClaimCalendarEventItemRequestBuilder;
...
class CheckInsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?CheckInsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/places/{place%2Did}/graph.room/checkIns{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(CheckInClaim $body, ?CheckInsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/places/{place%2Did}/graph.room/checkIns';
        $requestInfo->pathParameters = $this->pathParameters;
