...
class FixtureMapItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/fixturemap-delete?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @return Promise<FixtureMap|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/fixturemap-update?view=graph-rest-beta Find more info here
    */
