...
class LevelsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/buildingmap-list-levels?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?LevelsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/places/{place%2Did}/graph.building/map/levels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(LevelMap $body, ?LevelsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/places/{place%2Did}/graph.building/map/levels';
        $requestInfo->pathParameters = $this->pathParameters;
