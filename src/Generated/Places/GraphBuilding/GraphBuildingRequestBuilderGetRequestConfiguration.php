...
namespace Microsoft\Graph\Beta\Generated\Places\GraphBuilding;
...
class GraphBuildingRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): GraphBuildingRequestBuilderGetQueryParameters {
        return new GraphBuildingRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
