...
class PlacesRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * Instantiates a new placesRequestBuilderGetQueryParameters.
     ...
     * @return PlacesRequestBuilderGetQueryParameters
    */
    public static function addQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): PlacesRequestBuilderGetQueryParameters {
        return new PlacesRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
