...
class BookingCurrencyItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $bookingCurrencyId = null) {
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/bookingcurrency-get?view=graph-rest-1.0 Find more info here
    */
