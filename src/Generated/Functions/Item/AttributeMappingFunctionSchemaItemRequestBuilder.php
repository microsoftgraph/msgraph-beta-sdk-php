...
class AttributeMappingFunctionSchemaItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $attributeMappingFunctionSchemaId key: id of attributeMappingFunctionSchema
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $attributeMappingFunctionSchemaId = null) {
        $this->urlTemplate = '{+baseurl}/functions/{attributeMappingFunctionSchema%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['attributeMappingFunctionSchemaId'] = $attributeMappingFunctionSchemaId;
