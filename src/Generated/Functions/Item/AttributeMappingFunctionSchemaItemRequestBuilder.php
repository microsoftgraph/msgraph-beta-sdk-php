...
class AttributeMappingFunctionSchemaItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/functions/{attributeMappingFunctionSchema%2Did}');
    ...
    */
    public function toGetRequestInformation(?AttributeMappingFunctionSchemaItemRequestBuilderGetRequ_deb8d23a $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/functions/{attributeMappingFunctionSchema%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
