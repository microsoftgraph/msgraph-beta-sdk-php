...
namespace Microsoft\Graph\Beta\Generated\IdentityGovernance\RoleManagementAlerts\Operations\Item;
...
class LongRunningOperationItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityGovernance/roleManagementAlerts/operations/{longRunningOperation%2Did}');
    ...
    */
    public function toGetRequestInformation(?LongRunningOperationItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/roleManagementAlerts/operations/{longRunningOperation%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
