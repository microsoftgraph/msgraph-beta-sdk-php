...
namespace Microsoft\Graph\Beta\Generated\IdentityGovernance\RoleManagementAlerts\Alerts;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\IdentityGovernance\RoleManagementAlerts\Alerts\Count\CountRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\IdentityGovernance\RoleManagementAlerts\Alerts\Refresh\RefreshRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\UnifiedRoleManagementAlert;
use Microsoft\Graph\Beta\Generated\Models\UnifiedRoleManagementAlertCollectionResponse;
...
class AlertsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the alerts property of the microsoft.graph.roleManagementAlert entity.
     * @param string $unifiedRoleManagementAlertId The unique identifier of unifiedRoleManagementAlert
     * @return UnifiedRoleManagementAlertItemRequestBuilder
    */
    public function byUnifiedRoleManagementAlertId(string $unifiedRoleManagementAlertId): UnifiedRoleManagementAlertItemRequestBuilder {
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityGovernance/roleManagementAlerts/alerts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<UnifiedRoleManagementAlertCollectionResponse|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/rolemanagementalert-list-alerts?view=graph-rest-1.0 Find more info here
    */
    public function get(?AlertsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [UnifiedRoleManagementAlertCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
     ...
     * @throws Exception
    */
    public function post(UnifiedRoleManagementAlert $body, ?AlertsRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(UnifiedRoleManagementAlert $body, ?AlertsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/roleManagementAlerts/alerts';
        $requestInfo->pathParameters = $this->pathParameters;
