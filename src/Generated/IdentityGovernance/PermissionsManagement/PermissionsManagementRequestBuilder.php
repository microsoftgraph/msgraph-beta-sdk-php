...
*/
class PermissionsManagementRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Provides operations to manage the permissionsRequestChanges property of the microsoft.graph.permissionsManagement entity.
    */
    public function permissionsRequestChanges(): PermissionsRequestChangesRequestBuilder {
        return new PermissionsRequestChangesRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function scheduledPermissionsRequests(): ScheduledPermissionsRequestsRequestBuilder {
        return new ScheduledPermissionsRequestsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityGovernance/permissionsManagement');
     ...
     * @param PermissionsManagementRequestBuilderDeleteRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
    ...
    */
     ...
     * @param PermissionsManagementRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<PermissionsManagement|null>
     * @throws Exception
    */
     ...
     * @param PermissionsManagement $body The request body
     * @param PermissionsManagementRequestBuilderPatchRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<PermissionsManagement|null>
     * @throws Exception
    */
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?PermissionsManagementRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/permissionsManagement{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
     ...
     * @return PermissionsManagementRequestBuilder
    */
    public function withUrl(string $rawUrl): PermissionsManagementRequestBuilder {
        return new PermissionsManagementRequestBuilder($rawUrl, $this->requestAdapter);
    }
