...
class ApprovalStepItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $approvalStepId key: id of approvalStep
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $approvalStepId = null) {
        ...
        $urlTplParams['approvalStepId'] = $approvalStepId;
