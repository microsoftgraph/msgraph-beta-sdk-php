...
use Microsoft\Graph\Beta\Generated\IdentityGovernance\AccessReviews\Instances\Item\Stages\Item\Decisions\Item\Instance\Decisions\Item\Insights\InsightsRequestBuilder;
...
class AccessReviewInstanceDecisionItemItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/decisions/{accessReviewInstanceDecisionItem%2Did1}');
    ...
    */
    public function toGetRequestInformation(?AccessReviewInstanceDecisionItemItemRequestBuilderGetRe_6d4f61fd $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/decisions/{accessReviewInstanceDecisionItem%2Did1}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
