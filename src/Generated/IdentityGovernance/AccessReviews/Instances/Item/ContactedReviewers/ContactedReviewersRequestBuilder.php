...
use Microsoft\Graph\Beta\Generated\IdentityGovernance\AccessReviews\Instances\Item\ContactedReviewers\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\IdentityGovernance\AccessReviews\Instances\Item\ContactedReviewers\Item\AccessReviewReviewerItemRequestBuilder;
...
class ContactedReviewersRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?ContactedReviewersRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}/contactedReviewers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(AccessReviewReviewer $body, ?ContactedReviewersRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}/contactedReviewers';
        $requestInfo->pathParameters = $this->pathParameters;
