...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: AccessReviewHistoryInstanceItemRequestBuilderGetRequestConfiguration
*/
class AccessReviewHistoryInstanceItemRequestBuilderGetRequest_a0645916 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AccessReviewHistoryInstanceItemRequestBuilderGetRequest_a0645916 and sets the default values.
