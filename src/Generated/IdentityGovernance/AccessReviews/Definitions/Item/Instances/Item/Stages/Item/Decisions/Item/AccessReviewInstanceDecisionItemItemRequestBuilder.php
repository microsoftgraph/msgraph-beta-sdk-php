...
class AccessReviewInstanceDecisionItemItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessReviewInstanceDecisionItemId key: id of accessReviewInstanceDecisionItem
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $accessReviewInstanceDecisionItemId = null) {
