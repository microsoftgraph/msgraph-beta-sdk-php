...
class RecordAllDecisionsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return RecordAllDecisionsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RecordAllDecisionsRequestBody {
