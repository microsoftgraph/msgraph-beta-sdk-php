...
class AccessPackageAssignmentResourceRoleItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessPackageAssignmentResourceRoleId key: id of accessPackageAssignmentResourceRole
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $accessPackageAssignmentResourceRoleId = null) {
        ...
        $urlTplParams['accessPackageAssignmentResourceRoleId'] = $accessPackageAssignmentResourceRoleId;
