...
class ExternalOriginResourceConnectorsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?ExternalOriginResourceConnectorsRequestBuilderGetReques_2620d290 $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/entitlementManagement/externalOriginResourceConnectors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ExternalOriginResourceConnector $body, ?ExternalOriginResourceConnectorsRequestBuilderPostReque_d8df8208 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/entitlementManagement/externalOriginResourceConnectors';
        $requestInfo->pathParameters = $this->pathParameters;
