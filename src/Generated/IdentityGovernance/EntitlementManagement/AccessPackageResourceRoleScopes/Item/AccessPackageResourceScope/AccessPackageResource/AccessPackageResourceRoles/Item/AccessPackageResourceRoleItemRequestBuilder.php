...
class AccessPackageResourceRoleItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessPackageResourceRoleId key: id of accessPackageResourceRole
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $accessPackageResourceRoleId = null) {
        ...
        $urlTplParams['accessPackageResourceRoleId'] = $accessPackageResourceRoleId;
