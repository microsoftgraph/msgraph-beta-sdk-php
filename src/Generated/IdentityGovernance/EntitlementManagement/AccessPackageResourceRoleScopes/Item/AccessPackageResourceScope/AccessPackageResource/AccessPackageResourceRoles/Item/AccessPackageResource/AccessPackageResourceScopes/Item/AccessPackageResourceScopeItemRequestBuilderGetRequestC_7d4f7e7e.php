...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: AccessPackageResourceScopeItemRequestBuilderGetRequestConfiguration
*/
class AccessPackageResourceScopeItemRequestBuilderGetRequestC_7d4f7e7e extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AccessPackageResourceScopeItemRequestBuilderGetRequestC_7d4f7e7e and sets the default values.
