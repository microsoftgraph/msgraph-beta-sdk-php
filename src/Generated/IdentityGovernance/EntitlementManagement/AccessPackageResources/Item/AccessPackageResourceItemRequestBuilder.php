...
class AccessPackageResourceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessPackageResourceId key: id of accessPackageResource
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $accessPackageResourceId = null) {
