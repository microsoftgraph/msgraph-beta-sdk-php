...
class AccessPackageResourceItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $accessPackageResourceId = null) {
        ...
        $urlTplParams['accessPackageResourceId'] = $accessPackageResourceId;
