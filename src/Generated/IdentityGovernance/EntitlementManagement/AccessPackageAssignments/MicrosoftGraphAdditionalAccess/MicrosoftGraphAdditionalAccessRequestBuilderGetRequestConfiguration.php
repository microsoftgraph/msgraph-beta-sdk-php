...
class MicrosoftGraphAdditionalAccessRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * Instantiates a new microsoftGraphAdditionalAccessRequestBuilderGetQueryParameters.
     ...
     * @return MicrosoftGraphAdditionalAccessRequestBuilderGetQueryParameters
    */
    public static function addQueryParameters(?bool $count = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): MicrosoftGraphAdditionalAccessRequestBuilderGetQueryParameters {
        return new MicrosoftGraphAdditionalAccessRequestBuilderGetQueryParameters($count, $filter, $orderby, $search, $select, $skip, $top);
    }
