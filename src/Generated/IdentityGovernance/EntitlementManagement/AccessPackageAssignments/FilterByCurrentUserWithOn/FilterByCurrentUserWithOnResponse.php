...
namespace Microsoft\Graph\Beta\Generated\IdentityGovernance\EntitlementManagement\AccessPackageAssignments\FilterByCurrentUserWithOn;
...
class FilterByCurrentUserWithOnResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AccessPackageAssignment>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(AccessPackageAssignment::class)); },
        ];
    }
