...
namespace Microsoft\Graph\Beta\Generated\IdentityGovernance\EntitlementManagement\AccessPackageAssignments\Item\AccessPackageAssignmentPolicy\CustomExtensionStageSettings;

use Microsoft\Kiota\Abstractions\BaseRequestConfiguration;
use Microsoft\Kiota\Abstractions\RequestOption;

/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: customExtensionStageSettingsRequestBuilderGetRequestConfiguration
*/
class CustomExtensionStageSettingsRequestBuilderGetRequestCon_f44a05ce extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CustomExtensionStageSettingsRequestBuilderGetRequestCon_f44a05ce and sets the default values.
