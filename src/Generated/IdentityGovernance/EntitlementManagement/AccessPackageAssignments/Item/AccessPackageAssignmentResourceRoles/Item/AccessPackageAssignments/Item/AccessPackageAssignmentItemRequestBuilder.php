...
class AccessPackageAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessPackageAssignmentId1 key: id of accessPackageAssignment
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $accessPackageAssignmentId1 = null) {
