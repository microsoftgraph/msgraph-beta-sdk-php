...
namespace Microsoft\Graph\Beta\Generated\IdentityGovernance\EntitlementManagement\AccessPackageAssignments\Item\AccessPackage\AccessPackagesIncompatibleWithWithUniqueName;
...
*/
class AccessPackagesIncompatibleWithWithUniqueNameRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $uniqueName = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackage/accessPackagesIncompatibleWith(uniqueName=\'{uniqueName}\'){?%24expand,%24select}');
    ...
    */
    public function withUrl(string $rawUrl): AccessPackagesIncompatibleWithWithUniqueNameRequestBuilder {
        return new AccessPackagesIncompatibleWithWithUniqueNameRequestBuilder($rawUrl, $this->requestAdapter);
    }
