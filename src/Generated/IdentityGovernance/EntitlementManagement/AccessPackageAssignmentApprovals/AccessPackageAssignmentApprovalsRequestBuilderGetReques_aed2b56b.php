...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: accessPackageAssignmentApprovalsRequestBuilderGetRequestConfiguration
*/
class AccessPackageAssignmentApprovalsRequestBuilderGetReques_aed2b56b extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AccessPackageAssignmentApprovalsRequestBuilderGetReques_aed2b56b and sets the default values.
