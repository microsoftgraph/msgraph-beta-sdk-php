...
class AccessPackageSubjectItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessPackageSubjectId key: id of accessPackageSubject
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $accessPackageSubjectId = null) {
        ...
        $urlTplParams['accessPackageSubjectId'] = $accessPackageSubjectId;
