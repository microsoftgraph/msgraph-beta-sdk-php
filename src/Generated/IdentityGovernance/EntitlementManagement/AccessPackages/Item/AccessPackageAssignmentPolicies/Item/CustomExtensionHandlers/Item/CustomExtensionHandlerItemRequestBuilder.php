...
class CustomExtensionHandlerItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $customExtensionHandlerId key: id of customExtensionHandler
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $customExtensionHandlerId = null) {
        ...
        $urlTplParams['customExtensionHandlerId'] = $customExtensionHandlerId;
