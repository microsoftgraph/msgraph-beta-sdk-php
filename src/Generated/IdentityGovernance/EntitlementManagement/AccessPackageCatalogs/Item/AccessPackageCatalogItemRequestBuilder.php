...
class AccessPackageCatalogItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $accessPackageCatalogId = null) {
    ...
    */
    public function customAccessPackageWorkflowExtensionsById(string $id): CustomAccessPackageWorkflowExtensionItemRequestBuilder {
        ...
        return new CustomAccessPackageWorkflowExtensionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
