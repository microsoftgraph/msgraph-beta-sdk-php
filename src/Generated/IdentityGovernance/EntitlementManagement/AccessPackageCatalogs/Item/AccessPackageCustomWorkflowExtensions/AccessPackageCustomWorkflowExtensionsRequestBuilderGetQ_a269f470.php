...
/**
 * Get a list of the accessPackageAssignmentRequestWorkflowExtension and accessPackageAssignmentWorkflowExtension objects and their properties. The resulting list includes all the customAccessPackageWorkflowExtension objects for the catalog that the caller has access to read. Each object includes an @odata.type property that indicates whether the object is an  accessPackageAssignmentRequestWorkflowExtension or an accessPackageAssignmentWorkflowExtension. Original name: accessPackageCustomWorkflowExtensionsRequestBuilderGetQueryParameters
*/
class AccessPackageCustomWorkflowExtensionsRequestBuilderGetQ_a269f470 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AccessPackageCustomWorkflowExtensionsRequestBuilderGetQ_a269f470 and sets the default values.
