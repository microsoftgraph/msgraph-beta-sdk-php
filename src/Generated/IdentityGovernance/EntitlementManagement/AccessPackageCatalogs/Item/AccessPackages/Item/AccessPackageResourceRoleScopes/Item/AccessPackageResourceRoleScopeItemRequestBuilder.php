...
class AccessPackageResourceRoleScopeItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessPackageResourceRoleScopeId key: id of accessPackageResourceRoleScope
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $accessPackageResourceRoleScopeId = null) {
        ...
        $urlTplParams['accessPackageResourceRoleScopeId'] = $accessPackageResourceRoleScopeId;
