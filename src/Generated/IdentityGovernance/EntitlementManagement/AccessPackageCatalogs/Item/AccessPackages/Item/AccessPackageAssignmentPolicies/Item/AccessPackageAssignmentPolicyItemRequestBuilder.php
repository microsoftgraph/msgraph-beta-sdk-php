...
class AccessPackageAssignmentPolicyItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $accessPackageAssignmentPolicyId = null) {
    ...
    */
    public function customExtensionHandlersById(string $id): CustomExtensionHandlerItemRequestBuilder {
        ...
        return new CustomExtensionHandlerItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
