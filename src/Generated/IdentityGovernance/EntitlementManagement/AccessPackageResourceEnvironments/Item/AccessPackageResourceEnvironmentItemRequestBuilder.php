...
class AccessPackageResourceEnvironmentItemRequestBuilder 
{
    ...
    */
    public function accessPackageResourcesById(string $id): AccessPackageResourceItemRequestBuilder {
        ...
        return new AccessPackageResourceItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $accessPackageResourceEnvironmentId key: id of accessPackageResourceEnvironment
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $accessPackageResourceEnvironmentId = null) {
