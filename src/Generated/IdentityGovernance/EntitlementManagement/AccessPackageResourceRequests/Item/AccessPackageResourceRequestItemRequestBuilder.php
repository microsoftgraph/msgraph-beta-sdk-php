...
class AccessPackageResourceRequestItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessPackageResourceRequestId key: id of accessPackageResourceRequest
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $accessPackageResourceRequestId = null) {
        ...
        $urlTplParams['accessPackageResourceRequestId'] = $accessPackageResourceRequestId;
