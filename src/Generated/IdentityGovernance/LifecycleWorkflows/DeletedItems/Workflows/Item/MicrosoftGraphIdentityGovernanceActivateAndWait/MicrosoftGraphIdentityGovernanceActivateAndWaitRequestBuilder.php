...
namespace Microsoft\Graph\Beta\Generated\IdentityGovernance\LifecycleWorkflows\DeletedItems\Workflows\Item\MicrosoftGraphIdentityGovernanceActivateAndWait;
...
class MicrosoftGraphIdentityGovernanceActivateAndWaitRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphIdentityGovernanceActivateAndWaitRequestB_bf5bc838|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
    ...
    */
    public function post(ActivateAndWaitPostRequestBody $body, ?MicrosoftGraphIdentityGovernanceActivateAndWaitRequestB_bf5bc838 $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(ActivateAndWaitPostRequestBody $body, ?MicrosoftGraphIdentityGovernanceActivateAndWaitRequestB_bf5bc838 $requestConfiguration = null): RequestInformation {
