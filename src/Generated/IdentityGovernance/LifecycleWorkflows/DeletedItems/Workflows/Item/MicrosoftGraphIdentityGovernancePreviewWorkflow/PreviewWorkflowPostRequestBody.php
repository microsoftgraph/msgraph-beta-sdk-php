...
class PreviewWorkflowPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PreviewWorkflowPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PreviewWorkflowPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'subjects' => fn(ParseNode $n) => $o->setSubjects($n->getCollectionOfObjectValues([DirectoryObject::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
     ...
     * @param array<DirectoryObject>|null $value Value to set for the subjects property.
    */
