...
class UserProcessingResultItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userProcessingResultId = null) {
        ...
        $urlTplParams['userProcessingResultId'] = $userProcessingResultId;
