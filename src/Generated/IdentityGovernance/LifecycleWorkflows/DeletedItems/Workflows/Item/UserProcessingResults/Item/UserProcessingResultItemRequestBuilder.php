...
class UserProcessingResultItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userProcessingResultId key: id of userProcessingResult
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $userProcessingResultId = null) {
    ...
    */
    public function taskProcessingResultsById(string $id): TaskProcessingResultItemRequestBuilder {
        ...
        return new TaskProcessingResultItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
