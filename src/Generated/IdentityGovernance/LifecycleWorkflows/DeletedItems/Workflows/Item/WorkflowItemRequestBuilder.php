...
use Microsoft\Graph\Beta\Generated\IdentityGovernance\LifecycleWorkflows\DeletedItems\Workflows\Item\MicrosoftGraphIdentityGovernanceActivate\ActivateRequestBuilder;
use Microsoft\Graph\Beta\Generated\IdentityGovernance\LifecycleWorkflows\DeletedItems\Workflows\Item\MicrosoftGraphIdentityGovernanceCreateNewVersion\CreateNewVersionRequestBuilder;
use Microsoft\Graph\Beta\Generated\IdentityGovernance\LifecycleWorkflows\DeletedItems\Workflows\Item\MicrosoftGraphIdentityGovernanceRestore\RestoreRequestBuilder;
...
class WorkflowItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphIdentityGovernanceActivate(): ActivateRequestBuilder {
    ...
    */
    public function microsoftGraphIdentityGovernanceCreateNewVersion(): CreateNewVersionRequestBuilder {
    ...
    */
    public function microsoftGraphIdentityGovernanceRestore(): RestoreRequestBuilder {
    ...
    */
     ...
     * @param string|null $workflowId key: id of workflow
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $workflowId = null) {
    ...
    */
    public function runsById(string $id): RunItemRequestBuilder {
        ...
        return new RunItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function taskReportsById(string $id): TaskReportItemRequestBuilder {
        ...
        return new TaskReportItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function userProcessingResultsById(string $id): UserProcessingResultItemRequestBuilder {
        ...
        return new UserProcessingResultItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function versionsById(string $id): WorkflowVersionVersionNumberItemRequestBuilder {
        ...
        return new WorkflowVersionVersionNumberItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
