...
class WorkflowVersionVersionNumberItemRequestBuilder 
{
    ...
    */
     ...
     * @param int|null $workflowVersionVersionNumber key: versionNumber of workflowVersion
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?int $workflowVersionVersionNumber = null) {
        ...
        $urlTplParams['workflowVersionVersionNumber'] = $workflowVersionVersionNumber;
