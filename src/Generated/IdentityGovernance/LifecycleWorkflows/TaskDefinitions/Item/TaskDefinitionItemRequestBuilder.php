...
class TaskDefinitionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $taskDefinitionId key: id of taskDefinition
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $taskDefinitionId = null) {
        ...
        $urlTplParams['taskDefinitionId'] = $taskDefinitionId;
