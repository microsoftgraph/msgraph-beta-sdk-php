...
class CustomTaskExtensionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $customTaskExtensionId key: id of customTaskExtension
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $customTaskExtensionId = null) {
        ...
        $urlTplParams['customTaskExtensionId'] = $customTaskExtensionId;
