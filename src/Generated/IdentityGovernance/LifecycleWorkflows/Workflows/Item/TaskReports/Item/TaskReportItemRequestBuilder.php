...
class TaskReportItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $taskReportId key: id of taskReport
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $taskReportId = null) {
