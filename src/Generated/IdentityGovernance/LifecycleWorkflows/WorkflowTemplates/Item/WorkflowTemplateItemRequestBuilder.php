...
class WorkflowTemplateItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $workflowTemplateId = null) {
    ...
    */
    public function tasksById(string $id): TaskItemRequestBuilder {
        ...
        return new TaskItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
