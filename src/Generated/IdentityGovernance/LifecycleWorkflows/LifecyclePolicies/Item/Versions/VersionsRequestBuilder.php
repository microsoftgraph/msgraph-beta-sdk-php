...
namespace Microsoft\Graph\Beta\Generated\IdentityGovernance\LifecycleWorkflows\LifecyclePolicies\Item\Versions;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\IdentityGovernance\LifecycleWorkflows\LifecyclePolicies\Item\Versions\Item\LifecyclePolicyItemRequestBuilder;
...
class VersionsRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Provides operations to manage the versions property of the microsoft.graph.identityGovernance.lifecyclePolicy entity.
     * @param string $lifecyclePolicyId1 The unique identifier of lifecyclePolicy
     * @return LifecyclePolicyItemRequestBuilder
    */
    public function byLifecyclePolicyId1(string $lifecyclePolicyId1): LifecyclePolicyItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['lifecyclePolicy%2Did1'] = $lifecyclePolicyId1;
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityGovernance/lifecycleWorkflows/lifecyclePolicies/{lifecyclePolicy%2Did}/versions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
