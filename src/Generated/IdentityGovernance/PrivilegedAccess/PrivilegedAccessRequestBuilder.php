...
class PrivilegedAccessRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityGovernance/privilegedAccess{?%24expand,%24select}');
    ...
    */
     ...
     * @return Promise<PrivilegedAccessRoot|null>
     * @throws Exception
    */
    ...
    */
    public function toDeleteRequestInformation(?PrivilegedAccessRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/privilegedAccess';
