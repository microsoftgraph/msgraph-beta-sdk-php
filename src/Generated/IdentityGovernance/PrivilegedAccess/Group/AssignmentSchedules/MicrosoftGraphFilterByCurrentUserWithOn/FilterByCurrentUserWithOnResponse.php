...
namespace Microsoft\Graph\Beta\Generated\IdentityGovernance\PrivilegedAccess\Group\AssignmentSchedules\MicrosoftGraphFilterByCurrentUserWithOn;
...
class FilterByCurrentUserWithOnResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([PrivilegedAccessGroupAssignmentSchedule::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
     ...
     * @param array<PrivilegedAccessGroupAssignmentSchedule>|null $value Value to set for the value property.
    */
