...
class PrivilegedAccessGroupAssignmentScheduleItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedAccessGroupAssignmentScheduleId key: id of privilegedAccessGroupAssignmentSchedule
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $privilegedAccessGroupAssignmentScheduleId = null) {
        ...
        $urlTplParams['privilegedAccessGroupAssignmentScheduleId'] = $privilegedAccessGroupAssignmentScheduleId;
