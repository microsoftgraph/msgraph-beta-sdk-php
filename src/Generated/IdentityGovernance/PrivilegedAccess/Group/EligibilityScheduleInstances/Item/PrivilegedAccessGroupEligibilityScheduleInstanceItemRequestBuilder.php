...
class PrivilegedAccessGroupEligibilityScheduleInstanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedAccessGroupEligibilityScheduleInstanceId key: id of privilegedAccessGroupEligibilityScheduleInstance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $privilegedAccessGroupEligibilityScheduleInstanceId = null) {
        ...
        $urlTplParams['privilegedAccessGroupEligibilityScheduleInstanceId'] = $privilegedAccessGroupEligibilityScheduleInstanceId;
