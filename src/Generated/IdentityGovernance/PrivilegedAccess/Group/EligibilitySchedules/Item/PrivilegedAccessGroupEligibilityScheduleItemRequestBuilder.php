...
class PrivilegedAccessGroupEligibilityScheduleItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedAccessGroupEligibilityScheduleId key: id of privilegedAccessGroupEligibilitySchedule
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $privilegedAccessGroupEligibilityScheduleId = null) {
        ...
        $urlTplParams['privilegedAccessGroupEligibilityScheduleId'] = $privilegedAccessGroupEligibilityScheduleId;
