...
class PrivilegedAccessGroupAssignmentScheduleInstanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedAccessGroupAssignmentScheduleInstanceId key: id of privilegedAccessGroupAssignmentScheduleInstance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $privilegedAccessGroupAssignmentScheduleInstanceId = null) {
        ...
        $urlTplParams['privilegedAccessGroupAssignmentScheduleInstanceId'] = $privilegedAccessGroupAssignmentScheduleInstanceId;
