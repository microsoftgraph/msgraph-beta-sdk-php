...
namespace Microsoft\Graph\Beta\Generated\IdentityGovernance\Catalogs\Item\AccessPackagesWithUniqueName;

use Microsoft\Kiota\Abstractions\BaseRequestConfiguration;
use Microsoft\Kiota\Abstractions\RequestOption;

/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: accessPackagesWithUniqueNameRequestBuilderGetRequestConfiguration
*/
class AccessPackagesWithUniqueNameRequestBuilderGetRequestCon_3a8520d0 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AccessPackagesWithUniqueNameRequestBuilderGetRequestCon_3a8520d0 and sets the default values.
