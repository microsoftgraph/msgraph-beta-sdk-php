...
namespace Microsoft\Graph\Beta\Generated\IdentityGovernance\Catalogs;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\IdentityGovernance\Catalogs\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\IdentityGovernance\Catalogs\Item\AccessPackageCatalogItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\IdentityGovernance\Catalogs\Search\SearchRequestBuilder;
...
class CatalogsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?CatalogsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/catalogs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(AccessPackageCatalog $body, ?CatalogsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/catalogs';
        $requestInfo->pathParameters = $this->pathParameters;
