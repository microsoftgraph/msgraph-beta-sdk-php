...
class GcpRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityGovernance/permissionsAnalytics/gcp');
    ...
    */
    public function toGetRequestInformation(?GcpRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/identityGovernance/permissionsAnalytics/gcp{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
