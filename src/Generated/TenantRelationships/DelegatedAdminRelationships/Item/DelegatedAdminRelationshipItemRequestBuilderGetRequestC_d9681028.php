...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: DelegatedAdminRelationshipItemRequestBuilderGetRequestConfiguration
*/
class DelegatedAdminRelationshipItemRequestBuilderGetRequestC_d9681028 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DelegatedAdminRelationshipItemRequestBuilderGetRequestC_d9681028 and sets the default values.
