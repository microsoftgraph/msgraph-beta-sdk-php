...
use Microsoft\Graph\Beta\Generated\TenantRelationships\ManagedTenants\ManagementActions\Item\MicrosoftGraphManagedTenantsApply\ApplyRequestBuilder;
...
class ManagementActionItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphManagedTenantsApply(): ApplyRequestBuilder {
    ...
    */
     ...
     * @param string|null $managementActionId key: id of managementAction
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managementActionId = null) {
        ...
        $urlTplParams['managementActionId'] = $managementActionId;
