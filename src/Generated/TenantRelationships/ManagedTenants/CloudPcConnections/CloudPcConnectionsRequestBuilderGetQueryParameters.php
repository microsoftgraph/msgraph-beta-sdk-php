...
/**
 * Get a list of the cloudPcConnection objects and their properties. This API is supported in the following national cloud deployments.
*/
class CloudPcConnectionsRequestBuilderGetQueryParameters 
{
    ...
    */
    ...
    /**
     * Instantiates a new cloudPcConnectionsRequestBuilderGetQueryParameters and sets the default values.
