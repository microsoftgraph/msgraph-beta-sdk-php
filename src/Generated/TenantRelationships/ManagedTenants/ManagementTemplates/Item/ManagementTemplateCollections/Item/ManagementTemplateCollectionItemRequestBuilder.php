...
class ManagementTemplateCollectionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managementTemplateCollectionId key: id of managementTemplateCollection
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managementTemplateCollectionId = null) {
        $this->urlTemplate = '{+baseurl}/tenantRelationships/managedTenants/managementTemplates/{managementTemplate%2Did}/managementTemplateCollections/{managementTemplateCollection%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['managementTemplateCollectionId'] = $managementTemplateCollectionId;
