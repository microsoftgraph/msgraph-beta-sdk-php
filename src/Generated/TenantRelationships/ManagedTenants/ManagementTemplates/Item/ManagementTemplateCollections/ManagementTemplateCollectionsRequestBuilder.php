...
class ManagementTemplateCollectionsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/tenantRelationships/managedTenants/managementTemplates/{managementTemplate_id}/managementTemplateCollections{?top,skip,search,filter,count,orderby,select,expand}';
