...
class ManagedDeviceComplianceTrendItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedDeviceComplianceTrendId key: id of managedDeviceComplianceTrend
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedDeviceComplianceTrendId = null) {
        ...
        $urlTplParams['managedDeviceComplianceTrendId'] = $managedDeviceComplianceTrendId;
