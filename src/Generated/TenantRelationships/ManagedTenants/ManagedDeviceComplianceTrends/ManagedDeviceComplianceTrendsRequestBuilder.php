...
class ManagedDeviceComplianceTrendsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/tenantRelationships/managedTenants/managedDeviceComplianceTrends{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-manageddevicecompliancetrends?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function toPostRequestInformation(ManagedDeviceComplianceTrend $body, ?ManagedDeviceComplianceTrendsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/tenantRelationships/managedTenants/managedDeviceComplianceTrends';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return ManagedDeviceComplianceTrendsRequestBuilder
    */
    public function withUrl(string $rawUrl): ManagedDeviceComplianceTrendsRequestBuilder {
        return new ManagedDeviceComplianceTrendsRequestBuilder($rawUrl, $this->requestAdapter);
    }
