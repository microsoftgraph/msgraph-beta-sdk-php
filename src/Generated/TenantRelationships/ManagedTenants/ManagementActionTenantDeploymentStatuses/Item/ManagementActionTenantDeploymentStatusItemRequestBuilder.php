...
class ManagementActionTenantDeploymentStatusItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managementActionTenantDeploymentStatusId key: id of managementActionTenantDeploymentStatus
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managementActionTenantDeploymentStatusId = null) {
        ...
        $urlTplParams['managementActionTenantDeploymentStatusId'] = $managementActionTenantDeploymentStatusId;
