...
class ConditionalAccessPolicyCoverageItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $conditionalAccessPolicyCoverageId key: id of conditionalAccessPolicyCoverage
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $conditionalAccessPolicyCoverageId = null) {
        ...
        $urlTplParams['conditionalAccessPolicyCoverageId'] = $conditionalAccessPolicyCoverageId;
