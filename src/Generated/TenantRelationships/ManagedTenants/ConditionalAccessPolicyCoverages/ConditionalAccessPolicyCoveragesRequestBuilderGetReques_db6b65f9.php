...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: conditionalAccessPolicyCoveragesRequestBuilderGetRequestConfiguration
*/
class ConditionalAccessPolicyCoveragesRequestBuilderGetReques_db6b65f9 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ConditionalAccessPolicyCoveragesRequestBuilderGetReques_db6b65f9 and sets the default values.
