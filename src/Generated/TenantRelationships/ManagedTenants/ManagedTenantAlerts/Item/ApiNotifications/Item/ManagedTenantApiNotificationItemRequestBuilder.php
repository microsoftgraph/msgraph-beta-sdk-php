...
class ManagedTenantApiNotificationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedTenantApiNotificationId key: id of managedTenantApiNotification
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedTenantApiNotificationId = null) {
        ...
        $urlTplParams['managedTenantApiNotificationId'] = $managedTenantApiNotificationId;
