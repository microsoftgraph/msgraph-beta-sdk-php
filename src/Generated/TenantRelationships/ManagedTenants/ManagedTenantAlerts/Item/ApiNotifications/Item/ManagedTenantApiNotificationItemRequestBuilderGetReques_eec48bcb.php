...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ManagedTenantApiNotificationItemRequestBuilderGetRequestConfiguration
*/
class ManagedTenantApiNotificationItemRequestBuilderGetReques_eec48bcb extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ManagedTenantApiNotificationItemRequestBuilderGetReques_eec48bcb and sets the default values.
