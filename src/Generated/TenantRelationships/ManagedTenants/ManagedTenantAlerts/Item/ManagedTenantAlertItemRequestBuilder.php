...
class ManagedTenantAlertItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedTenantAlertId = null) {
        ...
        $urlTplParams['managedTenantAlertId'] = $managedTenantAlertId;
