...
use Microsoft\Graph\Beta\Generated\TenantRelationships\ManagedTenants\ManagedTenantAlerts\Item\MicrosoftGraphManagedTenantsAddUserInputLog\AddUserInputLogRequestBuilder;
...
class ManagedTenantAlertItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphManagedTenantsAddUserInputLog(): AddUserInputLogRequestBuilder {
    ...
    */
     ...
     * @param string|null $managedTenantAlertId key: id of managedTenantAlert
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $managedTenantAlertId = null) {
