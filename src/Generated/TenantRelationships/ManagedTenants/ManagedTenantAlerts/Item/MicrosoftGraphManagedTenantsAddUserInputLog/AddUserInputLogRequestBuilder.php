...
class AddUserInputLogRequestBuilder 
{
    ...
    */
     ...
     * @param AddUserInputLogRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
    */
    public function post(AddUserInputLogPostRequestBody $body, ?AddUserInputLogRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(AddUserInputLogPostRequestBody $body, ?AddUserInputLogRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
