...
class ManagedTenantAlertLogItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedTenantAlertLogId key: id of managedTenantAlertLog
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedTenantAlertLogId = null) {
        ...
        $urlTplParams['managedTenantAlertLogId'] = $managedTenantAlertLogId;
