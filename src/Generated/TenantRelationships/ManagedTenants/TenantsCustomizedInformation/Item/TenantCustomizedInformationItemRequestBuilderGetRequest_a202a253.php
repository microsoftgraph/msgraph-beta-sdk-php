...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: TenantCustomizedInformationItemRequestBuilderGetRequestConfiguration
*/
class TenantCustomizedInformationItemRequestBuilderGetRequest_a202a253 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TenantCustomizedInformationItemRequestBuilderGetRequest_a202a253 and sets the default values.
    ...
    */
    public static function createQueryParameters(?array $expand = null, ?array $select = null): TenantCustomizedInformationItemRequestBuilderGetQueryParameters {
