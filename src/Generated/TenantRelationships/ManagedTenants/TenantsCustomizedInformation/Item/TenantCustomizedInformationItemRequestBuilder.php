...
class TenantCustomizedInformationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $tenantCustomizedInformationId key: id of tenantCustomizedInformation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $tenantCustomizedInformationId = null) {
        ...
        $urlTplParams['tenantCustomizedInformationId'] = $tenantCustomizedInformationId;
