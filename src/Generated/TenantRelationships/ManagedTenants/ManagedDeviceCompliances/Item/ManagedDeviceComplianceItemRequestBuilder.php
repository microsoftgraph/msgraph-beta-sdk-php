...
class ManagedDeviceComplianceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedDeviceComplianceId key: id of managedDeviceCompliance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedDeviceComplianceId = null) {
        ...
        $urlTplParams['managedDeviceComplianceId'] = $managedDeviceComplianceId;
