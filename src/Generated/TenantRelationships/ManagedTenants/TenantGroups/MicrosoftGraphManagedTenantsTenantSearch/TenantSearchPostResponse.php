...
class TenantSearchPostResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return TenantSearchPostResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TenantSearchPostResponse {
    ...
    */
     ...
     * @param array<TenantGroup>|null $value Value to set for the value property.
    */
