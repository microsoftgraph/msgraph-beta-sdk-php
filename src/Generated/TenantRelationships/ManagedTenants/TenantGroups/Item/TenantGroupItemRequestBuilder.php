...
class TenantGroupItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $tenantGroupId key: id of tenantGroup
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $tenantGroupId = null) {
        ...
        $urlTplParams['tenantGroupId'] = $tenantGroupId;
