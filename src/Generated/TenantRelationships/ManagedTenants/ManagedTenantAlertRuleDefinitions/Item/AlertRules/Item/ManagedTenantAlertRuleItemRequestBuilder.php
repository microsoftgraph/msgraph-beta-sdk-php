...
class ManagedTenantAlertRuleItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedTenantAlertRuleId = null) {
        ...
        $urlTplParams['managedTenantAlertRuleId'] = $managedTenantAlertRuleId;
