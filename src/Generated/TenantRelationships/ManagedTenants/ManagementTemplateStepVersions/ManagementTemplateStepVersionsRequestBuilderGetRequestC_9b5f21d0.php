...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: managementTemplateStepVersionsRequestBuilderGetRequestConfiguration
*/
class ManagementTemplateStepVersionsRequestBuilderGetRequestC_9b5f21d0 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ManagementTemplateStepVersionsRequestBuilderGetRequestC_9b5f21d0 and sets the default values.
