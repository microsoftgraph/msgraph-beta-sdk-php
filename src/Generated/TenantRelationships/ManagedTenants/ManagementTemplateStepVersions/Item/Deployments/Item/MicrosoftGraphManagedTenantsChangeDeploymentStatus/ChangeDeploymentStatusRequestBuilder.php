...
class ChangeDeploymentStatusRequestBuilder 
{
    ...
    */
     ...
     * @return Promise
    */
    public function post(ChangeDeploymentStatusPostRequestBody $body, ?ChangeDeploymentStatusRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
