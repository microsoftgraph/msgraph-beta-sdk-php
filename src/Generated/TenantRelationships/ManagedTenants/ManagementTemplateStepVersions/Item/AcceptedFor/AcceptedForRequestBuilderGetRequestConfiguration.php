...
*/
class AcceptedForRequestBuilderGetRequestConfiguration 
{
    /**
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): AcceptedForRequestBuilderGetQueryParameters {
