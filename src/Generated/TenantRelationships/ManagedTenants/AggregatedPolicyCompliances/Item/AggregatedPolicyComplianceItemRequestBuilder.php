...
class AggregatedPolicyComplianceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $aggregatedPolicyComplianceId key: id of aggregatedPolicyCompliance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $aggregatedPolicyComplianceId = null) {
        ...
        $urlTplParams['aggregatedPolicyComplianceId'] = $aggregatedPolicyComplianceId;
