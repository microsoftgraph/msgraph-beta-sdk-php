...
namespace Microsoft\Graph\Beta\Generated\TenantRelationships\ManagedTenants\DeviceAppPerformances;
...
*/
class DeviceAppPerformancesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/tenantRelationships/managedTenants/deviceAppPerformances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
     ...
     * @param DeviceAppPerformancesRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<DeviceAppPerformanceCollectionResponse|null>
     * @throws Exception
    */
    public function get(?DeviceAppPerformancesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        $errorMappings = [
                '4XX' => [ODataError::class, 'createFromDiscriminatorValue'],
                '5XX' => [ODataError::class, 'createFromDiscriminatorValue'],
        ];
        return $this->requestAdapter->sendAsync($requestInfo, [DeviceAppPerformanceCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
     ...
     * @param DeviceAppPerformancesRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<DeviceAppPerformance|null>
     * @throws Exception
    */
    public function post(DeviceAppPerformance $body, ?DeviceAppPerformancesRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?DeviceAppPerformancesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
     ...
     * @return DeviceAppPerformancesRequestBuilder
    */
    public function withUrl(string $rawUrl): DeviceAppPerformancesRequestBuilder {
        return new DeviceAppPerformancesRequestBuilder($rawUrl, $this->requestAdapter);
    }
