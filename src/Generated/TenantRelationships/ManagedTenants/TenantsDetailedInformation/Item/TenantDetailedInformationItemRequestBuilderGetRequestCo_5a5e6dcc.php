...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: TenantDetailedInformationItemRequestBuilderGetRequestConfiguration
*/
class TenantDetailedInformationItemRequestBuilderGetRequestCo_5a5e6dcc extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TenantDetailedInformationItemRequestBuilderGetRequestCo_5a5e6dcc and sets the default values.
