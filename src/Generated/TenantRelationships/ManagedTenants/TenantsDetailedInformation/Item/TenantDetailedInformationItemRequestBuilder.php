...
class TenantDetailedInformationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $tenantDetailedInformationId key: id of tenantDetailedInformation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $tenantDetailedInformationId = null) {
        ...
        $urlTplParams['tenantDetailedInformationId'] = $tenantDetailedInformationId;
