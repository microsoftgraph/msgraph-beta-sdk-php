...
class ManagedTenantEmailNotificationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedTenantEmailNotificationId key: id of managedTenantEmailNotification
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedTenantEmailNotificationId = null) {
        ...
        $urlTplParams['managedTenantEmailNotificationId'] = $managedTenantEmailNotificationId;
