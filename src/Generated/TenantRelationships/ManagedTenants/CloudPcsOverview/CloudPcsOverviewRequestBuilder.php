...
class CloudPcsOverviewRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @return Promise<CloudPcOverviewCollectionResponse|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-cloudpcsoverview?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?CloudPcsOverviewRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/tenantRelationships/managedTenants/cloudPcsOverview{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(CloudPcOverview $body, ?CloudPcsOverviewRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/tenantRelationships/managedTenants/cloudPcsOverview';
        $requestInfo->pathParameters = $this->pathParameters;
