...
class CloudPcOverviewTenantItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcOverviewTenantId key: tenantId of cloudPcOverview
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcOverviewTenantId = null) {
        ...
        $urlTplParams['cloudPcOverviewTenantId'] = $cloudPcOverviewTenantId;
