...
class MyRoleTenantItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $myRoleTenantId key: tenantId of myRole
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $myRoleTenantId = null) {
        $this->urlTemplate = '{+baseurl}/tenantRelationships/managedTenants/myRoles/{myRole%2DtenantId}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['myRoleTenantId'] = $myRoleTenantId;
