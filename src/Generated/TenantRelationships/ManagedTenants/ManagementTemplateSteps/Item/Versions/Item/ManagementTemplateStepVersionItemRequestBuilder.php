...
class ManagementTemplateStepVersionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managementTemplateStepVersionId key: id of managementTemplateStepVersion
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managementTemplateStepVersionId = null) {
        $this->urlTemplate = '{+baseurl}/tenantRelationships/managedTenants/managementTemplateSteps/{managementTemplateStep%2Did}/versions/{managementTemplateStepVersion%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['managementTemplateStepVersionId'] = $managementTemplateStepVersionId;
