...
class ManagementTemplateStepItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managementTemplateStepId key: id of managementTemplateStep
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $managementTemplateStepId = null) {
    ...
    */
    public function versionsById(string $id): ManagementTemplateStepVersionItemRequestBuilder {
        ...
        return new ManagementTemplateStepVersionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
