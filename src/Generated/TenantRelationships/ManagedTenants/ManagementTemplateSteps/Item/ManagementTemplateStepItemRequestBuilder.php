...
class ManagementTemplateStepItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managementTemplateStepId = null) {
        ...
        $urlTplParams['managementTemplateStepId'] = $managementTemplateStepId;
