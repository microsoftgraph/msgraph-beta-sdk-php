...
class UnassignTagRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UnassignTagRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UnassignTagRequestBody {
