...
class ManagementTemplateCollectionTenantSummaryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managementTemplateCollectionTenantSummaryId key: id of managementTemplateCollectionTenantSummary
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managementTemplateCollectionTenantSummaryId = null) {
        ...
        $urlTplParams['managementTemplateCollectionTenantSummaryId'] = $managementTemplateCollectionTenantSummaryId;
