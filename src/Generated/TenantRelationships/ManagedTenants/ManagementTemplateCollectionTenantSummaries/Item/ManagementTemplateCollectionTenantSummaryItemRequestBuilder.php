...
*/
class ManagementTemplateCollectionTenantSummaryItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/tenantRelationships/managedTenants/managementTemplateCollectionTenantSummaries/{managementTemplateCollectionTenantSummary%2Did}{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?ManagementTemplateCollectionTenantSummaryItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/tenantRelationships/managedTenants/managementTemplateCollectionTenantSummaries/{managementTemplateCollectionTenantSummary%2Did}';
    ...
    */
    public function withUrl(string $rawUrl): ManagementTemplateCollectionTenantSummaryItemRequestBuilder {
        return new ManagementTemplateCollectionTenantSummaryItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
