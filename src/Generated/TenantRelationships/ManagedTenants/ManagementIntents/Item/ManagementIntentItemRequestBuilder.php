...
class ManagementIntentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managementIntentId key: id of managementIntent
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managementIntentId = null) {
        ...
        $urlTplParams['managementIntentId'] = $managementIntentId;
