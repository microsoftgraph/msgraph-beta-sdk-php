...
class CloudPcDeviceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcDeviceId key: id of cloudPcDevice
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcDeviceId = null) {
        ...
        $urlTplParams['cloudPcDeviceId'] = $cloudPcDeviceId;
