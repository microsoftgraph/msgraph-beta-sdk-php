...
class ManagedTenantAlertRuleItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedTenantAlertRuleId key: id of managedTenantAlertRule
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $managedTenantAlertRuleId = null) {
