...
class ManagementTemplateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managementTemplateId key: id of managementTemplate
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managementTemplateId = null) {
        ...
        $urlTplParams['managementTemplateId'] = $managementTemplateId;
