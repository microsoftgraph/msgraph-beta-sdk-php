...
class TenantItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function microsoftGraphManagedTenantsOffboardTenant(): MicrosoftGraphManagedTenantsOffboardTenantRequestBuilder {
        return new MicrosoftGraphManagedTenantsOffboardTenantRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/managedtenants-tenant-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?TenantItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): TenantItemRequestBuilder {
        return new TenantItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
