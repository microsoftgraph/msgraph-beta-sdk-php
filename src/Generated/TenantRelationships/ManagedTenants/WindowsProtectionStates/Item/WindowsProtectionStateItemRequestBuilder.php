...
class WindowsProtectionStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $windowsProtectionStateId key: id of windowsProtectionState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsProtectionStateId = null) {
        ...
        $urlTplParams['windowsProtectionStateId'] = $windowsProtectionStateId;
