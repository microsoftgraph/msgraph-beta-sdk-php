...
class ManagedTenantTicketingEndpointItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedTenantTicketingEndpointId key: id of managedTenantTicketingEndpoint
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedTenantTicketingEndpointId = null) {
        ...
        $urlTplParams['managedTenantTicketingEndpointId'] = $managedTenantTicketingEndpointId;
