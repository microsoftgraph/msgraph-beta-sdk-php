...
class CredentialUserRegistrationsSummaryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $credentialUserRegistrationsSummaryId key: id of credentialUserRegistrationsSummary
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $credentialUserRegistrationsSummaryId = null) {
        ...
        $urlTplParams['credentialUserRegistrationsSummaryId'] = $credentialUserRegistrationsSummaryId;
