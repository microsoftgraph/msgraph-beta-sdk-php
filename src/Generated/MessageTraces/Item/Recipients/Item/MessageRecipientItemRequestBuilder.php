...
class MessageRecipientItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $messageRecipientId key: id of messageRecipient
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $messageRecipientId = null) {
    ...
    */
    public function eventsById(string $id): MessageEventItemRequestBuilder {
        ...
        return new MessageEventItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
