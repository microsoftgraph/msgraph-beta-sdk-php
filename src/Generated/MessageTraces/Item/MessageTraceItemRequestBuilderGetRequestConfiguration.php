...
*/
class MessageTraceItemRequestBuilderGetRequestConfiguration 
{
    /**
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): MessageTraceItemRequestBuilderGetQueryParameters {
