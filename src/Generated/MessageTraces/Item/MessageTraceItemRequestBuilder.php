...
class MessageTraceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $messageTraceId key: id of messageTrace
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $messageTraceId = null) {
    ...
    */
    public function recipientsById(string $id): MessageRecipientItemRequestBuilder {
        ...
        return new MessageRecipientItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
