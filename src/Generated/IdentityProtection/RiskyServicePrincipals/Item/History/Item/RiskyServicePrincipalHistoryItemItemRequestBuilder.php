...
class RiskyServicePrincipalHistoryItemItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $riskyServicePrincipalHistoryItemId key: id of riskyServicePrincipalHistoryItem
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $riskyServicePrincipalHistoryItemId = null) {
        ...
        $urlTplParams['riskyServicePrincipalHistoryItemId'] = $riskyServicePrincipalHistoryItemId;
