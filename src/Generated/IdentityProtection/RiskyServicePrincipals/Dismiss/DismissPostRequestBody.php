...
class DismissPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'servicePrincipalIds' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setServicePrincipalIds($val);
            },
        ];
    }
    ...
    */
    public function getServicePrincipalIds(): ?array {
        $val = $this->getBackingStore()->get('servicePrincipalIds');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'servicePrincipalIds'");
    }
    ...
    */
    public function setServicePrincipalIds(?array $value): void {
        $this->getBackingStore()->set('servicePrincipalIds', $value);
    }
