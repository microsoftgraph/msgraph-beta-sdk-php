...
class RiskyUserHistoryItemItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityProtection/riskyUsers/{riskyUser%2Did}/history/{riskyUserHistoryItem%2Did}{?%24select,%24expand}');
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/riskyuserhistoryitem-get?view=graph-rest-1.0 Find more info here
    */
