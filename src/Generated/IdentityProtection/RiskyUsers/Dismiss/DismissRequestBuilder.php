...
class DismissRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/identityProtection/riskyUsers/dismiss');
     ...
     * @return Promise
     * @link https://learn.microsoft.com/graph/api/riskyusers-dismiss?view=graph-rest-1.0 Find more info here
    */
