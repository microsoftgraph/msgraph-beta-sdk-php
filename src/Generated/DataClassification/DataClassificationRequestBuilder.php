...
use Microsoft\Graph\Beta\Generated\DataClassification\MicrosoftGraphClassifyExactMatches\MicrosoftGraphClassifyExactMatchesRequestBuilder;
use Microsoft\Graph\Beta\Generated\DataClassification\MicrosoftGraphClassifyFile\MicrosoftGraphClassifyFileRequestBuilder;
...
class DataClassificationRequestBuilder 
{
    ...
    */
    public function microsoftGraphClassifyExactMatches(): MicrosoftGraphClassifyExactMatchesRequestBuilder {
        return new MicrosoftGraphClassifyExactMatchesRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the classifyFile method.
    */
    public function microsoftGraphClassifyFile(): MicrosoftGraphClassifyFileRequestBuilder {
        return new MicrosoftGraphClassifyFileRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function classifyFileJobsById(string $id): \Microsoft\Graph\Beta\Generated\DataClassification\ClassifyFileJobs\Item\JobResponseBaseItemRequestBuilder {
        ...
        return new \Microsoft\Graph\Beta\Generated\DataClassification\ClassifyFileJobs\Item\JobResponseBaseItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function classifyTextJobsById(string $id): \Microsoft\Graph\Beta\Generated\DataClassification\ClassifyTextJobs\Item\JobResponseBaseItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['jobResponseBase%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\DataClassification\ClassifyTextJobs\Item\JobResponseBaseItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function evaluateDlpPoliciesJobsById(string $id): \Microsoft\Graph\Beta\Generated\DataClassification\EvaluateDlpPoliciesJobs\Item\JobResponseBaseItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['jobResponseBase%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\DataClassification\EvaluateDlpPoliciesJobs\Item\JobResponseBaseItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function evaluateLabelJobsById(string $id): \Microsoft\Graph\Beta\Generated\DataClassification\EvaluateLabelJobs\Item\JobResponseBaseItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['jobResponseBase%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\DataClassification\EvaluateLabelJobs\Item\JobResponseBaseItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function exactMatchDataStoresById(string $id): ExactMatchDataStoreItemRequestBuilder {
        ...
        return new ExactMatchDataStoreItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function exactMatchUploadAgentsById(string $id): ExactMatchUploadAgentItemRequestBuilder {
        ...
        return new ExactMatchUploadAgentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function jobsById(string $id): \Microsoft\Graph\Beta\Generated\DataClassification\Jobs\Item\JobResponseBaseItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['jobResponseBase%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\DataClassification\Jobs\Item\JobResponseBaseItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function sensitiveTypesById(string $id): SensitiveTypeItemRequestBuilder {
        ...
        return new SensitiveTypeItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
