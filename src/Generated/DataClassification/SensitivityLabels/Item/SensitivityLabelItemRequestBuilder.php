...
class SensitivityLabelItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $sensitivityLabelId key: id of sensitivityLabel
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $sensitivityLabelId = null) {
        $this->urlTemplate = '{+baseurl}/dataClassification/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['sensitivityLabelId'] = $sensitivityLabelId;
