...
class ClassifyFileRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return ClassifyFileRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ClassifyFileRequestBody {
