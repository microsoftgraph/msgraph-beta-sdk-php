...
use Microsoft\Graph\Beta\Generated\DataClassification\ExactMatchDataStores\Item\MicrosoftGraphLookup\LookupRequestBuilder;
...
class ExactMatchDataStoreItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $exactMatchDataStoreId key: id of exactMatchDataStore
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $exactMatchDataStoreId = null) {
    ...
    */
    public function sessionsById(string $id): ExactMatchSessionItemRequestBuilder {
        ...
        return new ExactMatchSessionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
