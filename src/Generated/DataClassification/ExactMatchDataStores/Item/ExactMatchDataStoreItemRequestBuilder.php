...
class ExactMatchDataStoreItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $exactMatchDataStoreId = null) {
        ...
        $urlTplParams['exactMatchDataStoreId'] = $exactMatchDataStoreId;
