...
*/
class ClassifyFileJobsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/dataClassification/classifyFileJobs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
     ...
     * @throws Exception
    */
    public function get(?ClassifyFileJobsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
     ...
     * @throws Exception
    */
    public function post(JobResponseBase $body, ?ClassifyFileJobsRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return ClassifyFileJobsRequestBuilder
    */
    public function withUrl(string $rawUrl): ClassifyFileJobsRequestBuilder {
        return new ClassifyFileJobsRequestBuilder($rawUrl, $this->requestAdapter);
    }
