...
namespace Microsoft\Graph\Beta\Generated\DataClassification\ClassifyFileJobs\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/dataClassification/classifyFileJobs/$count{?%24search,%24filter}");
