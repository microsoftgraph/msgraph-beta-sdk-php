...
namespace Microsoft\Graph\Beta\Generated\DataClassification\SensitiveTypes\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/dataClassification/sensitiveTypes/$count{?%24search,%24filter}");
