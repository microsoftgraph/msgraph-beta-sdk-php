...
class ExactMatchUploadAgentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $exactMatchUploadAgentId key: id of exactMatchUploadAgent
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $exactMatchUploadAgentId = null) {
        ...
        $urlTplParams['exactMatchUploadAgentId'] = $exactMatchUploadAgentId;
