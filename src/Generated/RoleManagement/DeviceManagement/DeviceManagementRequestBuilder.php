...
use Microsoft\Graph\Beta\Generated\RoleManagement\DeviceManagement\ResourceNamespaces\Item\UnifiedRbacResourceNamespaceItemRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\RoleManagement\DeviceManagement\RoleDefinitions\Item\UnifiedRoleDefinitionItemRequestBuilder;
...
class DeviceManagementRequestBuilder 
{
    ...
    */
    public function createDeleteRequestInformation(?DeviceManagementRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(RbacApplicationMultiple $body, ?DeviceManagementRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return Promise
    */
    public function delete(?DeviceManagementRequestBuilderDeleteRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
    ...
    */
    public function get(?DeviceManagementRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [RbacApplicationMultiple::class, 'createFromDiscriminatorValue'], $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
     ...
     * @return Promise
    */
    public function patch(RbacApplicationMultiple $body, ?DeviceManagementRequestBuilderPatchRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.roleManagement.deviceManagement.resourceNamespaces.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.roleManagement.deviceManagement.roleAssignments.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.roleManagement.deviceManagement.roleDefinitions.item collection
     * @param string $id Unique identifier of the item
