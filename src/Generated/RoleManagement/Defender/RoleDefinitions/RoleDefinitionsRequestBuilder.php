...
namespace Microsoft\Graph\Beta\Generated\RoleManagement\Defender\RoleDefinitions;
...
use Microsoft\Graph\Beta\Generated\RoleManagement\Defender\RoleDefinitions\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\RoleManagement\Defender\RoleDefinitions\Item\UnifiedRoleDefinitionItemRequestBuilder;
...
class RoleDefinitionsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?RoleDefinitionsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/roleManagement/defender/roleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(UnifiedRoleDefinition $body, ?RoleDefinitionsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/roleManagement/defender/roleDefinitions';
        $requestInfo->pathParameters = $this->pathParameters;
