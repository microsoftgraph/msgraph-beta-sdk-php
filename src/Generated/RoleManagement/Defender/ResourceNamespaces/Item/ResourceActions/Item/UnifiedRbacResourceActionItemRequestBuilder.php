...
use Microsoft\Graph\Beta\Generated\RoleManagement\Defender\ResourceNamespaces\Item\ResourceActions\Item\AuthenticationContext\AuthenticationContextRequestBuilder;
use Microsoft\Graph\Beta\Generated\RoleManagement\Defender\ResourceNamespaces\Item\ResourceActions\Item\ResourceScope\ResourceScopeRequestBuilder;
...
class UnifiedRbacResourceActionItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/roleManagement/defender/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}');
    ...
    */
    public function toGetRequestInformation(?UnifiedRbacResourceActionItemRequestBuilderGetRequestCo_f1530e90 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/roleManagement/defender/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
