...
/**
 * Retrieve both roleAssignmentSchedules and roleEligibilitySchedules. Original name: roleSchedulesdirectoryScopeIdDirectoryScopeIdAppScopeIdAppScopeIdPrincipalIdPrincipalIdRoleDefinitionIdRoleDefinitionIdRequestBuilderGetQueryParameters
*/
class RoleSchedulesdirectoryScopeIdDirectoryScopeIdAppScopeId_ede88404 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RoleSchedulesdirectoryScopeIdDirectoryScopeIdAppScopeId_ede88404 and sets the default values.
    ...
    */
    public function __construct(?string $appScopeId = null, ?bool $count = null, ?string $directoryScopeId = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $principalId = null, ?string $roleDefinitionId = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null) {
