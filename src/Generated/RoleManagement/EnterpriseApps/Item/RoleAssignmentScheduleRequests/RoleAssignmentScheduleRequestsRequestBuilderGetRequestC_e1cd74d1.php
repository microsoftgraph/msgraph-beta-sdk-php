...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: roleAssignmentScheduleRequestsRequestBuilderGetRequestConfiguration
*/
class RoleAssignmentScheduleRequestsRequestBuilderGetRequestC_e1cd74d1 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RoleAssignmentScheduleRequestsRequestBuilderGetRequestC_e1cd74d1 and sets the default values.
