...
class UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $unifiedRoleAssignmentScheduleInstanceId key: id of unifiedRoleAssignmentScheduleInstance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $unifiedRoleAssignmentScheduleInstanceId = null) {
        ...
        $urlTplParams['unifiedRoleAssignmentScheduleInstanceId'] = $unifiedRoleAssignmentScheduleInstanceId;
