...
class ApprovalItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $approvalId = null) {
    ...
    */
    public function stepsById(string $id): ApprovalStepItemRequestBuilder {
        ...
        return new ApprovalStepItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
