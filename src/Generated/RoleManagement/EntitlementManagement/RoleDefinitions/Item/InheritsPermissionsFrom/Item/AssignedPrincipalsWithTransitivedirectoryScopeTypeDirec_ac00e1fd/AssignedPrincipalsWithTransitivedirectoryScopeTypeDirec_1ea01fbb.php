...
/**
 * Get the list of security principals (users, groups, and service principals) that are assigned to a specific role for different scopes either directly or transitively. You can use the $count query parameter to also get the count. This API is supported for the directory (Microsoft Entra ID) provider only. To list the direct and transitive role assignments for a specific principal, use the List transitiveRoleAssignments API. Original name: assignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilderGetQueryParameters
*/
class AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_1ea01fbb 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_1ea01fbb and sets the default values.
