...
class UnifiedRoleDefinitionItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.roleManagement.entitlementManagement.roleDefinitions.item.inheritsPermissionsFrom.item collection
