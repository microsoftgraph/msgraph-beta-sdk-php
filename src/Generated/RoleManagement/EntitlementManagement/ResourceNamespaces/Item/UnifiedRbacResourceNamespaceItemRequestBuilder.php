...
use Microsoft\Graph\Beta\Generated\RoleManagement\EntitlementManagement\ResourceNamespaces\Item\MicrosoftGraphImportResourceActions\ImportResourceActionsRequestBuilder;
...
class UnifiedRbacResourceNamespaceItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphImportResourceActions(): ImportResourceActionsRequestBuilder {
    ...
    */
     ...
     * @param string|null $unifiedRbacResourceNamespaceId key: id of unifiedRbacResourceNamespace
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $unifiedRbacResourceNamespaceId = null) {
    ...
    */
    public function resourceActionsById(string $id): UnifiedRbacResourceActionItemRequestBuilder {
        ...
        return new UnifiedRbacResourceActionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
