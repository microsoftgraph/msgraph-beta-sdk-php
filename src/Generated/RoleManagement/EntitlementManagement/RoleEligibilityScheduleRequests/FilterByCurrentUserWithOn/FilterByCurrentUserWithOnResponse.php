...
class FilterByCurrentUserWithOnResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnifiedRoleEligibilityScheduleRequest>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UnifiedRoleEligibilityScheduleRequest::class)); },
        ];
    }
