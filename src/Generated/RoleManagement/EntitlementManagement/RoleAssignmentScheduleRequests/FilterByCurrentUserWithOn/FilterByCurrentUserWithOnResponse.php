...
class FilterByCurrentUserWithOnResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnifiedRoleAssignmentScheduleRequest>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UnifiedRoleAssignmentScheduleRequest::class)); },
        ];
    }
