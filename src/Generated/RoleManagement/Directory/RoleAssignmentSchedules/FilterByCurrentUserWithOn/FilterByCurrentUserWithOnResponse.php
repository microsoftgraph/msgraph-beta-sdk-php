...
class FilterByCurrentUserWithOnResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnifiedRoleAssignmentSchedule>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UnifiedRoleAssignmentSchedule::class)); },
        ];
    }
