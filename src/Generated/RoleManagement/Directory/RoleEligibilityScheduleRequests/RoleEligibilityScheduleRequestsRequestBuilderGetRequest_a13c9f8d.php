...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: roleEligibilityScheduleRequestsRequestBuilderGetRequestConfiguration
*/
class RoleEligibilityScheduleRequestsRequestBuilderGetRequest_a13c9f8d extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RoleEligibilityScheduleRequestsRequestBuilderGetRequest_a13c9f8d and sets the default values.
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): RoleEligibilityScheduleRequestsRequestBuilderGetQueryParameters {
