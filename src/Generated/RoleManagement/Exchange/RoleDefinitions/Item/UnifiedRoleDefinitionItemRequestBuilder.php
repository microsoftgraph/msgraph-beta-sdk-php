...
use Microsoft\Graph\Beta\Generated\RoleManagement\Exchange\RoleDefinitions\Item\AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_ac00e1fd\AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_c9177a9a;
...
class UnifiedRoleDefinitionItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/roleManagement/exchange/roleDefinitions/{unifiedRoleDefinition%2Did}');
    ...
    */
    public function toGetRequestInformation(?UnifiedRoleDefinitionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/roleManagement/exchange/roleDefinitions/{unifiedRoleDefinition%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
