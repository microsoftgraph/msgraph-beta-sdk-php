...
class AppScopeRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}/appScope');
    ...
    */
    public function toGetRequestInformation(?AppScopeRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}/appScope{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
