...
class UnifiedRoleAssignmentMultipleItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $unifiedRoleAssignmentMultipleId = null) {
        ...
        $urlTplParams['unifiedRoleAssignmentMultipleId'] = $unifiedRoleAssignmentMultipleId;
