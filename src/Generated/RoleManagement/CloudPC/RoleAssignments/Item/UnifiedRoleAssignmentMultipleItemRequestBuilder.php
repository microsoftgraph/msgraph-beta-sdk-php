...
class UnifiedRoleAssignmentMultipleItemRequestBuilder 
{
    ...
    */
    public function appScopesById(string $id): AppScopeItemRequestBuilder {
        ...
        return new AppScopeItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $unifiedRoleAssignmentMultipleId key: id of unifiedRoleAssignmentMultiple
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $unifiedRoleAssignmentMultipleId = null) {
        $this->urlTemplate = '{+baseurl}/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}{?%24select,%24expand}';
    ...
    */
    public function directoryScopesById(string $id): \Microsoft\Graph\Beta\Generated\RoleManagement\CloudPC\RoleAssignments\Item\DirectoryScopes\Item\DirectoryObjectItemRequestBuilder {
        ...
        return new \Microsoft\Graph\Beta\Generated\RoleManagement\CloudPC\RoleAssignments\Item\DirectoryScopes\Item\DirectoryObjectItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function principalsById(string $id): \Microsoft\Graph\Beta\Generated\RoleManagement\CloudPC\RoleAssignments\Item\Principals\Item\DirectoryObjectItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['directoryObject%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\RoleManagement\CloudPC\RoleAssignments\Item\Principals\Item\DirectoryObjectItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
