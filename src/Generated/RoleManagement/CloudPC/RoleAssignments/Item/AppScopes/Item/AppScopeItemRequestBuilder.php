...
class AppScopeItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $appScopeId key: id of appScope
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $appScopeId = null) {
