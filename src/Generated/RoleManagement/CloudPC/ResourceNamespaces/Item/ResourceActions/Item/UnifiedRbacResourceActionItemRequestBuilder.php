...
class UnifiedRbacResourceActionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $unifiedRbacResourceActionId key: id of unifiedRbacResourceAction
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $unifiedRbacResourceActionId = null) {
        ...
        $urlTplParams['unifiedRbacResourceActionId'] = $unifiedRbacResourceActionId;
