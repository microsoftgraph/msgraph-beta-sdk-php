...
namespace Microsoft\Graph\Beta\Generated\InformationProtection\DataLossPreventionPolicies\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/informationProtection/dataLossPreventionPolicies/$count{?%24search,%24filter}");
