...
class DecryptBufferRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return DecryptBufferRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DecryptBufferRequestBody {
