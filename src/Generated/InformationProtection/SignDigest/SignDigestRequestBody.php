...
class SignDigestRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return SignDigestRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SignDigestRequestBody {
