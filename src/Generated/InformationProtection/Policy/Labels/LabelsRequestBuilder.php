...
use Microsoft\Graph\Beta\Generated\InformationProtection\Policy\Labels\EvaluateRemoval\EvaluateRemovalRequestBuilder;
use Microsoft\Graph\Beta\Generated\InformationProtection\Policy\Labels\ExtractLabel\ExtractLabelRequestBuilder;
...
class LabelsRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?LabelsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @param InformationProtectionLabel $body 
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(InformationProtectionLabel $body, ?LabelsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return Promise
    */
    public function get(?LabelsRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(InformationProtectionLabelCollectionResponse::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
     ...
     * @return Promise
    */
    public function post(InformationProtectionLabel $body, ?LabelsRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(InformationProtectionLabel::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
