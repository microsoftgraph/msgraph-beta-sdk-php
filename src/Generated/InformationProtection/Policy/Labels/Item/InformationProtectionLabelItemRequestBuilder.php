...
class InformationProtectionLabelItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/informationProtection/policy/labels/{informationProtectionLabel%2Did}');
    ...
    */
    public function toGetRequestInformation(?InformationProtectionLabelItemRequestBuilderGetRequestC_24a56aab $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/informationProtection/policy/labels/{informationProtectionLabel%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
