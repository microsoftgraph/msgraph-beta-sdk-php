...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: InformationProtectionLabelItemRequestBuilderGetRequestConfiguration
*/
class InformationProtectionLabelItemRequestBuilderGetRequestC_24a56aab extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new InformationProtectionLabelItemRequestBuilderGetRequestC_24a56aab and sets the default values.
