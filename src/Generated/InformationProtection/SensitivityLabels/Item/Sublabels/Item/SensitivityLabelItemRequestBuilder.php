...
use Microsoft\Graph\Beta\Generated\InformationProtection\SensitivityLabels\Item\Sublabels\Item\Rights\RightsRequestBuilder;
...
class SensitivityLabelItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/{sensitivityLabel%2Did1}');
    ...
    */
    public function toGetRequestInformation(?SensitivityLabelItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/{sensitivityLabel%2Did1}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
