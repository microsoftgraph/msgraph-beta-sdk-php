...
class CrossTenantAccessRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/networkAccess/settings/crossTenantAccess');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/networkaccess-crosstenantaccesssettings-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<CrossTenantAccessSettings|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/networkaccess-crosstenantaccesssettings-update?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?CrossTenantAccessRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/networkAccess/settings/crossTenantAccess{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
