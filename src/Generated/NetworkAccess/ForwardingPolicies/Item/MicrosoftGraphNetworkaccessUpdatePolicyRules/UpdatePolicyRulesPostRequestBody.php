...
use Microsoft\Graph\Beta\Generated\Models\Networkaccess\PolicyRuleDelta;
...
class UpdatePolicyRulesPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdatePolicyRulesPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'rules' => fn(ParseNode $n) => $o->setRules($n->getCollectionOfObjectValues([PolicyRuleDelta::class, 'createFromDiscriminatorValue'])),
        ];
    }

    /**
     * Gets the rules property value. The rules property
     * @return array<PolicyRuleDelta>|null
    */
    public function getRules(): ?array {
        $val = $this->getBackingStore()->get('rules');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, PolicyRuleDelta::class);
            /** @var array<PolicyRuleDelta>|null $val */
            return $val;
        }
    ...
    */
     ...
     * @param array<PolicyRuleDelta>|null $value Value to set for the rules property.
    */
