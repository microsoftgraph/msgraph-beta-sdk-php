...
/**
 * Get a collection of application usage analytics data points based on aggregated traffic logs for a specified time period, providing daily breakdown of usage between cloud and enterprise applications in Global Secure Access. Original name: microsoftGraphNetworkaccessGetApplicationUsageAnalyticsWithStartDateTimeWithEndDateTimeWithAggregatedByRequestBuilderGetQueryParameters
*/
class MicrosoftGraphNetworkaccessGetApplicationUsageAnalytics_9f168b4c 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MicrosoftGraphNetworkaccessGetApplicationUsageAnalytics_9f168b4c and sets the default values.
