    ...
    */
    public function get(?MicrosoftGraphNetworkaccessGetDestinationSummariesWithStartDateTimeWithEndDateTimeWithAggregatedByRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [GetDestinationSummariesWithStartDateTimeWithEndDateTimeWithAggregatedByResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
