...
*/
class MicrosoftGraphNetworkaccessUserReportWithStartDateTimeW_1f4eb17e extends BaseRequestBuilder 
{
    /**
     * Instantiates a new MicrosoftGraphNetworkaccessUserReportWithStartDateTimeW_1f4eb17e and sets the default values.
    ...
    */
     ...
     * @param MicrosoftGraphNetworkaccessUserReportWithStartDateTimeW_0d9488c2|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<UserReportWithStartDateTimeWithEndDateTimediscoveredApp_b0d3b3c1|null>
     * @throws Exception
    */
    public function get(?MicrosoftGraphNetworkaccessUserReportWithStartDateTimeW_0d9488c2 $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        $errorMappings = [
                'XXX' => [ODataError::class, 'createFromDiscriminatorValue'],
        ];
        return $this->requestAdapter->sendAsync($requestInfo, [UserReportWithStartDateTimeWithEndDateTimediscoveredApp_b0d3b3c1::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toGetRequestInformation(?MicrosoftGraphNetworkaccessUserReportWithStartDateTimeW_0d9488c2 $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): MicrosoftGraphNetworkaccessUserReportWithStartDateTimeW_1f4eb17e {
        return new MicrosoftGraphNetworkaccessUserReportWithStartDateTimeW_1f4eb17e($rawUrl, $this->requestAdapter);
    }
