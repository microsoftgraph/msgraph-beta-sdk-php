...
class RemoteNetworksRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/networkAccess/logs/remoteNetworks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/networkaccess-remotenetworkhealthstatusevent-list?view=graph-rest-1.0 Find more info here
    */
