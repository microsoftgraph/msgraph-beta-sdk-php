...
class TrafficRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/networkAccess/logs/traffic{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/networkaccess-logs-list-traffic?view=graph-rest-1.0 Find more info here
    */
    ...
    */
     ...
     * @return TrafficRequestBuilder
    */
    public function withUrl(string $rawUrl): TrafficRequestBuilder {
        return new TrafficRequestBuilder($rawUrl, $this->requestAdapter);
    }
