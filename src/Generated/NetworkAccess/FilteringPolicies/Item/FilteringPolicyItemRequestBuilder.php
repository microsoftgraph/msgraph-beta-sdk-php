...
use Microsoft\Graph\Beta\Generated\NetworkAccess\FilteringPolicies\Item\PolicyRules\PolicyRulesRequestBuilder;
...
class FilteringPolicyItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/networkAccess/filteringPolicies/{filteringPolicy%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/networkaccess-filteringpolicy-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?FilteringPolicyItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/networkAccess/filteringPolicies/{filteringPolicy%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
