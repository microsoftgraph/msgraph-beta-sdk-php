...
*/
class CloudFirewallPoliciesRequestBuilderGetQueryParameters 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CloudFirewallPoliciesRequestBuilderGetQueryParameters and sets the default values.
