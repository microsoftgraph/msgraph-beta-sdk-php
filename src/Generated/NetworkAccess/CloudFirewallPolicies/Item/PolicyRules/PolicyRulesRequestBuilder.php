...
namespace Microsoft\Graph\Beta\Generated\NetworkAccess\CloudFirewallPolicies\Item\PolicyRules;
...
use Microsoft\Graph\Beta\Generated\NetworkAccess\CloudFirewallPolicies\Item\PolicyRules\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\NetworkAccess\CloudFirewallPolicies\Item\PolicyRules\Item\PolicyRuleItemRequestBuilder;
...
class PolicyRulesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/networkaccess-cloudfirewallpolicy-list-policyrules?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/networkaccess-cloudfirewallpolicy-post-policyrules?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?PolicyRulesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/networkAccess/cloudFirewallPolicies/{cloudFirewallPolicy%2Did}/policyRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(PolicyRule $body, ?PolicyRulesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/networkAccess/cloudFirewallPolicies/{cloudFirewallPolicy%2Did}/policyRules';
        $requestInfo->pathParameters = $this->pathParameters;
