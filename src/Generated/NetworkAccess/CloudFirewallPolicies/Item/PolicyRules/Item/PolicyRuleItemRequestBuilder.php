...
namespace Microsoft\Graph\Beta\Generated\NetworkAccess\CloudFirewallPolicies\Item\PolicyRules\Item;
...
class PolicyRuleItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/networkAccess/cloudFirewallPolicies/{cloudFirewallPolicy%2Did}/policyRules/{policyRule%2Did}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/networkaccess-cloudfirewallrule-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/networkaccess-cloudfirewallrule-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<PolicyRule|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/networkaccess-cloudfirewallrule-update?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?PolicyRuleItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/networkAccess/cloudFirewallPolicies/{cloudFirewallPolicy%2Did}/policyRules/{policyRule%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
