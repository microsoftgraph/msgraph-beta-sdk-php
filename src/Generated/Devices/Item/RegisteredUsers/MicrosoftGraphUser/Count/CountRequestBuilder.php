...
namespace Microsoft\Graph\Beta\Generated\Devices\Item\RegisteredUsers\MicrosoftGraphUser\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/devices/{device%2Did}/registeredUsers/microsoft.graph.user/$count{?%24search,%24filter}';
