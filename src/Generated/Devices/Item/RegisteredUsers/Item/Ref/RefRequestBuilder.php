...
namespace Microsoft\\Graph\\Beta\\Generated\Devices\Item\RegisteredUsers\Item\Ref;
...
class RefRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/$ref');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/device-delete-registeredusers?view=graph-rest-beta Find more info here
    */
