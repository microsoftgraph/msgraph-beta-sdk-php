...
namespace Microsoft\\Graph\\Beta\\Generated\Devices\Item\RegisteredUsers\GraphServicePrincipal;

use Exception;
use Http\Promise\Promise;
use Microsoft\\Graph\\Beta\\Generated\Devices\Item\RegisteredUsers\GraphServicePrincipal\Count\CountRequestBuilder;
...
class GraphServicePrincipalRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/devices/{device%2Did}/registeredUsers/graph.servicePrincipal{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
