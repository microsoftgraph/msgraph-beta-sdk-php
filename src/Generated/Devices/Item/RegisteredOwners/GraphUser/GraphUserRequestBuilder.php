...
namespace Microsoft\Graph\Beta\Generated\Devices\Item\RegisteredOwners\GraphUser;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Devices\Item\RegisteredOwners\GraphUser\Count\CountRequestBuilder;
...
class GraphUserRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/devices/{device%2Did}/registeredOwners/graph.user{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
