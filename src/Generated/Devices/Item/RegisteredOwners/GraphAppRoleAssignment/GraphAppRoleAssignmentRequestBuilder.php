...
namespace Microsoft\\Graph\\Beta\\Generated\Devices\Item\RegisteredOwners\GraphAppRoleAssignment;

use Exception;
use Http\Promise\Promise;
use Microsoft\\Graph\\Beta\\Generated\Devices\Item\RegisteredOwners\GraphAppRoleAssignment\Count\CountRequestBuilder;
...
class GraphAppRoleAssignmentRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/devices/{device%2Did}/registeredOwners/graph.appRoleAssignment{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
