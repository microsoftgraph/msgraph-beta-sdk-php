...
namespace Microsoft\Graph\Beta\Generated\Devices\Item\MemberOf\Item\GraphGroup;
...
class GraphGroupRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/graph.group{?%24expand,%24select}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/device-list-memberof?view=graph-rest-beta Find more info here
    */
