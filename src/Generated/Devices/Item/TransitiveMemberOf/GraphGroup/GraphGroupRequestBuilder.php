...
namespace Microsoft\\Graph\\Beta\\Generated\Devices\Item\TransitiveMemberOf\GraphGroup;

use Exception;
use Http\Promise\Promise;
use Microsoft\\Graph\\Beta\\Generated\Devices\Item\TransitiveMemberOf\GraphGroup\Count\CountRequestBuilder;
...
class GraphGroupRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/devices/{device%2Did}/transitiveMemberOf/graph.group{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/device-list-transitivememberof?view=graph-rest-beta Find more info here
    */
