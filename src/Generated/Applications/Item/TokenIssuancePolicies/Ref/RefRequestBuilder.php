...
class RefRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/applications/{application%2Did}/tokenIssuancePolicies/$ref{?%24top,%24skip,%24search,%24filter,%24count,%24orderby}');
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/application-post-tokenissuancepolicies?view=graph-rest-1.0 Find more info here
    */
