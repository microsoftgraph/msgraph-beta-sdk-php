...
use Microsoft\Graph\Beta\Generated\Applications\Item\Synchronization\Jobs\Item\Schema\Directories\Item\MicrosoftGraphDiscover\DiscoverRequestBuilder;
...
class DirectoryDefinitionItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphDiscover(): DiscoverRequestBuilder {
    ...
    */
     ...
     * @param string|null $directoryDefinitionId key: id of directoryDefinition
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $directoryDefinitionId = null) {
        ...
        $urlTplParams['directoryDefinitionId'] = $directoryDefinitionId;
