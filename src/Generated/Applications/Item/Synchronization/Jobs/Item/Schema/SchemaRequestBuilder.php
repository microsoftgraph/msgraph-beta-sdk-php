...
class SchemaRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/applications/{application_id}/synchronization/jobs/{synchronizationJob_id}/schema{?select,expand}';
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.applications.item.synchronization.jobs.item.schema.directories.item collection
