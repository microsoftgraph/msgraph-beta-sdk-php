...
class ProvisionOnDemandPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getParameters(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, SynchronizationJobApplicationParameters::class);
            /** @var array<SynchronizationJobApplicationParameters>|null $val */
            return $val;
        }
