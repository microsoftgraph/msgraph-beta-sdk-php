...
class ValidateCredentialsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return ValidateCredentialsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ValidateCredentialsRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'applicationIdentifier' => function (self $o, ParseNode $n) { $o->setApplicationIdentifier($n->getStringValue()); },
            ...
            'useSavedCredentials' => function (self $o, ParseNode $n) { $o->setUseSavedCredentials($n->getBooleanValue()); },
        ];
    }
