...
namespace Microsoft\Graph\Beta\Generated\Applications\Item\FederatedIdentityCredentialsWithName;
...
class FederatedIdentityCredentialsWithNameRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $name = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/applications/{application%2Did}/federatedIdentityCredentials(name=\'{name}\')');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/federatedidentitycredential-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/federatedidentitycredential-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<FederatedIdentityCredential|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/federatedidentitycredential-upsert?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?FederatedIdentityCredentialsWithNameRequestBuilderGetRe_cda5e15a $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/applications/{application%2Did}/federatedIdentityCredentials(name=\'{name}\'){?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
