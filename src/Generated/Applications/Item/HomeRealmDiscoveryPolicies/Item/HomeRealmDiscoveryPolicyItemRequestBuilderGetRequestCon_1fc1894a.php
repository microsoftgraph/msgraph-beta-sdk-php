...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: HomeRealmDiscoveryPolicyItemRequestBuilderGetRequestConfiguration
*/
class HomeRealmDiscoveryPolicyItemRequestBuilderGetRequestCon_1fc1894a extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new HomeRealmDiscoveryPolicyItemRequestBuilderGetRequestCon_1fc1894a and sets the default values.
