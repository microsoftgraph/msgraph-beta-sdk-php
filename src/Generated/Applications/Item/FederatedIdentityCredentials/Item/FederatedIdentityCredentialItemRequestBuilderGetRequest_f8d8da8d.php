...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: FederatedIdentityCredentialItemRequestBuilderGetRequestConfiguration
*/
class FederatedIdentityCredentialItemRequestBuilderGetRequest_f8d8da8d extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new FederatedIdentityCredentialItemRequestBuilderGetRequest_f8d8da8d and sets the default values.
