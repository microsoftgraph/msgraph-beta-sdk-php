...
*/
class DiscoverCopilotToolsRequestBuilderGetQueryParameters 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DiscoverCopilotToolsRequestBuilderGetQueryParameters and sets the default values.
