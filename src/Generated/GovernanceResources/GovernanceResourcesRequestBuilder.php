...
*/
class GovernanceResourcesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/governanceResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @param GovernanceResourcesRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<GovernanceResourceCollectionResponse|null>
     * @throws Exception
    */
    public function get(?GovernanceResourcesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
     ...
     * @param GovernanceResourcesRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<GovernanceResource|null>
     * @throws Exception
    */
    public function post(GovernanceResource $body, ?GovernanceResourcesRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?GovernanceResourcesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(GovernanceResource $body, ?GovernanceResourcesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/governanceResources';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return GovernanceResourcesRequestBuilder
    */
    public function withUrl(string $rawUrl): GovernanceResourcesRequestBuilder {
        return new GovernanceResourcesRequestBuilder($rawUrl, $this->requestAdapter);
    }
