...
class RoleDefinitionRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/governanceResources/{governanceResource_id}/roleAssignmentRequests/{governanceRoleAssignmentRequest_id}/roleDefinition{?select,expand}';
