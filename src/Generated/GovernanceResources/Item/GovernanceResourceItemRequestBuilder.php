...
class GovernanceResourceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $governanceResourceId key: id of governanceResource
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $governanceResourceId = null) {
