...
class GovernanceResourceItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $governanceResourceId = null) {
        $this->urlTemplate = '{+baseurl}/governanceResources/{governanceResource%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['governanceResourceId'] = $governanceResourceId;
