...
class LinkedEligibleRoleAssignmentRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/governanceResources/{governanceResource_id}/roleAssignments/{governanceRoleAssignment_id}/linkedEligibleRoleAssignment{?select,expand}';
