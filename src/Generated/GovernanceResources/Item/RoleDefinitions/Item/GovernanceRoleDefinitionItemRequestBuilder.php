...
class GovernanceRoleDefinitionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $governanceRoleDefinitionId key: id of governanceRoleDefinition
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $governanceRoleDefinitionId = null) {
        ...
        $urlTplParams['governanceRoleDefinitionId'] = $governanceRoleDefinitionId;
