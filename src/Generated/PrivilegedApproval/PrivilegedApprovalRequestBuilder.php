...
class PrivilegedApprovalRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/privilegedApproval{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<PrivilegedApprovalCollectionResponse|null>
     * @throws Exception
    */
     ...
     * @return Promise<PrivilegedApproval|null>
     * @throws Exception
    */
