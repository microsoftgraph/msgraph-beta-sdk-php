...
class PrivilegedApprovalItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedApprovalId key: id of privilegedApproval
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $privilegedApprovalId = null) {
        $this->urlTemplate = '{+baseurl}/privilegedApproval/{privilegedApproval%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['privilegedApprovalId'] = $privilegedApprovalId;
