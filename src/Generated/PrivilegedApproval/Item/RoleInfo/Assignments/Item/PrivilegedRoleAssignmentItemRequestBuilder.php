...
class PrivilegedRoleAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedRoleAssignmentId key: id of privilegedRoleAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $privilegedRoleAssignmentId = null) {
        ...
        $urlTplParams['privilegedRoleAssignmentId'] = $privilegedRoleAssignmentId;
