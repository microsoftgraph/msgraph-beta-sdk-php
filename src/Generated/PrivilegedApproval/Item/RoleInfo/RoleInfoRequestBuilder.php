...
class RoleInfoRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.privilegedApproval.item.roleInfo.assignments.item collection
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/privilegedApproval/{privilegedApproval_id}/roleInfo{?select,expand}';
