...
class ServiceAnnouncementRequestBuilder 
{
    ...
    */
    public function get(?ServiceAnnouncementRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [ServiceAnnouncement::class, 'createFromDiscriminatorValue'], $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.admin.serviceAnnouncement.healthOverviews.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.admin.serviceAnnouncement.issues.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.admin.serviceAnnouncement.messages.item collection
     * @param string $id Unique identifier of the item
