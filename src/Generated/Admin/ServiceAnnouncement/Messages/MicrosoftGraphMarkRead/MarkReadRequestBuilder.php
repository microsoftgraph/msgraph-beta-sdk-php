...
namespace Microsoft\Graph\Beta\Generated\Admin\ServiceAnnouncement\Messages\MicrosoftGraphMarkRead;
...
class MarkReadRequestBuilder 
{
    ...
    */
    public function post(MarkReadPostRequestBody $body, ?MarkReadRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [MarkReadResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
    ...
    */
    public function toPostRequestInformation(MarkReadPostRequestBody $body, ?MarkReadRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
