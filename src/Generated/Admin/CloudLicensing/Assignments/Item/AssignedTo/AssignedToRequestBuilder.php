...
class AssignedToRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/cloudLicensing/assignments/{assignment%2Did}/assignedTo{?%24expand,%24select}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/cloudlicensing-assignment-get-assignedto?view=graph-rest-beta Find more info here
    */
