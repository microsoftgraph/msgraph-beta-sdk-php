...
namespace Microsoft\Graph\Beta\Generated\Admin\CloudLicensing\Assignments\MicrosoftGraphCloudLicensingReprocessAssignments;
...
*/
class MicrosoftGraphCloudLicensingReprocessAssignmentsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/cloudLicensing/assignments/microsoft.graph.cloudLicensing.reprocessAssignments');
    ...
    */
    public function withUrl(string $rawUrl): MicrosoftGraphCloudLicensingReprocessAssignmentsRequestBuilder {
        return new MicrosoftGraphCloudLicensingReprocessAssignmentsRequestBuilder($rawUrl, $this->requestAdapter);
    }
