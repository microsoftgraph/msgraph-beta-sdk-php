...
class PublishRequestBuilder 
{
    ...
    */
     ...
     * @param PublishPostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(PublishPostRequestBody $body, ?PublishRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(PublishPostRequestBody $body, ?PublishRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
