...
class BrowserSharedCookieItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $browserSharedCookieId key: id of browserSharedCookie
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $browserSharedCookieId = null) {
        ...
        $urlTplParams['browserSharedCookieId'] = $browserSharedCookieId;
