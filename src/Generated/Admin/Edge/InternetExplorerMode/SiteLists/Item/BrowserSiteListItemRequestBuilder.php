...
class BrowserSiteListItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $browserSiteListId = null) {
        ...
        $urlTplParams['browserSiteListId'] = $browserSiteListId;
