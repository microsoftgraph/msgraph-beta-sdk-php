...
use Microsoft\Graph\Beta\Generated\Admin\Edge\InternetExplorerMode\SiteLists\Item\MicrosoftGraphPublish\PublishRequestBuilder;
...
class BrowserSiteListItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $browserSiteListId key: id of browserSiteList
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $browserSiteListId = null) {
    ...
    */
    public function sharedCookiesById(string $id): BrowserSharedCookieItemRequestBuilder {
        ...
        return new BrowserSharedCookieItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function sitesById(string $id): BrowserSiteItemRequestBuilder {
        ...
        return new BrowserSiteItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
