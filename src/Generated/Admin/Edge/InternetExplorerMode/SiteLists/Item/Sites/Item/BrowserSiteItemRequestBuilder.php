...
class BrowserSiteItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $browserSiteId key: id of browserSite
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $browserSiteId = null) {
        ...
        $urlTplParams['browserSiteId'] = $browserSiteId;
