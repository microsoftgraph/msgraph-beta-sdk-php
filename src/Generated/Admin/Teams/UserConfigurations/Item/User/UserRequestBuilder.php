...
namespace Microsoft\Graph\Beta\Generated\Admin\Teams\UserConfigurations\Item\User;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Admin\Teams\UserConfigurations\Item\User\MailboxSettings\MailboxSettingsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\Teams\UserConfigurations\Item\User\ServiceProvisioningErrors\ServiceProvisioningErrorsRequestBuilder;
...
class UserRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/teams/userConfigurations/{teamsUserConfiguration%2Did}/user{?%24expand,%24select}');
