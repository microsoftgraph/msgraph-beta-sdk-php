...
namespace Microsoft\Graph\Beta\Generated\Admin\Teams\TelephoneNumberManagement\Operations\Item;
...
class TelephoneNumberLongRunningOperationItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/teams/telephoneNumberManagement/operations/{telephoneNumberLongRunningOperation%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/teamsadministration-telephonenumberlongrunningoperation-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?TelephoneNumberLongRunningOperationItemRequestBuilderGe_b0fdba2d $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/teams/telephoneNumberManagement/operations/{telephoneNumberLongRunningOperation%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
