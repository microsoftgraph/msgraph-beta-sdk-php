...
class OperationsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the operations property of the microsoft.graph.teamsAdministration.telephoneNumberManagementRoot entity.
     * @param string $telephoneNumberLongRunningOperationId The unique identifier of telephoneNumberLongRunningOperation
     * @return TelephoneNumberLongRunningOperationItemRequestBuilder
    */
    public function byTelephoneNumberLongRunningOperationId(string $telephoneNumberLongRunningOperationId): TelephoneNumberLongRunningOperationItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['telephoneNumberLongRunningOperation%2Did'] = $telephoneNumberLongRunningOperationId;
        return new TelephoneNumberLongRunningOperationItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
    ...
    */
     ...
     * @return Promise<TelephoneNumberLongRunningOperationCollectionResponse|null>
     * @throws Exception
    */
    public function get(?OperationsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [TelephoneNumberLongRunningOperationCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
     ...
     * @throws Exception
    */
    public function post(TelephoneNumberLongRunningOperation $body, ?OperationsRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?OperationsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/admin/teams/telephoneNumberManagement/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(TelephoneNumberLongRunningOperation $body, ?OperationsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/teams/telephoneNumberManagement/operations';
        $requestInfo->pathParameters = $this->pathParameters;
