    ...
    */
    public function get(?WindowsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [Windows::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
     ...
     * @return Promise
    */
    public function patch(Windows $body, ?WindowsRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
