...
class UpdatesRequestBuilderGetRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?array $expand = null, ?array $select = null): UpdatesRequestBuilderGetQueryParameters {
        return new UpdatesRequestBuilderGetQueryParameters($expand, $select);
    }
