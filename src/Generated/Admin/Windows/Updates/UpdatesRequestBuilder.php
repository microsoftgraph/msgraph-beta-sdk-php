    ...
    */
    public function get(?UpdatesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [Updates::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
     ...
     * @return Promise
    */
    public function patch(Updates $body, ?UpdatesRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
