...
namespace Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\DeploymentAudiences\Item\MicrosoftGraphWindowsUpdatesUpdateAudience;
...
class MicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/microsoft.graph.windowsUpdates.updateAudience');
     ...
     * @param MicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilde_c9bd876e|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<void|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/windowsupdates-deploymentaudience-updateaudience?view=graph-rest-beta Find more info here
    */
    public function post(UpdateAudiencePostRequestBody $body, ?MicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilde_c9bd876e $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(UpdateAudiencePostRequestBody $body, ?MicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilde_c9bd876e $requestConfiguration = null): RequestInformation {
