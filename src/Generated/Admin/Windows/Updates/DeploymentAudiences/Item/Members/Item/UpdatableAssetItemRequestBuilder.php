...
namespace Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\DeploymentAudiences\Item\Members\Item;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\DeploymentAudiences\Item\Members\Item\MicrosoftGraphWindowsUpdatesAddMembers\AddMembersRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\DeploymentAudiences\Item\Members\Item\MicrosoftGraphWindowsUpdatesAddMembersById\AddMembersByIdRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\DeploymentAudiences\Item\Members\Item\MicrosoftGraphWindowsUpdatesRemoveMembers\RemoveMembersRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\DeploymentAudiences\Item\Members\Item\MicrosoftGraphWindowsUpdatesRemoveMembersById\RemoveMembersByIdRequestBuilder;
...
class UpdatableAssetItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphWindowsUpdatesAddMembers(): AddMembersRequestBuilder {
    ...
    */
    public function microsoftGraphWindowsUpdatesAddMembersById(): AddMembersByIdRequestBuilder {
    ...
    */
    public function microsoftGraphWindowsUpdatesRemoveMembers(): RemoveMembersRequestBuilder {
    ...
    */
    public function microsoftGraphWindowsUpdatesRemoveMembersById(): RemoveMembersByIdRequestBuilder {
    ...
    */
     ...
     * @param string|null $updatableAssetId key: id of updatableAsset
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $updatableAssetId = null) {
        $this->urlTemplate = '{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/{updatableAsset%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['updatableAssetId'] = $updatableAssetId;
