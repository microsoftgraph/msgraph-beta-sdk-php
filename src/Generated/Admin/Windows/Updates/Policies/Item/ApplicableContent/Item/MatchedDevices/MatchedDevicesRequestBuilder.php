...
namespace Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\Policies\Item\ApplicableContent\Item\MatchedDevices;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\Policies\Item\ApplicableContent\Item\MatchedDevices\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\Policies\Item\ApplicableContent\Item\MatchedDevices\Item\ApplicableContentDeviceMatchDeviceItemRequestBuilder;
...
class MatchedDevicesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?MatchedDevicesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/admin/windows/updates/policies/{policy%2Did}/applicableContent/{applicableContent%2DcatalogEntryId}/matchedDevices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ApplicableContentDeviceMatch $body, ?MatchedDevicesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/windows/updates/policies/{policy%2Did}/applicableContent/{applicableContent%2DcatalogEntryId}/matchedDevices';
        $requestInfo->pathParameters = $this->pathParameters;
