...
use Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\Policies\Item\ApplicableContent\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\Policies\Item\ApplicableContent\Item\ApplicableContentCatalogEntryItemRequestBuilder;
...
class ApplicableContentRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/windowsupdates-policy-list-applicablecontent?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?ApplicableContentRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/admin/windows/updates/policies/{policy%2Did}/applicableContent{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ApplicableContent $body, ?ApplicableContentRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/windows/updates/policies/{policy%2Did}/applicableContent';
        $requestInfo->pathParameters = $this->pathParameters;
