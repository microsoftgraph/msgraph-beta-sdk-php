...
use Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\Policies\Item\ApplicableContent\Item\CatalogEntry\CatalogEntryRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\Windows\Updates\Policies\Item\ApplicableContent\Item\MatchedDevices\MatchedDevicesRequestBuilder;
...
class ApplicableContentCatalogEntryItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/windows/updates/policies/{policy%2Did}/applicableContent/{applicableContent%2DcatalogEntryId}');
    ...
    */
    public function toGetRequestInformation(?ApplicableContentCatalogEntryItemRequestBuilderGetReque_060c92af $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/windows/updates/policies/{policy%2Did}/applicableContent/{applicableContent%2DcatalogEntryId}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
