...
class UpdatePolicyItemRequestBuilder 
{
    ...
    */
    public function complianceChangesById(string $id): ComplianceChangeItemRequestBuilder {
        ...
        return new ComplianceChangeItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $updatePolicyId key: id of updatePolicy
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $updatePolicyId = null) {
