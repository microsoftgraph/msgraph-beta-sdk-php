...
*/
class ComplianceChangesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/complianceChanges{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
     ...
     * @return Promise
     * @link https://learn.microsoft.com/graph/api/windowsupdates-updatepolicy-list-compliancechanges?view=graph-rest-1.0 Find more info here
    */
    public function get(?ComplianceChangesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [ComplianceChangeCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
     ...
     * @return Promise
     * @link https://learn.microsoft.com/graph/api/windowsupdates-updatepolicy-post-compliancechanges-contentapproval?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?ComplianceChangesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
     ...
     * @return ComplianceChangesRequestBuilder
    */
    public function withUrl(string $rawUrl): ComplianceChangesRequestBuilder {
        return new ComplianceChangesRequestBuilder($rawUrl, $this->requestAdapter);
    }
