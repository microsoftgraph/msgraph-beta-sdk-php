...
class ComplianceChangeItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $complianceChangeId key: id of complianceChange
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $complianceChangeId = null) {
        ...
        $urlTplParams['complianceChangeId'] = $complianceChangeId;
