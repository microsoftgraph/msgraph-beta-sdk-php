...
class DeploymentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deploymentId key: id of deployment
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deploymentId = null) {
