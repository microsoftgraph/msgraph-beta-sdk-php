...
class UpdateAudienceRequestBuilder 
{
    ...
    */
     ...
     * @param UpdateAudiencePostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(UpdateAudiencePostRequestBody $body, ?UpdateAudienceRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(UpdateAudiencePostRequestBody $body, ?UpdateAudienceRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
