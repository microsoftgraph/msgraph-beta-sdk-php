...
class CatalogEntryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $catalogEntryId key: id of catalogEntry
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $catalogEntryId = null) {
        $this->urlTemplate = '{+baseurl}/admin/windows/updates/catalog/entries/{catalogEntry%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['catalogEntryId'] = $catalogEntryId;
