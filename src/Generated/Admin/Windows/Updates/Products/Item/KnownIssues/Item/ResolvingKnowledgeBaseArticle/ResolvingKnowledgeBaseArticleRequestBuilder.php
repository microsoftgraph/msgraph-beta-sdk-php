...
*/
class ResolvingKnowledgeBaseArticleRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/windows/updates/products/{product%2Did}/knownIssues/{knownIssue%2Did}/resolvingKnowledgeBaseArticle{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?ResolvingKnowledgeBaseArticleRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/admin/windows/updates/products/{product%2Did}/knownIssues/{knownIssue%2Did}/resolvingKnowledgeBaseArticle';
    ...
    */
     ...
     * @return ResolvingKnowledgeBaseArticleRequestBuilder
    */
    public function withUrl(string $rawUrl): ResolvingKnowledgeBaseArticleRequestBuilder {
        return new ResolvingKnowledgeBaseArticleRequestBuilder($rawUrl, $this->requestAdapter);
    }
