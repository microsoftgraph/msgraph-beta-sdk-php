...
class ResourceConnectionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $resourceConnectionId key: id of resourceConnection
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $resourceConnectionId = null) {
        ...
        $urlTplParams['resourceConnectionId'] = $resourceConnectionId;
