...
namespace Microsoft\Graph\Beta\Generated\Admin\Todo;
...
class TodoRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/todo{?%24expand,%24select}');
    ...
    */
    public function get(?TodoRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [AdminTodo::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toDeleteRequestInformation(?TodoRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/admin/todo';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(AdminTodo $body, ?TodoRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/todo';
        $requestInfo->pathParameters = $this->pathParameters;
