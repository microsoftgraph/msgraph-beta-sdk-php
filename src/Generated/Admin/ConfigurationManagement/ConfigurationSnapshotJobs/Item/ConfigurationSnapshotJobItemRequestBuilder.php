...
class ConfigurationSnapshotJobItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/configurationsnapshotjob-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/configurationsnapshotjob-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?ConfigurationSnapshotJobItemRequestBuilderGetRequestCon_9a00b865 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/configurationManagement/configurationSnapshotJobs/{configurationSnapshotJob%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
