...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ConfigurationSnapshotJobItemRequestBuilderGetRequestConfiguration
*/
class ConfigurationSnapshotJobItemRequestBuilderGetRequestCon_9a00b865 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ConfigurationSnapshotJobItemRequestBuilderGetRequestCon_9a00b865 and sets the default values.
