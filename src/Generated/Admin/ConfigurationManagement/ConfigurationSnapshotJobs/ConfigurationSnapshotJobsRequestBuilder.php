...
use Microsoft\Graph\Beta\Generated\Admin\ConfigurationManagement\ConfigurationSnapshotJobs\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\ConfigurationManagement\ConfigurationSnapshotJobs\Item\ConfigurationSnapshotJobItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\ConfigurationSnapshotJob;
use Microsoft\Graph\Beta\Generated\Models\ConfigurationSnapshotJobCollectionResponse;
...
class ConfigurationSnapshotJobsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function byConfigurationSnapshotJobId(string $configurationSnapshotJobId): ConfigurationSnapshotJobItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['configurationSnapshotJob%2Did'] = $configurationSnapshotJobId;
        return new ConfigurationSnapshotJobItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
    ...
    */
    public function get(?ConfigurationSnapshotJobsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [ConfigurationSnapshotJobCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toGetRequestInformation(?ConfigurationSnapshotJobsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/configurationManagement/configurationSnapshotJobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ConfigurationSnapshotJob $body, ?ConfigurationSnapshotJobsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/configurationManagement/configurationSnapshotJobs';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return ConfigurationSnapshotJobsRequestBuilder
    */
    public function withUrl(string $rawUrl): ConfigurationSnapshotJobsRequestBuilder {
        return new ConfigurationSnapshotJobsRequestBuilder($rawUrl, $this->requestAdapter);
    }
