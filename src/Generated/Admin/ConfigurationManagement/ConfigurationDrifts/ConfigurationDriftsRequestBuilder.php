...
use Microsoft\Graph\Beta\Generated\Admin\ConfigurationManagement\ConfigurationDrifts\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\ConfigurationManagement\ConfigurationDrifts\Item\ConfigurationDriftItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\ConfigurationDrift;
use Microsoft\Graph\Beta\Generated\Models\ConfigurationDriftCollectionResponse;
...
class ConfigurationDriftsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?ConfigurationDriftsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/admin/configurationManagement/configurationDrifts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ConfigurationDrift $body, ?ConfigurationDriftsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/configurationManagement/configurationDrifts';
        $requestInfo->pathParameters = $this->pathParameters;
