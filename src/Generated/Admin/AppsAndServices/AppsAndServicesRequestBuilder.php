...
class AppsAndServicesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/appsAndServices{?%24expand,%24select}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/adminappsandservices-get?view=graph-rest-1.0 Find more info here
    */
     ...
     * @return Promise<AdminAppsAndServices|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/adminappsandservices-update?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function toDeleteRequestInformation(?AppsAndServicesRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/admin/appsAndServices';
    ...
    */
     ...
     * @return AppsAndServicesRequestBuilder
    */
    public function withUrl(string $rawUrl): AppsAndServicesRequestBuilder {
        return new AppsAndServicesRequestBuilder($rawUrl, $this->requestAdapter);
    }
