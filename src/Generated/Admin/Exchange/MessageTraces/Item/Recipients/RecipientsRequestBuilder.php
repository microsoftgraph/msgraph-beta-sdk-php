...
namespace Microsoft\Graph\Beta\Generated\Admin\Exchange\MessageTraces\Item\Recipients;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Admin\Exchange\MessageTraces\Item\Recipients\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\Exchange\MessageTraces\Item\Recipients\Item\MessageRecipientItemRequestBuilder;
...
class RecipientsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?RecipientsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/admin/exchange/messageTraces/{messageTrace%2Did}/recipients{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(MessageRecipient $body, ?RecipientsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/exchange/messageTraces/{messageTrace%2Did}/recipients';
        $requestInfo->pathParameters = $this->pathParameters;
