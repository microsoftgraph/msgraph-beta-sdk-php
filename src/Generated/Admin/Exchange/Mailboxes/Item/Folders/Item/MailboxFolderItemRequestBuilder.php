...
class MailboxFolderItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/mailbox-delete-folders?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @return Promise<MailboxFolder|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/mailboxfolder-update?view=graph-rest-beta Find more info here
    */
