...
class ExportItemsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ExportItemsPostRequestBody {
    ...
    */
    public function getItemIds(): ?array {
        $val = $this->getBackingStore()->get('itemIds');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'itemIds'");
    }
    ...
    */
    public function setItemIds(?array $value): void {
        $this->getBackingStore()->set('itemIds', $value);
    }
