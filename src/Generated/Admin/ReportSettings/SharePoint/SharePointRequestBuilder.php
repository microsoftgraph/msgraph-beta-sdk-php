...
namespace Microsoft\Graph\Beta\Generated\Admin\ReportSettings\SharePoint;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Admin\ReportSettings\SharePoint\ApiUsageReportMetrics\ApiUsageReportMetricsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\ReportSettings\SharePoint\DisableApiUsageReport\DisableApiUsageReportRequestBuilder;
use Microsoft\Graph\Beta\Generated\Admin\ReportSettings\SharePoint\EnableApiUsageReport\EnableApiUsageReportRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\SharePointReportSettings;
...
class SharePointRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function apiUsageReportMetrics(): ApiUsageReportMetricsRequestBuilder {
        return new ApiUsageReportMetricsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the disableApiUsageReport method.
    */
    public function disableApiUsageReport(): DisableApiUsageReportRequestBuilder {
        return new DisableApiUsageReportRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the enableApiUsageReport method.
    */
    public function enableApiUsageReport(): EnableApiUsageReportRequestBuilder {
        return new EnableApiUsageReportRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/admin/reportSettings/sharePoint');
    ...
    */
     ...
     * @return Promise<SharePointReportSettings|null>
     * @throws Exception
    */
    public function get(?SharePointRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [SharePointReportSettings::class, 'createFromDiscriminatorValue'], $errorMappings);
    }

    /**
     * Update the navigation property sharePoint in admin
     * @param SharePointReportSettings $body The request body
     ...
     * @throws Exception
    */
    public function patch(SharePointReportSettings $body, ?SharePointRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?SharePointRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/admin/reportSettings/sharePoint{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(SharePointReportSettings $body, ?SharePointRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
