...
namespace Microsoft\Graph\Beta\Generated\Admin\ReportSettings\SharePoint\DisableApiUsageReport;
...
class DisableApiUsageReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DisableApiUsageReportPostRequestBody and sets the default values.
    */
     ...
     * @return DisableApiUsageReportPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DisableApiUsageReportPostRequestBody {
