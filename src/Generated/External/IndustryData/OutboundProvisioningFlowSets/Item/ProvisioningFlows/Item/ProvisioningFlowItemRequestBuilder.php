...
use Microsoft\Graph\Beta\Generated\External\IndustryData\OutboundProvisioningFlowSets\Item\ProvisioningFlows\Item\MicrosoftGraphIndustryDataReset\MicrosoftGraphIndustryDataResetRequestBuilder;
...
*/
class ProvisioningFlowItemRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Provides operations to call the reset method.
    */
    public function microsoftGraphIndustryDataReset(): MicrosoftGraphIndustryDataResetRequestBuilder {
        return new MicrosoftGraphIndustryDataResetRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/external/industryData/outboundProvisioningFlowSets/{outboundProvisioningFlowSet%2Did}/provisioningFlows/{provisioningFlow%2Did}');
    ...
    */
    public function toDeleteRequestInformation(?ProvisioningFlowItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?ProvisioningFlowItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/external/industryData/outboundProvisioningFlowSets/{outboundProvisioningFlowSet%2Did}/provisioningFlows/{provisioningFlow%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(ProvisioningFlow $body, ?ProvisioningFlowItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): ProvisioningFlowItemRequestBuilder {
        return new ProvisioningFlowItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
