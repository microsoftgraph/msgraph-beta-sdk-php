...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: OutboundProvisioningFlowSetItemRequestBuilderGetRequestConfiguration
*/
class OutboundProvisioningFlowSetItemRequestBuilderGetRequest_650a2ba3 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OutboundProvisioningFlowSetItemRequestBuilderGetRequest_650a2ba3 and sets the default values.
