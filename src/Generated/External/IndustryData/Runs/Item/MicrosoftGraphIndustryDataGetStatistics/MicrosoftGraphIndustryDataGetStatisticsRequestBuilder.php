...
namespace Microsoft\\Graph\\Beta\\Generated\External\IndustryData\Runs\Item\MicrosoftGraphIndustryDataGetStatistics;
...
*/
class MicrosoftGraphIndustryDataGetStatisticsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/microsoft.graph.industryData.getStatistics()');
    ...
    */
     ...
     * @return MicrosoftGraphIndustryDataGetStatisticsRequestBuilder
    */
    public function withUrl(string $rawUrl): MicrosoftGraphIndustryDataGetStatisticsRequestBuilder {
        return new MicrosoftGraphIndustryDataGetStatisticsRequestBuilder($rawUrl, $this->requestAdapter);
    }
