...
use Microsoft\Graph\Beta\Generated\Models\IndustryData\IndustryDataActivity;
...
class ActivityRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities/{industryDataRunActivity%2Did}/activity{?%24select,%24expand}');
     ...
     * @return Promise<IndustryDataActivity|null>
     * @throws Exception
    */
    public function get(?ActivityRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [IndustryDataActivity::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
