...
namespace Microsoft\Graph\Beta\Generated\External\IndustryData\Runs\Item\Activities;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\External\IndustryData\Runs\Item\Activities\Count\CountRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\Models\IndustryData\IndustryDataRunActivityCollectionResponse;
...
class ActivitiesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
     ...
     * @return Promise<IndustryDataRunActivityCollectionResponse|null>
     * @throws Exception
    */
    public function get(?ActivitiesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [IndustryDataRunActivityCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
