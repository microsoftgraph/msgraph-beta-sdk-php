...
*/
class SourceSystemsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/external/industryData/sourceSystems{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/industrydata-sourcesystemdefinition-list?view=graph-rest-1.0 Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/industrydata-sourcesystemdefinition-post?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function toPostRequestInformation(SourceSystemDefinition $body, ?SourceSystemsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/external/industryData/sourceSystems';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return SourceSystemsRequestBuilder
    */
    public function withUrl(string $rawUrl): SourceSystemsRequestBuilder {
        return new SourceSystemsRequestBuilder($rawUrl, $this->requestAdapter);
    }
