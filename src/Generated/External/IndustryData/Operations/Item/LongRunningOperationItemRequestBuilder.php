...
class LongRunningOperationItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/external/industryData/operations/{longRunningOperation%2Did}{?%24expand,%24select}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/industrydata-filevalidateoperation-get?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function toDeleteRequestInformation(?LongRunningOperationItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/external/industryData/operations/{longRunningOperation%2Did}';
