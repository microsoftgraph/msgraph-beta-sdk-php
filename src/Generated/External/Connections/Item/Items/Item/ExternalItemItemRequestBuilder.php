...
use Microsoft\Graph\Beta\Generated\External\Connections\Item\Items\Item\MicrosoftGraphExternalConnectorsAddActivities\AddActivitiesRequestBuilder;
...
class ExternalItemItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphExternalConnectorsAddActivities(): AddActivitiesRequestBuilder {
    ...
    */
    public function activitiesById(string $id): ExternalActivityItemRequestBuilder {
        ...
        return new ExternalActivityItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $externalItemId = null) {
