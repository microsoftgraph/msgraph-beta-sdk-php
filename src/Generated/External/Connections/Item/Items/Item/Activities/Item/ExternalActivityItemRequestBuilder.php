...
class ExternalActivityItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $externalActivityId key: id of externalActivity
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $externalActivityId = null) {
        ...
        $urlTplParams['externalActivityId'] = $externalActivityId;
