...
class DeviceManagementComplianceScheduledActionForRuleItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceManagementComplianceScheduledActionForRuleId = null) {
    ...
    */
    public function scheduledActionConfigurationsById(string $id): DeviceManagementComplianceActionItemItemRequestBuilder {
        ...
        return new DeviceManagementComplianceActionItemItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
