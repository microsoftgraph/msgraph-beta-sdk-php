...
class DeviceManagementComplianceScheduledActionForRuleItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementComplianceScheduledActionForRuleId key: id of deviceManagementComplianceScheduledActionForRule
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementComplianceScheduledActionForRuleId = null) {
        ...
        $urlTplParams['deviceManagementComplianceScheduledActionForRuleId'] = $deviceManagementComplianceScheduledActionForRuleId;
