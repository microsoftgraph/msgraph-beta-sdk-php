...
class DeviceManagementComplianceActionItemItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementComplianceActionItemId key: id of deviceManagementComplianceActionItem
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementComplianceActionItemId = null) {
        ...
        $urlTplParams['deviceManagementComplianceActionItemId'] = $deviceManagementComplianceActionItemId;
