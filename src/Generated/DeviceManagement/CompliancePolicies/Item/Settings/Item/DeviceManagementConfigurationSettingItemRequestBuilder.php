...
class DeviceManagementConfigurationSettingItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementConfigurationSettingId key: id of deviceManagementConfigurationSetting
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceManagementConfigurationSettingId = null) {
    ...
    */
    public function settingDefinitionsById(string $id): DeviceManagementConfigurationSettingDefinitionItemRequestBuilder {
        ...
        return new DeviceManagementConfigurationSettingDefinitionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
