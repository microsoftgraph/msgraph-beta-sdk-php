...
use Microsoft\Graph\Beta\Generated\DeviceManagement\CompliancePolicies\Item\MicrosoftGraphAssign\AssignRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\CompliancePolicies\Item\MicrosoftGraphSetScheduledActions\SetScheduledActionsRequestBuilder;
...
class DeviceManagementCompliancePolicyItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphSetScheduledActions(): SetScheduledActionsRequestBuilder {
    ...
    */
    public function assignmentsById(string $id): DeviceManagementConfigurationPolicyAssignmentItemRequestBuilder {
        ...
        return new DeviceManagementConfigurationPolicyAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $deviceManagementCompliancePolicyId key: id of deviceManagementCompliancePolicy
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceManagementCompliancePolicyId = null) {
     ...
     * @return Promise
    */
    public function delete(?DeviceManagementCompliancePolicyItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): Promise {
     ...
     * @return Promise
    */
    public function get(?DeviceManagementCompliancePolicyItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
     ...
     * @return Promise
    */
    public function patch(DeviceManagementCompliancePolicy $body, ?DeviceManagementCompliancePolicyItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function scheduledActionsForRuleById(string $id): DeviceManagementComplianceScheduledActionForRuleItemRequestBuilder {
        ...
        return new DeviceManagementComplianceScheduledActionForRuleItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function settingsById(string $id): DeviceManagementConfigurationSettingItemRequestBuilder {
        ...
        return new DeviceManagementConfigurationSettingItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function toDeleteRequestInformation(?DeviceManagementCompliancePolicyItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?DeviceManagementCompliancePolicyItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(DeviceManagementCompliancePolicy $body, ?DeviceManagementCompliancePolicyItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
