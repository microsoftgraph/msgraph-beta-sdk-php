...
class UserExperienceAnalyticsRemoteConnectionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsRemoteConnectionId key: id of userExperienceAnalyticsRemoteConnection
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsRemoteConnectionId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsRemoteConnectionId'] = $userExperienceAnalyticsRemoteConnectionId;
