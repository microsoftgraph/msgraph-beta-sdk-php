...
class GroupPolicyConfigurationAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $groupPolicyConfigurationAssignmentId key: id of groupPolicyConfigurationAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $groupPolicyConfigurationAssignmentId = null) {
        ...
        $urlTplParams['groupPolicyConfigurationAssignmentId'] = $groupPolicyConfigurationAssignmentId;
