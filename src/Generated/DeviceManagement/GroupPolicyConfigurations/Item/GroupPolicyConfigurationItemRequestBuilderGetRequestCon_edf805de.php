...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: GroupPolicyConfigurationItemRequestBuilderGetRequestConfiguration
*/
class GroupPolicyConfigurationItemRequestBuilderGetRequestCon_edf805de extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GroupPolicyConfigurationItemRequestBuilderGetRequestCon_edf805de and sets the default values.
