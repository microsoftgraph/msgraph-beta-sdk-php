...
class GroupPolicyDefinitionValueItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $groupPolicyDefinitionValueId key: id of groupPolicyDefinitionValue
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $groupPolicyDefinitionValueId = null) {
    ...
    */
    public function presentationValuesById(string $id): GroupPolicyPresentationValueItemRequestBuilder {
        ...
        return new GroupPolicyPresentationValueItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
