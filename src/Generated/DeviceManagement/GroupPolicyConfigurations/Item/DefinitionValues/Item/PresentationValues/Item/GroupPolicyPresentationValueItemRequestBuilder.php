...
class GroupPolicyPresentationValueItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $groupPolicyPresentationValueId key: id of groupPolicyPresentationValue
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $groupPolicyPresentationValueId = null) {
        ...
        $urlTplParams['groupPolicyPresentationValueId'] = $groupPolicyPresentationValueId;
