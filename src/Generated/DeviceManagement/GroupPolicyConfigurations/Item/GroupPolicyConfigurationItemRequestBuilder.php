...
use Microsoft\Graph\Beta\Generated\DeviceManagement\GroupPolicyConfigurations\Item\MicrosoftGraphAssign\AssignRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\GroupPolicyConfigurations\Item\MicrosoftGraphUpdateDefinitionValues\UpdateDefinitionValuesRequestBuilder;
...
class GroupPolicyConfigurationItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphUpdateDefinitionValues(): UpdateDefinitionValuesRequestBuilder {
    ...
    */
    public function assignmentsById(string $id): GroupPolicyConfigurationAssignmentItemRequestBuilder {
        ...
        return new GroupPolicyConfigurationAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $groupPolicyConfigurationId key: id of groupPolicyConfiguration
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $groupPolicyConfigurationId = null) {
    ...
    */
    public function definitionValuesById(string $id): GroupPolicyDefinitionValueItemRequestBuilder {
        ...
        return new GroupPolicyDefinitionValueItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
