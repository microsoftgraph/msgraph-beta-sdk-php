...
class GroupPolicyConfigurationItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $groupPolicyConfigurationId = null) {
        ...
        $urlTplParams['groupPolicyConfigurationId'] = $groupPolicyConfigurationId;
