...
class UserExperienceAnalyticsCategoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsCategoryId key: id of userExperienceAnalyticsCategory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsCategoryId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsCategoryId'] = $userExperienceAnalyticsCategoryId;
