...
class GroupPolicyDefinitionItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $groupPolicyDefinitionId = null) {
        ...
        $urlTplParams['groupPolicyDefinitionId'] = $groupPolicyDefinitionId;
