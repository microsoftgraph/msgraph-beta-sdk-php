...
class GroupPolicyDefinitionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $groupPolicyDefinitionId key: id of groupPolicyDefinition
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $groupPolicyDefinitionId = null) {
