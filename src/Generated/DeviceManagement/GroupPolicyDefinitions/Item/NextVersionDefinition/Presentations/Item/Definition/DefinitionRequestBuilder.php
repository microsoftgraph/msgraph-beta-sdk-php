...
class DefinitionRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition_id}/nextVersionDefinition/presentations/{groupPolicyPresentation_id}/definition{?select,expand}';
