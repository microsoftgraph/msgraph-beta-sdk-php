...
class NextVersionDefinitionRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition_id}/previousVersionDefinition/nextVersionDefinition{?select,expand}';
