...
class GroupPolicyPresentationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $groupPolicyPresentationId key: id of groupPolicyPresentation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $groupPolicyPresentationId = null) {
        ...
        $urlTplParams['groupPolicyPresentationId'] = $groupPolicyPresentationId;
