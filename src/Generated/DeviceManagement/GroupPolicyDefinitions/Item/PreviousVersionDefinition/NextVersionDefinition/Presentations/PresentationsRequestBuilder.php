...
class PresentationsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition/nextVersionDefinition/presentations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<GroupPolicyPresentationCollectionResponse|null>
     * @throws Exception
    */
    ...
    */
    public function toPostRequestInformation(GroupPolicyPresentation $body, ?PresentationsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition/nextVersionDefinition/presentations';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return PresentationsRequestBuilder
    */
    public function withUrl(string $rawUrl): PresentationsRequestBuilder {
        return new PresentationsRequestBuilder($rawUrl, $this->requestAdapter);
    }
