...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: localizedNotificationMessagesRequestBuilderGetRequestConfiguration
*/
class LocalizedNotificationMessagesRequestBuilderGetRequestCo_0f08689c extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new LocalizedNotificationMessagesRequestBuilderGetRequestCo_0f08689c and sets the default values.
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): LocalizedNotificationMessagesRequestBuilderGetQueryParameters {
