...
*/
class GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function withUrl(string $rawUrl): GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder {
        return new GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder($rawUrl, $this->requestAdapter);
    }
