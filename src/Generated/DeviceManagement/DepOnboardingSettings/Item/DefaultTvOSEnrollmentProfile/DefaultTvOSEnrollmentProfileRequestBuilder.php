...
use Microsoft\Graph\Beta\Generated\Models\DepTvOSEnrollmentProfile;
...
*/
class DefaultTvOSEnrollmentProfileRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/depOnboardingSettings/{depOnboardingSetting%2Did}/defaultTvOSEnrollmentProfile{?%24expand,%24select}');
    ...
    */
    public function get(?DefaultTvOSEnrollmentProfileRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DepTvOSEnrollmentProfile::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function withUrl(string $rawUrl): DefaultTvOSEnrollmentProfileRequestBuilder {
        return new DefaultTvOSEnrollmentProfileRequestBuilder($rawUrl, $this->requestAdapter);
    }
