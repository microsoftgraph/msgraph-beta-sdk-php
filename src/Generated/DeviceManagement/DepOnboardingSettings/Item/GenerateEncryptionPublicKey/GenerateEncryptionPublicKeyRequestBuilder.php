...
class GenerateEncryptionPublicKeyRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/depOnboardingSettings/{depOnboardingSetting_id}/microsoft.graph.generateEncryptionPublicKey';
    ...
    */
    public function post(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, GenerateEncryptionPublicKeyResponse::class, $responseHandler);
        } catch(Exception $ex) {
