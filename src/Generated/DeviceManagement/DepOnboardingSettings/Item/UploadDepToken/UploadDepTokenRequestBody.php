...
class UploadDepTokenRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UploadDepTokenRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UploadDepTokenRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'depToken' => function (self $o, ParseNode $n) { $o->setDepToken($n->getStringValue()); },
        ];
    }
