...
class UpdateDeviceProfileAssignmentRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UpdateDeviceProfileAssignmentRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UpdateDeviceProfileAssignmentRequestBody {
