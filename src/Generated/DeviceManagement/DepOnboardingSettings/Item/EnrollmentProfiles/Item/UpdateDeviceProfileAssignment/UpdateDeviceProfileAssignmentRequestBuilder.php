...
*/
class UpdateDeviceProfileAssignmentRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/depOnboardingSettings/{depOnboardingSetting%2Did}/enrollmentProfiles/{enrollmentProfile%2Did}/updateDeviceProfileAssignment');
    ...
    */
     ...
     * @return UpdateDeviceProfileAssignmentRequestBuilder
    */
    public function withUrl(string $rawUrl): UpdateDeviceProfileAssignmentRequestBuilder {
        return new UpdateDeviceProfileAssignmentRequestBuilder($rawUrl, $this->requestAdapter);
    }
