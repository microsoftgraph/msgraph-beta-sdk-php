...
class UpdateDeviceProfileAssignmentPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdateDeviceProfileAssignmentPostRequestBody {
