...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DepOnboardingSettings\Item\EnrollmentProfiles\Item\MicrosoftGraphExportMobileConfig\MicrosoftGraphExportMobileConfigRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DepOnboardingSettings\Item\EnrollmentProfiles\Item\MicrosoftGraphSetDefaultProfile\MicrosoftGraphSetDefaultProfileRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DepOnboardingSettings\Item\EnrollmentProfiles\Item\MicrosoftGraphUpdateDeviceProfileAssignment\MicrosoftGraphUpdateDeviceProfileAssignmentRequestBuilder;
...
class EnrollmentProfileItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphExportMobileConfig(): MicrosoftGraphExportMobileConfigRequestBuilder {
        return new MicrosoftGraphExportMobileConfigRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the setDefaultProfile method.
    */
    public function microsoftGraphSetDefaultProfile(): MicrosoftGraphSetDefaultProfileRequestBuilder {
        return new MicrosoftGraphSetDefaultProfileRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the updateDeviceProfileAssignment method.
    */
    public function microsoftGraphUpdateDeviceProfileAssignment(): MicrosoftGraphUpdateDeviceProfileAssignmentRequestBuilder {
        return new MicrosoftGraphUpdateDeviceProfileAssignmentRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
