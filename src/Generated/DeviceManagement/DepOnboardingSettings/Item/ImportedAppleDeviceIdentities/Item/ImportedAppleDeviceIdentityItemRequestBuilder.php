...
class ImportedAppleDeviceIdentityItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $importedAppleDeviceIdentityId key: id of importedAppleDeviceIdentity
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $importedAppleDeviceIdentityId = null) {
        ...
        $urlTplParams['importedAppleDeviceIdentityId'] = $importedAppleDeviceIdentityId;
