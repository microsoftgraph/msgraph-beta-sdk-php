...
class UserExperienceAnalyticsDeviceScoresItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsDeviceScoresId key: id of userExperienceAnalyticsDeviceScores
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsDeviceScoresId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsDeviceScoresId'] = $userExperienceAnalyticsDeviceScoresId;
