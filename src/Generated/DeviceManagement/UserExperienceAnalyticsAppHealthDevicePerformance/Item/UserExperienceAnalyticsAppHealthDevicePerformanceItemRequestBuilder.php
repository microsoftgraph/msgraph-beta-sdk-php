...
class UserExperienceAnalyticsAppHealthDevicePerformanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsAppHealthDevicePerformanceId key: id of userExperienceAnalyticsAppHealthDevicePerformance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsAppHealthDevicePerformanceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsAppHealthDevicePerformanceId'] = $userExperienceAnalyticsAppHealthDevicePerformanceId;
