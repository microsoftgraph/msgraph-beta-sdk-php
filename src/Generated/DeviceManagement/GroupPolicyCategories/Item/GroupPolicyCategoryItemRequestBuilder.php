...
class GroupPolicyCategoryItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $groupPolicyCategoryId = null) {
        ...
        $urlTplParams['groupPolicyCategoryId'] = $groupPolicyCategoryId;
