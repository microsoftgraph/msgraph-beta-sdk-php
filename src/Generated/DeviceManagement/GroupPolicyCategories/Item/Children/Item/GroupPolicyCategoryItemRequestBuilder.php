...
class GroupPolicyCategoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $groupPolicyCategoryId1 key: id of groupPolicyCategory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $groupPolicyCategoryId1 = null) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory%2Did}/children/{groupPolicyCategory%2Did1}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['groupPolicyCategoryId1'] = $groupPolicyCategoryId1;
