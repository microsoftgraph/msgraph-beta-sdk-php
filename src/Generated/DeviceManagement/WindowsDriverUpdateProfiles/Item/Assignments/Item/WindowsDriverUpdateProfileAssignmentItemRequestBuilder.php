...
class WindowsDriverUpdateProfileAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $windowsDriverUpdateProfileAssignmentId key: id of windowsDriverUpdateProfileAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsDriverUpdateProfileAssignmentId = null) {
        ...
        $urlTplParams['windowsDriverUpdateProfileAssignmentId'] = $windowsDriverUpdateProfileAssignmentId;
