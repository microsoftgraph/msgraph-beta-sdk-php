...
class WindowsDriverUpdateInventoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $windowsDriverUpdateInventoryId key: id of windowsDriverUpdateInventory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsDriverUpdateInventoryId = null) {
        ...
        $urlTplParams['windowsDriverUpdateInventoryId'] = $windowsDriverUpdateInventoryId;
