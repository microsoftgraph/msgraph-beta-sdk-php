...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: WindowsDriverUpdateInventoryItemRequestBuilderGetRequestConfiguration
*/
class WindowsDriverUpdateInventoryItemRequestBuilderGetReques_de01cfdc extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WindowsDriverUpdateInventoryItemRequestBuilderGetReques_de01cfdc and sets the default values.
