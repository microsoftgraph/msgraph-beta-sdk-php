...
class ExecuteActionRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'actionName' => function (self $o, ParseNode $n) { $o->setActionName($n->getEnumValue(DriverApprovalAction::class)); },
            'deploymentDate' => function (self $o, ParseNode $n) { $o->setDeploymentDate($n->getDateTimeValue()); },
            'driverIds' => function (self $o, ParseNode $n) { $o->setDriverIds($n->getCollectionOfPrimitiveValues()); },
        ];
    }
