...
*/
class WindowsDriverUpdateProfilesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/windowsDriverUpdateProfiles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<WindowsDriverUpdateProfileCollectionResponse|null>
     * @throws Exception
    */
    public function get(?WindowsDriverUpdateProfilesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        $errorMappings = [
                'XXX' => [ODataError::class, 'createFromDiscriminatorValue'],
        ];
        return $this->requestAdapter->sendAsync($requestInfo, [WindowsDriverUpdateProfileCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
     ...
     * @return WindowsDriverUpdateProfilesRequestBuilder
    */
    public function withUrl(string $rawUrl): WindowsDriverUpdateProfilesRequestBuilder {
        return new WindowsDriverUpdateProfilesRequestBuilder($rawUrl, $this->requestAdapter);
    }
