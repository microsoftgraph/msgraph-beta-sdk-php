...
*/
class GroupPolicyDefinitionFileItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/groupPolicyDefinitionFiles/{groupPolicyDefinitionFile%2Did}{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?GroupPolicyDefinitionFileItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/groupPolicyDefinitionFiles/{groupPolicyDefinitionFile%2Did}';
    ...
    */
    public function withUrl(string $rawUrl): GroupPolicyDefinitionFileItemRequestBuilder {
        return new GroupPolicyDefinitionFileItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
