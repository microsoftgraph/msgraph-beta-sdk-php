...
class GroupPolicyDefinitionFileItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $groupPolicyDefinitionFileId key: id of groupPolicyDefinitionFile
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $groupPolicyDefinitionFileId = null) {
    ...
    */
    public function definitionsById(string $id): GroupPolicyDefinitionItemRequestBuilder {
        ...
        return new GroupPolicyDefinitionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
