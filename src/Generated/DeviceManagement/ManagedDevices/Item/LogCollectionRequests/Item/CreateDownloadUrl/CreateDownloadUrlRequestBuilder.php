...
class CreateDownloadUrlRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/managedDevices/{managedDevice_id}/logCollectionRequests/{deviceLogCollectionResponse_id}/microsoft.graph.createDownloadUrl';
