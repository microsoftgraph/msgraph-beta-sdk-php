...
class DeviceHealthScriptStatesRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the deviceHealthScriptStates property of the microsoft.graph.managedDevice entity.
     * @param string $deviceId key: deviceId of deviceHealthScriptPolicyState
     * @param string $id key: id of deviceHealthScriptPolicyState
     * @param string $policyId key: policyId of deviceHealthScriptPolicyState
