...
class AssignmentFilterEvaluationStatusDetailsItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $assignmentFilterEvaluationStatusDetailsId key: id of assignmentFilterEvaluationStatusDetails
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $assignmentFilterEvaluationStatusDetailsId = null) {
        ...
        $urlTplParams['assignmentFilterEvaluationStatusDetailsId'] = $assignmentFilterEvaluationStatusDetailsId;
