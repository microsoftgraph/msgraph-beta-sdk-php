...
class ResizeCloudPcRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/resizeCloudPc');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/manageddevice-resizecloudpc?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @return ResizeCloudPcRequestBuilder
    */
    public function withUrl(string $rawUrl): ResizeCloudPcRequestBuilder {
        return new ResizeCloudPcRequestBuilder($rawUrl, $this->requestAdapter);
    }
