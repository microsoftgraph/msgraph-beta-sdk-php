...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: DeviceConfigurationStateItemRequestBuilderGetRequestConfiguration
*/
class DeviceConfigurationStateItemRequestBuilderGetRequestCon_21f19193 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceConfigurationStateItemRequestBuilderGetRequestCon_21f19193 and sets the default values.
