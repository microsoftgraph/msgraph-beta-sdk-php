...
*/
class WindowsQualityUpdateProfileItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/windowsQualityUpdateProfiles/{windowsQualityUpdateProfile%2Did}{?%24select,%24expand}');
    ...
    */
    public function withUrl(string $rawUrl): WindowsQualityUpdateProfileItemRequestBuilder {
        return new WindowsQualityUpdateProfileItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
