...
use Microsoft\Graph\Beta\Generated\DeviceManagement\WindowsQualityUpdateProfiles\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class WindowsQualityUpdateProfileItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): WindowsQualityUpdateProfileAssignmentItemRequestBuilder {
        ...
        return new WindowsQualityUpdateProfileAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $windowsQualityUpdateProfileId key: id of windowsQualityUpdateProfile
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $windowsQualityUpdateProfileId = null) {
