...
class WindowsQualityUpdateProfileItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsQualityUpdateProfileId = null) {
        ...
        $urlTplParams['windowsQualityUpdateProfileId'] = $windowsQualityUpdateProfileId;
