...
class GetScopesForUserWithUseridRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userid = null) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/resourceOperations/{resourceOperation_id}/microsoft.graph.getScopesForUser(userid=\'{userid}\')';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, GetScopesForUserWithUseridResponse::class, $responseHandler);
        } catch(Exception $ex) {
