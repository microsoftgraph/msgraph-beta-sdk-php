...
*/
class GetScopesForUserWithUseridRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function withUrl(string $rawUrl): GetScopesForUserWithUseridRequestBuilder {
        return new GetScopesForUserWithUseridRequestBuilder($rawUrl, $this->requestAdapter);
    }
