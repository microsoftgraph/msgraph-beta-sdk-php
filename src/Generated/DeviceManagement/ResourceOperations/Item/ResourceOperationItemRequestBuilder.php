...
use Microsoft\Graph\Beta\Generated\DeviceManagement\ResourceOperations\Item\MicrosoftGraphGetScopesForUserWithUserid\GetScopesForUserWithUseridRequestBuilder;
...
class ResourceOperationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $resourceOperationId key: id of resourceOperation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $resourceOperationId = null) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/resourceOperations/{resourceOperation%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['resourceOperationId'] = $resourceOperationId;
    ...
    */
    public function microsoftGraphGetScopesForUserWithUserid(string $userid): GetScopesForUserWithUseridRequestBuilder {
