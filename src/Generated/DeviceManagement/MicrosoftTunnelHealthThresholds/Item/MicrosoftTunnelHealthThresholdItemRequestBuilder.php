...
class MicrosoftTunnelHealthThresholdItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $microsoftTunnelHealthThresholdId key: id of microsoftTunnelHealthThreshold
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $microsoftTunnelHealthThresholdId = null) {
        ...
        $urlTplParams['microsoftTunnelHealthThresholdId'] = $microsoftTunnelHealthThresholdId;
