...
class UserExperienceAnalyticsAppHealthOSVersionPerformanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsAppHealthOSVersionPerformanceId key: id of userExperienceAnalyticsAppHealthOSVersionPerformance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsAppHealthOSVersionPerformanceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsAppHealthOSVersionPerformanceId'] = $userExperienceAnalyticsAppHealthOSVersionPerformanceId;
