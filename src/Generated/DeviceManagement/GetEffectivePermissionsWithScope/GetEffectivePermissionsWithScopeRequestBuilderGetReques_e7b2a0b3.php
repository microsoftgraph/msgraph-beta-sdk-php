...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: getEffectivePermissionsWithScopeRequestBuilderGetRequestConfiguration
*/
class GetEffectivePermissionsWithScopeRequestBuilderGetReques_e7b2a0b3 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetEffectivePermissionsWithScopeRequestBuilderGetReques_e7b2a0b3 and sets the default values.
