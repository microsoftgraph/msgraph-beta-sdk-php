...
*/
class SetAndroidDeviceOwnerFullyManagedEnrollmentStateRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/androidManagedStoreAccountEnterpriseSettings/setAndroidDeviceOwnerFullyManagedEnrollmentState');
    ...
    */
    public function withUrl(string $rawUrl): SetAndroidDeviceOwnerFullyManagedEnrollmentStateRequestBuilder {
        return new SetAndroidDeviceOwnerFullyManagedEnrollmentStateRequestBuilder($rawUrl, $this->requestAdapter);
    }
