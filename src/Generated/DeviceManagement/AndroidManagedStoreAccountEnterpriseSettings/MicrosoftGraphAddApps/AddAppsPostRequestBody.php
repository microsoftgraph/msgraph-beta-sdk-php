...
class AddAppsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AddAppsPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'productIds' => fn(ParseNode $n) => $o->setProductIds($n->getCollectionOfPrimitiveValues()),
        ];
    }
