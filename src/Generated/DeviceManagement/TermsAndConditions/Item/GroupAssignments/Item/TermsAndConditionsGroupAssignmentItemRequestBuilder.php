...
class TermsAndConditionsGroupAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $termsAndConditionsGroupAssignmentId key: id of termsAndConditionsGroupAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $termsAndConditionsGroupAssignmentId = null) {
        ...
        $urlTplParams['termsAndConditionsGroupAssignmentId'] = $termsAndConditionsGroupAssignmentId;
