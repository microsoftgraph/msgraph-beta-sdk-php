...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\DeviceHealthScriptRemediationSummary;
...
class GetRemediationSummaryRequestBuilder 
{
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, DeviceHealthScriptRemediationSummary::class, $responseHandler);
        } catch(Exception $ex) {
