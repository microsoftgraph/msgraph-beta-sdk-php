...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceHealthScripts\MicrosoftGraphAreGlobalScriptsAvailable\MicrosoftGraphAreGlobalScriptsAvailableRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceHealthScripts\MicrosoftGraphEnableGlobalScripts\MicrosoftGraphEnableGlobalScriptsRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceHealthScripts\MicrosoftGraphGetRemediationSummary\MicrosoftGraphGetRemediationSummaryRequestBuilder;
...
class DeviceHealthScriptsRequestBuilder 
{
    ...
    */
    public function microsoftGraphAreGlobalScriptsAvailable(): MicrosoftGraphAreGlobalScriptsAvailableRequestBuilder {
        return new MicrosoftGraphAreGlobalScriptsAvailableRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the enableGlobalScripts method.
    */
    public function microsoftGraphEnableGlobalScripts(): MicrosoftGraphEnableGlobalScriptsRequestBuilder {
        return new MicrosoftGraphEnableGlobalScriptsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the getRemediationSummary method.
    */
    public function microsoftGraphGetRemediationSummary(): MicrosoftGraphGetRemediationSummaryRequestBuilder {
        return new MicrosoftGraphGetRemediationSummaryRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
