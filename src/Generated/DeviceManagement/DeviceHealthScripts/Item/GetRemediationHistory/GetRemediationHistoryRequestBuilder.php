...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\DeviceHealthScriptRemediationHistory;
...
class GetRemediationHistoryRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/deviceHealthScripts/{deviceHealthScript_id}/microsoft.graph.getRemediationHistory()';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, DeviceHealthScriptRemediationHistory::class, $responseHandler);
        } catch(Exception $ex) {
