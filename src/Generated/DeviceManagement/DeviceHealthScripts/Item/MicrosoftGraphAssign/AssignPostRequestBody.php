...
namespace Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceHealthScripts\Item\MicrosoftGraphAssign;
...
class AssignPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getDeviceHealthScriptAssignments(): ?array {
        return $this->getBackingStore()->get('deviceHealthScriptAssignments');
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'deviceHealthScriptAssignments' => fn(ParseNode $n) => $o->setDeviceHealthScriptAssignments($n->getCollectionOfObjectValues([DeviceHealthScriptAssignment::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function setDeviceHealthScriptAssignments(?array $value): void {
        $this->getBackingStore()->set('deviceHealthScriptAssignments', $value);
    }
