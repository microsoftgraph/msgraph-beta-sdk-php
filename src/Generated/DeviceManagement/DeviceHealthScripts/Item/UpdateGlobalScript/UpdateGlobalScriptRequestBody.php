...
class UpdateGlobalScriptRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UpdateGlobalScriptRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UpdateGlobalScriptRequestBody {
