...
class AssignPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getDeviceHealthScriptAssignments(): ?array {
        $val = $this->getBackingStore()->get('deviceHealthScriptAssignments');
        ...
        throw new \UnexpectedValueException("Invalid type found in backing store for 'deviceHealthScriptAssignments'");
    }
