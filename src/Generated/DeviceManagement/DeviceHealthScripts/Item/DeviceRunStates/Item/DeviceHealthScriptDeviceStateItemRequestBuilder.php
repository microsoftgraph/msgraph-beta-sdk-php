...
class DeviceHealthScriptDeviceStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceHealthScriptDeviceStateId key: id of deviceHealthScriptDeviceState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceHealthScriptDeviceStateId = null) {
        ...
        $urlTplParams['deviceHealthScriptDeviceStateId'] = $deviceHealthScriptDeviceStateId;
