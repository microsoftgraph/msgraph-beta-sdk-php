...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceHealthScripts\Item\MicrosoftGraphAssign\MicrosoftGraphAssignRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceHealthScripts\Item\MicrosoftGraphGetGlobalScriptHighestAvailableVersion\MicrosoftGraphGetGlobalScriptHighestAvailableVersionRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceHealthScripts\Item\MicrosoftGraphGetRemediationHistory\MicrosoftGraphGetRemediationHistoryRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceHealthScripts\Item\MicrosoftGraphUpdateGlobalScript\MicrosoftGraphUpdateGlobalScriptRequestBuilder;
...
class DeviceHealthScriptItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphGetGlobalScriptHighestAvailableVersion(): MicrosoftGraphGetGlobalScriptHighestAvailableVersionRequestBuilder {
        return new MicrosoftGraphGetGlobalScriptHighestAvailableVersionRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the getRemediationHistory method.
    */
    public function microsoftGraphGetRemediationHistory(): MicrosoftGraphGetRemediationHistoryRequestBuilder {
        return new MicrosoftGraphGetRemediationHistoryRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the updateGlobalScript method.
    */
    public function microsoftGraphUpdateGlobalScript(): MicrosoftGraphUpdateGlobalScriptRequestBuilder {
        return new MicrosoftGraphUpdateGlobalScriptRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function assignmentsById(string $id): DeviceHealthScriptAssignmentItemRequestBuilder {
        ...
        return new DeviceHealthScriptAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function deviceRunStatesById(string $id): DeviceHealthScriptDeviceStateItemRequestBuilder {
        ...
        return new DeviceHealthScriptDeviceStateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
