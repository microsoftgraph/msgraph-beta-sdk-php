...
class RunSummaryRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/deviceHealthScripts/{deviceHealthScript%2Did}/runSummary');
    ...
    */
     ...
     * @return Promise<DeviceHealthScriptRunSummary|null>
     * @throws Exception
    */
    public function get(?RunSummaryRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DeviceHealthScriptRunSummary::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
     ...
     * @throws Exception
    */
    public function patch(DeviceHealthScriptRunSummary $body, ?RunSummaryRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?RunSummaryRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/deviceHealthScripts/{deviceHealthScript%2Did}/runSummary{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
