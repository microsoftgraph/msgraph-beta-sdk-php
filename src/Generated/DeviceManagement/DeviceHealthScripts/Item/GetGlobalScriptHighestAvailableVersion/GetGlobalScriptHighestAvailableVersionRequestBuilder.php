...
class GetGlobalScriptHighestAvailableVersionRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/deviceHealthScripts/{deviceHealthScript_id}/microsoft.graph.getGlobalScriptHighestAvailableVersion';
    ...
    */
    public function post(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, GetGlobalScriptHighestAvailableVersionResponse::class, $responseHandler);
        } catch(Exception $ex) {
