...
class GetGlobalScriptHighestAvailableVersionRequestBuilder 
{
    ...
    */
    public function createPostRequestInformation(?GetGlobalScriptHighestAvailableVersionRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(?GetGlobalScriptHighestAvailableVersionRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(GetGlobalScriptHighestAvailableVersionResponse::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
