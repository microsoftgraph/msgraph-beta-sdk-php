...
class AreGlobalScriptsAvailableRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?AreGlobalScriptsAvailableRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function get(?AreGlobalScriptsAvailableRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, 'GlobalDeviceHealthScriptState', $responseHandler, $errorMappings);
        } catch(Exception $ex) {
