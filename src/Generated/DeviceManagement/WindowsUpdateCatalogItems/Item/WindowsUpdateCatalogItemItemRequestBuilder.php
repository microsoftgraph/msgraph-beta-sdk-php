...
*/
class WindowsUpdateCatalogItemItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/windowsUpdateCatalogItems/{windowsUpdateCatalogItem%2Did}{?%24select,%24expand}');
    ...
    */
    public function withUrl(string $rawUrl): WindowsUpdateCatalogItemItemRequestBuilder {
        return new WindowsUpdateCatalogItemItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
