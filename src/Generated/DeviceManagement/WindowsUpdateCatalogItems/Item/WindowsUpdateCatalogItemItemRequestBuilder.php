...
class WindowsUpdateCatalogItemItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $windowsUpdateCatalogItemId key: id of windowsUpdateCatalogItem
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsUpdateCatalogItemId = null) {
        ...
        $urlTplParams['windowsUpdateCatalogItemId'] = $windowsUpdateCatalogItemId;
