...
class GetHealthMetricTimeSeriesPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getTimeSeries(): ?TimeSeriesParameter {
        $val = $this->getBackingStore()->get('timeSeries');
        if (is_null($val) || $val instanceof TimeSeriesParameter) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'timeSeries'");
    }
    ...
    */
    public function setTimeSeries(?TimeSeriesParameter $value): void {
        $this->getBackingStore()->set('timeSeries', $value);
    }
