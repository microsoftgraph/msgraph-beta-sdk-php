...
class EvaluateAssignmentFilterResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /**
     * Instantiates a new evaluateAssignmentFilterResponse and sets the default values.
    */
     ...
     * @return EvaluateAssignmentFilterResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): EvaluateAssignmentFilterResponse {
        return new EvaluateAssignmentFilterResponse();
    }
