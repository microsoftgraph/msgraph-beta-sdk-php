...
*/
class GetAssignmentFiltersStatusDetailsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/getAssignmentFiltersStatusDetails');
    ...
    */
     ...
     * @return GetAssignmentFiltersStatusDetailsRequestBuilder
    */
    public function withUrl(string $rawUrl): GetAssignmentFiltersStatusDetailsRequestBuilder {
        return new GetAssignmentFiltersStatusDetailsRequestBuilder($rawUrl, $this->requestAdapter);
    }
