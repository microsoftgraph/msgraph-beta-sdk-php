...
*/
class DeviceAndAppManagementAssignmentFilterItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/assignmentFilters/{deviceAndAppManagementAssignmentFilter%2Did}{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?DeviceAndAppManagementAssignmentFilterItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/assignmentFilters/{deviceAndAppManagementAssignmentFilter%2Did}';
    ...
    */
    public function withUrl(string $rawUrl): DeviceAndAppManagementAssignmentFilterItemRequestBuilder {
        return new DeviceAndAppManagementAssignmentFilterItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
