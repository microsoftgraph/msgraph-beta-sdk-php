...
class GetSupportedPropertiesResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return GetSupportedPropertiesResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetSupportedPropertiesResponse {
