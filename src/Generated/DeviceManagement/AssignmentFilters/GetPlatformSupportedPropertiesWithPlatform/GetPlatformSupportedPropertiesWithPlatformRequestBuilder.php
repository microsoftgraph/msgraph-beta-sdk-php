...
*/
class GetPlatformSupportedPropertiesWithPlatformRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function get(?GetPlatformSupportedPropertiesWithPlatformRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [GetPlatformSupportedPropertiesWithPlatformGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
    ...
    */
    public function withUrl(string $rawUrl): GetPlatformSupportedPropertiesWithPlatformRequestBuilder {
        return new GetPlatformSupportedPropertiesWithPlatformRequestBuilder($rawUrl, $this->requestAdapter);
    }
