...
class GetPlatformSupportedPropertiesWithPlatformRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?GetPlatformSupportedPropertiesWithPlatformRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function get(?GetPlatformSupportedPropertiesWithPlatformRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(GetPlatformSupportedPropertiesWithPlatformResponse::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
