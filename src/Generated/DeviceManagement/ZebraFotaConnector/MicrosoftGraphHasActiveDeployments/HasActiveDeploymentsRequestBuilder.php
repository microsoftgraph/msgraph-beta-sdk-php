...
*/
class HasActiveDeploymentsRequestBuilder 
{
    /**
    ...
    */
    public function post(?HasActiveDeploymentsRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [HasActiveDeploymentsResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
