...
class UserExperienceAnalyticsMetricItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsMetricId key: id of userExperienceAnalyticsMetric
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsMetricId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsMetricId'] = $userExperienceAnalyticsMetricId;
