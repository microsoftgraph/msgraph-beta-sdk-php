...
class AssignRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'deviceHealthScriptAssignments' => function (self $o, ParseNode $n) { $o->setDeviceHealthScriptAssignments($n->getCollectionOfObjectValues(DeviceHealthScriptAssignment::class)); },
        ];
    }
