...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceComplianceScripts\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class DeviceComplianceScriptItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceComplianceScriptId key: id of deviceComplianceScript
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceComplianceScriptId = null) {
    ...
    */
    public function deviceRunStatesById(string $id): DeviceComplianceScriptDeviceStateItemRequestBuilder {
        ...
        return new DeviceComplianceScriptDeviceStateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
