...
*/
class RunSummaryRequestBuilderGetRequestConfiguration 
{
    /**
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): RunSummaryRequestBuilderGetQueryParameters {
