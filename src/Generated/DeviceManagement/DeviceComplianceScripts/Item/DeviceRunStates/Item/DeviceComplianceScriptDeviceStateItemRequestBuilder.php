...
class DeviceComplianceScriptDeviceStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceComplianceScriptDeviceStateId key: id of deviceComplianceScriptDeviceState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceComplianceScriptDeviceStateId = null) {
        ...
        $urlTplParams['deviceComplianceScriptDeviceStateId'] = $deviceComplianceScriptDeviceStateId;
