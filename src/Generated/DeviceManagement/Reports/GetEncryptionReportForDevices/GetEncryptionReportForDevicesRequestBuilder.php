...
class GetEncryptionReportForDevicesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @return GetEncryptionReportForDevicesRequestBuilder
    */
    public function withUrl(string $rawUrl): GetEncryptionReportForDevicesRequestBuilder {
        return new GetEncryptionReportForDevicesRequestBuilder($rawUrl, $this->requestAdapter);
    }
