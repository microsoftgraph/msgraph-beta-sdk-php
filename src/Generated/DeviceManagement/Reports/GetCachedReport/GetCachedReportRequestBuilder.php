...
class GetCachedReportRequestBuilder 
{
    ...
    */
     ...
     * @param GetCachedReportPostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(GetCachedReportPostRequestBody $body, ?GetCachedReportRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(GetCachedReportPostRequestBody $body, ?GetCachedReportRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
