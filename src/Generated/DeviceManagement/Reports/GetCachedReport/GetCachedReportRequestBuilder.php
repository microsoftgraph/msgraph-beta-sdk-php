...
*/
class GetCachedReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getCachedReport');
    ...
    */
    public function toPostRequestInformation(GetCachedReportPostRequestBody $body, ?GetCachedReportRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): GetCachedReportRequestBuilder {
