...
class GetConfigurationSettingsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return GetConfigurationSettingsReportPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetConfigurationSettingsReportPostRequestBody {
