...
*/
class GetCompliancePolicyDevicesReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getCompliancePolicyDevicesReport');
    ...
    */
     ...
     * @return GetCompliancePolicyDevicesReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetCompliancePolicyDevicesReportRequestBuilder {
        return new GetCompliancePolicyDevicesReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
