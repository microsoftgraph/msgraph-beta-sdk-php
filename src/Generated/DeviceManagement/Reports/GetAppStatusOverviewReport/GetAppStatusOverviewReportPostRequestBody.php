...
namespace Microsoft\\Graph\\Beta\\Generated\DeviceManagement\Reports\GetAppStatusOverviewReport;
...
class GetAppStatusOverviewReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetAppStatusOverviewReportPostRequestBody and sets the default values.
    */
     ...
     * @return GetAppStatusOverviewReportPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetAppStatusOverviewReportPostRequestBody {
