...
class GetConfigurationPoliciesReportForDevicePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetConfigurationPoliciesReportForDevicePostRequestBody {
