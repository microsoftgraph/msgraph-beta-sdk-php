...
class GetDeviceInstallStatusReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetDeviceInstallStatusReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetDeviceInstallStatusReportRequestBody {
