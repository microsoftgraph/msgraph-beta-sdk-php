...
*/
class GetAppsInstallSummaryReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getAppsInstallSummaryReport');
    ...
    */
     ...
     * @return GetAppsInstallSummaryReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetAppsInstallSummaryReportRequestBuilder {
        return new GetAppsInstallSummaryReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
