...
class GetAutopilotDeploymentStatusPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetAutopilotDeploymentStatusPostRequestBody {
