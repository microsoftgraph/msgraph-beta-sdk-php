...
class GetUnhealthyDefenderAgentsReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    /**
     * Instantiates a new getUnhealthyDefenderAgentsReportRequestBody and sets the default values.
    */
     ...
     * @return GetUnhealthyDefenderAgentsReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetUnhealthyDefenderAgentsReportRequestBody {
        return new GetUnhealthyDefenderAgentsReportRequestBody();
    }
