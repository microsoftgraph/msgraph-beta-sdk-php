...
class GetWindowsUpdateAlertSummaryReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /**
     * Instantiates a new getWindowsUpdateAlertSummaryReportResponse and sets the default values.
    */
     ...
     * @return GetWindowsUpdateAlertSummaryReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetWindowsUpdateAlertSummaryReportResponse {
        return new GetWindowsUpdateAlertSummaryReportResponse();
    }
