...
class GetWindowsUpdateAlertSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetWindowsUpdateAlertSummaryReportPostRequestBody {
