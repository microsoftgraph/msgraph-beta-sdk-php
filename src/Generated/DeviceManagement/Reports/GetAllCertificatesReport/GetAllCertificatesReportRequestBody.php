...
class GetAllCertificatesReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetAllCertificatesReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetAllCertificatesReportRequestBody {
