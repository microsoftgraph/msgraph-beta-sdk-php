...
class DeviceManagementCachedReportConfigurationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementCachedReportConfigurationId key: id of deviceManagementCachedReportConfiguration
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementCachedReportConfigurationId = null) {
        ...
        $urlTplParams['deviceManagementCachedReportConfigurationId'] = $deviceManagementCachedReportConfigurationId;
