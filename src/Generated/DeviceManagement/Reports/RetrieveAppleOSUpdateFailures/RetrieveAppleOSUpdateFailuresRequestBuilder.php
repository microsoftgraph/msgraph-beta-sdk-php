...
*/
class RetrieveAppleOSUpdateFailuresRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/retrieveAppleOSUpdateFailures');
    ...
    */
     ...
     * @return RetrieveAppleOSUpdateFailuresRequestBuilder
    */
    public function withUrl(string $rawUrl): RetrieveAppleOSUpdateFailuresRequestBuilder {
        return new RetrieveAppleOSUpdateFailuresRequestBuilder($rawUrl, $this->requestAdapter);
    }
