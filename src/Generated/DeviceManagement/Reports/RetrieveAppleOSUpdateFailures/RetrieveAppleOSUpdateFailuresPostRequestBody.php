...
class RetrieveAppleOSUpdateFailuresPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RetrieveAppleOSUpdateFailuresPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RetrieveAppleOSUpdateFailuresPostRequestBody {
