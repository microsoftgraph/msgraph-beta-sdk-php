...
namespace Microsoft\\Graph\\Beta\\Generated\DeviceManagement\Reports\GetDevicesStatusBySettingReport;
...
*/
class GetDevicesStatusBySettingReportRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new GetDevicesStatusBySettingReportRequestBuilder and sets the default values.
     * @param array<string, mixed>|string $pathParametersOrRawUrl Path parameters for the request or a String representing the raw URL.
     * @param RequestAdapter $requestAdapter The request adapter to use to execute the requests.
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getDevicesStatusBySettingReport');
    ...
    */
     ...
     * @return GetDevicesStatusBySettingReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetDevicesStatusBySettingReportRequestBuilder {
        return new GetDevicesStatusBySettingReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
