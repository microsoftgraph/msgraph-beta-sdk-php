...
class GetCompliancePolicyDeviceSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return GetCompliancePolicyDeviceSummaryReportPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetCompliancePolicyDeviceSummaryReportPostRequestBody {
