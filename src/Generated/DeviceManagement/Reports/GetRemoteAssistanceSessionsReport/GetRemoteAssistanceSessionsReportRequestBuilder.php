...
*/
class GetRemoteAssistanceSessionsReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getRemoteAssistanceSessionsReport');
    ...
    */
     ...
     * @return GetRemoteAssistanceSessionsReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetRemoteAssistanceSessionsReportRequestBuilder {
        return new GetRemoteAssistanceSessionsReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
