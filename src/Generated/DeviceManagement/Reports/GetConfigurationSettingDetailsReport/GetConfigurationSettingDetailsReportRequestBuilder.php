...
*/
class GetConfigurationSettingDetailsReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
     ...
     * @return GetConfigurationSettingDetailsReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetConfigurationSettingDetailsReportRequestBuilder {
        return new GetConfigurationSettingDetailsReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
