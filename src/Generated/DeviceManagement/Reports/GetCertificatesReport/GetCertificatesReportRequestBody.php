...
class GetCertificatesReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetCertificatesReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetCertificatesReportRequestBody {
