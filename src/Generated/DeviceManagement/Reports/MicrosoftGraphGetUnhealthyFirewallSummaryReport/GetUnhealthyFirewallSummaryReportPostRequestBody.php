...
class GetUnhealthyFirewallSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetUnhealthyFirewallSummaryReportPostRequestBody {
