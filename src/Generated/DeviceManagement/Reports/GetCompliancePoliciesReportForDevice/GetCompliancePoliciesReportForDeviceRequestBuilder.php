...
class GetCompliancePoliciesReportForDeviceRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param GetCompliancePoliciesReportForDeviceRequestBuilderPostR_ed1b52a5|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<StreamInterface|null>
     * @throws Exception
    */
    public function post(GetCompliancePoliciesReportForDevicePostRequestBody $body, ?GetCompliancePoliciesReportForDeviceRequestBuilderPostR_ed1b52a5 $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(GetCompliancePoliciesReportForDevicePostRequestBody $body, ?GetCompliancePoliciesReportForDeviceRequestBuilderPostR_ed1b52a5 $requestConfiguration = null): RequestInformation {
