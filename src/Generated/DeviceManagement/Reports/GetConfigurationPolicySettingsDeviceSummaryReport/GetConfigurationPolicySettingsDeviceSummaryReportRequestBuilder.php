...
*/
class GetConfigurationPolicySettingsDeviceSummaryReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getConfigurationPolicySettingsDeviceSummaryReport');
    ...
    */
     ...
     * @return GetConfigurationPolicySettingsDeviceSummaryReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetConfigurationPolicySettingsDeviceSummaryReportRequestBuilder {
        return new GetConfigurationPolicySettingsDeviceSummaryReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
