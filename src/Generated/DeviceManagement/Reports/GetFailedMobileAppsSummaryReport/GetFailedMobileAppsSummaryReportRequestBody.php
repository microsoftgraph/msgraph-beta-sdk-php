...
class GetFailedMobileAppsSummaryReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetFailedMobileAppsSummaryReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetFailedMobileAppsSummaryReportRequestBody {
