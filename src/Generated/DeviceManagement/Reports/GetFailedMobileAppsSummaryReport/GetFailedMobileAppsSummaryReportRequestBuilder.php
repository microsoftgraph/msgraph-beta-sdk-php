...
*/
class GetFailedMobileAppsSummaryReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getFailedMobileAppsSummaryReport');
    ...
    */
     ...
     * @return GetFailedMobileAppsSummaryReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetFailedMobileAppsSummaryReportRequestBuilder {
        return new GetFailedMobileAppsSummaryReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
