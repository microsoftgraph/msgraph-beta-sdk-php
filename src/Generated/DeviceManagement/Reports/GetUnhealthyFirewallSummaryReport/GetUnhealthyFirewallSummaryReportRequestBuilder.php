...
*/
class GetUnhealthyFirewallSummaryReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getUnhealthyFirewallSummaryReport');
    ...
    */
     ...
     * @return GetUnhealthyFirewallSummaryReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetUnhealthyFirewallSummaryReportRequestBuilder {
        return new GetUnhealthyFirewallSummaryReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
