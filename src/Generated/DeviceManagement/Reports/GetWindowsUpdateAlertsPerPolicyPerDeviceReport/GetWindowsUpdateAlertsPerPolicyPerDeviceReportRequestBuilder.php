...
*/
class GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getWindowsUpdateAlertsPerPolicyPerDeviceReport');
    ...
    */
     ...
     * @return GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder {
        return new GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
