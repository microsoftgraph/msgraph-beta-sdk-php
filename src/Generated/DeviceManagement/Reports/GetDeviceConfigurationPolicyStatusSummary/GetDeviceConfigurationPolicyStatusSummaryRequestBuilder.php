...
*/
class GetDeviceConfigurationPolicyStatusSummaryRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getDeviceConfigurationPolicyStatusSummary');
    ...
    */
     ...
     * @return GetDeviceConfigurationPolicyStatusSummaryRequestBuilder
    */
    public function withUrl(string $rawUrl): GetDeviceConfigurationPolicyStatusSummaryRequestBuilder {
        return new GetDeviceConfigurationPolicyStatusSummaryRequestBuilder($rawUrl, $this->requestAdapter);
    }
