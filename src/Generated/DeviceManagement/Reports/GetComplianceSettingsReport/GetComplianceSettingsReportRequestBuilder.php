...
*/
class GetComplianceSettingsReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getComplianceSettingsReport');
    ...
    */
     ...
     * @return GetComplianceSettingsReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetComplianceSettingsReportRequestBuilder {
        return new GetComplianceSettingsReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
