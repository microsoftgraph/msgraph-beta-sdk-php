...
class GetDeviceConfigurationPolicyStatusSummaryPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return GetDeviceConfigurationPolicyStatusSummaryPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetDeviceConfigurationPolicyStatusSummaryPostRequestBody {
