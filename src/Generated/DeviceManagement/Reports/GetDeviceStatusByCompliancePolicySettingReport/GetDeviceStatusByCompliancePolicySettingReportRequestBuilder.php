...
*/
class GetDeviceStatusByCompliancePolicySettingReportRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/reports/getDeviceStatusByCompliancePolicySettingReport';
