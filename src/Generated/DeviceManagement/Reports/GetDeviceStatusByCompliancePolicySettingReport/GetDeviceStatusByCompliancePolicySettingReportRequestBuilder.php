...
class GetDeviceStatusByCompliancePolicySettingReportRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @return GetDeviceStatusByCompliancePolicySettingReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetDeviceStatusByCompliancePolicySettingReportRequestBuilder {
        return new GetDeviceStatusByCompliancePolicySettingReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
