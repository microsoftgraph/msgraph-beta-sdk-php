...
class GetDeviceStatusByCompliancePolicySettingReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetDeviceStatusByCompliancePolicySettingReportPostRequestBody {
