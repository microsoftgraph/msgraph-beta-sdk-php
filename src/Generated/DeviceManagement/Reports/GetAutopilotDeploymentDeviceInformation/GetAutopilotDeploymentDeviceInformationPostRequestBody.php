...
class GetAutopilotDeploymentDeviceInformationPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetAutopilotDeploymentDeviceInformationPostRequestBody {
