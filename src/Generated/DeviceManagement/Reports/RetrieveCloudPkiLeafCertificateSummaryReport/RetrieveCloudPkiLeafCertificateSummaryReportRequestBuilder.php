...
*/
class RetrieveCloudPkiLeafCertificateSummaryReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/retrieveCloudPkiLeafCertificateSummaryReport');
    ...
    */
     ...
     * @return RetrieveCloudPkiLeafCertificateSummaryReportRequestBuilder
    */
    public function withUrl(string $rawUrl): RetrieveCloudPkiLeafCertificateSummaryReportRequestBuilder {
        return new RetrieveCloudPkiLeafCertificateSummaryReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
