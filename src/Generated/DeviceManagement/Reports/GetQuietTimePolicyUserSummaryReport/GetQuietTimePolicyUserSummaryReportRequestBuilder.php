...
*/
class GetQuietTimePolicyUserSummaryReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
     ...
     * @return GetQuietTimePolicyUserSummaryReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetQuietTimePolicyUserSummaryReportRequestBuilder {
        return new GetQuietTimePolicyUserSummaryReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
