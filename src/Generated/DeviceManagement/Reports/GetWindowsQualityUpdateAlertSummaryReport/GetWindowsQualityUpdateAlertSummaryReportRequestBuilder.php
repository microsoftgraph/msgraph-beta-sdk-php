...
*/
class GetWindowsQualityUpdateAlertSummaryReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getWindowsQualityUpdateAlertSummaryReport');
    ...
    */
     ...
     * @return GetWindowsQualityUpdateAlertSummaryReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetWindowsQualityUpdateAlertSummaryReportRequestBuilder {
        return new GetWindowsQualityUpdateAlertSummaryReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
