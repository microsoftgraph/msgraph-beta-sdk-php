...
class GetWindowsQualityUpdateAlertSummaryReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetWindowsQualityUpdateAlertSummaryReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetWindowsQualityUpdateAlertSummaryReportRequestBody {
        return new GetWindowsQualityUpdateAlertSummaryReportRequestBody();
    }
