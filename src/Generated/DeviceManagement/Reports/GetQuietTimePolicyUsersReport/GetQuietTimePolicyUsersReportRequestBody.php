...
class GetQuietTimePolicyUsersReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetQuietTimePolicyUsersReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetQuietTimePolicyUsersReportRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'skipToken' => function (self $o, ParseNode $n) { $o->setSkipToken($n->getStringValue()); },
