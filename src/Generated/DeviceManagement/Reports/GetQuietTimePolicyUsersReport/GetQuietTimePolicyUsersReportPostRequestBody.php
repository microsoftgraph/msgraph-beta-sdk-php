...
namespace Microsoft\Graph\Beta\Generated\DeviceManagement\Reports\GetQuietTimePolicyUsersReport;
...
class GetQuietTimePolicyUsersReportPostRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetQuietTimePolicyUsersReportPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'skipToken' => function (ParseNode $n) use ($o) { $o->setSkipToken($n->getStringValue()); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeStringValue('skipToken', $this->skipToken);
