...
class GetWindowsDriverUpdateAlertSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetWindowsDriverUpdateAlertSummaryReportPostRequestBody {
