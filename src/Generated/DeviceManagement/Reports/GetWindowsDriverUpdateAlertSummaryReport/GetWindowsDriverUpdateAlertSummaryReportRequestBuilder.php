...
*/
class GetWindowsDriverUpdateAlertSummaryReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getWindowsDriverUpdateAlertSummaryReport');
    ...
    */
     ...
     * @return GetWindowsDriverUpdateAlertSummaryReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetWindowsDriverUpdateAlertSummaryReportRequestBuilder {
        return new GetWindowsDriverUpdateAlertSummaryReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
