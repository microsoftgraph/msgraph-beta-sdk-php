...
*/
class RetrieveAndroidWorkProfileDeviceMigrationStatusesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/retrieveAndroidWorkProfileDeviceMigrationStatuses');
    ...
    */
     ...
     * @return RetrieveAndroidWorkProfileDeviceMigrationStatusesRequestBuilder
    */
    public function withUrl(string $rawUrl): RetrieveAndroidWorkProfileDeviceMigrationStatusesRequestBuilder {
        return new RetrieveAndroidWorkProfileDeviceMigrationStatusesRequestBuilder($rawUrl, $this->requestAdapter);
    }
