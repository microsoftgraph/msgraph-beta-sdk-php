...
class GetFailedMobileAppsSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new getFailedMobileAppsSummaryReportPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetFailedMobileAppsSummaryReportPostRequestBody {
