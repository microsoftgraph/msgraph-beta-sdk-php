...
class GetGroupPolicySettingsDeviceSettingsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetGroupPolicySettingsDeviceSettingsReportPostRequestBody {
