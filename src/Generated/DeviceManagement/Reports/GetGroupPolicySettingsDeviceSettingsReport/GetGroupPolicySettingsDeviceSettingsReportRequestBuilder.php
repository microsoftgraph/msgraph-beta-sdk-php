...
*/
class GetGroupPolicySettingsDeviceSettingsReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getGroupPolicySettingsDeviceSettingsReport');
    ...
    */
     ...
     * @return GetGroupPolicySettingsDeviceSettingsReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetGroupPolicySettingsDeviceSettingsReportRequestBuilder {
        return new GetGroupPolicySettingsDeviceSettingsReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
