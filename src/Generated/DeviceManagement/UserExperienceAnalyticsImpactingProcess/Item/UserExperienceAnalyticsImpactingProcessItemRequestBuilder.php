...
class UserExperienceAnalyticsImpactingProcessItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsImpactingProcessId key: id of userExperienceAnalyticsImpactingProcess
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsImpactingProcessId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsImpactingProcessId'] = $userExperienceAnalyticsImpactingProcessId;
