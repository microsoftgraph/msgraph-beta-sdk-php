...
class ConnectRequestBuilder 
{
    ...
    */
     ...
     * @param ChromeOSOnboardingStatusPostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(ChromeOSOnboardingStatusPostRequestBody $body, ?ConnectRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(ChromeOSOnboardingStatusPostRequestBody $body, ?ConnectRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
