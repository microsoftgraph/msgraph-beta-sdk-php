...
class ConnectRequestBuilder 
{
    ...
    */
     ...
     * @param ConnectPostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(ConnectPostRequestBody $body, ?ConnectRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(ConnectPostRequestBody $body, ?ConnectRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
