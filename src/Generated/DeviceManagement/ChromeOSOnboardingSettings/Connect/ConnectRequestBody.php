...
class ConnectRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ConnectRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'ownerAccessToken' => function (self $o, ParseNode $n) { $o->setOwnerAccessToken($n->getStringValue()); },
