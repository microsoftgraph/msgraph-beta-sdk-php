...
*/
class ChromeOSOnboardingSettingsItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/chromeOSOnboardingSettings/{chromeOSOnboardingSettings%2Did}{?%24select,%24expand}');
    ...
    */
    public function withUrl(string $rawUrl): ChromeOSOnboardingSettingsItemRequestBuilder {
        return new ChromeOSOnboardingSettingsItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
