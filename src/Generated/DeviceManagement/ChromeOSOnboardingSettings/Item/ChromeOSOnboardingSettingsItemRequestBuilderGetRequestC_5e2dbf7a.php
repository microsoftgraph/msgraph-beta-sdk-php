...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ChromeOSOnboardingSettingsItemRequestBuilderGetRequestConfiguration
*/
class ChromeOSOnboardingSettingsItemRequestBuilderGetRequestC_5e2dbf7a extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ChromeOSOnboardingSettingsItemRequestBuilderGetRequestC_5e2dbf7a and sets the default values.
