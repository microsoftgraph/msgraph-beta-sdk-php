...
*/
class EnableAndroidDeviceAdministratorEnrollmentRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/enableAndroidDeviceAdministratorEnrollment');
    ...
    */
     ...
     * @return EnableAndroidDeviceAdministratorEnrollmentRequestBuilder
    */
    public function withUrl(string $rawUrl): EnableAndroidDeviceAdministratorEnrollmentRequestBuilder {
        return new EnableAndroidDeviceAdministratorEnrollmentRequestBuilder($rawUrl, $this->requestAdapter);
    }
