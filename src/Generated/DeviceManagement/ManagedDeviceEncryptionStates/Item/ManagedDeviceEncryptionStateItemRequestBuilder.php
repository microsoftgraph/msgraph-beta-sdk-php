...
*/
class ManagedDeviceEncryptionStateItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/managedDeviceEncryptionStates/{managedDeviceEncryptionState%2Did}{?%24select,%24expand}');
    ...
    */
    public function withUrl(string $rawUrl): ManagedDeviceEncryptionStateItemRequestBuilder {
        return new ManagedDeviceEncryptionStateItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
