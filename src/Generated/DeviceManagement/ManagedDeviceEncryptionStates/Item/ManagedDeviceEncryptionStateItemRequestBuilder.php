...
class ManagedDeviceEncryptionStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedDeviceEncryptionStateId key: id of managedDeviceEncryptionState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedDeviceEncryptionStateId = null) {
        ...
        $urlTplParams['managedDeviceEncryptionStateId'] = $managedDeviceEncryptionStateId;
