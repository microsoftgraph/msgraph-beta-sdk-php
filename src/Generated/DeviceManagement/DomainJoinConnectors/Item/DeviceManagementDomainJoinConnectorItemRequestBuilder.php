...
class DeviceManagementDomainJoinConnectorItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementDomainJoinConnectorId key: id of deviceManagementDomainJoinConnector
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementDomainJoinConnectorId = null) {
        ...
        $urlTplParams['deviceManagementDomainJoinConnectorId'] = $deviceManagementDomainJoinConnectorId;
