...
class UserExperienceAnalyticsBatteryHealthOsPerformanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsBatteryHealthOsPerformanceId key: id of userExperienceAnalyticsBatteryHealthOsPerformance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsBatteryHealthOsPerformanceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsBatteryHealthOsPerformanceId'] = $userExperienceAnalyticsBatteryHealthOsPerformanceId;
