...
class ClearEnrollmentTimeDeviceMembershipTargetRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reusablePolicySettings/{deviceManagementReusablePolicySetting%2Did}/referencingConfigurationPolicies/{deviceManagementConfigurationPolicy%2Did}/clearEnrollmentTimeDeviceMembershipTarget');
    ...
    */
    public function post(?ClearEnrollmentTimeDeviceMembershipTargetRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [ClearEnrollmentTimeDeviceMembershipTargetPostResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
