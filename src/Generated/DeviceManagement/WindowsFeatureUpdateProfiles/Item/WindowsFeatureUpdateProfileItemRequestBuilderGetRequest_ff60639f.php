...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: WindowsFeatureUpdateProfileItemRequestBuilderGetRequestConfiguration
*/
class WindowsFeatureUpdateProfileItemRequestBuilderGetRequest_ff60639f extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WindowsFeatureUpdateProfileItemRequestBuilderGetRequest_ff60639f and sets the default values.
