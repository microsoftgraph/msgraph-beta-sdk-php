...
class WindowsFeatureUpdateProfileAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $windowsFeatureUpdateProfileAssignmentId key: id of windowsFeatureUpdateProfileAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsFeatureUpdateProfileAssignmentId = null) {
        ...
        $urlTplParams['windowsFeatureUpdateProfileAssignmentId'] = $windowsFeatureUpdateProfileAssignmentId;
