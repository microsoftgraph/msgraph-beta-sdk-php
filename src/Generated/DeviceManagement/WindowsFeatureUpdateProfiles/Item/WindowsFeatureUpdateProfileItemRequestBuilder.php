...
class WindowsFeatureUpdateProfileItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsFeatureUpdateProfileId = null) {
        ...
        $urlTplParams['windowsFeatureUpdateProfileId'] = $windowsFeatureUpdateProfileId;
