...
use Microsoft\Graph\Beta\Generated\DeviceManagement\WindowsFeatureUpdateProfiles\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class WindowsFeatureUpdateProfileItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): WindowsFeatureUpdateProfileAssignmentItemRequestBuilder {
        ...
        return new WindowsFeatureUpdateProfileAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $windowsFeatureUpdateProfileId key: id of windowsFeatureUpdateProfile
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $windowsFeatureUpdateProfileId = null) {
