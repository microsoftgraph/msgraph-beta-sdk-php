...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: windowsFeatureUpdateProfilesRequestBuilderGetRequestConfiguration
*/
class WindowsFeatureUpdateProfilesRequestBuilderGetRequestCon_f1f1a614 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WindowsFeatureUpdateProfilesRequestBuilderGetRequestCon_f1f1a614 and sets the default values.
