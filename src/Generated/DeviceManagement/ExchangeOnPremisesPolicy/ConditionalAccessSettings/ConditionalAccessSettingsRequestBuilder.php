...
class ConditionalAccessSettingsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/exchangeOnPremisesPolicy/conditionalAccessSettings{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?ConditionalAccessSettingsRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/exchangeOnPremisesPolicy/conditionalAccessSettings';
