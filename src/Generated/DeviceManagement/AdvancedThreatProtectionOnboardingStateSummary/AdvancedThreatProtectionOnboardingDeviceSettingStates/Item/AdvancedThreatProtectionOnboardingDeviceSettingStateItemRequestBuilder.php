...
class AdvancedThreatProtectionOnboardingDeviceSettingStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $advancedThreatProtectionOnboardingDeviceSettingStateId key: id of advancedThreatProtectionOnboardingDeviceSettingState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $advancedThreatProtectionOnboardingDeviceSettingStateId = null) {
        ...
        $urlTplParams['advancedThreatProtectionOnboardingDeviceSettingStateId'] = $advancedThreatProtectionOnboardingDeviceSettingStateId;
