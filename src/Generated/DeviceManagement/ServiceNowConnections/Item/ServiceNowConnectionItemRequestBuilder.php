...
class ServiceNowConnectionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $serviceNowConnectionId key: id of serviceNowConnection
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $serviceNowConnectionId = null) {
        ...
        $urlTplParams['serviceNowConnectionId'] = $serviceNowConnectionId;
