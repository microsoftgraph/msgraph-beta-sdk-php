...
class DeviceRunStatesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the deviceRunStates property of the microsoft.graph.hardwareConfiguration entity.
     * @param string $hardwareConfigurationDeviceStateId The unique identifier of hardwareConfigurationDeviceState
     * @return HardwareConfigurationDeviceStateItemRequestBuilder
    */
    public function byHardwareConfigurationDeviceStateId(string $hardwareConfigurationDeviceStateId): HardwareConfigurationDeviceStateItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['hardwareConfigurationDeviceState%2Did'] = $hardwareConfigurationDeviceStateId;
        return new HardwareConfigurationDeviceStateItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
    ...
    */
     ...
     * @return Promise<HardwareConfigurationDeviceStateCollectionResponse|null>
     * @throws Exception
    */
    public function get(?DeviceRunStatesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [HardwareConfigurationDeviceStateCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
     ...
     * @throws Exception
    */
    public function post(HardwareConfigurationDeviceState $body, ?DeviceRunStatesRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?DeviceRunStatesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/hardwareConfigurations/{hardwareConfiguration%2Did}/deviceRunStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(HardwareConfigurationDeviceState $body, ?DeviceRunStatesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/hardwareConfigurations/{hardwareConfiguration%2Did}/deviceRunStates';
        $requestInfo->pathParameters = $this->pathParameters;
