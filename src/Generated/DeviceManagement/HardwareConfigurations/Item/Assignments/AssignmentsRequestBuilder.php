...
use Microsoft\Graph\Beta\Generated\DeviceManagement\HardwareConfigurations\Item\Assignments\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\HardwareConfigurations\Item\Assignments\Item\HardwareConfigurationAssignmentItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\HardwareConfigurationAssignment;
use Microsoft\Graph\Beta\Generated\Models\HardwareConfigurationAssignmentCollectionResponse;
...
class AssignmentsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the assignments property of the microsoft.graph.hardwareConfiguration entity.
     * @param string $hardwareConfigurationAssignmentId The unique identifier of hardwareConfigurationAssignment
     * @return HardwareConfigurationAssignmentItemRequestBuilder
    */
    public function byHardwareConfigurationAssignmentId(string $hardwareConfigurationAssignmentId): HardwareConfigurationAssignmentItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['hardwareConfigurationAssignment%2Did'] = $hardwareConfigurationAssignmentId;
        return new HardwareConfigurationAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
    ...
    */
     ...
     * @return Promise<HardwareConfigurationAssignmentCollectionResponse|null>
     * @throws Exception
    */
    public function get(?AssignmentsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [HardwareConfigurationAssignmentCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
     ...
     * @throws Exception
    */
    public function post(HardwareConfigurationAssignment $body, ?AssignmentsRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?AssignmentsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/hardwareConfigurations/{hardwareConfiguration%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(HardwareConfigurationAssignment $body, ?AssignmentsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/hardwareConfigurations/{hardwareConfiguration%2Did}/assignments';
        $requestInfo->pathParameters = $this->pathParameters;
