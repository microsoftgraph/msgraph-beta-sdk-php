...
*/
class HardwareConfigurationUserStateItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function toGetRequestInformation(?HardwareConfigurationUserStateItemRequestBuilderGetRequ_63fc036c $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/hardwareConfigurations/{hardwareConfiguration%2Did}/userRunStates/{hardwareConfigurationUserState%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): HardwareConfigurationUserStateItemRequestBuilder {
        return new HardwareConfigurationUserStateItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
