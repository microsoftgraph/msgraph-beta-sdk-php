...
*/
class UserExperienceAnalyticsDeviceTimelineEventItemRequestBuilder 
{
    /**
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsDeviceTimelineEventId key: id of userExperienceAnalyticsDeviceTimelineEvent
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsDeviceTimelineEventId = null) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceTimelineEvent/{userExperienceAnalyticsDeviceTimelineEvent%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['userExperienceAnalyticsDeviceTimelineEventId'] = $userExperienceAnalyticsDeviceTimelineEventId;
