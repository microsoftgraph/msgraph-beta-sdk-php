...
*/
class PrivilegeManagementElevationItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/privilegeManagementElevations/{privilegeManagementElevation%2Did}{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?PrivilegeManagementElevationItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/privilegeManagementElevations/{privilegeManagementElevation%2Did}';
    ...
    */
    public function withUrl(string $rawUrl): PrivilegeManagementElevationItemRequestBuilder {
        return new PrivilegeManagementElevationItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
