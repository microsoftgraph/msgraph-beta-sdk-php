...
use Microsoft\Graph\Beta\Generated\DeviceManagement\AndroidForWorkEnrollmentProfiles\Item\MicrosoftGraphCreateToken\MicrosoftGraphCreateTokenRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\AndroidForWorkEnrollmentProfiles\Item\MicrosoftGraphRevokeToken\MicrosoftGraphRevokeTokenRequestBuilder;
...
class AndroidForWorkEnrollmentProfileItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphCreateToken(): MicrosoftGraphCreateTokenRequestBuilder {
        return new MicrosoftGraphCreateTokenRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the revokeToken method.
    */
    public function microsoftGraphRevokeToken(): MicrosoftGraphRevokeTokenRequestBuilder {
        return new MicrosoftGraphRevokeTokenRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
