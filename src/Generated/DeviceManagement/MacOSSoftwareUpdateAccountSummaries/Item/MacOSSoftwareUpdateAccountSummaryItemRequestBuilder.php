...
class MacOSSoftwareUpdateAccountSummaryItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $macOSSoftwareUpdateAccountSummaryId = null) {
        ...
        $urlTplParams['macOSSoftwareUpdateAccountSummaryId'] = $macOSSoftwareUpdateAccountSummaryId;
