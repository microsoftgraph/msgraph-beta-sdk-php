...
class MacOSSoftwareUpdateAccountSummaryItemRequestBuilder 
{
    ...
    */
    public function categorySummariesById(string $id): MacOSSoftwareUpdateCategorySummaryItemRequestBuilder {
        ...
        return new MacOSSoftwareUpdateCategorySummaryItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $macOSSoftwareUpdateAccountSummaryId key: id of macOSSoftwareUpdateAccountSummary
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $macOSSoftwareUpdateAccountSummaryId = null) {
