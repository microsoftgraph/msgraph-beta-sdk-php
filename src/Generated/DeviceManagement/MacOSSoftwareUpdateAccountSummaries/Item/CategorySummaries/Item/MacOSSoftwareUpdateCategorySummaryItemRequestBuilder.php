...
class MacOSSoftwareUpdateCategorySummaryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $macOSSoftwareUpdateCategorySummaryId key: id of macOSSoftwareUpdateCategorySummary
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $macOSSoftwareUpdateCategorySummaryId = null) {
    ...
    */
    public function updateStateSummariesById(string $id): MacOSSoftwareUpdateStateSummaryItemRequestBuilder {
        ...
        return new MacOSSoftwareUpdateStateSummaryItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
