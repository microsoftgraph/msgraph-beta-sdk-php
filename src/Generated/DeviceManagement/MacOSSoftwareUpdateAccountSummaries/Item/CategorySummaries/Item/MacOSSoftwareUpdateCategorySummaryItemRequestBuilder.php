...
class MacOSSoftwareUpdateCategorySummaryItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $macOSSoftwareUpdateCategorySummaryId = null) {
        ...
        $urlTplParams['macOSSoftwareUpdateCategorySummaryId'] = $macOSSoftwareUpdateCategorySummaryId;
