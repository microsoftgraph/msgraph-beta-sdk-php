...
class MacOSSoftwareUpdateStateSummaryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $macOSSoftwareUpdateStateSummaryId key: id of macOSSoftwareUpdateStateSummary
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $macOSSoftwareUpdateStateSummaryId = null) {
        ...
        $urlTplParams['macOSSoftwareUpdateStateSummaryId'] = $macOSSoftwareUpdateStateSummaryId;
