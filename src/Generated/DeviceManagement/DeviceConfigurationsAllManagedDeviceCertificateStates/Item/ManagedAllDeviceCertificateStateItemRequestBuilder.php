...
class ManagedAllDeviceCertificateStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedAllDeviceCertificateStateId key: id of managedAllDeviceCertificateState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedAllDeviceCertificateStateId = null) {
        ...
        $urlTplParams['managedAllDeviceCertificateStateId'] = $managedAllDeviceCertificateStateId;
