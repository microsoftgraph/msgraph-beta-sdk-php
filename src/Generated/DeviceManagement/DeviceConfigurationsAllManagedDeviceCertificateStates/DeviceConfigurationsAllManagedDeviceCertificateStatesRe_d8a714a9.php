...
*/
class DeviceConfigurationsAllManagedDeviceCertificateStatesRe_d8a714a9 extends BaseRequestBuilder 
{
    /**
    ...
    */
     ...
     * @param DeviceConfigurationsAllManagedDeviceCertificateStatesRe_011a068d|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<ManagedAllDeviceCertificateStateCollectionResponse|null>
     * @throws Exception
    */
    public function get(?DeviceConfigurationsAllManagedDeviceCertificateStatesRe_011a068d $requestConfiguration = null): Promise {
     ...
     * @param DeviceConfigurationsAllManagedDeviceCertificateStatesRe_978a1fb1|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<ManagedAllDeviceCertificateState|null>
     * @throws Exception
    */
    public function post(ManagedAllDeviceCertificateState $body, ?DeviceConfigurationsAllManagedDeviceCertificateStatesRe_978a1fb1 $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?DeviceConfigurationsAllManagedDeviceCertificateStatesRe_011a068d $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/deviceConfigurationsAllManagedDeviceCertificateStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(ManagedAllDeviceCertificateState $body, ?DeviceConfigurationsAllManagedDeviceCertificateStatesRe_978a1fb1 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
     ...
     * @return DeviceConfigurationsAllManagedDeviceCertificateStatesRe_d8a714a9
    */
    public function withUrl(string $rawUrl): DeviceConfigurationsAllManagedDeviceCertificateStatesRe_d8a714a9 {
        return new DeviceConfigurationsAllManagedDeviceCertificateStatesRe_d8a714a9($rawUrl, $this->requestAdapter);
    }
