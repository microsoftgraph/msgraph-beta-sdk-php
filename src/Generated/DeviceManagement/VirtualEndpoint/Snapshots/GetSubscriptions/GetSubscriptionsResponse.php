...
class GetSubscriptionsResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
     * @var array<CloudPcSubscription>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetSubscriptionsResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(CloudPcSubscription::class, 'createFromDiscriminatorValue'))); },
        ]);
    }
