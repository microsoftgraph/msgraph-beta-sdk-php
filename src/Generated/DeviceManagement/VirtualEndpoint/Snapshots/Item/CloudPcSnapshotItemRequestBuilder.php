...
class CloudPcSnapshotItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcSnapshotId key: id of cloudPcSnapshot
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcSnapshotId = null) {
        ...
        $urlTplParams['cloudPcSnapshotId'] = $cloudPcSnapshotId;
