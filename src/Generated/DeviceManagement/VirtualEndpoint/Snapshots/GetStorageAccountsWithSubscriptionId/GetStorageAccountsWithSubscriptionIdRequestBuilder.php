...
class GetStorageAccountsWithSubscriptionIdRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?GetStorageAccountsWithSubscriptionIdRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function get(?GetStorageAccountsWithSubscriptionIdRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(GetStorageAccountsWithSubscriptionIdResponse::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
