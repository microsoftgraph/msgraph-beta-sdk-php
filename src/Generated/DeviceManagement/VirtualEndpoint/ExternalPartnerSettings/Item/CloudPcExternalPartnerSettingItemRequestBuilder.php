...
class CloudPcExternalPartnerSettingItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcExternalPartnerSettingId key: id of cloudPcExternalPartnerSetting
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcExternalPartnerSettingId = null) {
        ...
        $urlTplParams['cloudPcExternalPartnerSettingId'] = $cloudPcExternalPartnerSettingId;
