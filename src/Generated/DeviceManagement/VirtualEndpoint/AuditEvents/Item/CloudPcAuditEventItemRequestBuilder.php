...
class CloudPcAuditEventItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcAuditEventId key: id of cloudPcAuditEvent
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcAuditEventId = null) {
        ...
        $urlTplParams['cloudPcAuditEventId'] = $cloudPcAuditEventId;
