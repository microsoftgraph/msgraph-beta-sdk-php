...
class GetAuditActivityTypesResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetAuditActivityTypesResponse {
