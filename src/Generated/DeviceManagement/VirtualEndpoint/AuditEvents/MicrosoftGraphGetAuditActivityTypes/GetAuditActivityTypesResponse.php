...
class GetAuditActivityTypesResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
     ...
     * @return GetAuditActivityTypesResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetAuditActivityTypesResponse {
