...
use Microsoft\Graph\Beta\Generated\DeviceManagement\VirtualEndpoint\AuditEvents\MicrosoftGraphGetAuditActivityTypes\MicrosoftGraphGetAuditActivityTypesRequestBuilder;
...
class AuditEventsRequestBuilder 
{
    ...
    */
    public function microsoftGraphGetAuditActivityTypes(): MicrosoftGraphGetAuditActivityTypesRequestBuilder {
        return new MicrosoftGraphGetAuditActivityTypesRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/virtualendpoint-list-auditevents?view=graph-rest-1.0 Find more info here
    */
