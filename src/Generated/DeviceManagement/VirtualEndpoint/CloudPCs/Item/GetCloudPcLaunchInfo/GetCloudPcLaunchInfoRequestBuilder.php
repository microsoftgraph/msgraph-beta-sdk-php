...
*/
class GetCloudPcLaunchInfoRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/getCloudPcLaunchInfo()');
    ...
    */
    public function get(?GetCloudPcLaunchInfoRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [CloudPcLaunchInfo::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
