...
class RestoreRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/restore');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/cloudpc-restore?view=graph-rest-beta Find more info here
    */
