...
class ReprovisionRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/reprovision');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/cloudpc-reprovision?view=graph-rest-1.0 Find more info here
    */
