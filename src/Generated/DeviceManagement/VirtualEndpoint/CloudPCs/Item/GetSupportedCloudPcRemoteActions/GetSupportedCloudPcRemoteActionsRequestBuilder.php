...
*/
class GetSupportedCloudPcRemoteActionsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/getSupportedCloudPcRemoteActions(){?%24count,%24filter,%24search,%24skip,%24top}');
    ...
    */
    public function get(?GetSupportedCloudPcRemoteActionsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [GetSupportedCloudPcRemoteActionsGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function withUrl(string $rawUrl): GetSupportedCloudPcRemoteActionsRequestBuilder {
        return new GetSupportedCloudPcRemoteActionsRequestBuilder($rawUrl, $this->requestAdapter);
    }
