...
class RetrieveFrontlineCloudPcDetailRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param RetrieveFrontlineCloudPcDetailRequestBuilderGetRequestC_6067aab2|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
    ...
    */
    public function get(?RetrieveFrontlineCloudPcDetailRequestBuilderGetRequestC_6067aab2 $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?RetrieveFrontlineCloudPcDetailRequestBuilderGetRequestC_6067aab2 $requestConfiguration = null): RequestInformation {
