...
class PowerOnRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/powerOn');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/cloudpc-poweron?view=graph-rest-1.0 Find more info here
    */
