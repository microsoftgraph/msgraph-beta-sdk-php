...
namespace Microsoft\Graph\Beta\Generated\DeviceManagement\VirtualEndpoint\CloudPCs\Item\EndGracePeriod;
...
*/
class EndGracePeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/endGracePeriod');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/cloudpc-endgraceperiod?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toPostRequestInformation(?EndGracePeriodRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): EndGracePeriodRequestBuilder {
        return new EndGracePeriodRequestBuilder($rawUrl, $this->requestAdapter);
    }
