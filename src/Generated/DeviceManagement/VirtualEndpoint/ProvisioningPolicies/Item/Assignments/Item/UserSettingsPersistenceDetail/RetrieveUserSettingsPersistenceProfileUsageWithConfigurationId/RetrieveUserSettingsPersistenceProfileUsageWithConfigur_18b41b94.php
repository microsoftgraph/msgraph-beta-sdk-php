...
/**
 * Provides operations to call the retrieveUserSettingsPersistenceProfileUsage method. Original name: retrieveUserSettingsPersistenceProfileUsageWithConfigurationIdRequestBuilder
*/
class RetrieveUserSettingsPersistenceProfileUsageWithConfigur_18b41b94 extends BaseRequestBuilder 
{
    /**
     * Instantiates a new RetrieveUserSettingsPersistenceProfileUsageWithConfigur_18b41b94 and sets the default values.
    ...
    */
     ...
     * @param RetrieveUserSettingsPersistenceProfileUsageWithConfigur_da6d3300|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<CloudPCUserSettingsPersistenceUsageResult|null>
     * @throws Exception
    */
    public function get(?RetrieveUserSettingsPersistenceProfileUsageWithConfigur_da6d3300 $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?RetrieveUserSettingsPersistenceProfileUsageWithConfigur_da6d3300 $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): RetrieveUserSettingsPersistenceProfileUsageWithConfigur_18b41b94 {
        return new RetrieveUserSettingsPersistenceProfileUsageWithConfigur_18b41b94($rawUrl, $this->requestAdapter);
    }
