...
class CloudPcProvisioningPolicyAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcProvisioningPolicyAssignmentId key: id of cloudPcProvisioningPolicyAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcProvisioningPolicyAssignmentId = null) {
        ...
        $urlTplParams['cloudPcProvisioningPolicyAssignmentId'] = $cloudPcProvisioningPolicyAssignmentId;
