...
*/
class BatchCleanupUserSettingsPersistenceProfileRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}/assignments/{cloudPcProvisioningPolicyAssignment%2Did}/userSettingsPersistenceDetail/batchCleanupUserSettingsPersistenceProfile');
    ...
    */
    public function withUrl(string $rawUrl): BatchCleanupUserSettingsPersistenceProfileRequestBuilder {
        return new BatchCleanupUserSettingsPersistenceProfileRequestBuilder($rawUrl, $this->requestAdapter);
    }
