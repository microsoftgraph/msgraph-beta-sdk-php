...
class RetrieveUserSettingsPersistenceProfilesWithConfigurationIdGetResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
     * Instantiates a new RetrieveUserSettingsPersistenceProfilesWithConfigurationIdGetResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RetrieveUserSettingsPersistenceProfilesWithConfigurationIdGetResponse {
        return new RetrieveUserSettingsPersistenceProfilesWithConfigurationIdGetResponse();
    }
