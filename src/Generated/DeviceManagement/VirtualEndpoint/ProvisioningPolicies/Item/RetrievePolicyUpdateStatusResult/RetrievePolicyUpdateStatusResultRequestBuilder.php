...
class RetrievePolicyUpdateStatusResultRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param RetrievePolicyUpdateStatusResultRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
    ...
    */
    public function get(?RetrievePolicyUpdateStatusResultRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?RetrievePolicyUpdateStatusResultRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
