...
class CloudPcProvisioningPolicyItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcProvisioningPolicyId = null) {
        ...
        $urlTplParams['cloudPcProvisioningPolicyId'] = $cloudPcProvisioningPolicyId;
