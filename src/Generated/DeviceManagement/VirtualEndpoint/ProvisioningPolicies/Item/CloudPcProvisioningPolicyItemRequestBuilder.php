...
use Microsoft\Graph\Beta\Generated\DeviceManagement\VirtualEndpoint\ProvisioningPolicies\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class CloudPcProvisioningPolicyItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): CloudPcProvisioningPolicyAssignmentItemRequestBuilder {
        ...
        return new CloudPcProvisioningPolicyAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $cloudPcProvisioningPolicyId key: id of cloudPcProvisioningPolicy
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $cloudPcProvisioningPolicyId = null) {
