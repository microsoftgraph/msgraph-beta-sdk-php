...
*/
class ApplyConfigRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/applyConfig');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/cloudpcprovisioningpolicy-applyconfig?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toPostRequestInformation(ApplyConfigPostRequestBody $body, ?ApplyConfigRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return ApplyConfigRequestBuilder
    */
    public function withUrl(string $rawUrl): ApplyConfigRequestBuilder {
        return new ApplyConfigRequestBuilder($rawUrl, $this->requestAdapter);
    }
