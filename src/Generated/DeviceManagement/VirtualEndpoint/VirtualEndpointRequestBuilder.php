...
use Microsoft\Graph\Beta\Generated\DeviceManagement\VirtualEndpoint\CloudPcPools\CloudPcPoolsRequestBuilder;
...
class VirtualEndpointRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function externalPartners(): ExternalPartnersRequestBuilder {
        return new ExternalPartnersRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function retrieveScopedPermissions(): RetrieveScopedPermissionsRequestBuilder {
        return new RetrieveScopedPermissionsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the retrieveTenantEncryptionSetting method.
    */
    public function retrieveTenantEncryptionSetting(): RetrieveTenantEncryptionSettingRequestBuilder {
        return new RetrieveTenantEncryptionSettingRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint');
    ...
    */
    public function toGetRequestInformation(?VirtualEndpointRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/virtualEndpoint{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
