...
*/
class OrganizationActionRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/organizationAction');
    ...
    */
    public function toPostRequestInformation(OrganizationActionPostRequestBody $body, ?OrganizationActionRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return OrganizationActionRequestBuilder
    */
    public function withUrl(string $rawUrl): OrganizationActionRequestBuilder {
        return new OrganizationActionRequestBuilder($rawUrl, $this->requestAdapter);
    }
