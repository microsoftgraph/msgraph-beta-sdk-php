...
class CrossCloudGovernmentOrganizationMappingRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @return Promise
     * @link https://learn.microsoft.com/graph/api/cloudpccrosscloudgovernmentorganizationmapping-get?view=graph-rest-1.0 Find more info here
    */
    ...
    */
     ...
     * @return CrossCloudGovernmentOrganizationMappingRequestBuilder
    */
    public function withUrl(string $rawUrl): CrossCloudGovernmentOrganizationMappingRequestBuilder {
        return new CrossCloudGovernmentOrganizationMappingRequestBuilder($rawUrl, $this->requestAdapter);
    }
