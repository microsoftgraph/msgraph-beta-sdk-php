...
class CloudPcSharedUseServicePlanItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcSharedUseServicePlanId key: id of cloudPcSharedUseServicePlan
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcSharedUseServicePlanId = null) {
        ...
        $urlTplParams['cloudPcSharedUseServicePlanId'] = $cloudPcSharedUseServicePlanId;
