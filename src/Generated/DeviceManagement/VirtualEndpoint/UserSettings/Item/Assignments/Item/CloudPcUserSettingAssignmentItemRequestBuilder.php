...
class CloudPcUserSettingAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcUserSettingAssignmentId key: id of cloudPcUserSettingAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcUserSettingAssignmentId = null) {
        ...
        $urlTplParams['cloudPcUserSettingAssignmentId'] = $cloudPcUserSettingAssignmentId;
