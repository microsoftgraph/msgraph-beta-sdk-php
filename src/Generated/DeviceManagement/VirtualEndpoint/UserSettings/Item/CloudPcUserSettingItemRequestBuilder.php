...
use Microsoft\Graph\Beta\Generated\DeviceManagement\VirtualEndpoint\UserSettings\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class CloudPcUserSettingItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): CloudPcUserSettingAssignmentItemRequestBuilder {
        ...
        return new CloudPcUserSettingAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $cloudPcUserSettingId key: id of cloudPcUserSetting
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $cloudPcUserSettingId = null) {
