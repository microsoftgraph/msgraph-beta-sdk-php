...
/**
 * Retrieve the status of a specific deployment action on a specific Cloud PC device. If both activityId and cloudPcId are empty, the paging results are returned, and the pagination size is 100. Original name: retrieveDeployAgentActionResultsactivityIdActivityIdCloudPcIdCloudPcIdRequestBuilderGetQueryParameters
*/
class RetrieveDeployAgentActionResultsactivityIdActivityIdClo_f981ae45 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RetrieveDeployAgentActionResultsactivityIdActivityIdClo_f981ae45 and sets the default values.
