...
class RetrieveCloudPcClientAppUsageReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RetrieveCloudPcClientAppUsageReportPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RetrieveCloudPcClientAppUsageReportPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'reportType' => fn(ParseNode $n) => $o->setReportType($n->getEnumValue(CloudPcClientAppUsageReportType::class)),
    ...
    */
     ...
     * @return CloudPcClientAppUsageReportType|null
    */
    public function getReportType(): ?CloudPcClientAppUsageReportType {
        $val = $this->getBackingStore()->get('reportType');
        if (is_null($val) || $val instanceof CloudPcClientAppUsageReportType) {
            return $val;
        }
    ...
    */
     ...
     * @param CloudPcClientAppUsageReportType|null $value Value to set for the reportType property.
    */
    public function setReportType(?CloudPcClientAppUsageReportType $value): void {
