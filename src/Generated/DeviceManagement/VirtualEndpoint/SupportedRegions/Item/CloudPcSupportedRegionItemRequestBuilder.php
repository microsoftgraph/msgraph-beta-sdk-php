...
class CloudPcSupportedRegionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcSupportedRegionId key: id of cloudPcSupportedRegion
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcSupportedRegionId = null) {
        ...
        $urlTplParams['cloudPcSupportedRegionId'] = $cloudPcSupportedRegionId;
