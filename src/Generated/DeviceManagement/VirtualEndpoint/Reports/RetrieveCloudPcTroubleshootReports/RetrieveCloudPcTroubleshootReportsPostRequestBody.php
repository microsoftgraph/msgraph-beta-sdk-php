...
class RetrieveCloudPcTroubleshootReportsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RetrieveCloudPcTroubleshootReportsPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RetrieveCloudPcTroubleshootReportsPostRequestBody {
        return new RetrieveCloudPcTroubleshootReportsPostRequestBody();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'reportName' => fn(ParseNode $n) => $o->setReportName($n->getEnumValue(CloudPCTroubleshootReportType::class)),
    ...
    */
     ...
     * @return CloudPCTroubleshootReportType|null
    */
    public function getReportName(): ?CloudPCTroubleshootReportType {
        $val = $this->getBackingStore()->get('reportName');
        if (is_null($val) || $val instanceof CloudPCTroubleshootReportType) {
            return $val;
        }
    ...
    */
     ...
     * @param CloudPCTroubleshootReportType|null $value Value to set for the reportName property.
    */
    public function setReportName(?CloudPCTroubleshootReportType $value): void {
