...
class GetFrontlineReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetFrontlineReportPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'reportName' => fn(ParseNode $n) => $o->setReportName($n->getEnumValue(GetFrontlineReportPostRequestBody_reportName::class)),
    ...
    */
     ...
     * @return GetFrontlineReportPostRequestBody_reportName|null
    */
    public function getReportName(): ?GetFrontlineReportPostRequestBody_reportName {
        $val = $this->getBackingStore()->get('reportName');
        if (is_null($val) || $val instanceof GetFrontlineReportPostRequestBody_reportName) {
            return $val;
        }
    ...
    */
     ...
     * @param GetFrontlineReportPostRequestBody_reportName|null $value Value to set for the reportName property.
    */
    public function setReportName(?GetFrontlineReportPostRequestBody_reportName $value): void {
