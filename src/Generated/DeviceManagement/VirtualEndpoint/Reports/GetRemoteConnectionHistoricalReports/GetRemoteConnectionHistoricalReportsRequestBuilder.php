...
class GetRemoteConnectionHistoricalReportsRequestBuilder 
{
    ...
    */
    public function createPostRequestInformation(GetRemoteConnectionHistoricalReportsPostRequestBody $body, ?GetRemoteConnectionHistoricalReportsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(GetRemoteConnectionHistoricalReportsPostRequestBody $body, ?GetRemoteConnectionHistoricalReportsRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
