...
class GetCloudPcPerformanceReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetCloudPcPerformanceReportPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'reportName' => fn(ParseNode $n) => $o->setReportName($n->getEnumValue(GetCloudPcPerformanceReportPostRequestBody_reportName::class)),
    ...
    */
     ...
     * @return GetCloudPcPerformanceReportPostRequestBody_reportName|null
    */
    public function getReportName(): ?GetCloudPcPerformanceReportPostRequestBody_reportName {
        $val = $this->getBackingStore()->get('reportName');
        if (is_null($val) || $val instanceof GetCloudPcPerformanceReportPostRequestBody_reportName) {
            return $val;
        }
    ...
    */
     ...
     * @param GetCloudPcPerformanceReportPostRequestBody_reportName|null $value Value to set for the reportName property.
    */
    public function setReportName(?GetCloudPcPerformanceReportPostRequestBody_reportName $value): void {
