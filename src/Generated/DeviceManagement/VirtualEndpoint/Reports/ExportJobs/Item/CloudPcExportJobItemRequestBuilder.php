...
class CloudPcExportJobItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcExportJobId key: id of cloudPcExportJob
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcExportJobId = null) {
        ...
        $urlTplParams['cloudPcExportJobId'] = $cloudPcExportJobId;
