...
class ReportsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function retrieveCloudPcTenantMetricsReport(): RetrieveCloudPcTenantMetricsReportRequestBuilder {
        return new RetrieveCloudPcTenantMetricsReportRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/reports');
    ...
    */
    public function toGetRequestInformation(?ReportsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/virtualEndpoint/reports{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
