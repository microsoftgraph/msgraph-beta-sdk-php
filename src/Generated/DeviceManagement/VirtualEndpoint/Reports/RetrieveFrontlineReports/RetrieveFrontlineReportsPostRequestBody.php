...
use Microsoft\Graph\Beta\Generated\Models\CloudPCFrontlineReportType;
...
class RetrieveFrontlineReportsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RetrieveFrontlineReportsPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'reportName' => fn(ParseNode $n) => $o->setReportName($n->getEnumValue(CloudPCFrontlineReportType::class)),
    ...
    */
     ...
     * @return CloudPCFrontlineReportType|null
    */
    public function getReportName(): ?CloudPCFrontlineReportType {
        $val = $this->getBackingStore()->get('reportName');
        if (is_null($val) || $val instanceof CloudPCFrontlineReportType) {
            return $val;
        }
    ...
    */
     ...
     * @param CloudPCFrontlineReportType|null $value Value to set for the reportName property.
    */
    public function setReportName(?CloudPCFrontlineReportType $value): void {
