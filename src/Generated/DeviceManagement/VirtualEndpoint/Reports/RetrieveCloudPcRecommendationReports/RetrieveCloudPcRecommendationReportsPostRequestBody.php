...
class RetrieveCloudPcRecommendationReportsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'reportName' => fn(ParseNode $n) => $o->setReportName($n->getEnumValue(CloudPcRecommendationReportType::class)),
    ...
    */
    public function getReportName(): ?CloudPcRecommendationReportType {
    ...
    */
     ...
     * @param CloudPcRecommendationReportType|null $value Value to set for the reportName property.
    */
    public function setReportName(?CloudPcRecommendationReportType $value): void {
