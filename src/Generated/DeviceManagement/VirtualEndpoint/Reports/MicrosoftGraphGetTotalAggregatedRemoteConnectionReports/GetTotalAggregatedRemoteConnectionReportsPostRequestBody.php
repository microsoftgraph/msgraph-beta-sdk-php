...
class GetTotalAggregatedRemoteConnectionReportsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetTotalAggregatedRemoteConnectionReportsPostRequestBody {
