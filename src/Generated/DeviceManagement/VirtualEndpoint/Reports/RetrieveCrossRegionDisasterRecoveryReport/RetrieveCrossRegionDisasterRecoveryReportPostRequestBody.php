...
class RetrieveCrossRegionDisasterRecoveryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RetrieveCrossRegionDisasterRecoveryReportPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'reportName' => fn(ParseNode $n) => $o->setReportName($n->getEnumValue(CloudPcDisasterRecoveryReportName::class)),
    ...
    */
     ...
     * @return CloudPcDisasterRecoveryReportName|null
    */
    public function getReportName(): ?CloudPcDisasterRecoveryReportName {
        $val = $this->getBackingStore()->get('reportName');
        if (is_null($val) || $val instanceof CloudPcDisasterRecoveryReportName) {
            return $val;
        }
    ...
    */
     ...
     * @param CloudPcDisasterRecoveryReportName|null $value Value to set for the reportName property.
    */
    public function setReportName(?CloudPcDisasterRecoveryReportName $value): void {
