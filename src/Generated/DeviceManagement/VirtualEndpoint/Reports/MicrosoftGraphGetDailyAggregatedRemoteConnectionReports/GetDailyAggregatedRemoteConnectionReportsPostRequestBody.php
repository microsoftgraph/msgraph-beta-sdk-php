...
class GetDailyAggregatedRemoteConnectionReportsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetDailyAggregatedRemoteConnectionReportsPostRequestBody {
