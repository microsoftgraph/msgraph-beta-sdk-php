...
*/
class RetrieveConnectionQualityReportsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/virtualEndpoint/reports/retrieveConnectionQualityReports');
    ...
    */
     ...
     * @return RetrieveConnectionQualityReportsRequestBuilder
    */
    public function withUrl(string $rawUrl): RetrieveConnectionQualityReportsRequestBuilder {
        return new RetrieveConnectionQualityReportsRequestBuilder($rawUrl, $this->requestAdapter);
    }
