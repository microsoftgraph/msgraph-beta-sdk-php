...
class RetrieveConnectionQualityReportsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RetrieveConnectionQualityReportsPostRequestBody and sets the default values.
    */
     ...
     * @return RetrieveConnectionQualityReportsPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RetrieveConnectionQualityReportsPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'reportName' => fn(ParseNode $n) => $o->setReportName($n->getEnumValue(CloudPCConnectionQualityReportType::class)),
    ...
    */
     ...
     * @return CloudPCConnectionQualityReportType|null
    */
    public function getReportName(): ?CloudPCConnectionQualityReportType {
        $val = $this->getBackingStore()->get('reportName');
        if (is_null($val) || $val instanceof CloudPCConnectionQualityReportType) {
            return $val;
        }
    ...
    */
     ...
     * @param CloudPCConnectionQualityReportType|null $value Value to set for the reportName property.
    */
    public function setReportName(?CloudPCConnectionQualityReportType $value): void {
