...
class RetrieveCloudPcTenantMetricsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RetrieveCloudPcTenantMetricsReportPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'reportName' => fn(ParseNode $n) => $o->setReportName($n->getEnumValue(CloudPCPerformanceReportName::class)),
    ...
    */
     ...
     * @return CloudPCPerformanceReportName|null
    */
    public function getReportName(): ?CloudPCPerformanceReportName {
        $val = $this->getBackingStore()->get('reportName');
        if (is_null($val) || $val instanceof CloudPCPerformanceReportName) {
            return $val;
        }
    ...
    */
     ...
     * @param CloudPCPerformanceReportName|null $value Value to set for the reportName property.
    */
    public function setReportName(?CloudPCPerformanceReportName $value): void {
