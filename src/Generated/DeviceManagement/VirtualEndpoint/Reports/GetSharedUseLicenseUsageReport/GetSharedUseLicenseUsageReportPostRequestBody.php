...
class GetSharedUseLicenseUsageReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetSharedUseLicenseUsageReportPostRequestBody {
