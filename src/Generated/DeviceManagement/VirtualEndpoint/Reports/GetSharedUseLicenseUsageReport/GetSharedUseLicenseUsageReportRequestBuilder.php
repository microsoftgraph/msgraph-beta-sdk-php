...
*/
class GetSharedUseLicenseUsageReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/cloudpcreports-getshareduselicenseusagereport?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toPostRequestInformation(GetSharedUseLicenseUsageReportPostRequestBody $body, ?GetSharedUseLicenseUsageReportRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return GetSharedUseLicenseUsageReportRequestBuilder
    */
    public function withUrl(string $rawUrl): GetSharedUseLicenseUsageReportRequestBuilder {
        return new GetSharedUseLicenseUsageReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
