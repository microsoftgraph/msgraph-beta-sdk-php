...
class CloudPcGalleryImageItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPcGalleryImageId key: id of cloudPcGalleryImage
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPcGalleryImageId = null) {
        ...
        $urlTplParams['cloudPcGalleryImageId'] = $cloudPcGalleryImageId;
