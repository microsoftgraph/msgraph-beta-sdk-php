...
class ComanagementEligibleDeviceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $comanagementEligibleDeviceId key: id of comanagementEligibleDevice
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $comanagementEligibleDeviceId = null) {
        ...
        $urlTplParams['comanagementEligibleDeviceId'] = $comanagementEligibleDeviceId;
