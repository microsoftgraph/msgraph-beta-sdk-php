...
namespace Microsoft\Graph\Beta\Generated\DeviceManagement\ComanagementEligibleDevices\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/deviceManagement/comanagementEligibleDevices/$count{?%24search,%24filter}");
