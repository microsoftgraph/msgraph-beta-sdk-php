...
class ScopedForResourceWithResourceGetResponse implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ScopedForResourceWithResourceGetResponse {
