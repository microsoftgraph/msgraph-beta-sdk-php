...
use Microsoft\Graph\Beta\Generated\DeviceManagement\TemplateSettings\Count\CountRequestBuilder;
...
*/
class TemplateSettingsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/templateSettings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @param TemplateSettingsRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<DeviceManagementConfigurationSettingTemplateCollectionResponse|null>
     * @throws Exception
    */
    public function get(?TemplateSettingsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
     ...
     * @param TemplateSettingsRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<DeviceManagementConfigurationSettingTemplate|null>
     * @throws Exception
    */
    public function post(DeviceManagementConfigurationSettingTemplate $body, ?TemplateSettingsRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?TemplateSettingsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(DeviceManagementConfigurationSettingTemplate $body, ?TemplateSettingsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/templateSettings';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return TemplateSettingsRequestBuilder
    */
    public function withUrl(string $rawUrl): TemplateSettingsRequestBuilder {
        return new TemplateSettingsRequestBuilder($rawUrl, $this->requestAdapter);
    }
