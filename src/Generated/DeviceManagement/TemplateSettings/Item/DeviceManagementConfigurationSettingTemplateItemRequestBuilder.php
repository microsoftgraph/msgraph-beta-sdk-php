...
class DeviceManagementConfigurationSettingTemplateItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/templateSettings/{deviceManagementConfigurationSettingTemplate_id}{?select,expand}';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(DeviceManagementConfigurationSettingTemplate $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
     ...
     * @return Promise
    */
    public function patch(DeviceManagementConfigurationSettingTemplate $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
