...
class DeviceManagementConfigurationSettingTemplateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementConfigurationSettingTemplateId key: id of deviceManagementConfigurationSettingTemplate
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementConfigurationSettingTemplateId = null) {
        ...
        $urlTplParams['deviceManagementConfigurationSettingTemplateId'] = $deviceManagementConfigurationSettingTemplateId;
