...
class UserExperienceAnalyticsNotAutopilotReadyDeviceRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?UserExperienceAnalyticsNotAutopilotReadyDeviceRequestBu_708b167c $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/userExperienceAnalyticsNotAutopilotReadyDevice{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
