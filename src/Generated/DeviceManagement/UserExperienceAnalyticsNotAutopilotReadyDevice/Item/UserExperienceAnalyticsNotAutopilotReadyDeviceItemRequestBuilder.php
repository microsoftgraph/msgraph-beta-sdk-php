...
class UserExperienceAnalyticsNotAutopilotReadyDeviceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsNotAutopilotReadyDeviceId key: id of userExperienceAnalyticsNotAutopilotReadyDevice
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsNotAutopilotReadyDeviceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsNotAutopilotReadyDeviceId'] = $userExperienceAnalyticsNotAutopilotReadyDeviceId;
