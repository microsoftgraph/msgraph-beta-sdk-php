...
*/
class DeviceManagementConfigurationCategoryItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/configurationCategories/{deviceManagementConfigurationCategory%2Did}{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?DeviceManagementConfigurationCategoryItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/configurationCategories/{deviceManagementConfigurationCategory%2Did}';
    ...
    */
    public function withUrl(string $rawUrl): DeviceManagementConfigurationCategoryItemRequestBuilder {
        return new DeviceManagementConfigurationCategoryItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
