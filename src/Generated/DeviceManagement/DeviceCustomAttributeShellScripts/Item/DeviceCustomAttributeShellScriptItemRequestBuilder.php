...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceCustomAttributeShellScripts\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class DeviceCustomAttributeShellScriptItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): DeviceManagementScriptAssignmentItemRequestBuilder {
        ...
        return new DeviceManagementScriptAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $deviceCustomAttributeShellScriptId key: id of deviceCustomAttributeShellScript
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceCustomAttributeShellScriptId = null) {
    ...
    */
    public function deviceRunStatesById(string $id): DeviceManagementScriptDeviceStateItemRequestBuilder {
        ...
        return new DeviceManagementScriptDeviceStateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function groupAssignmentsById(string $id): DeviceManagementScriptGroupAssignmentItemRequestBuilder {
        ...
        return new DeviceManagementScriptGroupAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function userRunStatesById(string $id): DeviceManagementScriptUserStateItemRequestBuilder {
        ...
        return new DeviceManagementScriptUserStateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
