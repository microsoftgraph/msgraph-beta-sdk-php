...
class DeviceCustomAttributeShellScriptItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceCustomAttributeShellScriptId = null) {
        ...
        $urlTplParams['deviceCustomAttributeShellScriptId'] = $deviceCustomAttributeShellScriptId;
