...
class DeviceManagementScriptGroupAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementScriptGroupAssignmentId key: id of deviceManagementScriptGroupAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementScriptGroupAssignmentId = null) {
        ...
        $urlTplParams['deviceManagementScriptGroupAssignmentId'] = $deviceManagementScriptGroupAssignmentId;
