...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\ConfigManagerPolicySummary;
...
class GetPolicySummaryWithPolicyIdRequestBuilder 
{
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, ConfigManagerPolicySummary::class, $responseHandler);
        } catch(Exception $ex) {
