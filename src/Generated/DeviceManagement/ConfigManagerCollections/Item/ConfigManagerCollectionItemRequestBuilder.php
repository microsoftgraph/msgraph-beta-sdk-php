...
class ConfigManagerCollectionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $configManagerCollectionId key: id of configManagerCollection
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $configManagerCollectionId = null) {
        ...
        $urlTplParams['configManagerCollectionId'] = $configManagerCollectionId;
