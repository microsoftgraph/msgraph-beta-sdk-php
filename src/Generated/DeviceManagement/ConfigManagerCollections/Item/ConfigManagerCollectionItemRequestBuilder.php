...
class ConfigManagerCollectionItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/configManagerCollections/{configManagerCollection%2Did}');
    ...
    */
    public function toGetRequestInformation(?ConfigManagerCollectionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/configManagerCollections/{configManagerCollection%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
