...
class MicrosoftTunnelConfigurationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $microsoftTunnelConfigurationId key: id of microsoftTunnelConfiguration
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $microsoftTunnelConfigurationId = null) {
        ...
        $urlTplParams['microsoftTunnelConfigurationId'] = $microsoftTunnelConfigurationId;
