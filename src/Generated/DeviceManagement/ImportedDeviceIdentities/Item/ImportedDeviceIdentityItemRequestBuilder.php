...
class ImportedDeviceIdentityItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $importedDeviceIdentityId key: id of importedDeviceIdentity
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $importedDeviceIdentityId = null) {
        ...
        $urlTplParams['importedDeviceIdentityId'] = $importedDeviceIdentityId;
