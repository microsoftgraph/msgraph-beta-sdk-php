...
class UserExperienceAnalyticsScoreHistoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsScoreHistoryId key: id of userExperienceAnalyticsScoreHistory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsScoreHistoryId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsScoreHistoryId'] = $userExperienceAnalyticsScoreHistoryId;
