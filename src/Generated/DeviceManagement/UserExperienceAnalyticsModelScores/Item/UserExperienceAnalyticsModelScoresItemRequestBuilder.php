...
class UserExperienceAnalyticsModelScoresItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsModelScoresId key: id of userExperienceAnalyticsModelScores
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsModelScoresId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsModelScoresId'] = $userExperienceAnalyticsModelScoresId;
