...
class DeviceManagementSettingDefinitionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementSettingDefinitionId key: id of deviceManagementSettingDefinition
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementSettingDefinitionId = null) {
        ...
        $urlTplParams['deviceManagementSettingDefinitionId'] = $deviceManagementSettingDefinitionId;
