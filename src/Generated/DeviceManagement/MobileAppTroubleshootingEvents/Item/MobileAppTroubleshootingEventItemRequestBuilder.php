...
class MobileAppTroubleshootingEventItemRequestBuilder 
{
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.mobileAppTroubleshootingEvents.item.appLogCollectionRequests.item collection
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent_id}{?select,expand}';
