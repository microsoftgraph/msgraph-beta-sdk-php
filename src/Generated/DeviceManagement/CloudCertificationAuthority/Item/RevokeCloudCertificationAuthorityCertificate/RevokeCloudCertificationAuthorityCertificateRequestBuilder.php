...
namespace Microsoft\\Graph\\Beta\\Generated\DeviceManagement\CloudCertificationAuthority\Item\RevokeCloudCertificationAuthorityCertificate;
...
*/
class RevokeCloudCertificationAuthorityCertificateRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new RevokeCloudCertificationAuthorityCertificateRequestBuilder and sets the default values.
     * @param array<string, mixed>|string $pathParametersOrRawUrl Path parameters for the request or a String representing the raw URL.
     * @param RequestAdapter $requestAdapter The request adapter to use to execute the requests.
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/cloudCertificationAuthority/{cloudCertificationAuthority%2Did}/revokeCloudCertificationAuthorityCertificate');
    ...
    */
     ...
     * @return RevokeCloudCertificationAuthorityCertificateRequestBuilder
    */
    public function withUrl(string $rawUrl): RevokeCloudCertificationAuthorityCertificateRequestBuilder {
        return new RevokeCloudCertificationAuthorityCertificateRequestBuilder($rawUrl, $this->requestAdapter);
    }
