...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: CloudCertificationAuthorityItemRequestBuilderGetRequestConfiguration
*/
class CloudCertificationAuthorityItemRequestBuilderGetRequest_4b9418b3 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CloudCertificationAuthorityItemRequestBuilderGetRequest_4b9418b3 and sets the default values.
