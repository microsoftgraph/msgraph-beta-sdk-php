...
*/
class UploadExternallySignedCertificationAuthorityCertificate_4517321f implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UploadExternallySignedCertificationAuthorityCertificate_4517321f and sets the default values.
    */
     ...
     * @return UploadExternallySignedCertificationAuthorityCertificate_4517321f
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UploadExternallySignedCertificationAuthorityCertificate_4517321f {
        return new UploadExternallySignedCertificationAuthorityCertificate_4517321f();
    }
