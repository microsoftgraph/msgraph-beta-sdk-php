...
*/
class ChangeCloudCertificationAuthorityStatusRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new ChangeCloudCertificationAuthorityStatusRequestBuilder and sets the default values.
     * @param array<string, mixed>|string $pathParametersOrRawUrl Path parameters for the request or a String representing the raw URL.
     * @param RequestAdapter $requestAdapter The request adapter to use to execute the requests.
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/cloudCertificationAuthority/{cloudCertificationAuthority%2Did}/changeCloudCertificationAuthorityStatus');
    ...
    */
     ...
     * @return ChangeCloudCertificationAuthorityStatusRequestBuilder
    */
    public function withUrl(string $rawUrl): ChangeCloudCertificationAuthorityStatusRequestBuilder {
        return new ChangeCloudCertificationAuthorityStatusRequestBuilder($rawUrl, $this->requestAdapter);
    }
