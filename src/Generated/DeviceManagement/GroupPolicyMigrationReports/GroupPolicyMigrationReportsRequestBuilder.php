...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\GroupPolicyMigrationReport;
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\GroupPolicyMigrationReportCollectionResponse;
...
class GroupPolicyMigrationReportsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/groupPolicyMigrationReports{?top,skip,search,filter,count,orderby,select,expand}';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(GroupPolicyMigrationReport $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, GroupPolicyMigrationReportCollectionResponse::class, $responseHandler);
        } catch(Exception $ex) {
     ...
     * @return Promise
    */
    public function post(GroupPolicyMigrationReport $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        $requestInfo = $this->createPostRequestInformation($body, $headers, $options);
        try {
            return $this->requestAdapter->sendAsync($requestInfo, GroupPolicyMigrationReport::class, $responseHandler);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
