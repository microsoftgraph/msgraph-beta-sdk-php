...
use Microsoft\Graph\Beta\Generated\DeviceManagement\GroupPolicyMigrationReports\Item\MicrosoftGraphUpdateScopeTags\UpdateScopeTagsRequestBuilder;
...
class GroupPolicyMigrationReportItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphUpdateScopeTags(): UpdateScopeTagsRequestBuilder {
    ...
    */
     ...
     * @param string|null $groupPolicyMigrationReportId key: id of groupPolicyMigrationReport
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $groupPolicyMigrationReportId = null) {
    ...
    */
    public function groupPolicySettingMappingsById(string $id): GroupPolicySettingMappingItemRequestBuilder {
        ...
        return new GroupPolicySettingMappingItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function unsupportedGroupPolicyExtensionsById(string $id): UnsupportedGroupPolicyExtensionItemRequestBuilder {
        ...
        return new UnsupportedGroupPolicyExtensionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
