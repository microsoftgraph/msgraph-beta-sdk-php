...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: unsupportedGroupPolicyExtensionsRequestBuilderGetRequestConfiguration
*/
class UnsupportedGroupPolicyExtensionsRequestBuilderGetReques_907b3b3d extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UnsupportedGroupPolicyExtensionsRequestBuilderGetReques_907b3b3d and sets the default values.
