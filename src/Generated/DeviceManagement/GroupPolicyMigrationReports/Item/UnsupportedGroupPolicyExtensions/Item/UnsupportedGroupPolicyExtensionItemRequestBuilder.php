...
class UnsupportedGroupPolicyExtensionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $unsupportedGroupPolicyExtensionId key: id of unsupportedGroupPolicyExtension
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $unsupportedGroupPolicyExtensionId = null) {
        ...
        $urlTplParams['unsupportedGroupPolicyExtensionId'] = $unsupportedGroupPolicyExtensionId;
