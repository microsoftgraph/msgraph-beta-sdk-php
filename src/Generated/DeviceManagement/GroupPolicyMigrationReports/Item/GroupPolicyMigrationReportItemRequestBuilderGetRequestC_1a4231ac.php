...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: GroupPolicyMigrationReportItemRequestBuilderGetRequestConfiguration
*/
class GroupPolicyMigrationReportItemRequestBuilderGetRequestC_1a4231ac extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GroupPolicyMigrationReportItemRequestBuilderGetRequestC_1a4231ac and sets the default values.
