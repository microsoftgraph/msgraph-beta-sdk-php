...
class GroupPolicySettingMappingItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $groupPolicySettingMappingId key: id of groupPolicySettingMapping
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $groupPolicySettingMappingId = null) {
        ...
        $urlTplParams['groupPolicySettingMappingId'] = $groupPolicySettingMappingId;
