...
class UserExperienceAnalyticsDeviceStartupProcessPerformanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsDeviceStartupProcessPerformanceId key: id of userExperienceAnalyticsDeviceStartupProcessPerformance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsDeviceStartupProcessPerformanceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsDeviceStartupProcessPerformanceId'] = $userExperienceAnalyticsDeviceStartupProcessPerformanceId;
