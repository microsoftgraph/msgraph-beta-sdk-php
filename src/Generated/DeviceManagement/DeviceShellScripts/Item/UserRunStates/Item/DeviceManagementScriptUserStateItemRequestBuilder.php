...
class DeviceManagementScriptUserStateItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementScriptUserStateId = null) {
        ...
        $urlTplParams['deviceManagementScriptUserStateId'] = $deviceManagementScriptUserStateId;
