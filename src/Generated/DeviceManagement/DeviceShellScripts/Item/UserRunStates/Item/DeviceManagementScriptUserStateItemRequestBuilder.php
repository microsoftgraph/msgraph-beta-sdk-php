...
class DeviceManagementScriptUserStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementScriptUserStateId key: id of deviceManagementScriptUserState
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceManagementScriptUserStateId = null) {
