...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceShellScripts\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class DeviceShellScriptItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceShellScriptId key: id of deviceShellScript
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceShellScriptId = null) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['deviceShellScriptId'] = $deviceShellScriptId;
