...
class UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsAppHealthAppPerformanceByOSVersionId key: id of userExperienceAnalyticsAppHealthAppPerformanceByOSVersion
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsAppHealthAppPerformanceByOSVersionId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsAppHealthAppPerformanceByOSVersionId'] = $userExperienceAnalyticsAppHealthAppPerformanceByOSVersionId;
