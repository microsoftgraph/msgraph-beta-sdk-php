...
class RestrictedAppsViolationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $restrictedAppsViolationId key: id of restrictedAppsViolation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $restrictedAppsViolationId = null) {
        ...
        $urlTplParams['restrictedAppsViolationId'] = $restrictedAppsViolationId;
