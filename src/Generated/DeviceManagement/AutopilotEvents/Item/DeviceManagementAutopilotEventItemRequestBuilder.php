...
class DeviceManagementAutopilotEventItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementAutopilotEventId key: id of deviceManagementAutopilotEvent
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceManagementAutopilotEventId = null) {
    ...
    */
    public function policyStatusDetailsById(string $id): DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilder {
        ...
        return new DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
