...
class DeviceManagementAutopilotEventItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/autopilotEvents/{deviceManagementAutopilotEvent%2Did}{?%24select,%24expand}');
    ...
    */
    public function withUrl(string $rawUrl): DeviceManagementAutopilotEventItemRequestBuilder {
        return new DeviceManagementAutopilotEventItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
