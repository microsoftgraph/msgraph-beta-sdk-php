...
class DeviceManagementAutopilotEventItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementAutopilotEventId = null) {
        ...
        $urlTplParams['deviceManagementAutopilotEventId'] = $deviceManagementAutopilotEventId;
