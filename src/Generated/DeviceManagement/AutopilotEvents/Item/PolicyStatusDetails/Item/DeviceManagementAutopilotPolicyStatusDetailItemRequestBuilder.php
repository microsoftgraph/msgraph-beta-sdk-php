...
class DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementAutopilotPolicyStatusDetailId key: id of deviceManagementAutopilotPolicyStatusDetail
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementAutopilotPolicyStatusDetailId = null) {
        ...
        $urlTplParams['deviceManagementAutopilotPolicyStatusDetailId'] = $deviceManagementAutopilotPolicyStatusDetailId;
