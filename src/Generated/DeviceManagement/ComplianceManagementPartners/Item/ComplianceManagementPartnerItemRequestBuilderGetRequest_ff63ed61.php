...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ComplianceManagementPartnerItemRequestBuilderGetRequestConfiguration
*/
class ComplianceManagementPartnerItemRequestBuilderGetRequest_ff63ed61 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ComplianceManagementPartnerItemRequestBuilderGetRequest_ff63ed61 and sets the default values.
