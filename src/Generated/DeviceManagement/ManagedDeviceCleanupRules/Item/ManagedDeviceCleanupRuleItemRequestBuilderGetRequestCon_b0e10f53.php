...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ManagedDeviceCleanupRuleItemRequestBuilderGetRequestConfiguration
*/
class ManagedDeviceCleanupRuleItemRequestBuilderGetRequestCon_b0e10f53 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ManagedDeviceCleanupRuleItemRequestBuilderGetRequestCon_b0e10f53 and sets the default values.
