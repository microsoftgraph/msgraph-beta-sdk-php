...
class MonitoringRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.monitoring.alertRecords.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.monitoring.alertRules.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/monitoring{?%24select,%24expand}';
    ...
    */
    public function createDeleteRequestInformation(?MonitoringRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
     ...
     * @return Promise
    */
    public function delete(?MonitoringRequestBuilderDeleteRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
    ...
    */
    public function get(?MonitoringRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(Monitoring::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
