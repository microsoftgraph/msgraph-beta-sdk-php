...
*/
class DeviceManagementGetPortalNotificationsRequestBuilderGetQueryParameters 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new deviceManagementGetPortalNotificationsRequestBuilderGetQueryParameters and sets the default values.
