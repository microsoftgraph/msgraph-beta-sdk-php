...
class CartToClassAssociationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cartToClassAssociationId key: id of cartToClassAssociation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cartToClassAssociationId = null) {
        ...
        $urlTplParams['cartToClassAssociationId'] = $cartToClassAssociationId;
