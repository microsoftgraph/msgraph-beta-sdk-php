...
class TemplatesRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/templates{?top,skip,search,filter,count,orderby,select,expand}';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(DeviceManagementTemplate $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, DeviceManagementTemplateCollectionResponse::class, $responseHandler);
        } catch(Exception $ex) {
     ...
     * @return Promise
    */
    public function post(DeviceManagementTemplate $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
