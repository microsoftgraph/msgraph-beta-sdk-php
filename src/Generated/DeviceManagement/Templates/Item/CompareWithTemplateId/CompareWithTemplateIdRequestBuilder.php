...
class CompareWithTemplateIdRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $templateId = null) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/templates/{deviceManagementTemplate_id}/microsoft.graph.compare(templateId=\'{templateId}\')';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, CompareWithTemplateIdResponse::class, $responseHandler);
        } catch(Exception $ex) {
