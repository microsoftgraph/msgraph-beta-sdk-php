...
class CompareWithTemplateIdRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $templateId = null) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/compare(templateId=\'{templateId}\'){?%24top,%24skip,%24search,%24filter,%24count}';
