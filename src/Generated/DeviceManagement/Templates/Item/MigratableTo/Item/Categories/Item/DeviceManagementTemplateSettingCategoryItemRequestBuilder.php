...
class DeviceManagementTemplateSettingCategoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementTemplateSettingCategoryId key: id of deviceManagementTemplateSettingCategory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementTemplateSettingCategoryId = null) {
        ...
        $urlTplParams['deviceManagementTemplateSettingCategoryId'] = $deviceManagementTemplateSettingCategoryId;
