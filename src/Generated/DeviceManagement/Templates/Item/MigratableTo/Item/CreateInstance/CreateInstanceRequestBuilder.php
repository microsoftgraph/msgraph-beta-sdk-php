...
class CreateInstanceRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/templates/{deviceManagementTemplate_id}/migratableTo/{deviceManagementTemplate_id1}/microsoft.graph.createInstance';
     ...
     * @param CreateInstanceRequestBody $body 
     * @param array<string, mixed>|null $headers Request headers
     * @param array<string, RequestOption>|null $options Request options
     * @return RequestInformation
    */
    public function createPostRequestInformation(CreateInstanceRequestBody $body, ?array $headers = null, ?array $options = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(CreateInstanceRequestBody $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
