...
class DeviceManagementScriptAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementScriptAssignmentId key: id of deviceManagementScriptAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementScriptAssignmentId = null) {
        ...
        $urlTplParams['deviceManagementScriptAssignmentId'] = $deviceManagementScriptAssignmentId;
