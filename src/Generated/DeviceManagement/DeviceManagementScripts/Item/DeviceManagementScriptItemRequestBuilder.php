...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceManagementScripts\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class DeviceManagementScriptItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementScriptId key: id of deviceManagementScript
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementScriptId = null) {
        ...
        $urlTplParams['deviceManagementScriptId'] = $deviceManagementScriptId;
