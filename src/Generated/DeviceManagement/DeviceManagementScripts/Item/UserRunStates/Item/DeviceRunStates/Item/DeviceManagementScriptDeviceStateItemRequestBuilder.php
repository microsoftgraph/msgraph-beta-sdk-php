...
class DeviceManagementScriptDeviceStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementScriptDeviceStateId key: id of deviceManagementScriptDeviceState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementScriptDeviceStateId = null) {
        ...
        $urlTplParams['deviceManagementScriptDeviceStateId'] = $deviceManagementScriptDeviceStateId;
