...
use Microsoft\Graph\Beta\Generated\Models\DeviceAndAppManagementAssignedRoleDetail;
...
*/
class RetrieveUserRoleDetailWithUseridRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $userid = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/retrieveUserRoleDetail(userid=\'{userid}\')');
    ...
    */
    public function get(?RetrieveUserRoleDetailWithUseridRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DeviceAndAppManagementAssignedRoleDetail::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function withUrl(string $rawUrl): RetrieveUserRoleDetailWithUseridRequestBuilder {
        return new RetrieveUserRoleDetailWithUseridRequestBuilder($rawUrl, $this->requestAdapter);
    }
