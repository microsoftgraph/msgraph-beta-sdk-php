...
class UserExperienceAnalyticsDeviceStartupProcessItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsDeviceStartupProcessId key: id of userExperienceAnalyticsDeviceStartupProcess
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsDeviceStartupProcessId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsDeviceStartupProcessId'] = $userExperienceAnalyticsDeviceStartupProcessId;
