...
class UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryId = null) {
