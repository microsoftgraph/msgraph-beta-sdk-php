...
class UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryId key: id of userExperienceAnalyticsBatteryHealthDeviceRuntimeHistory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryId'] = $userExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryId;
