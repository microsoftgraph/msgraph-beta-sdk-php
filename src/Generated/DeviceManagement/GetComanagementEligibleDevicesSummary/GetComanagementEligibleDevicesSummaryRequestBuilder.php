...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\ComanagementEligibleDevicesSummary;
...
class GetComanagementEligibleDevicesSummaryRequestBuilder 
{
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, ComanagementEligibleDevicesSummary::class, $responseHandler);
        } catch(Exception $ex) {
