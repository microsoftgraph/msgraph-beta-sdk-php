...
*/
class GetComanagementEligibleDevicesSummaryRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function withUrl(string $rawUrl): GetComanagementEligibleDevicesSummaryRequestBuilder {
        return new GetComanagementEligibleDevicesSummaryRequestBuilder($rawUrl, $this->requestAdapter);
    }
