...
class DeviceManagementIntentDeviceStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementIntentDeviceStateId key: id of deviceManagementIntentDeviceState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementIntentDeviceStateId = null) {
        ...
        $urlTplParams['deviceManagementIntentDeviceStateId'] = $deviceManagementIntentDeviceStateId;
