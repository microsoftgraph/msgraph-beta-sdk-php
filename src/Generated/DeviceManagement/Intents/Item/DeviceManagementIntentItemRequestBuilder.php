...
use Microsoft\Graph\Beta\Generated\DeviceManagement\Intents\Item\MicrosoftGraphAssign\MicrosoftGraphAssignRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\Intents\Item\MicrosoftGraphCompareWithTemplateId\MicrosoftGraphCompareWithTemplateIdRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\Intents\Item\MicrosoftGraphCreateCopy\MicrosoftGraphCreateCopyRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\Intents\Item\MicrosoftGraphMigrateToTemplate\MicrosoftGraphMigrateToTemplateRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\Intents\Item\MicrosoftGraphUpdateSettings\MicrosoftGraphUpdateSettingsRequestBuilder;
...
class DeviceManagementIntentItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphCreateCopy(): MicrosoftGraphCreateCopyRequestBuilder {
        return new MicrosoftGraphCreateCopyRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the migrateToTemplate method.
    */
    public function microsoftGraphMigrateToTemplate(): MicrosoftGraphMigrateToTemplateRequestBuilder {
        return new MicrosoftGraphMigrateToTemplateRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the updateSettings method.
    */
    public function microsoftGraphUpdateSettings(): MicrosoftGraphUpdateSettingsRequestBuilder {
        return new MicrosoftGraphUpdateSettingsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function assignmentsById(string $id): DeviceManagementIntentAssignmentItemRequestBuilder {
        ...
        return new DeviceManagementIntentAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function categoriesById(string $id): DeviceManagementIntentSettingCategoryItemRequestBuilder {
        ...
        return new DeviceManagementIntentSettingCategoryItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function deviceSettingStateSummariesById(string $id): DeviceManagementIntentDeviceSettingStateSummaryItemRequestBuilder {
        ...
        return new DeviceManagementIntentDeviceSettingStateSummaryItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function deviceStatesById(string $id): DeviceManagementIntentDeviceStateItemRequestBuilder {
        ...
        return new DeviceManagementIntentDeviceStateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function settingsById(string $id): DeviceManagementSettingInstanceItemRequestBuilder {
        ...
        return new DeviceManagementSettingInstanceItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function userStatesById(string $id): DeviceManagementIntentUserStateItemRequestBuilder {
        ...
        return new DeviceManagementIntentUserStateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
