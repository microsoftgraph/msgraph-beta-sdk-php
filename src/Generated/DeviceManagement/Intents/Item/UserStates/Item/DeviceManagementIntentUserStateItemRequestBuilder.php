...
class DeviceManagementIntentUserStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementIntentUserStateId key: id of deviceManagementIntentUserState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementIntentUserStateId = null) {
        ...
        $urlTplParams['deviceManagementIntentUserStateId'] = $deviceManagementIntentUserStateId;
