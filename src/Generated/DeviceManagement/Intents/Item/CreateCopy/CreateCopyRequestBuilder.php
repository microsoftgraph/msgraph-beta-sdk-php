...
class CreateCopyRequestBuilder 
{
    ...
    */
     ...
     * @param CreateCopyPostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(CreateCopyPostRequestBody $body, ?CreateCopyRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(CreateCopyPostRequestBody $body, ?CreateCopyRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
