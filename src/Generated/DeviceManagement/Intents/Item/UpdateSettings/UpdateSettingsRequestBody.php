...
class UpdateSettingsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UpdateSettingsRequestBody {
