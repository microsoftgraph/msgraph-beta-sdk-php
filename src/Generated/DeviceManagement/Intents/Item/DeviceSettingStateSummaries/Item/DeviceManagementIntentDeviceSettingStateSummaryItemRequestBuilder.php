...
class DeviceManagementIntentDeviceSettingStateSummaryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementIntentDeviceSettingStateSummaryId key: id of deviceManagementIntentDeviceSettingStateSummary
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementIntentDeviceSettingStateSummaryId = null) {
        ...
        $urlTplParams['deviceManagementIntentDeviceSettingStateSummaryId'] = $deviceManagementIntentDeviceSettingStateSummaryId;
