...
*/
class DeviceStateSummaryRequestBuilderGetRequestConfiguration 
{
    /**
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): DeviceStateSummaryRequestBuilderGetQueryParameters {
