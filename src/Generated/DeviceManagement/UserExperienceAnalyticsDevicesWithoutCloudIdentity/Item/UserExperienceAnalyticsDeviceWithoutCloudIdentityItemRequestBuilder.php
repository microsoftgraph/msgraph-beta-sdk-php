...
class UserExperienceAnalyticsDeviceWithoutCloudIdentityItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsDeviceWithoutCloudIdentityId key: id of userExperienceAnalyticsDeviceWithoutCloudIdentity
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsDeviceWithoutCloudIdentityId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsDeviceWithoutCloudIdentityId'] = $userExperienceAnalyticsDeviceWithoutCloudIdentityId;
