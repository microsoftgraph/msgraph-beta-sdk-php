...
class UserExperienceAnalyticsMetricHistoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsMetricHistoryId key: id of userExperienceAnalyticsMetricHistory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsMetricHistoryId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsMetricHistoryId'] = $userExperienceAnalyticsMetricHistoryId;
