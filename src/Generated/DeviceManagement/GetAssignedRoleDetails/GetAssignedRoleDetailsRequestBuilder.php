...
class GetAssignedRoleDetailsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @return Promise<DeviceAndAppManagementAssignedRoleDetails|null>
     * @throws Exception
    */
    ...
    */
    public function withUrl(string $rawUrl): GetAssignedRoleDetailsRequestBuilder {
        return new GetAssignedRoleDetailsRequestBuilder($rawUrl, $this->requestAdapter);
    }
