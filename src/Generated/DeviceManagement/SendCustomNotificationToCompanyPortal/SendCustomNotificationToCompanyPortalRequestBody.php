...
class SendCustomNotificationToCompanyPortalRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'groupsToNotify' => function (self $o, ParseNode $n) { $o->setGroupsToNotify($n->getCollectionOfPrimitiveValues()); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeCollectionOfPrimitiveValues('groupsToNotify', $this->groupsToNotify);
