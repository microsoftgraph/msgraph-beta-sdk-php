...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: DeviceComplianceDeviceStatusItemRequestBuilderGetRequestConfiguration
*/
class DeviceComplianceDeviceStatusItemRequestBuilderGetReques_f6fd7d71 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceComplianceDeviceStatusItemRequestBuilderGetReques_f6fd7d71 and sets the default values.
