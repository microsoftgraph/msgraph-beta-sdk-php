...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: SettingStateDeviceSummaryItemRequestBuilderGetRequestConfiguration
*/
class SettingStateDeviceSummaryItemRequestBuilderGetRequestCo_25cbc452 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SettingStateDeviceSummaryItemRequestBuilderGetRequestCo_25cbc452 and sets the default values.
