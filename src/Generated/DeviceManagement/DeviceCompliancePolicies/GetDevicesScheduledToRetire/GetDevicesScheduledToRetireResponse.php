...
use Microsoft\Graph\Beta\Generated\Models\RetireScheduledManagedDevice;
...
class GetDevicesScheduledToRetireResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetDevicesScheduledToRetireResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([RetireScheduledManagedDevice::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
    public function getValue(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, RetireScheduledManagedDevice::class);
            /** @var array<RetireScheduledManagedDevice>|null $val */
            return $val;
        }
