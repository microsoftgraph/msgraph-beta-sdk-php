...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceCompliancePolicies\MicrosoftGraphGetDevicesScheduledToRetire\MicrosoftGraphGetDevicesScheduledToRetireRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceCompliancePolicies\MicrosoftGraphGetNoncompliantDevicesToRetire\MicrosoftGraphGetNoncompliantDevicesToRetireRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceCompliancePolicies\MicrosoftGraphHasPayloadLinks\MicrosoftGraphHasPayloadLinksRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceCompliancePolicies\MicrosoftGraphRefreshDeviceComplianceReportSummarization\MicrosoftGraphRefreshDeviceComplianceReportSummarizationRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceCompliancePolicies\MicrosoftGraphSetScheduledRetireState\MicrosoftGraphSetScheduledRetireStateRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceCompliancePolicies\MicrosoftGraphValidateComplianceScript\MicrosoftGraphValidateComplianceScriptRequestBuilder;
...
class DeviceCompliancePoliciesRequestBuilder 
{
    ...
    */
    public function microsoftGraphGetDevicesScheduledToRetire(): MicrosoftGraphGetDevicesScheduledToRetireRequestBuilder {
        return new MicrosoftGraphGetDevicesScheduledToRetireRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the getNoncompliantDevicesToRetire method.
    */
    public function microsoftGraphGetNoncompliantDevicesToRetire(): MicrosoftGraphGetNoncompliantDevicesToRetireRequestBuilder {
        return new MicrosoftGraphGetNoncompliantDevicesToRetireRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function microsoftGraphRefreshDeviceComplianceReportSummarization(): MicrosoftGraphRefreshDeviceComplianceReportSummarizationRequestBuilder {
        return new MicrosoftGraphRefreshDeviceComplianceReportSummarizationRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the setScheduledRetireState method.
    */
    public function microsoftGraphSetScheduledRetireState(): MicrosoftGraphSetScheduledRetireStateRequestBuilder {
        return new MicrosoftGraphSetScheduledRetireStateRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the validateComplianceScript method.
    */
    public function microsoftGraphValidateComplianceScript(): MicrosoftGraphValidateComplianceScriptRequestBuilder {
        return new MicrosoftGraphValidateComplianceScriptRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
