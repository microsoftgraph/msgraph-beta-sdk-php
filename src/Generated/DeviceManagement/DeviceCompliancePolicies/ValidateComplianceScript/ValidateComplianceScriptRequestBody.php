...
class ValidateComplianceScriptRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return ValidateComplianceScriptRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ValidateComplianceScriptRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'deviceCompliancePolicyScript' => function (self $o, ParseNode $n) { $o->setDeviceCompliancePolicyScript($n->getObjectValue(DeviceCompliancePolicyScript::class)); },
        ];
    }
