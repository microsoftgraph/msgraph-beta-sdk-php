...
class SetScheduledRetireStateRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return SetScheduledRetireStateRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SetScheduledRetireStateRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'state' => function (self $o, ParseNode $n) { $o->setState($n->getEnumValue(ScheduledRetireState::class)); },
        ];
    }
