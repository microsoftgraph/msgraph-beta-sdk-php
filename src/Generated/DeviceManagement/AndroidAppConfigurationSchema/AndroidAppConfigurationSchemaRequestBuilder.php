...
class AndroidAppConfigurationSchemaRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/androidAppConfigurationSchema');
    ...
    */
    public function toGetRequestInformation(?AndroidAppConfigurationSchemaRequestBuilderGetRequestCo_8e8f12bf $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/androidAppConfigurationSchema{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
