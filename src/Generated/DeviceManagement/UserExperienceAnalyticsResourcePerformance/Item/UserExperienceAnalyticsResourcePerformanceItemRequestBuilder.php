...
class UserExperienceAnalyticsResourcePerformanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsResourcePerformanceId key: id of userExperienceAnalyticsResourcePerformance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsResourcePerformanceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsResourcePerformanceId'] = $userExperienceAnalyticsResourcePerformanceId;
