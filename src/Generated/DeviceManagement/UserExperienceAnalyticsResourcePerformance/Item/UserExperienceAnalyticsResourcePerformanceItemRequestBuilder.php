...
*/
class UserExperienceAnalyticsResourcePerformanceItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/userExperienceAnalyticsResourcePerformance/{userExperienceAnalyticsResourcePerformance%2Did}{?%24select,%24expand}');
    ...
    */
    public function withUrl(string $rawUrl): UserExperienceAnalyticsResourcePerformanceItemRequestBuilder {
        return new UserExperienceAnalyticsResourcePerformanceItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
