...
*/
class IntuneBrandingProfileItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/intuneBrandingProfiles/{intuneBrandingProfile%2Did}');
    ...
    */
    public function toGetRequestInformation(?IntuneBrandingProfileItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/intuneBrandingProfiles/{intuneBrandingProfile%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): IntuneBrandingProfileItemRequestBuilder {
        return new IntuneBrandingProfileItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
