...
use Microsoft\Graph\Beta\Generated\DeviceManagement\IntuneBrandingProfiles\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class IntuneBrandingProfileItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): IntuneBrandingProfileAssignmentItemRequestBuilder {
        ...
        return new IntuneBrandingProfileAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $intuneBrandingProfileId key: id of intuneBrandingProfile
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $intuneBrandingProfileId = null) {
    ...
    */
     ...
     * @return Promise
    */
    public function get(?IntuneBrandingProfileItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
     ...
     * @return Promise
    */
    public function patch(IntuneBrandingProfile $body, ?IntuneBrandingProfileItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
