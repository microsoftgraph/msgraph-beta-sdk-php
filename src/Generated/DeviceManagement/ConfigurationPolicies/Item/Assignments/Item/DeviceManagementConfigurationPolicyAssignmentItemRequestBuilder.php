...
class DeviceManagementConfigurationPolicyAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementConfigurationPolicyAssignmentId key: id of deviceManagementConfigurationPolicyAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementConfigurationPolicyAssignmentId = null) {
        ...
        $urlTplParams['deviceManagementConfigurationPolicyAssignmentId'] = $deviceManagementConfigurationPolicyAssignmentId;
