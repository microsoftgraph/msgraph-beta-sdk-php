...
namespace Microsoft\Graph\Beta\Generated\DeviceManagement\ConfigurationPolicies\Item\MicrosoftGraphAssign;
...
class AssignResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([DeviceManagementConfigurationPolicyAssignment::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
     ...
     * @param array<DeviceManagementConfigurationPolicyAssignment>|null $value Value to set for the value property.
    */
