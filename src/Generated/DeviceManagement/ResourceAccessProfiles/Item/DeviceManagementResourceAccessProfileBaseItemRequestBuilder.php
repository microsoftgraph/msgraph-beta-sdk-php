...
use Microsoft\Graph\Beta\Generated\DeviceManagement\ResourceAccessProfiles\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class DeviceManagementResourceAccessProfileBaseItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): DeviceManagementResourceAccessProfileAssignmentItemRequestBuilder {
        ...
        return new DeviceManagementResourceAccessProfileAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $deviceManagementResourceAccessProfileBaseId key: id of deviceManagementResourceAccessProfileBase
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceManagementResourceAccessProfileBaseId = null) {
