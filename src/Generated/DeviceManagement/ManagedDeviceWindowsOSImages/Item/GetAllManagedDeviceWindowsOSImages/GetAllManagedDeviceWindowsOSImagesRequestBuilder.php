...
*/
class GetAllManagedDeviceWindowsOSImagesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/managedDeviceWindowsOSImages/{managedDeviceWindowsOperatingSystemImage%2Did}/getAllManagedDeviceWindowsOSImages(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function get(?GetAllManagedDeviceWindowsOSImagesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [GetAllManagedDeviceWindowsOSImagesGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
     ...
     * @return GetAllManagedDeviceWindowsOSImagesRequestBuilder
    */
    public function withUrl(string $rawUrl): GetAllManagedDeviceWindowsOSImagesRequestBuilder {
        return new GetAllManagedDeviceWindowsOSImagesRequestBuilder($rawUrl, $this->requestAdapter);
    }
