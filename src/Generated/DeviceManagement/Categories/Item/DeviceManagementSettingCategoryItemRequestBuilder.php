...
class DeviceManagementSettingCategoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementSettingCategoryId key: id of deviceManagementSettingCategory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementSettingCategoryId = null) {
        ...
        $urlTplParams['deviceManagementSettingCategoryId'] = $deviceManagementSettingCategoryId;
