...
use Microsoft\Graph\Beta\Generated\DeviceManagement\Categories\Count\CountRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\Models\DeviceManagementSettingCategoryCollectionResponse;
...
class CategoriesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the categories property of the microsoft.graph.deviceManagement entity.
     * @param string $deviceManagementSettingCategoryId The unique identifier of deviceManagementSettingCategory
     * @return DeviceManagementSettingCategoryItemRequestBuilder
    */
    public function byDeviceManagementSettingCategoryId(string $deviceManagementSettingCategoryId): DeviceManagementSettingCategoryItemRequestBuilder {
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/categories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<DeviceManagementSettingCategoryCollectionResponse|null>
     * @throws Exception
    */
    public function get(?CategoriesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DeviceManagementSettingCategoryCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
     ...
     * @throws Exception
    */
    public function post(DeviceManagementSettingCategory $body, ?CategoriesRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(DeviceManagementSettingCategory $body, ?CategoriesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/categories';
        $requestInfo->pathParameters = $this->pathParameters;
