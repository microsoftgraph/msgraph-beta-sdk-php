...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: windowsAutopilotDeviceIdentitiesRequestBuilderGetRequestConfiguration
*/
class WindowsAutopilotDeviceIdentitiesRequestBuilderGetReques_f6e66298 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WindowsAutopilotDeviceIdentitiesRequestBuilderGetReques_f6e66298 and sets the default values.
