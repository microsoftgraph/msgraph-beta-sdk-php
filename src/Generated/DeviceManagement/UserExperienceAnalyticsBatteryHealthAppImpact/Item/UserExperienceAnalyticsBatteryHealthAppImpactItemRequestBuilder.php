...
class UserExperienceAnalyticsBatteryHealthAppImpactItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsBatteryHealthAppImpactId key: id of userExperienceAnalyticsBatteryHealthAppImpact
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsBatteryHealthAppImpactId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsBatteryHealthAppImpactId'] = $userExperienceAnalyticsBatteryHealthAppImpactId;
