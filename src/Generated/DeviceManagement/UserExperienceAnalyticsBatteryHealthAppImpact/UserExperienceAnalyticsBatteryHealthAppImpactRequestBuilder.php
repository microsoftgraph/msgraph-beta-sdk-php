...
class UserExperienceAnalyticsBatteryHealthAppImpactRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?UserExperienceAnalyticsBatteryHealthAppImpactRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(UserExperienceAnalyticsBatteryHealthAppImpact $body, ?UserExperienceAnalyticsBatteryHealthAppImpactRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return Promise
    */
    public function get(?UserExperienceAnalyticsBatteryHealthAppImpactRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(UserExperienceAnalyticsBatteryHealthAppImpactCollectionResponse::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
     ...
     * @return Promise
    */
    public function post(UserExperienceAnalyticsBatteryHealthAppImpact $body, ?UserExperienceAnalyticsBatteryHealthAppImpactRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
