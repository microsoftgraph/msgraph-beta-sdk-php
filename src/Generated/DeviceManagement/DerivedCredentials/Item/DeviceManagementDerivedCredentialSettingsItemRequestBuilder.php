...
class DeviceManagementDerivedCredentialSettingsItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementDerivedCredentialSettingsId key: id of deviceManagementDerivedCredentialSettings
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementDerivedCredentialSettingsId = null) {
        ...
        $urlTplParams['deviceManagementDerivedCredentialSettingsId'] = $deviceManagementDerivedCredentialSettingsId;
