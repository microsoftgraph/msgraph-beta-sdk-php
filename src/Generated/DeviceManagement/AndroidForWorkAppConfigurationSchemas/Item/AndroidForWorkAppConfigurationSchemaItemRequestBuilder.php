...
class AndroidForWorkAppConfigurationSchemaItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $androidForWorkAppConfigurationSchemaId key: id of androidForWorkAppConfigurationSchema
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $androidForWorkAppConfigurationSchemaId = null) {
        ...
        $urlTplParams['androidForWorkAppConfigurationSchemaId'] = $androidForWorkAppConfigurationSchemaId;
