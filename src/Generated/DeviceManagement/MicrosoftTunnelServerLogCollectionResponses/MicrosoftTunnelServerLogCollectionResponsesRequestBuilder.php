...
class MicrosoftTunnelServerLogCollectionResponsesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/microsoftTunnelServerLogCollectionResponses{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
     ...
     * @return MicrosoftTunnelServerLogCollectionResponsesRequestBuilder
    */
    public function withUrl(string $rawUrl): MicrosoftTunnelServerLogCollectionResponsesRequestBuilder {
        return new MicrosoftTunnelServerLogCollectionResponsesRequestBuilder($rawUrl, $this->requestAdapter);
    }
