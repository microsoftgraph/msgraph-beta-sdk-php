...
class UserExperienceAnalyticsWorkFromAnywhereModelPerformanceItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsWorkFromAnywhereModelPerformanceId = null) {
