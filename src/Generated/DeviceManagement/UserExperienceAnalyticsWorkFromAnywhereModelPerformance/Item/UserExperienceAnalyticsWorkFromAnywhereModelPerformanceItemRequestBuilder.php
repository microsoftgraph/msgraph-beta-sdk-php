...
class UserExperienceAnalyticsWorkFromAnywhereModelPerformanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsWorkFromAnywhereModelPerformanceId key: id of userExperienceAnalyticsWorkFromAnywhereModelPerformance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsWorkFromAnywhereModelPerformanceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsWorkFromAnywhereModelPerformanceId'] = $userExperienceAnalyticsWorkFromAnywhereModelPerformanceId;
