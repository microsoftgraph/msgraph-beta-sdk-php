...
class EmbeddedSIMDeviceStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $embeddedSIMDeviceStateId key: id of embeddedSIMDeviceState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $embeddedSIMDeviceStateId = null) {
        ...
        $urlTplParams['embeddedSIMDeviceStateId'] = $embeddedSIMDeviceStateId;
