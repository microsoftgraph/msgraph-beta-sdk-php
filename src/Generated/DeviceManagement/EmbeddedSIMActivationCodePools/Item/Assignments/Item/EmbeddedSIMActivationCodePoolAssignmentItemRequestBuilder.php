...
class EmbeddedSIMActivationCodePoolAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $embeddedSIMActivationCodePoolAssignmentId key: id of embeddedSIMActivationCodePoolAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $embeddedSIMActivationCodePoolAssignmentId = null) {
        ...
        $urlTplParams['embeddedSIMActivationCodePoolAssignmentId'] = $embeddedSIMActivationCodePoolAssignmentId;
