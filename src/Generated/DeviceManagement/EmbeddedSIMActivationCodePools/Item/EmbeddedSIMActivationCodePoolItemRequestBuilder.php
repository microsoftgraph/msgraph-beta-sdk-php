...
use Microsoft\Graph\Beta\Generated\DeviceManagement\EmbeddedSIMActivationCodePools\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class EmbeddedSIMActivationCodePoolItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): EmbeddedSIMActivationCodePoolAssignmentItemRequestBuilder {
        ...
        return new EmbeddedSIMActivationCodePoolAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $embeddedSIMActivationCodePoolId key: id of embeddedSIMActivationCodePool
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $embeddedSIMActivationCodePoolId = null) {
    ...
    */
    public function deviceStatesById(string $id): EmbeddedSIMDeviceStateItemRequestBuilder {
        ...
        return new EmbeddedSIMDeviceStateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
