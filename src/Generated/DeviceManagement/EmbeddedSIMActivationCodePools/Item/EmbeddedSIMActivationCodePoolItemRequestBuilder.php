...
class EmbeddedSIMActivationCodePoolItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $embeddedSIMActivationCodePoolId = null) {
        ...
        $urlTplParams['embeddedSIMActivationCodePoolId'] = $embeddedSIMActivationCodePoolId;
