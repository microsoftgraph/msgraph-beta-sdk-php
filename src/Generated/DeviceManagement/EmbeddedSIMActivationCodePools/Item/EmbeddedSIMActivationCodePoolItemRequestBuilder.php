...
*/
class EmbeddedSIMActivationCodePoolItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/embeddedSIMActivationCodePools/{embeddedSIMActivationCodePool%2Did}{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?EmbeddedSIMActivationCodePoolItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/embeddedSIMActivationCodePools/{embeddedSIMActivationCodePool%2Did}';
    ...
    */
    public function withUrl(string $rawUrl): EmbeddedSIMActivationCodePoolItemRequestBuilder {
        return new EmbeddedSIMActivationCodePoolItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
