...
class AndroidManagedStoreAppConfigurationSchemasRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?AndroidManagedStoreAppConfigurationSchemasRequestBuilde_4b8ac4b7 $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/androidManagedStoreAppConfigurationSchemas{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
     ...
     * @return AndroidManagedStoreAppConfigurationSchemasRequestBuilder
    */
    public function withUrl(string $rawUrl): AndroidManagedStoreAppConfigurationSchemasRequestBuilder {
        return new AndroidManagedStoreAppConfigurationSchemasRequestBuilder($rawUrl, $this->requestAdapter);
    }
