...
class AndroidManagedStoreAppConfigurationSchemaItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $androidManagedStoreAppConfigurationSchemaId key: id of androidManagedStoreAppConfigurationSchema
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $androidManagedStoreAppConfigurationSchemaId = null) {
        ...
        $urlTplParams['androidManagedStoreAppConfigurationSchemaId'] = $androidManagedStoreAppConfigurationSchemaId;
