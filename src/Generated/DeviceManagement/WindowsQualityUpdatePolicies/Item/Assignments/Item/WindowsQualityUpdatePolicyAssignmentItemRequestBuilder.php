...
*/
class WindowsQualityUpdatePolicyAssignmentItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function withUrl(string $rawUrl): WindowsQualityUpdatePolicyAssignmentItemRequestBuilder {
        return new WindowsQualityUpdatePolicyAssignmentItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
