...
class BulkActionPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new BulkActionPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): BulkActionPostRequestBody {
     ...
     * @return WindowsQualityUpdatePolicyActionType|null
    */
    public function getAction(): ?WindowsQualityUpdatePolicyActionType {
        $val = $this->getBackingStore()->get('action');
        if (is_null($val) || $val instanceof WindowsQualityUpdatePolicyActionType) {
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'action' => fn(ParseNode $n) => $o->setAction($n->getEnumValue(WindowsQualityUpdatePolicyActionType::class)),
    ...
    */
     ...
     * @param WindowsQualityUpdatePolicyActionType|null $value Value to set for the action property.
    */
    public function setAction(?WindowsQualityUpdatePolicyActionType $value): void {
