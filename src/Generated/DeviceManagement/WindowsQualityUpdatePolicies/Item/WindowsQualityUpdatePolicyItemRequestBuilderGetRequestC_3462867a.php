...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: WindowsQualityUpdatePolicyItemRequestBuilderGetRequestConfiguration
*/
class WindowsQualityUpdatePolicyItemRequestBuilderGetRequestC_3462867a extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WindowsQualityUpdatePolicyItemRequestBuilderGetRequestC_3462867a and sets the default values.
