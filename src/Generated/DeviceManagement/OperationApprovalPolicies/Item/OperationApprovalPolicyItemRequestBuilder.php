...
class OperationApprovalPolicyItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/operationApprovalPolicies/{operationApprovalPolicy%2Did}');
     ...
     * @param OperationApprovalPolicyItemRequestBuilderDeleteRequestC_e01f7f11|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<void|null>
     * @throws Exception
    */
    public function delete(?OperationApprovalPolicyItemRequestBuilderDeleteRequestC_e01f7f11 $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @param OperationApprovalPolicyItemRequestBuilderPatchRequestCo_8a4f3137|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<OperationApprovalPolicy|null>
     * @throws Exception
    */
    public function patch(OperationApprovalPolicy $body, ?OperationApprovalPolicyItemRequestBuilderPatchRequestCo_8a4f3137 $requestConfiguration = null): Promise {
    ...
    */
    public function toDeleteRequestInformation(?OperationApprovalPolicyItemRequestBuilderDeleteRequestC_e01f7f11 $requestConfiguration = null): RequestInformation {
    ...
    */
    public function toGetRequestInformation(?OperationApprovalPolicyItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/operationApprovalPolicies/{operationApprovalPolicy%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(OperationApprovalPolicy $body, ?OperationApprovalPolicyItemRequestBuilderPatchRequestCo_8a4f3137 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
