...
*/
class RetrieveOperationsRequiringApprovalRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/operationApprovalPolicies/retrieveOperationsRequiringApproval(){?%24count,%24filter,%24search,%24skip,%24top}');
    ...
    */
    public function get(?RetrieveOperationsRequiringApprovalRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [RetrieveOperationsRequiringApprovalGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
     ...
     * @return RetrieveOperationsRequiringApprovalRequestBuilder
    */
    public function withUrl(string $rawUrl): RetrieveOperationsRequiringApprovalRequestBuilder {
        return new RetrieveOperationsRequiringApprovalRequestBuilder($rawUrl, $this->requestAdapter);
    }
