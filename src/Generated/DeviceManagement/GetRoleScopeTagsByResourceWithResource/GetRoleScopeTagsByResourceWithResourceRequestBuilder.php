...
class GetRoleScopeTagsByResourceWithResourceRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function get(?GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(GetRoleScopeTagsByResourceWithResourceResponse::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
