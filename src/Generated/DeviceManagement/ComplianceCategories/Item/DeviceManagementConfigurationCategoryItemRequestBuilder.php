...
class DeviceManagementConfigurationCategoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementConfigurationCategoryId key: id of deviceManagementConfigurationCategory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementConfigurationCategoryId = null) {
        ...
        $urlTplParams['deviceManagementConfigurationCategoryId'] = $deviceManagementConfigurationCategoryId;
