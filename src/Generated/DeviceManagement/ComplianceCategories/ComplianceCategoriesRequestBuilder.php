...
class ComplianceCategoriesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/complianceCategories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function toPostRequestInformation(DeviceManagementConfigurationCategory $body, ?ComplianceCategoriesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/complianceCategories';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return ComplianceCategoriesRequestBuilder
    */
    public function withUrl(string $rawUrl): ComplianceCategoriesRequestBuilder {
        return new ComplianceCategoriesRequestBuilder($rawUrl, $this->requestAdapter);
    }
