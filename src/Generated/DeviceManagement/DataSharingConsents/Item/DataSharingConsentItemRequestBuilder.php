...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DataSharingConsents\Item\MicrosoftGraphConsentToDataSharing\ConsentToDataSharingRequestBuilder;
...
class DataSharingConsentItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphConsentToDataSharing(): ConsentToDataSharingRequestBuilder {
    ...
    */
     ...
     * @param string|null $dataSharingConsentId key: id of dataSharingConsent
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $dataSharingConsentId = null) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/dataSharingConsents/{dataSharingConsent%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['dataSharingConsentId'] = $dataSharingConsentId;
