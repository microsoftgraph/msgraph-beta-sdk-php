...
*/
class CloudCertificationAuthorityVersionRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new CloudCertificationAuthorityVersionRequestBuilder and sets the default values.
     * @param array<string, mixed>|string $pathParametersOrRawUrl Path parameters for the request or a String representing the raw URL.
     * @param RequestAdapter $requestAdapter The request adapter to use to execute the requests.
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/cloudCertificationAuthorityLeafCertificate/{cloudCertificationAuthorityLeafCertificate%2Did}/cloudCertificationAuthorityVersion{?%24expand,%24select}');
    ...
    */
     ...
     * @return CloudCertificationAuthorityVersionRequestBuilder
    */
    public function withUrl(string $rawUrl): CloudCertificationAuthorityVersionRequestBuilder {
        return new CloudCertificationAuthorityVersionRequestBuilder($rawUrl, $this->requestAdapter);
    }
