...
*/
class AssignResourceAccountToDeviceRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfile%2Did}/assignedDevices/{windowsAutopilotDeviceIdentity%2Did}/assignResourceAccountToDevice');
    ...
    */
     ...
     * @return AssignResourceAccountToDeviceRequestBuilder
    */
    public function withUrl(string $rawUrl): AssignResourceAccountToDeviceRequestBuilder {
        return new AssignResourceAccountToDeviceRequestBuilder($rawUrl, $this->requestAdapter);
    }
