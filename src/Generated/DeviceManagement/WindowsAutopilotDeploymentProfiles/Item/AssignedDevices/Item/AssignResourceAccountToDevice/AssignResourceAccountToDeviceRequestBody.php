...
class AssignResourceAccountToDeviceRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return AssignResourceAccountToDeviceRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AssignResourceAccountToDeviceRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'resourceAccountName' => function (self $o, ParseNode $n) { $o->setResourceAccountName($n->getStringValue()); },
