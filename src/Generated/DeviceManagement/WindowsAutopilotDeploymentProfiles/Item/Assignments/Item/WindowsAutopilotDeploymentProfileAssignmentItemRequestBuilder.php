...
class WindowsAutopilotDeploymentProfileAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $windowsAutopilotDeploymentProfileAssignmentId key: id of windowsAutopilotDeploymentProfileAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsAutopilotDeploymentProfileAssignmentId = null) {
        ...
        $urlTplParams['windowsAutopilotDeploymentProfileAssignmentId'] = $windowsAutopilotDeploymentProfileAssignmentId;
