...
use Microsoft\Graph\Beta\Generated\DeviceManagement\WindowsAutopilotDeploymentProfiles\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class WindowsAutopilotDeploymentProfileItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): WindowsAutopilotDeploymentProfileAssignmentItemRequestBuilder {
        ...
        return new WindowsAutopilotDeploymentProfileAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $windowsAutopilotDeploymentProfileId key: id of windowsAutopilotDeploymentProfile
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $windowsAutopilotDeploymentProfileId = null) {
