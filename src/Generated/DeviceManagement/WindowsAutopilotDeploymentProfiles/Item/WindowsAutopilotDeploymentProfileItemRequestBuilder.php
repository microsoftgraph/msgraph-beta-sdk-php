...
class WindowsAutopilotDeploymentProfileItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsAutopilotDeploymentProfileId = null) {
        ...
        $urlTplParams['windowsAutopilotDeploymentProfileId'] = $windowsAutopilotDeploymentProfileId;
