...
class CloudPCConnectivityIssueItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudPCConnectivityIssueId key: id of cloudPCConnectivityIssue
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudPCConnectivityIssueId = null) {
        ...
        $urlTplParams['cloudPCConnectivityIssueId'] = $cloudPCConnectivityIssueId;
