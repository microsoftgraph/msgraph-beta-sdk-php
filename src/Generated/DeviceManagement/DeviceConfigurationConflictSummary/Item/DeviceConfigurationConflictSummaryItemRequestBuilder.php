...
class DeviceConfigurationConflictSummaryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceConfigurationConflictSummaryId key: id of deviceConfigurationConflictSummary
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceConfigurationConflictSummaryId = null) {
        ...
        $urlTplParams['deviceConfigurationConflictSummaryId'] = $deviceConfigurationConflictSummaryId;
