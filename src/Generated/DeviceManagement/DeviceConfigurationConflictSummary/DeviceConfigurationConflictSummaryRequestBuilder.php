...
*/
class DeviceConfigurationConflictSummaryRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/deviceConfigurationConflictSummary{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
    ...
    */
    public function get(?DeviceConfigurationConflictSummaryRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DeviceConfigurationConflictSummaryCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
     ...
     * @return DeviceConfigurationConflictSummaryRequestBuilder
    */
    public function withUrl(string $rawUrl): DeviceConfigurationConflictSummaryRequestBuilder {
        return new DeviceConfigurationConflictSummaryRequestBuilder($rawUrl, $this->requestAdapter);
    }
