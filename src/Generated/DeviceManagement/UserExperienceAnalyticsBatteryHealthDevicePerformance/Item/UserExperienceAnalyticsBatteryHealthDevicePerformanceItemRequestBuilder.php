...
class UserExperienceAnalyticsBatteryHealthDevicePerformanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsBatteryHealthDevicePerformanceId key: id of userExperienceAnalyticsBatteryHealthDevicePerformance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsBatteryHealthDevicePerformanceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsBatteryHealthDevicePerformanceId'] = $userExperienceAnalyticsBatteryHealthDevicePerformanceId;
