...
class UserExperienceAnalyticsAppHealthApplicationPerformanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsAppHealthApplicationPerformanceId key: id of userExperienceAnalyticsAppHealthApplicationPerformance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsAppHealthApplicationPerformanceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsAppHealthApplicationPerformanceId'] = $userExperienceAnalyticsAppHealthApplicationPerformanceId;
