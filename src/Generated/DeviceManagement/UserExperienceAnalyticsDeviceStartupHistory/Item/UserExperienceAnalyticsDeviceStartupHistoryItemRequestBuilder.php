...
class UserExperienceAnalyticsDeviceStartupHistoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsDeviceStartupHistoryId key: id of userExperienceAnalyticsDeviceStartupHistory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsDeviceStartupHistoryId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsDeviceStartupHistoryId'] = $userExperienceAnalyticsDeviceStartupHistoryId;
