...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\ComanagedDevicesSummary;
...
class GetComanagedDevicesSummaryRequestBuilder 
{
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, ComanagedDevicesSummary::class, $responseHandler);
        } catch(Exception $ex) {
