...
class SummarizeDevicePerformanceDevicesWithSummarizeByResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
     * @var array<UserExperienceAnalyticsDevicePerformance>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SummarizeDevicePerformanceDevicesWithSummarizeByResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(UserExperienceAnalyticsDevicePerformance::class, 'createFromDiscriminatorValue'))); },
        ]);
    }
