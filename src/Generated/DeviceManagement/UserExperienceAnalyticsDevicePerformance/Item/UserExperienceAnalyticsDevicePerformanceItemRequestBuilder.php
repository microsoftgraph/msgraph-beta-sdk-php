...
class UserExperienceAnalyticsDevicePerformanceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsDevicePerformanceId key: id of userExperienceAnalyticsDevicePerformance
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsDevicePerformanceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsDevicePerformanceId'] = $userExperienceAnalyticsDevicePerformanceId;
