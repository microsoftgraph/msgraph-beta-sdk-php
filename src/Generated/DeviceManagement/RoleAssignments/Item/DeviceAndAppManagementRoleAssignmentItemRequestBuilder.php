...
class DeviceAndAppManagementRoleAssignmentItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceAndAppManagementRoleAssignmentId = null) {
    ...
    */
    public function roleScopeTagsById(string $id): RoleScopeTagItemRequestBuilder {
        ...
        return new RoleScopeTagItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
