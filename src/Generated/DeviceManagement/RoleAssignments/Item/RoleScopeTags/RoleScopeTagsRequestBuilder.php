...
class RoleScopeTagsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/roleAssignments/{deviceAndAppManagementRoleAssignment_id}/roleScopeTags{?top,skip,search,filter,count,orderby,select,expand}';
