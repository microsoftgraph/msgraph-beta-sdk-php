...
class AppleEnrollmentProfileAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $appleEnrollmentProfileAssignmentId key: id of appleEnrollmentProfileAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $appleEnrollmentProfileAssignmentId = null) {
        ...
        $urlTplParams['appleEnrollmentProfileAssignmentId'] = $appleEnrollmentProfileAssignmentId;
