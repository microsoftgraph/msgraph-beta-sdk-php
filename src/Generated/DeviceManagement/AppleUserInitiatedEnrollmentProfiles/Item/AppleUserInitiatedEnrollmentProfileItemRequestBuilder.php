...
use Microsoft\Graph\Beta\Generated\DeviceManagement\AppleUserInitiatedEnrollmentProfiles\Item\MicrosoftGraphSetPriority\SetPriorityRequestBuilder;
...
class AppleUserInitiatedEnrollmentProfileItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): AppleEnrollmentProfileAssignmentItemRequestBuilder {
        ...
        return new AppleEnrollmentProfileAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $appleUserInitiatedEnrollmentProfileId key: id of appleUserInitiatedEnrollmentProfile
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $appleUserInitiatedEnrollmentProfileId = null) {
