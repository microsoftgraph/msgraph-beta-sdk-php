...
class RemoteActionAuditItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $remoteActionAuditId key: id of remoteActionAudit
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $remoteActionAuditId = null) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/remoteActionAudits/{remoteActionAudit%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['remoteActionAuditId'] = $remoteActionAuditId;
