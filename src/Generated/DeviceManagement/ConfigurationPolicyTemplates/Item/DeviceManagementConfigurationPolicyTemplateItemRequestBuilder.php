...
*/
class DeviceManagementConfigurationPolicyTemplateItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/configurationPolicyTemplates/{deviceManagementConfigurationPolicyTemplate%2Did}{?%24select,%24expand}');
    ...
    */
    public function withUrl(string $rawUrl): DeviceManagementConfigurationPolicyTemplateItemRequestBuilder {
        return new DeviceManagementConfigurationPolicyTemplateItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
