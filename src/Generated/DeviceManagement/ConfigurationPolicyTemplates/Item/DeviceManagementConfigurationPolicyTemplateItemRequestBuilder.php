...
class DeviceManagementConfigurationPolicyTemplateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementConfigurationPolicyTemplateId key: id of deviceManagementConfigurationPolicyTemplate
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceManagementConfigurationPolicyTemplateId = null) {
    ...
    */
    public function get(?DeviceManagementConfigurationPolicyTemplateItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [DeviceManagementConfigurationPolicyTemplate::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
    ...
    */
    public function settingTemplatesById(string $id): DeviceManagementConfigurationSettingTemplateItemRequestBuilder {
        ...
        return new DeviceManagementConfigurationSettingTemplateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
