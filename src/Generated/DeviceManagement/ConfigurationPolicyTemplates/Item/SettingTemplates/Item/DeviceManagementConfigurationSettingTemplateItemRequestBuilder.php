...
class DeviceManagementConfigurationSettingTemplateItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/deviceManagement/configurationPolicyTemplates/{deviceManagementConfigurationPolicyTemplate_id}/settingTemplates/{deviceManagementConfigurationSettingTemplate_id}{?select,expand}';
