...
class UserExperienceAnalyticsAnomalyDeviceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsAnomalyDeviceId key: id of userExperienceAnalyticsAnomalyDevice
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsAnomalyDeviceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsAnomalyDeviceId'] = $userExperienceAnalyticsAnomalyDeviceId;
