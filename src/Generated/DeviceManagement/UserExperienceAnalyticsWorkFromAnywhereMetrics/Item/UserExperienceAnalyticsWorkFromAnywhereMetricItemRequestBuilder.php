...
class UserExperienceAnalyticsWorkFromAnywhereMetricItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsWorkFromAnywhereMetricId key: id of userExperienceAnalyticsWorkFromAnywhereMetric
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsWorkFromAnywhereMetricId = null) {
    ...
    */
    public function metricDevicesById(string $id): UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilder {
        ...
        return new UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
