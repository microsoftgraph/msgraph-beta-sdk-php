...
class UserExperienceAnalyticsWorkFromAnywhereMetricItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsWorkFromAnywhereMetricId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsWorkFromAnywhereMetricId'] = $userExperienceAnalyticsWorkFromAnywhereMetricId;
