...
class UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsWorkFromAnywhereDeviceId key: id of userExperienceAnalyticsWorkFromAnywhereDevice
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsWorkFromAnywhereDeviceId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsWorkFromAnywhereDeviceId'] = $userExperienceAnalyticsWorkFromAnywhereDeviceId;
