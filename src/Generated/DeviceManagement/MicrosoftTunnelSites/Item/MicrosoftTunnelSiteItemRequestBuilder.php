...
use Microsoft\Graph\Beta\Generated\DeviceManagement\MicrosoftTunnelSites\Item\MicrosoftGraphRequestUpgrade\RequestUpgradeRequestBuilder;
...
class MicrosoftTunnelSiteItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphRequestUpgrade(): RequestUpgradeRequestBuilder {
    ...
    */
     ...
     * @param string|null $microsoftTunnelSiteId key: id of microsoftTunnelSite
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $microsoftTunnelSiteId = null) {
    ...
    */
    public function microsoftTunnelServersById(string $id): MicrosoftTunnelServerItemRequestBuilder {
        ...
        return new MicrosoftTunnelServerItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
