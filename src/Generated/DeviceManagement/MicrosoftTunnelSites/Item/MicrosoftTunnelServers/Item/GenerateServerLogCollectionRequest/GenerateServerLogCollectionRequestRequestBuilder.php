...
*/
class GenerateServerLogCollectionRequestRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/microsoftTunnelSites/{microsoftTunnelSite%2Did}/microsoftTunnelServers/{microsoftTunnelServer%2Did}/generateServerLogCollectionRequest');
    ...
    */
     ...
     * @return GenerateServerLogCollectionRequestRequestBuilder
    */
    public function withUrl(string $rawUrl): GenerateServerLogCollectionRequestRequestBuilder {
        return new GenerateServerLogCollectionRequestRequestBuilder($rawUrl, $this->requestAdapter);
    }
