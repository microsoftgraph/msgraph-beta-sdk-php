...
class CreateServerLogCollectionRequestRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return CreateServerLogCollectionRequestRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CreateServerLogCollectionRequestRequestBody {
