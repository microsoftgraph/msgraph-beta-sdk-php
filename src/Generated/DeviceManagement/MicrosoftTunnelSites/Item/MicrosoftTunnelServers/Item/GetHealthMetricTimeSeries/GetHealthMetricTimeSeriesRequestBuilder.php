...
class GetHealthMetricTimeSeriesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/microsoftTunnelSites/{microsoftTunnelSite%2Did}/microsoftTunnelServers/{microsoftTunnelServer%2Did}/getHealthMetricTimeSeries');
     ...
     * @return Promise<GetHealthMetricTimeSeriesPostResponse|null>
     * @throws Exception
    */
    public function post(GetHealthMetricTimeSeriesPostRequestBody $body, ?GetHealthMetricTimeSeriesRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [GetHealthMetricTimeSeriesPostResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
     ...
     * @return GetHealthMetricTimeSeriesRequestBuilder
    */
    public function withUrl(string $rawUrl): GetHealthMetricTimeSeriesRequestBuilder {
        return new GetHealthMetricTimeSeriesRequestBuilder($rawUrl, $this->requestAdapter);
    }
