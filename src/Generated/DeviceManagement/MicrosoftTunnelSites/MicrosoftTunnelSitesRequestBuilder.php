...
class MicrosoftTunnelSitesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/microsoftTunnelSites{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<MicrosoftTunnelSiteCollectionResponse|null>
     * @throws Exception
    */
