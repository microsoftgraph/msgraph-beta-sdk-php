...
class DeviceManagementExchangeOnPremisesPolicyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $deviceManagementExchangeOnPremisesPolicyId key: id of deviceManagementExchangeOnPremisesPolicy
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceManagementExchangeOnPremisesPolicyId = null) {
        ...
        $urlTplParams['deviceManagementExchangeOnPremisesPolicyId'] = $deviceManagementExchangeOnPremisesPolicyId;
