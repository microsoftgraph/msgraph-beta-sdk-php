...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceConfigurations\Item\Assign\AssignRequestBuilder;
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceConfigurations\Item\AssignedAccessMultiModeProfiles\AssignedAccessMultiModeProfilesRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\DeviceManagement\DeviceConfigurations\Item\GetOmaSettingPlainTextValueWithSecretReferenceValueId\GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilder;
...
class DeviceConfigurationItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.deviceConfigurations.item.assignments.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.deviceConfigurations.item.deviceSettingStateSummaries.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.deviceConfigurations.item.deviceStatuses.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    public function get(?DeviceConfigurationItemRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(DeviceConfiguration::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.deviceConfigurations.item.groupAssignments.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.deviceConfigurations.item.userStatuses.item collection
     * @param string $id Unique identifier of the item
