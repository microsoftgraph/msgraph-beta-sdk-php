...
class AssignPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getDeviceConfigurationGroupAssignments(): ?array {
        $val = $this->getBackingStore()->get('deviceConfigurationGroupAssignments');
        if (is_array($val) || is_null($val)) {
        ...
        throw new \UnexpectedValueException("Invalid type found in backing store for 'deviceConfigurationGroupAssignments'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'deviceConfigurationGroupAssignments' => fn(ParseNode $n) => $o->setDeviceConfigurationGroupAssignments($n->getCollectionOfObjectValues([DeviceConfigurationGroupAssignment::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function setDeviceConfigurationGroupAssignments(?array $value): void {
        $this->getBackingStore()->set('deviceConfigurationGroupAssignments', $value);
    }
