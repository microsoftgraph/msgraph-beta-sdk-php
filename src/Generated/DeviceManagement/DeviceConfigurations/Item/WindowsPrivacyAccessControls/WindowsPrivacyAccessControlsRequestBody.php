...
class WindowsPrivacyAccessControlsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return WindowsPrivacyAccessControlsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): WindowsPrivacyAccessControlsRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'windowsPrivacyAccessControls' => function (self $o, ParseNode $n) { $o->setWindowsPrivacyAccessControls($n->getCollectionOfObjectValues(WindowsPrivacyDataAccessControlItem::class)); },
        ];
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeCollectionOfObjectValues('windowsPrivacyAccessControls', $this->windowsPrivacyAccessControls);
