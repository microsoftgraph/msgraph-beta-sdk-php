...
*/
class AssignedAccessMultiModeProfilesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/assignedAccessMultiModeProfiles');
    ...
    */
     ...
     * @return AssignedAccessMultiModeProfilesRequestBuilder
    */
    public function withUrl(string $rawUrl): AssignedAccessMultiModeProfilesRequestBuilder {
        return new AssignedAccessMultiModeProfilesRequestBuilder($rawUrl, $this->requestAdapter);
    }
