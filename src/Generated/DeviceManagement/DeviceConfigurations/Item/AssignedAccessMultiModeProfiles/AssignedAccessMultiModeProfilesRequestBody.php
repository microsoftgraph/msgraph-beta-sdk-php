...
class AssignedAccessMultiModeProfilesRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return AssignedAccessMultiModeProfilesRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AssignedAccessMultiModeProfilesRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'assignedAccessMultiModeProfiles' => function (self $o, ParseNode $n) { $o->setAssignedAccessMultiModeProfiles($n->getCollectionOfObjectValues(WindowsAssignedAccessProfile::class)); },
        ];
    }
