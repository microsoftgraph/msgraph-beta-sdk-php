...
class GetTargetedUsersAndDevicesPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetTargetedUsersAndDevicesPostRequestBody {
    ...
    */
    public function getDeviceConfigurationIds(): ?array {
        $val = $this->getBackingStore()->get('deviceConfigurationIds');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'deviceConfigurationIds'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'deviceConfigurationIds' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setDeviceConfigurationIds($val);
            },
        ];
    }
