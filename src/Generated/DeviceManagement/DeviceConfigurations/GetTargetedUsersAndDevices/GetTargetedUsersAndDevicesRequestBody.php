...
class GetTargetedUsersAndDevicesRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetTargetedUsersAndDevicesRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetTargetedUsersAndDevicesRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'deviceConfigurationIds' => function (self $o, ParseNode $n) { $o->setDeviceConfigurationIds($n->getCollectionOfPrimitiveValues()); },
        ];
    }
