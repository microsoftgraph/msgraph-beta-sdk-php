...
*/
class GetIosAvailableUpdateVersionsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/deviceConfigurations/getIosAvailableUpdateVersions(){?%24top,%24skip,%24search,%24filter,%24count}');
    ...
    */
    public function get(?GetIosAvailableUpdateVersionsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [GetIosAvailableUpdateVersionsGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function withUrl(string $rawUrl): GetIosAvailableUpdateVersionsRequestBuilder {
        return new GetIosAvailableUpdateVersionsRequestBuilder($rawUrl, $this->requestAdapter);
    }
