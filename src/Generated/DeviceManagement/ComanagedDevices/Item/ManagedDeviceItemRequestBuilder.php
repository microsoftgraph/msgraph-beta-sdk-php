...
use Microsoft\Graph\Beta\Generated\DeviceManagement\ComanagedDevices\Item\CreateRemoteHelpSession\CreateRemoteHelpSessionRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\DeviceManagement\ComanagedDevices\Item\RequestRemoteHelpSessionAccess\RequestRemoteHelpSessionAccessRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\DeviceManagement\ComanagedDevices\Item\RetrieveRemoteHelpSessionWithSessionKey\RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder;
...
class ManagedDeviceItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.comanagedDevices.item.assignmentFilterEvaluationStatusDetails.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.comanagedDevices.item.detectedApps.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.comanagedDevices.item.deviceCompliancePolicyStates.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.comanagedDevices.item.deviceConfigurationStates.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.comanagedDevices.item.logCollectionRequests.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.comanagedDevices.item.managedDeviceMobileAppConfigurationStates.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.deviceManagement.comanagedDevices.item.securityBaselineStates.item collection
     * @param string $id Unique identifier of the item
