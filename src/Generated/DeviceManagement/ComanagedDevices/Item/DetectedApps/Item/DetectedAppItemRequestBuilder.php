...
class DetectedAppItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $detectedAppId key: id of detectedApp
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $detectedAppId = null) {
        ...
        $urlTplParams['detectedAppId'] = $detectedAppId;
