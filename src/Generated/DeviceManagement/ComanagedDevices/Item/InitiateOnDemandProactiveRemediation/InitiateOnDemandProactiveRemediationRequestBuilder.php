...
*/
class InitiateOnDemandProactiveRemediationRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/initiateOnDemandProactiveRemediation');
    ...
    */
     ...
     * @return InitiateOnDemandProactiveRemediationRequestBuilder
    */
    public function withUrl(string $rawUrl): InitiateOnDemandProactiveRemediationRequestBuilder {
        return new InitiateOnDemandProactiveRemediationRequestBuilder($rawUrl, $this->requestAdapter);
    }
