...
class EndRemoteHelpSessionPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EndRemoteHelpSessionPostRequestBody {
