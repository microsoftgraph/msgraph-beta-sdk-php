...
*/
class SendCustomNotificationToCompanyPortalRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/sendCustomNotificationToCompanyPortal');
    ...
    */
     ...
     * @return SendCustomNotificationToCompanyPortalRequestBuilder
    */
    public function withUrl(string $rawUrl): SendCustomNotificationToCompanyPortalRequestBuilder {
        return new SendCustomNotificationToCompanyPortalRequestBuilder($rawUrl, $this->requestAdapter);
    }
