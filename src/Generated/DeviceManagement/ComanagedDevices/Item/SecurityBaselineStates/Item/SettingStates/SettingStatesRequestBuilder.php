...
use Microsoft\Graph\Beta\Generated\DeviceManagement\ComanagedDevices\Item\SecurityBaselineStates\Item\SettingStates\Item\SecurityBaselineSettingStateItemRequestBuilder;
...
class SettingStatesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}/settingStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<SecurityBaselineSettingStateCollectionResponse|null>
     * @throws Exception
    */
    ...
    */
    public function toPostRequestInformation(SecurityBaselineSettingState $body, ?SettingStatesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}/settingStates';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return SettingStatesRequestBuilder
    */
    public function withUrl(string $rawUrl): SettingStatesRequestBuilder {
        return new SettingStatesRequestBuilder($rawUrl, $this->requestAdapter);
    }
