...
class SecurityBaselineSettingStateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $securityBaselineSettingStateId key: id of securityBaselineSettingState
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $securityBaselineSettingStateId = null) {
        ...
        $urlTplParams['securityBaselineSettingStateId'] = $securityBaselineSettingStateId;
