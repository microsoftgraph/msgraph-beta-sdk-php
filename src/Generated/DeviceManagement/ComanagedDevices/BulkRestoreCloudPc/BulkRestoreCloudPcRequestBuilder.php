...
*/
class BulkRestoreCloudPcRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/comanagedDevices/bulkRestoreCloudPc');
    ...
    */
    public function toPostRequestInformation(BulkRestoreCloudPcPostRequestBody $body, ?BulkRestoreCloudPcRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return BulkRestoreCloudPcRequestBuilder
    */
    public function withUrl(string $rawUrl): BulkRestoreCloudPcRequestBuilder {
        return new BulkRestoreCloudPcRequestBuilder($rawUrl, $this->requestAdapter);
    }
