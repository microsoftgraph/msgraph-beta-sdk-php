...
*/
class HardwarePasswordDetailItemRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new HardwarePasswordDetailItemRequestBuilder and sets the default values.
     * @param array<string, mixed>|string $pathParametersOrRawUrl Path parameters for the request or a String representing the raw URL.
     * @param RequestAdapter $requestAdapter The request adapter to use to execute the requests.
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/hardwarePasswordDetails/{hardwarePasswordDetail%2Did}');
    ...
    */
     ...
     * @param HardwarePasswordDetailItemRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<HardwarePasswordDetail|null>
     * @throws Exception
    */
    public function get(?HardwarePasswordDetailItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?HardwarePasswordDetailItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/hardwarePasswordDetails/{hardwarePasswordDetail%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): HardwarePasswordDetailItemRequestBuilder {
        return new HardwarePasswordDetailItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
