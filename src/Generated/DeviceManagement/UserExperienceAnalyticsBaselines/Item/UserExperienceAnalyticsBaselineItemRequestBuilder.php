...
class UserExperienceAnalyticsBaselineItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userExperienceAnalyticsBaselineId key: id of userExperienceAnalyticsBaseline
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userExperienceAnalyticsBaselineId = null) {
        ...
        $urlTplParams['userExperienceAnalyticsBaselineId'] = $userExperienceAnalyticsBaselineId;
