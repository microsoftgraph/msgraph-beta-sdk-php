...
class GetRoleScopeTagsByIdRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetRoleScopeTagsByIdRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetRoleScopeTagsByIdRequestBody {
