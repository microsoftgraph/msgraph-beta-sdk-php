...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: RoleScopeTagAutoAssignmentItemRequestBuilderGetRequestConfiguration
*/
class RoleScopeTagAutoAssignmentItemRequestBuilderGetRequestC_ce481f94 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RoleScopeTagAutoAssignmentItemRequestBuilderGetRequestC_ce481f94 and sets the default values.
    ...
    */
    public static function createQueryParameters(?array $expand = null, ?array $select = null): RoleScopeTagAutoAssignmentItemRequestBuilderGetQueryParameters {
