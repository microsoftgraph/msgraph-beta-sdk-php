...
class RoleScopeTagAutoAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $roleScopeTagAutoAssignmentId key: id of roleScopeTagAutoAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $roleScopeTagAutoAssignmentId = null) {
        ...
        $urlTplParams['roleScopeTagAutoAssignmentId'] = $roleScopeTagAutoAssignmentId;
