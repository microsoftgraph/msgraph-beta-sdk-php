...
*/
class RoleScopeTagAutoAssignmentItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/roleScopeTags/{roleScopeTag%2Did}/assignments/{roleScopeTagAutoAssignment%2Did}');
    ...
    */
    public function toGetRequestInformation(?RoleScopeTagAutoAssignmentItemRequestBuilderGetRequestC_ce481f94 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceManagement/roleScopeTags/{roleScopeTag%2Did}/assignments/{roleScopeTagAutoAssignment%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): RoleScopeTagAutoAssignmentItemRequestBuilder {
        return new RoleScopeTagAutoAssignmentItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
