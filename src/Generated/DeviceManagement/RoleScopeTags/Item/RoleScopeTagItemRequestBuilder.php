...
use Microsoft\Graph\Beta\Generated\DeviceManagement\RoleScopeTags\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class RoleScopeTagItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): RoleScopeTagAutoAssignmentItemRequestBuilder {
        ...
        return new RoleScopeTagAutoAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $roleScopeTagId key: id of roleScopeTag
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $roleScopeTagId = null) {
