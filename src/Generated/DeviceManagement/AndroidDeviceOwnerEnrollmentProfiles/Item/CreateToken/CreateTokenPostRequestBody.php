...
namespace Microsoft\Graph\Beta\Generated\DeviceManagement\AndroidDeviceOwnerEnrollmentProfiles\Item\CreateToken;
...
class CreateTokenPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getTokenValidityInSeconds(): ?int {
        $val = $this->getBackingStore()->get('tokenValidityInSeconds');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'tokenValidityInSeconds'");
    }
    ...
    */
    public function setTokenValidityInSeconds(?int $value): void {
        $this->getBackingStore()->set('tokenValidityInSeconds', $value);
    }
