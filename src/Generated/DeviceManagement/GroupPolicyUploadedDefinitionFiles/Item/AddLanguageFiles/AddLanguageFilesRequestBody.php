...
class AddLanguageFilesRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return AddLanguageFilesRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AddLanguageFilesRequestBody {
