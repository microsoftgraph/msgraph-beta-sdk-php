...
class AuthenticationMethodConfigurationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $authenticationMethodConfigurationId key: id of authenticationMethodConfiguration
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $authenticationMethodConfigurationId = null) {
        ...
        $urlTplParams['authenticationMethodConfigurationId'] = $authenticationMethodConfigurationId;
