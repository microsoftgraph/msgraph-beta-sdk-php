...
use Microsoft\Graph\Beta\Generated\Branding\SquareLogoDark\SquareLogoDarkRequestBuilder;
    ...
    */
    public function get(?BrandingRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [OrganizationalBranding::class, 'createFromDiscriminatorValue'], $responseHandler, $errorMappings);
        } catch(Exception $ex) {
