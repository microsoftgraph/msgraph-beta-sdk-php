...
class TermItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.termStore.sets.item.parentGroup.sets.item.children.item.children.item collection
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}{?select,expand}';
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.termStore.sets.item.parentGroup.sets.item.children.item.relations.item collection
     * @param string $id Unique identifier of the item
