...
namespace Microsoft\Graph\Beta\Generated\TermStore\Sets\Item;
...
use Microsoft\Graph\Beta\Generated\TermStore\Sets\Item\Children\ChildrenRequestBuilder;
use Microsoft\Graph\Beta\Generated\TermStore\Sets\Item\Children\Item\TermItemRequestBuilder as MicrosoftGraphBetaGeneratedTermStoreSetsItemChildrenItemTermItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\TermStore\Sets\Item\ParentGroup\ParentGroupRequestBuilder;
use Microsoft\Graph\Beta\Generated\TermStore\Sets\Item\Relations\Item\RelationItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\TermStore\Sets\Item\Relations\RelationsRequestBuilder;
use Microsoft\Graph\Beta\Generated\TermStore\Sets\Item\Terms\Item\TermItemRequestBuilder as MicrosoftGraphBetaGeneratedTermStoreSetsItemTermsItemTermItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\TermStore\Sets\Item\Terms\TermsRequestBuilder;
...
class SetItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.termStore.sets.item.children.item collection
     * @param string $id Unique identifier of the item
     * @return MicrosoftGraphBetaGeneratedTermStoreSetsItemChildrenItemTermItemRequestBuilder
    */
    public function childrenById(string $id): MicrosoftGraphBetaGeneratedTermStoreSetsItemChildrenItemTermItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['term%2Did'] = $id;
        return new MicrosoftGraphBetaGeneratedTermStoreSetsItemChildrenItemTermItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/termStore/sets/{set%2Did}{?%24select,%24expand}';
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.termStore.sets.item.relations.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.termStore.sets.item.terms.item collection
     * @param string $id Unique identifier of the item
     * @return MicrosoftGraphBetaGeneratedTermStoreSetsItemTermsItemTermItemRequestBuilder
    */
    public function termsById(string $id): MicrosoftGraphBetaGeneratedTermStoreSetsItemTermsItemTermItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['term%2Did'] = $id;
        return new MicrosoftGraphBetaGeneratedTermStoreSetsItemTermsItemTermItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
