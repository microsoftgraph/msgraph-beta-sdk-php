...
class SetItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/termStore/sets/{set%2Did}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/termstore-set-delete?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @return Promise<Set|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/termstore-set-update?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?SetItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/termStore/sets/{set%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
