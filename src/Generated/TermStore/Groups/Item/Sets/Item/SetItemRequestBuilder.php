...
class SetItemRequestBuilder 
{
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.termStore.groups.item.sets.item.children.item collection
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/termStore/groups/{group_id}/sets/{set_id}{?select,expand}';
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.termStore.groups.item.sets.item.relations.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.termStore.groups.item.sets.item.terms.item collection
     * @param string $id Unique identifier of the item
