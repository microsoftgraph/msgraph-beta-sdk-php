...
class ParentGroupRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/parentGroup');
    ...
    */
    public function toGetRequestInformation(?ParentGroupRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/parentGroup{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
