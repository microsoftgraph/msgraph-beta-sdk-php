...
class TermItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.termStore.groups.item.sets.item.children.item.children.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.termStore.groups.item.sets.item.children.item.relations.item collection
     * @param string $id Unique identifier of the item
