...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: OrganizationalBrandingThemeItemRequestBuilderGetRequestConfiguration
*/
class OrganizationalBrandingThemeItemRequestBuilderGetRequest_e7f41ef8 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OrganizationalBrandingThemeItemRequestBuilderGetRequest_e7f41ef8 and sets the default values.
