...
class ProfileCardPropertyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $profileCardPropertyId key: id of profileCardProperty
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $profileCardPropertyId = null) {
        ...
        $urlTplParams['profileCardPropertyId'] = $profileCardPropertyId;
