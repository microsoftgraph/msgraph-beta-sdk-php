...
namespace Microsoft\Graph\Beta\Generated\Organization\Item\MicrosoftGraphSetMobileDeviceManagementAuthority;
    ...
    */
    public function post(?SetMobileDeviceManagementAuthorityRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [SetMobileDeviceManagementAuthorityResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
