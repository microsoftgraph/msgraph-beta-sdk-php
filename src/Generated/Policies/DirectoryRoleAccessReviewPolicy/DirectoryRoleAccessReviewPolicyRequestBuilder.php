...
*/
class DirectoryRoleAccessReviewPolicyRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/policies/directoryRoleAccessReviewPolicy{?%24expand,%24select}');
    ...
    */
    public function get(?DirectoryRoleAccessReviewPolicyRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DirectoryRoleAccessReviewPolicy::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toDeleteRequestInformation(?DirectoryRoleAccessReviewPolicyRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/policies/directoryRoleAccessReviewPolicy';
    ...
    */
     ...
     * @return DirectoryRoleAccessReviewPolicyRequestBuilder
    */
    public function withUrl(string $rawUrl): DirectoryRoleAccessReviewPolicyRequestBuilder {
        return new DirectoryRoleAccessReviewPolicyRequestBuilder($rawUrl, $this->requestAdapter);
    }
