...
class IncludedGroupsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/policies/mobileAppManagementPolicies/{mobilityManagementPolicy_id}/includedGroups{?top,skip,search,filter,count,orderby,select,expand}';
