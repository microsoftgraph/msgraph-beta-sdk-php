...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: AuthenticationStrengthPolicyItemRequestBuilderGetRequestConfiguration
*/
class AuthenticationStrengthPolicyItemRequestBuilderGetReques_40301840 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AuthenticationStrengthPolicyItemRequestBuilderGetReques_40301840 and sets the default values.
