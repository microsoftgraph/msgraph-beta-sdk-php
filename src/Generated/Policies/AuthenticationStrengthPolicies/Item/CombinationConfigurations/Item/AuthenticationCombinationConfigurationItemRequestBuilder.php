...
class AuthenticationCombinationConfigurationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $authenticationCombinationConfigurationId key: id of authenticationCombinationConfiguration
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $authenticationCombinationConfigurationId = null) {
        ...
        $urlTplParams['authenticationCombinationConfigurationId'] = $authenticationCombinationConfigurationId;
