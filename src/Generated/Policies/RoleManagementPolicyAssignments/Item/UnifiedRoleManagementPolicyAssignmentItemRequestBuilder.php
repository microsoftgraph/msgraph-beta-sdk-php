...
class UnifiedRoleManagementPolicyAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $unifiedRoleManagementPolicyAssignmentId key: id of unifiedRoleManagementPolicyAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $unifiedRoleManagementPolicyAssignmentId = null) {
        ...
        $urlTplParams['unifiedRoleManagementPolicyAssignmentId'] = $unifiedRoleManagementPolicyAssignmentId;
