...
class ServicePrincipalCreationPolicyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $servicePrincipalCreationPolicyId key: id of servicePrincipalCreationPolicy
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $servicePrincipalCreationPolicyId = null) {
    ...
    */
    public function excludesById(string $id): \Microsoft\Graph\Beta\Generated\Policies\ServicePrincipalCreationPolicies\Item\Excludes\Item\ServicePrincipalCreationConditionSetItemRequestBuilder {
        ...
        return new \Microsoft\Graph\Beta\Generated\Policies\ServicePrincipalCreationPolicies\Item\Excludes\Item\ServicePrincipalCreationConditionSetItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function includesById(string $id): \Microsoft\Graph\Beta\Generated\Policies\ServicePrincipalCreationPolicies\Item\Includes\Item\ServicePrincipalCreationConditionSetItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['servicePrincipalCreationConditionSet%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\Policies\ServicePrincipalCreationPolicies\Item\Includes\Item\ServicePrincipalCreationConditionSetItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
