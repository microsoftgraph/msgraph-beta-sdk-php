...
class PermissionGrantConditionSetItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $permissionGrantConditionSetId key: id of permissionGrantConditionSet
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $permissionGrantConditionSetId = null) {
        ...
        $urlTplParams['permissionGrantConditionSetId'] = $permissionGrantConditionSetId;
