...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: PermissionGrantConditionSetItemRequestBuilderGetRequestConfiguration
*/
class PermissionGrantConditionSetItemRequestBuilderGetRequest_718d77de extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PermissionGrantConditionSetItemRequestBuilderGetRequest_718d77de and sets the default values.
