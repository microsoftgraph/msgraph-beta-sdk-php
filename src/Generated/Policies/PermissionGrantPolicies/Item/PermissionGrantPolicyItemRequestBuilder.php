...
class PermissionGrantPolicyItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.policies.permissionGrantPolicies.item.excludes.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.policies.permissionGrantPolicies.item.includes.item collection
     * @param string $id Unique identifier of the item
