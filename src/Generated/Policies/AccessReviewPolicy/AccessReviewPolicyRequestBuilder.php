...
*/
class AccessReviewPolicyRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/policies/accessReviewPolicy');
     ...
     * @throws Exception
    */
    public function delete(?AccessReviewPolicyRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): Promise {
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/accessreviewpolicy-get?view=graph-rest-beta Find more info here
    */
    public function get(?AccessReviewPolicyRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [AccessReviewPolicy::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
     ...
     * @return Promise<AccessReviewPolicy|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/accessreviewpolicy-update?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?AccessReviewPolicyRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/policies/accessReviewPolicy{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
     ...
     * @return AccessReviewPolicyRequestBuilder
    */
    public function withUrl(string $rawUrl): AccessReviewPolicyRequestBuilder {
        return new AccessReviewPolicyRequestBuilder($rawUrl, $this->requestAdapter);
    }
