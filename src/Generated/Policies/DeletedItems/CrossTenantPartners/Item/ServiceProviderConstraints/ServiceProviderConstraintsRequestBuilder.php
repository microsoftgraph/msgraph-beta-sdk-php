...
namespace Microsoft\Graph\Beta\Generated\Policies\DeletedItems\CrossTenantPartners\Item\ServiceProviderConstraints;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\ServiceProviderConstraints;
use Microsoft\Graph\Beta\Generated\Policies\DeletedItems\CrossTenantPartners\Item\ServiceProviderConstraints\Restore\RestoreRequestBuilder;
...
class ServiceProviderConstraintsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/policies/deletedItems/crossTenantPartners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}/serviceProviderConstraints{?%24expand,%24select}');
     ...
     * @param ServiceProviderConstraintsRequestBuilderDeleteRequestCo_5ae5c539|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<void|null>
     * @throws Exception
    */
    public function delete(?ServiceProviderConstraintsRequestBuilderDeleteRequestCo_5ae5c539 $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @param ServiceProviderConstraintsRequestBuilderPatchRequestCon_df60a313|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<ServiceProviderConstraints|null>
     * @throws Exception
    */
    public function patch(ServiceProviderConstraints $body, ?ServiceProviderConstraintsRequestBuilderPatchRequestCon_df60a313 $requestConfiguration = null): Promise {
    ...
    */
    public function toDeleteRequestInformation(?ServiceProviderConstraintsRequestBuilderDeleteRequestCo_5ae5c539 $requestConfiguration = null): RequestInformation {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(ServiceProviderConstraints $body, ?ServiceProviderConstraintsRequestBuilderPatchRequestCon_df60a313 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
