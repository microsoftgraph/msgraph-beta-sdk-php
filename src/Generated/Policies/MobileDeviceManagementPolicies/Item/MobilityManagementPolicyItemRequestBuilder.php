...
class MobilityManagementPolicyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $mobilityManagementPolicyId key: id of mobilityManagementPolicy
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $mobilityManagementPolicyId = null) {
        ...
        $urlTplParams['mobilityManagementPolicyId'] = $mobilityManagementPolicyId;
