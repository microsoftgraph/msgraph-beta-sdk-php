...
class CrossTenantAccessPolicyRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/policies/crossTenantAccessPolicy{?select,expand}';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(CrossTenantAccessPolicy $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, CrossTenantAccessPolicy::class, $responseHandler);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
     ...
     * @return CrossTenantAccessPolicyConfigurationPartnerItemRequestBuilder
    */
    public function partnersById(string $id): CrossTenantAccessPolicyConfigurationPartnerItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['crossTenantAccessPolicyConfigurationPartner_tenantId'] = $id;
        return new CrossTenantAccessPolicyConfigurationPartnerItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
     ...
     * @return Promise
    */
    public function patch(CrossTenantAccessPolicy $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
