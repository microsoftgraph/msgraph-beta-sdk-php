...
class CrossTenantAccessPolicyRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/crosstenantaccesspolicy-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<CrossTenantAccessPolicy|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/crosstenantaccesspolicy-update?view=graph-rest-beta Find more info here
    */
