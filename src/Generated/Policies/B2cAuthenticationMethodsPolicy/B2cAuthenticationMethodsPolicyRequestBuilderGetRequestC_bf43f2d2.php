...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: b2cAuthenticationMethodsPolicyRequestBuilderGetRequestConfiguration
*/
class B2cAuthenticationMethodsPolicyRequestBuilderGetRequestC_bf43f2d2 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new B2cAuthenticationMethodsPolicyRequestBuilderGetRequestC_bf43f2d2 and sets the default values.
