...
class AuthorizationPolicyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $authorizationPolicyId key: id of authorizationPolicy
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $authorizationPolicyId = null) {
    ...
    */
    public function defaultUserRoleOverridesById(string $id): DefaultUserRoleOverrideItemRequestBuilder {
        ...
        return new DefaultUserRoleOverrideItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
