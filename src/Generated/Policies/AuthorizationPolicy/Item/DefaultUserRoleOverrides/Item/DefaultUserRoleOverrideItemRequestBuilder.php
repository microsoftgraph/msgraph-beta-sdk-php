...
class DefaultUserRoleOverrideItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $defaultUserRoleOverrideId key: id of defaultUserRoleOverride
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $defaultUserRoleOverrideId = null) {
        ...
        $urlTplParams['defaultUserRoleOverrideId'] = $defaultUserRoleOverrideId;
