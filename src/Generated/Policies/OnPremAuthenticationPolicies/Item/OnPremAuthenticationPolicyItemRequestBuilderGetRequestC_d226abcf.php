...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: OnPremAuthenticationPolicyItemRequestBuilderGetRequestConfiguration
*/
class OnPremAuthenticationPolicyItemRequestBuilderGetRequestC_d226abcf extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OnPremAuthenticationPolicyItemRequestBuilderGetRequestC_d226abcf and sets the default values.
