...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: UnifiedRoleManagementPolicyItemRequestBuilderGetRequestConfiguration
*/
class UnifiedRoleManagementPolicyItemRequestBuilderGetRequest_31135ff8 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UnifiedRoleManagementPolicyItemRequestBuilderGetRequest_31135ff8 and sets the default values.
