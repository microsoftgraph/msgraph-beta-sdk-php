...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ActivityBasedTimeoutPolicyItemRequestBuilderGetRequestConfiguration
*/
class ActivityBasedTimeoutPolicyItemRequestBuilderGetRequestC_41a3a235 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ActivityBasedTimeoutPolicyItemRequestBuilderGetRequestC_41a3a235 and sets the default values.
