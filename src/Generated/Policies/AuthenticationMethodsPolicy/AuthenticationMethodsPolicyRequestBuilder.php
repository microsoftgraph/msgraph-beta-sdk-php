...
namespace Microsoft\Graph\Beta\Generated\Policies\AuthenticationMethodsPolicy;
...
use Microsoft\Graph\Beta\Generated\Policies\AuthenticationMethodsPolicy\AuthenticationMethodConfigurations\AuthenticationMethodConfigurationsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Policies\AuthenticationMethodsPolicy\AuthenticationMethodConfigurations\Item\AuthenticationMethodConfigurationItemRequestBuilder;
...
class AuthenticationMethodsPolicyRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.policies.authenticationMethodsPolicy.authenticationMethodConfigurations.item collection
    ...
    */
    public function get(?AuthenticationMethodsPolicyRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(AuthenticationMethodsPolicy::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
