...
class TaskItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/caseManagement/cases/{case%2Did}/tasks/{task%2Did}{?%24expand,%24select}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-casemanagement-task-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<Task|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-casemanagement-task-update?view=graph-rest-beta Find more info here
    */
