...
namespace Microsoft\Graph\Beta\Generated\Security\CaseManagement\Cases\Item\Tasks;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\Security\CaseManagement\Task;
use Microsoft\Graph\Beta\Generated\Models\Security\CaseManagement\TaskCollectionResponse;
use Microsoft\Graph\Beta\Generated\Security\CaseManagement\Cases\Item\Tasks\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\CaseManagement\Cases\Item\Tasks\Item\TaskItemRequestBuilder;
...
class TasksRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/caseManagement/cases/{case%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    /**
     * Get a list of task objects for a case.
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-casemanagement-case-list-tasks?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-casemanagement-case-post-tasks?view=graph-rest-beta Find more info here
    */
