...
use Microsoft\Graph\Beta\Generated\Security\CaseManagement\Cases\Item\Attachments\Item\Content\ContentRequestBuilder;
...
class AttachmentItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/caseManagement/cases/{case%2Did}/attachments/{attachment%2Did}{?%24expand,%24select}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-casemanagement-attachment-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<Attachment|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-casemanagement-attachment-update?view=graph-rest-beta Find more info here
    */
    public function patch(Attachment $body, ?AttachmentItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(Attachment $body, ?AttachmentItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
