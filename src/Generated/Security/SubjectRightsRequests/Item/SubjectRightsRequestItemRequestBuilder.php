...
use Microsoft\Graph\Beta\Generated\Security\SubjectRightsRequests\Item\ApproversWithUserPrincipalName\ApproversWithUserPrincipalNameRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\SubjectRightsRequests\Item\Collaborators\CollaboratorsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\SubjectRightsRequests\Item\CollaboratorsWithUserPrincipalName\CollaboratorsWithUserPrincipalNameRequestBuilder;
...
class SubjectRightsRequestItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}');
    ...
    */
    public function toGetRequestInformation(?SubjectRightsRequestItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
