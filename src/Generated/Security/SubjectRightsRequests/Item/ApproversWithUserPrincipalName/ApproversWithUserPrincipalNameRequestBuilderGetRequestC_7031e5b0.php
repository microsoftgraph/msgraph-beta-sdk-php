...
namespace Microsoft\Graph\Beta\Generated\Security\SubjectRightsRequests\Item\ApproversWithUserPrincipalName;

use Microsoft\Kiota\Abstractions\BaseRequestConfiguration;
use Microsoft\Kiota\Abstractions\RequestOption;

/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: approversWithUserPrincipalNameRequestBuilderGetRequestConfiguration
*/
class ApproversWithUserPrincipalNameRequestBuilderGetRequestC_7031e5b0 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ApproversWithUserPrincipalNameRequestBuilderGetRequestC_7031e5b0 and sets the default values.
