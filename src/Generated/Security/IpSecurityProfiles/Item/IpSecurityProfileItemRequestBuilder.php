...
class IpSecurityProfileItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $ipSecurityProfileId key: id of ipSecurityProfile
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $ipSecurityProfileId = null) {
        $this->urlTemplate = '{+baseurl}/security/ipSecurityProfiles/{ipSecurityProfile%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['ipSecurityProfileId'] = $ipSecurityProfileId;
