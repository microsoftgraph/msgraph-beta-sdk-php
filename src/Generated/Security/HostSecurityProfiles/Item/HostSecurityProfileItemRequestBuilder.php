...
class HostSecurityProfileItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $hostSecurityProfileId key: id of hostSecurityProfile
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $hostSecurityProfileId = null) {
        $this->urlTemplate = '{+baseurl}/security/hostSecurityProfiles/{hostSecurityProfile%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['hostSecurityProfileId'] = $hostSecurityProfileId;
