...
class FileSecurityProfileItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $fileSecurityProfileId key: id of fileSecurityProfile
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $fileSecurityProfileId = null) {
        $this->urlTemplate = '{+baseurl}/security/fileSecurityProfiles/{fileSecurityProfile%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['fileSecurityProfileId'] = $fileSecurityProfileId;
