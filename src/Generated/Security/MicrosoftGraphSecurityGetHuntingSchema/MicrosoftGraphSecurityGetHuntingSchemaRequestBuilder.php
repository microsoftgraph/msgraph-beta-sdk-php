...
class MicrosoftGraphSecurityGetHuntingSchemaRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphSecurityGetHuntingSchemaRequestBuilderGet_dc174970|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<HuntingSchemaResult|null>
     * @throws Exception
    */
    public function get(?MicrosoftGraphSecurityGetHuntingSchemaRequestBuilderGet_dc174970 $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?MicrosoftGraphSecurityGetHuntingSchemaRequestBuilderGet_dc174970 $requestConfiguration = null): RequestInformation {
