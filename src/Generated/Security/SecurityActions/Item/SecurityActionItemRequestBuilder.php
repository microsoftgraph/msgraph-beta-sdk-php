...
*/
class SecurityActionItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/securityActions/{securityAction%2Did}{?%24expand,%24select}');
     ...
     * @param SecurityActionItemRequestBuilderDeleteRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<void|null>
     * @throws Exception
    */
    public function delete(?SecurityActionItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): Promise {
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/securityaction-get?view=graph-rest-1.0 Find more info here
    */
     ...
     * @throws Exception
    */
    public function patch(SecurityAction $body, ?SecurityActionItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toDeleteRequestInformation(?SecurityActionItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/securityActions/{securityAction%2Did}';
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?SecurityActionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(SecurityAction $body, ?SecurityActionItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/securityActions/{securityAction%2Did}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): SecurityActionItemRequestBuilder {
        return new SecurityActionItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
