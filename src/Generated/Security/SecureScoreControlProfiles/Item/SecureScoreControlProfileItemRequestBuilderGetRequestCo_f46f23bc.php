...
namespace Microsoft\Graph\Beta\Generated\Security\SecureScoreControlProfiles\Item;

use Microsoft\Kiota\Abstractions\BaseRequestConfiguration;
use Microsoft\Kiota\Abstractions\RequestOption;

/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: SecureScoreControlProfileItemRequestBuilderGetRequestConfiguration
*/
class SecureScoreControlProfileItemRequestBuilderGetRequestCo_f46f23bc extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SecureScoreControlProfileItemRequestBuilderGetRequestCo_f46f23bc and sets the default values.
    ...
    */
    public static function createQueryParameters(?array $expand = null, ?array $select = null): SecureScoreControlProfileItemRequestBuilderGetQueryParameters {
