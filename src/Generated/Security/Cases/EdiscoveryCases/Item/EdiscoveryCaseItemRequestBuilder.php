...
use Microsoft\Graph\Beta\Generated\Security\Cases\EdiscoveryCases\Item\MicrosoftGraphSecurityClose\CloseRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\Cases\EdiscoveryCases\Item\MicrosoftGraphSecurityReopen\ReopenRequestBuilder;
...
class EdiscoveryCaseItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $ediscoveryCaseId = null) {
    ...
    */
    public function legalHoldsById(string $id): EdiscoveryHoldPolicyItemRequestBuilder {
        ...
        return new EdiscoveryHoldPolicyItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
