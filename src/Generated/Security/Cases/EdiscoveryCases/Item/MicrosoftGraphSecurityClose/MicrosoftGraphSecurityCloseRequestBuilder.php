...
namespace Microsoft\Graph\Beta\Generated\Security\Cases\EdiscoveryCases\Item\MicrosoftGraphSecurityClose;
...
*/
class MicrosoftGraphSecurityCloseRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/microsoft.graph.security.close');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-ediscoverycase-close?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @return MicrosoftGraphSecurityCloseRequestBuilder
    */
    public function withUrl(string $rawUrl): MicrosoftGraphSecurityCloseRequestBuilder {
