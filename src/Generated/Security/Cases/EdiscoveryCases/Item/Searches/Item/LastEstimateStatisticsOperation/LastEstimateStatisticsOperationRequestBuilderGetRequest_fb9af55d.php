...
namespace Microsoft\Graph\Beta\Generated\Security\Cases\EdiscoveryCases\Item\Searches\Item\LastEstimateStatisticsOperation;

use Microsoft\Kiota\Abstractions\BaseRequestConfiguration;
use Microsoft\Kiota\Abstractions\RequestOption;

/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: lastEstimateStatisticsOperationRequestBuilderGetRequestConfiguration
*/
class LastEstimateStatisticsOperationRequestBuilderGetRequest_fb9af55d extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new LastEstimateStatisticsOperationRequestBuilderGetRequest_fb9af55d and sets the default values.
