...
class PurgeDataRequestBuilder 
{
    ...
    */
    public function post(PurgeDataPostRequestBody $body, ?PurgeDataRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(PurgeDataPostRequestBody $body, ?PurgeDataRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
