...
class PurgeDataRequestBuilder 
{
    ...
    */
    public function createPostRequestInformation(?PurgeDataRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(?PurgeDataRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
