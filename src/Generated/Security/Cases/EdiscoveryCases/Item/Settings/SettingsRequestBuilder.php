...
namespace Microsoft\Graph\Beta\Generated\Security\Cases\EdiscoveryCases\Item\Settings;
...
use Microsoft\Graph\Beta\Generated\Security\Cases\EdiscoveryCases\Item\Settings\ResetToDefault\ResetToDefaultRequestBuilder;
...
class SettingsRequestBuilder 
{
    ...
    */
     ...
     * @param EdiscoveryCaseSettings $body 
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(EdiscoveryCaseSettings $body, ?SettingsRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?SettingsRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(EdiscoveryCaseSettings::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
     ...
     * @return Promise
    */
    public function patch(EdiscoveryCaseSettings $body, ?SettingsRequestBuilderPatchRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
