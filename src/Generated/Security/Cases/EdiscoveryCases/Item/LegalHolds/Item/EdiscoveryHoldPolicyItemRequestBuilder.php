...
class EdiscoveryHoldPolicyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $ediscoveryHoldPolicyId key: id of ediscoveryHoldPolicy
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $ediscoveryHoldPolicyId = null) {
        ...
        $urlTplParams['ediscoveryHoldPolicyId'] = $ediscoveryHoldPolicyId;
