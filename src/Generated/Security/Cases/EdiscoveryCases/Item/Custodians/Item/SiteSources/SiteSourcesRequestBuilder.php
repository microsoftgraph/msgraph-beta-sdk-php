...
namespace Microsoft\Graph\Beta\Generated\Security\Cases\EdiscoveryCases\Item\Custodians\Item\SiteSources;
...
use Microsoft\Graph\Beta\Generated\Models\Security\SiteSourceCollectionResponse;
use Microsoft\Graph\Beta\Generated\Security\Cases\EdiscoveryCases\Item\Custodians\Item\SiteSources\Count\CountRequestBuilder;
...
class SiteSourcesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function post(\Microsoft\Graph\Beta\Generated\Models\Security\SiteSource $body, ?SiteSourcesRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(\Microsoft\Graph\Beta\Generated\Models\Security\SiteSource $body, ?SiteSourcesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
