...
class EdiscoveryFileItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $ediscoveryFileId key: id of ediscoveryFile
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $ediscoveryFileId = null) {
        ...
        $urlTplParams['ediscoveryFileId'] = $ediscoveryFileId;
