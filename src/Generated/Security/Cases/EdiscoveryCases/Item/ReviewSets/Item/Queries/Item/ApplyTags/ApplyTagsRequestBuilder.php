...
namespace Microsoft\Graph\Beta\Generated\Security\Cases\EdiscoveryCases\Item\ReviewSets\Item\Queries\Item\ApplyTags;
...
class ApplyTagsRequestBuilder 
{
    ...
    */
     ...
     * @param ApplyTagsPostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(ApplyTagsPostRequestBody $body, ?ApplyTagsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(ApplyTagsPostRequestBody $body, ?ApplyTagsRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
