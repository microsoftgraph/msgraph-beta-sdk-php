...
class MicrosoftGraphSecurityRemoveHoldRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/noncustodialDataSources/{ediscoveryNoncustodialDataSource%2Did}/microsoft.graph.security.removeHold');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-ediscoverynoncustodialdatasource-removehold?view=graph-rest-beta Find more info here
    */
    public function post(?MicrosoftGraphSecurityRemoveHoldRequestBuilderPostReque_ca5f08a7 $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?MicrosoftGraphSecurityRemoveHoldRequestBuilderPostReque_ca5f08a7 $requestConfiguration = null): RequestInformation {
