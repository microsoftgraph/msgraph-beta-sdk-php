...
class DataSourceRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @return Promise
    */
    public function patch(\Microsoft\Graph\Beta\Generated\Models\Security\DataSource $body, ?DataSourceRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(\Microsoft\Graph\Beta\Generated\Models\Security\DataSource $body, ?DataSourceRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
