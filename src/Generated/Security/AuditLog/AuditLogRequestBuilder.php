...
use Microsoft\Graph\Beta\Generated\Security\AuditLog\Queries\QueriesRequestBuilder;
...
class AuditLogRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/auditLog');
    ...
    */
    public function toGetRequestInformation(?AuditLogRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/auditLog{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
