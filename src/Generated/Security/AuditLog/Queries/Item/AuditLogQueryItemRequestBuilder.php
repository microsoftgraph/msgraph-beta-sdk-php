...
use Microsoft\Graph\Beta\Generated\Security\AuditLog\Queries\Item\Records\RecordsRequestBuilder;
...
class AuditLogQueryItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-auditlogquery-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?AuditLogQueryItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/auditLog/queries/{auditLogQuery%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
