...
class AttackSimulationOperationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $attackSimulationOperationId key: id of attackSimulationOperation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $attackSimulationOperationId = null) {
        ...
        $urlTplParams['attackSimulationOperationId'] = $attackSimulationOperationId;
