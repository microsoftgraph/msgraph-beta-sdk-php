...
class PayloadItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/attackSimulation/payloads/{payload%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/payload-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?PayloadItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/attackSimulation/payloads/{payload%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
