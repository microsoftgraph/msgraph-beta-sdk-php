...
class PayloadItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $payloadId key: id of payload
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $payloadId = null) {
        $this->urlTemplate = '{+baseurl}/security/attackSimulation/payloads/{payload%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['payloadId'] = $payloadId;
