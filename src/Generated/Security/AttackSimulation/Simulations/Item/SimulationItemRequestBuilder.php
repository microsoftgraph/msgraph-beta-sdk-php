...
class SimulationItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/simulation-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/simulation-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<Simulation|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/simulation-update?view=graph-rest-beta Find more info here
    */
