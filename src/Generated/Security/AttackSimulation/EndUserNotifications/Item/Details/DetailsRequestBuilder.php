...
namespace Microsoft\Graph\Beta\Generated\Security\AttackSimulation\EndUserNotifications\Item\Details;
...
use Microsoft\Graph\Beta\Generated\Security\AttackSimulation\EndUserNotifications\Item\Details\Item\EndUserNotificationDetailItemRequestBuilder;
...
class DetailsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?DetailsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/security/attackSimulation/endUserNotifications/{endUserNotification%2Did}/details{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(EndUserNotificationDetail $body, ?DetailsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/attackSimulation/endUserNotifications/{endUserNotification%2Did}/details';
        $requestInfo->pathParameters = $this->pathParameters;
