...
class RetentionEventItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $retentionEventId key: id of retentionEvent
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $retentionEventId = null) {
        $this->urlTemplate = '{+baseurl}/security/triggers/retentionEvents/{retentionEvent%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['retentionEventId'] = $retentionEventId;
