...
class TiIndicatorItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $tiIndicatorId key: id of tiIndicator
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $tiIndicatorId = null) {
        $this->urlTemplate = '{+baseurl}/security/tiIndicators/{tiIndicator%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['tiIndicatorId'] = $tiIndicatorId;
