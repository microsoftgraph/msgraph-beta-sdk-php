...
use Microsoft\Graph\Beta\Generated\Security\TiIndicators\MicrosoftGraphDeleteTiIndicators\MicrosoftGraphDeleteTiIndicatorsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\TiIndicators\MicrosoftGraphDeleteTiIndicatorsByExternalId\MicrosoftGraphDeleteTiIndicatorsByExternalIdRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\TiIndicators\MicrosoftGraphSubmitTiIndicators\MicrosoftGraphSubmitTiIndicatorsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\TiIndicators\MicrosoftGraphUpdateTiIndicators\MicrosoftGraphUpdateTiIndicatorsRequestBuilder;
...
class TiIndicatorsRequestBuilder 
{
    ...
    */
    public function microsoftGraphDeleteTiIndicators(): MicrosoftGraphDeleteTiIndicatorsRequestBuilder {
        return new MicrosoftGraphDeleteTiIndicatorsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the deleteTiIndicatorsByExternalId method.
    */
    public function microsoftGraphDeleteTiIndicatorsByExternalId(): MicrosoftGraphDeleteTiIndicatorsByExternalIdRequestBuilder {
        return new MicrosoftGraphDeleteTiIndicatorsByExternalIdRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the submitTiIndicators method.
    */
    public function microsoftGraphSubmitTiIndicators(): MicrosoftGraphSubmitTiIndicatorsRequestBuilder {
        return new MicrosoftGraphSubmitTiIndicatorsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the updateTiIndicators method.
    */
    public function microsoftGraphUpdateTiIndicators(): MicrosoftGraphUpdateTiIndicatorsRequestBuilder {
        return new MicrosoftGraphUpdateTiIndicatorsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
