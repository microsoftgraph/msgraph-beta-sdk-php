...
class DeleteTiIndicatorsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return DeleteTiIndicatorsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeleteTiIndicatorsRequestBody {
        return new DeleteTiIndicatorsRequestBody();
    }
