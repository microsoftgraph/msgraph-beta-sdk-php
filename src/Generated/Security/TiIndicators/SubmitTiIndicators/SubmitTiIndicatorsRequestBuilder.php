...
*/
class SubmitTiIndicatorsRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/tiIndicators/submitTiIndicators');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/tiindicator-submittiindicators?view=graph-rest-1.0 Find more info here
    */
    ...
    */
     ...
     * @return SubmitTiIndicatorsRequestBuilder
    */
    public function withUrl(string $rawUrl): SubmitTiIndicatorsRequestBuilder {
        return new SubmitTiIndicatorsRequestBuilder($rawUrl, $this->requestAdapter);
    }
