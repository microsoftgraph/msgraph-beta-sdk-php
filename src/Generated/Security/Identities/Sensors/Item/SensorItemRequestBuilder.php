...
namespace Microsoft\Graph\Beta\Generated\Security\Identities\Sensors\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\Security\Sensor;
use Microsoft\Graph\Beta\Generated\Security\Identities\Sensors\Item\HealthIssues\HealthIssuesRequestBuilder;
...
class SensorItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/identities/sensors/{sensor%2Did}');
    ...
    */
    public function toGetRequestInformation(?SensorItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/identities/sensors/{sensor%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
