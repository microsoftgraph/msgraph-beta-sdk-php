...
use Microsoft\Graph\Beta\Generated\Security\Identities\HealthIssues\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\Identities\HealthIssues\Item\HealthIssueItemRequestBuilder;
...
class HealthIssuesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?HealthIssuesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/security/identities/healthIssues{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(HealthIssue $body, ?HealthIssuesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/identities/healthIssues';
        $requestInfo->pathParameters = $this->pathParameters;
