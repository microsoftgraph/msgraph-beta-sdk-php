...
namespace Microsoft\Graph\Beta\Generated\Security\Identities\IdentityAccounts\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\Security\IdentityAccounts;
use Microsoft\Graph\Beta\Generated\Security\Identities\IdentityAccounts\Item\MicrosoftGraphSecurityInvokeAction\MicrosoftGraphSecurityInvokeActionRequestBuilder;
...
class IdentityAccountsItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/identities/identityAccounts/{identityAccounts%2Did}');
    ...
    */
    public function toGetRequestInformation(?IdentityAccountsItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/identities/identityAccounts/{identityAccounts%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
