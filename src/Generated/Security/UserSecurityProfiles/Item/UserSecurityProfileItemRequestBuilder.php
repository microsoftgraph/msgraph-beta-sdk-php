...
class UserSecurityProfileItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userSecurityProfileId key: id of userSecurityProfile
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userSecurityProfileId = null) {
        $this->urlTemplate = '{+baseurl}/security/userSecurityProfiles/{userSecurityProfile%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['userSecurityProfileId'] = $userSecurityProfileId;
