...
class RetentionLabelItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-retentionlabel-delete?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @return Promise<RetentionLabel|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-retentionlabel-update?view=graph-rest-beta Find more info here
    */
