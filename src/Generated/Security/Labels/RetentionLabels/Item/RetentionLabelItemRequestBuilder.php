...
class RetentionLabelItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $retentionLabelId key: id of retentionLabel
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $retentionLabelId = null) {
    ...
    */
    public function dispositionReviewStagesById(string $id): DispositionReviewStageItemRequestBuilder {
        ...
        return new DispositionReviewStageItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
