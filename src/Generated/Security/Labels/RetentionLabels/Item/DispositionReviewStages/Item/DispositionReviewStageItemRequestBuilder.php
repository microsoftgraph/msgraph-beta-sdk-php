...
class DispositionReviewStageItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $dispositionReviewStageId key: id of dispositionReviewStage
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $dispositionReviewStageId = null) {
        ...
        $urlTplParams['dispositionReviewStageId'] = $dispositionReviewStageId;
