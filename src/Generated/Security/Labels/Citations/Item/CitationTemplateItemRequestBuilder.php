...
namespace Microsoft\Graph\Beta\Generated\Security\Labels\Citations\Item;
...
*/
class CitationTemplateItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/labels/citations/{citationTemplate%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-citationtemplate-get?view=graph-rest-beta Find more info here
    */
     ...
     * @param CitationTemplateItemRequestBuilderPatchRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<CitationTemplate|null>
     * @throws Exception
    */
    public function patch(CitationTemplate $body, ?CitationTemplateItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?CitationTemplateItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/labels/citations/{citationTemplate%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): CitationTemplateItemRequestBuilder {
        return new CitationTemplateItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
