...
class CloudAppSecurityProfileItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $cloudAppSecurityProfileId key: id of cloudAppSecurityProfile
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $cloudAppSecurityProfileId = null) {
        ...
        $urlTplParams['cloudAppSecurityProfileId'] = $cloudAppSecurityProfileId;
