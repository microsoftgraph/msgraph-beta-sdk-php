...
class FileThreatSubmissionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $fileThreatSubmissionId key: id of fileThreatSubmission
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $fileThreatSubmissionId = null) {
        ...
        $urlTplParams['fileThreatSubmissionId'] = $fileThreatSubmissionId;
