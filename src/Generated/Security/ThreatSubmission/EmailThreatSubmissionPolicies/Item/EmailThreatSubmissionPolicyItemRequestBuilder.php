...
class EmailThreatSubmissionPolicyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $emailThreatSubmissionPolicyId key: id of emailThreatSubmissionPolicy
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $emailThreatSubmissionPolicyId = null) {
        ...
        $urlTplParams['emailThreatSubmissionPolicyId'] = $emailThreatSubmissionPolicyId;
