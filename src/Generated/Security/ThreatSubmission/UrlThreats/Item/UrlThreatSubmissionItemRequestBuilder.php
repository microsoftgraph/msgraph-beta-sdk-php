...
class UrlThreatSubmissionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $urlThreatSubmissionId key: id of urlThreatSubmission
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $urlThreatSubmissionId = null) {
        ...
        $urlTplParams['urlThreatSubmissionId'] = $urlThreatSubmissionId;
