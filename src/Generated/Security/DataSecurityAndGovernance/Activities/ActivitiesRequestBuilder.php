...
use Microsoft\Graph\Beta\Generated\Models\TenantActivitiesContainer;
...
class ActivitiesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/dataSecurityAndGovernance/activities{?%24expand,%24select}');
    ...
    */
     ...
     * @return Promise<TenantActivitiesContainer|null>
     * @throws Exception
    */
    public function get(?ActivitiesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [TenantActivitiesContainer::class, 'createFromDiscriminatorValue'], $errorMappings);
    }

    /**
     * Update the navigation property activities in security
     * @param TenantActivitiesContainer $body The request body
     ...
     * @throws Exception
    */
    public function patch(TenantActivitiesContainer $body, ?ActivitiesRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(TenantActivitiesContainer $body, ?ActivitiesRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
