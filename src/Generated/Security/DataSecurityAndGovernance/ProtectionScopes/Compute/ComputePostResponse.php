...
use Microsoft\\Graph\\Beta\\Generated\Models\PolicyTenantScope;
...
class ComputePostResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([PolicyTenantScope::class, 'createFromDiscriminatorValue'])),
        ]);
    }

    /**
     * Gets the value property value. The value property
     * @return array<PolicyTenantScope>|null
    */
    public function getValue(): ?array {
        $val = $this->getBackingStore()->get('value');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, PolicyTenantScope::class);
            /** @var array<PolicyTenantScope>|null $val */
            return $val;
        }
    ...
    */
     ...
     * @param array<PolicyTenantScope>|null $value Value to set for the value property.
    */
