...
class RetentionEventTypeItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $retentionEventTypeId key: id of retentionEventType
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $retentionEventTypeId = null) {
        ...
        $urlTplParams['retentionEventTypeId'] = $retentionEventTypeId;
