...
class HostCookieItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/threatIntelligence/hostCookies/{hostCookie%2Did}{?%24select,%24expand}');
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/security-hostcookie-get?view=graph-rest-1.0 Find more info here
    */
