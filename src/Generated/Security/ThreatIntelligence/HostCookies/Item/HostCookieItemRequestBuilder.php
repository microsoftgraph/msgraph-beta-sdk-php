...
use Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\HostCookies\Item\Host\HostRequestBuilder;
...
class HostCookieItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/threatIntelligence/hostCookies/{hostCookie%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-hostcookie-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?HostCookieItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/threatIntelligence/hostCookies/{hostCookie%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
