...
use Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\HostTrackers\Item\Host\HostRequestBuilder;
...
class HostTrackerItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/threatIntelligence/hostTrackers/{hostTracker%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-hosttracker-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?HostTrackerItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/threatIntelligence/hostTrackers/{hostTracker%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
