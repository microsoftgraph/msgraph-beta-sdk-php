...
namespace Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\Hosts\Item\Cookies;
...
class CookiesRequestBuilderGetRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): CookiesRequestBuilderGetQueryParameters {
        return new CookiesRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
