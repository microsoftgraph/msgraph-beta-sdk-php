...
namespace Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\HostPorts\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\Security\HostPort;
use Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\HostPorts\Item\Host\HostRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\HostPorts\Item\MostRecentSslCertificate\MostRecentSslCertificateRequestBuilder;
...
class HostPortItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/threatIntelligence/hostPorts/{hostPort%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-hostport-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?HostPortItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/threatIntelligence/hostPorts/{hostPort%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
