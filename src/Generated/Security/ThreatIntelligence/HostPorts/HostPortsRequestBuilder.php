...
namespace Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\HostPorts;
...
use Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\HostPorts\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\HostPorts\Item\HostPortItemRequestBuilder;
...
class HostPortsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?HostPortsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/security/threatIntelligence/hostPorts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(HostPort $body, ?HostPortsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/threatIntelligence/hostPorts';
        $requestInfo->pathParameters = $this->pathParameters;
