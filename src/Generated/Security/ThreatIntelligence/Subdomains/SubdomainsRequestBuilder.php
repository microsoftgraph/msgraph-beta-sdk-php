...
namespace Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\Subdomains;
...
use Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\Subdomains\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Security\ThreatIntelligence\Subdomains\Item\SubdomainItemRequestBuilder;
...
class SubdomainsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?SubdomainsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/security/threatIntelligence/subdomains{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(Subdomain $body, ?SubdomainsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/threatIntelligence/subdomains';
        $requestInfo->pathParameters = $this->pathParameters;
