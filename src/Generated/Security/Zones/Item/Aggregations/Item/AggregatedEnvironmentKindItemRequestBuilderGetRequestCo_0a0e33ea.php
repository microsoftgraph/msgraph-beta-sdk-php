...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: AggregatedEnvironmentKindItemRequestBuilderGetRequestConfiguration
*/
class AggregatedEnvironmentKindItemRequestBuilderGetRequestCo_0a0e33ea extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AggregatedEnvironmentKindItemRequestBuilderGetRequestCo_0a0e33ea and sets the default values.
