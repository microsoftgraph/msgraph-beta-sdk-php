...
*/
class DetectionRuleItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/rules/detectionRules/{detectionRule%2Did}');
    ...
    */
     ...
     * @throws Exception
    */
    public function get(?DetectionRuleItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
     ...
     * @param DetectionRuleItemRequestBuilderPatchRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<DetectionRule|null>
     * @throws Exception
    */
    public function patch(DetectionRule $body, ?DetectionRuleItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?DetectionRuleItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/security/rules/detectionRules/{detectionRule%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): DetectionRuleItemRequestBuilder {
        return new DetectionRuleItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
