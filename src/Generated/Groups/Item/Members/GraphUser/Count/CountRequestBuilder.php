...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Members\GraphUser\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/members/graph.user/$count{?%24search,%24filter}');
