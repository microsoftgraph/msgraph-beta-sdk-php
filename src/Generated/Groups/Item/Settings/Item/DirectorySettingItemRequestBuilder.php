...
class DirectorySettingItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/settings/{directorySetting%2Did}{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?DirectorySettingItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/groups/{group%2Did}/settings/{directorySetting%2Did}';
    ...
    */
    public function withUrl(string $rawUrl): DirectorySettingItemRequestBuilder {
        return new DirectorySettingItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
