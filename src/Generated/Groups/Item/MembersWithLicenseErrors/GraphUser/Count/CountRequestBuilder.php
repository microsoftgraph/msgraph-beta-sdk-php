...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\MembersWithLicenseErrors\GraphUser\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/graph.user/$count{?%24filter,%24search}');
