...
use Microsoft\Graph\Beta\Generated\Groups\Item\Events\Item\Accept\AcceptRequestBuilder;
...
class EventItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.events.item.attachments.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.events.item.exceptionOccurrences.item collection
     * @param string $id Unique identifier of the item
     * @return MicrosoftGraphBetaGeneratedGroupsItemEventsItemExceptionOccurrencesItemEventItemRequestBuilder
    */
    public function exceptionOccurrencesById(string $id): MicrosoftGraphBetaGeneratedGroupsItemEventsItemExceptionOccurrencesItemEventItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['event%2Did1'] = $id;
        return new MicrosoftGraphBetaGeneratedGroupsItemEventsItemExceptionOccurrencesItemEventItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }

    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.events.item.extensions.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.events.item.instances.item collection
     * @param string $id Unique identifier of the item
     * @return MicrosoftGraphBetaGeneratedGroupsItemEventsItemInstancesItemEventItemRequestBuilder
    */
    public function instancesById(string $id): MicrosoftGraphBetaGeneratedGroupsItemEventsItemInstancesItemEventItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['event%2Did1'] = $id;
        return new MicrosoftGraphBetaGeneratedGroupsItemEventsItemInstancesItemEventItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }

    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.events.item.multiValueExtendedProperties.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.events.item.singleValueExtendedProperties.item collection
     * @param string $id Unique identifier of the item
