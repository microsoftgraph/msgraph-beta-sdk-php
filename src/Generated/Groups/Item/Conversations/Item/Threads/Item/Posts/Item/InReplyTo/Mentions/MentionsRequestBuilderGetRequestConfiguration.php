...
namespace Microsoft\\Graph\\Beta\\Generated\Groups\Item\Conversations\Item\Threads\Item\Posts\Item\InReplyTo\Mentions;
...
*/
class MentionsRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    /**
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): MentionsRequestBuilderGetQueryParameters {
        return new MentionsRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
