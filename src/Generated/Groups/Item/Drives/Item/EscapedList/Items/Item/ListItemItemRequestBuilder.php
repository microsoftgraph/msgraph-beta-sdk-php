...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\Activities\ActivitiesRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\Activities\Item\ItemActivityOLDItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\Analytics\AnalyticsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\CreateLink\CreateLinkRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\DocumentSetVersions\DocumentSetVersionsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\DocumentSetVersions\Item\DocumentSetVersionItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\DriveItem\DriveItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\Fields\FieldsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval\GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\Versions\Item\ListItemVersionItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\Item\Versions\VersionsRequestBuilder;
...
class ListItemItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.drives.item.list.items.item.activities.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.drives.item.list.items.item.documentSetVersions.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    public function get(?ListItemItemRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [ListItem::class, 'createFromDiscriminatorValue'], $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.drives.item.list.items.item.versions.item collection
     * @param string $id Unique identifier of the item
