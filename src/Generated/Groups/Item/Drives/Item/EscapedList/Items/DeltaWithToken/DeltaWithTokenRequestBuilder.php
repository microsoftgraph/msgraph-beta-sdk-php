...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Drives\Item\EscapedList\Items\DeltaWithToken;
...
class DeltaWithTokenRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $token = null) {
        $this->urlTemplate = '{+baseurl}/groups/{group_id}/drives/{drive_id}/list/items/microsoft.graph.delta(token=\'{token}\')';
