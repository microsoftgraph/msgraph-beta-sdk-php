...
use Microsoft\Graph\Beta\Generated\Models\DriveItemUploadableProperties;
...
class CreateUploadSessionPostRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'item' => function (ParseNode $n) use ($o) { $o->setItem($n->getObjectValue(array(DriveItemUploadableProperties::class, 'createFromDiscriminatorValue'))); },
        ];
    }
