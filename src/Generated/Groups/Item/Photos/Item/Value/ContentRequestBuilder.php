...
namespace Microsoft\\Graph\\Beta\\Generated\Groups\Item\Photos\Item\Value;
...
class ContentRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/photos/{profilePhoto%2Did}/$value');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/group-list-photos?view=graph-rest-beta Find more info here
    */
