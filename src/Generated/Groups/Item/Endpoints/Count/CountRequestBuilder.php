...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Endpoints\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/groups/{group%2Did}/endpoints/$count{?%24search,%24filter}");
