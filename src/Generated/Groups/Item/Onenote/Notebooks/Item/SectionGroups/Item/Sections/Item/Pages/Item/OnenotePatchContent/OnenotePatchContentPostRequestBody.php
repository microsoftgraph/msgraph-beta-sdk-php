...
namespace Microsoft\\Graph\\Beta\\Generated\Groups\Item\Onenote\Notebooks\Item\SectionGroups\Item\Sections\Item\Pages\Item\OnenotePatchContent;

use Microsoft\\Graph\\Beta\\Generated\Models\OnenotePatchContentCommand;
...
class OnenotePatchContentPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getCommands(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, OnenotePatchContentCommand::class);
            /** @var array<OnenotePatchContentCommand>|null $val */
            return $val;
        }
