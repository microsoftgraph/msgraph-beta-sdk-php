...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Onenote\Notebooks\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/groups/{group%2Did}/onenote/notebooks/$count{?%24search,%24filter}");
