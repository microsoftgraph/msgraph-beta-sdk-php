...
class ForwardRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo/forward');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/post-forward?view=graph-rest-beta Find more info here
    */
