...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Owners\Item\GraphUser;
...
class GraphUserRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/graph.user{?%24select,%24expand}");
