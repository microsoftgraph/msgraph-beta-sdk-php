...
class AppRoleAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $appRoleAssignmentId key: id of appRoleAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $appRoleAssignmentId = null) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/appRoleAssignments/{appRoleAssignment%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['appRoleAssignmentId'] = $appRoleAssignmentId;
