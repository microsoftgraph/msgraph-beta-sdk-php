...
use Microsoft\Graph\Beta\Generated\Groups\Item\CalendarView\Item\ExceptionOccurrences\Item\Attachments\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\CalendarView\Item\ExceptionOccurrences\Item\Attachments\CreateUploadSession\CreateUploadSessionRequestBuilder;
...
class AttachmentsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}');
    ...
    */
    public function toPostRequestInformation(Attachment $body, ?AttachmentsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments';
        $requestInfo->pathParameters = $this->pathParameters;
