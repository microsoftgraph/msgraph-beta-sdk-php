...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\SubscribeByMail;
...
class SubscribeByMailRequestBuilder 
{
    ...
    */
    public function createPostRequestInformation(?SubscribeByMailRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(?SubscribeByMailRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
