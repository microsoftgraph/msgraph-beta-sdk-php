...
class UnarchiveRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/team/unarchive');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/team-unarchive?view=graph-rest-beta Find more info here
    */
