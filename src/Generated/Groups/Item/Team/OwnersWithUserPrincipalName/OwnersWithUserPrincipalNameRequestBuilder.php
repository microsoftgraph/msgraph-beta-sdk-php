...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Team\OwnersWithUserPrincipalName;
...
class OwnersWithUserPrincipalNameRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $userPrincipalName = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/team/owners(userPrincipalName=\'{userPrincipalName}\'){?%24expand,%24select}');
