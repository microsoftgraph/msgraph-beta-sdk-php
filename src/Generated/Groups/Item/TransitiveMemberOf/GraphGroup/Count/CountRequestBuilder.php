...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\TransitiveMemberOf\GraphGroup\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/groups/{group%2Did}/transitiveMemberOf/graph.group/$count{?%24search,%24filter}");
