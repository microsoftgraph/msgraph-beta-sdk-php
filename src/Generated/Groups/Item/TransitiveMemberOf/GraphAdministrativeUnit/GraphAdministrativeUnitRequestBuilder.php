...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\TransitiveMemberOf\GraphAdministrativeUnit;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Groups\Item\TransitiveMemberOf\GraphAdministrativeUnit\Count\CountRequestBuilder;
...
class GraphAdministrativeUnitRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/transitiveMemberOf/graph.administrativeUnit{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
