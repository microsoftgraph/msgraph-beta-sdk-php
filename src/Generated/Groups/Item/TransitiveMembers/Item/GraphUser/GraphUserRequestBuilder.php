...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\TransitiveMembers\Item\GraphUser;
...
class GraphUserRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/graph.user{?%24expand,%24select}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/group-list-transitivemembers?view=graph-rest-beta Find more info here
    */
