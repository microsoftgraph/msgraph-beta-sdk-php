...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\Events\Item\SingleValueExtendedProperties\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/singleValueExtendedProperties/$count{?%24search,%24filter}");
