...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\ExceptionOccurrences\Item\SingleValueExtendedProperties;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\ExceptionOccurrences\Item\SingleValueExtendedProperties\Count\CountRequestBuilder;
...
class SingleValueExtendedPropertiesRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}';
