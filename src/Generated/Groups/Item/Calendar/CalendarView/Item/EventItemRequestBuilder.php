...
use Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\MicrosoftGraphAccept\MicrosoftGraphAcceptRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\MicrosoftGraphCancel\MicrosoftGraphCancelRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\MicrosoftGraphDecline\MicrosoftGraphDeclineRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\MicrosoftGraphDismissReminder\MicrosoftGraphDismissReminderRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\MicrosoftGraphForward\MicrosoftGraphForwardRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\MicrosoftGraphSnoozeReminder\MicrosoftGraphSnoozeReminderRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\MicrosoftGraphTentativelyAccept\MicrosoftGraphTentativelyAcceptRequestBuilder;
...
class EventItemRequestBuilder 
{
    ...
    */
     ...
     * Provides operations to manage the exceptionOccurrences property of the microsoft.graph.event entity.
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\ExceptionOccurrences\Item\EventItemRequestBuilder
    */
    public function exceptionOccurrencesById(string $id): \Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\ExceptionOccurrences\Item\EventItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['event%2Did1'] = $id;
        return new \Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\ExceptionOccurrences\Item\EventItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
     ...
     * Provides operations to manage the instances property of the microsoft.graph.event entity.
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\Instances\Item\EventItemRequestBuilder
    */
    public function instancesById(string $id): \Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\Instances\Item\EventItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['event%2Did1'] = $id;
        return new \Microsoft\Graph\Beta\Generated\Groups\Item\Calendar\CalendarView\Item\Instances\Item\EventItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
