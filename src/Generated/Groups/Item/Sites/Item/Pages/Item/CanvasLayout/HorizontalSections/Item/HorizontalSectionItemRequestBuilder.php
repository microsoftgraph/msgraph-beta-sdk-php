...
class HorizontalSectionItemRequestBuilder 
{
    ...
    */
    public function columnsById(string $id): HorizontalSectionColumnItemRequestBuilder {
        ...
        return new HorizontalSectionColumnItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $horizontalSectionId key: id of horizontalSection
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $horizontalSectionId = null) {
