...
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Pages\Item\CanvasLayout\HorizontalSections\Item\Columns\Item\Webparts\Item\MicrosoftGraphGetPositionOfWebPart\GetPositionOfWebPartRequestBuilder;
...
class WebPartItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphGetPositionOfWebPart(): GetPositionOfWebPartRequestBuilder {
    ...
    */
     ...
     * @param string|null $webPartId key: id of webPart
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $webPartId = null) {
        ...
        $urlTplParams['webPartId'] = $webPartId;
