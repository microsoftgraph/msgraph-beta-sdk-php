...
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Pages\Item\MicrosoftGraphGetWebPartsByPosition\GetWebPartsByPositionRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Pages\Item\MicrosoftGraphPublish\PublishRequestBuilder;
...
class SitePageItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphGetWebPartsByPosition(): GetWebPartsByPositionRequestBuilder {
    ...
    */
     ...
     * @param string|null $sitePageId key: id of sitePage
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $sitePageId = null) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{sitePage%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['sitePageId'] = $sitePageId;
