...
class HorizontalSectionColumnItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $horizontalSectionColumnId = null) {
        ...
        $urlTplParams['horizontalSectionColumnId'] = $horizontalSectionColumnId;
