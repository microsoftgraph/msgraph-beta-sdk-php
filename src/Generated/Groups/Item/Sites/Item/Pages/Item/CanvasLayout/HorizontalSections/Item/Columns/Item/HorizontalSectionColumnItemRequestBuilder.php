...
class HorizontalSectionColumnItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $horizontalSectionColumnId key: id of horizontalSectionColumn
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $horizontalSectionColumnId = null) {
    ...
    */
    public function webpartsById(string $id): WebPartItemRequestBuilder {
        ...
        return new WebPartItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
