...
namespace Microsoft\\Graph\\Beta\\Generated\Groups\Item\Sites\Item\Pages\GraphSitePage;
...
class GraphSitePageRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): GraphSitePageRequestBuilderGetQueryParameters {
        return new GraphSitePageRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
