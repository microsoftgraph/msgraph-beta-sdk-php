...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Lists\Item\Items\MicrosoftGraphDeltaWithToken;
...
class DeltaWithTokenRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $token = null) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/microsoft.graph.delta(token=\'{token}\'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}';
