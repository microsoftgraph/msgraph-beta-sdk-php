...
class GetCompatibleHubContentTypesRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/groups/{group_id}/sites/{site_id}/lists/{list_id}/contentTypes/microsoft.graph.getCompatibleHubContentTypes()';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, GetCompatibleHubContentTypesResponse::class, $responseHandler);
        } catch(Exception $ex) {
