...
class ListItemItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.lists.item.items.item.activities.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.lists.item.items.item.documentSetVersions.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.lists.item.items.item.versions.item collection
     * @param string $id Unique identifier of the item
