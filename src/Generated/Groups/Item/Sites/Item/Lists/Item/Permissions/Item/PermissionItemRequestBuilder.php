...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Lists\Item\Permissions\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Lists\Item\Permissions\Item\Grant\GrantRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Lists\Item\Permissions\Item\RevokeGrants\RevokeGrantsRequestBuilder;
...
class PermissionItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/permissions/{permission%2Did}');
    ...
    */
    public function toGetRequestInformation(?PermissionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/permissions/{permission%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
