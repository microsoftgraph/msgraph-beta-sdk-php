...
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\ContentTypes\Item\AssociateWithHubSites\AssociateWithHubSitesRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\ContentTypes\Item\Unpublish\UnpublishRequestBuilder;
...
class ContentTypeItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.contentTypes.item.baseTypes.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.contentTypes.item.columnLinks.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.contentTypes.item.columnPositions.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.contentTypes.item.columns.item collection
     * @param string $id Unique identifier of the item
