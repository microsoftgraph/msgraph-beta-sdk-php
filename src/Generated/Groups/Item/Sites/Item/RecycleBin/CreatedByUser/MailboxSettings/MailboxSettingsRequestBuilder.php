...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\RecycleBin\CreatedByUser\MailboxSettings;
...
class MailboxSettingsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/createdByUser/mailboxSettings{?%24expand,%24select}');
    ...
    */
    public function toPatchRequestInformation(MailboxSettings $body, ?MailboxSettingsRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/createdByUser/mailboxSettings';
        $requestInfo->pathParameters = $this->pathParameters;
