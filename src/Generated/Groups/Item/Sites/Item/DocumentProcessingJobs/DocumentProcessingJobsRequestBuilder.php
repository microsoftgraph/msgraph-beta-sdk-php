...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\DocumentProcessingJobs;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\DocumentProcessingJobs\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\DocumentProcessingJobs\Item\DocumentProcessingJobItemRequestBuilder;
...
class DocumentProcessingJobsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?DocumentProcessingJobsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/documentProcessingJobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(DocumentProcessingJob $body, ?DocumentProcessingJobsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/documentProcessingJobs';
        $requestInfo->pathParameters = $this->pathParameters;
