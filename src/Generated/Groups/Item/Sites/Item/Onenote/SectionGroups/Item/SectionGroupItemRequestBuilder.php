...
class SectionGroupItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.onenote.sectionGroups.item.sectionGroups.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.onenote.sectionGroups.item.sections.item collection
     * @param string $id Unique identifier of the item
