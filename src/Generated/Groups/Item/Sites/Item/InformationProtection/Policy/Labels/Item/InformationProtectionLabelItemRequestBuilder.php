...
class InformationProtectionLabelItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $informationProtectionLabelId key: id of informationProtectionLabel
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $informationProtectionLabelId = null) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['informationProtectionLabelId'] = $informationProtectionLabelId;
