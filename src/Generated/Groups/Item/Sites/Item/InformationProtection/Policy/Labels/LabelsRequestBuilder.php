...
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\InformationProtection\Policy\Labels\MicrosoftGraphEvaluateApplication\MicrosoftGraphEvaluateApplicationRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\InformationProtection\Policy\Labels\MicrosoftGraphEvaluateClassificationResults\MicrosoftGraphEvaluateClassificationResultsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\InformationProtection\Policy\Labels\MicrosoftGraphEvaluateRemoval\MicrosoftGraphEvaluateRemovalRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\InformationProtection\Policy\Labels\MicrosoftGraphExtractLabel\MicrosoftGraphExtractLabelRequestBuilder;
...
class LabelsRequestBuilder 
{
    ...
    */
    public function microsoftGraphEvaluateApplication(): MicrosoftGraphEvaluateApplicationRequestBuilder {
        return new MicrosoftGraphEvaluateApplicationRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the evaluateClassificationResults method.
    */
    public function microsoftGraphEvaluateClassificationResults(): MicrosoftGraphEvaluateClassificationResultsRequestBuilder {
        return new MicrosoftGraphEvaluateClassificationResultsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the evaluateRemoval method.
    */
    public function microsoftGraphEvaluateRemoval(): MicrosoftGraphEvaluateRemovalRequestBuilder {
        return new MicrosoftGraphEvaluateRemovalRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the extractLabel method.
    */
    public function microsoftGraphExtractLabel(): MicrosoftGraphExtractLabelRequestBuilder {
        return new MicrosoftGraphExtractLabelRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}';
