...
class DataLossPreventionPolicyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $dataLossPreventionPolicyId key: id of dataLossPreventionPolicy
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $dataLossPreventionPolicyId = null) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/dataLossPreventionPolicies/{dataLossPreventionPolicy%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['dataLossPreventionPolicyId'] = $dataLossPreventionPolicyId;
