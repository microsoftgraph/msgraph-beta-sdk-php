...
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\ContentModels\Item\AddToDrive\AddToDriveRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\ContentModels\Item\GetAppliedDrives\GetAppliedDrivesRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\ContentModels\Item\RemoveFromDrive\RemoveFromDriveRequestBuilder;
...
class ContentModelItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentModels/{contentModel%2Did}');
    ...
    */
    public function toGetRequestInformation(?ContentModelItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentModels/{contentModel%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
