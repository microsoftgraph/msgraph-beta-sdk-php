...
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\InformationProtection\InformationProtectionRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\MicrosoftGraphGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval\GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\MicrosoftGraphGetApplicableContentTypesForListWithListId\GetApplicableContentTypesForListWithListIdRequestBuilder;
use Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\MicrosoftGraphGetByPathWithPath\GetByPathWithPathRequestBuilder;
...
class SiteItemRequestBuilder 
{
    ...
    */
    public function columnsById(string $id): \Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Columns\Item\ColumnDefinitionItemRequestBuilder {
        ...
        return new \Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Columns\Item\ColumnDefinitionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $siteId = null) {
    ...
    */
    public function externalColumnsById(string $id): \Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\ExternalColumns\Item\ColumnDefinitionItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['columnDefinition%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\ExternalColumns\Item\ColumnDefinitionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function pagesById(string $id): SitePageItemRequestBuilder {
        ...
        return new SitePageItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function sitesById(string $id): \Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Sites\Item\SiteItemRequestBuilder {
        ...
        return new \Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\Sites\Item\SiteItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
