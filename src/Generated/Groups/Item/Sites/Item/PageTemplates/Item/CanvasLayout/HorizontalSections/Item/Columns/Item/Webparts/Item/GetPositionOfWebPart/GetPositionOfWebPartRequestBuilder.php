...
namespace Microsoft\Graph\Beta\Generated\Groups\Item\Sites\Item\PageTemplates\Item\CanvasLayout\HorizontalSections\Item\Columns\Item\Webparts\Item\GetPositionOfWebPart;
...
class GetPositionOfWebPartRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout/horizontalSections/{horizontalSection%2Did}/columns/{horizontalSectionColumn%2Did}/webparts/{webPart%2Did}/getPositionOfWebPart');
     ...
     * @return Promise<WebPartPosition|null>
     * @throws Exception
    */
    ...
    */
    public function withUrl(string $rawUrl): GetPositionOfWebPartRequestBuilder {
        return new GetPositionOfWebPartRequestBuilder($rawUrl, $this->requestAdapter);
    }
