...
class TermItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.termStore.sets.item.parentGroup.sets.item.children.item.children.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.groups.item.sites.item.termStore.sets.item.parentGroup.sets.item.children.item.relations.item collection
     * @param string $id Unique identifier of the item
