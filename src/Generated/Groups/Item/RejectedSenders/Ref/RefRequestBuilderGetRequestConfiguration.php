...
class RefRequestBuilderGetRequestConfiguration 
{
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?string $filter = null, ?array $orderby = null, ?int $skip = null, ?int $top = null): RefRequestBuilderGetQueryParameters {
