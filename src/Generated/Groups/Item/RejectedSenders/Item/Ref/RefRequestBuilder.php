...
class RefRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/rejectedSenders/{directoryObject%2Did}/$ref{?%40id*}');
     ...
     * @return Promise
     * @link https://learn.microsoft.com/graph/api/group-delete-rejectedsenders?view=graph-rest-1.0 Find more info here
    */
