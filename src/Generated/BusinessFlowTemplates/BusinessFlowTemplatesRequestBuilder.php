...
class BusinessFlowTemplatesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/businessFlowTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/businessflowtemplate-list?view=graph-rest-beta Find more info here
    */
