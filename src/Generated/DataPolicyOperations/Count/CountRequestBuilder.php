...
namespace Microsoft\Graph\Beta\Generated\DataPolicyOperations\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/dataPolicyOperations/$count{?%24search,%24filter}");
