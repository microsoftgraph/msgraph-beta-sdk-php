...
class DataPolicyOperationItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $dataPolicyOperationId = null) {
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/datapolicyoperation-get?view=graph-rest-1.0 Find more info here
    */
