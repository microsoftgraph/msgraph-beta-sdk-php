...
class DataPolicyOperationItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/dataPolicyOperations/{dataPolicyOperation%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/datapolicyoperation-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?DataPolicyOperationItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/dataPolicyOperations/{dataPolicyOperation%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
