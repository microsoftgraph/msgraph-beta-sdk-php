...
class HasPayloadLinksPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'payloadIds' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setPayloadIds($val);
            },
        ];
    }
    ...
    */
    public function getPayloadIds(): ?array {
        $val = $this->getBackingStore()->get('payloadIds');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'payloadIds'");
    }
    ...
    */
    public function setPayloadIds(?array $value): void {
        $this->getBackingStore()->set('payloadIds', $value);
    }
