...
class WindowsDefenderApplicationControlSupplementalPolicyAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $windowsDefenderApplicationControlSupplementalPolicyAssignmentId key: id of windowsDefenderApplicationControlSupplementalPolicyAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsDefenderApplicationControlSupplementalPolicyAssignmentId = null) {
        ...
        $urlTplParams['windowsDefenderApplicationControlSupplementalPolicyAssignmentId'] = $windowsDefenderApplicationControlSupplementalPolicyAssignmentId;
