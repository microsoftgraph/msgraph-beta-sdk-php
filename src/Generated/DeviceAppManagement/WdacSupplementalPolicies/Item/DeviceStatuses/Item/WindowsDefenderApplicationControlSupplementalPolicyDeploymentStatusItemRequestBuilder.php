...
class WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $windowsDefenderApplicationControlSupplementalPolicyDeploymentStatusId key: id of windowsDefenderApplicationControlSupplementalPolicyDeploymentStatus
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsDefenderApplicationControlSupplementalPolicyDeploymentStatusId = null) {
        ...
        $urlTplParams['windowsDefenderApplicationControlSupplementalPolicyDeploymentStatusId'] = $windowsDefenderApplicationControlSupplementalPolicyDeploymentStatusId;
