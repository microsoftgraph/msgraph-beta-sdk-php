...
class AssignRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'wdacPolicyAssignments' => function (self $o, ParseNode $n) { $o->setWdacPolicyAssignments($n->getCollectionOfObjectValues(WindowsDefenderApplicationControlSupplementalPolicyAssignment::class)); },
        ];
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeCollectionOfObjectValues('wdacPolicyAssignments', $this->wdacPolicyAssignments);
