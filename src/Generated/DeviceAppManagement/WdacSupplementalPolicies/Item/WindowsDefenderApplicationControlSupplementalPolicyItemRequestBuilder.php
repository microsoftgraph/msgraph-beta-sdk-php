...
use Microsoft\Graph\Beta\Generated\DeviceAppManagement\WdacSupplementalPolicies\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class WindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): WindowsDefenderApplicationControlSupplementalPolicyAssignmentItemRequestBuilder {
        ...
        return new WindowsDefenderApplicationControlSupplementalPolicyAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $windowsDefenderApplicationControlSupplementalPolicyId key: id of windowsDefenderApplicationControlSupplementalPolicy
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $windowsDefenderApplicationControlSupplementalPolicyId = null) {
    ...
    */
    public function deviceStatusesById(string $id): WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilder {
        ...
        return new WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
