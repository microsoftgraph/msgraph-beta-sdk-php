...
class WindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsDefenderApplicationControlSupplementalPolicyId = null) {
        ...
        $urlTplParams['windowsDefenderApplicationControlSupplementalPolicyId'] = $windowsDefenderApplicationControlSupplementalPolicyId;
