...
class RevokeLicensesRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return RevokeLicensesRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RevokeLicensesRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'revokeUntrackedLicenses' => function (self $o, ParseNode $n) { $o->setRevokeUntrackedLicenses($n->getBooleanValue()); },
        ];
    }
