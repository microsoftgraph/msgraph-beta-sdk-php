...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: getLicensesForAppWithBundleIdRequestBuilderGetRequestConfiguration
*/
class GetLicensesForAppWithBundleIdRequestBuilderGetRequestCo_7263a0b2 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetLicensesForAppWithBundleIdRequestBuilderGetRequestCo_7263a0b2 and sets the default values.
