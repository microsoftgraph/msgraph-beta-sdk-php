...
use Microsoft\Graph\Beta\Generated\DeviceAppManagement\DeviceAppManagementTasks\Item\MicrosoftGraphUpdateStatus\UpdateStatusRequestBuilder;
...
class DeviceAppManagementTaskItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphUpdateStatus(): UpdateStatusRequestBuilder {
    ...
    */
     ...
     * @param string|null $deviceAppManagementTaskId key: id of deviceAppManagementTask
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $deviceAppManagementTaskId = null) {
