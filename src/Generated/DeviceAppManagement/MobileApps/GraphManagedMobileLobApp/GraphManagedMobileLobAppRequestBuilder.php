...
namespace Microsoft\\Graph\\Beta\\Generated\DeviceAppManagement\MobileApps\GraphManagedMobileLobApp;

use Exception;
use Http\Promise\Promise;
use Microsoft\\Graph\\Beta\\Generated\DeviceAppManagement\MobileApps\GraphManagedMobileLobApp\Count\CountRequestBuilder;
...
class GraphManagedMobileLobAppRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceAppManagement/mobileApps/graph.managedMobileLobApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
