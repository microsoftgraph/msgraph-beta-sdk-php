...
use Microsoft\Graph\Beta\Generated\DeviceAppManagement\MobileApps\GraphAndroidForWorkApp\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\AndroidForWorkAppCollectionResponse;
...
class GraphAndroidForWorkAppRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceAppManagement/mobileApps/graph.androidForWorkApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<AndroidForWorkAppCollectionResponse|null>
     * @throws Exception
    */
    public function get(?GraphAndroidForWorkAppRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [AndroidForWorkAppCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
