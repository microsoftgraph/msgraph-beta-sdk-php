...
class UpdateRelationshipsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @return UpdateRelationshipsRequestBuilder
    */
    public function withUrl(string $rawUrl): UpdateRelationshipsRequestBuilder {
        return new UpdateRelationshipsRequestBuilder($rawUrl, $this->requestAdapter);
    }
