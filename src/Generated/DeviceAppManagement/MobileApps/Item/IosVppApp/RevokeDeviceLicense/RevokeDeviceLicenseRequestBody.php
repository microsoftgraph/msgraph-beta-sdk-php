...
class RevokeDeviceLicenseRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return RevokeDeviceLicenseRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RevokeDeviceLicenseRequestBody {
