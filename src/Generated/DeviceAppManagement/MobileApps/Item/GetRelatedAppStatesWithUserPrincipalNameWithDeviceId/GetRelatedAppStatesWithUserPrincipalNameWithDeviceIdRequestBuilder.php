...
class GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $deviceId = null, ?string $userPrincipalName = null) {
        $this->urlTemplate = '{+baseurl}/deviceAppManagement/mobileApps/{mobileApp_id}/microsoft.graph.getRelatedAppStates(userPrincipalName=\'{userPrincipalName}\',deviceId=\'{deviceId}\')';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse::class, $responseHandler);
        } catch(Exception $ex) {
