...
class GetTopMobileAppsWithStatusWithCountResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetTopMobileAppsWithStatusWithCountResponse {
