...
class GetTopMobileAppsWithStatusWithCountRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?GetTopMobileAppsWithStatusWithCountRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function get(?GetTopMobileAppsWithStatusWithCountRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(GetTopMobileAppsWithStatusWithCountResponse::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
