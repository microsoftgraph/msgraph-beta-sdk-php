...
namespace Microsoft\Graph\Beta\Generated\DeviceAppManagement\MobileApps\GraphMicrosoftStoreForBusinessApp;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\DeviceAppManagement\MobileApps\GraphMicrosoftStoreForBusinessApp\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\MicrosoftStoreForBusinessAppCollectionResponse;
...
class GraphMicrosoftStoreForBusinessAppRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceAppManagement/mobileApps/graph.microsoftStoreForBusinessApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
     ...
     * @return Promise<MicrosoftStoreForBusinessAppCollectionResponse|null>
     * @throws Exception
    */
    public function get(?GraphMicrosoftStoreForBusinessAppRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [MicrosoftStoreForBusinessAppCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
