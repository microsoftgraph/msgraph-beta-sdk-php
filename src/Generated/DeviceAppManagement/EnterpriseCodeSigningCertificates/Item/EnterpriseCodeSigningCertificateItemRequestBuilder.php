...
*/
class EnterpriseCodeSigningCertificateItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceAppManagement/enterpriseCodeSigningCertificates/{enterpriseCodeSigningCertificate%2Did}');
    ...
    */
    public function toGetRequestInformation(?EnterpriseCodeSigningCertificateItemRequestBuilderGetRe_959b60f6 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceAppManagement/enterpriseCodeSigningCertificates/{enterpriseCodeSigningCertificate%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): EnterpriseCodeSigningCertificateItemRequestBuilder {
        return new EnterpriseCodeSigningCertificateItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
