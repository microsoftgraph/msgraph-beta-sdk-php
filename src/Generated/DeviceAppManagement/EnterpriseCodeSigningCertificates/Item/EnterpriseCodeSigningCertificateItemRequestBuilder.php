...
class EnterpriseCodeSigningCertificateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $enterpriseCodeSigningCertificateId key: id of enterpriseCodeSigningCertificate
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $enterpriseCodeSigningCertificateId = null) {
        ...
        $urlTplParams['enterpriseCodeSigningCertificateId'] = $enterpriseCodeSigningCertificateId;
