...
use Microsoft\Graph\Beta\Generated\DeviceAppManagement\MicrosoftGraphSyncMicrosoftStoreForBusinessApps\MicrosoftGraphSyncMicrosoftStoreForBusinessAppsRequestBuilder;
...
class DeviceAppManagementRequestBuilder 
{
    ...
    */
    public function deviceAppManagementTasksById(string $id): DeviceAppManagementTaskItemRequestBuilder {
        ...
        return new DeviceAppManagementTaskItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function enterpriseCodeSigningCertificatesById(string $id): EnterpriseCodeSigningCertificateItemRequestBuilder {
        ...
        return new EnterpriseCodeSigningCertificateItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function iosLobAppProvisioningConfigurationsById(string $id): IosLobAppProvisioningConfigurationItemRequestBuilder {
        ...
        return new IosLobAppProvisioningConfigurationItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function managedEBookCategoriesById(string $id): ManagedEBookCategoryItemRequestBuilder {
        ...
        return new ManagedEBookCategoryItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function policySetsById(string $id): PolicySetItemRequestBuilder {
        ...
        return new PolicySetItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function wdacSupplementalPoliciesById(string $id): WindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilder {
        ...
        return new WindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function windowsInformationProtectionWipeActionsById(string $id): WindowsInformationProtectionWipeActionItemRequestBuilder {
        ...
        return new WindowsInformationProtectionWipeActionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function windowsManagedAppProtectionsById(string $id): WindowsManagedAppProtectionItemRequestBuilder {
        ...
        return new WindowsManagedAppProtectionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
