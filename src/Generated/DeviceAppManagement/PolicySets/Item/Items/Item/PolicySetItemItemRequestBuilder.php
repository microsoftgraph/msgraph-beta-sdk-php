...
class PolicySetItemItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $policySetItemId key: id of policySetItem
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $policySetItemId = null) {
        ...
        $urlTplParams['policySetItemId'] = $policySetItemId;
