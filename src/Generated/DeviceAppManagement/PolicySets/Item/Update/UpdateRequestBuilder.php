...
class UpdateRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceAppManagement/policySets/{policySet%2Did}/update');
     ...
     * @return Promise
    */
    public function post(UpdatePostRequestBody $body, ?UpdateRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(UpdatePostRequestBody $body, ?UpdateRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
