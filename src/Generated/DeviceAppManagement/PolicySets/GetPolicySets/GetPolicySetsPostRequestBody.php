...
class GetPolicySetsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetPolicySetsPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'policySetIds' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setPolicySetIds($val);
            },
        ];
    }
    ...
    */
    public function getPolicySetIds(): ?array {
        $val = $this->getBackingStore()->get('policySetIds');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'policySetIds'");
    }
    ...
    */
    public function setPolicySetIds(?array $value): void {
        $this->getBackingStore()->set('policySetIds', $value);
    }
