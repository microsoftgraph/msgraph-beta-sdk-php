...
class ManagedDeviceMobileAppConfigurationAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedDeviceMobileAppConfigurationAssignmentId key: id of managedDeviceMobileAppConfigurationAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedDeviceMobileAppConfigurationAssignmentId = null) {
        ...
        $urlTplParams['managedDeviceMobileAppConfigurationAssignmentId'] = $managedDeviceMobileAppConfigurationAssignmentId;
