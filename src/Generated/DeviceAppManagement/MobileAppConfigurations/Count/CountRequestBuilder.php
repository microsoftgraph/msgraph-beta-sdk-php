...
namespace Microsoft\Graph\Beta\Generated\DeviceAppManagement\MobileAppConfigurations\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/deviceAppManagement/mobileAppConfigurations/$count{?%24search,%24filter}");
