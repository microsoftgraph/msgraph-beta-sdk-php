...
class WindowsInformationProtectionWipeActionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $windowsInformationProtectionWipeActionId key: id of windowsInformationProtectionWipeAction
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $windowsInformationProtectionWipeActionId = null) {
        ...
        $urlTplParams['windowsInformationProtectionWipeActionId'] = $windowsInformationProtectionWipeActionId;
