...
*/
class MobileAppCatalogPackageItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
     ...
     * @param MobileAppCatalogPackageItemRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<MobileAppCatalogPackage|null>
     * @throws Exception
    */
    public function get(?MobileAppCatalogPackageItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?MobileAppCatalogPackageItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/deviceAppManagement/mobileAppCatalogPackages/{mobileAppCatalogPackage%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): MobileAppCatalogPackageItemRequestBuilder {
        return new MobileAppCatalogPackageItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
