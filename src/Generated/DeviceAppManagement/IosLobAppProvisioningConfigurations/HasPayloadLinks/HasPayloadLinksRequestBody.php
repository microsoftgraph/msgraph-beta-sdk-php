...
class HasPayloadLinksRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return HasPayloadLinksRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): HasPayloadLinksRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'payloadIds' => function (self $o, ParseNode $n) { $o->setPayloadIds($n->getCollectionOfPrimitiveValues()); },
        ];
    }
