...
class IosLobAppProvisioningConfigurationAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $iosLobAppProvisioningConfigurationAssignmentId key: id of iosLobAppProvisioningConfigurationAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $iosLobAppProvisioningConfigurationAssignmentId = null) {
        ...
        $urlTplParams['iosLobAppProvisioningConfigurationAssignmentId'] = $iosLobAppProvisioningConfigurationAssignmentId;
