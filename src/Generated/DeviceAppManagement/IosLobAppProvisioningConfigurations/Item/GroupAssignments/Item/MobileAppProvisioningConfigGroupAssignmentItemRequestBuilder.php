...
class MobileAppProvisioningConfigGroupAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $mobileAppProvisioningConfigGroupAssignmentId key: id of mobileAppProvisioningConfigGroupAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $mobileAppProvisioningConfigGroupAssignmentId = null) {
        ...
        $urlTplParams['mobileAppProvisioningConfigGroupAssignmentId'] = $mobileAppProvisioningConfigGroupAssignmentId;
