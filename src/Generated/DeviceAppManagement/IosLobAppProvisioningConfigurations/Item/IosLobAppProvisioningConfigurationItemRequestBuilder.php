...
use Microsoft\Graph\Beta\Generated\DeviceAppManagement\IosLobAppProvisioningConfigurations\Item\MicrosoftGraphAssign\AssignRequestBuilder;
...
class IosLobAppProvisioningConfigurationItemRequestBuilder 
{
    ...
    */
    public function assignmentsById(string $id): IosLobAppProvisioningConfigurationAssignmentItemRequestBuilder {
        ...
        return new IosLobAppProvisioningConfigurationAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $iosLobAppProvisioningConfigurationId key: id of iosLobAppProvisioningConfiguration
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $iosLobAppProvisioningConfigurationId = null) {
    ...
    */
    public function groupAssignmentsById(string $id): MobileAppProvisioningConfigGroupAssignmentItemRequestBuilder {
        ...
        return new MobileAppProvisioningConfigGroupAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
