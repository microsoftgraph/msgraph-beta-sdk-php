...
class ManagedDeviceMobileAppConfigurationUserStatusItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $managedDeviceMobileAppConfigurationUserStatusId key: id of managedDeviceMobileAppConfigurationUserStatus
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $managedDeviceMobileAppConfigurationUserStatusId = null) {
        ...
        $urlTplParams['managedDeviceMobileAppConfigurationUserStatusId'] = $managedDeviceMobileAppConfigurationUserStatusId;
