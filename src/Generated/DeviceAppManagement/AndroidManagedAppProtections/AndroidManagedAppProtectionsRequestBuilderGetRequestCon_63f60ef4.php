...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: androidManagedAppProtectionsRequestBuilderGetRequestConfiguration
*/
class AndroidManagedAppProtectionsRequestBuilderGetRequestCon_63f60ef4 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AndroidManagedAppProtectionsRequestBuilderGetRequestCon_63f60ef4 and sets the default values.
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): AndroidManagedAppProtectionsRequestBuilderGetQueryParameters {
