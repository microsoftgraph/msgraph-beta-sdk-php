...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: AndroidManagedAppProtectionItemRequestBuilderGetRequestConfiguration
*/
class AndroidManagedAppProtectionItemRequestBuilderGetRequest_dcae54fc extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AndroidManagedAppProtectionItemRequestBuilderGetRequest_dcae54fc and sets the default values.
