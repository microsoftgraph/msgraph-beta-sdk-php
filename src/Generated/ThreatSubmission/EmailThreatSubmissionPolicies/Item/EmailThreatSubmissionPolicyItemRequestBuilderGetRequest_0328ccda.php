...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: EmailThreatSubmissionPolicyItemRequestBuilderGetRequestConfiguration
*/
class EmailThreatSubmissionPolicyItemRequestBuilderGetRequest_0328ccda extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EmailThreatSubmissionPolicyItemRequestBuilderGetRequest_0328ccda and sets the default values.
