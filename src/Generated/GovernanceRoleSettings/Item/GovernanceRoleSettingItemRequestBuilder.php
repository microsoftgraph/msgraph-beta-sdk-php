...
class GovernanceRoleSettingItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $governanceRoleSettingId key: id of governanceRoleSetting
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $governanceRoleSettingId = null) {
        $this->urlTemplate = '{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['governanceRoleSettingId'] = $governanceRoleSettingId;
