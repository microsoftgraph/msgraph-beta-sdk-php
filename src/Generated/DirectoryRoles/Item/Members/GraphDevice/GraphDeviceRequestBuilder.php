...
namespace Microsoft\Graph\Beta\Generated\DirectoryRoles\Item\Members\GraphDevice;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\DirectoryRoles\Item\Members\GraphDevice\Count\CountRequestBuilder;
...
class GraphDeviceRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/directoryRoles/{directoryRole%2Did}/members/graph.device{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
