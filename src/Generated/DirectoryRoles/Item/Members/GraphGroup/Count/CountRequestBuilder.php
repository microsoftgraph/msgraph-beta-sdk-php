...
namespace Microsoft\Graph\Beta\Generated\DirectoryRoles\Item\Members\GraphGroup\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/graph.group/$count{?%24search,%24filter}");
