...
class RefRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/directoryRoles/{directoryRole%2Did}/members/{directoryObject%2Did}/$ref');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/directoryrole-delete-member?view=graph-rest-beta Find more info here
    */
