...
class TeamworkTagItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teams/{team%2Did}/tags/{teamworkTag%2Did}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/teamworktag-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/teamworktag-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<TeamworkTag|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/teamworktag-update?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?TeamworkTagItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/tags/{teamworkTag%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
