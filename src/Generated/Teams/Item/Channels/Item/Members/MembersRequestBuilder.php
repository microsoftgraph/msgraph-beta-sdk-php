...
namespace Microsoft\Graph\Beta\Generated\Teams\Item\Channels\Item\Members;
...
use Microsoft\Graph\Beta\Generated\Teams\Item\Channels\Item\Members\Item\ConversationMemberItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Teams\Item\Channels\Item\Members\Remove\RemoveRequestBuilder;
...
class MembersRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/channel-list-members?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/channel-post-members?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?MembersRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ConversationMember $body, ?MembersRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/members';
        $requestInfo->pathParameters = $this->pathParameters;
