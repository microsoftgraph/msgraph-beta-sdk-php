...
use Microsoft\Graph\Beta\Generated\Teams\Item\Channels\Item\Planner\Plans\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Teams\Item\Channels\Item\Planner\Plans\Delta\DeltaRequestBuilder;
use Microsoft\Graph\Beta\Generated\Teams\Item\Channels\Item\Planner\Plans\Item\PlannerPlanItemRequestBuilder;
...
class PlansRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/teamschannelplanner-list-plans?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?PlansRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/planner/plans{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(PlannerPlan $body, ?PlansRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/planner/plans';
        $requestInfo->pathParameters = $this->pathParameters;
