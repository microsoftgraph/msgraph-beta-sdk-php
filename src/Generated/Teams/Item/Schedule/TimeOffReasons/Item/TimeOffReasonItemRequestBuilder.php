...
class TimeOffReasonItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teams/{team%2Did}/schedule/timeOffReasons/{timeOffReason%2Did}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/timeoffreason-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/timeoffreason-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<TimeOffReason|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/timeoffreason-put?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?TimeOffReasonItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/schedule/timeOffReasons/{timeOffReason%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
