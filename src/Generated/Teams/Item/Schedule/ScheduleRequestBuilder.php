...
class ScheduleRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function shiftsRoleDefinitions(): ShiftsRoleDefinitionsRequestBuilder {
        return new ShiftsRoleDefinitionsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teams/{team%2Did}/schedule');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/schedule-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<Schedule|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/team-put-schedule?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?ScheduleRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/teams/{team%2Did}/schedule{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
