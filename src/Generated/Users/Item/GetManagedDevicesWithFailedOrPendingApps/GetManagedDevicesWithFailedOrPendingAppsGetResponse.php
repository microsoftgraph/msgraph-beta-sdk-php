...
class GetManagedDevicesWithFailedOrPendingAppsGetResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetManagedDevicesWithFailedOrPendingAppsGetResponse {
    ...
    */
    public function getValue(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, ManagedDeviceSummarizedAppState::class);
            /** @var array<ManagedDeviceSummarizedAppState>|null $val */
            return $val;
        }
