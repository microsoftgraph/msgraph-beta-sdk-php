...
namespace Microsoft\Graph\Beta\Generated\Users\Item\ContactFolders\Item\ChildFolders\MicrosoftGraphDelta;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([ContactFolder::class, 'createFromDiscriminatorValue'])),
        ]);
    }
