...
namespace Microsoft\Graph\Beta\Generated\Users\Item\ContactFolders;
...
class ContactFoldersRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?array $select = null, ?int $skip = null, ?int $top = null): ContactFoldersRequestBuilderGetQueryParameters {
        return new ContactFoldersRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $select, $skip, $top);
    }
