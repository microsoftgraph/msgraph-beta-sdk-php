...
namespace Microsoft\Graph\Beta\Generated\Users\Item\CalendarGroups;
...
class CalendarGroupsRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): CalendarGroupsRequestBuilderGetQueryParameters {
        return new CalendarGroupsRequestBuilderGetQueryParameters($count, $filter, $orderby, $search, $select, $skip, $top);
    }
