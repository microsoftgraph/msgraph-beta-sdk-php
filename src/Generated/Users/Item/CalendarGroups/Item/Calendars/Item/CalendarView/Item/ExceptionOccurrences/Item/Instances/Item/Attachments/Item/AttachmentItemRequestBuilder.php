...
class AttachmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $attachmentId key: id of attachment
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $attachmentId = null) {
