...
namespace Microsoft\Graph\Beta\Generated\Users\Item\CalendarGroups\Item\Calendars\Item\Events\Item\ExceptionOccurrences\Item\Instances\MicrosoftGraphDelta;
...
class MicrosoftGraphDeltaRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/microsoft.graph.delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}';
     ...
     * @param MicrosoftGraphDeltaRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/event-delta?view=graph-rest-1.0 Find more info here
    */
    public function get(?MicrosoftGraphDeltaRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?MicrosoftGraphDeltaRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
