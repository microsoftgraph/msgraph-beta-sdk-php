...
namespace Microsoft\Graph\Beta\Generated\Users\Item\CalendarGroups\Item\Calendars\Item\Events\Item\ExceptionOccurrences\Item\Instances\Item\SnoozeReminder;
...
class SnoozeReminderPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getNewReminderTime(): ?DateTimeTimeZone {
        $val = $this->getBackingStore()->get('newReminderTime');
        if (is_null($val) || $val instanceof DateTimeTimeZone) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'newReminderTime'");
    }
