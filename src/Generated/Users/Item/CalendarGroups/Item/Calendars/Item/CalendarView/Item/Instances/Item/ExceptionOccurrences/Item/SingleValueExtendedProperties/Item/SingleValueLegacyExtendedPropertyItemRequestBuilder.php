...
class SingleValueLegacyExtendedPropertyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $singleValueLegacyExtendedPropertyId key: id of singleValueLegacyExtendedProperty
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $singleValueLegacyExtendedPropertyId = null) {
        ...
        $urlTplParams['singleValueLegacyExtendedPropertyId'] = $singleValueLegacyExtendedPropertyId;
