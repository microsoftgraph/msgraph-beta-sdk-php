...
namespace Microsoft\Graph\Beta\Generated\Users\Item\DirectReports\GraphUser\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/directReports/graph.user/$count{?%24search,%24filter}');
