...
namespace Microsoft\Graph\Beta\Generated\Users\Item\Calendar\CalendarView\Item\ExceptionOccurrences\Item\Instances\Item\Attachments;
...
use Microsoft\Graph\Beta\Generated\Users\Item\Calendar\CalendarView\Item\ExceptionOccurrences\Item\Instances\Item\Attachments\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Users\Item\Calendar\CalendarView\Item\ExceptionOccurrences\Item\Instances\Item\Attachments\CreateUploadSession\CreateUploadSessionRequestBuilder;
...
class AttachmentsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/attachments{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}');
    ...
    */
    public function toPostRequestInformation(Attachment $body, ?AttachmentsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/attachments';
        $requestInfo->pathParameters = $this->pathParameters;
