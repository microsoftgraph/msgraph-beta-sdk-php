...
class SingleValueLegacyExtendedPropertyItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/calendar/calendarView/{event_id}/exceptionOccurrences/{event_id1}/instances/{event_id2}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty_id}{?select,expand}';
