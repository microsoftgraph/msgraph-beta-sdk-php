...
class ExceptionOccurrencesRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/calendar/calendarView/{event_id}/instances/{event_id1}/exceptionOccurrences{?top,skip,filter,count,orderby,select,expand}';
