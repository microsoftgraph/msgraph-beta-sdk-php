...
use Microsoft\Graph\Beta\Generated\Users\Item\Calendars\Item\Events\Item\Instances\Item\ExceptionOccurrences\Item\Attachments\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Users\Item\Calendars\Item\Events\Item\Instances\Item\ExceptionOccurrences\Item\Attachments\CreateUploadSession\CreateUploadSessionRequestBuilder;
...
class AttachmentsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/attachments{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}');
    ...
    */
    public function toPostRequestInformation(Attachment $body, ?AttachmentsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/attachments';
        $requestInfo->pathParameters = $this->pathParameters;
