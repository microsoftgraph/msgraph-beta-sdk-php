...
*/
class AssignAndActivateRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/authentication/hardwareOathMethods/assignAndActivate');
    ...
    */
    public function toPostRequestInformation(AssignAndActivatePostRequestBody $body, ?AssignAndActivateRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return AssignAndActivateRequestBuilder
    */
    public function withUrl(string $rawUrl): AssignAndActivateRequestBuilder {
        return new AssignAndActivateRequestBuilder($rawUrl, $this->requestAdapter);
    }
