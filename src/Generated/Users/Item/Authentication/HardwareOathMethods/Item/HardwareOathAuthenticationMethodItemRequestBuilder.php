...
use Microsoft\Graph\Beta\Generated\Users\Item\Authentication\HardwareOathMethods\Item\Activate\ActivateRequestBuilder;
use Microsoft\Graph\Beta\Generated\Users\Item\Authentication\HardwareOathMethods\Item\Deactivate\DeactivateRequestBuilder;
use Microsoft\Graph\Beta\Generated\Users\Item\Authentication\HardwareOathMethods\Item\Device\DeviceRequestBuilder;
...
*/
class HardwareOathAuthenticationMethodItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function toDeleteRequestInformation(?HardwareOathAuthenticationMethodItemRequestBuilderDelet_56dc3796 $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/authentication/hardwareOathMethods/{hardwareOathAuthenticationMethod%2Did}';
    ...
    */
    public function toGetRequestInformation(?HardwareOathAuthenticationMethodItemRequestBuilderGetRe_15937e73 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/authentication/hardwareOathMethods/{hardwareOathAuthenticationMethod%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): HardwareOathAuthenticationMethodItemRequestBuilder {
        return new HardwareOathAuthenticationMethodItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
