...
class SoftwareOathAuthenticationMethodItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $softwareOathAuthenticationMethodId key: id of softwareOathAuthenticationMethod
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $softwareOathAuthenticationMethodId = null) {
        ...
        $urlTplParams['softwareOathAuthenticationMethodId'] = $softwareOathAuthenticationMethodId;
