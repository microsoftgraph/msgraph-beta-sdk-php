...
class TemporaryQRCodeRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/authentication/qrCodePinMethod/temporaryQRCode');
    ...
    */
    public function toGetRequestInformation(?TemporaryQRCodeRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/authentication/qrCodePinMethod/temporaryQRCode{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
