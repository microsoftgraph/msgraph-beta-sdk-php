...
*/
class SignInPreferencesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/authentication/signInPreferences{?%24expand,%24select}');
    ...
    */
    public function get(?SignInPreferencesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [SignInPreferences::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toGetRequestInformation(?SignInPreferencesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
     ...
     * @return SignInPreferencesRequestBuilder
    */
    public function withUrl(string $rawUrl): SignInPreferencesRequestBuilder {
        return new SignInPreferencesRequestBuilder($rawUrl, $this->requestAdapter);
    }
