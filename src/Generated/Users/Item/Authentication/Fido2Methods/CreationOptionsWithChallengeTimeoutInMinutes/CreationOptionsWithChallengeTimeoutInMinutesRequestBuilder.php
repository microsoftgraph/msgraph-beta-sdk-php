...
use Microsoft\\Graph\\Beta\\Generated\Models\WebauthnCredentialCreationOptions;
...
*/
class CreationOptionsWithChallengeTimeoutInMinutesRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new CreationOptionsWithChallengeTimeoutInMinutesRequestBuilder and sets the default values.
     * @param array<string, mixed>|string $pathParametersOrRawUrl Path parameters for the request or a String representing the raw URL.
     * @param RequestAdapter $requestAdapter The request adapter to use to execute the requests.
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/authentication/fido2Methods/creationOptions(challengeTimeoutInMinutes=@challengeTimeoutInMinutes){?challengeTimeoutInMinutes*}');
    ...
    */
    public function get(?CreationOptionsWithChallengeTimeoutInMinutesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [WebauthnCredentialCreationOptions::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
     ...
     * @return CreationOptionsWithChallengeTimeoutInMinutesRequestBuilder
    */
    public function withUrl(string $rawUrl): CreationOptionsWithChallengeTimeoutInMinutesRequestBuilder {
        return new CreationOptionsWithChallengeTimeoutInMinutesRequestBuilder($rawUrl, $this->requestAdapter);
    }
