...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: Fido2AuthenticationMethodItemRequestBuilderGetRequestConfiguration
*/
class Fido2AuthenticationMethodItemRequestBuilderGetRequestCo_b29db3ff extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Fido2AuthenticationMethodItemRequestBuilderGetRequestCo_b29db3ff and sets the default values.
