...
class LongRunningOperationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $longRunningOperationId key: id of longRunningOperation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $longRunningOperationId = null) {
        ...
        $urlTplParams['longRunningOperationId'] = $longRunningOperationId;
