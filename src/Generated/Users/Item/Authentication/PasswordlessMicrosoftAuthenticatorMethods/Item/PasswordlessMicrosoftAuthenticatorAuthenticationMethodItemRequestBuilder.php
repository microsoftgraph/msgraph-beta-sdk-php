...
class PasswordlessMicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $passwordlessMicrosoftAuthenticatorAuthenticationMethodId key: id of passwordlessMicrosoftAuthenticatorAuthenticationMethod
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $passwordlessMicrosoftAuthenticatorAuthenticationMethodId = null) {
        ...
        $urlTplParams['passwordlessMicrosoftAuthenticatorAuthenticationMethodId'] = $passwordlessMicrosoftAuthenticatorAuthenticationMethodId;
