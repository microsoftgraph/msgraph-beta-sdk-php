...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: externalAuthenticationMethodsRequestBuilderGetRequestConfiguration
*/
class ExternalAuthenticationMethodsRequestBuilderGetRequestCo_5f6e9dfc extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ExternalAuthenticationMethodsRequestBuilderGetRequestCo_5f6e9dfc and sets the default values.
