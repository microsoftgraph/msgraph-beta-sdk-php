...
class ResetPasswordRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ResetPasswordRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'requireChangeOnNextSignIn' => function (self $o, ParseNode $n) { $o->setRequireChangeOnNextSignIn($n->getBooleanValue()); },
        ];
    }
