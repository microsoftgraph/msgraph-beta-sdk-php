...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: EmailAuthenticationMethodItemRequestBuilderGetRequestConfiguration
*/
class EmailAuthenticationMethodItemRequestBuilderGetRequestCo_6d9021a4 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EmailAuthenticationMethodItemRequestBuilderGetRequestCo_6d9021a4 and sets the default values.
