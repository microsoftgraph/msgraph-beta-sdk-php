...
class ShiftPreferencesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/shiftpreferences-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<ShiftPreferences|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/shiftpreferences-put?view=graph-rest-beta Find more info here
    */
