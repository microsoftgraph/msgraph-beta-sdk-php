...
namespace Microsoft\Graph\Beta\Generated\Users\Item\PendingAccessReviewInstances\MicrosoftGraphFilterByCurrentUserWithOn;
...
class MicrosoftGraphFilterByCurrentUserWithOnRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $on = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/microsoft.graph.filterByCurrentUser(on=\'{on}\'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}';
