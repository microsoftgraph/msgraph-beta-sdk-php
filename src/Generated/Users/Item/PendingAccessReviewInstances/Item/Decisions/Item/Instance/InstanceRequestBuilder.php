...
class InstanceRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.pendingAccessReviewInstances.item.decisions.item.instance.contactedReviewers.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.pendingAccessReviewInstances.item.decisions.item.instance.stages.item collection
     * @param string $id Unique identifier of the item
