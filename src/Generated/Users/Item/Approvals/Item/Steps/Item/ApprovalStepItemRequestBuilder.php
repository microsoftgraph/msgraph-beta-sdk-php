...
class ApprovalStepItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/approvals/{approval%2Did}/steps/{approvalStep%2Did}{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?ApprovalStepItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/approvals/{approval%2Did}/steps/{approvalStep%2Did}';
