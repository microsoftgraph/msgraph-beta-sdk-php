...
class DeviceEnrollmentConfigurationItemRequestBuilder 
{
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.deviceEnrollmentConfigurations.item.assignments.item collection
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration_id}{?select,expand}';
