...
class CreateEnrollmentNotificationConfigurationPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getDeviceEnrollmentNotificationConfigurations(): ?array {
        $val = $this->getBackingStore()->get('deviceEnrollmentNotificationConfigurations');
        ...
        throw new \UnexpectedValueException("Invalid type found in backing store for 'deviceEnrollmentNotificationConfigurations'");
    }
