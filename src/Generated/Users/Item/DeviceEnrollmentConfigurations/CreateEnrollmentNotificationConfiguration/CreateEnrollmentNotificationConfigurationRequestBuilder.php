...
*/
class CreateEnrollmentNotificationConfigurationRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations/createEnrollmentNotificationConfiguration');
    ...
    */
     ...
     * @return CreateEnrollmentNotificationConfigurationRequestBuilder
    */
    public function withUrl(string $rawUrl): CreateEnrollmentNotificationConfigurationRequestBuilder {
        return new CreateEnrollmentNotificationConfigurationRequestBuilder($rawUrl, $this->requestAdapter);
    }
