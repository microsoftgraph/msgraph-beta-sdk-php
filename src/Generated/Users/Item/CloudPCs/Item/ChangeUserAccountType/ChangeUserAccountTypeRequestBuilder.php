...
*/
class ChangeUserAccountTypeRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}/changeUserAccountType');
     ...
     * @return Promise
     * @link https://learn.microsoft.com/graph/api/cloudpc-changeuseraccounttype?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function toPostRequestInformation(ChangeUserAccountTypePostRequestBody $body, ?ChangeUserAccountTypeRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return ChangeUserAccountTypeRequestBuilder
    */
    public function withUrl(string $rawUrl): ChangeUserAccountTypeRequestBuilder {
        return new ChangeUserAccountTypeRequestBuilder($rawUrl, $this->requestAdapter);
    }
