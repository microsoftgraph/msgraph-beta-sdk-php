...
*/
class RetrieveCloudPCRemoteActionResultsRequestBuilderGetQueryParameters 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RetrieveCloudPCRemoteActionResultsRequestBuilderGetQueryParameters and sets the default values.
