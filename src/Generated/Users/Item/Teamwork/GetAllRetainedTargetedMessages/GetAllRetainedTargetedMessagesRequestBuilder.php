...
*/
class GetAllRetainedTargetedMessagesRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/teamwork/getAllRetainedTargetedMessages(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function get(?GetAllRetainedTargetedMessagesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [GetAllRetainedTargetedMessagesGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
     ...
     * @return GetAllRetainedTargetedMessagesRequestBuilder
    */
    public function withUrl(string $rawUrl): GetAllRetainedTargetedMessagesRequestBuilder {
        return new GetAllRetainedTargetedMessagesRequestBuilder($rawUrl, $this->requestAdapter);
    }
