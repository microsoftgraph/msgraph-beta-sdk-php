...
use Microsoft\Graph\Beta\Generated\Models\TeamworkSectionCollectionResponse;
use Microsoft\Graph\Beta\Generated\Users\Item\Teamwork\Sections\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Users\Item\Teamwork\Sections\Item\TeamworkSectionItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Users\Item\Teamwork\Sections\Reorder\ReorderRequestBuilder;
...
class SectionsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the sections property of the microsoft.graph.userTeamwork entity.
     * @param string $teamworkSectionId The unique identifier of teamworkSection
     * @return TeamworkSectionItemRequestBuilder
    */
    public function byTeamworkSectionId(string $teamworkSectionId): TeamworkSectionItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['teamworkSection%2Did'] = $teamworkSectionId;
        return new TeamworkSectionItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/teamwork/sections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function get(?SectionsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [TeamworkSectionCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(TeamworkSection $body, ?SectionsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
