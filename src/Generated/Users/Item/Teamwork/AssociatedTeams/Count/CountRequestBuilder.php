...
namespace Microsoft\Graph\Beta\Generated\Users\Item\Teamwork\AssociatedTeams\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/users/{user%2Did}/teamwork/associatedTeams/$count{?%24search,%24filter}");
