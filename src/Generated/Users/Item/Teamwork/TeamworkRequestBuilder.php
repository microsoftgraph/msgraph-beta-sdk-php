...
namespace Microsoft\Graph\Beta\Generated\Users\Item\Teamwork;
...
use Microsoft\Graph\Beta\Generated\Users\Item\Teamwork\AssociatedTeams\Item\AssociatedTeamInfoItemRequestBuilder;
...
class TeamworkRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.teamwork.associatedTeams.item collection
    ...
    */
    public function get(?TeamworkRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [UserTeamwork::class, 'createFromDiscriminatorValue'], $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.teamwork.installedApps.item collection
     * @param string $id Unique identifier of the item
