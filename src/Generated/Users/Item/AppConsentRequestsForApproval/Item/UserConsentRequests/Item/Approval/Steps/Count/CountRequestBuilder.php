...
class CountRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/appConsentRequestsForApproval/{appConsentRequest_id}/userConsentRequests/{userConsentRequest_id}/approval/steps/$count';
