...
namespace Microsoft\Graph\Beta\Generated\Users\Item\AppConsentRequestsForApproval\MicrosoftGraphFilterByCurrentUserWithOn;
...
class FilterByCurrentUserWithOnRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $on = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/appConsentRequestsForApproval/microsoft.graph.filterByCurrentUser(on=\'{on}\'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}';
