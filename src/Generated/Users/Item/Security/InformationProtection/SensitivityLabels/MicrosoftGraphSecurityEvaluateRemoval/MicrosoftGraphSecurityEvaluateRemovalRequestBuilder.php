...
*/
class MicrosoftGraphSecurityEvaluateRemovalRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/microsoft.graph.security.evaluateRemoval');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/security-sensitivitylabel-evaluateremoval?view=graph-rest-1.0 Find more info here
    */
    ...
    */
     ...
     * @return MicrosoftGraphSecurityEvaluateRemovalRequestBuilder
    */
    public function withUrl(string $rawUrl): MicrosoftGraphSecurityEvaluateRemovalRequestBuilder {
        return new MicrosoftGraphSecurityEvaluateRemovalRequestBuilder($rawUrl, $this->requestAdapter);
    }
