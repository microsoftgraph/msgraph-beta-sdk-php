...
namespace Microsoft\Graph\Beta\Generated\Users\Item\DataSecurityAndGovernance\Activities;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ActivitiesContainer;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Users\Item\DataSecurityAndGovernance\Activities\ContentActivities\ContentActivitiesRequestBuilder;
...
class ActivitiesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/dataSecurityAndGovernance/activities');
    ...
    */
    public function toGetRequestInformation(?ActivitiesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/dataSecurityAndGovernance/activities{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
