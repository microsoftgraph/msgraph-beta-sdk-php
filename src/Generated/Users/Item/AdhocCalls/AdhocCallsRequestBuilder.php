...
use Microsoft\Graph\Beta\Generated\Users\Item\AdhocCalls\GetAllRecordingsuserIdUserIdWithStartDateTimeWithEndDateTime\GetAllRecordingsuserIdUserIdWithStartDateTimeWithEndDat_5a15ee1d;
use Microsoft\Graph\Beta\Generated\Users\Item\AdhocCalls\GetAllTranscriptsuserIdUserIdWithStartDateTimeWithEndDateTime\GetAllTranscriptsuserIdUserIdWithStartDateTimeWithEndDa_d83c3382;
...
class AdhocCallsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?AdhocCallsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/adhocCalls{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(AdhocCall $body, ?AdhocCallsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/adhocCalls';
        $requestInfo->pathParameters = $this->pathParameters;
