...
class AssignedRolesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/employeeexperienceuser-list-assignedroles?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?AssignedRolesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/employeeExperience/assignedRoles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(EngagementRole $body, ?AssignedRolesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/employeeExperience/assignedRoles';
        $requestInfo->pathParameters = $this->pathParameters;
