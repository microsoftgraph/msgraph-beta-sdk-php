...
class PersonItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/people/{person%2Did}{?%24expand,%24select}');
    ...
    */
    public function withUrl(string $rawUrl): PersonItemRequestBuilder {
