...
namespace Microsoft\Graph\Beta\Generated\Users\Item\TransitiveReports\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/users/{user%2Did}/transitiveReports/$count{?%24search,%24filter}");
