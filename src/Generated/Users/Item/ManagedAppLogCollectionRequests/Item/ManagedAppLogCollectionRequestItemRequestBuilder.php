...
class ManagedAppLogCollectionRequestItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/managedAppLogCollectionRequests/{managedAppLogCollectionRequest%2Did}');
    ...
    */
    public function toGetRequestInformation(?ManagedAppLogCollectionRequestItemRequestBuilderGetRequ_fb344b89 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/managedAppLogCollectionRequests/{managedAppLogCollectionRequest%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
