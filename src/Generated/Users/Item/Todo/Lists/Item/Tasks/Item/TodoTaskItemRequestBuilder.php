...
use Microsoft\Graph\Beta\Generated\Users\Item\Todo\Lists\Item\Tasks\Item\Extensions\Item\ExtensionItemRequestBuilder;
...
class TodoTaskItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.todo.lists.item.tasks.item.attachments.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.todo.lists.item.tasks.item.attachmentSessions.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.todo.lists.item.tasks.item.checklistItems.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.todo.lists.item.tasks.item.extensions.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.todo.lists.item.tasks.item.linkedResources.item collection
     * @param string $id Unique identifier of the item
