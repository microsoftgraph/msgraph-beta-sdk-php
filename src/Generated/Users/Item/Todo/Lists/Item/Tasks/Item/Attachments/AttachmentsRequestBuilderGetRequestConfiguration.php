...
class AttachmentsRequestBuilderGetRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?string $filter = null, ?array $orderby = null, ?array $select = null, ?int $skip = null, ?int $top = null): AttachmentsRequestBuilderGetQueryParameters {
        return new AttachmentsRequestBuilderGetQueryParameters($count, $filter, $orderby, $select, $skip, $top);
    }
