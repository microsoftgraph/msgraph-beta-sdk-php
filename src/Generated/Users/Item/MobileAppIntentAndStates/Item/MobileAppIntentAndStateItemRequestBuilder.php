...
class MobileAppIntentAndStateItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/mobileAppIntentAndStates/{mobileAppIntentAndState%2Did}{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?MobileAppIntentAndStateItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/mobileAppIntentAndStates/{mobileAppIntentAndState%2Did}';
    ...
    */
    public function withUrl(string $rawUrl): MobileAppIntentAndStateItemRequestBuilder {
        return new MobileAppIntentAndStateItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
