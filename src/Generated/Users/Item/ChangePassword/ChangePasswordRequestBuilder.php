...
class ChangePasswordRequestBuilder 
{
    ...
    */
     ...
     * @param ChangePasswordPostRequestBody $body 
    ...
    */
    public function createPostRequestInformation(ChangePasswordPostRequestBody $body, ?ChangePasswordRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
