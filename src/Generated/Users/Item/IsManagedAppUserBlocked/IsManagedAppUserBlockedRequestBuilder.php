...
class IsManagedAppUserBlockedRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/microsoft.graph.isManagedAppUserBlocked()';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, IsManagedAppUserBlockedResponse::class, $responseHandler);
        } catch(Exception $ex) {
