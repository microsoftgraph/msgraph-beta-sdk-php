...
namespace Microsoft\Graph\Beta\Generated\Users\Item\MicrosoftGraphGetManagedAppPolicies;
...
class MicrosoftGraphGetManagedAppPoliciesRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * Instantiates a new microsoftGraphGetManagedAppPoliciesRequestBuilderGetQueryParameters.
     ...
     * @return MicrosoftGraphGetManagedAppPoliciesRequestBuilderGetQueryParameters
    */
    public static function addQueryParameters(?bool $count = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): MicrosoftGraphGetManagedAppPoliciesRequestBuilderGetQueryParameters {
        return new MicrosoftGraphGetManagedAppPoliciesRequestBuilderGetQueryParameters($count, $filter, $orderby, $search, $select, $skip, $top);
    }
