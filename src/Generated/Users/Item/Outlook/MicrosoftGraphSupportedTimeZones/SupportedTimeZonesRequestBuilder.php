...
namespace Microsoft\Graph\Beta\Generated\Users\Item\Outlook\MicrosoftGraphSupportedTimeZones;
    ...
    */
    public function get(?SupportedTimeZonesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [SupportedTimeZonesResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
