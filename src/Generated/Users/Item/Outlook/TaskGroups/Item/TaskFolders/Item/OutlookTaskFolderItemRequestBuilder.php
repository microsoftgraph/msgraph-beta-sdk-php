...
class OutlookTaskFolderItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $outlookTaskFolderId = null) {
        ...
        $urlTplParams['outlookTaskFolderId'] = $outlookTaskFolderId;
