...
class OutlookTaskFolderItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $outlookTaskFolderId key: id of outlookTaskFolder
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $outlookTaskFolderId = null) {
    ...
    */
    public function tasksById(string $id): OutlookTaskItemRequestBuilder {
        ...
        return new OutlookTaskItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
