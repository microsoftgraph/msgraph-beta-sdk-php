...
class OutlookTaskGroupItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $outlookTaskGroupId key: id of outlookTaskGroup
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $outlookTaskGroupId = null) {
    ...
    */
    public function taskFoldersById(string $id): OutlookTaskFolderItemRequestBuilder {
        ...
        return new OutlookTaskFolderItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
