...
class OutlookTaskGroupItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/outlook/taskGroups/{outlookTaskGroup%2Did}');
    ...
    */
    public function toGetRequestInformation(?OutlookTaskGroupItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/outlook/taskGroups/{outlookTaskGroup%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): OutlookTaskGroupItemRequestBuilder {
        return new OutlookTaskGroupItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
