...
use Microsoft\Graph\Beta\Generated\Users\Item\Outlook\Tasks\Item\PermanentDelete\PermanentDeleteRequestBuilder;
...
class OutlookTaskItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/outlook/tasks/{outlookTask%2Did}');
    ...
    */
    public function toGetRequestInformation(?OutlookTaskItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/outlook/tasks/{outlookTask%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
