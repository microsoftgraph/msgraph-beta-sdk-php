...
namespace Microsoft\Graph\Beta\Generated\Users\Item\Outlook\Tasks\Item\Attachments;
...
use Microsoft\Graph\Beta\Generated\Users\Item\Outlook\Tasks\Item\Attachments\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Users\Item\Outlook\Tasks\Item\Attachments\CreateUploadSession\CreateUploadSessionRequestBuilder;
...
class AttachmentsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/outlooktask-list-attachments?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?AttachmentsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/outlook/tasks/{outlookTask%2Did}/attachments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(Attachment $body, ?AttachmentsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/outlook/tasks/{outlookTask%2Did}/attachments';
        $requestInfo->pathParameters = $this->pathParameters;
