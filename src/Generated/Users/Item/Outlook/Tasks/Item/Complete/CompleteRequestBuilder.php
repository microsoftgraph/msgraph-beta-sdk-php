...
class CompleteRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/outlook/tasks/{outlookTask%2Did}/complete');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/outlooktask-complete?view=graph-rest-beta Find more info here
    */
