...
class OutlookCategoryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $outlookCategoryId key: id of outlookCategory
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $outlookCategoryId = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/outlook/masterCategories/{outlookCategory%2Did}{?%24select}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['outlookCategoryId'] = $outlookCategoryId;
