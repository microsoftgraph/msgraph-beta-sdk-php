...
class UserItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/user-delete?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/user-get?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @return Promise<User|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/user-update?view=graph-rest-beta Find more info here
    */
