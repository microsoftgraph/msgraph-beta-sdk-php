...
class GetAllMessagesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/chats/getAllMessages(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,model*}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/chats-getallmessages?view=graph-rest-beta Find more info here
    */
