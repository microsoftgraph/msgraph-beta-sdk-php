...
namespace Microsoft\Graph\Beta\Generated\Users\Item\FollowedSites\Add;
...
class AddRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/followedSites/add');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/site-follow?view=graph-rest-beta Find more info here
    */
