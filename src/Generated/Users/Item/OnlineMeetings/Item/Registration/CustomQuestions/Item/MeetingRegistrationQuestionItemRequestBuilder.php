...
class MeetingRegistrationQuestionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $meetingRegistrationQuestionId key: id of meetingRegistrationQuestion
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $meetingRegistrationQuestionId = null) {
        ...
        $urlTplParams['meetingRegistrationQuestionId'] = $meetingRegistrationQuestionId;
