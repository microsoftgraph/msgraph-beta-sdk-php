...
*/
class InvitedByRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/invitedBy{?%24expand,%24select}');
    ...
    */
    public function toGetRequestInformation(?InvitedByRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return InvitedByRequestBuilder
    */
    public function withUrl(string $rawUrl): InvitedByRequestBuilder {
        return new InvitedByRequestBuilder($rawUrl, $this->requestAdapter);
    }
