...
class CommandItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $commandId key: id of command
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $commandId = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/devices/{device%2Did}/commands/{command%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['commandId'] = $commandId;
