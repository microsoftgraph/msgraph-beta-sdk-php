...
namespace Microsoft\Graph\Beta\Generated\Users\Item\Devices\Item\TransitiveMemberOf\MicrosoftGraphUser\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.user/$count{?%24search,%24filter}';
