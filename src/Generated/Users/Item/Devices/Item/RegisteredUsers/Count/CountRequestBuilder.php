...
namespace Microsoft\Graph\Beta\Generated\Users\Item\Devices\Item\RegisteredUsers\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers/$count{?%24search,%24filter}");
