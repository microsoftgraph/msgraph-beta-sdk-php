...
*/
class ItemEmailItemRequestBuilderGetRequestConfiguration 
{
    /**
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): ItemEmailItemRequestBuilderGetQueryParameters {
