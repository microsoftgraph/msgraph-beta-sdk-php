...
class ItemEmailItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $itemEmailId key: id of itemEmail
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $itemEmailId = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/profile/emails/{itemEmail%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['itemEmailId'] = $itemEmailId;
