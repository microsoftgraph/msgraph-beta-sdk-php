...
*/
class EducationalActivityItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/profile/educationalActivities/{educationalActivity%2Did}{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?EducationalActivityItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/profile/educationalActivities/{educationalActivity%2Did}';
    ...
    */
    public function withUrl(string $rawUrl): EducationalActivityItemRequestBuilder {
        return new EducationalActivityItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
