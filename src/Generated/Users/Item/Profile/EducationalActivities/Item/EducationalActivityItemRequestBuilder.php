...
class EducationalActivityItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $educationalActivityId key: id of educationalActivity
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $educationalActivityId = null) {
        ...
        $urlTplParams['educationalActivityId'] = $educationalActivityId;
