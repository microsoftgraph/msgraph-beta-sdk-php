...
class PersonWebsiteItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $personWebsiteId key: id of personWebsite
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $personWebsiteId = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/profile/websites/{personWebsite%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['personWebsiteId'] = $personWebsiteId;
