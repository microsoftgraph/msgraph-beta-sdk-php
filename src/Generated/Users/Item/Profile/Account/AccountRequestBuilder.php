...
class AccountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/profile/account{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function get(?AccountRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [UserAccountInformationCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function post(UserAccountInformation $body, ?AccountRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [UserAccountInformation::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toPostRequestInformation(UserAccountInformation $body, ?AccountRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/profile/account';
        $requestInfo->pathParameters = $this->pathParameters;
