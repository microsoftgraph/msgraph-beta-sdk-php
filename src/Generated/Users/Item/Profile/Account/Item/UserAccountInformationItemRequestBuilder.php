...
class UserAccountInformationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userAccountInformationId key: id of userAccountInformation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userAccountInformationId = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/profile/account/{userAccountInformation%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['userAccountInformationId'] = $userAccountInformationId;
