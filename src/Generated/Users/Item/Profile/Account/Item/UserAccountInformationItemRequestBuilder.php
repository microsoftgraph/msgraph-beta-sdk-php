...
*/
class UserAccountInformationItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/profile/account/{userAccountInformation%2Did}{?%24select,%24expand}');
    ...
    */
    public function withUrl(string $rawUrl): UserAccountInformationItemRequestBuilder {
        return new UserAccountInformationItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
