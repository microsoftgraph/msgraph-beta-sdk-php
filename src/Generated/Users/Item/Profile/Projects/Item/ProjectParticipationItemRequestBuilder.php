...
class ProjectParticipationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $projectParticipationId key: id of projectParticipation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $projectParticipationId = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/profile/projects/{projectParticipation%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['projectParticipationId'] = $projectParticipationId;
