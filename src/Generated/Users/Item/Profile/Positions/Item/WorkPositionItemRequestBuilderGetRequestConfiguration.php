...
*/
class WorkPositionItemRequestBuilderGetRequestConfiguration 
{
    /**
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): WorkPositionItemRequestBuilderGetQueryParameters {
