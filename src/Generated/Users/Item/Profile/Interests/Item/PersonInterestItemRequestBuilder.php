...
class PersonInterestItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $personInterestId key: id of personInterest
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $personInterestId = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/profile/interests/{personInterest%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['personInterestId'] = $personInterestId;
