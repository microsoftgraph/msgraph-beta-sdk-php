...
*/
class PersonInterestItemRequestBuilderGetRequestConfiguration 
{
    /**
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): PersonInterestItemRequestBuilderGetQueryParameters {
