...
class ItemPatentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $itemPatentId key: id of itemPatent
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $itemPatentId = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/profile/patents/{itemPatent%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['itemPatentId'] = $itemPatentId;
