...
class AnniversariesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/profile/anniversaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
    ...
    */
     ...
     * @return Promise
     * @link https://learn.microsoft.com/graph/api/profile-post-anniversaries?view=graph-rest-1.0 Find more info here
    */
