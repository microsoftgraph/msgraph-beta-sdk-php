...
class PersonAwardItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $personAwardId key: id of personAward
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $personAwardId = null) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/profile/awards/{personAward%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['personAwardId'] = $personAwardId;
