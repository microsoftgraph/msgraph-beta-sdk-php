...
class PersonAwardItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/profile/awards/{personAward%2Did}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/personaward-delete?view=graph-rest-beta Find more info here
    */
    ...
    */
     ...
     * @return Promise<PersonAward|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/personaward-update?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?PersonAwardItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/profile/awards/{personAward%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
