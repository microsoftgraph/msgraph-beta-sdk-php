...
class GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/microsoft.graph.getEffectiveDeviceEnrollmentConfigurations()';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, GetEffectiveDeviceEnrollmentConfigurationsResponse::class, $responseHandler);
        } catch(Exception $ex) {
