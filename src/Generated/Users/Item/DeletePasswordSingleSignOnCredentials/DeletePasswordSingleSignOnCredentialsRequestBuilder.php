...
class DeletePasswordSingleSignOnCredentialsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/deletePasswordSingleSignOnCredentials');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/user-deletepasswordsinglesignoncredentials?view=graph-rest-beta Find more info here
    */
