...
class EvaluateDynamicMembershipRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/joinedGroups/evaluateDynamicMembership');
     ...
     * @return Promise<EvaluateDynamicMembershipResult|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/group-evaluatedynamicmembership?view=graph-rest-beta Find more info here
    */
