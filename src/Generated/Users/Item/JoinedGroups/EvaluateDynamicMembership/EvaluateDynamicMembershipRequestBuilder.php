...
class EvaluateDynamicMembershipRequestBuilder 
{
    ...
    */
    public function createPostRequestInformation(EvaluateDynamicMembershipPostRequestBody $body, ?EvaluateDynamicMembershipRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(EvaluateDynamicMembershipPostRequestBody $body, ?EvaluateDynamicMembershipRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(EvaluateDynamicMembershipResult::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
