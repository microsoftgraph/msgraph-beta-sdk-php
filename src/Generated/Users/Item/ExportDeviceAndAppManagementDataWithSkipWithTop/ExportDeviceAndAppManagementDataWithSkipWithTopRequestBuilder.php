...
class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?int $skip = null, ?int $top = null) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/microsoft.graph.exportDeviceAndAppManagementData(skip={skip},top={top})';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, DeviceAndAppManagementData::class, $responseHandler);
        } catch(Exception $ex) {
