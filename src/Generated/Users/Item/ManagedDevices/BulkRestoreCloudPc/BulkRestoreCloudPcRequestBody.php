...
class BulkRestoreCloudPcRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return BulkRestoreCloudPcRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BulkRestoreCloudPcRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'restorePointDateTime' => function (self $o, ParseNode $n) { $o->setRestorePointDateTime($n->getDateTimeValue()); },
            'timeRange' => function (self $o, ParseNode $n) { $o->setTimeRange($n->getEnumValue(RestoreTimeRange::class)); },
        ];
    }
