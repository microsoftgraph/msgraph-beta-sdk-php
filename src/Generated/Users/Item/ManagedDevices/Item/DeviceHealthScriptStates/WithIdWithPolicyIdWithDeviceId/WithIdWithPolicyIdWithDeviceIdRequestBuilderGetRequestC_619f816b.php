...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: WithIdWithPolicyIdWithDeviceIdRequestBuilderGetRequestConfiguration
*/
class WithIdWithPolicyIdWithDeviceIdRequestBuilderGetRequestC_619f816b extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WithIdWithPolicyIdWithDeviceIdRequestBuilderGetRequestC_619f816b and sets the default values.
