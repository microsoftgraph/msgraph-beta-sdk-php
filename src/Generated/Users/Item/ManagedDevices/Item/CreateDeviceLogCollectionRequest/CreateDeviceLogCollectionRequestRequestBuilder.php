...
*/
class CreateDeviceLogCollectionRequestRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/createDeviceLogCollectionRequest');
    ...
    */
     ...
     * @return CreateDeviceLogCollectionRequestRequestBuilder
    */
    public function withUrl(string $rawUrl): CreateDeviceLogCollectionRequestRequestBuilder {
        return new CreateDeviceLogCollectionRequestRequestBuilder($rawUrl, $this->requestAdapter);
    }
