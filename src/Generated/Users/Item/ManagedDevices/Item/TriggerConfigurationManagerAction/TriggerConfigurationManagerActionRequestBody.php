...
class TriggerConfigurationManagerActionRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return TriggerConfigurationManagerActionRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TriggerConfigurationManagerActionRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'configurationManagerAction' => function (self $o, ParseNode $n) { $o->setConfigurationManagerAction($n->getObjectValue(ConfigurationManagerAction::class)); },
        ];
    }
