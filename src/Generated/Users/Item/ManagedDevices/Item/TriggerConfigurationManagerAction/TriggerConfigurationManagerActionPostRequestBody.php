...
class TriggerConfigurationManagerActionPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getConfigurationManagerAction(): ?ConfigurationManagerAction {
        $val = $this->getBackingStore()->get('configurationManagerAction');
        if (is_null($val) || $val instanceof ConfigurationManagerAction) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'configurationManagerAction'");
    }
    ...
    */
    public function setConfigurationManagerAction(?ConfigurationManagerAction $value): void {
        $this->getBackingStore()->set('configurationManagerAction', $value);
    }
