...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: SecurityBaselineSettingStateItemRequestBuilderGetRequestConfiguration
*/
class SecurityBaselineSettingStateItemRequestBuilderGetReques_2fd40eca extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SecurityBaselineSettingStateItemRequestBuilderGetReques_2fd40eca and sets the default values.
