...
class RestoreCloudPcRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return RestoreCloudPcRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RestoreCloudPcRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'cloudPcSnapshotId' => function (self $o, ParseNode $n) { $o->setCloudPcSnapshotId($n->getStringValue()); },
        ];
    }
