...
class ActivateDeviceEsimRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return ActivateDeviceEsimRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ActivateDeviceEsimRequestBody {
