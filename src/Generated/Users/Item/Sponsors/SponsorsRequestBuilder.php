...
use Microsoft\Graph\Beta\Generated\Users\Item\Sponsors\Ref\RefRequestBuilder;
...
class SponsorsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft/Graph/Beta/Generated.users.item.sponsors.item collection
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/sponsors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function withUrl(string $rawUrl): SponsorsRequestBuilder {
        return new SponsorsRequestBuilder($rawUrl, $this->requestAdapter);
    }
