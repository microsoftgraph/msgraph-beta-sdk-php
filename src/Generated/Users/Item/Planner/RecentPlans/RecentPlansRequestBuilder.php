...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\PlannerPlanCollectionResponse;
...
class RecentPlansRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/planner/recentPlans{?top,skip,search,filter,count,orderby,select,expand}';
