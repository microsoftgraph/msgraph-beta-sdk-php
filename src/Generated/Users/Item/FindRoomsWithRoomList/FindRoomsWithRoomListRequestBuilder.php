...
class FindRoomsWithRoomListRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $roomList = null) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/microsoft.graph.findRooms(RoomList=\'{RoomList}\')';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, FindRoomsWithRoomListResponse::class, $responseHandler);
        } catch(Exception $ex) {
