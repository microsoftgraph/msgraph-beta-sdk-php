...
class FindRoomListsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/findRoomLists(){?%24top,%24skip,%24search,%24filter,%24count}');
     ...
     * @return Promise
     * @link https://learn.microsoft.com/graph/api/user-findroomlists?view=graph-rest-1.0 Find more info here
    */
