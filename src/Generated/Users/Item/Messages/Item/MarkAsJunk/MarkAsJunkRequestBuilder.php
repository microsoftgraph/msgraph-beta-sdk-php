...
namespace Microsoft\Graph\Beta\Generated\Users\Item\Messages\Item\MarkAsJunk;
...
class MarkAsJunkRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/messages/{message%2Did}/markAsJunk');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/message-markasjunk?view=graph-rest-beta Find more info here
    */
