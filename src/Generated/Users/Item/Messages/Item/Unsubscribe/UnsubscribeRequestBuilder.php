...
class UnsubscribeRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/messages/{message%2Did}/unsubscribe');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/message-unsubscribe?view=graph-rest-beta Find more info here
    */
