...
class CreateReplyAllRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/createReplyAll');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/message-createreplyall?view=graph-rest-beta Find more info here
    */
