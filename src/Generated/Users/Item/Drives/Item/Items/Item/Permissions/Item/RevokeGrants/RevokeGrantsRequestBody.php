...
class RevokeGrantsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return RevokeGrantsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RevokeGrantsRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'grantees' => function (self $o, ParseNode $n) { $o->setGrantees($n->getCollectionOfObjectValues(DriveRecipient::class)); },
        ];
    }
