...
class ThreatAssessmentRequestItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest_id}{?select,expand}';
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.informationProtection.threatAssessmentRequests.item.results.item collection
