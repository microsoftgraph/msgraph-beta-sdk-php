...
class SensitivityLabelItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/informationProtection/sensitivityLabels/{sensitivityLabel_id}{?select,expand}';
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.users.item.informationProtection.sensitivityLabels.item.sublabels.item collection
