...
namespace Microsoft\Graph\Beta\Generated\Users\Item\InformationProtection\SensitivityLabels;
...
use Microsoft\Graph\Beta\Generated\Users\Item\InformationProtection\SensitivityLabels\ComputeInheritanceWithLabelIdsWithLocaleWithContentFormats\ComputeInheritanceWithLabelIdsWithLocaleWithContentForm_2b72dc93;
use Microsoft\Graph\Beta\Generated\Users\Item\InformationProtection\SensitivityLabels\ComputeRightsAndInheritance\ComputeRightsAndInheritanceRequestBuilder;
use Microsoft\Graph\Beta\Generated\Users\Item\InformationProtection\SensitivityLabels\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Users\Item\InformationProtection\SensitivityLabels\Evaluate\EvaluateRequestBuilder;
...
class SensitivityLabelsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?SensitivityLabelsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/informationProtection/sensitivityLabels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(SensitivityLabel $body, ?SensitivityLabelsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/informationProtection/sensitivityLabels';
        $requestInfo->pathParameters = $this->pathParameters;
