...
namespace Microsoft\Graph\Beta\Generated\Users\Item\Insights\Used;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\UsedInsight;
use Microsoft\Graph\Beta\Generated\Models\UsedInsightCollectionResponse;
use Microsoft\Graph\Beta\Generated\Users\Item\Insights\Used\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Users\Item\Insights\Used\Item\UsedInsightItemRequestBuilder;
...
class UsedRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/insights/used{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function toPostRequestInformation(UsedInsight $body, ?UsedRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/users/{user%2Did}/insights/used';
        $requestInfo->pathParameters = $this->pathParameters;
