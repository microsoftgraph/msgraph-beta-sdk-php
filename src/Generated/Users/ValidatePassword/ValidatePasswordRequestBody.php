...
class ValidatePasswordRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return ValidatePasswordRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ValidatePasswordRequestBody {
