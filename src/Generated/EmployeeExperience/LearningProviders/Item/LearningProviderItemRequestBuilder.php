...
use Microsoft\Graph\Beta\Generated\EmployeeExperience\LearningProviders\Item\LearningContents\Item\LearningContentExternalItemRequestBuilder;
...
class LearningProviderItemRequestBuilder 
{
    ...
    */
    public function createDeleteRequestInformation(?LearningProviderItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return RequestInformation
    */
    public function createGetRequestInformation(?LearningProviderItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(LearningProvider $body, ?LearningProviderItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return Promise
    */
    public function delete(?LearningProviderItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
     ...
     * @return Promise
    */
    public function get(?LearningProviderItemRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, array(LearningProvider::class, 'createFromDiscriminatorValue'), $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
     ...
     * @return LearningContentExternalItemRequestBuilder
    */
    public function learningContentsById(string $id): LearningContentExternalItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['learningContent%2DexternalId'] = $id;
        return new LearningContentExternalItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
     ...
     * @return Promise
    */
    public function patch(LearningProvider $body, ?LearningProviderItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
