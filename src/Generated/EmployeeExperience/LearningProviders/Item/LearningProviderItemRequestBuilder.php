...
class LearningProviderItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $learningProviderId key: id of learningProvider
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $learningProviderId = null) {
    ...
    */
    public function learningContentsById(string $id): LearningContentItemRequestBuilder {
        ...
        return new LearningContentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
