...
class LearningContentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $learningContentId key: id of learningContent
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $learningContentId = null) {
        ...
        $urlTplParams['learningContentId'] = $learningContentId;
