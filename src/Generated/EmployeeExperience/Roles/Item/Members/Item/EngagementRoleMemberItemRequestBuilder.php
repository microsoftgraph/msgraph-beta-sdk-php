...
class EngagementRoleMemberItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/employeeExperience/roles/{engagementRole%2Did}/members/{engagementRoleMember%2Did}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/engagementrole-delete-members?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?EngagementRoleMemberItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/employeeExperience/roles/{engagementRole%2Did}/members/{engagementRoleMember%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
