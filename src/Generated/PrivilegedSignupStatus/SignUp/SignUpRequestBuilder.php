...
namespace Microsoft\Graph\Beta\Generated\PrivilegedSignupStatus\SignUp;
...
*/
class SignUpRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/privilegedSignupStatus/signUp');
     ...
     * @throws Exception
    */
    public function post(?SignUpRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?SignUpRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): SignUpRequestBuilder {
        return new SignUpRequestBuilder($rawUrl, $this->requestAdapter);
    }
