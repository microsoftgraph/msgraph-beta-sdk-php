...
class PrivilegedSignupStatusItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedSignupStatusId key: id of privilegedSignupStatus
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $privilegedSignupStatusId = null) {
        $this->urlTemplate = '{+baseurl}/privilegedSignupStatus/{privilegedSignupStatus%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['privilegedSignupStatusId'] = $privilegedSignupStatusId;
    ...
    */
     ...
     * @return Promise
    */
    public function get(?PrivilegedSignupStatusItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
