...
use Microsoft\Graph\Beta\Generated\PrivilegedSignupStatus\MicrosoftGraphCanSignUp\MicrosoftGraphCanSignUpRequestBuilder;
use Microsoft\Graph\Beta\Generated\PrivilegedSignupStatus\MicrosoftGraphCompleteSetup\MicrosoftGraphCompleteSetupRequestBuilder;
use Microsoft\Graph\Beta\Generated\PrivilegedSignupStatus\MicrosoftGraphIsSignedUp\MicrosoftGraphIsSignedUpRequestBuilder;
use Microsoft\Graph\Beta\Generated\PrivilegedSignupStatus\MicrosoftGraphSignUp\MicrosoftGraphSignUpRequestBuilder;
...
class PrivilegedSignupStatusRequestBuilder 
{
    ...
    */
    public function microsoftGraphCanSignUp(): MicrosoftGraphCanSignUpRequestBuilder {
        return new MicrosoftGraphCanSignUpRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the completeSetup method.
    */
    public function microsoftGraphCompleteSetup(): MicrosoftGraphCompleteSetupRequestBuilder {
        return new MicrosoftGraphCompleteSetupRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the isSignedUp method.
    */
    public function microsoftGraphIsSignedUp(): MicrosoftGraphIsSignedUpRequestBuilder {
        return new MicrosoftGraphIsSignedUpRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the signUp method.
    */
    public function microsoftGraphSignUp(): MicrosoftGraphSignUpRequestBuilder {
        return new MicrosoftGraphSignUpRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
