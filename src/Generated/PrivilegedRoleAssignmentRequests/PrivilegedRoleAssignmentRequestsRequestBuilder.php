...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\PrivilegedRoleAssignmentRequestCollectionResponse;
...
class PrivilegedRoleAssignmentRequestsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/privilegedRoleAssignmentRequests{?top,skip,search,filter,count,orderby,select,expand}';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(PrivilegedRoleAssignmentRequest $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, PrivilegedRoleAssignmentRequestCollectionResponse::class, $responseHandler);
        } catch(Exception $ex) {
    ...
    */
     ...
     * @return Promise
    */
    public function post(PrivilegedRoleAssignmentRequest $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
