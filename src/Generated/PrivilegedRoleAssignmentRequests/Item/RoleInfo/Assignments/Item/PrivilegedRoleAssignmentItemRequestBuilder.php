...
class PrivilegedRoleAssignmentItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest_id}/roleInfo/assignments/{privilegedRoleAssignment_id}{?select,expand}';
