...
use Microsoft\Graph\Beta\Generated\PrivilegedRoleAssignmentRequests\Item\RoleInfo\MicrosoftGraphSelfActivate\MicrosoftGraphSelfActivateRequestBuilder;
use Microsoft\Graph\Beta\Generated\PrivilegedRoleAssignmentRequests\Item\RoleInfo\MicrosoftGraphSelfDeactivate\MicrosoftGraphSelfDeactivateRequestBuilder;
...
class RoleInfoRequestBuilder 
{
    ...
    */
    public function microsoftGraphSelfActivate(): MicrosoftGraphSelfActivateRequestBuilder {
        return new MicrosoftGraphSelfActivateRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    
    /**
     * Provides operations to call the selfDeactivate method.
    */
    public function microsoftGraphSelfDeactivate(): MicrosoftGraphSelfDeactivateRequestBuilder {
        return new MicrosoftGraphSelfDeactivateRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function assignmentsById(string $id): PrivilegedRoleAssignmentItemRequestBuilder {
        ...
        return new PrivilegedRoleAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
