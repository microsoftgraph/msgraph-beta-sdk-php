...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Connectors\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/connectors/$count{?%24search,%24filter}');
