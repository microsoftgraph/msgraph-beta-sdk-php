...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Reports\MicrosoftGraphGetTeamsUserActivityCountsWithPeriod;
...
class GetTeamsUserActivityCountsWithPeriodRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        $this->urlTemplate = '{+baseurl}/print/reports/microsoft.graph.getTeamsUserActivityCounts(period=\'{period}\')';
