...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Reports\MicrosoftGraphGetOneDriveUsageFileCountsWithPeriod;
...
class GetOneDriveUsageFileCountsWithPeriodRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $period = null) {
        $this->urlTemplate = '{+baseurl}/print/reports/microsoft.graph.getOneDriveUsageFileCounts(period=\'{period}\')';
