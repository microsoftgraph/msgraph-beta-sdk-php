...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Reports\GetEmailAppUsageUserDetailWithDate;
...
class GetEmailAppUsageUserDetailWithDateRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?Date $date = null) {
        $this->urlTemplate = '{+baseurl}/print/reports/microsoft.graph.getEmailAppUsageUserDetail(date={date})';
    ...
    */
    public function createGetRequestInformation(?GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function get(?GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
