...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Reports\GetYammerGroupsActivityDetailWithDate;
...
class GetYammerGroupsActivityDetailWithDateRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?Date $date = null) {
        $this->urlTemplate = '{+baseurl}/print/reports/microsoft.graph.getYammerGroupsActivityDetail(date={date})';
    ...
    */
    public function createGetRequestInformation(?GetYammerGroupsActivityDetailWithDateRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
