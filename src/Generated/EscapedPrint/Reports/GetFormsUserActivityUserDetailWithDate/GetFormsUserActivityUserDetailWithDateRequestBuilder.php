...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Reports\GetFormsUserActivityUserDetailWithDate;
...
class GetFormsUserActivityUserDetailWithDateRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?Date $date = null) {
        $this->urlTemplate = '{+baseurl}/print/reports/getFormsUserActivityUserDetail(date={date})';
