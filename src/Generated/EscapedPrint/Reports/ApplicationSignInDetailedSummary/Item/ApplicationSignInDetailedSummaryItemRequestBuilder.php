...
class ApplicationSignInDetailedSummaryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $applicationSignInDetailedSummaryId key: id of applicationSignInDetailedSummary
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $applicationSignInDetailedSummaryId = null) {
        ...
        $urlTplParams['applicationSignInDetailedSummaryId'] = $applicationSignInDetailedSummaryId;
