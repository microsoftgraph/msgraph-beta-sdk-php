...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Reports\MicrosoftGraphGetEmailAppUsageUserCountsWithPeriod;
...
class GetEmailAppUsageUserCountsWithPeriodRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        $this->urlTemplate = '{+baseurl}/print/reports/microsoft.graph.getEmailAppUsageUserCounts(period=\'{period}\')';
