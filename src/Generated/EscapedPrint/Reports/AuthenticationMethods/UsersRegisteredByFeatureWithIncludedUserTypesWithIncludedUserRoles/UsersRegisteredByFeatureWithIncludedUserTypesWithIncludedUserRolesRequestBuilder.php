...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\UserRegistrationFeatureSummary;
...
class UsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilder 
{
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, UserRegistrationFeatureSummary::class, $responseHandler);
        } catch(Exception $ex) {
