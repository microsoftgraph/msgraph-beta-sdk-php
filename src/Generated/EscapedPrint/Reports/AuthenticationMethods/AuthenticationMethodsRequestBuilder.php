...
class AuthenticationMethodsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/print/reports/authenticationMethods{?select,expand}';
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.print.reports.authenticationMethods.userRegistrationDetails.item collection
