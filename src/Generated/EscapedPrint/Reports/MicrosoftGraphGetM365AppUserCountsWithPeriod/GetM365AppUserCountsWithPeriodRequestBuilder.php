...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Reports\MicrosoftGraphGetM365AppUserCountsWithPeriod;
...
class GetM365AppUserCountsWithPeriodRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $period = null) {
        $this->urlTemplate = '{+baseurl}/print/reports/microsoft.graph.getM365AppUserCounts(period=\'{period}\')';
