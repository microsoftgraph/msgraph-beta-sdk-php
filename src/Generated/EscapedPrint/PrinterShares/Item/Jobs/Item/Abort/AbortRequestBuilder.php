...
class AbortRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}/abort');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printjob-abort?view=graph-rest-beta Find more info here
    */
