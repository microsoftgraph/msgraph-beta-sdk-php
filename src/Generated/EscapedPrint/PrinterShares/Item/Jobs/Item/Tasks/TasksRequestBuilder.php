...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\PrinterShares\Item\Jobs\Item\Tasks;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\EscapedPrint\PrinterShares\Item\Jobs\Item\Tasks\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\EscapedPrint\PrinterShares\Item\Jobs\Item\Tasks\Item\PrintTaskItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\PrintTask;
use Microsoft\Graph\Beta\Generated\Models\PrintTaskCollectionResponse;
...
class TasksRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the tasks property of the microsoft.graph.printJob entity.
     * @param string $printTaskId The unique identifier of printTask
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<PrintTaskCollectionResponse|null>
     * @throws Exception
    */
    ...
    */
    public function toPostRequestInformation(PrintTask $body, ?TasksRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks';
        $requestInfo->pathParameters = $this->pathParameters;
