...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Services\Item\Endpoints\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/services/{printService%2Did}/endpoints/$count{?%24search,%24filter}');
