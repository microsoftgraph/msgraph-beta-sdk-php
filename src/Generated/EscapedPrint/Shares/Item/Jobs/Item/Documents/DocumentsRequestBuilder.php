...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Shares\Item\Jobs\Item\Documents;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\EscapedPrint\Shares\Item\Jobs\Item\Documents\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\EscapedPrint\Shares\Item\Jobs\Item\Documents\Item\PrintDocumentItemRequestBuilder;
...
class DocumentsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/documents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function toPostRequestInformation(PrintDocument $body, ?DocumentsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/documents';
        $requestInfo->pathParameters = $this->pathParameters;
