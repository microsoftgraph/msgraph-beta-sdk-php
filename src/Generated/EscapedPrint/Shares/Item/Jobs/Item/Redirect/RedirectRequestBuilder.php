...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Shares\Item\Jobs\Item\Redirect;
...
class RedirectRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/redirect');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printjob-redirect?view=graph-rest-beta Find more info here
    */
