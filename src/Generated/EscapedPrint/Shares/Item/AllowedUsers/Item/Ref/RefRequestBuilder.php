...
class RefRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/shares/{printerShare%2Did}/allowedUsers/{user%2Did}/$ref{?%40id*}');
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/printershare-delete-alloweduser?view=graph-rest-1.0 Find more info here
    */
