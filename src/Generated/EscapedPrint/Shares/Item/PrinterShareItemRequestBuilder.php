...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Shares\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\EscapedPrint\Shares\Item\AllowedGroups\AllowedGroupsRequestBuilder;
use Microsoft\Graph\Beta\Generated\EscapedPrint\Shares\Item\AllowedUsers\AllowedUsersRequestBuilder;
use Microsoft\Graph\Beta\Generated\EscapedPrint\Shares\Item\Jobs\JobsRequestBuilder;
use Microsoft\Graph\Beta\Generated\EscapedPrint\Shares\Item\Printer\PrinterRequestBuilder;
...
class PrinterShareItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/shares/{printerShare%2Did}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printershare-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printershare-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<PrinterShare|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printershare-update?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?PrinterShareItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/print/shares/{printerShare%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
