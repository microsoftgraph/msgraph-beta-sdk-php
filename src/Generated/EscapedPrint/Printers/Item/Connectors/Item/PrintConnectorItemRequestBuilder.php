...
class PrintConnectorItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $printConnectorId key: id of printConnector
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $printConnectorId = null) {
        $this->urlTemplate = '{+baseurl}/print/printers/{printer%2Did}/connectors/{printConnector%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['printConnectorId'] = $printConnectorId;
