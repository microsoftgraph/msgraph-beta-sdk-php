...
class PrinterItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printer-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printer-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<Printer|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printer-update?view=graph-rest-beta Find more info here
    */
