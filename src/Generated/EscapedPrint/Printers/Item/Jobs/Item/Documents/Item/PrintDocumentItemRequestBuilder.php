...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Printers\Item\Jobs\Item\Documents\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\EscapedPrint\Printers\Item\Jobs\Item\Documents\Item\CreateUploadSession\CreateUploadSessionRequestBuilder;
use Microsoft\Graph\Beta\Generated\EscapedPrint\Printers\Item\Jobs\Item\Documents\Item\Value\ContentRequestBuilder;
...
class PrintDocumentItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/documents/{printDocument%2Did}');
    ...
    */
    public function toGetRequestInformation(?PrintDocumentItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/documents/{printDocument%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
