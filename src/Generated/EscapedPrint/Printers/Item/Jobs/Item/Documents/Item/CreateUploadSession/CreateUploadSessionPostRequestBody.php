...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Printers\Item\Jobs\Item\Documents\Item\CreateUploadSession;
...
class CreateUploadSessionPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'properties' => fn(ParseNode $n) => $o->setProperties($n->getObjectValue([PrintDocumentUploadProperties::class, 'createFromDiscriminatorValue'])),
        ];
    }

    /**
     * Gets the properties property value. The properties property
     * @return PrintDocumentUploadProperties|null
    */
    public function getProperties(): ?PrintDocumentUploadProperties {
        $val = $this->getBackingStore()->get('properties');
        if (is_null($val) || $val instanceof PrintDocumentUploadProperties) {
            return $val;
        }
    ...
    */
     ...
     * @param PrintDocumentUploadProperties|null $value Value to set for the properties property.
    */
    public function setProperties(?PrintDocumentUploadProperties $value): void {
