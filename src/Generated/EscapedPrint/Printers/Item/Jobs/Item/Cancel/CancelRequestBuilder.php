...
namespace Microsoft\Graph\Beta\Generated\EscapedPrint\Printers\Item\Jobs\Item\Cancel;
...
class CancelRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/cancel');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/printjob-cancel?view=graph-rest-beta Find more info here
    */
