...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\PrinterCapabilities;
...
class GetCapabilitiesRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/print/printers/{printer_id}/microsoft.graph.getCapabilities()';
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, PrinterCapabilities::class, $responseHandler);
        } catch(Exception $ex) {
