...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: SharedWithChannelTeamInfoItemRequestBuilderGetRequestConfiguration
*/
class SharedWithChannelTeamInfoItemRequestBuilderGetRequestCo_1d5b8884 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SharedWithChannelTeamInfoItemRequestBuilderGetRequestCo_1d5b8884 and sets the default values.
