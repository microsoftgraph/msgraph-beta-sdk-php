...
class TimeOffReasonItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $timeOffReasonId key: id of timeOffReason
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $timeOffReasonId = null) {
        ...
        $urlTplParams['timeOffReasonId'] = $timeOffReasonId;
