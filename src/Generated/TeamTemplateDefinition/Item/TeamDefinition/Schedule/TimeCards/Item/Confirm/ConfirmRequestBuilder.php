...
class ConfirmRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}/confirm');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/timecard-confirm?view=graph-rest-beta Find more info here
    */
