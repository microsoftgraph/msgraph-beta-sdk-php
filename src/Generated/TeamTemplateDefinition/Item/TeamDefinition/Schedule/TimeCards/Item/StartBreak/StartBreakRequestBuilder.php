...
class StartBreakRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}/startBreak');
    ...
    */
    public function withUrl(string $rawUrl): StartBreakRequestBuilder {
        return new StartBreakRequestBuilder($rawUrl, $this->requestAdapter);
    }
