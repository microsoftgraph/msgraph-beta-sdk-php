...
use Microsoft\Graph\Beta\Generated\TeamTemplateDefinition\Item\TeamDefinition\Schedule\TimeCards\MicrosoftGraphClockIn\MicrosoftGraphClockInRequestBuilder;
...
class TimeCardsRequestBuilder 
{
    ...
    */
    public function microsoftGraphClockIn(): MicrosoftGraphClockInRequestBuilder {
        return new MicrosoftGraphClockInRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/timecard-list?view=graph-rest-1.0 Find more info here
    */
