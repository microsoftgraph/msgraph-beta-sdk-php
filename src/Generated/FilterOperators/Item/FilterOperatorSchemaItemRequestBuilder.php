...
class FilterOperatorSchemaItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $filterOperatorSchemaId key: id of filterOperatorSchema
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $filterOperatorSchemaId = null) {
        $this->urlTemplate = '{+baseurl}/filterOperators/{filterOperatorSchema%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['filterOperatorSchemaId'] = $filterOperatorSchemaId;
