...
class MuteRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/app/calls/{call%2Did}/participants/{participant%2Did}/mute');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/participant-mute?view=graph-rest-beta Find more info here
    */
