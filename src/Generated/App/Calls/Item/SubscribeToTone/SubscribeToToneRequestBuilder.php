...
class SubscribeToToneRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/app/calls/{call%2Did}/subscribeToTone');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/call-subscribetotone?view=graph-rest-beta Find more info here
    */
