...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\Call;
...
class CallItemRequestBuilder 
{
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.app.calls.item.audioRoutingGroups.item collection
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/app/calls/{call_id}{?select,expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
    }

    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.app.calls.item.contentSharingSessions.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.app.calls.item.operations.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.app.calls.item.participants.item collection
     * @param string $id Unique identifier of the item
