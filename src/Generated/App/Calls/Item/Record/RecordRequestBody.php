...
namespace Microsoft\Graph\Beta\Generated\App\Calls\Item\Record;
...
class RecordRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RecordRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'streamWhileRecording' => function (self $o, ParseNode $n) { $o->setStreamWhileRecording($n->getBooleanValue()); },
        ];
    }
