...
use Microsoft\Graph\Beta\Generated\App\Calls\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\App\Calls\Item\CallItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\App\Calls\LogTeleconferenceDeviceQuality\LogTeleconferenceDeviceQualityRequestBuilder;
...
class CallsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/app/calls{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function toPostRequestInformation(Call $body, ?CallsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/app/calls';
        $requestInfo->pathParameters = $this->pathParameters;
