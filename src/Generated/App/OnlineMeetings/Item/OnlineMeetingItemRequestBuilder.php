...
use Microsoft\Graph\Beta\Generated\App\OnlineMeetings\Item\AttendanceReports\Item\MeetingAttendanceReportItemRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\App\OnlineMeetings\Item\Transcripts\Item\CallTranscriptItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\App\OnlineMeetings\Item\Transcripts\TranscriptsRequestBuilder;
use Microsoft\Graph\Beta\Generated\App\OnlineMeetings\Item\VirtualAppointment\VirtualAppointmentRequestBuilder;
...
class OnlineMeetingItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $onlineMeetingId key: id of onlineMeeting
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $onlineMeetingId = null) {
        $this->urlTemplate = '{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}{?%24select,%24expand}';
    ...
    */
    public function transcriptsById(string $id): CallTranscriptItemRequestBuilder {
        ...
        return new CallTranscriptItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
