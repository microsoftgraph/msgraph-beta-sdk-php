...
class OnlineMeetingItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $onlineMeetingId = null) {
        $this->urlTemplate = '{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['onlineMeetingId'] = $onlineMeetingId;
