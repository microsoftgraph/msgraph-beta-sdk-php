...
*/
class MeetingAttendanceReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?MeetingAttendanceReportRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport';
    ...
    */
    public function withUrl(string $rawUrl): MeetingAttendanceReportRequestBuilder {
        return new MeetingAttendanceReportRequestBuilder($rawUrl, $this->requestAdapter);
    }
