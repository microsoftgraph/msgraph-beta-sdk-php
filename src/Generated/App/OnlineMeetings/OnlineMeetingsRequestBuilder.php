...
use Microsoft\Graph\Beta\Generated\App\OnlineMeetings\GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_be4c23e9\GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_37aeadf4;
use Microsoft\Graph\Beta\Generated\App\OnlineMeetings\GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_056e0011\GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_f6fef853;
...
class OnlineMeetingsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?OnlineMeetingsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/app/onlineMeetings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(OnlineMeeting $body, ?OnlineMeetingsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/app/onlineMeetings';
        $requestInfo->pathParameters = $this->pathParameters;
