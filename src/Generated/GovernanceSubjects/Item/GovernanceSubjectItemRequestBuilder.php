...
class GovernanceSubjectItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $governanceSubjectId key: id of governanceSubject
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $governanceSubjectId = null) {
        $this->urlTemplate = '{+baseurl}/governanceSubjects/{governanceSubject%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['governanceSubjectId'] = $governanceSubjectId;
