...
namespace Microsoft\Graph\Beta\Generated\Storage\FileStorage\Containers\Item\Columns;
...
use Microsoft\Graph\Beta\Generated\Storage\FileStorage\Containers\Item\Columns\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Storage\FileStorage\Containers\Item\Columns\Item\ColumnDefinitionItemRequestBuilder;
...
class ColumnsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?ColumnsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/columns{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ColumnDefinition $body, ?ColumnsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/columns';
        $requestInfo->pathParameters = $this->pathParameters;
