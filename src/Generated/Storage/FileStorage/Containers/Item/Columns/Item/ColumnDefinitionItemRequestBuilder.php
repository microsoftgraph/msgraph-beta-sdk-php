...
namespace Microsoft\Graph\Beta\Generated\Storage\FileStorage\Containers\Item\Columns\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ColumnDefinition;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Storage\FileStorage\Containers\Item\Columns\Item\SourceColumn\SourceColumnRequestBuilder;
...
class ColumnDefinitionItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/columns/{columnDefinition%2Did}');
    ...
    */
    public function toGetRequestInformation(?ColumnDefinitionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/columns/{columnDefinition%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
