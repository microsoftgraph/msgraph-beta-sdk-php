...
class PowerPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PowerPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'power' => fn(ParseNode $n) => $o->setPower($n->getObjectValue([Json::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function getPower(): ?Json {
        $val = $this->getBackingStore()->get('power');
        if (is_null($val) || $val instanceof Json) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'power'");
    }
