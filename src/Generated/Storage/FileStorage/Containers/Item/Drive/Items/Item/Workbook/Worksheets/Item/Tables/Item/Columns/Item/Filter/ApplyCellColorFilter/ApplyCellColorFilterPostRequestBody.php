...
class ApplyCellColorFilterPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApplyCellColorFilterPostRequestBody {
