...
namespace Microsoft\Graph\Beta\Generated\Storage\FileStorage\Containers\Item\Drive\Items\Item\Workbook\Functions\Subtotal;
...
class SubtotalPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SubtotalPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'functionNum' => fn(ParseNode $n) => $o->setFunctionNum($n->getObjectValue([Json::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function getFunctionNum(): ?Json {
        $val = $this->getBackingStore()->get('functionNum');
        if (is_null($val) || $val instanceof Json) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'functionNum'");
    }
