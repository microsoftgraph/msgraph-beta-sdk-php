...
namespace Microsoft\Graph\Beta\Generated\Storage\FileStorage\Containers\Item\Drive\Items\Item\Workbook\Functions\Rank_Eq;
...
*/
class Rank_EqRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/rank_Eq');
     ...
     * @throws Exception
    */
    public function post(Rank_EqPostRequestBody $body, ?Rank_EqRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(Rank_EqPostRequestBody $body, ?Rank_EqRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
