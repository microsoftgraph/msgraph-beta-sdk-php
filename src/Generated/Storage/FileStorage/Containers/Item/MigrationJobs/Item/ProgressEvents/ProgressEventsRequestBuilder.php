...
use Microsoft\Graph\Beta\Generated\Storage\FileStorage\Containers\Item\MigrationJobs\Item\ProgressEvents\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Storage\FileStorage\Containers\Item\MigrationJobs\Item\ProgressEvents\Item\SharePointMigrationEventItemRequestBuilder;
...
class ProgressEventsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?ProgressEventsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/migrationJobs/{sharePointMigrationJob%2Did}/progressEvents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(SharePointMigrationEvent $body, ?ProgressEventsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/migrationJobs/{sharePointMigrationJob%2Did}/progressEvents';
        $requestInfo->pathParameters = $this->pathParameters;
