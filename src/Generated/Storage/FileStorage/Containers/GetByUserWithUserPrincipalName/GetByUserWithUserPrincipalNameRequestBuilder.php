...
*/
class GetByUserWithUserPrincipalNameRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new GetByUserWithUserPrincipalNameRequestBuilder and sets the default values.
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $userPrincipalName = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storage/fileStorage/containers/getByUser(userPrincipalName=\'{userPrincipalName}\'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function get(?GetByUserWithUserPrincipalNameRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [GetByUserWithUserPrincipalNameGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toGetRequestInformation(?GetByUserWithUserPrincipalNameRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): GetByUserWithUserPrincipalNameRequestBuilder {
        return new GetByUserWithUserPrincipalNameRequestBuilder($rawUrl, $this->requestAdapter);
    }
