...
use Microsoft\Graph\Beta\Generated\Models\WorkbookSessionInfo;
...
class CreateSessionRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/createSession');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/workbook-createsession?view=graph-rest-beta Find more info here
    */
