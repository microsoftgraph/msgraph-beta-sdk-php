...
class ErfCPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return ErfCPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ErfCPostRequestBody {
