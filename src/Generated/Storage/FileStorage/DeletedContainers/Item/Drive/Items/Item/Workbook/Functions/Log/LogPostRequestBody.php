...
class LogPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): LogPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'base' => fn(ParseNode $n) => $o->setBase($n->getObjectValue([Json::class, 'createFromDiscriminatorValue'])),
