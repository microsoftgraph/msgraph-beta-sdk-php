...
namespace Microsoft\Graph\Beta\Generated\Storage\FileStorage\DeletedContainers\Item\Drive\Items\Item\Workbook\Functions\ImLog2;
...
*/
class ImLog2RequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/imLog2');
     ...
     * @throws Exception
    */
    public function post(ImLog2PostRequestBody $body, ?ImLog2RequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(ImLog2PostRequestBody $body, ?ImLog2RequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
