...
class RoundDownPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RoundDownPostRequestBody {
    ...
    */
    public function getNumDigits(): ?Json {
        $val = $this->getBackingStore()->get('numDigits');
        if (is_null($val) || $val instanceof Json) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'numDigits'");
    }
