...
namespace Microsoft\Graph\Beta\Generated\Storage\FileStorage\DeletedContainers\Item\Drive\Items\Item\Workbook\Worksheets\Item\Tables\Item\Columns\Item\Filter\ApplyTopPercentFilter;
...
class ApplyTopPercentFilterPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApplyTopPercentFilterPostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'percent' => fn(ParseNode $n) => $o->setPercent($n->getIntegerValue()),
        ];
    }
