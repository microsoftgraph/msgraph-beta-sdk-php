...
namespace Microsoft\Graph\Beta\Generated\Storage\FileStorage\DeletedContainers\Item\Drive\Items\Item\Workbook\Functions\Choose;
...
class ChoosePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ChoosePostRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'indexNum' => fn(ParseNode $n) => $o->setIndexNum($n->getObjectValue([Json::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function getIndexNum(): ?Json {
        $val = $this->getBackingStore()->get('indexNum');
        if (is_null($val) || $val instanceof Json) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'indexNum'");
    }
    ...
    */
    public function setIndexNum(?Json $value): void {
        $this->getBackingStore()->set('indexNum', $value);
    }
