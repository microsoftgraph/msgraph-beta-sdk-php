...
class AddCopyFromContentTypeHubPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getContentTypeId(): ?string {
        $val = $this->getBackingStore()->get('contentTypeId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'contentTypeId'");
    }
