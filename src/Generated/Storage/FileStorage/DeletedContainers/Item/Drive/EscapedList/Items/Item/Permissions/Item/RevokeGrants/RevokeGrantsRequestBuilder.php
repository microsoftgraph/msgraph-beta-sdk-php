...
namespace Microsoft\Graph\Beta\Generated\Storage\FileStorage\DeletedContainers\Item\Drive\EscapedList\Items\Item\Permissions\Item\RevokeGrants;
...
class RevokeGrantsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/permissions/{permission%2Did}/revokeGrants');
    ...
    */
    public function withUrl(string $rawUrl): RevokeGrantsRequestBuilder {
        return new RevokeGrantsRequestBuilder($rawUrl, $this->requestAdapter);
    }
