...
class DeltaWithTokenGetResponse extends BaseDeltaFunctionResponse implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeltaWithTokenGetResponse {
