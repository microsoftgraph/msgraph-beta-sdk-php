...
namespace Microsoft\Graph\Beta\Generated\Storage\FileStorage\DeletedContainers\Item\Drive\EscapedList\ContentTypes\AddCopyFromContentTypeHub;
...
*/
class AddCopyFromContentTypeHubRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/contentTypes/addCopyFromContentTypeHub');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/contenttype-addcopyfromcontenttypehub?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toPostRequestInformation(AddCopyFromContentTypeHubPostRequestBody $body, ?AddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): AddCopyFromContentTypeHubRequestBuilder {
