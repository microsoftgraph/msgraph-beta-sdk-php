...
use Microsoft\Graph\Beta\Generated\Storage\Settings\Quota\Services\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Storage\Settings\Quota\Services\Item\ServiceStorageQuotaBreakdownItemRequestBuilder;
...
class ServicesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?ServicesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/storage/settings/quota/services{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ServiceStorageQuotaBreakdown $body, ?ServicesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/storage/settings/quota/services';
        $requestInfo->pathParameters = $this->pathParameters;
