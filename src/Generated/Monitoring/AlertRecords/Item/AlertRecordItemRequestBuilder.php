...
use Microsoft\Graph\Beta\Generated\Monitoring\AlertRecords\Item\MicrosoftGraphDeviceManagementSetPortalNotificationAsSent\SetPortalNotificationAsSentRequestBuilder;
...
class AlertRecordItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphDeviceManagementSetPortalNotificationAsSent(): SetPortalNotificationAsSentRequestBuilder {
    ...
    */
     ...
     * @param string|null $alertRecordId key: id of alertRecord
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $alertRecordId = null) {
        $this->urlTemplate = '{+baseurl}/monitoring/alertRecords/{alertRecord%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['alertRecordId'] = $alertRecordId;
