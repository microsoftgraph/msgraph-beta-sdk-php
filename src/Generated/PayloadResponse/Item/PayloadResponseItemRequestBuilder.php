...
class PayloadResponseItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $payloadResponseId key: id of payloadResponse
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $payloadResponseId = null) {
        $this->urlTemplate = '{+baseurl}/payloadResponse/{payloadResponse%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['payloadResponseId'] = $payloadResponseId;
