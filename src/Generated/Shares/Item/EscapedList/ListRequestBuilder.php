...
use Microsoft\Graph\Beta\Generated\Shares\Item\EscapedList\Columns\Item\ColumnDefinitionItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Shares\Item\EscapedList\ContentTypes\ContentTypesRequestBuilder;
use Microsoft\Graph\Beta\Generated\Shares\Item\EscapedList\ContentTypes\Item\ContentTypeItemRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\Shares\Item\EscapedList\Operations\Item\RichLongRunningOperationItemRequestBuilder;
...
class ListRequestBuilder 
{
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.shares.item.list.columns.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.shares.item.list.contentTypes.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.shares.item.list.items.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.shares.item.list.operations.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.shares.item.list.subscriptions.item collection
     * @param string $id Unique identifier of the item
