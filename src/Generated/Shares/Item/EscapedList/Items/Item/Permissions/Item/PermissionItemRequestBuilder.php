...
use Microsoft\Graph\Beta\Generated\Shares\Item\EscapedList\Items\Item\Permissions\Item\Grant\GrantRequestBuilder;
use Microsoft\Graph\Beta\Generated\Shares\Item\EscapedList\Items\Item\Permissions\Item\RevokeGrants\RevokeGrantsRequestBuilder;
...
class PermissionItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/permissions/{permission%2Did}');
    ...
    */
    public function toGetRequestInformation(?PermissionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/permissions/{permission%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
