...
use Microsoft\Graph\Beta\Generated\Search\MicrosoftGraphQuery\QueryRequestBuilder;
...
class SearchRequestBuilder 
{
    ...
    */
    public function acronymsById(string $id): AcronymItemRequestBuilder {
        ...
        return new AcronymItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function bookmarksById(string $id): BookmarkItemRequestBuilder {
        ...
        return new BookmarkItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function qnasById(string $id): QnaItemRequestBuilder {
        ...
        return new QnaItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
