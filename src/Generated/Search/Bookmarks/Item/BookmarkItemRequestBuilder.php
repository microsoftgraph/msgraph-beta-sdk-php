...
class BookmarkItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $bookmarkId key: id of bookmark
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $bookmarkId = null) {
        $this->urlTemplate = '{+baseurl}/search/bookmarks/{bookmark%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['bookmarkId'] = $bookmarkId;
