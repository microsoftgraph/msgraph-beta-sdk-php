...
class BookmarkItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/search-bookmark-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/search-bookmark-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<Bookmark|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/search-bookmark-update?view=graph-rest-beta Find more info here
    */
