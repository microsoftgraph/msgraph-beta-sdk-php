...
class AcronymItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/search-acronym-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/search-acronym-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<Acronym|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/search-acronym-update?view=graph-rest-beta Find more info here
    */
