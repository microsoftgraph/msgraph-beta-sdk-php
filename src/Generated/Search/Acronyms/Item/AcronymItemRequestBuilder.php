...
class AcronymItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $acronymId key: id of acronym
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $acronymId = null) {
        $this->urlTemplate = '{+baseurl}/search/acronyms/{acronym%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['acronymId'] = $acronymId;
