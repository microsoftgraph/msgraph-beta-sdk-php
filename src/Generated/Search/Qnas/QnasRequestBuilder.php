...
*/
class QnasRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/search-searchentity-list-qnas?view=graph-rest-beta Find more info here
    */
    public function get(?QnasRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [QnaCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/search-searchentity-post-qnas?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?QnasRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/search/qnas{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(Qna $body, ?QnasRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/search/qnas';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): QnasRequestBuilder {
        return new QnasRequestBuilder($rawUrl, $this->requestAdapter);
    }
