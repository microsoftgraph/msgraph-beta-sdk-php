...
class QnaItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $qnaId key: id of qna
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $qnaId = null) {
        $this->urlTemplate = '{+baseurl}/search/qnas/{qna%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['qnaId'] = $qnaId;
