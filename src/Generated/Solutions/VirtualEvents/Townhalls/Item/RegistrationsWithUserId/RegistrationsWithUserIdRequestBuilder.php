...
use Microsoft\Graph\Beta\Generated\Solutions\VirtualEvents\Townhalls\Item\RegistrationsWithUserId\Cancel\CancelRequestBuilder;
...
class RegistrationsWithUserIdRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $userId = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(userId=\'{userId}\')');
    ...
    */
    public function toGetRequestInformation(?RegistrationsWithUserIdRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(userId=\'{userId}\'){?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
