...
use Microsoft\Graph\Beta\Generated\Solutions\VirtualEvents\Townhalls\Item\RegistrationConfiguration\Questions\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Solutions\VirtualEvents\Townhalls\Item\RegistrationConfiguration\Questions\Item\VirtualEventRegistrationQuestionBaseItemRequestBuilder;
...
class QuestionsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?QuestionsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrationConfiguration/questions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(VirtualEventRegistrationQuestionBase $body, ?QuestionsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrationConfiguration/questions';
        $requestInfo->pathParameters = $this->pathParameters;
