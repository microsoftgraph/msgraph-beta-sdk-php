...
use Microsoft\Graph\Beta\Generated\Solutions\VirtualEvents\Townhalls\Item\Registrations\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Solutions\VirtualEvents\Townhalls\Item\Registrations\Item\VirtualEventRegistrationItemRequestBuilder;
...
class RegistrationsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?RegistrationsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(VirtualEventRegistration $body, ?RegistrationsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations';
        $requestInfo->pathParameters = $this->pathParameters;
