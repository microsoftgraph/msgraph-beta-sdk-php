...
use Microsoft\Graph\Beta\Generated\Solutions\VirtualEvents\Townhalls\Item\RegistrationsWithEmail\Cancel\CancelRequestBuilder;
...
class RegistrationsWithEmailRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $email = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(email=\'{email}\')');
    ...
    */
    public function toGetRequestInformation(?RegistrationsWithEmailRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(email=\'{email}\'){?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
