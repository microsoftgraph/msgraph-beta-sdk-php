...
namespace Microsoft\\Graph\\Beta\\Generated\Solutions\VirtualEvents\Events\Item\Presenters\Item\SessionsWithJoinWebUrl;
...
class SessionsWithJoinWebUrlRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $joinWebUrl = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/presenters/{virtualEventPresenter%2Did}/sessions(joinWebUrl=\'{joinWebUrl}\'){?%24expand,%24select}');
