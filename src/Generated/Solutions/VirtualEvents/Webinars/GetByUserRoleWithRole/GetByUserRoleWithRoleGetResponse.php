...
namespace Microsoft\Graph\Beta\Generated\Solutions\VirtualEvents\Webinars\GetByUserRoleWithRole;
...
class GetByUserRoleWithRoleGetResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetByUserRoleWithRoleGetResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([VirtualEventWebinar::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
     ...
     * @param array<VirtualEventWebinar>|null $value Value to set for the value property.
    */
