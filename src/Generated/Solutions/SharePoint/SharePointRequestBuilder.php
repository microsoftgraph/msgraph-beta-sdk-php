...
use Microsoft\Graph\Beta\Generated\Models\SharePointRoot;
use Microsoft\Graph\Beta\Generated\Solutions\SharePoint\Migrations\MigrationsRequestBuilder;
...
class SharePointRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/sharePoint');
    ...
    */
     ...
     * @return Promise<SharePointRoot|null>
     * @throws Exception
    */
    public function get(?SharePointRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [SharePointRoot::class, 'createFromDiscriminatorValue'], $errorMappings);
    }

    /**
     * Update the navigation property sharePoint in solutions
     * @param SharePointRoot $body The request body
     ...
     * @throws Exception
    */
    public function patch(SharePointRoot $body, ?SharePointRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?SharePointRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/sharePoint{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(SharePointRoot $body, ?SharePointRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
