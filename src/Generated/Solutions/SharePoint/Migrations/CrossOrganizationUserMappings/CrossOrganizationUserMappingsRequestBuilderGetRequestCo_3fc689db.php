...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: crossOrganizationUserMappingsRequestBuilderGetRequestConfiguration
*/
class CrossOrganizationUserMappingsRequestBuilderGetRequestCo_3fc689db extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CrossOrganizationUserMappingsRequestBuilderGetRequestCo_3fc689db and sets the default values.
