...
*/
class SharePointGroupIdentityMappingItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/sharePoint/migrations/crossOrganizationGroupMappings/{sharePointGroupIdentityMapping%2Did}');
    ...
    */
    public function toGetRequestInformation(?SharePointGroupIdentityMappingItemRequestBuilderGetRequ_2bf17795 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/sharePoint/migrations/crossOrganizationGroupMappings/{sharePointGroupIdentityMapping%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): SharePointGroupIdentityMappingItemRequestBuilder {
        return new SharePointGroupIdentityMappingItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
