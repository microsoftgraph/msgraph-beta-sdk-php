...
/**
 * Provides operations to call the getBySourceGroupMailNickname method. Original name: getBySourceGroupMailNicknameWithSourceGroupMailNicknameRequestBuilder
*/
class GetBySourceGroupMailNicknameWithSourceGroupMailNickname_13802845 extends BaseRequestBuilder 
{
    /**
     * Instantiates a new GetBySourceGroupMailNicknameWithSourceGroupMailNickname_13802845 and sets the default values.
    ...
    */
     ...
     * @param GetBySourceGroupMailNicknameWithSourceGroupMailNickname_3fbd99bd|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
    ...
    */
    public function get(?GetBySourceGroupMailNicknameWithSourceGroupMailNickname_3fbd99bd $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?GetBySourceGroupMailNicknameWithSourceGroupMailNickname_3fbd99bd $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): GetBySourceGroupMailNicknameWithSourceGroupMailNickname_13802845 {
        return new GetBySourceGroupMailNicknameWithSourceGroupMailNickname_13802845($rawUrl, $this->requestAdapter);
    }
