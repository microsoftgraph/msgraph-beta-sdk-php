...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: ExchangeProtectionPolicyItemRequestBuilderGetRequestConfiguration
*/
class ExchangeProtectionPolicyItemRequestBuilderGetRequestCon_364255e4 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ExchangeProtectionPolicyItemRequestBuilderGetRequestCon_364255e4 and sets the default values.
