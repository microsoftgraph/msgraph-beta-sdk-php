...
use Microsoft\Graph\Beta\Generated\Models\SharePointBrowseSession;
...
class SharePointBrowseSessionItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/sharepointbrowsesession-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?SharePointBrowseSessionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/backupRestore/sharePointBrowseSessions/{sharePointBrowseSession%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
