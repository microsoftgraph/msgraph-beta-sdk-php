...
namespace Microsoft\Graph\Beta\Generated\Solutions\BackupRestore\DriveInclusionRules;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\DriveProtectionRule;
use Microsoft\Graph\Beta\Generated\Models\DriveProtectionRuleCollectionResponse;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Solutions\BackupRestore\DriveInclusionRules\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Solutions\BackupRestore\DriveInclusionRules\Item\DriveProtectionRuleItemRequestBuilder;
...
class DriveInclusionRulesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param DriveProtectionRule $body The request body
     * @param DriveInclusionRulesRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<DriveProtectionRule|null>
     * @throws Exception
    */
    public function post(DriveProtectionRule $body, ?DriveInclusionRulesRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?DriveInclusionRulesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/solutions/backupRestore/driveInclusionRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(DriveProtectionRule $body, ?DriveInclusionRulesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/backupRestore/driveInclusionRules';
        $requestInfo->pathParameters = $this->pathParameters;
