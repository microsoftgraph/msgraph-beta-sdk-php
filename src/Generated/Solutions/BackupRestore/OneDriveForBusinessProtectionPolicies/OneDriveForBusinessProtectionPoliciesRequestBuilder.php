...
use Microsoft\Graph\Beta\Generated\Models\OneDriveForBusinessProtectionPolicyCollectionResponse;
use Microsoft\Graph\Beta\Generated\Solutions\BackupRestore\OneDriveForBusinessProtectionPolicies\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Solutions\BackupRestore\OneDriveForBusinessProtectionPolicies\Item\OneDriveForBusinessProtectionPolicyItemRequestBuilder;
...
class OneDriveForBusinessProtectionPoliciesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/backuprestoreroot-post-onedriveforbusinessprotectionpolicies?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?OneDriveForBusinessProtectionPoliciesRequestBuilderGetR_438da6fb $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/solutions/backupRestore/oneDriveForBusinessProtectionPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(OneDriveForBusinessProtectionPolicy $body, ?OneDriveForBusinessProtectionPoliciesRequestBuilderPost_37571801 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/backupRestore/oneDriveForBusinessProtectionPolicies';
        $requestInfo->pathParameters = $this->pathParameters;
