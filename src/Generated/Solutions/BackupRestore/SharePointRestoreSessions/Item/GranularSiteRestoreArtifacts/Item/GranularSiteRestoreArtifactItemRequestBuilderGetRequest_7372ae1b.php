...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: GranularSiteRestoreArtifactItemRequestBuilderGetRequestConfiguration
*/
class GranularSiteRestoreArtifactItemRequestBuilderGetRequest_7372ae1b extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GranularSiteRestoreArtifactItemRequestBuilderGetRequest_7372ae1b and sets the default values.
