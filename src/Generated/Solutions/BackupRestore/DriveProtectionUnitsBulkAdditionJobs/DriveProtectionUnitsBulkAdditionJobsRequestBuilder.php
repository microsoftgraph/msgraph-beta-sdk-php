...
use Microsoft\Graph\Beta\Generated\Models\DriveProtectionUnitsBulkAdditionJob;
use Microsoft\Graph\Beta\Generated\Models\DriveProtectionUnitsBulkAdditionJobCollectionResponse;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Solutions\BackupRestore\DriveProtectionUnitsBulkAdditionJobs\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Solutions\BackupRestore\DriveProtectionUnitsBulkAdditionJobs\Item\DriveProtectionUnitsBulkAdditionJobItemRequestBuilder;
...
class DriveProtectionUnitsBulkAdditionJobsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param DriveProtectionUnitsBulkAdditionJobsRequestBuilderPostR_57f9aace|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<DriveProtectionUnitsBulkAdditionJob|null>
     * @throws Exception
    */
    public function post(DriveProtectionUnitsBulkAdditionJob $body, ?DriveProtectionUnitsBulkAdditionJobsRequestBuilderPostR_57f9aace $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?DriveProtectionUnitsBulkAdditionJobsRequestBuilderGetRe_5271b05c $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/solutions/backupRestore/driveProtectionUnitsBulkAdditionJobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(DriveProtectionUnitsBulkAdditionJob $body, ?DriveProtectionUnitsBulkAdditionJobsRequestBuilderPostR_57f9aace $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/backupRestore/driveProtectionUnitsBulkAdditionJobs';
        $requestInfo->pathParameters = $this->pathParameters;
