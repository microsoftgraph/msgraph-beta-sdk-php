...
namespace Microsoft\Graph\Beta\Generated\Solutions\BookingBusinesses\Item\Appointments\Item\Cancel;
...
class CancelPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getCancellationMessage(): ?string {
        $val = $this->getBackingStore()->get('cancellationMessage');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'cancellationMessage'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'cancellationMessage' => fn(ParseNode $n) => $o->setCancellationMessage($n->getStringValue()),
        ];
    }
