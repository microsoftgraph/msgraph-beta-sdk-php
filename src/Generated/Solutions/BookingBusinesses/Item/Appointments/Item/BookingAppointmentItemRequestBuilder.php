...
use Microsoft\Graph\Beta\Generated\Solutions\BookingBusinesses\Item\Appointments\Item\Cancel\CancelRequestBuilder;
...
class BookingAppointmentItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/appointments/{bookingAppointment%2Did}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/bookingappointment-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/bookingappointment-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<BookingAppointment|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/bookingappointment-update?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?BookingAppointmentItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/appointments/{bookingAppointment%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
