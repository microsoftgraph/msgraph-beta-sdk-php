...
namespace Microsoft\Graph\Beta\Generated\Solutions\BookingBusinesses\Item\StaffMembers;
...
use Microsoft\Graph\Beta\Generated\Solutions\BookingBusinesses\Item\StaffMembers\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Solutions\BookingBusinesses\Item\StaffMembers\Item\BookingStaffMemberItemRequestBuilder;
...
class StaffMembersRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?StaffMembersRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/staffMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(BookingStaffMember $body, ?StaffMembersRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/staffMembers';
        $requestInfo->pathParameters = $this->pathParameters;
