...
use Microsoft\Graph\Beta\Generated\Solutions\BusinessScenarios\Item\Planner\MicrosoftGraphGetPlan\MicrosoftGraphGetPlanRequestBuilder;
...
class PlannerRequestBuilder 
{
    ...
    */
    public function microsoftGraphGetPlan(): MicrosoftGraphGetPlanRequestBuilder {
        return new MicrosoftGraphGetPlanRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function tasksById(string $id): BusinessScenarioTaskItemRequestBuilder {
        ...
        return new BusinessScenarioTaskItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
