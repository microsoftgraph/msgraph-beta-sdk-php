...
class BusinessScenarioTaskItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $businessScenarioTaskId key: id of businessScenarioTask
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $businessScenarioTaskId = null) {
        ...
        $urlTplParams['businessScenarioTaskId'] = $businessScenarioTaskId;
