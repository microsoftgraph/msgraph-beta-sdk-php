...
class PlannerPlanConfigurationLocalizationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $plannerPlanConfigurationLocalizationId key: id of plannerPlanConfigurationLocalization
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $plannerPlanConfigurationLocalizationId = null) {
        ...
        $urlTplParams['plannerPlanConfigurationLocalizationId'] = $plannerPlanConfigurationLocalizationId;
