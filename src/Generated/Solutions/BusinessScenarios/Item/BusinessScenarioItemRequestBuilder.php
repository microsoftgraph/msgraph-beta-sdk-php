...
class BusinessScenarioItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $businessScenarioId key: id of businessScenario
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $businessScenarioId = null) {
        $this->urlTemplate = '{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['businessScenarioId'] = $businessScenarioId;
