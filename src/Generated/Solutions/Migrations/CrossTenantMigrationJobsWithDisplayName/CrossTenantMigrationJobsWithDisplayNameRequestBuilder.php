...
class CrossTenantMigrationJobsWithDisplayNameRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $displayName = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/migrations/crossTenantMigrationJobs(displayName=\'{displayName}\')');
     ...
     * @param CrossTenantMigrationJobsWithDisplayNameRequestBuilderDe_75711669|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<void|null>
     * @throws Exception
    */
    public function delete(?CrossTenantMigrationJobsWithDisplayNameRequestBuilderDe_75711669 $requestConfiguration = null): Promise {
     ...
     * @param CrossTenantMigrationJobsWithDisplayNameRequestBuilderGe_aa4d205c|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
    ...
    */
    public function get(?CrossTenantMigrationJobsWithDisplayNameRequestBuilderGe_aa4d205c $requestConfiguration = null): Promise {
     ...
     * @param CrossTenantMigrationJobsWithDisplayNameRequestBuilderPa_f3db2b17|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<CrossTenantMigrationJob|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/crosstenantmigrationjob-update?view=graph-rest-beta Find more info here
    */
    public function patch(CrossTenantMigrationJob $body, ?CrossTenantMigrationJobsWithDisplayNameRequestBuilderPa_f3db2b17 $requestConfiguration = null): Promise {
    ...
    */
    public function toDeleteRequestInformation(?CrossTenantMigrationJobsWithDisplayNameRequestBuilderDe_75711669 $requestConfiguration = null): RequestInformation {
     ...
     * @return RequestInformation
    */
    public function toGetRequestInformation(?CrossTenantMigrationJobsWithDisplayNameRequestBuilderGe_aa4d205c $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/migrations/crossTenantMigrationJobs(displayName=\'{displayName}\'){?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(CrossTenantMigrationJob $body, ?CrossTenantMigrationJobsWithDisplayNameRequestBuilderPa_f3db2b17 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
