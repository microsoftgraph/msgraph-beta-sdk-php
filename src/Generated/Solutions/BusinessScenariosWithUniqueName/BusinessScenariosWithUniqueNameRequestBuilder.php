...
*/
class BusinessScenariosWithUniqueNameRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $uniqueName = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/businessScenarios(uniqueName=\'{uniqueName}\'){?%24select,%24expand}');
    ...
    */
    public function withUrl(string $rawUrl): BusinessScenariosWithUniqueNameRequestBuilder {
        return new BusinessScenariosWithUniqueNameRequestBuilder($rawUrl, $this->requestAdapter);
    }
