...
namespace Microsoft\Graph\Beta\Generated\Solutions\BookingCurrencies;
...
use Microsoft\Graph\Beta\Generated\Solutions\BookingCurrencies\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Solutions\BookingCurrencies\Item\BookingCurrencyItemRequestBuilder;
...
class BookingCurrenciesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/bookingcurrency-list?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?BookingCurrenciesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/solutions/bookingCurrencies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(BookingCurrency $body, ?BookingCurrenciesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/bookingCurrencies';
        $requestInfo->pathParameters = $this->pathParameters;
