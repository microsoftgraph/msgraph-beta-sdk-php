...
namespace Microsoft\Graph\Beta\Generated\Solutions\BookingCurrencies\Item;
...
class BookingCurrencyItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/solutions/bookingCurrencies/{bookingCurrency%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/bookingcurrency-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?BookingCurrencyItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/solutions/bookingCurrencies/{bookingCurrency%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
