...
class CategoriesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/applicationTemplates/categories(){?%24count,%24filter,%24search,%24skip,%24top}');
     ...
     * @return Promise<CategoriesGetResponse|null>
     * @throws Exception
    */
    public function get(?CategoriesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [CategoriesGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
