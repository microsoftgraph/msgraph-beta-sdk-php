...
class ControlsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the controls property of the microsoft.graph.program entity.
     * @param string $programControlId Unique identifier of the item
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/programs/{program%2Did}/controls{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
