...
namespace Microsoft\Graph\Beta\Generated\Domains\Item\ForceDelete;
...
class ForceDeletePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ForceDeletePostRequestBody {
    ...
    */
    public function getDisableUserAccounts(): ?bool {
        $val = $this->getBackingStore()->get('disableUserAccounts');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'disableUserAccounts'");
    }
    ...
    */
    public function setDisableUserAccounts(?bool $value): void {
        $this->getBackingStore()->set('disableUserAccounts', $value);
    }
