...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: InternalDomainFederationItemRequestBuilderGetRequestConfiguration
*/
class InternalDomainFederationItemRequestBuilderGetRequestCon_3b4e2569 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new InternalDomainFederationItemRequestBuilderGetRequestCon_3b4e2569 and sets the default values.
