...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: sharedEmailDomainInvitationsRequestBuilderGetRequestConfiguration
*/
class SharedEmailDomainInvitationsRequestBuilderGetRequestCon_5f9d1b44 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SharedEmailDomainInvitationsRequestBuilderGetRequestCon_5f9d1b44 and sets the default values.
