...
class SharedEmailDomainInvitationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $sharedEmailDomainInvitationId key: id of sharedEmailDomainInvitation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $sharedEmailDomainInvitationId = null) {
        ...
        $urlTplParams['sharedEmailDomainInvitationId'] = $sharedEmailDomainInvitationId;
