...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: SignInEventsAppActivityAppItemRequestBuilderGetRequestConfiguration
*/
class SignInEventsAppActivityAppItemRequestBuilderGetRequestC_eae4649a extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SignInEventsAppActivityAppItemRequestBuilderGetRequestC_eae4649a and sets the default values.
