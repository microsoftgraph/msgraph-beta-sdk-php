...
class DirectoryAuditItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/auditLogs/directoryAudits/{directoryAudit%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/directoryaudit-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?DirectoryAuditItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/auditLogs/directoryAudits/{directoryAudit%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
