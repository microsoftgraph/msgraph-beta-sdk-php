...
/**
 * Returns aggregated non-interactive sign-in event counts grouped by user, application, IP address, and time window, with drill-down capability using individual requestIds via the /signIns endpoint. This includes autonomous agent sign-in events. Original name: getSummarizedNonInteractiveSignInsWithAggregationWindowRequestBuilderGetQueryParameters
*/
class GetSummarizedNonInteractiveSignInsWithAggregationWindow_44b75b36 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetSummarizedNonInteractiveSignInsWithAggregationWindow_44b75b36 and sets the default values.
