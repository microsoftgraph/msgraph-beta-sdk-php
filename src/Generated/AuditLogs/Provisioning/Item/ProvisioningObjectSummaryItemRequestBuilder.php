...
class ProvisioningObjectSummaryItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $provisioningObjectSummaryId key: id of provisioningObjectSummary
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $provisioningObjectSummaryId = null) {
        $this->urlTemplate = '{+baseurl}/auditLogs/provisioning/{provisioningObjectSummary%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['provisioningObjectSummaryId'] = $provisioningObjectSummaryId;
