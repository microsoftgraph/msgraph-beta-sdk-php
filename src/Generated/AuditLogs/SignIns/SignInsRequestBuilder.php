...
use Microsoft\Graph\Beta\Generated\AuditLogs\SignIns\MicrosoftGraphConfirmCompromised\MicrosoftGraphConfirmCompromisedRequestBuilder;
use Microsoft\Graph\Beta\Generated\AuditLogs\SignIns\MicrosoftGraphConfirmSafe\MicrosoftGraphConfirmSafeRequestBuilder;
...
class SignInsRequestBuilder 
{
    ...
    */
    public function microsoftGraphConfirmSafe(): MicrosoftGraphConfirmSafeRequestBuilder {
        return new MicrosoftGraphConfirmSafeRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/signin-list?view=graph-rest-1.0 Find more info here
    */
