...
*/
class GetSummarizedMSISignInsWithAggregationWindowRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $aggregationWindow = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/auditLogs/getSummarizedMSISignIns(aggregationWindow=\'{aggregationWindow}\'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function get(?GetSummarizedMSISignInsWithAggregationWindowRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [GetSummarizedMSISignInsWithAggregationWindowGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function withUrl(string $rawUrl): GetSummarizedMSISignInsWithAggregationWindowRequestBuilder {
        return new GetSummarizedMSISignInsWithAggregationWindowRequestBuilder($rawUrl, $this->requestAdapter);
    }
