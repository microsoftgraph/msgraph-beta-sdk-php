...
/**
 * Returns aggregated service principal sign-in event counts grouped by user, application, IP address, and time window, with drill-down capability using individual requestIds via the /signIns endpoint. This includes autonomous agent sign-in events. Original name: getSummarizedServicePrincipalSignInsWithAggregationWindowRequestBuilderGetQueryParameters
*/
class GetSummarizedServicePrincipalSignInsWithAggregationWind_04f38ece 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetSummarizedServicePrincipalSignInsWithAggregationWind_04f38ece and sets the default values.
