...
*/
class CustomSecurityAttributeAuditItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/auditLogs/customSecurityAttributeAudits/{customSecurityAttributeAudit%2Did}{?%24select,%24expand}');
    ...
    */
    public function withUrl(string $rawUrl): CustomSecurityAttributeAuditItemRequestBuilder {
        return new CustomSecurityAttributeAuditItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
