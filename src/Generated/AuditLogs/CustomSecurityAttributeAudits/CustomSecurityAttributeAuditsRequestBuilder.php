...
class CustomSecurityAttributeAuditsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param CustomSecurityAttributeAuditsRequestBuilderGetRequestCo_756db1bd|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
    ...
    */
    public function get(?CustomSecurityAttributeAuditsRequestBuilderGetRequestCo_756db1bd $requestConfiguration = null): Promise {
     ...
     * @param CustomSecurityAttributeAuditsRequestBuilderPostRequestC_958d4dc5|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<CustomSecurityAttributeAudit|null>
     * @throws Exception
    */
    public function post(CustomSecurityAttributeAudit $body, ?CustomSecurityAttributeAuditsRequestBuilderPostRequestC_958d4dc5 $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?CustomSecurityAttributeAuditsRequestBuilderGetRequestCo_756db1bd $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/auditLogs/customSecurityAttributeAudits{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(CustomSecurityAttributeAudit $body, ?CustomSecurityAttributeAuditsRequestBuilderPostRequestC_958d4dc5 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/auditLogs/customSecurityAttributeAudits';
        $requestInfo->pathParameters = $this->pathParameters;
