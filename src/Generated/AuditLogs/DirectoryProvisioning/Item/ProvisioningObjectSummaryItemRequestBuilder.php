...
class ProvisioningObjectSummaryItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/auditLogs/directoryProvisioning/{provisioningObjectSummary%2Did}');
    ...
    */
    public function toGetRequestInformation(?ProvisioningObjectSummaryItemRequestBuilderGetRequestCo_de568d79 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/auditLogs/directoryProvisioning/{provisioningObjectSummary%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
