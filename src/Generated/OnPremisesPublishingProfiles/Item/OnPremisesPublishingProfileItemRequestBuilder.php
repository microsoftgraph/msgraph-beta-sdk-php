...
class OnPremisesPublishingProfileItemRequestBuilder 
{
    ...
    */
    public function agentsById(string $id): OnPremisesAgentItemRequestBuilder {
        ...
        return new OnPremisesAgentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
     ...
     * @param string|null $onPremisesPublishingProfileId key: id of onPremisesPublishingProfile
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $onPremisesPublishingProfileId = null) {
    ...
    */
    public function publishedResourcesById(string $id): PublishedResourceItemRequestBuilder {
        ...
        return new PublishedResourceItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
