...
class OnPremisesPublishingProfileItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $onPremisesPublishingProfileId = null) {
        ...
        $urlTplParams['onPremisesPublishingProfileId'] = $onPremisesPublishingProfileId;
