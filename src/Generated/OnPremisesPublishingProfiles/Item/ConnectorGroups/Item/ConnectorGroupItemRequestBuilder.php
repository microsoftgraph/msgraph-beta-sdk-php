...
class ConnectorGroupItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $connectorGroupId = null) {
        ...
        $urlTplParams['connectorGroupId'] = $connectorGroupId;
