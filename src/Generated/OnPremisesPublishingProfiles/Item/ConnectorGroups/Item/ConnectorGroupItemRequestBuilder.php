...
class ConnectorGroupItemRequestBuilder 
{
    ...
    */
    public function applicationsById(string $id): ApplicationItemRequestBuilder {
        ...
        return new ApplicationItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $connectorGroupId key: id of connectorGroup
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $connectorGroupId = null) {
    ...
    */
    public function membersById(string $id): ConnectorItemRequestBuilder {
        ...
        return new ConnectorItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
