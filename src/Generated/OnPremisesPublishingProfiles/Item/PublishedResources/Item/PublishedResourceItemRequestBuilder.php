...
class PublishedResourceItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $publishedResourceId = null) {
        ...
        $urlTplParams['publishedResourceId'] = $publishedResourceId;
