...
class OnPremisesAgentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $onPremisesAgentId key: id of onPremisesAgent
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $onPremisesAgentId = null) {
