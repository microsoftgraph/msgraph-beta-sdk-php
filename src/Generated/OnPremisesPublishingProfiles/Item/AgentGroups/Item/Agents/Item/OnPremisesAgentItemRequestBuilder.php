...
class OnPremisesAgentItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $onPremisesAgentId = null) {
        ...
        $urlTplParams['onPremisesAgentId'] = $onPremisesAgentId;
