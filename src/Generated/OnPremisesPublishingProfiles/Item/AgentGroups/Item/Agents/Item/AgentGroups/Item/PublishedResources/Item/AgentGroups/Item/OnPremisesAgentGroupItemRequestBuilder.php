...
namespace Microsoft\Graph\Beta\Generated\OnPremisesPublishingProfiles\Item\AgentGroups\Item\Agents\Item\AgentGroups\Item\PublishedResources\Item\AgentGroups\Item;
...
class OnPremisesAgentGroupItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile_id}/agentGroups/{onPremisesAgentGroup_id}/agents/{onPremisesAgent_id}/agentGroups/{onPremisesAgentGroup_id1}/publishedResources/{publishedResource_id}/agentGroups/{onPremisesAgentGroup_id2}{?select,expand}';
