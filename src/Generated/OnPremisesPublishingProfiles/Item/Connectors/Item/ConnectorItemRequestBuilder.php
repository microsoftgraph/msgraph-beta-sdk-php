...
class ConnectorItemRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $connectorId = null) {
    ...
    */
    public function memberOfById(string $id): ConnectorGroupItemRequestBuilder {
        ...
        return new ConnectorGroupItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
