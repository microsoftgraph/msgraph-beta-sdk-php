...
class UpdateRequestRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UpdateRequestRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UpdateRequestRequestBody {
