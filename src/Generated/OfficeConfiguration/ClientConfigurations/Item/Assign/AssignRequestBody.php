...
class AssignRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'officeConfigurationAssignments' => function (self $o, ParseNode $n) { $o->setOfficeConfigurationAssignments($n->getCollectionOfObjectValues(OfficeClientConfigurationAssignment::class)); },
        ];
    }
