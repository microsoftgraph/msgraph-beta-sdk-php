...
namespace Microsoft\Graph\Beta\Generated\OfficeConfiguration\ClientConfigurations\Item\MicrosoftGraphAssign;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([OfficeClientConfigurationAssignment::class, 'createFromDiscriminatorValue'])),
        ]);
    }
