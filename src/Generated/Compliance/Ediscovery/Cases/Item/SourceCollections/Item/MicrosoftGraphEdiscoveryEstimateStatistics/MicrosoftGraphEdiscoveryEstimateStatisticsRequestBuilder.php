...
class MicrosoftGraphEdiscoveryEstimateStatisticsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphEdiscoveryEstimateStatisticsRequestBuilde_735c7ed0|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
    ...
    */
    public function post(?MicrosoftGraphEdiscoveryEstimateStatisticsRequestBuilde_735c7ed0 $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?MicrosoftGraphEdiscoveryEstimateStatisticsRequestBuilde_735c7ed0 $requestConfiguration = null): RequestInformation {
