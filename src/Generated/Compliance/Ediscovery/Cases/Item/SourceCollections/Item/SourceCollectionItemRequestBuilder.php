...
class SourceCollectionItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $sourceCollectionId = null) {
        ...
        $urlTplParams['sourceCollectionId'] = $sourceCollectionId;
