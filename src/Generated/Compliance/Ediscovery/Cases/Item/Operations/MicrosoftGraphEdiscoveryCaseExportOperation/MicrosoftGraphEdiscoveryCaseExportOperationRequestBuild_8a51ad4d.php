...
class MicrosoftGraphEdiscoveryCaseExportOperationRequestBuild_8a51ad4d extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): MicrosoftGraphEdiscoveryCaseExportOperationRequestBuild_6a55fe82 {
        return new MicrosoftGraphEdiscoveryCaseExportOperationRequestBuild_6a55fe82($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
