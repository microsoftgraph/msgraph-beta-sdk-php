...
class AsHierarchyResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([\Microsoft\Graph\Beta\Generated\Models\Ediscovery\Tag::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
     ...
     * @param array<\Microsoft\Graph\Beta\Generated\Models\Ediscovery\Tag>|null $value Value to set for the value property.
    */
