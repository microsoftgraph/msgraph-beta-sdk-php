...
class TagItemRequestBuilder 
{
    ...
    */
    public function childTagsById(string $id): \Microsoft\Graph\Beta\Generated\Compliance\Ediscovery\Cases\Item\Tags\Item\ChildTags\Item\TagItemRequestBuilder {
        ...
        return new \Microsoft\Graph\Beta\Generated\Compliance\Ediscovery\Cases\Item\Tags\Item\ChildTags\Item\TagItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @param string|null $tagId key: id of tag
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $tagId = null) {
