...
class TagItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $tagId1 key: id of tag
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $tagId1 = null) {
