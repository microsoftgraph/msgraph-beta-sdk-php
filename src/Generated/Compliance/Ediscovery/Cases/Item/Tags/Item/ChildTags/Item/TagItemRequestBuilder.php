...
class TagItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/compliance/ediscovery/cases/{case%2Did}/tags/{tag%2Did}/childTags/{tag%2Did1}{?%24expand,%24select}');
    ...
    */
    public function withUrl(string $rawUrl): TagItemRequestBuilder {
        return new TagItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
