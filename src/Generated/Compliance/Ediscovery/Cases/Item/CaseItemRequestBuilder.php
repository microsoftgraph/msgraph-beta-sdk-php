...
use Microsoft\Graph\Beta\Generated\Compliance\Ediscovery\Cases\Item\MicrosoftGraphEdiscoveryClose\CloseRequestBuilder;
use Microsoft\Graph\Beta\Generated\Compliance\Ediscovery\Cases\Item\MicrosoftGraphEdiscoveryReopen\ReopenRequestBuilder;
...
class CaseItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphEdiscoveryClose(): CloseRequestBuilder {
    ...
    */
    public function microsoftGraphEdiscoveryReopen(): ReopenRequestBuilder {
    ...
    */
     ...
     * @param string|null $caseId key: id of case
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $caseId = null) {
    ...
    */
    public function custodiansById(string $id): CustodianItemRequestBuilder {
        ...
        return new CustodianItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function legalHoldsById(string $id): LegalHoldItemRequestBuilder {
        ...
        return new LegalHoldItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function reviewSetsById(string $id): ReviewSetItemRequestBuilder {
        ...
        return new ReviewSetItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function sourceCollectionsById(string $id): SourceCollectionItemRequestBuilder {
        ...
        return new SourceCollectionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function tagsById(string $id): TagItemRequestBuilder {
        ...
        return new TagItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
