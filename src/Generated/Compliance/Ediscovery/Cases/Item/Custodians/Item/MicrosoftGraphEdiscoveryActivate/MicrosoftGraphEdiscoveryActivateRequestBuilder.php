...
*/
class MicrosoftGraphEdiscoveryActivateRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/{custodian%2Did}/microsoft.graph.ediscovery.activate');
    ...
    */
     ...
     * @return MicrosoftGraphEdiscoveryActivateRequestBuilder
    */
    public function withUrl(string $rawUrl): MicrosoftGraphEdiscoveryActivateRequestBuilder {
        return new MicrosoftGraphEdiscoveryActivateRequestBuilder($rawUrl, $this->requestAdapter);
    }
