...
use Microsoft\Graph\Beta\Generated\Compliance\Ediscovery\Cases\Item\ReviewSets\Item\Queries\Item\MicrosoftGraphEdiscoveryApplyTags\ApplyTagsRequestBuilder;
...
class ReviewSetQueryItemRequestBuilder 
{
    ...
    */
    public function microsoftGraphEdiscoveryApplyTags(): ApplyTagsRequestBuilder {
    ...
    */
     ...
     * @param string|null $reviewSetQueryId key: id of reviewSetQuery
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $reviewSetQueryId = null) {
        ...
        $urlTplParams['reviewSetQueryId'] = $reviewSetQueryId;
