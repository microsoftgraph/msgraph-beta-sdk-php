...
*/
class MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/compliance/ediscovery/cases/{case%2Did}/reviewSets/{reviewSet%2Did}/microsoft.graph.ediscovery.addToReviewSet');
     ...
     * @return Promise
     * @link https://learn.microsoft.com/graph/api/ediscovery-reviewset-addtoreviewset?view=graph-rest-1.0 Find more info here
    */
    ...
    */
     ...
     * @return MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder
    */
    public function withUrl(string $rawUrl): MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder {
        return new MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder($rawUrl, $this->requestAdapter);
    }
