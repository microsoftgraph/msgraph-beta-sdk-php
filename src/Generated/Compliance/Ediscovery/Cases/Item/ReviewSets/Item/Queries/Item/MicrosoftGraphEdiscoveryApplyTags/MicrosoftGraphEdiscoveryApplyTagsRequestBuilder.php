...
class MicrosoftGraphEdiscoveryApplyTagsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @return MicrosoftGraphEdiscoveryApplyTagsRequestBuilder
    */
    public function withUrl(string $rawUrl): MicrosoftGraphEdiscoveryApplyTagsRequestBuilder {
        return new MicrosoftGraphEdiscoveryApplyTagsRequestBuilder($rawUrl, $this->requestAdapter);
    }
