...
class ExportRequestBuilder 
{
    ...
    */
    public function createPostRequestInformation(ExportPostRequestBody $body, ?ExportRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(ExportPostRequestBody $body, ?ExportRequestBuilderPostRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
