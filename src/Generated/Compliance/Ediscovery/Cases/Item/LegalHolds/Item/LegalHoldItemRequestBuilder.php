...
class LegalHoldItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $legalHoldId key: id of legalHold
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $legalHoldId = null) {
        ...
        $urlTplParams['legalHoldId'] = $legalHoldId;
