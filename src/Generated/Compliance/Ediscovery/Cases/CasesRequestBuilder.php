...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\Ediscovery\CaseCollectionResponse;
...
class CasesRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/compliance/ediscovery/cases{?top,skip,search,filter,count,orderby,select,expand}';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(EscapedCase $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, CaseCollectionResponse::class, $responseHandler);
        } catch(Exception $ex) {
     ...
     * @return Promise
    */
    public function post(EscapedCase $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
