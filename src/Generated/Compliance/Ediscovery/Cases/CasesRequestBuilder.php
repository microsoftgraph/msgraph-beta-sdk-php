...
class CasesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the cases property of the microsoft.graph.ediscovery.ediscoveryroot entity.
     * @param string $caseId Unique identifier of the item
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/ediscovery-case-list?view=graph-rest-1.0 Find more info here
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/ediscovery-case-post?view=graph-rest-1.0 Find more info here
    */
