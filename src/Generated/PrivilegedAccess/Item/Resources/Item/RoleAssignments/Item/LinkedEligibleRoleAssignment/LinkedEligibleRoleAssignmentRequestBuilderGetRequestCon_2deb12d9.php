...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: linkedEligibleRoleAssignmentRequestBuilderGetRequestConfiguration
*/
class LinkedEligibleRoleAssignmentRequestBuilderGetRequestCon_2deb12d9 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new LinkedEligibleRoleAssignmentRequestBuilderGetRequestCon_2deb12d9 and sets the default values.
