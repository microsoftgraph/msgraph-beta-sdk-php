...
namespace Microsoft\Graph\Beta\Generated\PrivilegedAccess\Item\Resources\Item\RoleAssignments\Item;

use Microsoft\Kiota\Abstractions\BaseRequestConfiguration;
use Microsoft\Kiota\Abstractions\RequestOption;

/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: GovernanceRoleAssignmentItemRequestBuilderGetRequestConfiguration
*/
class GovernanceRoleAssignmentItemRequestBuilderGetRequestCon_5742a7a1 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GovernanceRoleAssignmentItemRequestBuilderGetRequestCon_5742a7a1 and sets the default values.
