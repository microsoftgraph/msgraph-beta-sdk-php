...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: GovernanceRoleDefinitionItemRequestBuilderGetRequestConfiguration
*/
class GovernanceRoleDefinitionItemRequestBuilderGetRequestCon_ea7199cb extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GovernanceRoleDefinitionItemRequestBuilderGetRequestCon_ea7199cb and sets the default values.
