...
class GovernanceRoleDefinitionItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/privilegedAccess/{privilegedAccess_id}/resources/{governanceResource_id}/roleDefinitions/{governanceRoleDefinition_id}{?select,expand}';
