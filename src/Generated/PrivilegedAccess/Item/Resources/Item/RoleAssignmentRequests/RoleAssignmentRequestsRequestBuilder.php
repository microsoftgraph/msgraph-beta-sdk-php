...
class RoleAssignmentRequestsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/privilegedAccess/{privilegedAccess_id}/resources/{governanceResource_id}/roleAssignmentRequests{?top,skip,search,filter,count,orderby,select,expand}';
