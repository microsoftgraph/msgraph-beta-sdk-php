...
class PrivilegedAccessItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedAccessId key: id of privilegedAccess
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $privilegedAccessId = null) {
    ...
    */
    public function resourcesById(string $id): GovernanceResourceItemRequestBuilder {
        ...
        return new GovernanceResourceItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function roleAssignmentRequestsById(string $id): GovernanceRoleAssignmentRequestItemRequestBuilder {
        ...
        return new GovernanceRoleAssignmentRequestItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function roleAssignmentsById(string $id): GovernanceRoleAssignmentItemRequestBuilder {
        ...
        return new GovernanceRoleAssignmentItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function roleDefinitionsById(string $id): GovernanceRoleDefinitionItemRequestBuilder {
        ...
        return new GovernanceRoleDefinitionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function roleSettingsById(string $id): GovernanceRoleSettingItemRequestBuilder {
        ...
        return new GovernanceRoleSettingItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
