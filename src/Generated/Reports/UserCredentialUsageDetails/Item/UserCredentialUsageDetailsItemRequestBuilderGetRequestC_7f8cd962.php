...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: UserCredentialUsageDetailsItemRequestBuilderGetRequestConfiguration
*/
class UserCredentialUsageDetailsItemRequestBuilderGetRequestC_7f8cd962 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserCredentialUsageDetailsItemRequestBuilderGetRequestC_7f8cd962 and sets the default values.
