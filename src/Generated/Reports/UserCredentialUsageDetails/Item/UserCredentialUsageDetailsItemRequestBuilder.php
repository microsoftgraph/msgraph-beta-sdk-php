...
class UserCredentialUsageDetailsItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userCredentialUsageDetailsId key: id of userCredentialUsageDetails
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userCredentialUsageDetailsId = null) {
        ...
        $urlTplParams['userCredentialUsageDetailsId'] = $userCredentialUsageDetailsId;
