...
class UserCredentialUsageDetailsItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/userCredentialUsageDetails/{userCredentialUsageDetails%2Did}');
    ...
    */
    public function toGetRequestInformation(?UserCredentialUsageDetailsItemRequestBuilderGetRequestC_7f8cd962 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/userCredentialUsageDetails/{userCredentialUsageDetails%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
