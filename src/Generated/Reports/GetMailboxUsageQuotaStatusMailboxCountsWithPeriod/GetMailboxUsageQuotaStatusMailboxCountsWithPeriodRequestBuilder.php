...
*/
class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getMailboxUsageQuotaStatusMailboxCounts(period=\'{period}\')');
