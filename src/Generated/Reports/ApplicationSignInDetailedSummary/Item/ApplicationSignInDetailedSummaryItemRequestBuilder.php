...
class ApplicationSignInDetailedSummaryItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/applicationsignindetailedsummary-get?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function withUrl(string $rawUrl): ApplicationSignInDetailedSummaryItemRequestBuilder {
        return new ApplicationSignInDetailedSummaryItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
