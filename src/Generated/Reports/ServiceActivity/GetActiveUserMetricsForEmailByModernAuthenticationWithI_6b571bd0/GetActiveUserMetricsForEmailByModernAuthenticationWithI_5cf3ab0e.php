...
/**
 * Get all the active usage based on the number of users who signed in with modern authentication across all email apps. Original name: getActiveUserMetricsForEmailByModernAuthenticationWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForEmailByModernAuthenticationWithI_5cf3ab0e 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForEmailByModernAuthenticationWithI_5cf3ab0e and sets the default values.
