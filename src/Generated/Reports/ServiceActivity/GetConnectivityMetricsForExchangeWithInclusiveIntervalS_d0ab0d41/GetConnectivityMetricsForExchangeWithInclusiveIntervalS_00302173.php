...
/**
 * Get estimated connectivity metrics based on the percentage of successful synthetic connections between organization devices and Exchange Online that might include issues outside the control of Microsoft. Original name: getConnectivityMetricsForExchangeWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetConnectivityMetricsForExchangeWithInclusiveIntervalS_00302173 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetConnectivityMetricsForExchangeWithInclusiveIntervalS_00302173 and sets the default values.
