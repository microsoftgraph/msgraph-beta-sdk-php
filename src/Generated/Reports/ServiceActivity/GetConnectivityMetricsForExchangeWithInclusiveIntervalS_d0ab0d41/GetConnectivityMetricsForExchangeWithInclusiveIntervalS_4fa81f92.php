...
*/
class GetConnectivityMetricsForExchangeWithInclusiveIntervalS_4fa81f92 extends BaseRequestBuilder 
{
    /**
     * Instantiates a new GetConnectivityMetricsForExchangeWithInclusiveIntervalS_4fa81f92 and sets the default values.
    ...
    */
     ...
     * @param GetConnectivityMetricsForExchangeWithInclusiveIntervalS_61cc78f2|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<GetConnectivityMetricsForExchangeWithInclusiveIntervalS_7f5ff4e9|null>
     * @throws Exception
    ...
    */
    public function get(?GetConnectivityMetricsForExchangeWithInclusiveIntervalS_61cc78f2 $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        $errorMappings = [
                'XXX' => [ODataError::class, 'createFromDiscriminatorValue'],
        ];
        return $this->requestAdapter->sendAsync($requestInfo, [GetConnectivityMetricsForExchangeWithInclusiveIntervalS_7f5ff4e9::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toGetRequestInformation(?GetConnectivityMetricsForExchangeWithInclusiveIntervalS_61cc78f2 $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): GetConnectivityMetricsForExchangeWithInclusiveIntervalS_4fa81f92 {
        return new GetConnectivityMetricsForExchangeWithInclusiveIntervalS_4fa81f92($rawUrl, $this->requestAdapter);
    }
