...
/**
 * Retrieve the number of remote networks with connected BGP. A remote network represents a location such as a branch office where customer premises equipment (CPE) is connected to the nearest deployment of Global Secure Access service through IPsec tunnels. Original name: getMetricsForNetworkAccessRemoteNetworkBranchesBGPConnectedWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConne_b5deded7 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConne_b5deded7 and sets the default values.
