...
/**
 * Get the number of times users fail to complete interactive MFA sign-ins using the Microsoft Entra MFA cloud service during a specified time period. Sign-in failures happen, for example, when users abandon or cancel MFA requests, or refresh MFA sessions without doing interactive MFA. Original name: getMetricsForMfaSignInFailureWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_9c5066e4 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_9c5066e4 and sets the default values.
