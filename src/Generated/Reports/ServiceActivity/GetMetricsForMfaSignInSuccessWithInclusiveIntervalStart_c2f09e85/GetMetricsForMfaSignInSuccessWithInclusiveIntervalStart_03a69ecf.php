...
/**
 * Get the number of times users successfully completed interactive MFA sign-ins using the Microsoft Entra MFA cloud service during a specified time period. Original name: getMetricsForMfaSignInSuccessWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetMetricsForMfaSignInSuccessWithInclusiveIntervalStart_03a69ecf 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetMetricsForMfaSignInSuccessWithInclusiveIntervalStart_03a69ecf and sets the default values.
