...
/**
 * Get all the active usage based on the number of active users that signed in and started Outlook for the web. Original name: getActiveUserMetricsForOutlookWebByAppOpeningWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_075bdf47 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_075bdf47 and sets the default values.
