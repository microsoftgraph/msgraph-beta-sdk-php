...
/**
 * Get the number of messages successfully delivered by Exchange. Success is based on message delivery within 15 minutes of its receipt by Exchange Online. Original name: getMessageVolumeMetricsForEmailDeliveryWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetMessageVolumeMetricsForEmailDeliveryWithInclusiveInt_b0edd1a2 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetMessageVolumeMetricsForEmailDeliveryWithInclusiveInt_b0edd1a2 and sets the default values.
