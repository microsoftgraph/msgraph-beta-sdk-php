...
/**
 * Get usage metrics based on the number of times users opened the Teams app without error. Original name: getUsageMetricsForTeamsByLaunchWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalSta_d731f334 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalSta_d731f334 and sets the default values.
