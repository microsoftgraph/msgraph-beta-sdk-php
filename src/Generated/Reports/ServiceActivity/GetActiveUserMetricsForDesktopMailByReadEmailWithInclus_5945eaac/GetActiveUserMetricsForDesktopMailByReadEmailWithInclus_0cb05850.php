...
/**
 * Get all the active usage based on the number of users who successfully read emails using desktop mail apps. Original name: getActiveUserMetricsForDesktopMailByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForDesktopMailByReadEmailWithInclus_0cb05850 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForDesktopMailByReadEmailWithInclus_0cb05850 and sets the default values.
