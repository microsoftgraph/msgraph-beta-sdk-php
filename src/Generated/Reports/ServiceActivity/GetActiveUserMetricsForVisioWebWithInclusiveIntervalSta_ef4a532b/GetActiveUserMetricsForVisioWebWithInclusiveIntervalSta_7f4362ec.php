...
/**
 * Get all the active usage based on the number of active users who open or save Visio for the web. Original name: getActiveUserMetricsForVisioWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForVisioWebWithInclusiveIntervalSta_7f4362ec 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForVisioWebWithInclusiveIntervalSta_7f4362ec and sets the default values.
