...
/**
 * Retrieve the number of internet applications that were blocked due to web content filtering policies applied to specific FQDNs using Global Secure Access client. Microsoft Entra Internet Access traffic may be restricted when these policies are enforced. Original name: getMetricsForNetworkAccessInternetAppPolicyBlockedAppsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsW_601ae0fb 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsW_601ae0fb and sets the default values.
