...
/**
 * Get all the active usage based on the number of active users who open or save OneNote for the web. Original name: getActiveUserMetricsForOneNoteWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalS_b7b7d2d1 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalS_b7b7d2d1 and sets the default values.
