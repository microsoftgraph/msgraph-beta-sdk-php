...
/**
 * Get all the active usage based on the number of users who successfully read emails using Outlook for Mac. Original name: getActiveUserMetricsForOutlookMacByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForOutlookMacByReadEmailWithInclusi_318a6538 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForOutlookMacByReadEmailWithInclusi_318a6538 and sets the default values.
