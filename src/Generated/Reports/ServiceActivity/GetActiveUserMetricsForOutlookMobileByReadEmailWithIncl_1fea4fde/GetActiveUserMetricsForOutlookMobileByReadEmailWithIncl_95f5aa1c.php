...
/**
 * Get all the active usage based on the number of users who successfully read emails using Outlook apps for mobile. Original name: getActiveUserMetricsForOutlookMobileByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForOutlookMobileByReadEmailWithIncl_95f5aa1c 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForOutlookMobileByReadEmailWithIncl_95f5aa1c and sets the default values.
