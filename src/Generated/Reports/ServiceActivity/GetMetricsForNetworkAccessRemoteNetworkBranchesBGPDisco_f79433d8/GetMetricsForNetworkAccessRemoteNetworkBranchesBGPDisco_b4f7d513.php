...
*/
class GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b4f7d513 extends BaseRequestBuilder 
{
    /**
     * Instantiates a new GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b4f7d513 and sets the default values.
    ...
    */
     ...
     * @param GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_6f52441c|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_943536a8|null>
     * @throws Exception
    ...
    */
    public function get(?GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_6f52441c $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        $errorMappings = [
                'XXX' => [ODataError::class, 'createFromDiscriminatorValue'],
        ];
        return $this->requestAdapter->sendAsync($requestInfo, [GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_943536a8::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toGetRequestInformation(?GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_6f52441c $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b4f7d513 {
        return new GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b4f7d513($rawUrl, $this->requestAdapter);
    }
