...
/**
 * Get metrics based on the percentage of audio streams for which quality of experience (QoE) telemetry was received by the Teams service. Original name: getAudioStreamQoEMetricsForTeamsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalSt_6520d0f5 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalSt_6520d0f5 and sets the default values.
