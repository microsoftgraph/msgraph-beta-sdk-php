...
/**
 * Get the number of user authentication requests, during a specific time period, that satisfy a Conditional Access policy requiring devices to be managed. Managed devices are computers joined to and managed by your on-premises directory and hybrid devices joined to Microsoft Entra. Original name: getMetricsForConditionalAccessManagedDevicesSignInSuccessWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetMetricsForConditionalAccessManagedDevicesSignInSucce_ca9c970f 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetMetricsForConditionalAccessManagedDevicesSignInSucce_ca9c970f and sets the default values.
