...
/**
 * Retrieve the number of private applications that were allowed using Global Secure Access client. Original name: getMetricsForNetworkAccessPrivateAppsAllowedByConnectorWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetMetricsForNetworkAccessPrivateAppsAllowedByConnector_4cd7c080 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetMetricsForNetworkAccessPrivateAppsAllowedByConnector_4cd7c080 and sets the default values.
