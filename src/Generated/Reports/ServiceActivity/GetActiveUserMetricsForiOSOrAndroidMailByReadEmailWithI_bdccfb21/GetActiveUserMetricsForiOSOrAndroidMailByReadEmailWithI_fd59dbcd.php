...
/**
 * Get all the active usage based on the number of users who successfully read emails using iOS or Android mail apps. Original name: getActiveUserMetricsForiOSOrAndroidMailByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithI_fd59dbcd 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithI_fd59dbcd and sets the default values.
