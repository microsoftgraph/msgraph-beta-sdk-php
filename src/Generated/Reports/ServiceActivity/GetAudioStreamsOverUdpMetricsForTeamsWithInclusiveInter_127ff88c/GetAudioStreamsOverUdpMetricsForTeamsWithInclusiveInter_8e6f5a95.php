...
/**
 * Get metrics based on the percentage of audio streams that were established over User Datagram Protocol. Original name: getAudioStreamsOverUdpMetricsForTeamsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveInter_8e6f5a95 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveInter_8e6f5a95 and sets the default values.
