...
/**
 * Retrieve the number of users' private application access attempts that were allowed using Global Secure Access client. Original name: getMetricsForNetworkAccessPrivateAppUsersAllowedByConnectorWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_b0e5ebff 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_b0e5ebff and sets the default values.
