...
/**
 * Get usage metrics based on the number of times users joined Teams meetings without errors. Original name: getUsageMetricsForTeamsByMeetingsJoinedWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetUsageMetricsForTeamsByMeetingsJoinedWithInclusiveInt_ae883eb5 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetUsageMetricsForTeamsByMeetingsJoinedWithInclusiveInt_ae883eb5 and sets the default values.
