...
/**
 * Get the number of SAML 2.0 authentications successfully processed by the Microsoft Entra cloud service for the tenant during a specified time period. This health signal currently doesn't include WS-FED/SAML 1.1 apps that are integrated with Microsoft Entra. Original name: getMetricsForSamlSignInSuccessWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetMetricsForSamlSignInSuccessWithInclusiveIntervalStar_a121c3e4 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetMetricsForSamlSignInSuccessWithInclusiveIntervalStar_a121c3e4 and sets the default values.
