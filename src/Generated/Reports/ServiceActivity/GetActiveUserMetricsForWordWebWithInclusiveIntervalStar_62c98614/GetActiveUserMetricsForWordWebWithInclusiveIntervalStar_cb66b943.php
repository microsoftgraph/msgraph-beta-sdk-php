...
/**
 * Get all the active usage based on the number of active users who open or save Word for the web. Original name: getActiveUserMetricsForWordWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForWordWebWithInclusiveIntervalStar_cb66b943 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForWordWebWithInclusiveIntervalStar_cb66b943 and sets the default values.
