...
/**
 * Retrieve the number of users allowed by web content filtering policies applied to specific FQDNs using Global Secure Access client. Original name: getMetricsForNetworkAccessInternetAppPolicyAllowedUsersWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetMetricsForNetworkAccessInternetAppPolicyAllowedUsers_9da07249 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetMetricsForNetworkAccessInternetAppPolicyAllowedUsers_9da07249 and sets the default values.
