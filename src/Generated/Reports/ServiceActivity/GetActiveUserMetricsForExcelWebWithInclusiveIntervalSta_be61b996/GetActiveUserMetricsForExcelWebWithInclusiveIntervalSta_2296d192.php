...
/**
 * Get all the active usage based on the number of active users who open or save Excel for the web. Original name: getActiveUserMetricsForExcelWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForExcelWebWithInclusiveIntervalSta_2296d192 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForExcelWebWithInclusiveIntervalSta_2296d192 and sets the default values.
