...
/**
 * Get all the active usage based on the number of active users who open or save PowerPoint for the web. Original name: getActiveUserMetricsForPowerPointWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters
*/
class GetActiveUserMetricsForPowerPointWebWithInclusiveInterv_472b5409 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GetActiveUserMetricsForPowerPointWebWithInclusiveInterv_472b5409 and sets the default values.
