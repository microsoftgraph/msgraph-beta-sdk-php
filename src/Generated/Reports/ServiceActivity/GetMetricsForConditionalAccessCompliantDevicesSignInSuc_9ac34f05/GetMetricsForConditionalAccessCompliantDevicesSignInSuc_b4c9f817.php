...
*/
class GetMetricsForConditionalAccessCompliantDevicesSignInSuc_b4c9f817 extends BaseRequestBuilder 
{
    /**
     * Instantiates a new GetMetricsForConditionalAccessCompliantDevicesSignInSuc_b4c9f817 and sets the default values.
    ...
    */
     ...
     * @param GetMetricsForConditionalAccessCompliantDevicesSignInSuc_cf953483|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<GetMetricsForConditionalAccessCompliantDevicesSignInSuc_d034e2da|null>
     * @throws Exception
    ...
    */
    public function get(?GetMetricsForConditionalAccessCompliantDevicesSignInSuc_cf953483 $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        $errorMappings = [
                'XXX' => [ODataError::class, 'createFromDiscriminatorValue'],
        ];
        return $this->requestAdapter->sendAsync($requestInfo, [GetMetricsForConditionalAccessCompliantDevicesSignInSuc_d034e2da::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toGetRequestInformation(?GetMetricsForConditionalAccessCompliantDevicesSignInSuc_cf953483 $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): GetMetricsForConditionalAccessCompliantDevicesSignInSuc_b4c9f817 {
        return new GetMetricsForConditionalAccessCompliantDevicesSignInSuc_b4c9f817($rawUrl, $this->requestAdapter);
    }
