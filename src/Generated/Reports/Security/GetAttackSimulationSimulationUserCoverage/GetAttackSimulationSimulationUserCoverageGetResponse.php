...
class GetAttackSimulationSimulationUserCoverageGetResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetAttackSimulationSimulationUserCoverageGetResponse {
