...
namespace Microsoft\Graph\Beta\Generated\Reports\Correlations\Item\Identities;
...
class IdentitiesRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): IdentitiesRequestBuilderGetQueryParameters {
        return new IdentitiesRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
