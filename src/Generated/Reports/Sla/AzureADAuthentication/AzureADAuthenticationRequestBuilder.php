...
class AzureADAuthenticationRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/sla/azureADAuthentication');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/azureadauthentication-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?AzureADAuthenticationRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/sla/azureADAuthentication{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
