...
class CredentialUserRegistrationDetailsItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $credentialUserRegistrationDetailsId key: id of credentialUserRegistrationDetails
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $credentialUserRegistrationDetailsId = null) {
        ...
        $urlTplParams['credentialUserRegistrationDetailsId'] = $credentialUserRegistrationDetailsId;
