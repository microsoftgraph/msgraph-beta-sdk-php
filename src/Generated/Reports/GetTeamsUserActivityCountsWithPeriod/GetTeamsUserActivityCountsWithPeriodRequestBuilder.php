...
class GetTeamsUserActivityCountsWithPeriodRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?GetTeamsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function get(?GetTeamsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
