...
*/
class GetOffice365GroupsActivityCountsWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getOffice365GroupsActivityCounts(period=\'{period}\'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
     ...
     * @return Promise<GetOffice365GroupsActivityCountsWithPeriodGetResponse|null>
     * @throws Exception
    */
    public function get(?GetOffice365GroupsActivityCountsWithPeriodRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [GetOffice365GroupsActivityCountsWithPeriodGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function withUrl(string $rawUrl): GetOffice365GroupsActivityCountsWithPeriodRequestBuilder {
