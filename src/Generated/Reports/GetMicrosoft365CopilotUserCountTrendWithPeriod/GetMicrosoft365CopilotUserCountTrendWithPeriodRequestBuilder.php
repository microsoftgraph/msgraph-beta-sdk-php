...
*/
class GetMicrosoft365CopilotUserCountTrendWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getMicrosoft365CopilotUserCountTrend(period=\'{period}\')');
    ...
    */
    public function withUrl(string $rawUrl): GetMicrosoft365CopilotUserCountTrendWithPeriodRequestBuilder {
        return new GetMicrosoft365CopilotUserCountTrendWithPeriodRequestBuilder($rawUrl, $this->requestAdapter);
    }
