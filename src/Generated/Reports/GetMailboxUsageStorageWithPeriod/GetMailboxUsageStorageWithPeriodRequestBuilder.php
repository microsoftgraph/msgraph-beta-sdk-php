...
class GetMailboxUsageStorageWithPeriodRequestBuilder 
{
    ...
    */
    public function createGetRequestInformation(?GetMailboxUsageStorageWithPeriodRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return Promise
    */
    public function get(?GetMailboxUsageStorageWithPeriodRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
