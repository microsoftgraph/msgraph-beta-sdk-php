...
*/
class GetM365AppUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getM365AppUserDetail(period=\'{period}\')');
    ...
    */
    public function withUrl(string $rawUrl): GetM365AppUserDetailWithPeriodRequestBuilder {
