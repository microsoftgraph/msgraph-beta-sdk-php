...
class UserRegistrationDetailsItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $userRegistrationDetailsId key: id of userRegistrationDetails
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $userRegistrationDetailsId = null) {
        ...
        $urlTplParams['userRegistrationDetailsId'] = $userRegistrationDetailsId;
