...
*/
class UserRegistrationActivityWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new UserRegistrationActivityWithPeriodRequestBuilder and sets the default values.
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/authenticationMethods/userRegistrationActivity(period=\'{period}\'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function get(?UserRegistrationActivityWithPeriodRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [UserRegistrationActivityWithPeriodGetResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function withUrl(string $rawUrl): UserRegistrationActivityWithPeriodRequestBuilder {
        return new UserRegistrationActivityWithPeriodRequestBuilder($rawUrl, $this->requestAdapter);
    }
