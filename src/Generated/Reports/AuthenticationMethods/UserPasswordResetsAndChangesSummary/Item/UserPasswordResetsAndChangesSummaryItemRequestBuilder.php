...
*/
class UserPasswordResetsAndChangesSummaryItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function toGetRequestInformation(?UserPasswordResetsAndChangesSummaryItemRequestBuilderGe_86baa845 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/authenticationMethods/userPasswordResetsAndChangesSummary/{userPasswordResetsAndChangesSummary%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): UserPasswordResetsAndChangesSummaryItemRequestBuilder {
        return new UserPasswordResetsAndChangesSummaryItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
