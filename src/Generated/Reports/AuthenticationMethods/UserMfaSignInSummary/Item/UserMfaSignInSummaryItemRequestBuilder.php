...
class UserMfaSignInSummaryItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/authenticationMethods/userMfaSignInSummary/{userMfaSignInSummary%2Did}');
    ...
    */
    public function toGetRequestInformation(?UserMfaSignInSummaryItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/authenticationMethods/userMfaSignInSummary/{userMfaSignInSummary%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
