...
class UsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $includedUserRoles = null, ?string $includedUserTypes = null) {
        $this->urlTemplate = '{+baseurl}/reports/authenticationMethods/usersRegisteredByMethod(includedUserTypes=\'{includedUserTypes}\',includedUserRoles=\'{includedUserRoles}\')';
