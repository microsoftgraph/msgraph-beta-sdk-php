...
use Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\UserRegistrationMethodSummary;
...
class UsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder 
{
    ...
    */
    public function get(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, UserRegistrationMethodSummary::class, $responseHandler);
        } catch(Exception $ex) {
