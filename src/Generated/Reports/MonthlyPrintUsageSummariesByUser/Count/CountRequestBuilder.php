...
namespace Microsoft\Graph\Beta\Generated\Reports\MonthlyPrintUsageSummariesByUser\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/reports/monthlyPrintUsageSummariesByUser/$count{?%24search,%24filter}");
