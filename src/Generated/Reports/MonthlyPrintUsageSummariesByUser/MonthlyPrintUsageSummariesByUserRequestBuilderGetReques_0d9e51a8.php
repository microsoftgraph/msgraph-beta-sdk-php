...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: monthlyPrintUsageSummariesByUserRequestBuilderGetRequestConfiguration
*/
class MonthlyPrintUsageSummariesByUserRequestBuilderGetReques_0d9e51a8 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MonthlyPrintUsageSummariesByUserRequestBuilderGetReques_0d9e51a8 and sets the default values.
