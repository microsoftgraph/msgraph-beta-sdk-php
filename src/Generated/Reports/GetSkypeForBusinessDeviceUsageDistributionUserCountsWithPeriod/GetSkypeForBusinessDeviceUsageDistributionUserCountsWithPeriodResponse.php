...
class GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriodResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriodResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriodResponse {
