...
namespace Microsoft\Graph\Beta\Generated\Reports\Partners\Billing\Operations;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\Partners\Billing\Operation;
use Microsoft\Graph\Beta\Generated\Models\Partners\Billing\OperationCollectionResponse;
use Microsoft\Graph\Beta\Generated\Reports\Partners\Billing\Operations\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Reports\Partners\Billing\Operations\Item\OperationItemRequestBuilder;
...
class OperationsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the operations property of the microsoft.graph.partners.billing.billing entity.
     * @param string $operationId The unique identifier of operation
     * @return OperationItemRequestBuilder
    */
    public function byOperationId(string $operationId): OperationItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['operation%2Did'] = $operationId;
        return new OperationItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/partners/billing/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function get(?OperationsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [OperationCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
     ...
     * @throws Exception
    */
    public function post(Operation $body, ?OperationsRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(Operation $body, ?OperationsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/partners/billing/operations';
        $requestInfo->pathParameters = $this->pathParameters;
