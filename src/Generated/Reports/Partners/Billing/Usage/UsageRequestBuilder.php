...
namespace Microsoft\Graph\Beta\Generated\Reports\Partners\Billing\Usage;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\Partners\Billing\AzureUsage;
use Microsoft\Graph\Beta\Generated\Reports\Partners\Billing\Usage\Billed\BilledRequestBuilder;
use Microsoft\Graph\Beta\Generated\Reports\Partners\Billing\Usage\Unbilled\UnbilledRequestBuilder;
...
class UsageRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/partners/billing/usage');
    ...
    */
    public function toGetRequestInformation(?UsageRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/partners/billing/usage{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
