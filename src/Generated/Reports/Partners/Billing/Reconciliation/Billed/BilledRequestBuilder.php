...
class BilledRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/partners/billing/reconciliation/billed');
    ...
    */
    public function toGetRequestInformation(?BilledRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/partners/billing/reconciliation/billed{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
