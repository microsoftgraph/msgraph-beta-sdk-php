...
namespace Microsoft\Graph\Beta\Generated\Reports\Partners\Billing\Reconciliation\Billed;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\Partners\Billing\BilledReconciliation;
use Microsoft\Graph\Beta\Generated\Reports\Partners\Billing\Reconciliation\Billed\MicrosoftGraphPartnersBillingExport\MicrosoftGraphPartnersBillingExportRequestBuilder;
...
class BilledRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/partners/billing/reconciliation/billed{?%24expand,%24select}');
    ...
    */
     ...
     * @return Promise<BilledReconciliation|null>
     * @throws Exception
    */
    public function get(?BilledRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [BilledReconciliation::class, 'createFromDiscriminatorValue'], $errorMappings);
    }

    /**
     * Update the navigation property billed in reports
     * @param BilledReconciliation $body The request body
     ...
     * @throws Exception
    */
    public function patch(BilledReconciliation $body, ?BilledRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toDeleteRequestInformation(?BilledRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/reports/partners/billing/reconciliation/billed';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(BilledReconciliation $body, ?BilledRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/reports/partners/billing/reconciliation/billed';
        $requestInfo->pathParameters = $this->pathParameters;
