...
namespace Microsoft\Graph\Beta\Generated\Reports\GetSkypeForBusinessDeviceUsageUserDetailWithPeriod;
...
*/
class GetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getSkypeForBusinessDeviceUsageUserDetail(period=\'{period}\')');
    ...
    */
    public function withUrl(string $rawUrl): GetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder {
        return new GetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder($rawUrl, $this->requestAdapter);
    }
