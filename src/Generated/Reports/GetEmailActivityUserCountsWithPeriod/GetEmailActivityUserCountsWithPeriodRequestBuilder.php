...
*/
class GetEmailActivityUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getEmailActivityUserCounts(period=\'{period}\')');
    ...
    */
    public function withUrl(string $rawUrl): GetEmailActivityUserCountsWithPeriodRequestBuilder {
