...
use Microsoft\Graph\Beta\Generated\Models\DailyInactiveUsersMetric;
...
*/
class DailyInactiveUsersMetricItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/userInsights/daily/inactiveUsers/{dailyInactiveUsersMetric%2Did}{?%24expand,%24select}');
    ...
    */
    public function get(?DailyInactiveUsersMetricItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DailyInactiveUsersMetric::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function withUrl(string $rawUrl): DailyInactiveUsersMetricItemRequestBuilder {
        return new DailyInactiveUsersMetricItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
