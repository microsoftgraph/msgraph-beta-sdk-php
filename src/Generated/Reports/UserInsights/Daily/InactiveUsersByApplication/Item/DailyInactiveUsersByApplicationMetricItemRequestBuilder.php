...
use Microsoft\Graph\Beta\Generated\Models\DailyInactiveUsersByApplicationMetric;
...
*/
class DailyInactiveUsersByApplicationMetricItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/userInsights/daily/inactiveUsersByApplication/{dailyInactiveUsersByApplicationMetric%2Did}{?%24select,%24expand}');
    ...
    */
    public function get(?DailyInactiveUsersByApplicationMetricItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DailyInactiveUsersByApplicationMetric::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function withUrl(string $rawUrl): DailyInactiveUsersByApplicationMetricItemRequestBuilder {
        return new DailyInactiveUsersByApplicationMetricItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
