...
class InactiveUsersByApplicationRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the inactiveUsersByApplication property of the microsoft.graph.dailyUserInsightMetricsRoot entity.
     * @param string $dailyInactiveUsersByApplicationMetricId The unique identifier of dailyInactiveUsersByApplicationMetric
     * @return DailyInactiveUsersByApplicationMetricItemRequestBuilder
    */
    public function byDailyInactiveUsersByApplicationMetricId(string $dailyInactiveUsersByApplicationMetricId): DailyInactiveUsersByApplicationMetricItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['dailyInactiveUsersByApplicationMetric%2Did'] = $dailyInactiveUsersByApplicationMetricId;
        return new DailyInactiveUsersByApplicationMetricItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/userInsights/daily/inactiveUsersByApplication{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
     ...
     * @return Promise<DailyInactiveUsersByApplicationMetricCollectionResponse|null>
     * @throws Exception
    */
    public function get(?InactiveUsersByApplicationRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [DailyInactiveUsersByApplicationMetricCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
