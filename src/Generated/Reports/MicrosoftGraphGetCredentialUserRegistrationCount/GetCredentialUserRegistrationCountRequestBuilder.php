...
class GetCredentialUserRegistrationCountRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/reports/microsoft.graph.getCredentialUserRegistrationCount(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}';
    ...
    */
    public function get(?GetCredentialUserRegistrationCountRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [GetCredentialUserRegistrationCountResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
