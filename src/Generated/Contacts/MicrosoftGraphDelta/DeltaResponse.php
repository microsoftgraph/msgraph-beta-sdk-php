...
namespace Microsoft\Graph\Beta\Generated\Contacts\MicrosoftGraphDelta;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([OrgContact::class, 'createFromDiscriminatorValue'])),
        ]);
    }
