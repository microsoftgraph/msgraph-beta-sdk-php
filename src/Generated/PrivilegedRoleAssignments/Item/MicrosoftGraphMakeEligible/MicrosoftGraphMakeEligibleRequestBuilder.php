...
namespace Microsoft\Graph\Beta\Generated\PrivilegedRoleAssignments\Item\MicrosoftGraphMakeEligible;
...
*/
class MicrosoftGraphMakeEligibleRequestBuilder 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MicrosoftGraphMakeEligibleRequestBuilder and sets the default values.
    ...
    */
     ...
     * @param MicrosoftGraphMakeEligibleRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/privilegedroleassignment-makeeligible?view=graph-rest-1.0 Find more info here
    */
    public function post(?MicrosoftGraphMakeEligibleRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?MicrosoftGraphMakeEligibleRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
