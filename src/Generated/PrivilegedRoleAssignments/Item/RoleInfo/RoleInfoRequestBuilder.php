...
class RoleInfoRequestBuilder 
{
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.privilegedRoleAssignments.item.roleInfo.assignments.item collection
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment_id}/roleInfo{?select,expand}';
