...
class PrivilegedRoleAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedRoleAssignmentId1 key: id of privilegedRoleAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $privilegedRoleAssignmentId1 = null) {
        ...
        $urlTplParams['privilegedRoleAssignmentId1'] = $privilegedRoleAssignmentId1;
