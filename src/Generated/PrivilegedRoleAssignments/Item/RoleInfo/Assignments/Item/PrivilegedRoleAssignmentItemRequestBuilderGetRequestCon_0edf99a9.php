...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: PrivilegedRoleAssignmentItemRequestBuilderGetRequestConfiguration
*/
class PrivilegedRoleAssignmentItemRequestBuilderGetRequestCon_0edf99a9 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PrivilegedRoleAssignmentItemRequestBuilderGetRequestCon_0edf99a9 and sets the default values.
