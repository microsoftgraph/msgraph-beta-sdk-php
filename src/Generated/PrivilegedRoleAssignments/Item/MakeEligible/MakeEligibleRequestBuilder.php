...
*/
class MakeEligibleRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/makeEligible');
     ...
     * @return Promise
    */
    public function post(?MakeEligibleRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?MakeEligibleRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return MakeEligibleRequestBuilder
    */
    public function withUrl(string $rawUrl): MakeEligibleRequestBuilder {
        return new MakeEligibleRequestBuilder($rawUrl, $this->requestAdapter);
    }
