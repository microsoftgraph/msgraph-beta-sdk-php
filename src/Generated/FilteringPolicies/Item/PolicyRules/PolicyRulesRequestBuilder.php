...
use Microsoft\Graph\Beta\Generated\FilteringPolicies\Item\PolicyRules\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\FilteringPolicies\Item\PolicyRules\Item\PolicyRuleItemRequestBuilder;
...
class PolicyRulesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?PolicyRulesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/filteringPolicies/{filteringPolicy%2Did}/policyRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(PolicyRule $body, ?PolicyRulesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/filteringPolicies/{filteringPolicy%2Did}/policyRules';
        $requestInfo->pathParameters = $this->pathParameters;
