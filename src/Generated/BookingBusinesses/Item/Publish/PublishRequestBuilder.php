...
namespace Microsoft\Graph\Beta\Generated\BookingBusinesses\Item\Publish;
...
class PublishRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/publish');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/bookingbusiness-publish?view=graph-rest-beta Find more info here
    */
