...
use Microsoft\Graph\Beta\Generated\Models\StaffAvailabilityItem;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([StaffAvailabilityItem::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
    public function getValue(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, StaffAvailabilityItem::class);
            /** @var array<StaffAvailabilityItem>|null $val */
            return $val;
        }
