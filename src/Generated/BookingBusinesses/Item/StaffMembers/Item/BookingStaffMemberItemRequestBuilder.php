...
class BookingStaffMemberItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $bookingStaffMemberId key: id of bookingStaffMember
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $bookingStaffMemberId = null) {
        ...
        $urlTplParams['bookingStaffMemberId'] = $bookingStaffMemberId;
