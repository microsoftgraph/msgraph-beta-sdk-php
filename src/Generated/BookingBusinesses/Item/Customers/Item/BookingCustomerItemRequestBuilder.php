...
class BookingCustomerItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $bookingCustomerId key: id of bookingCustomer
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $bookingCustomerId = null) {
        ...
        $urlTplParams['bookingCustomerId'] = $bookingCustomerId;
