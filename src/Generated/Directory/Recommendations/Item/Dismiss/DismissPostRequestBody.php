...
class DismissPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getDismissReason(): ?string {
        $val = $this->getBackingStore()->get('dismissReason');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'dismissReason'");
    }
    ...
    */
    public function setDismissReason(?string $value): void {
        $this->getBackingStore()->set('dismissReason', $value);
    }
