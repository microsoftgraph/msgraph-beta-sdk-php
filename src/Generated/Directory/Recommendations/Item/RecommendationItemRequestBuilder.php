...
use Microsoft\Graph\Beta\Generated\Directory\Recommendations\Item\MicrosoftGraphComplete\CompleteRequestBuilder;
use Microsoft\Graph\Beta\Generated\Directory\Recommendations\Item\MicrosoftGraphDismiss\DismissRequestBuilder;
use Microsoft\Graph\Beta\Generated\Directory\Recommendations\Item\MicrosoftGraphPostpone\PostponeRequestBuilder;
use Microsoft\Graph\Beta\Generated\Directory\Recommendations\Item\MicrosoftGraphReactivate\ReactivateRequestBuilder;
...
class RecommendationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $recommendationId key: id of recommendation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $recommendationId = null) {
        $this->urlTemplate = '{+baseurl}/directory/recommendations/{recommendation%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['recommendationId'] = $recommendationId;
