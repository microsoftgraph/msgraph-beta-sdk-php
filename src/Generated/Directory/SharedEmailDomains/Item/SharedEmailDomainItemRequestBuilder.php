...
class SharedEmailDomainItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $sharedEmailDomainId key: id of sharedEmailDomain
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $sharedEmailDomainId = null) {
        $this->urlTemplate = '{+baseurl}/directory/sharedEmailDomains/{sharedEmailDomain%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['sharedEmailDomainId'] = $sharedEmailDomainId;
