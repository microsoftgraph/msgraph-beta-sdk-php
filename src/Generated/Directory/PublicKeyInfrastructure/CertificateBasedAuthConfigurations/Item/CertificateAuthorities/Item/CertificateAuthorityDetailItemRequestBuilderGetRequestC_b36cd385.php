...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: CertificateAuthorityDetailItemRequestBuilderGetRequestConfiguration
*/
class CertificateAuthorityDetailItemRequestBuilderGetRequestC_b36cd385 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CertificateAuthorityDetailItemRequestBuilderGetRequestC_b36cd385 and sets the default values.
