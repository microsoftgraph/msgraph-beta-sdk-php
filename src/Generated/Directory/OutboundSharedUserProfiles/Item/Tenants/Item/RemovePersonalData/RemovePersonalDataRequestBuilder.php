...
class RemovePersonalDataRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/directory/outboundSharedUserProfiles/{outboundSharedUserProfile_userId}/tenants/{tenantReference_tenantId}/microsoft.graph.removePersonalData';
