...
use Microsoft\Graph\Beta\Generated\Directory\OutboundSharedUserProfiles\Item\Tenants\Item\MicrosoftGraphRemovePersonalData\RemovePersonalDataRequestBuilder;
...
class TenantReferenceTenantItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $tenantReferenceTenantId key: tenantId of tenantReference
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $tenantReferenceTenantId = null) {
        ...
        $urlTplParams['tenantReferenceTenantId'] = $tenantReferenceTenantId;
