...
class OutboundSharedUserProfileUserItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $outboundSharedUserProfileUserId = null) {
        ...
        $urlTplParams['outboundSharedUserProfileUserId'] = $outboundSharedUserProfileUserId;
