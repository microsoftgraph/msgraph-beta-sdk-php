...
class OutboundSharedUserProfileUserItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $outboundSharedUserProfileUserId key: userId of outboundSharedUserProfile
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $outboundSharedUserProfileUserId = null) {
    ...
    */
    public function tenantsById(string $id): TenantReferenceTenantItemRequestBuilder {
        ...
        return new TenantReferenceTenantItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
