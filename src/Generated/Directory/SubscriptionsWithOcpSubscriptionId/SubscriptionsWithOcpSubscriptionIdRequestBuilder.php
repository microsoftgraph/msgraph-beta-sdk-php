...
*/
class SubscriptionsWithOcpSubscriptionIdRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function toGetRequestInformation(?SubscriptionsWithOcpSubscriptionIdRequestBuilderGetRequ_54f51c87 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/directory/subscriptions(ocpSubscriptionId=\'{ocpSubscriptionId}\'){?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): SubscriptionsWithOcpSubscriptionIdRequestBuilder {
        return new SubscriptionsWithOcpSubscriptionIdRequestBuilder($rawUrl, $this->requestAdapter);
    }
