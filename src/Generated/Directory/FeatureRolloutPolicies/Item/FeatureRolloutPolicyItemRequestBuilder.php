...
namespace Microsoft\Graph\Beta\Generated\Directory\FeatureRolloutPolicies\Item;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Directory\FeatureRolloutPolicies\Item\AppliesTo\AppliesToRequestBuilder;
...
class FeatureRolloutPolicyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $featureRolloutPolicyId key: id of featureRolloutPolicy
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $featureRolloutPolicyId = null) {
        $this->urlTemplate = '{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['featureRolloutPolicyId'] = $featureRolloutPolicyId;
