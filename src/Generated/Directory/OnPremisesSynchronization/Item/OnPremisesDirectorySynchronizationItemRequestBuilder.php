...
class OnPremisesDirectorySynchronizationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $onPremisesDirectorySynchronizationId key: id of onPremisesDirectorySynchronization
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $onPremisesDirectorySynchronizationId = null) {
        ...
        $urlTplParams['onPremisesDirectorySynchronizationId'] = $onPremisesDirectorySynchronizationId;
