...
use Microsoft\Graph\Beta\Generated\Directory\DeviceLocalCredentials\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Directory\DeviceLocalCredentials\Item\DeviceLocalCredentialInfoItemRequestBuilder;
...
class DeviceLocalCredentialsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/directory-list-devicelocalcredentials?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?DeviceLocalCredentialsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/directory/deviceLocalCredentials{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(DeviceLocalCredentialInfo $body, ?DeviceLocalCredentialsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/directory/deviceLocalCredentials';
        $requestInfo->pathParameters = $this->pathParameters;
