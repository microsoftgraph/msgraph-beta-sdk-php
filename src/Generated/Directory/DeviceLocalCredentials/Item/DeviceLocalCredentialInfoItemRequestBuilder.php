...
*/
class DeviceLocalCredentialInfoItemRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/directory/deviceLocalCredentials/{deviceLocalCredentialInfo%2Did}');
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/devicelocalcredentialinfo-get?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?DeviceLocalCredentialInfoItemRequestBuilderGetRequestCo_e311dfa8 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/directory/deviceLocalCredentials/{deviceLocalCredentialInfo%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function withUrl(string $rawUrl): DeviceLocalCredentialInfoItemRequestBuilder {
