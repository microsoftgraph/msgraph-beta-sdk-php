...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: DeviceLocalCredentialInfoItemRequestBuilderGetRequestConfiguration
*/
class DeviceLocalCredentialInfoItemRequestBuilderGetRequestCo_e311dfa8 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceLocalCredentialInfoItemRequestBuilderGetRequestCo_e311dfa8 and sets the default values.
