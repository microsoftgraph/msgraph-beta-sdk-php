...
class CustomSecurityAttributeDefinitionItemRequestBuilder 
{
    ...
    */
    public function allowedValuesById(string $id): AllowedValueItemRequestBuilder {
        ...
        return new AllowedValueItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $customSecurityAttributeDefinitionId = null) {
