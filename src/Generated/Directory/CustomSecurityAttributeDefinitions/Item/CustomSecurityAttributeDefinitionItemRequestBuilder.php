...
class CustomSecurityAttributeDefinitionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $customSecurityAttributeDefinitionId key: id of customSecurityAttributeDefinition
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $customSecurityAttributeDefinitionId = null) {
        ...
        $urlTplParams['customSecurityAttributeDefinitionId'] = $customSecurityAttributeDefinitionId;
