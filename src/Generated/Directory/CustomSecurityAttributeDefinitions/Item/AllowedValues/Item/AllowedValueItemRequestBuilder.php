...
class AllowedValueItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $allowedValueId key: id of allowedValue
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $allowedValueId = null) {
        ...
        $urlTplParams['allowedValueId'] = $allowedValueId;
