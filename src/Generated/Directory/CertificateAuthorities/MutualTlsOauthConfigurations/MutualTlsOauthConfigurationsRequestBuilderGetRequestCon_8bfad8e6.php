...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: mutualTlsOauthConfigurationsRequestBuilderGetRequestConfiguration
*/
class MutualTlsOauthConfigurationsRequestBuilderGetRequestCon_8bfad8e6 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MutualTlsOauthConfigurationsRequestBuilderGetRequestCon_8bfad8e6 and sets the default values.
