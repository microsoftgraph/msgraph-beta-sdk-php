...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: MutualTlsOauthConfigurationItemRequestBuilderGetRequestConfiguration
*/
class MutualTlsOauthConfigurationItemRequestBuilderGetRequest_127ee3a5 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MutualTlsOauthConfigurationItemRequestBuilderGetRequest_127ee3a5 and sets the default values.
