...
use Microsoft\Graph\Beta\Generated\AgentRegistry\AgentCollections\Item\Members\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\AgentRegistry\AgentCollections\Item\Members\Item\AgentInstanceItemRequestBuilder;
...
class MembersRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
    */
    public function post(AgentInstance $body, ?MembersRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toGetRequestInformation(?MembersRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/agentRegistry/agentCollections/{agentCollection%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(AgentInstance $body, ?MembersRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/agentRegistry/agentCollections/{agentCollection%2Did}/members';
        $requestInfo->pathParameters = $this->pathParameters;
