...
class AccessReviewDecisionItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessReviewDecisionId key: id of accessReviewDecision
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $accessReviewDecisionId = null) {
        ...
        $urlTplParams['accessReviewDecisionId'] = $accessReviewDecisionId;
