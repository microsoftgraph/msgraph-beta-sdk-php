...
use Microsoft\Graph\Beta\Generated\AccessReviews\Item\MicrosoftGraphApplyDecisions\ApplyDecisionsRequestBuilder;
use Microsoft\Graph\Beta\Generated\AccessReviews\Item\MicrosoftGraphResetDecisions\ResetDecisionsRequestBuilder;
use Microsoft\Graph\Beta\Generated\AccessReviews\Item\MicrosoftGraphSendReminder\SendReminderRequestBuilder;
use Microsoft\Graph\Beta\Generated\AccessReviews\Item\MicrosoftGraphStop\StopRequestBuilder;
...
class AccessReviewItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $accessReviewId key: id of accessReview
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $accessReviewId = null) {
    ...
    */
    public function decisionsById(string $id): \Microsoft\Graph\Beta\Generated\AccessReviews\Item\Decisions\Item\AccessReviewDecisionItemRequestBuilder {
        ...
        return new \Microsoft\Graph\Beta\Generated\AccessReviews\Item\Decisions\Item\AccessReviewDecisionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/accessreview-delete?view=graph-rest-1.0 Find more info here
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/accessreview-get?view=graph-rest-1.0 Find more info here
    */
    ...
    */
    public function instancesById(string $id): \Microsoft\Graph\Beta\Generated\AccessReviews\Item\Instances\Item\AccessReviewItemRequestBuilder {
        ...
        return new \Microsoft\Graph\Beta\Generated\AccessReviews\Item\Instances\Item\AccessReviewItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
    public function myDecisionsById(string $id): \Microsoft\Graph\Beta\Generated\AccessReviews\Item\MyDecisions\Item\AccessReviewDecisionItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['accessReviewDecision%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\AccessReviews\Item\MyDecisions\Item\AccessReviewDecisionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/accessreview-update?view=graph-rest-1.0 Find more info here
    */
