...
class HideForUserRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return HideForUserRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): HideForUserRequestBody {
