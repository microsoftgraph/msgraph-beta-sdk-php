...
class MarkChatReadForUserRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/chats/{chat%2Did}/markChatReadForUser');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/chat-markchatreadforuser?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function withUrl(string $rawUrl): MarkChatReadForUserRequestBuilder {
