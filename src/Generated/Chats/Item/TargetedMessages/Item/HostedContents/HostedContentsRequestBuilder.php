...
namespace Microsoft\Graph\Beta\Generated\Chats\Item\TargetedMessages\Item\HostedContents;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Chats\Item\TargetedMessages\Item\HostedContents\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Chats\Item\TargetedMessages\Item\HostedContents\Item\ChatMessageHostedContentItemRequestBuilder;
...
class HostedContentsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?HostedContentsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}/hostedContents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(ChatMessageHostedContent $body, ?HostedContentsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}/hostedContents';
        $requestInfo->pathParameters = $this->pathParameters;
