...
class StartMigrationRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/chats/{chat%2Did}/startMigration');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/chat-startmigration?view=graph-rest-beta Find more info here
    */
