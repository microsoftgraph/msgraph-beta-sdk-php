...
class UpdatePasswordSingleSignOnCredentialsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UpdatePasswordSingleSignOnCredentialsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UpdatePasswordSingleSignOnCredentialsRequestBody {
