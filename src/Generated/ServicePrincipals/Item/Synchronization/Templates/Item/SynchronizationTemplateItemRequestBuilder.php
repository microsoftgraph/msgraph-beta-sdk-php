...
class SynchronizationTemplateItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $synchronizationTemplateId key: id of synchronizationTemplate
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $synchronizationTemplateId = null) {
        ...
        $urlTplParams['synchronizationTemplateId'] = $synchronizationTemplateId;
