...
class RestartRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return RestartRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RestartRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'criteria' => function (self $o, ParseNode $n) { $o->setCriteria($n->getObjectValue(SynchronizationJobRestartCriteria::class)); },
        ];
    }
