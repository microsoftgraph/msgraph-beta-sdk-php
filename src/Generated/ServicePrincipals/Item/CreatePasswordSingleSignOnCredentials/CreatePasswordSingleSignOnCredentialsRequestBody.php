...
class CreatePasswordSingleSignOnCredentialsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return CreatePasswordSingleSignOnCredentialsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CreatePasswordSingleSignOnCredentialsRequestBody {
