...
namespace Microsoft\\Graph\\Beta\\Generated\ServicePrincipals\Item\TransitiveMemberOf\GraphDirectoryRole;
...
class GraphDirectoryRoleRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): GraphDirectoryRoleRequestBuilderGetQueryParameters {
        return new GraphDirectoryRoleRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
