...
namespace Microsoft\Graph\Beta\Generated\Communications\OnlineMeetingConversations\Item\Messages\Item\Replies;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetingConversations\Item\Messages\Item\Replies\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetingConversations\Item\Messages\Item\Replies\Item\EngagementConversationMessageItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Models\EngagementConversationMessage;
use Microsoft\Graph\Beta\Generated\Models\EngagementConversationMessageCollectionResponse;
...
class RepliesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Provides operations to manage the replies property of the microsoft.graph.engagementConversationMessage entity.
     * @param string $engagementConversationMessageId1 The unique identifier of engagementConversationMessage
     * @return EngagementConversationMessageItemRequestBuilder
    */
    public function byEngagementConversationMessageId1(string $engagementConversationMessageId1): EngagementConversationMessageItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['engagementConversationMessage%2Did1'] = $engagementConversationMessageId1;
    ...
    */
    public function toGetRequestInformation(?RepliesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/messages/{engagementConversationMessage%2Did}/replies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(EngagementConversationMessage $body, ?RepliesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/messages/{engagementConversationMessage%2Did}/replies';
        $requestInfo->pathParameters = $this->pathParameters;
