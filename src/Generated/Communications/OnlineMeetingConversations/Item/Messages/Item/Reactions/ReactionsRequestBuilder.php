...
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetingConversations\Item\Messages\Item\Reactions\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetingConversations\Item\Messages\Item\Reactions\Item\EngagementConversationMessageReactionItemRequestBuilder;
...
class ReactionsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/engagementconversationdiscussionmessage-list-reactions?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?ReactionsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/messages/{engagementConversationMessage%2Did}/reactions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(EngagementConversationMessageReaction $body, ?ReactionsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/messages/{engagementConversationMessage%2Did}/reactions';
        $requestInfo->pathParameters = $this->pathParameters;
