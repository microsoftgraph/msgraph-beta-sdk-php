...
namespace Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Transcripts;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Transcripts\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Transcripts\Delta\DeltaRequestBuilder;
use Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Transcripts\Item\CallTranscriptItemRequestBuilder;
...
class TranscriptsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?TranscriptsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/transcripts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(CallTranscript $body, ?TranscriptsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/transcripts';
        $requestInfo->pathParameters = $this->pathParameters;
