...
namespace Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Transcripts\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Transcripts\Item\Content\ContentRequestBuilder;
use Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Transcripts\Item\MetadataContent\MetadataContentRequestBuilder;
...
class CallTranscriptItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/transcripts/{callTranscript%2Did}');
    ...
    */
    public function toGetRequestInformation(?CallTranscriptItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/transcripts/{callTranscript%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
