...
namespace Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Recordings;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Recordings\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Recordings\Delta\DeltaRequestBuilder;
use Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Recordings\Item\CallRecordingItemRequestBuilder;
...
class RecordingsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?RecordingsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/recordings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(CallRecording $body, ?RecordingsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/recordings';
        $requestInfo->pathParameters = $this->pathParameters;
