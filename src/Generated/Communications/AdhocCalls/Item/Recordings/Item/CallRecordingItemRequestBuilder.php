...
namespace Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Recordings\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Communications\AdhocCalls\Item\Recordings\Item\Content\ContentRequestBuilder;
...
class CallRecordingItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/recordings/{callRecording%2Did}');
    ...
    */
    public function toGetRequestInformation(?CallRecordingItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/adhocCalls/{adhocCall%2Did}/recordings/{callRecording%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
