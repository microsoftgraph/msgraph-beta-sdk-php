...
class AudioRoutingGroupItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/audioroutinggroup-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/audioroutinggroup-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<AudioRoutingGroup|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/audioroutinggroup-update?view=graph-rest-beta Find more info here
    */
