...
namespace Microsoft\Graph\Beta\Generated\Communications\Calls\Item\Participants\Item\MicrosoftGraphStartHoldMusic;
...
class MicrosoftGraphStartHoldMusicRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphStartHoldMusicRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
    ...
    */
    public function toPostRequestInformation(StartHoldMusicPostRequestBody $body, ?MicrosoftGraphStartHoldMusicRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
