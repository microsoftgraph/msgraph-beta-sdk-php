...
class RemoveFromLobbyPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RemoveFromLobbyPostRequestBody and sets the default values.
    */
     ...
     * @return RemoveFromLobbyPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RemoveFromLobbyPostRequestBody {
