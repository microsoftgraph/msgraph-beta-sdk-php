...
class MeetingAttendanceReportRequestBuilder 
{
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.communications.onlineMeetings.item.meetingAttendanceReport.attendanceRecords.item collection
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/communications/onlineMeetings/{onlineMeeting_id}/meetingAttendanceReport{?select,expand}';
