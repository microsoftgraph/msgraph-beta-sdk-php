...
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetings\Item\AiInsights\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetings\Item\AiInsights\Item\CallAiInsightItemRequestBuilder;
...
class AiInsightsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?AiInsightsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/aiInsights{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(CallAiInsight $body, ?AiInsightsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/aiInsights';
        $requestInfo->pathParameters = $this->pathParameters;
