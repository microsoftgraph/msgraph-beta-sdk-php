...
namespace Microsoft\Graph\Beta\Generated\Communications\OnlineMeetings\Item\Registration\Registrants;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetings\Item\Registration\Registrants\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetings\Item\Registration\Registrants\Item\MeetingRegistrantBaseItemRequestBuilder;
...
class RegistrantsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration/registrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
    public function toPostRequestInformation(MeetingRegistrantBase $body, ?RegistrantsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration/registrants';
        $requestInfo->pathParameters = $this->pathParameters;
