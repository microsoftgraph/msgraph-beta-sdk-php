...
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetings\Item\AiInsights\AiInsightsRequestBuilder;
...
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetings\Item\SendVirtualAppointmentReminderSms\SendVirtualAppointmentReminderSmsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Communications\OnlineMeetings\Item\SendVirtualAppointmentSms\SendVirtualAppointmentSmsRequestBuilder;
...
class OnlineMeetingItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}');
    ...
    */
    public function toGetRequestInformation(?OnlineMeetingItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
