...
class CallTranscriptItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $callTranscriptId key: id of callTranscript
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $callTranscriptId = null) {
        ...
        $urlTplParams['callTranscriptId'] = $callTranscriptId;
