...
class OnlineMeetingsWithJoinWebUrlRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $joinWebUrl = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/communications/onlineMeetings(joinWebUrl=\'{joinWebUrl}\')');
    ...
    */
    public function toGetRequestInformation(?OnlineMeetingsWithJoinWebUrlRequestBuilderGetRequestCon_ac039a4a $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/communications/onlineMeetings(joinWebUrl=\'{joinWebUrl}\'){?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
