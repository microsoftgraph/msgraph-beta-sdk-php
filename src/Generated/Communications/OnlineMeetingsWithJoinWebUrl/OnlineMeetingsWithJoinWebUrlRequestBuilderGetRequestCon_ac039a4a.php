...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: onlineMeetingsWithJoinWebUrlRequestBuilderGetRequestConfiguration
*/
class OnlineMeetingsWithJoinWebUrlRequestBuilderGetRequestCon_ac039a4a extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OnlineMeetingsWithJoinWebUrlRequestBuilderGetRequestCon_ac039a4a and sets the default values.
