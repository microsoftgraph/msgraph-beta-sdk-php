...
class GetPstnOnlineMeetingDialoutReportWithFromDateTimeWithToDateTimeGetResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetPstnOnlineMeetingDialoutReportWithFromDateTimeWithToDateTimeGetResponse {
    ...
    */
    public function getValue(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, PstnOnlineMeetingDialoutReport::class);
            /** @var array<PstnOnlineMeetingDialoutReport>|null $val */
            return $val;
        }
