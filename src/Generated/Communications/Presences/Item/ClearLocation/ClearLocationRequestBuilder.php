...
namespace Microsoft\Graph\Beta\Generated\Communications\Presences\Item\ClearLocation;
...
*/
class ClearLocationRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/communications/presences/{presence%2Did}/clearLocation');
    ...
    */
    public function toPostRequestInformation(?ClearLocationRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return ClearLocationRequestBuilder
    */
    public function withUrl(string $rawUrl): ClearLocationRequestBuilder {
        return new ClearLocationRequestBuilder($rawUrl, $this->requestAdapter);
    }
