...
class SetPresenceRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/presence-setpresence?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function withUrl(string $rawUrl): SetPresenceRequestBuilder {
