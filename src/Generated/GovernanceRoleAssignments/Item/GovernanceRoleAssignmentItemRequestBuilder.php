...
class GovernanceRoleAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $governanceRoleAssignmentId key: id of governanceRoleAssignment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $governanceRoleAssignmentId = null) {
        $this->urlTemplate = '{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['governanceRoleAssignmentId'] = $governanceRoleAssignmentId;
