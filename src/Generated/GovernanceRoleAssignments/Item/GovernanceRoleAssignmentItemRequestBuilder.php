...
class GovernanceRoleAssignmentItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}');
    ...
    */
    public function toGetRequestInformation(?GovernanceRoleAssignmentItemRequestBuilderGetRequestCon_5742a7a1 $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
