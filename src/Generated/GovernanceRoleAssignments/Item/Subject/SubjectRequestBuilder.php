...
class SubjectRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}/subject');
    ...
    */
    public function toGetRequestInformation(?SubjectRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}/subject{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
