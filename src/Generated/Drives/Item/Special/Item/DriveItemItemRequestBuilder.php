...
namespace Microsoft\Graph\Beta\Generated\Drives\Item\Special\Item;

use Exception;
use Http\Promise\Promise;
use Microsoft\Graph\Beta\Generated\Drives\Item\Special\Item\Content\ContentRequestBuilder;
use Microsoft\Graph\Beta\Generated\Drives\Item\Special\Item\ContentStream\ContentStreamRequestBuilder;
...
class DriveItemItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/special/{driveItem%2Did}{?%24expand,%24select}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/drive-get-specialfolder?view=graph-rest-1.0 Find more info here
    */
