...
namespace Microsoft\Graph\Beta\Generated\Drives\Item\EscapedList\Items\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], "{+baseurl}/drives/{drive%2Did}/list/items/$count{?%24search,%24filter}");
