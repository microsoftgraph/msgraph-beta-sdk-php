...
class ItemActivityOLDItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $itemActivityOLDId key: id of itemActivityOLD
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $itemActivityOLDId = null) {
        ...
        $urlTplParams['itemActivityOLDId'] = $itemActivityOLDId;
