...
namespace Microsoft\Graph\Beta\Generated\Drives\Item\MicrosoftGraphSharedWithMe;
    ...
    */
    public function get(?SharedWithMeRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [SharedWithMeResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
