...
namespace Microsoft\Graph\Beta\Generated\Drives\Item\Items\Item\MicrosoftGraphSearchWithQ;
...
class MicrosoftGraphSearchWithQRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * Instantiates a new microsoftGraphSearchWithQRequestBuilderGetQueryParameters.
     ...
     * @return MicrosoftGraphSearchWithQRequestBuilderGetQueryParameters
    */
    public static function addQueryParameters(?bool $count = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): MicrosoftGraphSearchWithQRequestBuilderGetQueryParameters {
        return new MicrosoftGraphSearchWithQRequestBuilderGetQueryParameters($count, $filter, $orderby, $search, $select, $skip, $top);
    }
