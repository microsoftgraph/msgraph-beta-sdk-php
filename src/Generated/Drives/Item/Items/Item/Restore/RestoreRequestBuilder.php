...
class RestoreRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/restore');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/driveitem-restore?view=graph-rest-beta Find more info here
    */
