...
class ItemActivityItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $itemActivityId key: id of itemActivity
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $itemActivityId = null) {
        ...
        $urlTplParams['itemActivityId'] = $itemActivityId;
