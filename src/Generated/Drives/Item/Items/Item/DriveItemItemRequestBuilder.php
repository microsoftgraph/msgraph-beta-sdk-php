...
class DriveItemItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.drives.item.items.item.activities.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.drives.item.items.item.children.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.drives.item.items.item.permissions.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.drives.item.items.item.subscriptions.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.drives.item.items.item.thumbnails.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.drives.item.items.item.versions.item collection
     * @param string $id Unique identifier of the item
