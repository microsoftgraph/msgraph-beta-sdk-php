...
*/
class PreviewPostRequestBody_zoom implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PreviewPostRequestBody_zoom and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PreviewPostRequestBody_zoom {
        $result = new PreviewPostRequestBody_zoom();
