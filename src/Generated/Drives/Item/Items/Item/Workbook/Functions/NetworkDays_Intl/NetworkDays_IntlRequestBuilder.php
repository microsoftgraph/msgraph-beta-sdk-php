...
namespace Microsoft\\Graph\\Beta\\Generated\Drives\Item\Items\Item\Workbook\Functions\NetworkDays_Intl;
...
*/
class NetworkDays_IntlRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/networkDays_Intl');
     ...
     * @throws Exception
    */
    public function post(NetworkDays_IntlPostRequestBody $body, ?NetworkDays_IntlRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(NetworkDays_IntlPostRequestBody $body, ?NetworkDays_IntlRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
