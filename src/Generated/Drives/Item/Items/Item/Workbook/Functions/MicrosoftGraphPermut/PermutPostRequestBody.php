...
class PermutPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return PermutPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PermutPostRequestBody {
