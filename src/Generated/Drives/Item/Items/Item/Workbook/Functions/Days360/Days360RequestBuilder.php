...
namespace Microsoft\Graph\Beta\Generated\Drives\Item\Items\Item\Workbook\Functions\Days360;
...
*/
class Days360RequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/days360');
     ...
     * @throws Exception
    */
    public function post(Days360PostRequestBody $body, ?Days360RequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(Days360PostRequestBody $body, ?Days360RequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): Days360RequestBuilder {
