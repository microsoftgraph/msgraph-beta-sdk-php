...
class OddFPricePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OddFPricePostRequestBody {
    ...
    */
    public function getFirstCoupon(): ?Json {
        $val = $this->getBackingStore()->get('firstCoupon');
        if (is_null($val) || $val instanceof Json) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'firstCoupon'");
    }
