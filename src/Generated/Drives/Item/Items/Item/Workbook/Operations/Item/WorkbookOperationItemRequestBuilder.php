...
class WorkbookOperationItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $workbookOperationId key: id of workbookOperation
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $workbookOperationId = null) {
        ...
        $urlTplParams['workbookOperationId'] = $workbookOperationId;
