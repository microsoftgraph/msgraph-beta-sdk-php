...
namespace Microsoft\Graph\Beta\Generated\Drives\Item\Items\Item\Workbook\Tables\Item\MicrosoftGraphClearFilters;
...
class ClearFiltersRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/microsoft.graph.clearFilters';
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/table-clearfilters?view=graph-rest-1.0 Find more info here
    */
