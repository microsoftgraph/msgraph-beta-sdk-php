...
namespace Microsoft\Graph\Beta\Generated\Drives\Item\Items\Item\Workbook\Worksheets\Item\Names\MicrosoftGraphAddFormulaLocal;
...
class MicrosoftGraphAddFormulaLocalRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphAddFormulaLocalRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
    ...
    */
    public function toPostRequestInformation(AddFormulaLocalPostRequestBody $body, ?MicrosoftGraphAddFormulaLocalRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
