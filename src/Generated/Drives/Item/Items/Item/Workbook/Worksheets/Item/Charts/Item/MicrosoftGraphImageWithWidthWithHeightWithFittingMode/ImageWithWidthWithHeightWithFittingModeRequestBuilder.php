...
namespace Microsoft\Graph\Beta\Generated\Drives\Item\Items\Item\Workbook\Worksheets\Item\Charts\Item\MicrosoftGraphImageWithWidthWithHeightWithFittingMode;
...
class ImageWithWidthWithHeightWithFittingModeRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $fittingMode = null, ?int $height = null, ?int $width = null) {
    ...
    */
    public function get(?ImageWithWidthWithHeightWithFittingModeRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [ImageWithWidthWithHeightWithFittingModeResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
