...
namespace Microsoft\Graph\Beta\Generated\Drives\Item\Items\Item\Workbook\Worksheets\Item\UsedRange\OffsetRangeWithRowOffsetWithColumnOffset;
...
class OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?int $columnOffset = null, ?int $rowOffset = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/usedRange()/offsetRange(rowOffset={rowOffset},columnOffset={columnOffset})');
