...
class WorkbookCommentItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $workbookCommentId key: id of workbookComment
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $workbookCommentId = null) {
        ...
        $urlTplParams['workbookCommentId'] = $workbookCommentId;
