...
class WorkbookCommentReplyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $workbookCommentReplyId key: id of workbookCommentReply
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $workbookCommentReplyId = null) {
        ...
        $urlTplParams['workbookCommentReplyId'] = $workbookCommentReplyId;
