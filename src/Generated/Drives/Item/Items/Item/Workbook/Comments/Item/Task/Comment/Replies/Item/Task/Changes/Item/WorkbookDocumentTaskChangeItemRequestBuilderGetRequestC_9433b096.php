...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: WorkbookDocumentTaskChangeItemRequestBuilderGetRequestConfiguration
*/
class WorkbookDocumentTaskChangeItemRequestBuilderGetRequestC_9433b096 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WorkbookDocumentTaskChangeItemRequestBuilderGetRequestC_9433b096 and sets the default values.
