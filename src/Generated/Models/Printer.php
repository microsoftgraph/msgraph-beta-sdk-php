    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            'acceptingJobs' => function (self $o, ParseNode $n) { $o->setAcceptingJobs($n->getBooleanValue()); },
            ...
            'share' => function (self $o, ParseNode $n) { $o->setShare($n->getObjectValue(PrinterShare::class)); },
