...
class Printer extends PrinterBase implements Parsable 
{
    ...
    */
    public function getAcceptingJobs(): ?bool {
        $val = $this->getBackingStore()->get('acceptingJobs');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'acceptingJobs'");
    }
    ...
    */
    public function getShare(): ?PrinterShare {
        ...
        if (is_null($val) || $val instanceof PrinterShare) {
            return $val;
        }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeBooleanValue('acceptingJobs', $this->getAcceptingJobs());
