...
class GovernanceNotificationPolicy implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getEnabledTemplateTypes(): ?array {
        $val = $this->getBackingStore()->get('enabledTemplateTypes');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'enabledTemplateTypes'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'enabledTemplateTypes' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setEnabledTemplateTypes($val);
            },
    ...
    */
    public function getNotificationTemplates(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, GovernanceNotificationTemplate::class);
            /** @var array<GovernanceNotificationTemplate>|null $val */
            return $val;
        }
