...
*/
class UserExperienceAnalyticsWorkFromAnywhereDevice_cloudProvisioningScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsWorkFromAnywhereDevice_cloudProvisioningScore and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsWorkFromAnywhereDevice_cloudProvisioningScore {
        $result = new UserExperienceAnalyticsWorkFromAnywhereDevice_cloudProvisioningScore();
