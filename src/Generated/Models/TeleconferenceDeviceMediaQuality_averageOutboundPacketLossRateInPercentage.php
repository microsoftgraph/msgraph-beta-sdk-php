...
*/
class TeleconferenceDeviceMediaQuality_averageOutboundPacketLossRateInPercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TeleconferenceDeviceMediaQuality_averageOutboundPacketLossRateInPercentage and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TeleconferenceDeviceMediaQuality_averageOutboundPacketLossRateInPercentage {
        $result = new TeleconferenceDeviceMediaQuality_averageOutboundPacketLossRateInPercentage();
