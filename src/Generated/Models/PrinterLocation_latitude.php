...
*/
class PrinterLocation_latitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PrinterLocation_latitude and sets the default values.
    */
     ...
     * @return PrinterLocation_latitude
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PrinterLocation_latitude {
        $result = new PrinterLocation_latitude();
