...
class ApprovalSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'approvalStages' => fn(ParseNode $n) => $o->setApprovalStages($n->getCollectionOfObjectValues([ApprovalStage::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<ApprovalStage>|null $value Value to set for the approvalStages property.
    */
