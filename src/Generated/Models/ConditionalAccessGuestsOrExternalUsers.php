...
class ConditionalAccessGuestsOrExternalUsers implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getExternalTenants(): ?ConditionalAccessExternalTenants {
        $val = $this->getBackingStore()->get('externalTenants');
        if (is_null($val) || $val instanceof ConditionalAccessExternalTenants) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'externalTenants'");
    }
    ...
    */
    public function getGuestOrExternalUserTypes(): ?ConditionalAccessGuestOrExternalUserTypes {
        $val = $this->getBackingStore()->get('guestOrExternalUserTypes');
        if (is_null($val) || $val instanceof ConditionalAccessGuestOrExternalUserTypes) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'guestOrExternalUserTypes'");
    }
