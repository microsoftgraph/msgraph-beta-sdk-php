...
class ExtractAlphaTransformation extends CustomClaimTransformation implements Parsable 
{
    /**
     * Instantiates a new ExtractAlphaTransformation and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ExtractAlphaTransformation {
