...
*/
class DeviceManagementConfigurationSimpleSettingCollectionIns_a974c598 extends DeviceManagementConfigurationSettingInstanceTemplate implements Parsable 
{
    /**
     * Instantiates a new DeviceManagementConfigurationSimpleSettingCollectionIns_a974c598 and sets the default values.
    */
     ...
     * @return DeviceManagementConfigurationSimpleSettingCollectionIns_a974c598
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementConfigurationSimpleSettingCollectionIns_a974c598 {
        return new DeviceManagementConfigurationSimpleSettingCollectionIns_a974c598();
    }
