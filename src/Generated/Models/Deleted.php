...
class Deleted implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function __construct() {
        ...
        $this->setOdataType('#microsoft.graph.deleted');
    }
     ...
     * @return Deleted
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Deleted {
        return new Deleted();
    }
