...
class AndroidImportedPFXCertificateProfile extends AndroidCertificateProfileBase implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AndroidImportedPFXCertificateProfile {
