...
class OnenotePagePreviewLinks implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OnenotePagePreviewLinks {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'previewImageUrl' => fn(ParseNode $n) => $o->setPreviewImageUrl($n->getObjectValue([ExternalLink::class, 'createFromDiscriminatorValue'])),
        ];
    }
