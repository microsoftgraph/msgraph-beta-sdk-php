...
class PlannerPropertyRule implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PlannerPropertyRule {
        ...
        return new PlannerPropertyRule();
    }
    ...
    */
    public function getRuleKind(): ?PlannerRuleKind {
        return $this->getBackingStore()->get('ruleKind');
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeEnumValue('ruleKind', $this->getRuleKind());
