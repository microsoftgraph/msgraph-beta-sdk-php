...
class OrganizationalMessageTenantConsent implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $firstPartyMessageAllowed Indicates if first party message is allowed
    */
    ...
    */
    public function __construct() {
        ...
        $this->setOdataType('#microsoft.graph.organizationalMessageTenantConsent');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OrganizationalMessageTenantConsent {
    ...
    */
    ...
    /**
     * Gets the firstPartyMessageAllowed property value. Indicates if first party message is allowed
     * @return bool|null
    */
    ...
    */
    ...
    /**
     * Sets the firstPartyMessageAllowed property value. Indicates if first party message is allowed
