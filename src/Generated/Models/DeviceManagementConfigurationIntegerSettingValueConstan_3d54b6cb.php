...
*/
class DeviceManagementConfigurationIntegerSettingValueConstan_3d54b6cb extends DeviceManagementConfigurationIntegerSettingValueDefaultTemplate implements Parsable 
{
    /**
     * Instantiates a new DeviceManagementConfigurationIntegerSettingValueConstan_3d54b6cb and sets the default values.
    */
     ...
     * @return DeviceManagementConfigurationIntegerSettingValueConstan_3d54b6cb
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementConfigurationIntegerSettingValueConstan_3d54b6cb {
        return new DeviceManagementConfigurationIntegerSettingValueConstan_3d54b6cb();
    }
