...
class TargetOwners implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getNotifyMembers(): ?NotifyMembers {
        $val = $this->getBackingStore()->get('notifyMembers');
        if (is_null($val) || $val instanceof NotifyMembers) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'notifyMembers'");
    }
    ...
    */
    public function setNotifyMembers(?NotifyMembers $value): void {
        $this->getBackingStore()->set('notifyMembers', $value);
    }
