...
class PlannerApprovalRequirement implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PlannerApprovalRequirement and sets the default values.
    */
     ...
     * @return PlannerApprovalRequirement
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PlannerApprovalRequirement {
