...
class RiskDetection extends Entity implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'riskType' => fn(ParseNode $n) => $o->setRiskType($n->getEnumValue(RiskDetection_riskType::class)),
    ...
    */
     ...
     * @return RiskDetection_riskType|null
    */
    public function getRiskType(): ?RiskDetection_riskType {
        $val = $this->getBackingStore()->get('riskType');
        if (is_null($val) || $val instanceof RiskDetection_riskType) {
            return $val;
        }
    ...
    */
     ...
     * @param RiskDetection_riskType|null $value Value to set for the riskType property.
    */
    public function setRiskType(?RiskDetection_riskType $value): void {
