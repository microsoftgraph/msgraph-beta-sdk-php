...
class CustomAccessPackageWorkflowExtensionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<CustomAccessPackageWorkflowExtension>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CustomAccessPackageWorkflowExtensionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(CustomAccessPackageWorkflowExtension::class, 'createFromDiscriminatorValue'))); },
        ];
    }
    ...
    */
     ...
     *  @param array<CustomAccessPackageWorkflowExtension>|null $value Value to set for the value property.
    */
