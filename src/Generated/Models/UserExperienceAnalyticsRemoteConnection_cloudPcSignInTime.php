...
*/
class UserExperienceAnalyticsRemoteConnection_cloudPcSignInTime implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsRemoteConnection_cloudPcSignInTime and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsRemoteConnection_cloudPcSignInTime
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsRemoteConnection_cloudPcSignInTime {
        $result = new UserExperienceAnalyticsRemoteConnection_cloudPcSignInTime();
