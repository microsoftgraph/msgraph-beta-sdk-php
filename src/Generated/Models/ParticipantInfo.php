...
class ParticipantInfo implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getNonAnonymizedIdentity(): ?IdentitySet {
        $val = $this->getBackingStore()->get('nonAnonymizedIdentity');
        if (is_null($val) || $val instanceof IdentitySet) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'nonAnonymizedIdentity'");
    }
    ...
    */
    public function getPlatformId(): ?string {
        $val = $this->getBackingStore()->get('platformId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'platformId'");
    }
