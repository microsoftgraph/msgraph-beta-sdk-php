...
class AwsIdentity extends AuthorizationSystemIdentity implements Parsable 
{
    /**
    ...
    */
     ...
     * @return AwsIdentity
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AwsIdentity {
