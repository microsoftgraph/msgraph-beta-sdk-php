...
class SimulationAutomationRunCollectionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<SimulationAutomationRun>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SimulationAutomationRunCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(SimulationAutomationRun::class, 'createFromDiscriminatorValue'))); },
        ];
    }
    ...
    */
     ...
     *  @param array<SimulationAutomationRun>|null $value Value to set for the value property.
    */
