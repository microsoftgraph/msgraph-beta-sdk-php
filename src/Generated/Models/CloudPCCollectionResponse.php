...
class CloudPCCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<CloudPC>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CloudPCCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(CloudPC::class)); },
        ];
    }
