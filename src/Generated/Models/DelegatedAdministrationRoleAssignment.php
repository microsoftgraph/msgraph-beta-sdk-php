...
class DelegatedAdministrationRoleAssignment implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DelegatedAdministrationRoleAssignment and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DelegatedAdministrationRoleAssignment {
