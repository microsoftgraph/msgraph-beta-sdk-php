...
class CustomClaimBase implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CustomClaimBase {
    ...
    */
    public function getConfigurations(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, CustomClaimConfiguration::class);
            /** @var array<CustomClaimConfiguration>|null $val */
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'configurations' => fn(ParseNode $n) => $o->setConfigurations($n->getCollectionOfObjectValues([CustomClaimConfiguration::class, 'createFromDiscriminatorValue'])),
