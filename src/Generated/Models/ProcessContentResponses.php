...
class ProcessContentResponses implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ProcessContentResponses {
        return new ProcessContentResponses();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'results' => fn(ParseNode $n) => $o->setResults($n->getObjectValue([ProcessContentResponse::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
     ...
     * @return ProcessContentResponse|null
    */
    public function getResults(): ?ProcessContentResponse {
        $val = $this->getBackingStore()->get('results');
        if (is_null($val) || $val instanceof ProcessContentResponse) {
            return $val;
        }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeObjectValue('results', $this->getResults());
    ...
    */
     ...
     * @param ProcessContentResponse|null $value Value to set for the results property.
    */
    public function setResults(?ProcessContentResponse $value): void {
