...
class CloudPcRegionGroupConfiguration implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CloudPcRegionGroupConfiguration and sets the default values.
    */
    ...
    */
    public function getRegions(): ?array {
        $val = $this->getBackingStore()->get('regions');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'regions'");
    }
    ...
    */
    public function setRegions(?array $value): void {
        $this->getBackingStore()->set('regions', $value);
    }
