...
class OnPasswordSubmitListener extends AuthenticationEventListener implements Parsable 
{
    /**
     * Instantiates a new OnPasswordSubmitListener and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OnPasswordSubmitListener {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'handler' => fn(ParseNode $n) => $o->setHandler($n->getObjectValue([OnPasswordSubmitHandler::class, 'createFromDiscriminatorValue'])),
        ]);
    }
     ...
     * @return OnPasswordSubmitHandler|null
    */
    public function getHandler(): ?OnPasswordSubmitHandler {
        $val = $this->getBackingStore()->get('handler');
        if (is_null($val) || $val instanceof OnPasswordSubmitHandler) {
            return $val;
        }
    ...
    */
     ...
     * @param OnPasswordSubmitHandler|null $value Value to set for the handler property.
    */
    public function setHandler(?OnPasswordSubmitHandler $value): void {
