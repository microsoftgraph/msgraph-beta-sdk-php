...
class Channel extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'moderationSettings' => function (ParseNode $n) use ($o) { $o->setModerationSettings($n->getObjectValue(array(ChannelModerationSettings::class, 'createFromDiscriminatorValue'))); },
