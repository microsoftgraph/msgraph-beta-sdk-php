...
class Channel extends Entity 
{
    ...
    /** @var array<SharedWithChannelTeamInfo>|null $sharedWithTeams The sharedWithTeams property */
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'moderationSettings' => function (self $o, ParseNode $n) { $o->setModerationSettings($n->getObjectValue(ChannelModerationSettings::class)); },
            'sharedWithTeams' => function (self $o, ParseNode $n) { $o->setSharedWithTeams($n->getCollectionOfObjectValues(SharedWithChannelTeamInfo::class)); },
    ...
    */
    ...
    /**
     * Gets the sharedWithTeams property value. The sharedWithTeams property
    ...
    */
    ...
    /**
     * Sets the sharedWithTeams property value. The sharedWithTeams property
