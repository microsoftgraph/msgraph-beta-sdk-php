...
*/
class UserExperienceAnalyticsWorkFromAnywhereDevice_cloudIdentityScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsWorkFromAnywhereDevice_cloudIdentityScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereDevice_cloudIdentityScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsWorkFromAnywhereDevice_cloudIdentityScore {
