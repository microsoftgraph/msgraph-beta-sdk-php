...
class UnitMap extends BaseMapFeature implements Parsable 
{
    /**
     * Instantiates a new UnitMap and sets the default values.
    */
     ...
     * @return UnitMap
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UnitMap {
        return new UnitMap();
    }
