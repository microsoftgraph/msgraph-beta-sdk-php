...
class EducationAssignment extends Entity implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'feedbackResourcesFolderUrl' => function (ParseNode $n) use ($o) { $o->setFeedbackResourcesFolderUrl($n->getStringValue()); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeStringValue('feedbackResourcesFolderUrl', $this->feedbackResourcesFolderUrl);
