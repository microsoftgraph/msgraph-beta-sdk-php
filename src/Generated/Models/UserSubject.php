...
class UserSubject extends ConditionalAccessWhatIfSubject implements Parsable 
{
    /**
    ...
    */
     ...
     * @return UserSubject
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserSubject {
