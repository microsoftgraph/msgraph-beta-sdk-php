...
class AuthenticationFlowsPolicy extends Entity implements Parsable 
{
    ...
    */
    public function getSelfServiceSignUp(): ?SelfServiceSignUpAuthenticationFlowConfiguration {
        $val = $this->getBackingStore()->get('selfServiceSignUp');
        if (is_null($val) || $val instanceof SelfServiceSignUpAuthenticationFlowConfiguration) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'selfServiceSignUp'");
    }
