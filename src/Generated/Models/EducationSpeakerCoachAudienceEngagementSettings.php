...
class EducationSpeakerCoachAudienceEngagementSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EducationSpeakerCoachAudienceEngagementSettings and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EducationSpeakerCoachAudienceEngagementSettings {
        return new EducationSpeakerCoachAudienceEngagementSettings();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'isBodyLanguageEnabled' => fn(ParseNode $n) => $o->setIsBodyLanguageEnabled($n->getBooleanValue()),
    ...
    */
    public function getIsBodyLanguageEnabled(): ?bool {
        $val = $this->getBackingStore()->get('isBodyLanguageEnabled');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isBodyLanguageEnabled'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeBooleanValue('isBodyLanguageEnabled', $this->getIsBodyLanguageEnabled());
    ...
    */
    public function setIsBodyLanguageEnabled(?bool $value): void {
        $this->getBackingStore()->set('isBodyLanguageEnabled', $value);
    }
