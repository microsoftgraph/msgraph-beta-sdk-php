...
class ProvisioningStatusInfo implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getErrorInformation(): ?ProvisioningErrorInfo {
        $val = $this->getBackingStore()->get('errorInformation');
        if (is_null($val) || $val instanceof ProvisioningErrorInfo) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'errorInformation'");
    }
