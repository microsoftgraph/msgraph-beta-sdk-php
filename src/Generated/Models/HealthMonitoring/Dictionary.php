...
class Dictionary implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Dictionary {
        ...
        if ($mappingValueNode !== null) {
            ...
            switch ($mappingValue) {
                ...
                case '#microsoft.graph.healthMonitoring.healthMonitoringDictionary': return new HealthMonitoringDictionary();
