...
class AuthenticationStrengthRoot extends Entity implements Parsable 
{
    ...
    */
    public function getAuthenticationCombinations(): ?array {
        $val = $this->getBackingStore()->get('authenticationCombinations');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, AuthenticationMethodModes::class);
            /** @var array<AuthenticationMethodModes>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'authenticationCombinations'");
    }
