...
class Event extends OutlookItem implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'cancelledOccurrences' => function (ParseNode $n) use ($o) { $o->setCancelledOccurrences($n->getCollectionOfPrimitiveValues()); },
            'end' => function (ParseNode $n) use ($o) { $o->setEnd($n->getObjectValue(array(DateTimeTimeZone::class, 'createFromDiscriminatorValue'))); },
            'exceptionOccurrences' => function (ParseNode $n) use ($o) { $o->setExceptionOccurrences($n->getCollectionOfObjectValues(array(Event::class, 'createFromDiscriminatorValue'))); },
            ...
            'occurrenceId' => function (ParseNode $n) use ($o) { $o->setOccurrenceId($n->getStringValue()); },
            ...
            'uid' => function (ParseNode $n) use ($o) { $o->setUid($n->getStringValue()); },
