...
class ConditionalAccessPlatforms implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<ConditionalAccessDevicePlatform>|null $excludePlatforms Possible values are: android, iOS, windows, windowsPhone, macOS, all, unknownFutureValue, linux.
    */
    private ?array $excludePlatforms = null;
    
    /**
     * @var array<ConditionalAccessDevicePlatform>|null $includePlatforms Possible values are: android, iOS, windows, windowsPhone, macOS, all, unknownFutureValue,linux``.
    */
