...
*/
class WorkbookRangeFormat_rowHeight implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WorkbookRangeFormat_rowHeight and sets the default values.
    */
     ...
     * @return WorkbookRangeFormat_rowHeight
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WorkbookRangeFormat_rowHeight {
        $result = new WorkbookRangeFormat_rowHeight();
