...
class WebApplicationFirewallVerifiedDetails implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getDnsConfiguration(): ?WebApplicationFirewallDnsConfiguration {
        $val = $this->getBackingStore()->get('dnsConfiguration');
        if (is_null($val) || $val instanceof WebApplicationFirewallDnsConfiguration) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'dnsConfiguration'");
    }
    ...
    */
    public function setDnsConfiguration(?WebApplicationFirewallDnsConfiguration $value): void {
        $this->getBackingStore()->set('dnsConfiguration', $value);
    }
