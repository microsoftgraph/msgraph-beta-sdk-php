...
class MacOsVppApp extends MobileApp implements Parsable 
{
    ...
    */
    public function getAssignedLicenses(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, MacOsVppAppAssignedLicense::class);
            /** @var array<MacOsVppAppAssignedLicense>|null $val */
            return $val;
        }
    ...
    */
    public function getRevokeLicenseActionResults(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, MacOsVppAppRevokeLicensesActionResult::class);
            /** @var array<MacOsVppAppRevokeLicensesActionResult>|null $val */
            return $val;
        }
