...
class RecycleBinSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RecycleBinSettings {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'retentionPeriodOverrideDays' => fn(ParseNode $n) => $o->setRetentionPeriodOverrideDays($n->getIntegerValue()),
        ];
    }
    ...
    */
    public function getRetentionPeriodOverrideDays(): ?int {
        $val = $this->getBackingStore()->get('retentionPeriodOverrideDays');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'retentionPeriodOverrideDays'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeIntegerValue('retentionPeriodOverrideDays', $this->getRetentionPeriodOverrideDays());
    ...
    */
    public function setRetentionPeriodOverrideDays(?int $value): void {
        $this->getBackingStore()->set('retentionPeriodOverrideDays', $value);
    }
