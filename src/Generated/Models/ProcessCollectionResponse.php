...
class ProcessCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
     * @var array<Process>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ProcessCollectionResponse {
