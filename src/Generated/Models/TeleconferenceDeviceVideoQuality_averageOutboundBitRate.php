...
*/
class TeleconferenceDeviceVideoQuality_averageOutboundBitRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TeleconferenceDeviceVideoQuality_averageOutboundBitRate and sets the default values.
    */
     ...
     * @return TeleconferenceDeviceVideoQuality_averageOutboundBitRate
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TeleconferenceDeviceVideoQuality_averageOutboundBitRate {
