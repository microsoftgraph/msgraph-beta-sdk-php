...
*/
class UserExperienceAnalyticsBatteryHealthAppImpact_batteryUsagePercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsBatteryHealthAppImpact_batteryUsagePercentage and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsBatteryHealthAppImpact_batteryUsagePercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsBatteryHealthAppImpact_batteryUsagePercentage {
        $result = new UserExperienceAnalyticsBatteryHealthAppImpact_batteryUsagePercentage();
