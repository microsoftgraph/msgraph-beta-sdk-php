...
*/
class OutlookGeoCoordinates_altitudeAccuracy implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OutlookGeoCoordinates_altitudeAccuracy and sets the default values.
    */
     ...
     * @return OutlookGeoCoordinates_altitudeAccuracy
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OutlookGeoCoordinates_altitudeAccuracy {
        $result = new OutlookGeoCoordinates_altitudeAccuracy();
