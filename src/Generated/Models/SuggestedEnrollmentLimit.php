...
*/
class SuggestedEnrollmentLimit implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getSuggestedDailyLimit(): ?int {
        $val = $this->getBackingStore()->get('suggestedDailyLimit');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'suggestedDailyLimit'");
    }
    ...
    */
    public function setSuggestedDailyLimit(?int $value): void {
        $this->getBackingStore()->set('suggestedDailyLimit', $value);
    }
