...
class DelegatedAdminRelationshipRequestCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DelegatedAdminRelationshipRequest>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DelegatedAdminRelationshipRequestCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DelegatedAdminRelationshipRequest::class)); },
        ];
    }
