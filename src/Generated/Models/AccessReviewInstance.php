    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'definition' => function (self $o, ParseNode $n) { $o->setDefinition($n->getObjectValue(AccessReviewScheduleDefinition::class)); },
            'endDateTime' => function (self $o, ParseNode $n) { $o->setEndDateTime($n->getDateTimeValue()); },
            'errors' => function (self $o, ParseNode $n) { $o->setErrors($n->getCollectionOfObjectValues(AccessReviewError::class)); },
            ...
            'stages' => function (self $o, ParseNode $n) { $o->setStages($n->getCollectionOfObjectValues(AccessReviewStage::class)); },
