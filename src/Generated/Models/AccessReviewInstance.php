...
class AccessReviewInstance extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var AccessReviewScheduleDefinition|null $definition There is exactly one accessReviewScheduleDefinition associated with each instance. It is the parent schedule for the instance, where instances are created for each recurrence of a review definition and each group selected to review by the definition.
    */
    private ?AccessReviewScheduleDefinition $definition = null;
    ...
    */
    ...
    /**
     * @var array<AccessReviewError>|null $errors Collection of errors in an access review instance lifecycle. Read-only.
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'definition' => function (ParseNode $n) use ($o) { $o->setDefinition($n->getObjectValue(array(AccessReviewScheduleDefinition::class, 'createFromDiscriminatorValue'))); },
            'endDateTime' => function (ParseNode $n) use ($o) { $o->setEndDateTime($n->getDateTimeValue()); },
            'errors' => function (ParseNode $n) use ($o) { $o->setErrors($n->getCollectionOfObjectValues(array(AccessReviewError::class, 'createFromDiscriminatorValue'))); },
