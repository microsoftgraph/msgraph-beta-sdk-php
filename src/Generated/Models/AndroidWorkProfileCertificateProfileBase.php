...
class AndroidWorkProfileCertificateProfileBase extends DeviceConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var AndroidWorkProfileTrustedRootCertificate|null $rootCertificate Trusted Root Certificate.
    */
    private ?AndroidWorkProfileTrustedRootCertificate $rootCertificate = null;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'rootCertificate' => function (ParseNode $n) use ($o) { $o->setRootCertificate($n->getObjectValue(array(AndroidWorkProfileTrustedRootCertificate::class, 'createFromDiscriminatorValue'))); },
    ...
    */
    public function getRootCertificate(): ?AndroidWorkProfileTrustedRootCertificate {
    ...
    */
     ...
     *  @param AndroidWorkProfileTrustedRootCertificate|null $value Value to set for the rootCertificate property.
    */
