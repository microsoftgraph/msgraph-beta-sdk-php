...
*/
class WorkbookChartFont_size implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WorkbookChartFont_size and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WorkbookChartFont_size {
        $result = new WorkbookChartFont_size();
