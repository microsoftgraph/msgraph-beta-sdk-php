...
class AndroidManagedAppProtectionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AndroidManagedAppProtectionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(AndroidManagedAppProtection::class, 'createFromDiscriminatorValue'))); },
        ];
    }
