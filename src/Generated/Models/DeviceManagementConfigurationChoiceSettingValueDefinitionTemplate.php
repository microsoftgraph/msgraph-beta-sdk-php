...
class DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<DeviceManagementConfigurationOptionDefinitionTemplate>|null $allowedOptions Choice Setting Allowed Options
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate {
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeCollectionOfObjectValues('allowedOptions', $this->allowedOptions);
    ...
    */
     ...
     *  @param array<DeviceManagementConfigurationOptionDefinitionTemplate>|null $value Value to set for the allowedOptions property.
    */
    public function setAllowedOptions(?array $value ): void {
