...
class AndroidGeneralDeviceConfiguration extends DeviceConfiguration implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $dateAndTimeBlockChanges Indicates whether or not to block changing date and time while in KNOX Mode.
    */
    private ?bool $dateAndTimeBlockChanges = null;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'dateAndTimeBlockChanges' => function (ParseNode $n) use ($o) { $o->setDateAndTimeBlockChanges($n->getBooleanValue()); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeBooleanValue('dateAndTimeBlockChanges', $this->dateAndTimeBlockChanges);
