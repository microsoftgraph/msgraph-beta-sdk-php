...
*/
class DeviceGeoLocation_altitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceGeoLocation_altitude and sets the default values.
    */
     ...
     * @return DeviceGeoLocation_altitude
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceGeoLocation_altitude {
        $result = new DeviceGeoLocation_altitude();
