...
*/
class UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudManagementScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudManagementScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudManagementScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudManagementScore {
