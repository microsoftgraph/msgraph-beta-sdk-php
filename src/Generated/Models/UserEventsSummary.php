...
class UserEventsSummary extends Entity implements Parsable 
{
    /**
     * Instantiates a new UserEventsSummary and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserEventsSummary {
