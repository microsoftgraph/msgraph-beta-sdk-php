...
class InformationalUrls implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getAppSignUpUrl(): ?string {
        $val = $this->getBackingStore()->get('appSignUpUrl');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'appSignUpUrl'");
    }
    ...
    */
    public function getSingleSignOnDocumentationUrl(): ?string {
        $val = $this->getBackingStore()->get('singleSignOnDocumentationUrl');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'singleSignOnDocumentationUrl'");
    }
