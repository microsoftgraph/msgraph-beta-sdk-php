...
class ImportedDeviceIdentityResult extends ImportedDeviceIdentity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ImportedDeviceIdentityResult {
