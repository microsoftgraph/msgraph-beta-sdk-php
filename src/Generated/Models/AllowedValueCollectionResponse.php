...
class AllowedValueCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AllowedValue>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AllowedValueCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(AllowedValue::class)); },
        ];
    }
