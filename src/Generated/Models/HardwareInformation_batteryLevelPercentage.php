...
*/
class HardwareInformation_batteryLevelPercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new HardwareInformation_batteryLevelPercentage and sets the default values.
    */
     ...
     * @return HardwareInformation_batteryLevelPercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): HardwareInformation_batteryLevelPercentage {
        $result = new HardwareInformation_batteryLevelPercentage();
