...
class AndroidWorkProfileTrustedRootCertificate extends DeviceConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AndroidWorkProfileTrustedRootCertificate {
