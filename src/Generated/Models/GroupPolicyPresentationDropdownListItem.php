...
class GroupPolicyPresentationDropdownListItem implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $displayName Localized display name for the drop-down list item.
    */
    ...
    */
    ...
    /**
     * @var string|null $value Associated value for the drop-down list item
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GroupPolicyPresentationDropdownListItem {
