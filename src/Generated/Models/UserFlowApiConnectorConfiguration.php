...
class UserFlowApiConnectorConfiguration implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getPreTokenIssuance(): ?IdentityApiConnector {
        $val = $this->getBackingStore()->get('preTokenIssuance');
        if (is_null($val) || $val instanceof IdentityApiConnector) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'preTokenIssuance'");
    }
    ...
    */
    public function setPreTokenIssuance(?IdentityApiConnector $value): void {
        $this->getBackingStore()->set('preTokenIssuance', $value);
    }
