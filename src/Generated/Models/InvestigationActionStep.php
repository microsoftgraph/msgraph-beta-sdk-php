...
class InvestigationActionStep implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new InvestigationActionStep and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): InvestigationActionStep {
    ...
    */
    public function getActionUrl(): ?InvestigationActionUrl {
        ...
        if (is_null($val) || $val instanceof InvestigationActionUrl) {
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'actionUrl' => fn(ParseNode $n) => $o->setActionUrl($n->getObjectValue([InvestigationActionUrl::class, 'createFromDiscriminatorValue'])),
