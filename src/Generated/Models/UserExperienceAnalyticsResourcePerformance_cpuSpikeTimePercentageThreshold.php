...
*/
class UserExperienceAnalyticsResourcePerformance_cpuSpikeTimePercentageThreshold implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsResourcePerformance_cpuSpikeTimePercentageThreshold and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsResourcePerformance_cpuSpikeTimePercentageThreshold
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsResourcePerformance_cpuSpikeTimePercentageThreshold {
        $result = new UserExperienceAnalyticsResourcePerformance_cpuSpikeTimePercentageThreshold();
