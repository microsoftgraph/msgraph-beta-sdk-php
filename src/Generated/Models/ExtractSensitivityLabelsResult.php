...
class ExtractSensitivityLabelsResult implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'labels' => fn(ParseNode $n) => $o->setLabels($n->getCollectionOfObjectValues([SensitivityLabelAssignment::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function getLabels(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, SensitivityLabelAssignment::class);
            /** @var array<SensitivityLabelAssignment>|null $val */
            return $val;
        }
