...
class CloudPcAuditProperty implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getNewValue(): ?string {
        $val = $this->getBackingStore()->get('newValue');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'newValue'");
    }
    ...
    */
    public function getOldValue(): ?string {
        $val = $this->getBackingStore()->get('oldValue');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'oldValue'");
    }
