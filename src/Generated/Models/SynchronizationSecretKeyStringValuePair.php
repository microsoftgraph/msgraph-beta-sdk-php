...
class SynchronizationSecretKeyStringValuePair implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'key' => fn(ParseNode $n) => $o->setKey($n->getEnumValue(SynchronizationSecret::class)),
    ...
    */
    public function getKey(): ?SynchronizationSecret {
        ...
        if (is_null($val) || $val instanceof SynchronizationSecret) {
            return $val;
        }
