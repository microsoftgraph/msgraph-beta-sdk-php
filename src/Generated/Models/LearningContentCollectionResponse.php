...
class LearningContentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<LearningContent>|null $value The value property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(LearningContent::class, 'createFromDiscriminatorValue'))); },
        ];
    }
