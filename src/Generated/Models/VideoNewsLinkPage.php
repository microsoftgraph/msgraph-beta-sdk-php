...
class VideoNewsLinkPage extends BaseSitePage implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VideoNewsLinkPage {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'videoDuration' => fn(ParseNode $n) => $o->setVideoDuration($n->getDateIntervalValue()),
        ]);
    }
    ...
    */
    public function getVideoDuration(): ?DateInterval {
        $val = $this->getBackingStore()->get('videoDuration');
        if (is_null($val) || $val instanceof DateInterval) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'videoDuration'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeDateIntervalValue('videoDuration', $this->getVideoDuration());
    }
    ...
    */
     ...
     * @param DateInterval|null $value Value to set for the videoDuration property.
    */
    public function setVideoDuration(?DateInterval $value): void {
        $this->getBackingStore()->set('videoDuration', $value);
    }
