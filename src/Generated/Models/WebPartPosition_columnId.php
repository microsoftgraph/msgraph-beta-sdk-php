...
*/
class WebPartPosition_columnId implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WebPartPosition_columnId and sets the default values.
    */
     ...
     * @return WebPartPosition_columnId
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WebPartPosition_columnId {
        $result = new WebPartPosition_columnId();
