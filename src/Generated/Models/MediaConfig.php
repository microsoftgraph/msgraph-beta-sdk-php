...
class MediaConfig implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getRemoveFromDefaultAudioGroup(): ?bool {
        $val = $this->getBackingStore()->get('removeFromDefaultAudioGroup');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'removeFromDefaultAudioGroup'");
    }
    ...
    */
    public function setRemoveFromDefaultAudioGroup(?bool $value): void {
        $this->getBackingStore()->set('removeFromDefaultAudioGroup', $value);
    }
