...
class EducationSynchronizationProfileStatus extends Entity 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): EducationSynchronizationProfileStatus {
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'lastActivityDateTime' => function (self $o, ParseNode $n) { $o->setLastActivityDateTime($n->getDateTimeValue()); },
            'lastSynchronizationDateTime' => function (self $o, ParseNode $n) { $o->setLastSynchronizationDateTime($n->getDateTimeValue()); },
            'status' => function (self $o, ParseNode $n) { $o->setStatus($n->getEnumValue(EducationSynchronizationStatus::class)); },
