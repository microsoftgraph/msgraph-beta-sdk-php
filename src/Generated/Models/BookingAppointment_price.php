...
*/
class BookingAppointment_price implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new BookingAppointment_price and sets the default values.
    */
     ...
     * @return BookingAppointment_price
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): BookingAppointment_price {
        $result = new BookingAppointment_price();
