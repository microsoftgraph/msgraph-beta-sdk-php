...
class AwsSource extends AuthorizationSystemIdentitySource implements Parsable 
{
    /**
    ...
    */
     ...
     * @return AwsSource
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AwsSource {
