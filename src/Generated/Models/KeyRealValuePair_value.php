...
*/
class KeyRealValuePair_value implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new KeyRealValuePair_value and sets the default values.
    */
     ...
     * @return KeyRealValuePair_value
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): KeyRealValuePair_value {
        $result = new KeyRealValuePair_value();
