...
*/
class UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore {
        $result = new UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore();
