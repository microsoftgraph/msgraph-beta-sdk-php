...
class SiteExclusionUnitsBulkAdditionJob extends ExclusionUnitBulkAdditionJob implements Parsable 
{
    /**
     * Instantiates a new SiteExclusionUnitsBulkAdditionJob and sets the default values.
    */
    public function __construct() {
        parent::__construct();
        $this->setOdataType('#microsoft.graph.siteExclusionUnitsBulkAdditionJob');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SiteExclusionUnitsBulkAdditionJob {
        return new SiteExclusionUnitsBulkAdditionJob();
    }
