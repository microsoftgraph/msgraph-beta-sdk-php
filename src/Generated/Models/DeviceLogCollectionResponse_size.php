...
*/
class DeviceLogCollectionResponse_size implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceLogCollectionResponse_size and sets the default values.
    */
     ...
     * @return DeviceLogCollectionResponse_size
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceLogCollectionResponse_size {
        $result = new DeviceLogCollectionResponse_size();
