...
{
    /**
     * @var array<string>|null $appliesToCombinations The appliesToCombinations property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'appliesToCombinations' => function (ParseNode $n) use ($o) { $o->setAppliesToCombinations($n->getCollectionOfPrimitiveValues()); },
        ]);
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeCollectionOfPrimitiveValues('appliesToCombinations', $this->appliesToCombinations);
    }

    /**
     * Sets the appliesToCombinations property value. The appliesToCombinations property
     *  @param array<string>|null $value Value to set for the appliesToCombinations property.
    */
