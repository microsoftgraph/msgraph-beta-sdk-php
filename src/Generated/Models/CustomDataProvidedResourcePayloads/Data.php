...
class Data implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Data and sets the default values.
    */
     ...
     * @return Data
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Data {
        ...
        if ($mappingValueNode !== null) {
            ...
            switch ($mappingValue) {
                ...
                case '#microsoft.graph.customDataProvidedResourcePayloads.accessReviewContextDataBase': return new AccessReviewContextDataBase();
