    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'authorizedApplicationRulesFromGroupPolicyNotMerged' => function (ParseNode $n) use ($o) { $o->setAuthorizedApplicationRulesFromGroupPolicyNotMerged($n->getBooleanValue()); },
            ...
            'connectionSecurityRulesFromGroupPolicyNotMerged' => function (ParseNode $n) use ($o) { $o->setConnectionSecurityRulesFromGroupPolicyNotMerged($n->getBooleanValue()); },
            ...
            'globalPortRulesFromGroupPolicyNotMerged' => function (ParseNode $n) use ($o) { $o->setGlobalPortRulesFromGroupPolicyNotMerged($n->getBooleanValue()); },
            'inboundConnectionsBlocked' => function (ParseNode $n) use ($o) { $o->setInboundConnectionsBlocked($n->getBooleanValue()); },
            'inboundConnectionsRequired' => function (ParseNode $n) use ($o) { $o->setInboundConnectionsRequired($n->getBooleanValue()); },
            ...
            'policyRulesFromGroupPolicyNotMerged' => function (ParseNode $n) use ($o) { $o->setPolicyRulesFromGroupPolicyNotMerged($n->getBooleanValue()); },
            'securedPacketExemptionAllowed' => function (ParseNode $n) use ($o) { $o->setSecuredPacketExemptionAllowed($n->getBooleanValue()); },
            'securedPacketExemptionBlocked' => function (ParseNode $n) use ($o) { $o->setSecuredPacketExemptionBlocked($n->getBooleanValue()); },
            'stealthModeBlocked' => function (ParseNode $n) use ($o) { $o->setStealthModeBlocked($n->getBooleanValue()); },
            'stealthModeRequired' => function (ParseNode $n) use ($o) { $o->setStealthModeRequired($n->getBooleanValue()); },
            ...
            'unicastResponsesToMulticastBroadcastsRequired' => function (ParseNode $n) use ($o) { $o->setUnicastResponsesToMulticastBroadcastsRequired($n->getBooleanValue()); },
        ];
    }
