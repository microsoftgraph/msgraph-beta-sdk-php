...
class WindowsFirewallNetworkProfile implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getAuthorizedApplicationRulesFromGroupPolicyNotMerged(): ?bool {
        $val = $this->getBackingStore()->get('authorizedApplicationRulesFromGroupPolicyNotMerged');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'authorizedApplicationRulesFromGroupPolicyNotMerged'");
    }
    ...
    */
    public function getConnectionSecurityRulesFromGroupPolicyNotMerged(): ?bool {
        $val = $this->getBackingStore()->get('connectionSecurityRulesFromGroupPolicyNotMerged');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'connectionSecurityRulesFromGroupPolicyNotMerged'");
    }
    ...
    */
    public function getGlobalPortRulesFromGroupPolicyNotMerged(): ?bool {
        $val = $this->getBackingStore()->get('globalPortRulesFromGroupPolicyNotMerged');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'globalPortRulesFromGroupPolicyNotMerged'");
    }
    ...
    */
    public function getInboundConnectionsRequired(): ?bool {
        $val = $this->getBackingStore()->get('inboundConnectionsRequired');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'inboundConnectionsRequired'");
    }
    ...
    */
    public function getInboundNotificationsRequired(): ?bool {
        $val = $this->getBackingStore()->get('inboundNotificationsRequired');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'inboundNotificationsRequired'");
    }
    ...
    */
    public function getIncomingTrafficRequired(): ?bool {
        $val = $this->getBackingStore()->get('incomingTrafficRequired');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'incomingTrafficRequired'");
    }
    ...
    */
    public function getOutboundConnectionsRequired(): ?bool {
        $val = $this->getBackingStore()->get('outboundConnectionsRequired');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'outboundConnectionsRequired'");
    }
    ...
    */
    public function getPolicyRulesFromGroupPolicyNotMerged(): ?bool {
        $val = $this->getBackingStore()->get('policyRulesFromGroupPolicyNotMerged');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'policyRulesFromGroupPolicyNotMerged'");
    }
    ...
    */
    public function getSecuredPacketExemptionBlocked(): ?bool {
        $val = $this->getBackingStore()->get('securedPacketExemptionBlocked');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'securedPacketExemptionBlocked'");
    }
    ...
    */
    public function getStealthModeRequired(): ?bool {
        $val = $this->getBackingStore()->get('stealthModeRequired');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'stealthModeRequired'");
    }
    ...
    */
    public function getUnicastResponsesToMulticastBroadcastsRequired(): ?bool {
        $val = $this->getBackingStore()->get('unicastResponsesToMulticastBroadcastsRequired');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'unicastResponsesToMulticastBroadcastsRequired'");
    }
