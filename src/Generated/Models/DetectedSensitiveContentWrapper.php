...
class DetectedSensitiveContentWrapper implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getClassification(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, DetectedSensitiveContent::class);
            /** @var array<DetectedSensitiveContent>|null $val */
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'classification' => fn(ParseNode $n) => $o->setClassification($n->getCollectionOfObjectValues([DetectedSensitiveContent::class, 'createFromDiscriminatorValue'])),
