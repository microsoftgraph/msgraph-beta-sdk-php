...
class CrossTenantUserSyncInbound implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CrossTenantUserSyncInbound {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'isSyncAllowed' => fn(ParseNode $n) => $o->setIsSyncAllowed($n->getBooleanValue()),
    ...
    */
    public function getIsSyncAllowed(): ?bool {
        $val = $this->getBackingStore()->get('isSyncAllowed');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isSyncAllowed'");
    }
