...
class Windows10GeneralConfiguration extends DeviceConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var Enablement|null $activateAppsWithVoice Specifies if Windows apps can be activated by voice. Possible values are: notConfigured, enabled, disabled.
    */
    ...
    */
    ...
    /**
     * @var Enablement|null $authenticationWebSignIn Indicates whether or not Web Credential Provider will be enabled. Possible values are: notConfigured, enabled, disabled.
    */
    ...
    */
    ...
    /**
     * @var ConfigurationUsage|null $cellularData Whether or not to allow the cellular data channel on the device. If not configured, the cellular data channel is allowed and the user can turn it off. Possible values are: blocked, required, allowed, notConfigured.
    */
    ...
    */
    ...
    /**
     * @var DefenderProtectionType|null $defenderPotentiallyUnwantedAppActionSetting Gets or sets Defender’s action to take on Potentially Unwanted Application (PUA), which includes software with behaviors of ad-injection, software bundling, persistent solicitation for payment or subscription, etc. Defender alerts user when PUA is being downloaded or attempts to install itself. Added in Windows 10 for desktop. Possible values are: userDefined, enable, auditMode, warn, notConfigured.
    */
    ...
    */
    ...
    /**
     * @var VisibilitySetting|null $edgeFavoritesBarVisibility Get or set a value that specifies whether to set the favorites bar to always be visible or hidden on any page. Possible values are: notConfigured, hide, show.
    */
    ...
    */
    ...
    /**
     * @var EdgeKioskModeRestrictionType|null $edgeKioskModeRestriction Controls how the Microsoft Edge settings are restricted based on the configure kiosk mode. Possible values are: notConfigured, digitalSignage, normalMode, publicBrowsingSingleApp, publicBrowsingMultiApp.
    */
    ...
    */
    ...
    /**
     * @var EdgeOpenOptions|null $edgeOpensWith Specify what kind of pages are open at start. Possible values are: notConfigured, startPage, newTabPage, previousPages, specificPages.
    */
    ...
    */
    ...
    /**
     * @var InternetExplorerMessageSetting|null $edgeShowMessageWhenOpeningInternetExplorerSites Controls the message displayed by Edge before switching to Internet Explorer. Possible values are: notConfigured, disabled, enabled, keepGoing.
    */
    ...
    */
    ...
    /**
     * @var EdgeTelemetryMode|null $edgeTelemetryForMicrosoft365Analytics Specifies what type of telemetry data (none, intranet, internet, both) is sent to Microsoft 365 Analytics. Possible values are: notConfigured, intranet, internet, intranetAndInternet.
    */
    ...
    */
    ...
    /**
     * @var BrowserSyncSetting|null $experienceDoNotSyncBrowserSettings Allow or prevent the syncing of Microsoft Edge Browser settings. Option for IT admins to prevent syncing across devices, but allow user override. Possible values are: notConfigured, blockedWithUserOverride, blocked.
    */
    private ?BrowserSyncSetting $experienceDoNotSyncBrowserSettings = null;
    
    /**
     * @var Enablement|null $findMyFiles Controls if the user can configure search to Find My Files mode, which searches files in secondary hard drives and also outside of the user profile. Find My Files does not allow users to search files or locations to which they do not have access. Possible values are: notConfigured, enabled, disabled.
    */
    ...
    */
    ...
    /**
     * @var InkAccessSetting|null $inkWorkspaceAccess Controls the user access to the ink workspace, from the desktop and from above the lock screen. Possible values are: notConfigured, enabled, disabled.
    */
    private ?InkAccessSetting $inkWorkspaceAccess = null;
    
    /**
     * @var StateManagementSetting|null $inkWorkspaceAccessState Controls the user access to the ink workspace, from the desktop and from above the lock screen. Possible values are: notConfigured, blocked, allowed.
    */
    ...
    */
    ...
    /**
     * @var Enablement|null $lockScreenActivateAppsWithVoice This policy setting specifies whether Windows apps can be activated by voice while the system is locked. Possible values are: notConfigured, enabled, disabled.
    */
    ...
    */
    ...
    /**
     * @var SignInAssistantOptions|null $microsoftAccountSignInAssistantSettings Controls the Microsoft Account Sign-In Assistant (wlidsvc) NT service. Possible values are: notConfigured, disabled.
    */
    ...
    */
    ...
    /**
     * @var PowerActionType|null $powerButtonActionOnBattery This setting specifies the action that Windows takes when a user presses the Power button while on battery. Possible values are: notConfigured, noAction, sleep, hibernate, shutdown.
    */
    private ?PowerActionType $powerButtonActionOnBattery = null;
    
    /**
     * @var PowerActionType|null $powerButtonActionPluggedIn This setting specifies the action that Windows takes when a user presses the Power button while plugged in. Possible values are: notConfigured, noAction, sleep, hibernate, shutdown.
    */
    private ?PowerActionType $powerButtonActionPluggedIn = null;
    
    /**
     * @var Enablement|null $powerHybridSleepOnBattery This setting allows you to turn off hybrid sleep while on battery. If you set this setting to disable, a hiberfile is not generated when the system transitions to sleep (Stand By). If you set this setting to enable or do not configure this policy setting, users control this setting. Possible values are: notConfigured, enabled, disabled.
    */
    private ?Enablement $powerHybridSleepOnBattery = null;
    
    /**
     * @var Enablement|null $powerHybridSleepPluggedIn This setting allows you to turn off hybrid sleep while plugged in. If you set this setting to disable, a hiberfile is not generated when the system transitions to sleep (Stand By). If you set this setting to enable or do not configure this policy setting, users control this setting. Possible values are: notConfigured, enabled, disabled.
    */
    private ?Enablement $powerHybridSleepPluggedIn = null;
    
    /**
     * @var PowerActionType|null $powerLidCloseActionOnBattery This setting specifies the action that Windows takes when a user closes the lid on a mobile PC while on battery. Possible values are: notConfigured, noAction, sleep, hibernate, shutdown.
    */
    private ?PowerActionType $powerLidCloseActionOnBattery = null;
    
    /**
     * @var PowerActionType|null $powerLidCloseActionPluggedIn This setting specifies the action that Windows takes when a user closes the lid on a mobile PC while plugged in. Possible values are: notConfigured, noAction, sleep, hibernate, shutdown.
    */
    private ?PowerActionType $powerLidCloseActionPluggedIn = null;
    
    /**
     * @var PowerActionType|null $powerSleepButtonActionOnBattery This setting specifies the action that Windows takes when a user presses the Sleep button while on battery. Possible values are: notConfigured, noAction, sleep, hibernate, shutdown.
    */
    private ?PowerActionType $powerSleepButtonActionOnBattery = null;
    
    /**
     * @var PowerActionType|null $powerSleepButtonActionPluggedIn This setting specifies the action that Windows takes when a user presses the Sleep button while plugged in. Possible values are: notConfigured, noAction, sleep, hibernate, shutdown.
    */
    ...
    */
    ...
    /**
     * @var AppInstallControlType|null $smartScreenAppInstallControl Added in Windows 10, version 1703. Allows IT Admins to control whether users are allowed to install apps from places other than the Store. Possible values are: notConfigured, anywhere, storeOnly, recommendations, preferStore.
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'activateAppsWithVoice' => function (ParseNode $n) use ($o) { $o->setActivateAppsWithVoice($n->getEnumValue(Enablement::class)); },
            'antiTheftModeBlocked' => function (ParseNode $n) use ($o) { $o->setAntiTheftModeBlocked($n->getBooleanValue()); },
            'appManagementMSIAllowUserControlOverInstall' => function (ParseNode $n) use ($o) { $o->setAppManagementMSIAllowUserControlOverInstall($n->getBooleanValue()); },
            'appManagementMSIAlwaysInstallWithElevatedPrivileges' => function (ParseNode $n) use ($o) { $o->setAppManagementMSIAlwaysInstallWithElevatedPrivileges($n->getBooleanValue()); },
            'appManagementPackageFamilyNamesToLaunchAfterLogOn' => function (ParseNode $n) use ($o) { $o->setAppManagementPackageFamilyNamesToLaunchAfterLogOn($n->getCollectionOfPrimitiveValues()); },
            ...
            'authenticationAllowSecondaryDevice' => function (ParseNode $n) use ($o) { $o->setAuthenticationAllowSecondaryDevice($n->getBooleanValue()); },
            'authenticationPreferredAzureADTenantDomainName' => function (ParseNode $n) use ($o) { $o->setAuthenticationPreferredAzureADTenantDomainName($n->getStringValue()); },
            'authenticationWebSignIn' => function (ParseNode $n) use ($o) { $o->setAuthenticationWebSignIn($n->getEnumValue(Enablement::class)); },
            ...
            'bluetoothBlockPromptedProximalConnections' => function (ParseNode $n) use ($o) { $o->setBluetoothBlockPromptedProximalConnections($n->getBooleanValue()); },
            ...
            'cellularData' => function (ParseNode $n) use ($o) { $o->setCellularData($n->getEnumValue(ConfigurationUsage::class)); },
            ...
            'configureTimeZone' => function (ParseNode $n) use ($o) { $o->setConfigureTimeZone($n->getStringValue()); },
            ...
            'cryptographyAllowFipsAlgorithmPolicy' => function (ParseNode $n) use ($o) { $o->setCryptographyAllowFipsAlgorithmPolicy($n->getBooleanValue()); },
            'dataProtectionBlockDirectMemoryAccess' => function (ParseNode $n) use ($o) { $o->setDataProtectionBlockDirectMemoryAccess($n->getBooleanValue()); },
            'defenderBlockEndUserAccess' => function (ParseNode $n) use ($o) { $o->setDefenderBlockEndUserAccess($n->getBooleanValue()); },
            'defenderBlockOnAccessProtection' => function (ParseNode $n) use ($o) { $o->setDefenderBlockOnAccessProtection($n->getBooleanValue()); },
            ...
            'defenderCloudExtendedTimeout' => function (ParseNode $n) use ($o) { $o->setDefenderCloudExtendedTimeout($n->getIntegerValue()); },
            ...
            'defenderPotentiallyUnwantedAppAction' => function (ParseNode $n) use ($o) { $o->setDefenderPotentiallyUnwantedAppAction($n->getEnumValue(DefenderPotentiallyUnwantedAppAction::class)); },
            'defenderPotentiallyUnwantedAppActionSetting' => function (ParseNode $n) use ($o) { $o->setDefenderPotentiallyUnwantedAppActionSetting($n->getEnumValue(DefenderProtectionType::class)); },
            ...
            'defenderScheduleScanEnableLowCpuPriority' => function (ParseNode $n) use ($o) { $o->setDefenderScheduleScanEnableLowCpuPriority($n->getBooleanValue()); },
            ...
            'displayAppListWithGdiDPIScalingTurnedOff' => function (ParseNode $n) use ($o) { $o->setDisplayAppListWithGdiDPIScalingTurnedOff($n->getCollectionOfPrimitiveValues()); },
            'displayAppListWithGdiDPIScalingTurnedOn' => function (ParseNode $n) use ($o) { $o->setDisplayAppListWithGdiDPIScalingTurnedOn($n->getCollectionOfPrimitiveValues()); },
            ...
            'edgeBlockEditFavorites' => function (ParseNode $n) use ($o) { $o->setEdgeBlockEditFavorites($n->getBooleanValue()); },
            'edgeBlockExtensions' => function (ParseNode $n) use ($o) { $o->setEdgeBlockExtensions($n->getBooleanValue()); },
            'edgeBlockFullScreenMode' => function (ParseNode $n) use ($o) { $o->setEdgeBlockFullScreenMode($n->getBooleanValue()); },
            ...
            'edgeBlockPrelaunch' => function (ParseNode $n) use ($o) { $o->setEdgeBlockPrelaunch($n->getBooleanValue()); },
            'edgeBlockPrinting' => function (ParseNode $n) use ($o) { $o->setEdgeBlockPrinting($n->getBooleanValue()); },
            'edgeBlockSavingHistory' => function (ParseNode $n) use ($o) { $o->setEdgeBlockSavingHistory($n->getBooleanValue()); },
            'edgeBlockSearchEngineCustomization' => function (ParseNode $n) use ($o) { $o->setEdgeBlockSearchEngineCustomization($n->getBooleanValue()); },
            ...
            'edgeBlockSideloadingExtensions' => function (ParseNode $n) use ($o) { $o->setEdgeBlockSideloadingExtensions($n->getBooleanValue()); },
            'edgeBlockTabPreloading' => function (ParseNode $n) use ($o) { $o->setEdgeBlockTabPreloading($n->getBooleanValue()); },
            'edgeBlockWebContentOnNewTabPage' => function (ParseNode $n) use ($o) { $o->setEdgeBlockWebContentOnNewTabPage($n->getBooleanValue()); },
            ...
            'edgeFavoritesBarVisibility' => function (ParseNode $n) use ($o) { $o->setEdgeFavoritesBarVisibility($n->getEnumValue(VisibilitySetting::class)); },
            'edgeFavoritesListLocation' => function (ParseNode $n) use ($o) { $o->setEdgeFavoritesListLocation($n->getStringValue()); },
            'edgeFirstRunUrl' => function (ParseNode $n) use ($o) { $o->setEdgeFirstRunUrl($n->getStringValue()); },
            'edgeHomeButtonConfiguration' => function (ParseNode $n) use ($o) { $o->setEdgeHomeButtonConfiguration($n->getObjectValue(array(EdgeHomeButtonConfiguration::class, 'createFromDiscriminatorValue'))); },
            'edgeHomeButtonConfigurationEnabled' => function (ParseNode $n) use ($o) { $o->setEdgeHomeButtonConfigurationEnabled($n->getBooleanValue()); },
            'edgeHomepageUrls' => function (ParseNode $n) use ($o) { $o->setEdgeHomepageUrls($n->getCollectionOfPrimitiveValues()); },
            'edgeKioskModeRestriction' => function (ParseNode $n) use ($o) { $o->setEdgeKioskModeRestriction($n->getEnumValue(EdgeKioskModeRestrictionType::class)); },
            'edgeKioskResetAfterIdleTimeInMinutes' => function (ParseNode $n) use ($o) { $o->setEdgeKioskResetAfterIdleTimeInMinutes($n->getIntegerValue()); },
            'edgeNewTabPageURL' => function (ParseNode $n) use ($o) { $o->setEdgeNewTabPageURL($n->getStringValue()); },
            'edgeOpensWith' => function (ParseNode $n) use ($o) { $o->setEdgeOpensWith($n->getEnumValue(EdgeOpenOptions::class)); },
            'edgePreventCertificateErrorOverride' => function (ParseNode $n) use ($o) { $o->setEdgePreventCertificateErrorOverride($n->getBooleanValue()); },
            'edgeRequiredExtensionPackageFamilyNames' => function (ParseNode $n) use ($o) { $o->setEdgeRequiredExtensionPackageFamilyNames($n->getCollectionOfPrimitiveValues()); },
            ...
            'edgeShowMessageWhenOpeningInternetExplorerSites' => function (ParseNode $n) use ($o) { $o->setEdgeShowMessageWhenOpeningInternetExplorerSites($n->getEnumValue(InternetExplorerMessageSetting::class)); },
            ...
            'edgeTelemetryForMicrosoft365Analytics' => function (ParseNode $n) use ($o) { $o->setEdgeTelemetryForMicrosoft365Analytics($n->getEnumValue(EdgeTelemetryMode::class)); },
            'enableAutomaticRedeployment' => function (ParseNode $n) use ($o) { $o->setEnableAutomaticRedeployment($n->getBooleanValue()); },
            'energySaverOnBatteryThresholdPercentage' => function (ParseNode $n) use ($o) { $o->setEnergySaverOnBatteryThresholdPercentage($n->getIntegerValue()); },
            'energySaverPluggedInThresholdPercentage' => function (ParseNode $n) use ($o) { $o->setEnergySaverPluggedInThresholdPercentage($n->getIntegerValue()); },
            ...
            'experienceDoNotSyncBrowserSettings' => function (ParseNode $n) use ($o) { $o->setExperienceDoNotSyncBrowserSettings($n->getEnumValue(BrowserSyncSetting::class)); },
            'findMyFiles' => function (ParseNode $n) use ($o) { $o->setFindMyFiles($n->getEnumValue(Enablement::class)); },
            'gameDvrBlocked' => function (ParseNode $n) use ($o) { $o->setGameDvrBlocked($n->getBooleanValue()); },
            'inkWorkspaceAccess' => function (ParseNode $n) use ($o) { $o->setInkWorkspaceAccess($n->getEnumValue(InkAccessSetting::class)); },
            'inkWorkspaceAccessState' => function (ParseNode $n) use ($o) { $o->setInkWorkspaceAccessState($n->getEnumValue(StateManagementSetting::class)); },
            'inkWorkspaceBlockSuggestedApps' => function (ParseNode $n) use ($o) { $o->setInkWorkspaceBlockSuggestedApps($n->getBooleanValue()); },
            ...
            'lockScreenActivateAppsWithVoice' => function (ParseNode $n) use ($o) { $o->setLockScreenActivateAppsWithVoice($n->getEnumValue(Enablement::class)); },
            ...
            'messagingBlockMMS' => function (ParseNode $n) use ($o) { $o->setMessagingBlockMMS($n->getBooleanValue()); },
            'messagingBlockRichCommunicationServices' => function (ParseNode $n) use ($o) { $o->setMessagingBlockRichCommunicationServices($n->getBooleanValue()); },
            'messagingBlockSync' => function (ParseNode $n) use ($o) { $o->setMessagingBlockSync($n->getBooleanValue()); },
            ...
            'microsoftAccountSignInAssistantSettings' => function (ParseNode $n) use ($o) { $o->setMicrosoftAccountSignInAssistantSettings($n->getEnumValue(SignInAssistantOptions::class)); },
            ...
            'passwordMinimumAgeInDays' => function (ParseNode $n) use ($o) { $o->setPasswordMinimumAgeInDays($n->getIntegerValue()); },
            ...
            'powerButtonActionOnBattery' => function (ParseNode $n) use ($o) { $o->setPowerButtonActionOnBattery($n->getEnumValue(PowerActionType::class)); },
            'powerButtonActionPluggedIn' => function (ParseNode $n) use ($o) { $o->setPowerButtonActionPluggedIn($n->getEnumValue(PowerActionType::class)); },
            'powerHybridSleepOnBattery' => function (ParseNode $n) use ($o) { $o->setPowerHybridSleepOnBattery($n->getEnumValue(Enablement::class)); },
            'powerHybridSleepPluggedIn' => function (ParseNode $n) use ($o) { $o->setPowerHybridSleepPluggedIn($n->getEnumValue(Enablement::class)); },
            'powerLidCloseActionOnBattery' => function (ParseNode $n) use ($o) { $o->setPowerLidCloseActionOnBattery($n->getEnumValue(PowerActionType::class)); },
            'powerLidCloseActionPluggedIn' => function (ParseNode $n) use ($o) { $o->setPowerLidCloseActionPluggedIn($n->getEnumValue(PowerActionType::class)); },
            'powerSleepButtonActionOnBattery' => function (ParseNode $n) use ($o) { $o->setPowerSleepButtonActionOnBattery($n->getEnumValue(PowerActionType::class)); },
            'powerSleepButtonActionPluggedIn' => function (ParseNode $n) use ($o) { $o->setPowerSleepButtonActionPluggedIn($n->getEnumValue(PowerActionType::class)); },
            'printerBlockAddition' => function (ParseNode $n) use ($o) { $o->setPrinterBlockAddition($n->getBooleanValue()); },
            'printerDefaultName' => function (ParseNode $n) use ($o) { $o->setPrinterDefaultName($n->getStringValue()); },
            'printerNames' => function (ParseNode $n) use ($o) { $o->setPrinterNames($n->getCollectionOfPrimitiveValues()); },
            'privacyAccessControls' => function (ParseNode $n) use ($o) { $o->setPrivacyAccessControls($n->getCollectionOfObjectValues(array(WindowsPrivacyDataAccessControlItem::class, 'createFromDiscriminatorValue'))); },
            ...
            'privacyBlockActivityFeed' => function (ParseNode $n) use ($o) { $o->setPrivacyBlockActivityFeed($n->getBooleanValue()); },
            'privacyBlockInputPersonalization' => function (ParseNode $n) use ($o) { $o->setPrivacyBlockInputPersonalization($n->getBooleanValue()); },
            'privacyBlockPublishUserActivities' => function (ParseNode $n) use ($o) { $o->setPrivacyBlockPublishUserActivities($n->getBooleanValue()); },
            'privacyDisableLaunchExperience' => function (ParseNode $n) use ($o) { $o->setPrivacyDisableLaunchExperience($n->getBooleanValue()); },
            ...
            'searchBlockWebResults' => function (ParseNode $n) use ($o) { $o->setSearchBlockWebResults($n->getBooleanValue()); },
            ...
            'searchDisableLocation' => function (ParseNode $n) use ($o) { $o->setSearchDisableLocation($n->getBooleanValue()); },
            'searchDisableUseLocation' => function (ParseNode $n) use ($o) { $o->setSearchDisableUseLocation($n->getBooleanValue()); },
            ...
            'securityBlockAzureADJoinedDevicesAutoEncryption' => function (ParseNode $n) use ($o) { $o->setSecurityBlockAzureADJoinedDevicesAutoEncryption($n->getBooleanValue()); },
            ...
            'smartScreenAppInstallControl' => function (ParseNode $n) use ($o) { $o->setSmartScreenAppInstallControl($n->getEnumValue(AppInstallControlType::class)); },
            ...
            'systemTelemetryProxyServer' => function (ParseNode $n) use ($o) { $o->setSystemTelemetryProxyServer($n->getStringValue()); },
            'taskManagerBlockEndTask' => function (ParseNode $n) use ($o) { $o->setTaskManagerBlockEndTask($n->getBooleanValue()); },
            ...
            'windows10AppsForceUpdateSchedule' => function (ParseNode $n) use ($o) { $o->setWindows10AppsForceUpdateSchedule($n->getObjectValue(array(Windows10AppsForceUpdateSchedule::class, 'createFromDiscriminatorValue'))); },
