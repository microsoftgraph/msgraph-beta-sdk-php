...
class MailboxSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
     ...
     * @return MailboxRecipientType|null
    */
    public function getUserPurposeV2(): ?MailboxRecipientType {
        $val = $this->getBackingStore()->get('userPurposeV2');
        if (is_null($val) || $val instanceof MailboxRecipientType) {
            return $val;
        }
    ...
    */
     ...
     * @param MailboxRecipientType|null $value Value to set for the userPurposeV2 property.
    */
