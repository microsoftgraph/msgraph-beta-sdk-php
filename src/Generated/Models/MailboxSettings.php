...
class MailboxSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'userPurposeV2' => fn(ParseNode $n) => $o->setUserPurposeV2($n->getEnumValue(MailboxSettings_userPurposeV2::class)),
    ...
    */
     ...
     * @return MailboxSettings_userPurposeV2|null
    */
    public function getUserPurposeV2(): ?MailboxSettings_userPurposeV2 {
        $val = $this->getBackingStore()->get('userPurposeV2');
        if (is_null($val) || $val instanceof MailboxSettings_userPurposeV2) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'userPurposeV2'");
    }
    ...
    */
     ...
     * @param MailboxSettings_userPurposeV2|null $value Value to set for the userPurposeV2 property.
    */
    public function setUserPurposeV2(?MailboxSettings_userPurposeV2 $value): void {
