...
class DelegatedAdminCustomerCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<DelegatedAdminCustomer>|null $value The value property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(DelegatedAdminCustomer::class, 'createFromDiscriminatorValue'))); },
        ];
    }
