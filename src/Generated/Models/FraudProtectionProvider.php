...
class FraudProtectionProvider extends Entity implements Parsable 
{
    /**
     * Instantiates a new FraudProtectionProvider and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FraudProtectionProvider {
