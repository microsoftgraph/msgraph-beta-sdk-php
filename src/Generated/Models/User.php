...
class User extends DirectoryObject implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $externalUserStateChangeDateTime Shows the timestamp for the latest change to the externalUserState property. Supports $filter (eq, ne, not , in).
    */
    ...
    */
    ...
    /**
     * @var ItemInsights|null $insights The insights property
    */
    ...
    */
    ...
    /**
     * @var array<Group>|null $joinedGroups The joinedGroups property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'customSecurityAttributes' => function (ParseNode $n) use ($o) { $o->setCustomSecurityAttributes($n->getObjectValue(array(CustomSecurityAttributeValue::class, 'createFromDiscriminatorValue'))); },
            ...
            'deviceKeys' => function (ParseNode $n) use ($o) { $o->setDeviceKeys($n->getCollectionOfObjectValues(array(DeviceKey::class, 'createFromDiscriminatorValue'))); },
            ...
            'devices' => function (ParseNode $n) use ($o) { $o->setDevices($n->getCollectionOfObjectValues(array(Device::class, 'createFromDiscriminatorValue'))); },
            ...
            'externalUserStateChangeDateTime' => function (ParseNode $n) use ($o) { $o->setExternalUserStateChangeDateTime($n->getStringValue()); },
            ...
            'insights' => function (ParseNode $n) use ($o) { $o->setInsights($n->getObjectValue(array(ItemInsights::class, 'createFromDiscriminatorValue'))); },
            ...
            'joinedGroups' => function (ParseNode $n) use ($o) { $o->setJoinedGroups($n->getCollectionOfObjectValues(array(Group::class, 'createFromDiscriminatorValue'))); },
            ...
            'mobileAppIntentAndStates' => function (ParseNode $n) use ($o) { $o->setMobileAppIntentAndStates($n->getCollectionOfObjectValues(array(MobileAppIntentAndState::class, 'createFromDiscriminatorValue'))); },
            ...
            'notifications' => function (ParseNode $n) use ($o) { $o->setNotifications($n->getCollectionOfObjectValues(array(Notification::class, 'createFromDiscriminatorValue'))); },
            ...
            'pendingAccessReviewInstances' => function (ParseNode $n) use ($o) { $o->setPendingAccessReviewInstances($n->getCollectionOfObjectValues(array(AccessReviewInstance::class, 'createFromDiscriminatorValue'))); },
            ...
            'profile' => function (ParseNode $n) use ($o) { $o->setProfile($n->getObjectValue(array(Profile::class, 'createFromDiscriminatorValue'))); },
            ...
            'security' => function (ParseNode $n) use ($o) { $o->setSecurity($n->getObjectValue(array(Security::class, 'createFromDiscriminatorValue'))); },
            ...
            'signInActivity' => function (ParseNode $n) use ($o) { $o->setSignInActivity($n->getObjectValue(array(SignInActivity::class, 'createFromDiscriminatorValue'))); },
            ...
            'tasks' => function (ParseNode $n) use ($o) { $o->setTasks($n->getObjectValue(array(Tasks::class, 'createFromDiscriminatorValue'))); },
            ...
            'transitiveReports' => function (ParseNode $n) use ($o) { $o->setTransitiveReports($n->getCollectionOfObjectValues(array(DirectoryObject::class, 'createFromDiscriminatorValue'))); },
