...
class OmaSettingFloatingPoint extends OmaSetting implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getObjectValue([OmaSettingFloatingPoint_value::class, 'createFromDiscriminatorValue'])),
        ]);
    }

    /**
     * Gets the value property value. Value.
     * @return OmaSettingFloatingPoint_value|null
    */
    public function getValue(): ?OmaSettingFloatingPoint_value {
        $val = $this->getBackingStore()->get('value');
        if (is_null($val) || $val instanceof OmaSettingFloatingPoint_value) {
            return $val;
        }
    ...
    */
     ...
     * @param OmaSettingFloatingPoint_value|null $value Value to set for the value property.
    */
    public function setValue(?OmaSettingFloatingPoint_value $value): void {
