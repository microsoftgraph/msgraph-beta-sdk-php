...
class ApprovalStepCollectionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<ApprovalStep>|null $value The value property
    */
    ...
    */
     ...
     * @return ApprovalStepCollectionResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApprovalStepCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(ApprovalStep::class, 'createFromDiscriminatorValue'))); },
        ];
    }
    ...
    */
     ...
     *  @param array<ApprovalStep>|null $value Value to set for the value property.
    */
