...
class AuthenticationCombinationConfigurationCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    /**
     * @var array<AuthenticationCombinationConfiguration>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AuthenticationCombinationConfigurationCollectionResponse {
    ...
    */
     ...
     *  @param array<AuthenticationCombinationConfiguration>|null $value Value to set for the value property.
    */
