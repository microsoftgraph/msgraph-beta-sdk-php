...
class AppleVpnConfiguration extends DeviceConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'associatedDomains' => function (ParseNode $n) use ($o) { $o->setAssociatedDomains($n->getCollectionOfPrimitiveValues()); },
            ...
            'connectionType' => function (ParseNode $n) use ($o) { $o->setConnectionType($n->getEnumValue(AppleVpnConnectionType::class)); },
            ...
            'disableOnDemandUserOverride' => function (ParseNode $n) use ($o) { $o->setDisableOnDemandUserOverride($n->getBooleanValue()); },
            'disconnectOnIdle' => function (ParseNode $n) use ($o) { $o->setDisconnectOnIdle($n->getBooleanValue()); },
            'disconnectOnIdleTimerInSeconds' => function (ParseNode $n) use ($o) { $o->setDisconnectOnIdleTimerInSeconds($n->getIntegerValue()); },
            'enablePerApp' => function (ParseNode $n) use ($o) { $o->setEnablePerApp($n->getBooleanValue()); },
            'enableSplitTunneling' => function (ParseNode $n) use ($o) { $o->setEnableSplitTunneling($n->getBooleanValue()); },
            'excludedDomains' => function (ParseNode $n) use ($o) { $o->setExcludedDomains($n->getCollectionOfPrimitiveValues()); },
            ...
            'onDemandRules' => function (ParseNode $n) use ($o) { $o->setOnDemandRules($n->getCollectionOfObjectValues(array(VpnOnDemandRule::class, 'createFromDiscriminatorValue'))); },
            'optInToDeviceIdSharing' => function (ParseNode $n) use ($o) { $o->setOptInToDeviceIdSharing($n->getBooleanValue()); },
            'providerType' => function (ParseNode $n) use ($o) { $o->setProviderType($n->getEnumValue(VpnProviderType::class)); },
