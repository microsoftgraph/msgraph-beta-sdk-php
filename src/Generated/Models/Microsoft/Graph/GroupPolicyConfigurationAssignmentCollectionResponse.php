...
class GroupPolicyConfigurationAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<GroupPolicyConfigurationAssignment>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GroupPolicyConfigurationAssignmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(GroupPolicyConfigurationAssignment::class)); },
        ];
    }
