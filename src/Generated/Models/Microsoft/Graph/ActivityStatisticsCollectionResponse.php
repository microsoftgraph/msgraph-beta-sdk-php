...
class ActivityStatisticsCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ActivityStatistics>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ActivityStatisticsCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ActivityStatistics::class)); },
        ];
    }
