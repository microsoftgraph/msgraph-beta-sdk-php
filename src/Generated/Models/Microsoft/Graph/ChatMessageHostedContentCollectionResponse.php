...
class ChatMessageHostedContentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ChatMessageHostedContent>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ChatMessageHostedContent::class)); },
        ];
    }
