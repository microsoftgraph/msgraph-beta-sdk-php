    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'continuousAccessEvaluation' => function (self $o, ParseNode $n) { $o->setContinuousAccessEvaluation($n->getObjectValue(ContinuousAccessEvaluationSessionControl::class)); },
