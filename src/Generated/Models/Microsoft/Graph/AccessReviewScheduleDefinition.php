...
class AccessReviewScheduleDefinition extends Entity 
{
    ...
    /** @var array<AccessReviewReviewerScope>|null $backupReviewers  */
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'backupReviewers' => function (self $o, ParseNode $n) { $o->setBackupReviewers($n->getCollectionOfObjectValues(AccessReviewReviewerScope::class)); },
            ...
            'stageSettings' => function (self $o, ParseNode $n) { $o->setStageSettings($n->getCollectionOfObjectValues(AccessReviewStageSettings::class)); },
