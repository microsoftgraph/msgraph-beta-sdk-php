...
class Notification extends Entity 
{
    ...
    */
     ...
     * @return Notification
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): Notification {
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            'displayTimeToLive' => function (self $o, ParseNode $n) { $o->setDisplayTimeToLive($n->getIntegerValue()); },
            'expirationDateTime' => function (self $o, ParseNode $n) { $o->setExpirationDateTime($n->getDateTimeValue()); },
            'groupName' => function (self $o, ParseNode $n) { $o->setGroupName($n->getStringValue()); },
            'payload' => function (self $o, ParseNode $n) { $o->setPayload($n->getObjectValue(PayloadTypes::class)); },
            'priority' => function (self $o, ParseNode $n) { $o->setPriority($n->getEnumValue(Priority::class)); },
            'targetHostName' => function (self $o, ParseNode $n) { $o->setTargetHostName($n->getStringValue()); },
            'targetPolicy' => function (self $o, ParseNode $n) { $o->setTargetPolicy($n->getObjectValue(TargetPolicyEndpoints::class)); },
        ]);
    }
