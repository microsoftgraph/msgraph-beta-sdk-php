...
class IdentityUserFlowCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<IdentityUserFlow>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): IdentityUserFlowCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(IdentityUserFlow::class)); },
        ];
    }
