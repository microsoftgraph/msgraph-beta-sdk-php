...
class ImportedWindowsAutopilotDeviceIdentityCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ImportedWindowsAutopilotDeviceIdentity>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ImportedWindowsAutopilotDeviceIdentity::class)); },
        ];
    }
