...
class DeviceComplianceScheduledActionForRuleCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceComplianceScheduledActionForRule>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DeviceComplianceScheduledActionForRule::class)); },
        ];
    }
