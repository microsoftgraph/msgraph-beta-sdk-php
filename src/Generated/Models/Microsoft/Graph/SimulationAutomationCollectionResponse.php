...
class SimulationAutomationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SimulationAutomation>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SimulationAutomationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SimulationAutomation::class)); },
        ];
    }
