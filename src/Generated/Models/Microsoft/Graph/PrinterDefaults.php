...
class PrinterDefaults implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var string|null $documentMimeType  */
    ...
    /** @var PrintDuplexConfiguration|null $duplexConfiguration  */
    ...
    /** @var bool|null $pdfFitToPage  */
    private ?bool $pdfFitToPage = null;
    
    /** @var PrintPresentationDirection|null $presentationDirection  */
    private ?PrintPresentationDirection $presentationDirection = null;
    
    /** @var PrintColorConfiguration|null $printColorConfiguration  */
    private ?PrintColorConfiguration $printColorConfiguration = null;
    
    /** @var PrintQuality|null $printQuality  */
    ...
    */
    ...
    /**
     * Gets the documentMimeType property value. 
     * @return string|null
    */
    ...
    */
    ...
    /**
     * Gets the duplexConfiguration property value. 
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'documentMimeType' => function (self $o, ParseNode $n) { $o->setDocumentMimeType($n->getStringValue()); },
            'dpi' => function (self $o, ParseNode $n) { $o->setDpi($n->getIntegerValue()); },
            'duplexConfiguration' => function (self $o, ParseNode $n) { $o->setDuplexConfiguration($n->getEnumValue(PrintDuplexConfiguration::class)); },
            ...
            'pdfFitToPage' => function (self $o, ParseNode $n) { $o->setPdfFitToPage($n->getBooleanValue()); },
            'presentationDirection' => function (self $o, ParseNode $n) { $o->setPresentationDirection($n->getEnumValue(PrintPresentationDirection::class)); },
            'printColorConfiguration' => function (self $o, ParseNode $n) { $o->setPrintColorConfiguration($n->getEnumValue(PrintColorConfiguration::class)); },
            'printQuality' => function (self $o, ParseNode $n) { $o->setPrintQuality($n->getEnumValue(PrintQuality::class)); },
    ...
    */
    ...
    /**
     * Gets the pdfFitToPage property value. 
     * @return bool|null
    */
    ...
    /**
     * Gets the presentationDirection property value. 
    ...
    */
    ...
    /**
     * Gets the printColorConfiguration property value. 
    ...
    */
    ...
    /**
     * Gets the printQuality property value. 
    ...
    */
    ...
    /**
     * Sets the documentMimeType property value. 
    ...
    */
    ...
    /**
     * Sets the duplexConfiguration property value. 
    ...
    */
    ...
    /**
     * Sets the pdfFitToPage property value. 
    ...
    */
    ...
    /**
     * Sets the presentationDirection property value. 
    ...
    */
    ...
    /**
     * Sets the printColorConfiguration property value. 
    ...
    */
    ...
    /**
     * Sets the printQuality property value. 
