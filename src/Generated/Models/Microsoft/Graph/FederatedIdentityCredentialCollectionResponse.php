...
class FederatedIdentityCredentialCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<FederatedIdentityCredential>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): FederatedIdentityCredentialCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(FederatedIdentityCredential::class)); },
        ];
    }
