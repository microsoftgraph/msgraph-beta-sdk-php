...
class WindowsAutopilotDeploymentProfile extends Entity 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): WindowsAutopilotDeploymentProfile {
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            'assignedDevices' => function (self $o, ParseNode $n) { $o->setAssignedDevices($n->getCollectionOfObjectValues(WindowsAutopilotDeviceIdentity::class)); },
            'assignments' => function (self $o, ParseNode $n) { $o->setAssignments($n->getCollectionOfObjectValues(WindowsAutopilotDeploymentProfileAssignment::class)); },
            'createdDateTime' => function (self $o, ParseNode $n) { $o->setCreatedDateTime($n->getDateTimeValue()); },
            'description' => function (self $o, ParseNode $n) { $o->setDescription($n->getStringValue()); },
            'deviceNameTemplate' => function (self $o, ParseNode $n) { $o->setDeviceNameTemplate($n->getStringValue()); },
            'deviceType' => function (self $o, ParseNode $n) { $o->setDeviceType($n->getEnumValue(WindowsAutopilotDeviceType::class)); },
            'displayName' => function (self $o, ParseNode $n) { $o->setDisplayName($n->getStringValue()); },
            'enableWhiteGlove' => function (self $o, ParseNode $n) { $o->setEnableWhiteGlove($n->getBooleanValue()); },
            'enrollmentStatusScreenSettings' => function (self $o, ParseNode $n) { $o->setEnrollmentStatusScreenSettings($n->getObjectValue(WindowsEnrollmentStatusScreenSettings::class)); },
            'extractHardwareHash' => function (self $o, ParseNode $n) { $o->setExtractHardwareHash($n->getBooleanValue()); },
            'language' => function (self $o, ParseNode $n) { $o->setLanguage($n->getStringValue()); },
            'lastModifiedDateTime' => function (self $o, ParseNode $n) { $o->setLastModifiedDateTime($n->getDateTimeValue()); },
            'managementServiceAppId' => function (self $o, ParseNode $n) { $o->setManagementServiceAppId($n->getStringValue()); },
            'outOfBoxExperienceSettings' => function (self $o, ParseNode $n) { $o->setOutOfBoxExperienceSettings($n->getObjectValue(OutOfBoxExperienceSettings::class)); },
