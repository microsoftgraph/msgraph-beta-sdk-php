...
class CatalogEntryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<CatalogEntry>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CatalogEntryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(CatalogEntry::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<CatalogEntry>|null $value Value to set for the value property.
    */
