...
class DeviceManagementComplianceActionItem extends Entity 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementComplianceActionItem {
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            'actionType' => function (self $o, ParseNode $n) { $o->setActionType($n->getEnumValue(DeviceManagementComplianceActionType::class)); },
