...
class UserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserExperienceAnalyticsDeviceStartupProcessPerformance>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UserExperienceAnalyticsDeviceStartupProcessPerformance::class)); },
        ];
    }
