...
class UnifiedRoleManagementPolicyRuleCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnifiedRoleManagementPolicyRule>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UnifiedRoleManagementPolicyRule::class)); },
        ];
    }
