...
class PrivilegedApprovalCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PrivilegedApproval>|null $value  */
    ...
    */
     ...
     * @return PrivilegedApprovalCollectionResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PrivilegedApprovalCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(PrivilegedApproval::class)); },
        ];
    }
