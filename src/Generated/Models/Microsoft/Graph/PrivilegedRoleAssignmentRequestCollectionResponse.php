...
class PrivilegedRoleAssignmentRequestCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PrivilegedRoleAssignmentRequestCollectionResponse {
