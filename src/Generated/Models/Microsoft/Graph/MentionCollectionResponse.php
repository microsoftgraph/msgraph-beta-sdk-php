...
class MentionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return MentionCollectionResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MentionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(Mention::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Mention>|null $value Value to set for the value property.
    */
