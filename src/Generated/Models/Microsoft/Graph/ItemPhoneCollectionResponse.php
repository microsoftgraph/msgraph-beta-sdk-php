...
class ItemPhoneCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ItemPhone>|null $value  */
    ...
    */
     ...
     * @return ItemPhoneCollectionResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ItemPhoneCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ItemPhone::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ItemPhone>|null $value Value to set for the value property.
    */
