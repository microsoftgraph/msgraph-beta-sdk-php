...
class SharedEmailDomainCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SharedEmailDomain>|null $value  */
    ...
    */
     ...
     * @return SharedEmailDomainCollectionResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SharedEmailDomainCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SharedEmailDomain::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SharedEmailDomain>|null $value Value to set for the value property.
    */
