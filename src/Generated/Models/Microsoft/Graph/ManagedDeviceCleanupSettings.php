...
class ManagedDeviceCleanupSettings implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return string|null
    */
    public function getDeviceInactivityBeforeRetirementInDays(): ?string {
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeStringValue('deviceInactivityBeforeRetirementInDays', $this->deviceInactivityBeforeRetirementInDays);
    ...
    */
     ...
     *  @param string|null $value Value to set for the deviceInactivityBeforeRetirementInDays property.
    */
    public function setDeviceInactivityBeforeRetirementInDays(?string $value ): void {
