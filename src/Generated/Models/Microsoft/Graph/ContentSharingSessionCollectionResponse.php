...
class ContentSharingSessionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ContentSharingSession>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ContentSharingSessionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ContentSharingSession::class)); },
        ];
    }
