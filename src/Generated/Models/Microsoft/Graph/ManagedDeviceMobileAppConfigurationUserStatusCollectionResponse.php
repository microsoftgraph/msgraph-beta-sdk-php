...
class ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ManagedDeviceMobileAppConfigurationUserStatus>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ManagedDeviceMobileAppConfigurationUserStatus::class)); },
        ];
    }
