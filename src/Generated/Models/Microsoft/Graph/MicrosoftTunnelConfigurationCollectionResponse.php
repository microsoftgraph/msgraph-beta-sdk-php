...
class MicrosoftTunnelConfigurationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<MicrosoftTunnelConfiguration>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MicrosoftTunnelConfigurationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(MicrosoftTunnelConfiguration::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<MicrosoftTunnelConfiguration>|null $value Value to set for the value property.
    */
