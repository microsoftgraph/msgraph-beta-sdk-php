...
class SideLoadingKeyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SideLoadingKey>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SideLoadingKeyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SideLoadingKey::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SideLoadingKey>|null $value Value to set for the value property.
    */
