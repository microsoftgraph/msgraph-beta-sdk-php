...
class DirectoryDefinitionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DirectoryDefinition>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DirectoryDefinitionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DirectoryDefinition::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DirectoryDefinition>|null $value Value to set for the value property.
    */
