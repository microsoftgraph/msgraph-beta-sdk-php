...
class BookingStaffMemberCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<BookingStaffMember>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BookingStaffMemberCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(BookingStaffMember::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<BookingStaffMember>|null $value Value to set for the value property.
    */
