...
class CloudPcDomainJoinConfiguration implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var string|null $onPremisesConnectionId The on-premises connection ID that matches the virtual network IT admins want the provisioning policy to use when they create Cloud PCs. You can use this property in both domain join types: Azure AD joined or Hybrid Azure AD joined. If you enter an onPremisesConnectionId, leave regionName as empty. */
