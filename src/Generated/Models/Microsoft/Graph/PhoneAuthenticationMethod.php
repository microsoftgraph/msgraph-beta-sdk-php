...
class PhoneAuthenticationMethod extends AuthenticationMethod 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PhoneAuthenticationMethod {
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'phoneType' => function (self $o, ParseNode $n) { $o->setPhoneType($n->getEnumValue(AuthenticationPhoneType::class)); },
            'smsSignInState' => function (self $o, ParseNode $n) { $o->setSmsSignInState($n->getEnumValue(AuthenticationMethodSignInState::class)); },
        ]);
    }
