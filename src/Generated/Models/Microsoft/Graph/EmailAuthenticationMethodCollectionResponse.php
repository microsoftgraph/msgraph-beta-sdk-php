...
class EmailAuthenticationMethodCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EmailAuthenticationMethod>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): EmailAuthenticationMethodCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(EmailAuthenticationMethod::class)); },
        ];
    }
