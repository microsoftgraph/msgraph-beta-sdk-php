...
class TargetedManagedAppPolicyAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TargetedManagedAppPolicyAssignment>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(TargetedManagedAppPolicyAssignment::class)); },
        ];
    }
