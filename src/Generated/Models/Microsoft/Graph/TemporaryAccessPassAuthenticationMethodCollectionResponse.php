...
class TemporaryAccessPassAuthenticationMethodCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TemporaryAccessPassAuthenticationMethod>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TemporaryAccessPassAuthenticationMethodCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(TemporaryAccessPassAuthenticationMethod::class)); },
        ];
    }
