...
class RoleScopeTagAutoAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<RoleScopeTagAutoAssignment>|null $value  */
    ...
    */
     ...
     * @return RoleScopeTagAutoAssignmentCollectionResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RoleScopeTagAutoAssignmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(RoleScopeTagAutoAssignment::class)); },
        ];
    }
