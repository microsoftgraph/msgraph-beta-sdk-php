...
class UnsupportedGroupPolicyExtensionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnsupportedGroupPolicyExtension>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UnsupportedGroupPolicyExtensionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UnsupportedGroupPolicyExtension::class)); },
        ];
    }
