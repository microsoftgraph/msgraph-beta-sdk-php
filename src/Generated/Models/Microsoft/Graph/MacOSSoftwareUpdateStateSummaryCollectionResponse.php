...
class MacOSSoftwareUpdateStateSummaryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<MacOSSoftwareUpdateStateSummary>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MacOSSoftwareUpdateStateSummaryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(MacOSSoftwareUpdateStateSummary::class)); },
        ];
    }
