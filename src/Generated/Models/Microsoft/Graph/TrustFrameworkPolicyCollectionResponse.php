...
class TrustFrameworkPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TrustFrameworkPolicy>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TrustFrameworkPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(TrustFrameworkPolicy::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TrustFrameworkPolicy>|null $value Value to set for the value property.
    */
