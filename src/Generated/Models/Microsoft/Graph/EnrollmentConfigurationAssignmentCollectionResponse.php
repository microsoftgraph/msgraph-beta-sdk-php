...
class EnrollmentConfigurationAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EnrollmentConfigurationAssignment>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(EnrollmentConfigurationAssignment::class)); },
        ];
    }
