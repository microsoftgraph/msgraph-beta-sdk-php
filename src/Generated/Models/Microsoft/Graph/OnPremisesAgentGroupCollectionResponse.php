...
class OnPremisesAgentGroupCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<OnPremisesAgentGroup>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OnPremisesAgentGroupCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(OnPremisesAgentGroup::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<OnPremisesAgentGroup>|null $value Value to set for the value property.
    */
