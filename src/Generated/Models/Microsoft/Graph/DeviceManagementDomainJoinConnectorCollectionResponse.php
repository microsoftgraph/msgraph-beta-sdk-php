...
class DeviceManagementDomainJoinConnectorCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceManagementDomainJoinConnector>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementDomainJoinConnectorCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DeviceManagementDomainJoinConnector::class)); },
        ];
    }
