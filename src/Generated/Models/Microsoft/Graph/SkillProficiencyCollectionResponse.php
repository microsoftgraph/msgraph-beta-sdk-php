...
class SkillProficiencyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SkillProficiency>|null $value  */
    ...
    */
     ...
     * @return SkillProficiencyCollectionResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SkillProficiencyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SkillProficiency::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SkillProficiency>|null $value Value to set for the value property.
    */
