...
class Organization extends DirectoryObject 
{
    ...
    /** @var OrganizationalBranding|null $branding  */
    ...
    /** @var array<string>|null $securityComplianceNotificationMails  */
    private ?array $securityComplianceNotificationMails = null;
    
    /** @var array<string>|null $securityComplianceNotificationPhones  */
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'certificateConnectorSetting' => function (self $o, ParseNode $n) { $o->setCertificateConnectorSetting($n->getObjectValue(CertificateConnectorSetting::class)); },
            ...
            'directorySizeQuota' => function (self $o, ParseNode $n) { $o->setDirectorySizeQuota($n->getObjectValue(DirectorySizeQuota::class)); },
            'displayName' => function (self $o, ParseNode $n) { $o->setDisplayName($n->getStringValue()); },
            'extensions' => function (self $o, ParseNode $n) { $o->setExtensions($n->getCollectionOfObjectValues(Extension::class)); },
            'isMultipleDataLocationsForServicesEnabled' => function (self $o, ParseNode $n) { $o->setIsMultipleDataLocationsForServicesEnabled($n->getBooleanValue()); },
            ...
            'settings' => function (self $o, ParseNode $n) { $o->setSettings($n->getObjectValue(OrganizationSettings::class)); },
