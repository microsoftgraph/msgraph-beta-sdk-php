...
class ProgramControlCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ProgramControl>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ProgramControlCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ProgramControl::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ProgramControl>|null $value Value to set for the value property.
    */
