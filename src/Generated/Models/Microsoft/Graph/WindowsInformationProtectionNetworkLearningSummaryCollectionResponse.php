...
class WindowsInformationProtectionNetworkLearningSummaryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<WindowsInformationProtectionNetworkLearningSummary>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(WindowsInformationProtectionNetworkLearningSummary::class)); },
        ];
    }
