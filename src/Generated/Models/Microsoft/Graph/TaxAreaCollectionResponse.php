...
class TaxAreaCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TaxAreaCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(TaxArea::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TaxArea>|null $value Value to set for the value property.
    */
