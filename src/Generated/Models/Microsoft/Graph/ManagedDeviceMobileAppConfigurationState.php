...
class ManagedDeviceMobileAppConfigurationState extends Entity 
{
    ...
    /** @var array<ManagedDeviceMobileAppConfigurationSettingState>|null $settingStates  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ManagedDeviceMobileAppConfigurationState {
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'settingStates' => function (self $o, ParseNode $n) { $o->setSettingStates($n->getCollectionOfObjectValues(ManagedDeviceMobileAppConfigurationSettingState::class)); },
