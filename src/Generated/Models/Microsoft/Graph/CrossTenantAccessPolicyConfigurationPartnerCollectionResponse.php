...
class CrossTenantAccessPolicyConfigurationPartnerCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<CrossTenantAccessPolicyConfigurationPartner>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CrossTenantAccessPolicyConfigurationPartnerCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(CrossTenantAccessPolicyConfigurationPartner::class)); },
        ];
    }
