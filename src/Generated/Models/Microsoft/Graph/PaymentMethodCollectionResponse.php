...
class PaymentMethodCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PaymentMethod>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PaymentMethodCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(PaymentMethod::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<PaymentMethod>|null $value Value to set for the value property.
    */
