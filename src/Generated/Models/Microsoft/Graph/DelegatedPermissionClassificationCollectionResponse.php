...
class DelegatedPermissionClassificationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DelegatedPermissionClassification>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DelegatedPermissionClassification::class)); },
        ];
    }
