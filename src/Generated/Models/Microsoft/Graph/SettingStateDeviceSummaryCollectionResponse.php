...
class SettingStateDeviceSummaryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SettingStateDeviceSummary>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SettingStateDeviceSummary::class)); },
        ];
    }
