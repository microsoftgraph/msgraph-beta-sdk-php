    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'media' => function (self $o, ParseNode $n) { $o->setMedia($n->getObjectValue(Media::class)); },
            ...
            'source' => function (self $o, ParseNode $n) { $o->setSource($n->getObjectValue(DriveItemSource::class)); },
