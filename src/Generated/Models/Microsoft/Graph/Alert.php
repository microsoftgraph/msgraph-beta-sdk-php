...
class Alert extends Entity 
{
    ...
    /** @var array<AlertDetection>|null $alertDetections  */
    ...
    /** @var array<InvestigationSecurityState>|null $investigationSecurityStates  */
    private ?array $investigationSecurityStates = null;
    
    /** @var DateTime|null $lastEventDateTime  */
    ...
    /** @var array<MessageSecurityState>|null $messageSecurityStates  */
    ...
    /** @var array<UriClickSecurityState>|null $uriClickSecurityStates  */
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            'activityGroupName' => function (self $o, ParseNode $n) { $o->setActivityGroupName($n->getStringValue()); },
            'alertDetections' => function (self $o, ParseNode $n) { $o->setAlertDetections($n->getCollectionOfObjectValues(AlertDetection::class)); },
            ...
            'cloudAppStates' => function (self $o, ParseNode $n) { $o->setCloudAppStates($n->getCollectionOfObjectValues(CloudAppSecurityState::class)); },
            ...
            'detectionIds' => function (self $o, ParseNode $n) { $o->setDetectionIds($n->getCollectionOfPrimitiveValues()); },
            ...
            'fileStates' => function (self $o, ParseNode $n) { $o->setFileStates($n->getCollectionOfObjectValues(FileSecurityState::class)); },
            'historyStates' => function (self $o, ParseNode $n) { $o->setHistoryStates($n->getCollectionOfObjectValues(AlertHistoryState::class)); },
            'hostStates' => function (self $o, ParseNode $n) { $o->setHostStates($n->getCollectionOfObjectValues(HostSecurityState::class)); },
            'incidentIds' => function (self $o, ParseNode $n) { $o->setIncidentIds($n->getCollectionOfPrimitiveValues()); },
            'investigationSecurityStates' => function (self $o, ParseNode $n) { $o->setInvestigationSecurityStates($n->getCollectionOfObjectValues(InvestigationSecurityState::class)); },
            'lastEventDateTime' => function (self $o, ParseNode $n) { $o->setLastEventDateTime($n->getDateTimeValue()); },
            ...
            'messageSecurityStates' => function (self $o, ParseNode $n) { $o->setMessageSecurityStates($n->getCollectionOfObjectValues(MessageSecurityState::class)); },
            'networkConnections' => function (self $o, ParseNode $n) { $o->setNetworkConnections($n->getCollectionOfObjectValues(NetworkConnection::class)); },
            'processes' => function (self $o, ParseNode $n) { $o->setProcesses($n->getCollectionOfObjectValues(Process::class)); },
            'recommendedActions' => function (self $o, ParseNode $n) { $o->setRecommendedActions($n->getCollectionOfPrimitiveValues()); },
            'registryKeyStates' => function (self $o, ParseNode $n) { $o->setRegistryKeyStates($n->getCollectionOfObjectValues(RegistryKeyState::class)); },
            'securityResources' => function (self $o, ParseNode $n) { $o->setSecurityResources($n->getCollectionOfObjectValues(SecurityResource::class)); },
            'severity' => function (self $o, ParseNode $n) { $o->setSeverity($n->getEnumValue(AlertSeverity::class)); },
            'sourceMaterials' => function (self $o, ParseNode $n) { $o->setSourceMaterials($n->getCollectionOfPrimitiveValues()); },
            ...
            'triggers' => function (self $o, ParseNode $n) { $o->setTriggers($n->getCollectionOfObjectValues(AlertTrigger::class)); },
            'uriClickSecurityStates' => function (self $o, ParseNode $n) { $o->setUriClickSecurityStates($n->getCollectionOfObjectValues(UriClickSecurityState::class)); },
            'userStates' => function (self $o, ParseNode $n) { $o->setUserStates($n->getCollectionOfObjectValues(UserSecurityState::class)); },
