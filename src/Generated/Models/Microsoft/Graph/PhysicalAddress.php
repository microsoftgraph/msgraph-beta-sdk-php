    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'postOfficeBox' => function (self $o, ParseNode $n) { $o->setPostOfficeBox($n->getStringValue()); },
            ...
            'type' => function (self $o, ParseNode $n) { $o->setType($n->getEnumValue(PhysicalAddressType::class)); },
        ];
    }
