...
class UnifiedRoleAssignment extends Entity 
{
    ...
    /** @var string|null $principalOrganizationId  */
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'principalOrganizationId' => function (self $o, ParseNode $n) { $o->setPrincipalOrganizationId($n->getStringValue()); },
            'resourceScope' => function (self $o, ParseNode $n) { $o->setResourceScope($n->getStringValue()); },
