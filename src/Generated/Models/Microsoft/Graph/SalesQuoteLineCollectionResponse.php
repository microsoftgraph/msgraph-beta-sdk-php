...
class SalesQuoteLineCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SalesQuoteLine>|null $value  */
    ...
    */
     ...
     * @return SalesQuoteLineCollectionResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SalesQuoteLineCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SalesQuoteLine::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SalesQuoteLine>|null $value Value to set for the value property.
    */
