...
class CompanyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CompanyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(Company::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Company>|null $value Value to set for the value property.
    */
