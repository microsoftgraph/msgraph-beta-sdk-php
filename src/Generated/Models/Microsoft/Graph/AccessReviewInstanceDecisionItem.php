...
class AccessReviewInstanceDecisionItem extends Entity 
{
    ...
    /** @var DecisionItemPrincipalResourceMembership|null $principalResourceMembership  */
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'insights' => function (self $o, ParseNode $n) { $o->setInsights($n->getCollectionOfObjectValues(GovernanceInsight::class)); },
            'instance' => function (self $o, ParseNode $n) { $o->setInstance($n->getObjectValue(AccessReviewInstance::class)); },
            ...
            'principalResourceMembership' => function (self $o, ParseNode $n) { $o->setPrincipalResourceMembership($n->getObjectValue(DecisionItemPrincipalResourceMembership::class)); },
            ...
            'target' => function (self $o, ParseNode $n) { $o->setTarget($n->getObjectValue(AccessReviewInstanceDecisionItemTarget::class)); },
        ]);
    }
    ...
    */
    ...
    /**
     * Gets the principalResourceMembership property value. 
    ...
    */
    ...
    /**
     * Sets the principalResourceMembership property value. 
