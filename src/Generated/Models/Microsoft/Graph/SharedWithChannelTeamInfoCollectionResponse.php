...
class SharedWithChannelTeamInfoCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SharedWithChannelTeamInfo>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SharedWithChannelTeamInfoCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SharedWithChannelTeamInfo::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SharedWithChannelTeamInfo>|null $value Value to set for the value property.
    */
