...
class TelecomExpenseManagementPartnerCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TelecomExpenseManagementPartner>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(TelecomExpenseManagementPartner::class)); },
        ];
    }
