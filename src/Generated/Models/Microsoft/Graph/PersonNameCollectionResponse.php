...
class PersonNameCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PersonName>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PersonNameCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(PersonName::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<PersonName>|null $value Value to set for the value property.
    */
