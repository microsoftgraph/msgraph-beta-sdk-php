...
class SalesInvoiceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SalesInvoice>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SalesInvoiceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SalesInvoice::class)); },
        ];
    }
