...
class ApplicationTemplate extends Entity 
{
    ...
    /** @var InformationalUrls|null $informationalUrls  */
    private ?InformationalUrls $informationalUrls = null;
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'informationalUrls' => function (self $o, ParseNode $n) { $o->setInformationalUrls($n->getObjectValue(InformationalUrls::class)); },
    ...
    */
    ...
    /**
     * Gets the informationalUrls property value. 
    ...
    */
    ...
    /**
     * Sets the informationalUrls property value. 
