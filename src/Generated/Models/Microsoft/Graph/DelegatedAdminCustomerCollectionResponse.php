...
class DelegatedAdminCustomerCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DelegatedAdminCustomer>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DelegatedAdminCustomerCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DelegatedAdminCustomer::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DelegatedAdminCustomer>|null $value Value to set for the value property.
    */
