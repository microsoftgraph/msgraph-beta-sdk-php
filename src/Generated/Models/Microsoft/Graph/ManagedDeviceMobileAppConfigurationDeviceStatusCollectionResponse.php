...
class ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ManagedDeviceMobileAppConfigurationDeviceStatus>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ManagedDeviceMobileAppConfigurationDeviceStatus::class)); },
        ];
    }
