...
class UnifiedRbacResourceNamespaceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnifiedRbacResourceNamespace>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UnifiedRbacResourceNamespaceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UnifiedRbacResourceNamespace::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UnifiedRbacResourceNamespace>|null $value Value to set for the value property.
    */
