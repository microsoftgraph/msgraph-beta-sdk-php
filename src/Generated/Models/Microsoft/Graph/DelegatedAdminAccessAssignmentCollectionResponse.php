...
class DelegatedAdminAccessAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DelegatedAdminAccessAssignment>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DelegatedAdminAccessAssignmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DelegatedAdminAccessAssignment::class)); },
        ];
    }
