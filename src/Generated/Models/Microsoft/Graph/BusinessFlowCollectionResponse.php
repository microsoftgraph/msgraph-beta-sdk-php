...
class BusinessFlowCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<BusinessFlow>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BusinessFlowCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(BusinessFlow::class)); },
        ];
    }
