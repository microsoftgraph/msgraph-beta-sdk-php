...
class QnaCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): QnaCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(Qna::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Qna>|null $value Value to set for the value property.
    */
