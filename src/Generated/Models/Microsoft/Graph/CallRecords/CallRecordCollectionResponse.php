...
namespace Microsoft\Graph\Beta\Generated\Models\Microsoft\Graph\CallRecords;
...
class CallRecordCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<CallRecord>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(CallRecord::class)); },
        ];
    }
