...
class WindowsInformationProtectionDeviceRegistrationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<WindowsInformationProtectionDeviceRegistration>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): WindowsInformationProtectionDeviceRegistrationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(WindowsInformationProtectionDeviceRegistration::class)); },
        ];
    }
