...
class UserExperienceAnalyticsDeviceStartupHistoryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserExperienceAnalyticsDeviceStartupHistory>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDeviceStartupHistoryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UserExperienceAnalyticsDeviceStartupHistory::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UserExperienceAnalyticsDeviceStartupHistory>|null $value Value to set for the value property.
    */
