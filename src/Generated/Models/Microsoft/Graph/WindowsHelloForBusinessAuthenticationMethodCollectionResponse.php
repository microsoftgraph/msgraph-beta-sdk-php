...
class WindowsHelloForBusinessAuthenticationMethodCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<WindowsHelloForBusinessAuthenticationMethod>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(WindowsHelloForBusinessAuthenticationMethod::class)); },
        ];
    }
