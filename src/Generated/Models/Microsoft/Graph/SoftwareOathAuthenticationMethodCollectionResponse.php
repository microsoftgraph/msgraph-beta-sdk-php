...
class SoftwareOathAuthenticationMethodCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SoftwareOathAuthenticationMethod>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SoftwareOathAuthenticationMethodCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SoftwareOathAuthenticationMethod::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SoftwareOathAuthenticationMethod>|null $value Value to set for the value property.
    */
