...
class MobileThreatDefenseConnectorCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<MobileThreatDefenseConnector>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(MobileThreatDefenseConnector::class)); },
        ];
    }
