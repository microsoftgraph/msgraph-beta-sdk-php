...
class TeamworkTagCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TeamworkTag>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TeamworkTagCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(TeamworkTag::class)); },
        ];
    }
