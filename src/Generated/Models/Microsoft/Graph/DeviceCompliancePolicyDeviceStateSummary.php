    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'configManagerCount' => function (self $o, ParseNode $n) { $o->setConfigManagerCount($n->getIntegerValue()); },
            ...
            'inGracePeriodCount' => function (self $o, ParseNode $n) { $o->setInGracePeriodCount($n->getIntegerValue()); },
