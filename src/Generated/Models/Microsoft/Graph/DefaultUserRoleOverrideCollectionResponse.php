...
class DefaultUserRoleOverrideCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DefaultUserRoleOverride>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DefaultUserRoleOverrideCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DefaultUserRoleOverride::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DefaultUserRoleOverride>|null $value Value to set for the value property.
    */
