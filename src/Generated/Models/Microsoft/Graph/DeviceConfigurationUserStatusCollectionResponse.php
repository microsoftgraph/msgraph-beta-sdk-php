...
class DeviceConfigurationUserStatusCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceConfigurationUserStatus>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DeviceConfigurationUserStatus::class)); },
        ];
    }
