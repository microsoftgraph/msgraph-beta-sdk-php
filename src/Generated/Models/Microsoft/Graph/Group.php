...
class Group extends DirectoryObject 
{
    ...
    /** @var GroupAccessType|null $accessType  */
    ...
    /** @var array<DirectoryObject>|null $members UMembers of this group, who can be users, devices, other groups, or service principals. Supports the List members, Add member, and Remove member operations. Nullable. Supports $expand including nested $select. For example, /groups?$filter=startsWith(displayName,'Role')&$select=id,displayName&$expand=members($select=id,userPrincipalName,displayName). */
    ...
    /** @var string|null $onPremisesSecurityIdentifier Contains the on-premises security identifier (SID) for the group that was synchronized from on-premises to the cloud. Returned by default. Supports $filter on null values. Read-only. */
    ...
    /** @var array<string>|null $resourceProvisioningOptions Specifies the group resources that are provisioned as part of Microsoft 365 group creation, that are not normally part of default group creation. Possible value is Team. For more information, see Set Microsoft 365 group behaviors and provisioning options. */
    ...
    /** @var array<DirectoryObject>|null $transitiveMemberOf  */
    private ?array $transitiveMemberOf = null;
    
    /** @var array<DirectoryObject>|null $transitiveMembers  */
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'accessType' => function (self $o, ParseNode $n) { $o->setAccessType($n->getEnumValue(GroupAccessType::class)); },
            ...
            'membershipRuleProcessingStatus' => function (self $o, ParseNode $n) { $o->setMembershipRuleProcessingStatus($n->getObjectValue(MembershipRuleProcessingStatus::class)); },
            ...
            'organizationId' => function (self $o, ParseNode $n) { $o->setOrganizationId($n->getStringValue()); },
            ...
            'resourceBehaviorOptions' => function (self $o, ParseNode $n) { $o->setResourceBehaviorOptions($n->getCollectionOfPrimitiveValues()); },
            'resourceProvisioningOptions' => function (self $o, ParseNode $n) { $o->setResourceProvisioningOptions($n->getCollectionOfPrimitiveValues()); },
            ...
            'settings' => function (self $o, ParseNode $n) { $o->setSettings($n->getCollectionOfObjectValues(DirectorySetting::class)); },
            ...
            'unseenConversationsCount' => function (self $o, ParseNode $n) { $o->setUnseenConversationsCount($n->getIntegerValue()); },
            'unseenCount' => function (self $o, ParseNode $n) { $o->setUnseenCount($n->getIntegerValue()); },
            'unseenMessagesCount' => function (self $o, ParseNode $n) { $o->setUnseenMessagesCount($n->getIntegerValue()); },
