...
class UserFlowApiConnectorConfiguration implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var IdentityApiConnector|null $postAttributeCollection  */
    private ?IdentityApiConnector $postAttributeCollection = null;
    
    /** @var IdentityApiConnector|null $postFederationSignup  */
    private ?IdentityApiConnector $postFederationSignup = null;
    
    /** @var IdentityApiConnector|null $preTokenIssuance  */
    ...
    */
     ...
     * @return IdentityApiConnector|null
    */
    public function getPreTokenIssuance(): ?IdentityApiConnector {
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeObjectValue('preTokenIssuance', $this->preTokenIssuance);
    ...
    */
     ...
     *  @param IdentityApiConnector|null $value Value to set for the preTokenIssuance property.
    */
    public function setPreTokenIssuance(?IdentityApiConnector $value ): void {
