    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'claimTokenManagementFromExternalMdm' => function (self $o, ParseNode $n) { $o->setClaimTokenManagementFromExternalMdm($n->getBooleanValue()); },
            ...
            'locationName' => function (self $o, ParseNode $n) { $o->setLocationName($n->getStringValue()); },
            ...
            'tokenActionResults' => function (self $o, ParseNode $n) { $o->setTokenActionResults($n->getCollectionOfObjectValues(VppTokenActionResult::class)); },
