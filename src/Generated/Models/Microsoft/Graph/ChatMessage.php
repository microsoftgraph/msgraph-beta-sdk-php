...
class ChatMessage extends Entity 
{
    ...
    /** @var ChatMessageFromIdentitySet|null $onBehalfOf User attribution of the message when bot sends a message on behalf of a user. */
    private ?ChatMessageFromIdentitySet $onBehalfOf = null;
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'onBehalfOf' => function (self $o, ParseNode $n) { $o->setOnBehalfOf($n->getObjectValue(ChatMessageFromIdentitySet::class)); },
    ...
    */
     ...
     * @return ChatMessageFromIdentitySet|null
    */
    public function getOnBehalfOf(): ?ChatMessageFromIdentitySet {
