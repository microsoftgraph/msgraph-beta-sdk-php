...
class SimulationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Simulation>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SimulationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(Simulation::class)); },
        ];
    }
