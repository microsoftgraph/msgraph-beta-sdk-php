...
class ChecklistItemCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ChecklistItem>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ChecklistItemCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ChecklistItem::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ChecklistItem>|null $value Value to set for the value property.
    */
