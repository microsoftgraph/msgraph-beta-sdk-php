...
class BookingCustomerCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<BookingCustomer>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BookingCustomerCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(BookingCustomer::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<BookingCustomer>|null $value Value to set for the value property.
    */
