...
class CloudPcConnection extends Entity 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CloudPcConnection {
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'healthCheckStatus' => function (self $o, ParseNode $n) { $o->setHealthCheckStatus($n->getStringValue()); },
