...
class AggregatedPolicyComplianceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AggregatedPolicyCompliance>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AggregatedPolicyComplianceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(AggregatedPolicyCompliance::class)); },
        ];
    }
