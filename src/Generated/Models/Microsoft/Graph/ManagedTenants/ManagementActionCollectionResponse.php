...
class ManagementActionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ManagementAction>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ManagementActionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ManagementAction::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ManagementAction>|null $value Value to set for the value property.
    */
