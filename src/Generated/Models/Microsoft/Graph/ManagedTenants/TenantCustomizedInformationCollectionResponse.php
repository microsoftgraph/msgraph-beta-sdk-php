...
class TenantCustomizedInformationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TenantCustomizedInformation>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TenantCustomizedInformationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(TenantCustomizedInformation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TenantCustomizedInformation>|null $value Value to set for the value property.
    */
