...
class DeviceCompliancePolicySettingStateSummaryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceCompliancePolicySettingStateSummary>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DeviceCompliancePolicySettingStateSummary::class)); },
        ];
    }
