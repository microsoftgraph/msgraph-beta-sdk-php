...
class SiteSourceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SiteSource>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SiteSourceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(SiteSource::class)); },
        ];
    }
