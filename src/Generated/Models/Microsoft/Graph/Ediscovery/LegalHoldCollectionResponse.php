...
class LegalHoldCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<LegalHold>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): LegalHoldCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(LegalHold::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<LegalHold>|null $value Value to set for the value property.
    */
