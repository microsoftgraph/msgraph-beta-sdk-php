...
class CaseCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EscapedCase>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CaseCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(EscapedCase::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<EscapedCase>|null $value Value to set for the value property.
    */
