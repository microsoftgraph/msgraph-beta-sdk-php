...
class CustodianCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Custodian>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CustodianCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(Custodian::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Custodian>|null $value Value to set for the value property.
    */
