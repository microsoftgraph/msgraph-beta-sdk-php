...
class RiskyServicePrincipalHistoryItemCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<RiskyServicePrincipalHistoryItem>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RiskyServicePrincipalHistoryItemCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(RiskyServicePrincipalHistoryItem::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<RiskyServicePrincipalHistoryItem>|null $value Value to set for the value property.
    */
