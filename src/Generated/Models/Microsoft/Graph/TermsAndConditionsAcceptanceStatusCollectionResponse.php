...
class TermsAndConditionsAcceptanceStatusCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TermsAndConditionsAcceptanceStatus>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(TermsAndConditionsAcceptanceStatus::class)); },
        ];
    }
