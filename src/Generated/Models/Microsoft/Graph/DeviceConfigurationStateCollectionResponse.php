...
class DeviceConfigurationStateCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceConfigurationState>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DeviceConfigurationState::class)); },
        ];
    }
