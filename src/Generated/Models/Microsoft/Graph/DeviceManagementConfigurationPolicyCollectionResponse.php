...
class DeviceManagementConfigurationPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceManagementConfigurationPolicy>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementConfigurationPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DeviceManagementConfigurationPolicy::class)); },
        ];
    }
