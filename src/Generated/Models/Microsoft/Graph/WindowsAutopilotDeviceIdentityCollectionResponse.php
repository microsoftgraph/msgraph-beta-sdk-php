...
class WindowsAutopilotDeviceIdentityCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<WindowsAutopilotDeviceIdentity>|null $value  */
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(WindowsAutopilotDeviceIdentity::class)); },
        ];
    }
