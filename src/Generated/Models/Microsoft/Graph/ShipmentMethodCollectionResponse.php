...
class ShipmentMethodCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ShipmentMethod>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ShipmentMethodCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ShipmentMethod::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ShipmentMethod>|null $value Value to set for the value property.
    */
