...
class UserExperienceAnalyticsMetricHistoryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserExperienceAnalyticsMetricHistory>|null $value  */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsMetricHistoryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UserExperienceAnalyticsMetricHistory::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UserExperienceAnalyticsMetricHistory>|null $value Value to set for the value property.
    */
