...
*/
class EducationGradingSchemeGrade_minPercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EducationGradingSchemeGrade_minPercentage and sets the default values.
    */
     ...
     * @return EducationGradingSchemeGrade_minPercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EducationGradingSchemeGrade_minPercentage {
        $result = new EducationGradingSchemeGrade_minPercentage();
