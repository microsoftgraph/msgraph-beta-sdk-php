...
class AndroidForWorkEnterpriseWiFiConfiguration extends AndroidForWorkWiFiConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var AndroidForWorkCertificateProfileBase|null $identityCertificateForClientAuthentication Identity Certificate for client authentication when EAP Type is configured to EAP-TLS, EAP-TTLS (with Certificate Authentication), or PEAP (with Certificate Authentication). This is the certificate presented by client to the Wi-Fi endpoint. The authentication server sitting behind the Wi-Fi endpoint must accept this certificate to successfully establish a Wi-Fi connection.
    */
    private ?AndroidForWorkCertificateProfileBase $identityCertificateForClientAuthentication = null;
    ...
    */
    ...
    /**
     * @var AndroidForWorkTrustedRootCertificate|null $rootCertificateForServerValidation Trusted Root Certificate for Server Validation when EAP Type is configured to EAP-TLS, EAP-TTLS or PEAP. This is the certificate presented by the Wi-Fi endpoint when the device attempts to connect to Wi-Fi endpoint. The device (or user) must accept this certificate to continue the connection attempt.
    */
    private ?AndroidForWorkTrustedRootCertificate $rootCertificateForServerValidation = null;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'identityCertificateForClientAuthentication' => function (ParseNode $n) use ($o) { $o->setIdentityCertificateForClientAuthentication($n->getObjectValue(array(AndroidForWorkCertificateProfileBase::class, 'createFromDiscriminatorValue'))); },
            ...
            'rootCertificateForServerValidation' => function (ParseNode $n) use ($o) { $o->setRootCertificateForServerValidation($n->getObjectValue(array(AndroidForWorkTrustedRootCertificate::class, 'createFromDiscriminatorValue'))); },
