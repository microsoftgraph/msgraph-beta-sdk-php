...
*/
class UserExperienceAnalyticsAppHealthApplicationPerformance_appHealthScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsAppHealthApplicationPerformance_appHealthScore and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsAppHealthApplicationPerformance_appHealthScore {
        $result = new UserExperienceAnalyticsAppHealthApplicationPerformance_appHealthScore();
