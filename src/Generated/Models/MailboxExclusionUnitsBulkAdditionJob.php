...
class MailboxExclusionUnitsBulkAdditionJob extends ExclusionUnitBulkAdditionJob implements Parsable 
{
    /**
     * Instantiates a new MailboxExclusionUnitsBulkAdditionJob and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MailboxExclusionUnitsBulkAdditionJob {
