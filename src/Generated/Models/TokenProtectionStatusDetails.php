...
class TokenProtectionStatusDetails implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TokenProtectionStatusDetails {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'signInSessionStatus' => fn(ParseNode $n) => $o->setSignInSessionStatus($n->getEnumValue(TokenProtectionStatus::class)),
            'signInSessionStatusCode' => fn(ParseNode $n) => $o->setSignInSessionStatusCode($n->getIntegerValue()),
        ];
    }
    ...
    */
    public function getSignInSessionStatus(): ?TokenProtectionStatus {
        $val = $this->getBackingStore()->get('signInSessionStatus');
        if (is_null($val) || $val instanceof TokenProtectionStatus) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'signInSessionStatus'");
    }
    ...
    */
    public function getSignInSessionStatusCode(): ?int {
        $val = $this->getBackingStore()->get('signInSessionStatusCode');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'signInSessionStatusCode'");
    }
    ...
    */
    public function setSignInSessionStatus(?TokenProtectionStatus $value): void {
        $this->getBackingStore()->set('signInSessionStatus', $value);
    }
    ...
    */
    public function setSignInSessionStatusCode(?int $value): void {
        $this->getBackingStore()->set('signInSessionStatusCode', $value);
    }
