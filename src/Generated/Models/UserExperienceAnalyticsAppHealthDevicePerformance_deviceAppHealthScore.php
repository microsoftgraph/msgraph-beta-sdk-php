...
*/
class UserExperienceAnalyticsAppHealthDevicePerformance_deviceAppHealthScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsAppHealthDevicePerformance_deviceAppHealthScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsAppHealthDevicePerformance_deviceAppHealthScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsAppHealthDevicePerformance_deviceAppHealthScore {
