...
class CloudPcProvisioningConfiguration implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CloudPcProvisioningConfiguration and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CloudPcProvisioningConfiguration {
        return new CloudPcProvisioningConfiguration();
    }
