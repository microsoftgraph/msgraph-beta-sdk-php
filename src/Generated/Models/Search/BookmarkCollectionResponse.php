...
class BookmarkCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Bookmark>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BookmarkCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(Bookmark::class)); },
        ];
    }
