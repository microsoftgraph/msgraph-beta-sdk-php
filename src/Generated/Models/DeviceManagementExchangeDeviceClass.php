...
*/
class DeviceManagementExchangeDeviceClass implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getType(): ?DeviceManagementExchangeAccessRuleType {
        ...
        if (is_null($val) || $val instanceof DeviceManagementExchangeAccessRuleType) {
            return $val;
        }
