...
class RiskyUser extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * Gets the riskLevel property value. Level of the detected risky user. The possible values are low, medium, high, hidden, none, unknownFutureValue.  Supports $filter (eq).
    ...
    */
    ...
    /**
     * Sets the riskLevel property value. Level of the detected risky user. The possible values are low, medium, high, hidden, none, unknownFutureValue.  Supports $filter (eq).
