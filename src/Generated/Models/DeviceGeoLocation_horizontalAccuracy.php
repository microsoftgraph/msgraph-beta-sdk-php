...
*/
class DeviceGeoLocation_horizontalAccuracy implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceGeoLocation_horizontalAccuracy and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceGeoLocation_horizontalAccuracy {
        $result = new DeviceGeoLocation_horizontalAccuracy();
