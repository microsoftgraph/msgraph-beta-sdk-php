...
class GsuiteSource extends AuthorizationSystemIdentitySource implements Parsable 
{
    /**
    ...
    */
     ...
     * @return GsuiteSource
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GsuiteSource {
