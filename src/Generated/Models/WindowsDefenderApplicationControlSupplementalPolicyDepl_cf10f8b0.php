...
*/
class WindowsDefenderApplicationControlSupplementalPolicyDepl_cf10f8b0 extends Entity implements Parsable 
{
    /**
     * Instantiates a new WindowsDefenderApplicationControlSupplementalPolicyDepl_cf10f8b0 and sets the default values.
    */
     ...
     * @return WindowsDefenderApplicationControlSupplementalPolicyDepl_cf10f8b0
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WindowsDefenderApplicationControlSupplementalPolicyDepl_cf10f8b0 {
        return new WindowsDefenderApplicationControlSupplementalPolicyDepl_cf10f8b0();
    }
