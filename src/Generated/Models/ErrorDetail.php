...
class ErrorDetail implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getResourceInstanceName(): ?string {
        $val = $this->getBackingStore()->get('resourceInstanceName');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'resourceInstanceName'");
    }
    ...
    */
    public function setResourceInstanceName(?string $value): void {
        $this->getBackingStore()->set('resourceInstanceName', $value);
    }
