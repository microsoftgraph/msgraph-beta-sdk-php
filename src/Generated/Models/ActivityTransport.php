...
class ActivityTransport implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ActivityTransport and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ActivityTransport {
    ...
    */
    public function getConnectionType(): ?ConnectionType {
        ...
        if (is_null($val) || $val instanceof ConnectionType) {
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'connectionType' => fn(ParseNode $n) => $o->setConnectionType($n->getEnumValue(ConnectionType::class)),
    ...
    */
     ...
     * @param ConnectionType|null $value Value to set for the connectionType property.
    */
    public function setConnectionType(?ConnectionType $value): void {
