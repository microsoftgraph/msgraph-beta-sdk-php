...
class TeamDiscoverySettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getShowInTeamsSearchAndSuggestions(): ?bool {
        $val = $this->getBackingStore()->get('showInTeamsSearchAndSuggestions');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'showInTeamsSearchAndSuggestions'");
    }
    ...
    */
    public function setShowInTeamsSearchAndSuggestions(?bool $value): void {
        $this->getBackingStore()->set('showInTeamsSearchAndSuggestions', $value);
    }
