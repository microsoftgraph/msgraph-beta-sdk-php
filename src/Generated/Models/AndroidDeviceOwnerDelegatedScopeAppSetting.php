...
*/
class AndroidDeviceOwnerDelegatedScopeAppSetting implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AndroidDeviceOwnerDelegatedScopeAppSetting {
    ...
    */
    public function getAppDetail(): ?AppListItem {
        $val = $this->getBackingStore()->get('appDetail');
        if (is_null($val) || $val instanceof AppListItem) {
            return $val;
        }
     ...
     * @return array<AndroidDeviceOwnerDelegatedAppScopeType>|null
    */
    public function getAppScopes(): ?array {
        $val = $this->getBackingStore()->get('appScopes');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, AndroidDeviceOwnerDelegatedAppScopeType::class);
            /** @var array<AndroidDeviceOwnerDelegatedAppScopeType>|null $val */
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'appDetail' => fn(ParseNode $n) => $o->setAppDetail($n->getObjectValue([AppListItem::class, 'createFromDiscriminatorValue'])),
            'appScopes' => fn(ParseNode $n) => $o->setAppScopes($n->getCollectionOfEnumValues(AndroidDeviceOwnerDelegatedAppScopeType::class)),
    ...
    */
     ...
     * @param AppListItem|null $value Value to set for the appDetail property.
    */
    public function setAppDetail(?AppListItem $value): void {
        $this->getBackingStore()->set('appDetail', $value);
    }

    /**
     * Sets the appScopes property value. List of scopes an app has been assigned.
     * @param array<AndroidDeviceOwnerDelegatedAppScopeType>|null $value Value to set for the appScopes property.
    */
