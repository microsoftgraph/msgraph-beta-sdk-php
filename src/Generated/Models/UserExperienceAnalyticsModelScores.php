...
class UserExperienceAnalyticsModelScores extends Entity implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'meanResourceSpikeTimeScore' => fn(ParseNode $n) => $o->setMeanResourceSpikeTimeScore($n->getObjectValue([UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @return UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore|null
    */
    public function getMeanResourceSpikeTimeScore(): ?UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore {
        $val = $this->getBackingStore()->get('meanResourceSpikeTimeScore');
        if (is_null($val) || $val instanceof UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) {
            return $val;
        }
    ...
    */
     ...
     * @param UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore|null $value Value to set for the meanResourceSpikeTimeScore property.
    */
    public function setMeanResourceSpikeTimeScore(?UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore $value): void {
