...
*/
class UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudIdentityScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudIdentityScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudIdentityScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudIdentityScore {
        $result = new UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudIdentityScore();
