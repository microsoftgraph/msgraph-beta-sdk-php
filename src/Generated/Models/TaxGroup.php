...
class TaxGroup extends Entity implements Parsable 
{
    ...
    */
     ...
     * @return TaxGroup
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TaxGroup {
        return new TaxGroup();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'taxType' => fn(ParseNode $n) => $o->setTaxType($n->getStringValue()),
        ]);
    }
    ...
    */
    public function getTaxType(): ?string {
        $val = $this->getBackingStore()->get('taxType');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'taxType'");
    }
