...
class CountryRegion implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getAddressFormat(): ?string {
        $val = $this->getBackingStore()->get('addressFormat');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'addressFormat'");
    }
