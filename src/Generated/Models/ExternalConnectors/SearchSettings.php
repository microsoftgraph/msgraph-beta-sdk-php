...
class SearchSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getSearchResultTemplates(): ?array {
        $val = $this->getBackingStore()->get('searchResultTemplates');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, DisplayTemplate::class);
            /** @var array<DisplayTemplate>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'searchResultTemplates'");
    }
