...
class ComplianceSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getEDiscoveryResultTemplates(): ?array {
        $val = $this->getBackingStore()->get('eDiscoveryResultTemplates');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, DisplayTemplate::class);
            /** @var array<DisplayTemplate>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'eDiscoveryResultTemplates'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'eDiscoveryResultTemplates' => fn(ParseNode $n) => $o->setEDiscoveryResultTemplates($n->getCollectionOfObjectValues([DisplayTemplate::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function setEDiscoveryResultTemplates(?array $value): void {
        $this->getBackingStore()->set('eDiscoveryResultTemplates', $value);
    }
