...
class ActivitySettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getUrlToItemResolvers(): ?array {
        $val = $this->getBackingStore()->get('urlToItemResolvers');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, UrlToItemResolverBase::class);
            /** @var array<UrlToItemResolverBase>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'urlToItemResolvers'");
    }
