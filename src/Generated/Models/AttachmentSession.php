...
class AttachmentSession extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<string>|null $nextExpectedRange The nextExpectedRange property
    */
    private ?array $nextExpectedRange = null;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'nextExpectedRange' => function (ParseNode $n) use ($o) { $o->setNextExpectedRange($n->getCollectionOfPrimitiveValues()); },
        ]);
    }
    ...
    */
    public function getNextExpectedRange(): ?array {
        return $this->nextExpectedRange;
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeCollectionOfPrimitiveValues('nextExpectedRange', $this->nextExpectedRange);
    }
    ...
    */
     ...
     *  @param array<string>|null $value Value to set for the nextExpectedRange property.
    */
    public function setNextExpectedRange(?array $value ): void {
        $this->nextExpectedRange = $value;
    }
