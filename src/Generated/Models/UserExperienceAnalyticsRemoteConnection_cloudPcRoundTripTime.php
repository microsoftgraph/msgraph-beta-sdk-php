...
*/
class UserExperienceAnalyticsRemoteConnection_cloudPcRoundTripTime implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsRemoteConnection_cloudPcRoundTripTime and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsRemoteConnection_cloudPcRoundTripTime
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsRemoteConnection_cloudPcRoundTripTime {
        $result = new UserExperienceAnalyticsRemoteConnection_cloudPcRoundTripTime();
