...
class CancelRunsScope extends CancelScope implements Parsable 
{
    /**
     * Instantiates a new CancelRunsScope and sets the default values.
    */
     ...
     * @return CancelRunsScope
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CancelRunsScope {
