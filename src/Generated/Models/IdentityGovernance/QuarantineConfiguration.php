...
class QuarantineConfiguration implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getConditions(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, QuarantineCondition::class);
            /** @var array<QuarantineCondition>|null $val */
            return $val;
        }
    ...
    */
    public function getMatchMode(): ?MatchMode {
        $val = $this->getBackingStore()->get('matchMode');
        if (is_null($val) || $val instanceof MatchMode) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'matchMode'");
    }
    ...
    */
    public function setMatchMode(?MatchMode $value): void {
        $this->getBackingStore()->set('matchMode', $value);
    }
