...
class IfNotEmptyTransformation extends CustomClaimTransformation implements Parsable 
{
    /**
    ...
    */
    public function __construct() {
        parent::__construct();
        $this->setOdataType('#microsoft.graph.ifNotEmptyTransformation');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): IfNotEmptyTransformation {
