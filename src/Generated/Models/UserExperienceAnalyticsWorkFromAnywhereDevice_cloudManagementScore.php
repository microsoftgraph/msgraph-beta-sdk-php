...
*/
class UserExperienceAnalyticsWorkFromAnywhereDevice_cloudManagementScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsWorkFromAnywhereDevice_cloudManagementScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereDevice_cloudManagementScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsWorkFromAnywhereDevice_cloudManagementScore {
        $result = new UserExperienceAnalyticsWorkFromAnywhereDevice_cloudManagementScore();
