...
class WindowsApplication implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getPackageSid(): ?string {
        $val = $this->getBackingStore()->get('packageSid');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'packageSid'");
    }
