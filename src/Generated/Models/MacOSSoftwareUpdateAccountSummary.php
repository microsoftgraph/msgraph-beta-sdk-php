...
class MacOSSoftwareUpdateAccountSummary extends Entity 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MacOSSoftwareUpdateAccountSummary {
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            'categorySummaries' => function (self $o, ParseNode $n) { $o->setCategorySummaries($n->getCollectionOfObjectValues(MacOSSoftwareUpdateCategorySummary::class)); },
