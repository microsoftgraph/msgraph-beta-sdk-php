...
class CloudPcProvisioningPolicyAutopatch implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CloudPcProvisioningPolicyAutopatch {
    ...
    */
    public function getAutopatchGroupId(): ?string {
        $val = $this->getBackingStore()->get('autopatchGroupId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'autopatchGroupId'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'autopatchGroupId' => fn(ParseNode $n) => $o->setAutopatchGroupId($n->getStringValue()),
    ...
    */
    public function setAutopatchGroupId(?string $value): void {
        $this->getBackingStore()->set('autopatchGroupId', $value);
    }
