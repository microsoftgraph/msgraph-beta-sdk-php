...
*/
class AndroidAppConfigurationSchema extends Entity implements Parsable 
{
    /**
     * Instantiates a new AndroidAppConfigurationSchema and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AndroidAppConfigurationSchema {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'nestedSchemaItems' => fn(ParseNode $n) => $o->setNestedSchemaItems($n->getCollectionOfObjectValues([AppConfigurationSchemaItemType::class, 'createFromDiscriminatorValue'])),
            'schemaItems' => fn(ParseNode $n) => $o->setSchemaItems($n->getCollectionOfObjectValues([AppConfigurationSchemaItemType::class, 'createFromDiscriminatorValue'])),
        ]);
    }
     ...
     * @return array<AppConfigurationSchemaItemType>|null
    */
    public function getNestedSchemaItems(): ?array {
        $val = $this->getBackingStore()->get('nestedSchemaItems');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, AppConfigurationSchemaItemType::class);
            /** @var array<AppConfigurationSchemaItemType>|null $val */
            return $val;
        }
    ...
    */
     ...
     * @param array<AppConfigurationSchemaItemType>|null $value Value to set for the nestedSchemaItems property.
    */
     ...
     * @param array<AppConfigurationSchemaItemType>|null $value Value to set for the schemaItems property.
    */
