...
class WebApplicationFirewallDnsConfiguration implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getIsDomainVerified(): ?bool {
        $val = $this->getBackingStore()->get('isDomainVerified');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isDomainVerified'");
    }
    ...
    */
    public function getIsProxied(): ?bool {
        $val = $this->getBackingStore()->get('isProxied');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isProxied'");
    }
    ...
    */
    public function getRecordType(): ?WebApplicationFirewallDnsRecordType {
        ...
        if (is_null($val) || $val instanceof WebApplicationFirewallDnsRecordType) {
            return $val;
        }
    ...
    */
    public function setIsDomainVerified(?bool $value): void {
        $this->getBackingStore()->set('isDomainVerified', $value);
    }
    ...
    */
    public function setIsProxied(?bool $value): void {
        $this->getBackingStore()->set('isProxied', $value);
    }
