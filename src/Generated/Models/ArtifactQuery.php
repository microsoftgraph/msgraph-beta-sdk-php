...
class ArtifactQuery implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ArtifactQuery {
    ...
    */
     ...
     * @return RestorableArtifact|null
    */
    public function getArtifactType(): ?RestorableArtifact {
        $val = $this->getBackingStore()->get('artifactType');
        if (is_null($val) || $val instanceof RestorableArtifact) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'artifactType'");
    }
    ...
    */
    public function getQueryExpression(): ?string {
        $val = $this->getBackingStore()->get('queryExpression');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'queryExpression'");
    }
    ...
    */
     ...
     * @param RestorableArtifact|null $value Value to set for the artifactType property.
    */
    public function setArtifactType(?RestorableArtifact $value): void {
        $this->getBackingStore()->set('artifactType', $value);
    }
