...
class SignUpStatus implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return SignUpStatus
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SignUpStatus {
