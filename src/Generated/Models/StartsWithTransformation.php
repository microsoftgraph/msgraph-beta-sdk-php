...
class StartsWithTransformation extends CustomClaimTransformation implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): StartsWithTransformation {
