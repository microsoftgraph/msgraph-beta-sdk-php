...
class DeviceDetail implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getBrowserId(): ?string {
        $val = $this->getBackingStore()->get('browserId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'browserId'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'browserId' => fn(ParseNode $n) => $o->setBrowserId($n->getStringValue()),
    ...
    */
     ...
     * @param string|null $value Value to set for the browserId property.
    */
    public function setBrowserId(?string $value): void {
        $this->getBackingStore()->set('browserId', $value);
    }
