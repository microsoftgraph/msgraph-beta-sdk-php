...
*/
class UserExperienceAnalyticsRemoteConnection_coreSignInTime implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsRemoteConnection_coreSignInTime and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsRemoteConnection_coreSignInTime
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsRemoteConnection_coreSignInTime {
        $result = new UserExperienceAnalyticsRemoteConnection_coreSignInTime();
