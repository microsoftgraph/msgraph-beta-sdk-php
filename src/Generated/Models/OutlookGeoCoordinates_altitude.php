...
*/
class OutlookGeoCoordinates_altitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OutlookGeoCoordinates_altitude and sets the default values.
    */
     ...
     * @return OutlookGeoCoordinates_altitude
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OutlookGeoCoordinates_altitude {
        $result = new OutlookGeoCoordinates_altitude();
