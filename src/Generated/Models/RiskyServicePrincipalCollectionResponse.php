...
class RiskyServicePrincipalCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<RiskyServicePrincipal>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RiskyServicePrincipalCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(RiskyServicePrincipal::class)); },
        ];
    }
