...
*/
class Photo_exposureNumerator implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Photo_exposureNumerator and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Photo_exposureNumerator {
        $result = new Photo_exposureNumerator();
