...
class SecurityCopilot extends Entity implements Parsable 
{
    /**
     * Instantiates a new SecurityCopilot and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SecurityCopilot {
