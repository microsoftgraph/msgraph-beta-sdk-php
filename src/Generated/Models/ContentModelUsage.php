...
class ContentModelUsage implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ContentModelUsage {
        return new ContentModelUsage();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'modelId' => fn(ParseNode $n) => $o->setModelId($n->getStringValue()),
    ...
    */
    public function getModelId(): ?string {
        $val = $this->getBackingStore()->get('modelId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'modelId'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeStringValue('modelId', $this->getModelId());
    ...
    */
     ...
     * @param string|null $value Value to set for the modelId property.
    */
    public function setModelId(?string $value): void {
        $this->getBackingStore()->set('modelId', $value);
    }
