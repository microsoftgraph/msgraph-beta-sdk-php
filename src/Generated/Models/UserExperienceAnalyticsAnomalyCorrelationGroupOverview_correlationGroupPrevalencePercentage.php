...
*/
class UserExperienceAnalyticsAnomalyCorrelationGroupOverview_correlationGroupPrevalencePercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsAnomalyCorrelationGroupOverview_correlationGroupPrevalencePercentage and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsAnomalyCorrelationGroupOverview_correlationGroupPrevalencePercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsAnomalyCorrelationGroupOverview_correlationGroupPrevalencePercentage {
        $result = new UserExperienceAnalyticsAnomalyCorrelationGroupOverview_correlationGroupPrevalencePercentage();
