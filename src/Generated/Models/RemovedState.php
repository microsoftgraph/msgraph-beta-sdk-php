...
class RemovedState implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return RemovedState
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RemovedState {
