...
*/
class GeoCoordinates_latitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GeoCoordinates_latitude and sets the default values.
    */
     ...
     * @return GeoCoordinates_latitude
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GeoCoordinates_latitude {
        $result = new GeoCoordinates_latitude();
