...
class DeviceKey implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getKeyMaterial(): ?StreamInterface {
        $val = $this->getBackingStore()->get('keyMaterial');
        if (is_null($val) || $val instanceof StreamInterface) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'keyMaterial'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeBinaryContent('keyMaterial', $this->getKeyMaterial());
    ...
    */
    public function setKeyMaterial(?StreamInterface $value): void {
        $this->getBackingStore()->set('keyMaterial', $value);
    }
