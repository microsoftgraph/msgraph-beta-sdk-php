...
*/
class OmaSettingFloatingPoint_value implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OmaSettingFloatingPoint_value and sets the default values.
    */
     ...
     * @return OmaSettingFloatingPoint_value
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OmaSettingFloatingPoint_value {
        $result = new OmaSettingFloatingPoint_value();
