...
class MentionAction implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MentionAction {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'mentionees' => fn(ParseNode $n) => $o->setMentionees($n->getCollectionOfObjectValues([IdentitySet::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function getMentionees(): ?array {
        $val = $this->getBackingStore()->get('mentionees');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, IdentitySet::class);
            /** @var array<IdentitySet>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'mentionees'");
    }
    ...
    */
    public function setMentionees(?array $value): void {
        $this->getBackingStore()->set('mentionees', $value);
    }
