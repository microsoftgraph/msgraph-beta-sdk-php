...
*/
class WindowsAutoUpdateCatalogAppInstallExperience implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WindowsAutoUpdateCatalogAppInstallExperience and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WindowsAutoUpdateCatalogAppInstallExperience {
    ...
    */
     ...
     * @return WindowsAutoUpdateCatalogAppRestartBehavior|null
    */
    public function getDeviceRestartBehavior(): ?WindowsAutoUpdateCatalogAppRestartBehavior {
        $val = $this->getBackingStore()->get('deviceRestartBehavior');
        if (is_null($val) || $val instanceof WindowsAutoUpdateCatalogAppRestartBehavior) {
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'deviceRestartBehavior' => fn(ParseNode $n) => $o->setDeviceRestartBehavior($n->getEnumValue(WindowsAutoUpdateCatalogAppRestartBehavior::class)),
    ...
    */
     ...
     * @param WindowsAutoUpdateCatalogAppRestartBehavior|null $value Value to set for the deviceRestartBehavior property.
    */
    public function setDeviceRestartBehavior(?WindowsAutoUpdateCatalogAppRestartBehavior $value): void {
