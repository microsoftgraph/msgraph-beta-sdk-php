...
*/
class UserExperienceAnalyticsModelScores_workFromAnywhereScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsModelScores_workFromAnywhereScore and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsModelScores_workFromAnywhereScore {
        $result = new UserExperienceAnalyticsModelScores_workFromAnywhereScore();
