...
class Message extends OutlookItem implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var MentionsPreview|null $mentionsPreview The mentionsPreview property
    */
    ...
    */
    ...
    /**
     * @var array<string>|null $unsubscribeData The unsubscribeData property
    */
    private ?array $unsubscribeData = null;
    
    /**
     * @var bool|null $unsubscribeEnabled The unsubscribeEnabled property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'mentions' => function (ParseNode $n) use ($o) { $o->setMentions($n->getCollectionOfObjectValues(array(Mention::class, 'createFromDiscriminatorValue'))); },
            'mentionsPreview' => function (ParseNode $n) use ($o) { $o->setMentionsPreview($n->getObjectValue(array(MentionsPreview::class, 'createFromDiscriminatorValue'))); },
