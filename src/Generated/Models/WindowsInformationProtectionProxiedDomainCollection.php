...
*/
class WindowsInformationProtectionProxiedDomainCollection implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getProxiedDomains(): ?array {
        $val = $this->getBackingStore()->get('proxiedDomains');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, ProxiedDomain::class);
            /** @var array<ProxiedDomain>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'proxiedDomains'");
    }
