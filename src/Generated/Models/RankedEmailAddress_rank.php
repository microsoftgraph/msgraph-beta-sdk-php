...
*/
class RankedEmailAddress_rank implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RankedEmailAddress_rank and sets the default values.
    */
     ...
     * @return RankedEmailAddress_rank
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RankedEmailAddress_rank {
        $result = new RankedEmailAddress_rank();
