...
*/
class InsightValueDouble_value implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new InsightValueDouble_value and sets the default values.
    */
     ...
     * @return InsightValueDouble_value
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): InsightValueDouble_value {
        $result = new InsightValueDouble_value();
