...
class AndroidForWorkVpnConfiguration extends DeviceConfiguration implements Parsable 
{
    ...
    */
    public function getConnectionType(): ?AndroidForWorkVpnConnectionType {
        ...
        if (is_null($val) || $val instanceof AndroidForWorkVpnConnectionType) {
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'connectionType' => fn(ParseNode $n) => $o->setConnectionType($n->getEnumValue(AndroidForWorkVpnConnectionType::class)),
            ...
            'identityCertificate' => fn(ParseNode $n) => $o->setIdentityCertificate($n->getObjectValue([AndroidForWorkCertificateProfileBase::class, 'createFromDiscriminatorValue'])),
