...
class Organization extends DirectoryObject implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var CertificateConnectorSetting|null $certificateConnectorSetting Certificate connector setting.
    */
    private ?CertificateConnectorSetting $certificateConnectorSetting = null;
    ...
    */
    ...
    /**
     * @var bool|null $isMultipleDataLocationsForServicesEnabled true if organization is Multi-Geo enabled; false if organization is not Multi-Geo enabled; null (default). Read-only. For more information, see OneDrive Online Multi-Geo.
    */
    private ?bool $isMultipleDataLocationsForServicesEnabled = null;
    ...
    */
    ...
    /**
     * @var OrganizationSettings|null $settings Retrieve the properties and relationships of organizationSettings object. Nullable.
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'certificateConnectorSetting' => function (ParseNode $n) use ($o) { $o->setCertificateConnectorSetting($n->getObjectValue(array(CertificateConnectorSetting::class, 'createFromDiscriminatorValue'))); },
            ...
            'directorySizeQuota' => function (ParseNode $n) use ($o) { $o->setDirectorySizeQuota($n->getObjectValue(array(DirectorySizeQuota::class, 'createFromDiscriminatorValue'))); },
            ...
            'isMultipleDataLocationsForServicesEnabled' => function (ParseNode $n) use ($o) { $o->setIsMultipleDataLocationsForServicesEnabled($n->getBooleanValue()); },
            ...
            'settings' => function (ParseNode $n) use ($o) { $o->setSettings($n->getObjectValue(array(OrganizationSettings::class, 'createFromDiscriminatorValue'))); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeObjectValue('certificateConnectorSetting', $this->certificateConnectorSetting);
        ...
        $writer->writeBooleanValue('isMultipleDataLocationsForServicesEnabled', $this->isMultipleDataLocationsForServicesEnabled);
