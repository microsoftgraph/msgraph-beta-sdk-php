...
class ProtectionPolicyArtifactCount implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    ...
    /**
     * Gets the completed property value. The number of artifacts whose protection is completed.
     * @return int|null
    */
    ...
    /**
     * Gets the failed property value. The number of artifacts whose protection failed.
     * @return int|null
    */
    ...
    */
    ...
    /**
     * Gets the inProgress property value. The number of artifacts whose protection is in progress.
     * @return int|null
    */
    ...
    */
    ...
    /**
     * Gets the total property value. The number of artifacts present in the protection policy.
     * @return int|null
    */
    ...
    */
    ...
    /**
     * Sets the completed property value. The number of artifacts whose protection is completed.
    ...
    */
    ...
    /**
     * Sets the failed property value. The number of artifacts whose protection failed.
    ...
    */
    ...
    /**
     * Sets the inProgress property value. The number of artifacts whose protection is in progress.
    ...
    */
    ...
    /**
     * Sets the total property value. The number of artifacts present in the protection policy.
