...
*/
class WorkbookRangeFont_size implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WorkbookRangeFont_size and sets the default values.
    */
     ...
     * @return WorkbookRangeFont_size
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WorkbookRangeFont_size {
        $result = new WorkbookRangeFont_size();
