...
class EdiscoveryCase extends EscapedCase implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'legalHolds' => function (ParseNode $n) use ($o) { $o->setLegalHolds($n->getCollectionOfObjectValues(array(EdiscoveryHoldPolicy::class, 'createFromDiscriminatorValue'))); },
