...
class AuditLogRecord extends Entity implements Parsable 
{
    ...
    */
     ...
     * @return AuditLogRecord_auditLogRecordType|null
    */
    public function getAuditLogRecordType(): ?AuditLogRecord_auditLogRecordType {
        $val = $this->getBackingStore()->get('auditLogRecordType');
        if (is_null($val) || $val instanceof AuditLogRecord_auditLogRecordType) {
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'auditLogRecordType' => fn(ParseNode $n) => $o->setAuditLogRecordType($n->getEnumValue(AuditLogRecord_auditLogRecordType::class)),
            ...
            'userType' => fn(ParseNode $n) => $o->setUserType($n->getEnumValue(AuditLogRecord_userType::class)),
        ]);
    }
    ...
    */
     ...
     * @return AuditLogRecord_userType|null
    */
    public function getUserType(): ?AuditLogRecord_userType {
        $val = $this->getBackingStore()->get('userType');
        if (is_null($val) || $val instanceof AuditLogRecord_userType) {
            return $val;
        }
    ...
    */
     ...
     * @param AuditLogRecord_auditLogRecordType|null $value Value to set for the auditLogRecordType property.
    */
    public function setAuditLogRecordType(?AuditLogRecord_auditLogRecordType $value): void {
    ...
    */
     ...
     * @param AuditLogRecord_userType|null $value Value to set for the userType property.
    */
    public function setUserType(?AuditLogRecord_userType $value): void {
