...
class AggregatedEnvironment implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    ...
    /**
     * Instantiates a new AggregatedEnvironment and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AggregatedEnvironment {
