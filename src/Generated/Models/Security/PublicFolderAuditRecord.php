...
{
    /**
     * Instantiates a new PublicFolderAuditRecord and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PublicFolderAuditRecord {
