...
class BooleanValueProperty extends ValueProperty implements Parsable 
{
    /**
     * Instantiates a new BooleanValueProperty and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): BooleanValueProperty {
