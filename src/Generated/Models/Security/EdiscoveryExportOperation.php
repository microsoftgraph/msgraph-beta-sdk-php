...
class EdiscoveryExportOperation extends CaseOperation implements Parsable 
{
    ...
    */
     ...
     * @return ExportFileMetadata|null
    */
    public function getExportFileMetadata(): ?ExportFileMetadata {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'exportFileMetadata' => fn(ParseNode $n) => $o->setExportFileMetadata($n->getObjectValue([ExportFileMetadata::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeObjectValue('exportFileMetadata', $this->getExportFileMetadata());
    ...
    */
     ...
     * @param ExportFileMetadata|null $value Value to set for the exportFileMetadata property.
    */
    public function setExportFileMetadata(?ExportFileMetadata $value): void {
