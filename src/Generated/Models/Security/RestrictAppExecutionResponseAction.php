...
class RestrictAppExecutionResponseAction extends ResponseAction implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RestrictAppExecutionResponseAction {
