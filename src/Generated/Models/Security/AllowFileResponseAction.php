...
class AllowFileResponseAction extends ResponseAction implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AllowFileResponseAction {
