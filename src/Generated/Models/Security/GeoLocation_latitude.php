...
*/
class GeoLocation_latitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GeoLocation_latitude and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GeoLocation_latitude {
        $result = new GeoLocation_latitude();
