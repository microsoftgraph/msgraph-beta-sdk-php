...
class MitreTechnique implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MitreTechnique and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MitreTechnique {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'technique' => fn(ParseNode $n) => $o->setTechnique($n->getStringValue()),
        ];
    }
    ...
    */
     ...
     * @param string|null $value Value to set for the technique property.
    */
    public function setTechnique(?string $value): void {
