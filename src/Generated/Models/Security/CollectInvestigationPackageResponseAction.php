...
class CollectInvestigationPackageResponseAction extends ResponseAction implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CollectInvestigationPackageResponseAction {
