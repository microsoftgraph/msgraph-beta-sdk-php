...
*/
class GeoLocation_longitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new GeoLocation_longitude and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GeoLocation_longitude {
        $result = new GeoLocation_longitude();
