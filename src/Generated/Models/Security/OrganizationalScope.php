...
class OrganizationalScope implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OrganizationalScope {
    ...
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'scopeNames' => function (ParseNode $n) {
                ...
                $this->setScopeNames($val);
            },
            'scopeType' => fn(ParseNode $n) => $o->setScopeType($n->getEnumValue(ScopeType::class)),
        ];
    }
    ...
    */
    public function getScopeNames(): ?array {
        $val = $this->getBackingStore()->get('scopeNames');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'scopeNames'");
    }
    ...
    */
    public function getScopeType(): ?ScopeType {
        ...
        if (is_null($val) || $val instanceof ScopeType) {
            return $val;
        }
    ...
    */
    public function setScopeNames(?array $value): void {
        $this->getBackingStore()->set('scopeNames', $value);
    }

    /**
     * Sets the scopeType property value. The scopeType property
     * @param ScopeType|null $value Value to set for the scopeType property.
    */
    public function setScopeType(?ScopeType $value): void {
