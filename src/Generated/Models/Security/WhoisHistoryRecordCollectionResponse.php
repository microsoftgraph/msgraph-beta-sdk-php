...
class WhoisHistoryRecordCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable 
{
    ...
    */
     ...
     * @return WhoisHistoryRecordCollectionResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WhoisHistoryRecordCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'value' => fn(ParseNode $n) => $o->setValue($n->getCollectionOfObjectValues([WhoisHistoryRecord::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
     ...
     * @param array<WhoisHistoryRecord>|null $value Value to set for the value property.
    */
