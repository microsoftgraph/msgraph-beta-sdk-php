...
class RedirectUriBlockedDomainConfiguration implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RedirectUriBlockedDomainConfiguration and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RedirectUriBlockedDomainConfiguration {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'publicClient' => fn(ParseNode $n) => $o->setPublicClient($n->getObjectValue([RedirectUriPlatformBlockedDomainConfiguration::class, 'createFromDiscriminatorValue'])),
            'restrictForAppsCreatedAfterDateTime' => fn(ParseNode $n) => $o->setRestrictForAppsCreatedAfterDateTime($n->getDateTimeValue()),
            'spa' => fn(ParseNode $n) => $o->setSpa($n->getObjectValue([RedirectUriPlatformBlockedDomainConfiguration::class, 'createFromDiscriminatorValue'])),
            'state' => fn(ParseNode $n) => $o->setState($n->getEnumValue(AppManagementRestrictionState::class)),
            'web' => fn(ParseNode $n) => $o->setWeb($n->getObjectValue([RedirectUriPlatformBlockedDomainConfiguration::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function getPublicClient(): ?RedirectUriPlatformBlockedDomainConfiguration {
        ...
        if (is_null($val) || $val instanceof RedirectUriPlatformBlockedDomainConfiguration) {
            return $val;
        }
