...
*/
class UserExperienceAnalyticsAnomalyCorrelationGroupFeature implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsAnomalyCorrelationGroupFeature {
    ...
    */
     ...
     * @return UserExperienceAnalyticsAnomalyDeviceFeatureType|null
    */
    public function getDeviceFeatureType(): ?UserExperienceAnalyticsAnomalyDeviceFeatureType {
        $val = $this->getBackingStore()->get('deviceFeatureType');
        if (is_null($val) || $val instanceof UserExperienceAnalyticsAnomalyDeviceFeatureType) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'deviceFeatureType'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'deviceFeatureType' => fn(ParseNode $n) => $o->setDeviceFeatureType($n->getEnumValue(UserExperienceAnalyticsAnomalyDeviceFeatureType::class)),
    ...
    */
     ...
     * @param UserExperienceAnalyticsAnomalyDeviceFeatureType|null $value Value to set for the deviceFeatureType property.
    */
    public function setDeviceFeatureType(?UserExperienceAnalyticsAnomalyDeviceFeatureType $value): void {
        $this->getBackingStore()->set('deviceFeatureType', $value);
    }
