...
*/
class DeviceGeoLocation_longitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceGeoLocation_longitude and sets the default values.
    */
     ...
     * @return DeviceGeoLocation_longitude
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceGeoLocation_longitude {
        $result = new DeviceGeoLocation_longitude();
