...
class DeviceManagementSettingFileConstraint extends DeviceManagementConstraint implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'supportedExtensions' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setSupportedExtensions($val);
            },
        ]);
    }
    ...
    */
    public function getSupportedExtensions(): ?array {
        $val = $this->getBackingStore()->get('supportedExtensions');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'supportedExtensions'");
    }
