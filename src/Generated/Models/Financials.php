...
class Financials implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return Financials
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Financials {
    ...
    */
    public function getCompanies(): ?array {
        $val = $this->getBackingStore()->get('companies');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, Company::class);
            /** @var array<Company>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'companies'");
    }
