...
*/
class BookingAppointment_invoiceAmount implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new BookingAppointment_invoiceAmount and sets the default values.
    */
     ...
     * @return BookingAppointment_invoiceAmount
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): BookingAppointment_invoiceAmount {
        $result = new BookingAppointment_invoiceAmount();
