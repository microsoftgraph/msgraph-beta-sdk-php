...
class AzureIdentity extends AuthorizationSystemIdentity implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AzureIdentity {
