...
class OnenoteOperationError implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function __construct() {
        ...
        $this->setOdataType('#microsoft.graph.onenoteOperationError');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OnenoteOperationError {
