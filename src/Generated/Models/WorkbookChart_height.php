...
*/
class WorkbookChart_height implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WorkbookChart_height and sets the default values.
    */
     ...
     * @return WorkbookChart_height
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WorkbookChart_height {
        $result = new WorkbookChart_height();
