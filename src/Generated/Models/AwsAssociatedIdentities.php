...
class AwsAssociatedIdentities implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AwsAssociatedIdentities {
    ...
    */
     ...
     * @return array<AwsIdentity>|null
    */
    public function getAll(): ?array {
        $val = $this->getBackingStore()->get('all');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, AwsIdentity::class);
            /** @var array<AwsIdentity>|null $val */
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'all' => fn(ParseNode $n) => $o->setAll($n->getCollectionOfObjectValues([AwsIdentity::class, 'createFromDiscriminatorValue'])),
            '@odata.type' => fn(ParseNode $n) => $o->setOdataType($n->getStringValue()),
            'roles' => fn(ParseNode $n) => $o->setRoles($n->getCollectionOfObjectValues([AwsRole::class, 'createFromDiscriminatorValue'])),
            'users' => fn(ParseNode $n) => $o->setUsers($n->getCollectionOfObjectValues([AwsUser::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
     ...
     * @return array<AwsUser>|null
    */
    public function getUsers(): ?array {
        $val = $this->getBackingStore()->get('users');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, AwsUser::class);
            /** @var array<AwsUser>|null $val */
            return $val;
        }
    ...
    */
     ...
     * @param array<AwsIdentity>|null $value Value to set for the all property.
    */
    ...
    */
     ...
     * @param array<AwsRole>|null $value Value to set for the roles property.
    */
     ...
     * @param array<AwsUser>|null $value Value to set for the users property.
    */
