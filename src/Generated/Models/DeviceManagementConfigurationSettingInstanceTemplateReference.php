...
*/
class DeviceManagementConfigurationSettingInstanceTemplateReference implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementConfigurationSettingInstanceTemplateReference {
    ...
    */
    public function getSettingInstanceTemplateId(): ?string {
        $val = $this->getBackingStore()->get('settingInstanceTemplateId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'settingInstanceTemplateId'");
    }
