...
class ApplicationsRequiredResourceAccess implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ApplicationsRequiredResourceAccess and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApplicationsRequiredResourceAccess {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'permissions' => fn(ParseNode $n) => $o->setPermissions($n->getCollectionOfObjectValues([ApplicationResourcePermission::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function getPermissions(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, ApplicationResourcePermission::class);
            /** @var array<ApplicationResourcePermission>|null $val */
            return $val;
        }
