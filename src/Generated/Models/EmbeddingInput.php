...
class EmbeddingInput implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EmbeddingInput and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EmbeddingInput {
    ...
    */
    public function getModelType(): ?string {
        $val = $this->getBackingStore()->get('modelType');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'modelType'");
    }
    ...
    */
     ...
     * @param string|null $value Value to set for the modelType property.
    */
    public function setModelType(?string $value): void {
        $this->getBackingStore()->set('modelType', $value);
    }
