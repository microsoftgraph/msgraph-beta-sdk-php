...
*/
class UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore {
        $result = new UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore();
