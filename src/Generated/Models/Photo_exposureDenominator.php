...
*/
class Photo_exposureDenominator implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Photo_exposureDenominator and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Photo_exposureDenominator {
        $result = new Photo_exposureDenominator();
