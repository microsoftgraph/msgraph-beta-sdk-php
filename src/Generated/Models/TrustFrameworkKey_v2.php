...
class TrustFrameworkKey_v2 implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TrustFrameworkKey_v2 and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TrustFrameworkKey_v2 {
    ...
    */
    ...
    /**
     * Gets the kid property value. The unique identifier for the key. Primary key.
     * @return string|null
    */
    ...
    */
    ...
    /**
     * Sets the kid property value. The unique identifier for the key. Primary key.
