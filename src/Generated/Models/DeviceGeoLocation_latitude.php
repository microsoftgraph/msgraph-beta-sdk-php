...
*/
class DeviceGeoLocation_latitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceGeoLocation_latitude and sets the default values.
    */
     ...
     * @return DeviceGeoLocation_latitude
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceGeoLocation_latitude {
        $result = new DeviceGeoLocation_latitude();
