...
*/
class UserExperienceAnalyticsRemoteConnection_remoteSignInTime implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsRemoteConnection_remoteSignInTime and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsRemoteConnection_remoteSignInTime
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsRemoteConnection_remoteSignInTime {
        $result = new UserExperienceAnalyticsRemoteConnection_remoteSignInTime();
