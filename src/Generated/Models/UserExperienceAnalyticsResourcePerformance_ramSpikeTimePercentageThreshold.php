...
*/
class UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentageThreshold implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentageThreshold and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentageThreshold
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentageThreshold {
        $result = new UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentageThreshold();
