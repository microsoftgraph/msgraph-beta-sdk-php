...
*/
class SecurityBaselineContributingPolicy implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getSourceType(): ?SecurityBaselinePolicySourceType {
        ...
        if (is_null($val) || $val instanceof SecurityBaselinePolicySourceType) {
            return $val;
        }
