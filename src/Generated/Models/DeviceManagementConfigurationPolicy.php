...
class DeviceManagementConfigurationPolicy extends Entity implements Parsable 
{
    ...
    */
    public function getPriorityMetaData(): ?DeviceManagementPriorityMetaData {
        $val = $this->getBackingStore()->get('priorityMetaData');
        if (is_null($val) || $val instanceof DeviceManagementPriorityMetaData) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'priorityMetaData'");
    }
    ...
    */
    public function getTemplateReference(): ?DeviceManagementConfigurationPolicyTemplateReference {
        $val = $this->getBackingStore()->get('templateReference');
        if (is_null($val) || $val instanceof DeviceManagementConfigurationPolicyTemplateReference) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'templateReference'");
    }
