...
class AdminConsent implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getShareAPNSData(): ?AdminConsentState {
        $val = $this->getBackingStore()->get('shareAPNSData');
        if (is_null($val) || $val instanceof AdminConsentState) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'shareAPNSData'");
    }
    ...
    */
    public function getShareUserExperienceAnalyticsData(): ?AdminConsentState {
        $val = $this->getBackingStore()->get('shareUserExperienceAnalyticsData');
        if (is_null($val) || $val instanceof AdminConsentState) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'shareUserExperienceAnalyticsData'");
    }
