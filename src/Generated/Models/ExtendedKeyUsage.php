...
class ExtendedKeyUsage implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'objectIdentifier' => fn(ParseNode $n) => $o->setObjectIdentifier($n->getStringValue()),
    ...
    */
    public function getObjectIdentifier(): ?string {
        $val = $this->getBackingStore()->get('objectIdentifier');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'objectIdentifier'");
    }
    ...
    */
    public function setObjectIdentifier(?string $value): void {
        $this->getBackingStore()->set('objectIdentifier', $value);
    }
