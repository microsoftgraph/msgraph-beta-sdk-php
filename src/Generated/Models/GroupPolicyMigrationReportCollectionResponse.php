...
class GroupPolicyMigrationReportCollectionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GroupPolicyMigrationReportCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(GroupPolicyMigrationReport::class, 'createFromDiscriminatorValue'))); },
        ];
    }
