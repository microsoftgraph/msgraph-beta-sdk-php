...
class PhoneOptions implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return PhoneOptions
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PhoneOptions {
    ...
    */
    public function getDefaultRegions(): ?array {
        $val = $this->getBackingStore()->get('defaultRegions');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'int');
            /** @var array<int>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'defaultRegions'");
    }
     ...
     * @return array<int>|null
    */
    public function getExcludeRegions(): ?array {
        $val = $this->getBackingStore()->get('excludeRegions');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'int');
            /** @var array<int>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'excludeRegions'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'defaultRegions' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'int');
                }
                /** @var array<int>|null $val */
                $this->setDefaultRegions($val);
            },
            'excludeRegions' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'int');
                }
                /** @var array<int>|null $val */
                $this->setExcludeRegions($val);
            },
            'includeAdditionalRegions' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'int');
                }
                /** @var array<int>|null $val */
                $this->setIncludeAdditionalRegions($val);
            },
     ...
     * @return array<int>|null
    */
    public function getIncludeAdditionalRegions(): ?array {
        $val = $this->getBackingStore()->get('includeAdditionalRegions');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'int');
            /** @var array<int>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'includeAdditionalRegions'");
    }
    ...
    */
     ...
     * @param array<int>|null $value Value to set for the defaultRegions property.
    */
    public function setDefaultRegions(?array $value): void {
        $this->getBackingStore()->set('defaultRegions', $value);
    }
     ...
     * @param array<int>|null $value Value to set for the excludeRegions property.
    */
    public function setExcludeRegions(?array $value): void {
        $this->getBackingStore()->set('excludeRegions', $value);
    }

    /**
     * Sets the includeAdditionalRegions property value. A numbers-only set representing the country codes that can be manually added to enable telephony service in those regions, in addition to the list of countries that are already enabled. For more information about regions that require opt in, see Regions that need to opt in for MFA telephony verification. Validates against current International Subscriber Dialing (ISD) country codes where the maximum code length is 4. Values must be positive integers and can't overlap with 'excludeRegions'.
     * @param array<int>|null $value Value to set for the includeAdditionalRegions property.
    */
    public function setIncludeAdditionalRegions(?array $value): void {
        $this->getBackingStore()->set('includeAdditionalRegions', $value);
    }
