...
class PlannerTaskPolicy implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PlannerTaskPolicy {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'rules' => fn(ParseNode $n) => $o->setRules($n->getCollectionOfObjectValues([PlannerTaskRoleBasedRule::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function getRules(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, PlannerTaskRoleBasedRule::class);
            /** @var array<PlannerTaskRoleBasedRule>|null $val */
            return $val;
        }
