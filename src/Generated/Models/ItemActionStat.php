...
class ItemActionStat implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getActionCount(): ?int {
        $val = $this->getBackingStore()->get('actionCount');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'actionCount'");
    }
    ...
    */
    public function getActorCount(): ?int {
        $val = $this->getBackingStore()->get('actorCount');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'actorCount'");
    }
