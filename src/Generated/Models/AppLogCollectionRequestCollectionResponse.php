...
class AppLogCollectionRequestCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AppLogCollectionRequest>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AppLogCollectionRequestCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(AppLogCollectionRequest::class)); },
        ];
    }
