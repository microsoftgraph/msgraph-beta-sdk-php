...
class NetworkInterface implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): NetworkInterface {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'ipV4Address' => function (self $o, ParseNode $n) { $o->setIpV4Address($n->getStringValue()); },
            'ipV6Address' => function (self $o, ParseNode $n) { $o->setIpV6Address($n->getStringValue()); },
            'localIpV6Address' => function (self $o, ParseNode $n) { $o->setLocalIpV6Address($n->getStringValue()); },
