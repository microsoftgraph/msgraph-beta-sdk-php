...
class OnTokenIssuanceStartReturnClaim implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $claimIdInApiResponse The claimIdInApiResponse property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'claimIdInApiResponse' => function (ParseNode $n) use ($o) { $o->setClaimIdInApiResponse($n->getStringValue()); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeStringValue('claimIdInApiResponse', $this->claimIdInApiResponse);
