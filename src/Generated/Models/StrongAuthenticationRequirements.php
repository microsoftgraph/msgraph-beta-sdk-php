...
class StrongAuthenticationRequirements implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): StrongAuthenticationRequirements {
        return new StrongAuthenticationRequirements();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'perUserMfaState' => fn(ParseNode $n) => $o->setPerUserMfaState($n->getEnumValue(PerUserMfaState::class)),
        ];
    }
    ...
    */
    public function getPerUserMfaState(): ?PerUserMfaState {
        $val = $this->getBackingStore()->get('perUserMfaState');
        if (is_null($val) || $val instanceof PerUserMfaState) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'perUserMfaState'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeEnumValue('perUserMfaState', $this->getPerUserMfaState());
    ...
    */
    public function setPerUserMfaState(?PerUserMfaState $value): void {
        $this->getBackingStore()->set('perUserMfaState', $value);
    }
