...
class ShiftsUserInfo implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return ShiftsUserInfo
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ShiftsUserInfo {
