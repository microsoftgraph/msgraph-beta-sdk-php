...
class AutoReviewSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getNotReviewedResult(): ?string {
        $val = $this->getBackingStore()->get('notReviewedResult');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'notReviewedResult'");
    }
    ...
    */
    public function setNotReviewedResult(?string $value): void {
        $this->getBackingStore()->set('notReviewedResult', $value);
    }
