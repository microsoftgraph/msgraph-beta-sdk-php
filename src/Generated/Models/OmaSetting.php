...
class OmaSetting implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getOmaUri(): ?string {
        $val = $this->getBackingStore()->get('omaUri');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'omaUri'");
    }
    ...
    */
    public function getSecretReferenceValueId(): ?string {
        $val = $this->getBackingStore()->get('secretReferenceValueId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'secretReferenceValueId'");
    }
