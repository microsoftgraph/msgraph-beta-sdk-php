...
class ThreatAssessmentRequest extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * Gets the requestSource property value. The source of the threat assessment request. The possible values are: user, administrator.
    ...
    */
    ...
    /**
     * Sets the requestSource property value. The source of the threat assessment request. The possible values are: user, administrator.
