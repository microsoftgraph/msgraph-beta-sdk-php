...
class OptionalClaim implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getAdditionalProperties(): ?array {
        $val = $this->getBackingStore()->get('additionalProperties');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'additionalProperties'");
    }
    ...
    */
    public function getEssential(): ?bool {
        $val = $this->getBackingStore()->get('essential');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'essential'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'additionalProperties' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setAdditionalProperties($val);
            },
