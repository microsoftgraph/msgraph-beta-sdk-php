...
*/
class ManagedDeviceMobileAppConfigurationSettingState implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ManagedDeviceMobileAppConfigurationSettingState {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'settingInstanceId' => fn(ParseNode $n) => $o->setSettingInstanceId($n->getStringValue()),
