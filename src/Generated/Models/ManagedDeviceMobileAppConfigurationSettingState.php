...
class ManagedDeviceMobileAppConfigurationSettingState implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ManagedDeviceMobileAppConfigurationSettingState {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'settingInstanceId' => function (self $o, ParseNode $n) { $o->setSettingInstanceId($n->getStringValue()); },
