...
class CommsNotification implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getResourceUrl(): ?string {
        return $this->getBackingStore()->get('resourceUrl');
    }
    ...
    */
    public function setResourceUrl(?string $value): void {
        $this->getBackingStore()->set('resourceUrl', $value);
    }
