...
class MacOSRedirectSingleSignOnExtension extends MacOSSingleSignOnExtension implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MacOSRedirectSingleSignOnExtension {
