...
class ReferenceUpdateSchema implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return ReferenceUpdateSchema
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ReferenceUpdateSchema {
