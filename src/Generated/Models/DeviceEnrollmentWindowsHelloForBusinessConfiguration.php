...
class DeviceEnrollmentWindowsHelloForBusinessConfiguration extends DeviceEnrollmentConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var Enablement|null $securityKeyForSignIn Security key for Sign In provides the capacity for remotely turning ON/OFF Windows Hello Sercurity Keyl Not configured will honor configurations done on the clinet. Possible values are: notConfigured, enabled, disabled.
    */
    private ?Enablement $securityKeyForSignIn = null;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'securityKeyForSignIn' => function (ParseNode $n) use ($o) { $o->setSecurityKeyForSignIn($n->getEnumValue(Enablement::class)); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeEnumValue('securityKeyForSignIn', $this->securityKeyForSignIn);
