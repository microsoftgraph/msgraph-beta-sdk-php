    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'errorUrl' => function (ParseNode $n) use ($o) { $o->setErrorUrl($n->getStringValue()); },
            ...
            'passwordSingleSignOnSettings' => function (ParseNode $n) use ($o) { $o->setPasswordSingleSignOnSettings($n->getObjectValue(array(PasswordSingleSignOnSettings::class, 'createFromDiscriminatorValue'))); },
            'preferredSingleSignOnMode' => function (ParseNode $n) use ($o) { $o->setPreferredSingleSignOnMode($n->getStringValue()); },
            'preferredTokenSigningKeyEndDateTime' => function (ParseNode $n) use ($o) { $o->setPreferredTokenSigningKeyEndDateTime($n->getDateTimeValue()); },
            'preferredTokenSigningKeyThumbprint' => function (ParseNode $n) use ($o) { $o->setPreferredTokenSigningKeyThumbprint($n->getStringValue()); },
            'publishedPermissionScopes' => function (ParseNode $n) use ($o) { $o->setPublishedPermissionScopes($n->getCollectionOfObjectValues(array(PermissionScope::class, 'createFromDiscriminatorValue'))); },
