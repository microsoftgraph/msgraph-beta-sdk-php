...
class UserPrint implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'recentPrinterShares' => fn(ParseNode $n) => $o->setRecentPrinterShares($n->getCollectionOfObjectValues([PrinterShare::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function getRecentPrinterShares(): ?array {
        $val = $this->getBackingStore()->get('recentPrinterShares');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, PrinterShare::class);
            /** @var array<PrinterShare>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'recentPrinterShares'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeCollectionOfObjectValues('recentPrinterShares', $this->getRecentPrinterShares());
    ...
    */
    public function setRecentPrinterShares(?array $value): void {
        $this->getBackingStore()->set('recentPrinterShares', $value);
    }
