...
*/
class Payload_predictedCompromiseRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Payload_predictedCompromiseRate and sets the default values.
    */
     ...
     * @return Payload_predictedCompromiseRate
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Payload_predictedCompromiseRate {
        $result = new Payload_predictedCompromiseRate();
