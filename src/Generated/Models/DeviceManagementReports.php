    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            'cachedReportConfigurations' => function (self $o, ParseNode $n) { $o->setCachedReportConfigurations($n->getCollectionOfObjectValues(DeviceManagementCachedReportConfiguration::class)); },
