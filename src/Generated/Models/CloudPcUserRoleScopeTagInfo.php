...
class CloudPcUserRoleScopeTagInfo implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'roleScopeTagId' => fn(ParseNode $n) => $o->setRoleScopeTagId($n->getStringValue()),
        ];
    }
    ...
    */
    public function getRoleScopeTagId(): ?string {
        $val = $this->getBackingStore()->get('roleScopeTagId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'roleScopeTagId'");
    }
    ...
    */
    public function setRoleScopeTagId(?string $value): void {
        $this->getBackingStore()->set('roleScopeTagId', $value);
    }
