...
class SearchHit implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            '_id' => function (self $o, ParseNode $n) { $o->set_id($n->getStringValue()); },
            '_score' => function (self $o, ParseNode $n) { $o->set_score($n->getIntegerValue()); },
            '_source' => function (self $o, ParseNode $n) { $o->set_source($n->getObjectValue(Entity::class)); },
            '_summary' => function (self $o, ParseNode $n) { $o->set_summary($n->getStringValue()); },
