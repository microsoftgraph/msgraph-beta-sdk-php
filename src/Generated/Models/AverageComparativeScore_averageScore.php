...
*/
class AverageComparativeScore_averageScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AverageComparativeScore_averageScore and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AverageComparativeScore_averageScore {
        $result = new AverageComparativeScore_averageScore();
