...
*/
class DeviceAndAppManagementAssignedRoleDefinition implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceAndAppManagementAssignedRoleDefinition {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'roleDefinitionDisplayName' => fn(ParseNode $n) => $o->setRoleDefinitionDisplayName($n->getStringValue()),
        ];
    }
    ...
    */
     ...
     * @return string|null
    */
    public function getRoleDefinitionDisplayName(): ?string {
        $val = $this->getBackingStore()->get('roleDefinitionDisplayName');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'roleDefinitionDisplayName'");
    }
    ...
    */
     ...
     * @param string|null $value Value to set for the roleDefinitionDisplayName property.
    */
    public function setRoleDefinitionDisplayName(?string $value): void {
        $this->getBackingStore()->set('roleDefinitionDisplayName', $value);
    }
