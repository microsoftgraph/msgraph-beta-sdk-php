...
*/
class OutlookGeoCoordinates_accuracy implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OutlookGeoCoordinates_accuracy and sets the default values.
    */
     ...
     * @return OutlookGeoCoordinates_accuracy
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OutlookGeoCoordinates_accuracy {
        $result = new OutlookGeoCoordinates_accuracy();
