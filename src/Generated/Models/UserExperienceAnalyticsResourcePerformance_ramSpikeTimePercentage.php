...
*/
class UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentage and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentage {
        $result = new UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentage();
