...
class MacOSScepCertificateProfile extends MacOSCertificateProfileBase implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var MacOSTrustedRootCertificate|null $rootCertificate Trusted Root Certificate.
    */
    private ?MacOSTrustedRootCertificate $rootCertificate = null;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'rootCertificate' => function (ParseNode $n) use ($o) { $o->setRootCertificate($n->getObjectValue(array(MacOSTrustedRootCertificate::class, 'createFromDiscriminatorValue'))); },
