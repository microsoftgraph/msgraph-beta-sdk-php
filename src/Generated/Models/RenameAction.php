...
class RenameAction implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getNewName(): ?string {
        $val = $this->getBackingStore()->get('newName');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'newName'");
    }
    ...
    */
    public function getOldName(): ?string {
        $val = $this->getBackingStore()->get('oldName');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'oldName'");
    }
    ...
    */
    public function setNewName(?string $value): void {
        $this->getBackingStore()->set('newName', $value);
    }
    ...
    */
    public function setOldName(?string $value): void {
        $this->getBackingStore()->set('oldName', $value);
    }
