...
class SignInActivity implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SignInActivity {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'lastNonInteractiveSignInDateTime' => function (self $o, ParseNode $n) { $o->setLastNonInteractiveSignInDateTime($n->getDateTimeValue()); },
            'lastNonInteractiveSignInRequestId' => function (self $o, ParseNode $n) { $o->setLastNonInteractiveSignInRequestId($n->getStringValue()); },
            'lastSignInDateTime' => function (self $o, ParseNode $n) { $o->setLastSignInDateTime($n->getDateTimeValue()); },
            'lastSignInRequestId' => function (self $o, ParseNode $n) { $o->setLastSignInRequestId($n->getStringValue()); },
        ];
    }
