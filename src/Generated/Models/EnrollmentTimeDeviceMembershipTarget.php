...
*/
class EnrollmentTimeDeviceMembershipTarget implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EnrollmentTimeDeviceMembershipTarget {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'targetType' => fn(ParseNode $n) => $o->setTargetType($n->getEnumValue(EnrollmentTimeDeviceMembershipTargetType::class)),
        ];
    }
    ...
    */
     ...
     * @return EnrollmentTimeDeviceMembershipTargetType|null
    */
    public function getTargetType(): ?EnrollmentTimeDeviceMembershipTargetType {
        $val = $this->getBackingStore()->get('targetType');
        if (is_null($val) || $val instanceof EnrollmentTimeDeviceMembershipTargetType) {
            return $val;
        }
    ...
    */
     ...
     * @param EnrollmentTimeDeviceMembershipTargetType|null $value Value to set for the targetType property.
    */
    public function setTargetType(?EnrollmentTimeDeviceMembershipTargetType $value): void {
