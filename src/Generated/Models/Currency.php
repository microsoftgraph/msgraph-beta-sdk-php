...
class Currency implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getAmountDecimalPlaces(): ?string {
        $val = $this->getBackingStore()->get('amountDecimalPlaces');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'amountDecimalPlaces'");
    }
    ...
    */
    public function getAmountRoundingPrecision(): ?string {
        $val = $this->getBackingStore()->get('amountRoundingPrecision');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'amountRoundingPrecision'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeStringValue('amountRoundingPrecision', $this->getAmountRoundingPrecision());
