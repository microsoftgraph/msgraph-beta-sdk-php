...
*/
class UserExperienceAnalyticsResourcePerformance_cpuClockSpeedInMHz implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsResourcePerformance_cpuClockSpeedInMHz and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsResourcePerformance_cpuClockSpeedInMHz
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsResourcePerformance_cpuClockSpeedInMHz {
        $result = new UserExperienceAnalyticsResourcePerformance_cpuClockSpeedInMHz();
