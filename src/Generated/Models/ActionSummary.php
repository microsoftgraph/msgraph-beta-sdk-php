...
class ActionSummary implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ActionSummary {
    ...
    */
    public function getAssigned(): ?int {
        $val = $this->getBackingStore()->get('assigned');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'assigned'");
    }
    ...
    */
    public function getAvailable(): ?int {
        $val = $this->getBackingStore()->get('available');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'available'");
    }
    ...
    */
    public function getExercised(): ?int {
        $val = $this->getBackingStore()->get('exercised');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'exercised'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'assigned' => fn(ParseNode $n) => $o->setAssigned($n->getIntegerValue()),
            'available' => fn(ParseNode $n) => $o->setAvailable($n->getIntegerValue()),
            'exercised' => fn(ParseNode $n) => $o->setExercised($n->getIntegerValue()),
    ...
    */
    public function setAssigned(?int $value): void {
        $this->getBackingStore()->set('assigned', $value);
    }
    ...
    */
    public function setExercised(?int $value): void {
        $this->getBackingStore()->set('exercised', $value);
    }
