...
*/
class ServiceLevelAgreementAttainment_score implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ServiceLevelAgreementAttainment_score and sets the default values.
    */
     ...
     * @return ServiceLevelAgreementAttainment_score
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ServiceLevelAgreementAttainment_score {
        $result = new ServiceLevelAgreementAttainment_score();
