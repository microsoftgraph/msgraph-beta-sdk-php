...
*/
class RubricQuality_weight implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RubricQuality_weight and sets the default values.
    */
     ...
     * @return RubricQuality_weight
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RubricQuality_weight {
        $result = new RubricQuality_weight();
