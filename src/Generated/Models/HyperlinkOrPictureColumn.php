...
class HyperlinkOrPictureColumn implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'isPicture' => fn(ParseNode $n) => $o->setIsPicture($n->getBooleanValue()),
    ...
    */
    public function getIsPicture(): ?bool {
        $val = $this->getBackingStore()->get('isPicture');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isPicture'");
    }
