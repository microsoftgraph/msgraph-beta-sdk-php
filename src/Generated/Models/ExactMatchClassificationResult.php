...
class ExactMatchClassificationResult implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getClassification(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, ExactMatchDetectedSensitiveContent::class);
            /** @var array<ExactMatchDetectedSensitiveContent>|null $val */
            return $val;
        }
    ...
    */
    public function getErrors(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, ClassificationError::class);
            /** @var array<ClassificationError>|null $val */
            return $val;
        }
