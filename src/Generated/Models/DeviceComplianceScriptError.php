...
class DeviceComplianceScriptError implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'code' => fn(ParseNode $n) => $o->setCode($n->getEnumValue(Code::class)),
            'deviceComplianceScriptRulesValidationError' => fn(ParseNode $n) => $o->setDeviceComplianceScriptRulesValidationError($n->getEnumValue(DeviceComplianceScriptRulesValidationError::class)),
    ...
    */
    public function setDeviceComplianceScriptRulesValidationError(?DeviceComplianceScriptRulesValidationError $value): void {
        $this->getBackingStore()->set('deviceComplianceScriptRulesValidationError', $value);
    }
