...
class DriveExclusionUnit extends ExclusionUnitBase implements Parsable 
{
    /**
     * Instantiates a new DriveExclusionUnit and sets the default values.
    */
    public function __construct() {
        parent::__construct();
        $this->setOdataType('#microsoft.graph.driveExclusionUnit');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DriveExclusionUnit {
        return new DriveExclusionUnit();
    }
