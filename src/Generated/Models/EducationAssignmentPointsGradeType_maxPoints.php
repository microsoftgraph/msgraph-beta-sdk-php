...
*/
class EducationAssignmentPointsGradeType_maxPoints implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EducationAssignmentPointsGradeType_maxPoints and sets the default values.
    */
     ...
     * @return EducationAssignmentPointsGradeType_maxPoints
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EducationAssignmentPointsGradeType_maxPoints {
        $result = new EducationAssignmentPointsGradeType_maxPoints();
