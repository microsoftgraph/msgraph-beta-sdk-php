...
class Customer implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getTaxAreaDisplayName(): ?string {
        $val = $this->getBackingStore()->get('taxAreaDisplayName');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'taxAreaDisplayName'");
    }
    ...
    */
    public function getTaxAreaId(): ?string {
        $val = $this->getBackingStore()->get('taxAreaId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'taxAreaId'");
    }
