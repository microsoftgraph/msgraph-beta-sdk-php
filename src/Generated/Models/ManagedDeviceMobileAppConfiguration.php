...
class ManagedDeviceMobileAppConfiguration extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<string>|null $roleScopeTagIds List of Scope Tags for this App configuration entity.
    */
