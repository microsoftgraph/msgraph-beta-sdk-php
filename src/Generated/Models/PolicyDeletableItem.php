...
class PolicyDeletableItem implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PolicyDeletableItem and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PolicyDeletableItem {
        ...
        return new PolicyDeletableItem();
    }
    ...
    */
    ...
    /**
     * Gets the deletedDateTime property value. Shows the last date and time the policy was deleted.
    ...
    */
    ...
    /**
     * Sets the deletedDateTime property value. Shows the last date and time the policy was deleted.
