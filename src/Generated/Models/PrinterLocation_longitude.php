...
*/
class PrinterLocation_longitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PrinterLocation_longitude and sets the default values.
    */
     ...
     * @return PrinterLocation_longitude
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PrinterLocation_longitude {
        $result = new PrinterLocation_longitude();
