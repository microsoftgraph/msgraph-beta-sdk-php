...
class AzureServerlessFunction extends AzureIdentity implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AzureServerlessFunction {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'resource' => fn(ParseNode $n) => $o->setResource($n->getObjectValue([AzureAuthorizationSystemResource::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
    public function getResource(): ?AzureAuthorizationSystemResource {
        ...
        if (is_null($val) || $val instanceof AzureAuthorizationSystemResource) {
            return $val;
        }
