...
class DriveSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DriveSettings and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DriveSettings {
    ...
    */
    ...
    /**
     * Gets the itemDefaultSensitivityLabelId property value. The ID of the default sensitivity label for items in the drive. Read-only.
     * @return string|null
    */
    ...
    */
    ...
    /**
     * Sets the itemDefaultSensitivityLabelId property value. The ID of the default sensitivity label for items in the drive. Read-only.
