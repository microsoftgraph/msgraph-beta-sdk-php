...
class MeetingInfo implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getAllowConversationWithoutHost(): ?bool {
        $val = $this->getBackingStore()->get('allowConversationWithoutHost');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'allowConversationWithoutHost'");
    }
    ...
    */
    public function setAllowConversationWithoutHost(?bool $value): void {
        $this->getBackingStore()->set('allowConversationWithoutHost', $value);
    }
