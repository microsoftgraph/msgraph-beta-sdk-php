...
class IosVppApp extends MobileApp implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<IosVppAppAssignedLicense>|null $assignedLicenses The licenses assigned to this app.
    */
    ...
    */
    ...
    /**
     * @var array<IosVppAppRevokeLicensesActionResult>|null $revokeLicenseActionResults Results of revoke license actions on this app.
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'assignedLicenses' => function (ParseNode $n) use ($o) { $o->setAssignedLicenses($n->getCollectionOfObjectValues(array(IosVppAppAssignedLicense::class, 'createFromDiscriminatorValue'))); },
            ...
            'revokeLicenseActionResults' => function (ParseNode $n) use ($o) { $o->setRevokeLicenseActionResults($n->getCollectionOfObjectValues(array(IosVppAppRevokeLicensesActionResult::class, 'createFromDiscriminatorValue'))); },
