...
*/
class OutlookGeoCoordinates_longitude implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new OutlookGeoCoordinates_longitude and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OutlookGeoCoordinates_longitude {
        $result = new OutlookGeoCoordinates_longitude();
