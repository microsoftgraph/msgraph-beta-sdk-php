...
class AccessPackageLocalizedText implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getLanguageCode(): ?string {
        $val = $this->getBackingStore()->get('languageCode');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'languageCode'");
    }
