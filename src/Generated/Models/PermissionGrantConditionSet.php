...
class PermissionGrantConditionSet extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $certifiedClientApplicationsOnly Set to true to only match on client applications that are Microsoft 365 certified. Set to false to match on any other client app. Default is false.
    */
    private ?bool $certifiedClientApplicationsOnly = null;
    ...
    */
    public function getCertifiedClientApplicationsOnly(): ?bool {
        return $this->certifiedClientApplicationsOnly;
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'certifiedClientApplicationsOnly' => function (ParseNode $n) use ($o) { $o->setCertifiedClientApplicationsOnly($n->getBooleanValue()); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeBooleanValue('certifiedClientApplicationsOnly', $this->certifiedClientApplicationsOnly);
    ...
    */
     ...
     *  @param bool|null $value Value to set for the certifiedClientApplicationsOnly property.
    */
    public function setCertifiedClientApplicationsOnly(?bool $value ): void {
        $this->certifiedClientApplicationsOnly = $value;
    }
