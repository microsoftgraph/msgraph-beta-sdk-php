...
class SectionMap extends BaseMapFeature implements Parsable 
{
    /**
     * Instantiates a new SectionMap and sets the default values.
    */
     ...
     * @return SectionMap
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SectionMap {
