...
class VirtualAppointmentUser implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $displayName The display name of the user who participates in a virtual appointment. Optional.
    */
    private ?string $displayName = null;
    
    /**
     * @var string|null $emailAddress The email address of the user who participates in a virtual appointment. Optional.
    */
    ...
    */
    ...
    /**
     * @var string|null $smsCapablePhoneNumber The phone number for sending SMS texts for the user who participates in a virtual appointment. Optional.
    */
    private ?string $smsCapablePhoneNumber = null;
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VirtualAppointmentUser {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'smsCapablePhoneNumber' => function (ParseNode $n) use ($o) { $o->setSmsCapablePhoneNumber($n->getStringValue()); },
        ];
    }
    ...
    */
     ...
     * @return string|null
    */
    public function getSmsCapablePhoneNumber(): ?string {
