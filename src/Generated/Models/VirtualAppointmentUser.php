...
class VirtualAppointmentUser implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getSmsCapablePhoneNumber(): ?string {
        $val = $this->getBackingStore()->get('smsCapablePhoneNumber');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'smsCapablePhoneNumber'");
    }
