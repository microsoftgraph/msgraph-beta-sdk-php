...
*/
class EducationAssignmentPointsGrade_points implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EducationAssignmentPointsGrade_points and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EducationAssignmentPointsGrade_points {
        $result = new EducationAssignmentPointsGrade_points();
