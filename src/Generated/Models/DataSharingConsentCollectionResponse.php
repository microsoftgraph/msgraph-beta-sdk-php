...
class DataSharingConsentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DataSharingConsent>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DataSharingConsentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(DataSharingConsent::class)); },
        ];
    }
