...
class VoiceAuthenticationMethodConfiguration extends AuthenticationMethodConfiguration implements Parsable 
{
    ...
    */
    public function getIncludeTargets(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, VoiceAuthenticationMethodTarget::class);
            /** @var array<VoiceAuthenticationMethodTarget>|null $val */
            return $val;
        }
    ...
    */
     ...
     * @param array<VoiceAuthenticationMethodTarget>|null $value Value to set for the includeTargets property.
    */
