...
*/
class SecureScore_maxScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SecureScore_maxScore and sets the default values.
    */
     ...
     * @return SecureScore_maxScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SecureScore_maxScore {
        $result = new SecureScore_maxScore();
