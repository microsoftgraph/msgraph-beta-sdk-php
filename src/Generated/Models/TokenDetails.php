...
class TokenDetails implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TokenDetails and sets the default values.
    */
     ...
     * @return TokenDetails
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TokenDetails {
