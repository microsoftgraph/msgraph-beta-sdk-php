...
class ReferenceValue implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ReferenceValue {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => fn(ParseNode $n) => $o->setValue($n->getObjectValue([ReferenceDefinition::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function getValue(): ?ReferenceDefinition {
        $val = $this->getBackingStore()->get('value');
        if (is_null($val) || $val instanceof ReferenceDefinition) {
            return $val;
        }
    ...
    */
     ...
     * @param ReferenceDefinition|null $value Value to set for the value property.
    */
    public function setValue(?ReferenceDefinition $value): void {
