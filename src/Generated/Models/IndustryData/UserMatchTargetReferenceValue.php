...
class UserMatchTargetReferenceValue extends ReferenceValue implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserMatchTargetReferenceValue {
