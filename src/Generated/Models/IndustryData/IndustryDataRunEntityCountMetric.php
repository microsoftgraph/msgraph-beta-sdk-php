...
class IndustryDataRunEntityCountMetric implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): IndustryDataRunEntityCountMetric {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'inactive' => fn(ParseNode $n) => $o->setInactive($n->getIntegerValue()),
    ...
    */
     ...
     * @param int|null $value Value to set for the inactive property.
    */
    public function setInactive(?int $value): void {
        $this->getBackingStore()->set('inactive', $value);
    }
