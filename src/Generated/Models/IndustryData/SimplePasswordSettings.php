...
class SimplePasswordSettings extends PasswordSettings implements Parsable 
{
    /**
     * Instantiates a new SimplePasswordSettings and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SimplePasswordSettings {
