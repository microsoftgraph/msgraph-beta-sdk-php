...
class FileDataConnector extends IndustryDataConnector implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FileDataConnector {
