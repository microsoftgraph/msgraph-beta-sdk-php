...
class EducationSpeakerCoachContentSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getIsInclusivenessEnabled(): ?bool {
        $val = $this->getBackingStore()->get('isInclusivenessEnabled');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isInclusivenessEnabled'");
    }
    ...
    */
    public function getIsRepetitiveLanguageEnabled(): ?bool {
        $val = $this->getBackingStore()->get('isRepetitiveLanguageEnabled');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isRepetitiveLanguageEnabled'");
    }
    ...
    */
    public function setIsInclusivenessEnabled(?bool $value): void {
        $this->getBackingStore()->set('isInclusivenessEnabled', $value);
    }
    ...
    */
    public function setIsRepetitiveLanguageEnabled(?bool $value): void {
        $this->getBackingStore()->set('isRepetitiveLanguageEnabled', $value);
    }
