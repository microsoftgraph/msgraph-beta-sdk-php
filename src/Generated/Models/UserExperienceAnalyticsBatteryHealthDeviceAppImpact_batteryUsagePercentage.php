...
*/
class UserExperienceAnalyticsBatteryHealthDeviceAppImpact_batteryUsagePercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsBatteryHealthDeviceAppImpact_batteryUsagePercentage and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsBatteryHealthDeviceAppImpact_batteryUsagePercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsBatteryHealthDeviceAppImpact_batteryUsagePercentage {
        $result = new UserExperienceAnalyticsBatteryHealthDeviceAppImpact_batteryUsagePercentage();
