...
class UpdateAllowedCombinationsResult implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<string>|null $currentCombinations The currentCombinations property
    */
    ...
    */
    ...
    /**
     * @var array<string>|null $previousCombinations The previousCombinations property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'currentCombinations' => function (ParseNode $n) use ($o) { $o->setCurrentCombinations($n->getCollectionOfPrimitiveValues()); },
            '@odata.type' => function (ParseNode $n) use ($o) { $o->setOdataType($n->getStringValue()); },
            'previousCombinations' => function (ParseNode $n) use ($o) { $o->setPreviousCombinations($n->getCollectionOfPrimitiveValues()); },
        ];
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeCollectionOfPrimitiveValues('currentCombinations', $this->currentCombinations);
        $writer->writeStringValue('@odata.type', $this->odataType);
        $writer->writeCollectionOfPrimitiveValues('previousCombinations', $this->previousCombinations);
    ...
    */
     ...
     *  @param array<string>|null $value Value to set for the currentCombinations property.
    */
    ...
    */
     ...
     *  @param array<string>|null $value Value to set for the previousCombinations property.
    */
