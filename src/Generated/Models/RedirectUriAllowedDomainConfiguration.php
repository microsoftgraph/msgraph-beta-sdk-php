...
class RedirectUriAllowedDomainConfiguration implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RedirectUriAllowedDomainConfiguration and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RedirectUriAllowedDomainConfiguration {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'publicClient' => fn(ParseNode $n) => $o->setPublicClient($n->getObjectValue([RedirectUriPlatformAllowedDomainConfiguration::class, 'createFromDiscriminatorValue'])),
            'restrictForAppsCreatedAfterDateTime' => fn(ParseNode $n) => $o->setRestrictForAppsCreatedAfterDateTime($n->getDateTimeValue()),
            'spa' => fn(ParseNode $n) => $o->setSpa($n->getObjectValue([RedirectUriPlatformAllowedDomainConfiguration::class, 'createFromDiscriminatorValue'])),
            'state' => fn(ParseNode $n) => $o->setState($n->getEnumValue(AppManagementRestrictionState::class)),
            'web' => fn(ParseNode $n) => $o->setWeb($n->getObjectValue([RedirectUriPlatformAllowedDomainConfiguration::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function getPublicClient(): ?RedirectUriPlatformAllowedDomainConfiguration {
        ...
        if (is_null($val) || $val instanceof RedirectUriPlatformAllowedDomainConfiguration) {
            return $val;
        }
