...
class SignUpIdentity implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SignUpIdentity {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'signUpIdentifier' => fn(ParseNode $n) => $o->setSignUpIdentifier($n->getStringValue()),
            'signUpIdentifierType' => fn(ParseNode $n) => $o->setSignUpIdentifierType($n->getEnumValue(SignUpIdentifierType::class)),
        ];
    }
    ...
    */
    public function getSignUpIdentifier(): ?string {
        $val = $this->getBackingStore()->get('signUpIdentifier');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'signUpIdentifier'");
    }
    ...
    */
    public function getSignUpIdentifierType(): ?SignUpIdentifierType {
        $val = $this->getBackingStore()->get('signUpIdentifierType');
        if (is_null($val) || $val instanceof SignUpIdentifierType) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'signUpIdentifierType'");
    }
    ...
    */
    public function setSignUpIdentifier(?string $value): void {
        $this->getBackingStore()->set('signUpIdentifier', $value);
    }
    ...
    */
    public function setSignUpIdentifierType(?SignUpIdentifierType $value): void {
        $this->getBackingStore()->set('signUpIdentifierType', $value);
    }
