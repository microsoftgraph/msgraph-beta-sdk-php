...
*/
class DeviceInfo_micGlitchRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_micGlitchRate and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_micGlitchRate {
        $result = new DeviceInfo_micGlitchRate();
