...
*/
class MediaStream_postForwardErrorCorrectionPacketLossRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_postForwardErrorCorrectionPacketLossRate and sets the default values.
    */
     ...
     * @return MediaStream_postForwardErrorCorrectionPacketLossRate
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_postForwardErrorCorrectionPacketLossRate {
        $result = new MediaStream_postForwardErrorCorrectionPacketLossRate();
