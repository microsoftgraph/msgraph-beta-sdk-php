...
class CallLogRow implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CallLogRow and sets the default values.
    */
     ...
     * @return CallLogRow
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CallLogRow {
