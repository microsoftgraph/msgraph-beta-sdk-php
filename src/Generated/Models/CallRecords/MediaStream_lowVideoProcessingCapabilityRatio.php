...
*/
class MediaStream_lowVideoProcessingCapabilityRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_lowVideoProcessingCapabilityRatio and sets the default values.
    */
     ...
     * @return MediaStream_lowVideoProcessingCapabilityRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_lowVideoProcessingCapabilityRatio {
        $result = new MediaStream_lowVideoProcessingCapabilityRatio();
