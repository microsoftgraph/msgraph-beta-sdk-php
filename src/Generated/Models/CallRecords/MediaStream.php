...
class MediaStream implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            'averageAudioDegradation' => function (self $o, ParseNode $n) { $o->setAverageAudioDegradation($n->getFloatValue()); },
            'averageAudioNetworkJitter' => function (self $o, ParseNode $n) { $o->setAverageAudioNetworkJitter($n->getDateIntervalValue()); },
            'averageBandwidthEstimate' => function (self $o, ParseNode $n) { $o->setAverageBandwidthEstimate($n->getIntegerValue()); },
            'averageJitter' => function (self $o, ParseNode $n) { $o->setAverageJitter($n->getDateIntervalValue()); },
            'averagePacketLossRate' => function (self $o, ParseNode $n) { $o->setAveragePacketLossRate($n->getFloatValue()); },
            'averageRatioOfConcealedSamples' => function (self $o, ParseNode $n) { $o->setAverageRatioOfConcealedSamples($n->getFloatValue()); },
            'averageReceivedFrameRate' => function (self $o, ParseNode $n) { $o->setAverageReceivedFrameRate($n->getFloatValue()); },
            'averageRoundTripTime' => function (self $o, ParseNode $n) { $o->setAverageRoundTripTime($n->getDateIntervalValue()); },
            'averageVideoFrameLossPercentage' => function (self $o, ParseNode $n) { $o->setAverageVideoFrameLossPercentage($n->getFloatValue()); },
            'averageVideoFrameRate' => function (self $o, ParseNode $n) { $o->setAverageVideoFrameRate($n->getFloatValue()); },
            'averageVideoPacketLossRate' => function (self $o, ParseNode $n) { $o->setAverageVideoPacketLossRate($n->getFloatValue()); },
            'endDateTime' => function (self $o, ParseNode $n) { $o->setEndDateTime($n->getDateTimeValue()); },
            'lowFrameRateRatio' => function (self $o, ParseNode $n) { $o->setLowFrameRateRatio($n->getFloatValue()); },
            'lowVideoProcessingCapabilityRatio' => function (self $o, ParseNode $n) { $o->setLowVideoProcessingCapabilityRatio($n->getFloatValue()); },
            'maxAudioNetworkJitter' => function (self $o, ParseNode $n) { $o->setMaxAudioNetworkJitter($n->getDateIntervalValue()); },
            'maxJitter' => function (self $o, ParseNode $n) { $o->setMaxJitter($n->getDateIntervalValue()); },
            'maxPacketLossRate' => function (self $o, ParseNode $n) { $o->setMaxPacketLossRate($n->getFloatValue()); },
            'maxRatioOfConcealedSamples' => function (self $o, ParseNode $n) { $o->setMaxRatioOfConcealedSamples($n->getFloatValue()); },
            'maxRoundTripTime' => function (self $o, ParseNode $n) { $o->setMaxRoundTripTime($n->getDateIntervalValue()); },
            'packetUtilization' => function (self $o, ParseNode $n) { $o->setPacketUtilization($n->getIntegerValue()); },
            'postForwardErrorCorrectionPacketLossRate' => function (self $o, ParseNode $n) { $o->setPostForwardErrorCorrectionPacketLossRate($n->getFloatValue()); },
            'startDateTime' => function (self $o, ParseNode $n) { $o->setStartDateTime($n->getDateTimeValue()); },
            'streamDirection' => function (self $o, ParseNode $n) { $o->setStreamDirection($n->getEnumValue(MediaStreamDirection::class)); },
            'streamId' => function (self $o, ParseNode $n) { $o->setStreamId($n->getStringValue()); },
            'wasMediaBypassed' => function (self $o, ParseNode $n) { $o->setWasMediaBypassed($n->getBooleanValue()); },
        ];
    }
