...
*/
class MediaStream_averageRatioOfConcealedSamples implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_averageRatioOfConcealedSamples and sets the default values.
    */
     ...
     * @return MediaStream_averageRatioOfConcealedSamples
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_averageRatioOfConcealedSamples {
        $result = new MediaStream_averageRatioOfConcealedSamples();
