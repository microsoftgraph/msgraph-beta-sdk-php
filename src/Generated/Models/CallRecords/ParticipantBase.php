...
class ParticipantBase extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * Gets the administrativeUnitInfos property value. List of administrativeUnitInfo of the call participant.
    ...
    */
    ...
    /**
     * Sets the administrativeUnitInfos property value. List of administrativeUnitInfo of the call participant.
