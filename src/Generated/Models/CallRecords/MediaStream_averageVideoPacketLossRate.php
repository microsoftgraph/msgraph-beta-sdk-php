...
*/
class MediaStream_averageVideoPacketLossRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_averageVideoPacketLossRate and sets the default values.
    */
     ...
     * @return MediaStream_averageVideoPacketLossRate
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_averageVideoPacketLossRate {
        $result = new MediaStream_averageVideoPacketLossRate();
