...
*/
class MediaStream_averageVideoFrameRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_averageVideoFrameRate and sets the default values.
    */
     ...
     * @return MediaStream_averageVideoFrameRate
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_averageVideoFrameRate {
        $result = new MediaStream_averageVideoFrameRate();
