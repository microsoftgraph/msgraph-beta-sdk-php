...
*/
class DeviceInfo_renderMuteEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_renderMuteEventRatio and sets the default values.
    */
     ...
     * @return DeviceInfo_renderMuteEventRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_renderMuteEventRatio {
        $result = new DeviceInfo_renderMuteEventRatio();
