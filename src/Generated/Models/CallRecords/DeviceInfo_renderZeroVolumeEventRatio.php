...
*/
class DeviceInfo_renderZeroVolumeEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_renderZeroVolumeEventRatio and sets the default values.
    */
     ...
     * @return DeviceInfo_renderZeroVolumeEventRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_renderZeroVolumeEventRatio {
