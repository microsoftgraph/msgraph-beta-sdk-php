...
*/
class MediaStream_averageReceivedFrameRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_averageReceivedFrameRate and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_averageReceivedFrameRate {
        $result = new MediaStream_averageReceivedFrameRate();
