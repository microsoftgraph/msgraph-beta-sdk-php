...
*/
class DeviceInfo_lowSpeechToNoiseEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_lowSpeechToNoiseEventRatio and sets the default values.
    */
     ...
     * @return DeviceInfo_lowSpeechToNoiseEventRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_lowSpeechToNoiseEventRatio {
        $result = new DeviceInfo_lowSpeechToNoiseEventRatio();
