...
*/
class DeviceInfo_deviceClippingEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_deviceClippingEventRatio and sets the default values.
    */
     ...
     * @return DeviceInfo_deviceClippingEventRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_deviceClippingEventRatio {
        $result = new DeviceInfo_deviceClippingEventRatio();
