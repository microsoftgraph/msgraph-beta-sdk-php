...
*/
class MediaStream_lowFrameRateRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_lowFrameRateRatio and sets the default values.
    */
     ...
     * @return MediaStream_lowFrameRateRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_lowFrameRateRatio {
        $result = new MediaStream_lowFrameRateRatio();
