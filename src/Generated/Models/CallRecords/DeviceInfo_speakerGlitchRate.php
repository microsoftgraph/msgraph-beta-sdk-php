...
*/
class DeviceInfo_speakerGlitchRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceInfo_speakerGlitchRate and sets the default values.
    */
     ...
     * @return DeviceInfo_speakerGlitchRate
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInfo_speakerGlitchRate {
        $result = new DeviceInfo_speakerGlitchRate();
