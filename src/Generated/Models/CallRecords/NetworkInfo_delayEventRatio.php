...
*/
class NetworkInfo_delayEventRatio implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new NetworkInfo_delayEventRatio and sets the default values.
    */
     ...
     * @return NetworkInfo_delayEventRatio
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): NetworkInfo_delayEventRatio {
        $result = new NetworkInfo_delayEventRatio();
