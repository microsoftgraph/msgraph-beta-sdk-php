...
*/
class MediaStream_maxPacketLossRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_maxPacketLossRate and sets the default values.
    */
     ...
     * @return MediaStream_maxPacketLossRate
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_maxPacketLossRate {
        $result = new MediaStream_maxPacketLossRate();
