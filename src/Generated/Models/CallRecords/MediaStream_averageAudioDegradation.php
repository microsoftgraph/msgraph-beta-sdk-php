...
*/
class MediaStream_averageAudioDegradation implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_averageAudioDegradation and sets the default values.
    */
     ...
     * @return MediaStream_averageAudioDegradation
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_averageAudioDegradation {
        $result = new MediaStream_averageAudioDegradation();
