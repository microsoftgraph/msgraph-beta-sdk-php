...
*/
class MediaStream_maxRatioOfConcealedSamples implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MediaStream_maxRatioOfConcealedSamples and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MediaStream_maxRatioOfConcealedSamples {
        $result = new MediaStream_maxRatioOfConcealedSamples();
