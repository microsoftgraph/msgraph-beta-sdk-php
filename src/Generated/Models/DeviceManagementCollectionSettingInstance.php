...
class DeviceManagementCollectionSettingInstance extends DeviceManagementSettingInstance implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementCollectionSettingInstance {
