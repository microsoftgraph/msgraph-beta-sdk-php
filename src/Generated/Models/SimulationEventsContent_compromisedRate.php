...
*/
class SimulationEventsContent_compromisedRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SimulationEventsContent_compromisedRate and sets the default values.
    */
     ...
     * @return SimulationEventsContent_compromisedRate
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SimulationEventsContent_compromisedRate {
        $result = new SimulationEventsContent_compromisedRate();
