...
class PlannerTaskChatMention implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PlannerTaskChatMention and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PlannerTaskChatMention {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'mentioned' => fn(ParseNode $n) => $o->setMentioned($n->getStringValue()),
            'mentionType' => fn(ParseNode $n) => $o->setMentionType($n->getEnumValue(PlannerTaskChatMentionType::class)),
    ...
    */
     ...
     * @return PlannerTaskChatMentionType|null
    */
    public function getMentionType(): ?PlannerTaskChatMentionType {
        $val = $this->getBackingStore()->get('mentionType');
        if (is_null($val) || $val instanceof PlannerTaskChatMentionType) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'mentionType'");
    }
    ...
    */
     ...
     * @param string|null $value Value to set for the mentioned property.
    */
    public function setMentioned(?string $value): void {
        $this->getBackingStore()->set('mentioned', $value);
    }

    /**
     * Sets the mentionType property value. The mentionType property
     * @param PlannerTaskChatMentionType|null $value Value to set for the mentionType property.
    */
    public function setMentionType(?PlannerTaskChatMentionType $value): void {
        $this->getBackingStore()->set('mentionType', $value);
    }
