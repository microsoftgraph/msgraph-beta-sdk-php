...
class WindowsUniversalAppX extends MobileLobApp implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<MobileContainedApp>|null $committedContainedApps The collection of contained apps in the committed mobileAppContent of a windowsUniversalAppX app.
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'committedContainedApps' => function (ParseNode $n) use ($o) { $o->setCommittedContainedApps($n->getCollectionOfObjectValues(array(MobileContainedApp::class, 'createFromDiscriminatorValue'))); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeCollectionOfObjectValues('committedContainedApps', $this->committedContainedApps);
