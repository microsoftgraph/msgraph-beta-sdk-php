...
class TargetPolicyEndpoints implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'platformTypes' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setPlatformTypes($val);
            },
        ];
    }
    ...
    */
    public function getPlatformTypes(): ?array {
        $val = $this->getBackingStore()->get('platformTypes');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'platformTypes'");
    }
    ...
    */
    public function setPlatformTypes(?array $value): void {
        $this->getBackingStore()->set('platformTypes', $value);
    }
