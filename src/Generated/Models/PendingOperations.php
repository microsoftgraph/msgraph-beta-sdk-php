...
class PendingOperations implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getPendingContentUpdate(): ?PendingContentUpdate {
        $val = $this->getBackingStore()->get('pendingContentUpdate');
        if (is_null($val) || $val instanceof PendingContentUpdate) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'pendingContentUpdate'");
    }
