...
*/
class RecommendationBase_maxScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RecommendationBase_maxScore and sets the default values.
    */
     ...
     * @return RecommendationBase_maxScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RecommendationBase_maxScore {
        $result = new RecommendationBase_maxScore();
