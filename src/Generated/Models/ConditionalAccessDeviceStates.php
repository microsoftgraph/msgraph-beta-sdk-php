...
class ConditionalAccessDeviceStates implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getExcludeStates(): ?array {
        $val = $this->getBackingStore()->get('excludeStates');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'excludeStates'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'excludeStates' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setExcludeStates($val);
            },
            'includeStates' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setIncludeStates($val);
            },
    ...
    */
    public function getIncludeStates(): ?array {
        $val = $this->getBackingStore()->get('includeStates');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'includeStates'");
    }
