...
class MailFolder extends Entity implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'userConfigurations' => fn(ParseNode $n) => $o->setUserConfigurations($n->getCollectionOfObjectValues([UserConfiguration::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function getUserConfigurations(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, UserConfiguration::class);
            /** @var array<UserConfiguration>|null $val */
            return $val;
        }
