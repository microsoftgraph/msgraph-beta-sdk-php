...
class MailFolder extends Entity 
{
    ...
    /** @var array<UserConfiguration>|null $userConfigurations The userConfigurations property */
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'userConfigurations' => function (self $o, ParseNode $n) { $o->setUserConfigurations($n->getCollectionOfObjectValues(UserConfiguration::class)); },
            'wellKnownName' => function (self $o, ParseNode $n) { $o->setWellKnownName($n->getStringValue()); },
        ]);
    }
