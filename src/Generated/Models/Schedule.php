    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'timeCards' => function (self $o, ParseNode $n) { $o->setTimeCards($n->getCollectionOfObjectValues(TimeCard::class)); },
            'timeClockEnabled' => function (self $o, ParseNode $n) { $o->setTimeClockEnabled($n->getBooleanValue()); },
            'timeClockSettings' => function (self $o, ParseNode $n) { $o->setTimeClockSettings($n->getObjectValue(TimeClockSettings::class)); },
