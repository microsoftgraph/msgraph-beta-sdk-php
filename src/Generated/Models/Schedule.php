...
class Schedule extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<TimeCard>|null $timeCards The timeCards property
    */
    ...
    */
    ...
    /**
     * @var TimeClockSettings|null $timeClockSettings The timeClockSettings property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'timeCards' => function (ParseNode $n) use ($o) { $o->setTimeCards($n->getCollectionOfObjectValues(array(TimeCard::class, 'createFromDiscriminatorValue'))); },
            'timeClockEnabled' => function (ParseNode $n) use ($o) { $o->setTimeClockEnabled($n->getBooleanValue()); },
            'timeClockSettings' => function (ParseNode $n) use ($o) { $o->setTimeClockSettings($n->getObjectValue(array(TimeClockSettings::class, 'createFromDiscriminatorValue'))); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeCollectionOfObjectValues('timeCards', $this->timeCards);
        $writer->writeBooleanValue('timeClockEnabled', $this->timeClockEnabled);
        $writer->writeObjectValue('timeClockSettings', $this->timeClockSettings);
