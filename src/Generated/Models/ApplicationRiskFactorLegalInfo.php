...
class ApplicationRiskFactorLegalInfo implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getDataRetention(): ?DataRetentionLevel {
        $val = $this->getBackingStore()->get('dataRetention');
        if (is_null($val) || $val instanceof DataRetentionLevel) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'dataRetention'");
    }
    ...
    */
    public function getGdpr(): ?ApplicationRiskFactorLegalInfoGdpr {
        $val = $this->getBackingStore()->get('gdpr');
        if (is_null($val) || $val instanceof ApplicationRiskFactorLegalInfoGdpr) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'gdpr'");
    }
    ...
    */
    public function getHasDataOwnership(): ?bool {
        $val = $this->getBackingStore()->get('hasDataOwnership');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'hasDataOwnership'");
    }
    ...
    */
    public function getHasDmca(): ?bool {
        $val = $this->getBackingStore()->get('hasDmca');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'hasDmca'");
    }
    ...
    */
    public function setDataRetention(?DataRetentionLevel $value): void {
        $this->getBackingStore()->set('dataRetention', $value);
    }
    ...
    */
    public function setGdpr(?ApplicationRiskFactorLegalInfoGdpr $value): void {
        $this->getBackingStore()->set('gdpr', $value);
    }
    ...
    */
    public function setHasDataOwnership(?bool $value): void {
        $this->getBackingStore()->set('hasDataOwnership', $value);
    }
    ...
    */
    public function setHasDmca(?bool $value): void {
        $this->getBackingStore()->set('hasDmca', $value);
    }
