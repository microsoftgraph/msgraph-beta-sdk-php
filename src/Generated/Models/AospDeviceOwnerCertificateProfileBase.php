...
class AospDeviceOwnerCertificateProfileBase extends DeviceConfiguration implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AospDeviceOwnerCertificateProfileBase {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'rootCertificate' => function (ParseNode $n) use ($o) { $o->setRootCertificate($n->getObjectValue(array(AospDeviceOwnerTrustedRootCertificate::class, 'createFromDiscriminatorValue'))); },
