...
*/
class PartnerSecurityScore_currentScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PartnerSecurityScore_currentScore and sets the default values.
    */
     ...
     * @return PartnerSecurityScore_currentScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PartnerSecurityScore_currentScore {
        $result = new PartnerSecurityScore_currentScore();
