...
use Microsoft\Graph\Beta\Generated\Models\ReferenceNumeric;
...
*/
class ResponseTimeSecurityRequirement_averageResponseTimeInHours implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ResponseTimeSecurityRequirement_averageResponseTimeInHours and sets the default values.
    */
     ...
     * @return ResponseTimeSecurityRequirement_averageResponseTimeInHours
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ResponseTimeSecurityRequirement_averageResponseTimeInHours {
        $result = new ResponseTimeSecurityRequirement_averageResponseTimeInHours();
