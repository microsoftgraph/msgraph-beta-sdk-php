...
*/
class SecurityScoreHistory_score implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SecurityScoreHistory_score and sets the default values.
    */
     ...
     * @return SecurityScoreHistory_score
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SecurityScoreHistory_score {
        $result = new SecurityScoreHistory_score();
