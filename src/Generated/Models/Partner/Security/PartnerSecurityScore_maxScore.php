...
*/
class PartnerSecurityScore_maxScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PartnerSecurityScore_maxScore and sets the default values.
    */
     ...
     * @return PartnerSecurityScore_maxScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PartnerSecurityScore_maxScore {
        $result = new PartnerSecurityScore_maxScore();
