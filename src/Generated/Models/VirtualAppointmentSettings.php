...
class VirtualAppointmentSettings implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $allowClientToJoinUsingBrowser Indicates whether the client can use the browser to join a virtual appointment. If set to false, the client can only use Microsoft Teams to join. Optional.
    */
    private ?bool $allowClientToJoinUsingBrowser = null;
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VirtualAppointmentSettings {
    ...
    */
     ...
     * @return bool|null
    */
    public function getAllowClientToJoinUsingBrowser(): ?bool {
        return $this->allowClientToJoinUsingBrowser;
    }
    ...
    */
     ...
     *  @param bool|null $value Value to set for the allowClientToJoinUsingBrowser property.
    */
    public function setAllowClientToJoinUsingBrowser(?bool $value ): void {
        $this->allowClientToJoinUsingBrowser = $value;
    }
