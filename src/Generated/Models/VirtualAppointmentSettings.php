...
class VirtualAppointmentSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getAllowClientToJoinUsingBrowser(): ?bool {
        $val = $this->getBackingStore()->get('allowClientToJoinUsingBrowser');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'allowClientToJoinUsingBrowser'");
    }
    ...
    */
    public function setAllowClientToJoinUsingBrowser(?bool $value): void {
        $this->getBackingStore()->set('allowClientToJoinUsingBrowser', $value);
    }
