...
class MailboxItemImportSession implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MailboxItemImportSession {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'importUrl' => fn(ParseNode $n) => $o->setImportUrl($n->getStringValue()),
    ...
    */
    public function getImportUrl(): ?string {
        $val = $this->getBackingStore()->get('importUrl');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'importUrl'");
    }
    ...
    */
    public function setImportUrl(?string $value): void {
        $this->getBackingStore()->set('importUrl', $value);
    }
