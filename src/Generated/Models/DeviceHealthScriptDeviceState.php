...
class DeviceHealthScriptDeviceState extends Entity 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceHealthScriptDeviceState {
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'postRemediationDetectionScriptError' => function (self $o, ParseNode $n) { $o->setPostRemediationDetectionScriptError($n->getStringValue()); },
            'postRemediationDetectionScriptOutput' => function (self $o, ParseNode $n) { $o->setPostRemediationDetectionScriptOutput($n->getStringValue()); },
            'preRemediationDetectionScriptError' => function (self $o, ParseNode $n) { $o->setPreRemediationDetectionScriptError($n->getStringValue()); },
            'preRemediationDetectionScriptOutput' => function (self $o, ParseNode $n) { $o->setPreRemediationDetectionScriptOutput($n->getStringValue()); },
            'remediationScriptError' => function (self $o, ParseNode $n) { $o->setRemediationScriptError($n->getStringValue()); },
            'remediationState' => function (self $o, ParseNode $n) { $o->setRemediationState($n->getEnumValue(RemediationState::class)); },
        ]);
    }
