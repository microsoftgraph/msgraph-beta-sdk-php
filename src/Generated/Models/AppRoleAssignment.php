...
class AppRoleAssignment extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeDateTimeValue('creationTimestamp', $this->creationTimestamp);
    ...
    */
     ...
     *  @param DateTime|null $value Value to set for the creationTimestamp property.
    */
