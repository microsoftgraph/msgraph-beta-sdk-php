...
class VerifiableCredentialVerified extends VerifiableCredentialRequirementStatus implements Parsable 
{
    ...
    */
    public function __construct() {
        parent::__construct();
        $this->setOdataType('#microsoft.graph.verifiableCredentialVerified');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VerifiableCredentialVerified {
