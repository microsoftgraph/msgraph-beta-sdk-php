...
class AospDeviceOwnerEnterpriseWiFiConfiguration extends AospDeviceOwnerWiFiConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var AospDeviceOwnerCertificateProfileBase|null $identityCertificateForClientAuthentication Identity Certificate for client authentication when EAP Type is configured to EAP-TLS, EAP-TTLS (with Certificate Authentication), or PEAP (with Certificate Authentication). This is the certificate presented by client to the Wi-Fi endpoint. The authentication server sitting behind the Wi-Fi endpoint must accept this certificate to successfully establish a Wi-Fi connection.
    */
    private ?AospDeviceOwnerCertificateProfileBase $identityCertificateForClientAuthentication = null;
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'identityCertificateForClientAuthentication' => function (ParseNode $n) use ($o) { $o->setIdentityCertificateForClientAuthentication($n->getObjectValue(array(AospDeviceOwnerCertificateProfileBase::class, 'createFromDiscriminatorValue'))); },
            ...
            'rootCertificateForServerValidation' => function (ParseNode $n) use ($o) { $o->setRootCertificateForServerValidation($n->getObjectValue(array(AospDeviceOwnerTrustedRootCertificate::class, 'createFromDiscriminatorValue'))); },
