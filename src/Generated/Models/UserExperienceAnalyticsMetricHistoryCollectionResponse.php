...
class UserExperienceAnalyticsMetricHistoryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<UserExperienceAnalyticsMetricHistory>|null $value The value property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(UserExperienceAnalyticsMetricHistory::class, 'createFromDiscriminatorValue'))); },
        ];
    }
