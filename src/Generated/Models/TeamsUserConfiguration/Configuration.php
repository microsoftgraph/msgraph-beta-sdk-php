...
namespace Microsoft\Graph\Beta\Generated\Models\TeamsUserConfiguration;
...
class Configuration implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getAuthorizedAppIds(): ?array {
        $val = $this->getBackingStore()->get('authorizedAppIds');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'authorizedAppIds'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'authorizedAppIds' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setAuthorizedAppIds($val);
            },
            'authorizedApps' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setAuthorizedApps($val);
            },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeCollectionOfPrimitiveValues('authorizedApps', $this->getAuthorizedApps());
    ...
    */
    public function setAuthorizedAppIds(?array $value): void {
        $this->getBackingStore()->set('authorizedAppIds', $value);
    }
