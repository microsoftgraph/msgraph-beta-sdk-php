...
class GovernanceInsightCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<GovernanceInsight>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GovernanceInsightCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(GovernanceInsight::class)); },
        ];
    }
