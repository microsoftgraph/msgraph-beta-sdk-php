...
class ReviewSetQueryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<ReviewSetQuery>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ReviewSetQueryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(ReviewSetQuery::class, 'createFromDiscriminatorValue'))); },
        ];
    }
    ...
    */
     ...
     *  @param array<ReviewSetQuery>|null $value Value to set for the value property.
    */
