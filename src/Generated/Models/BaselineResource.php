...
class BaselineResource implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new BaselineResource and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): BaselineResource {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'properties' => fn(ParseNode $n) => $o->setProperties($n->getObjectValue([OpenComplexDictionaryType::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function getProperties(): ?OpenComplexDictionaryType {
    ...
    */
     ...
     * @param OpenComplexDictionaryType|null $value Value to set for the properties property.
    */
    public function setProperties(?OpenComplexDictionaryType $value): void {
