...
/**
 * Choice Setting Value Constant Default Template Original name: deviceManagementConfigurationChoiceSettingValueConstantDefaultTemplate
*/
class DeviceManagementConfigurationChoiceSettingValueConstant_c93bdeb8 extends DeviceManagementConfigurationChoiceSettingValueDefaultTemplate implements Parsable 
{
    /**
     * Instantiates a new DeviceManagementConfigurationChoiceSettingValueConstant_c93bdeb8 and sets the default values.
    */
     ...
     * @return DeviceManagementConfigurationChoiceSettingValueConstant_c93bdeb8
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementConfigurationChoiceSettingValueConstant_c93bdeb8 {
        return new DeviceManagementConfigurationChoiceSettingValueConstant_c93bdeb8();
    }
