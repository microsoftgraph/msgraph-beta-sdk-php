...
class DeviceOperatingSystemSummary implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getAospUserAssociatedCount(): ?int {
        $val = $this->getBackingStore()->get('aospUserAssociatedCount');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'aospUserAssociatedCount'");
    }
    ...
    */
    public function getAospUserlessCount(): ?int {
        $val = $this->getBackingStore()->get('aospUserlessCount');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'aospUserlessCount'");
    }
    ...
    */
    public function getChromeOSCount(): ?int {
        $val = $this->getBackingStore()->get('chromeOSCount');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'chromeOSCount'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'aospUserAssociatedCount' => fn(ParseNode $n) => $o->setAospUserAssociatedCount($n->getIntegerValue()),
            'aospUserlessCount' => fn(ParseNode $n) => $o->setAospUserlessCount($n->getIntegerValue()),
            'chromeOSCount' => fn(ParseNode $n) => $o->setChromeOSCount($n->getIntegerValue()),
            ...
            'linuxCount' => fn(ParseNode $n) => $o->setLinuxCount($n->getIntegerValue()),
    ...
    */
    public function getLinuxCount(): ?int {
        $val = $this->getBackingStore()->get('linuxCount');
        if (is_null($val) || is_int($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'linuxCount'");
    }
    ...
    */
    public function setAospUserAssociatedCount(?int $value): void {
        $this->getBackingStore()->set('aospUserAssociatedCount', $value);
    }
    ...
    */
    public function setChromeOSCount(?int $value): void {
        $this->getBackingStore()->set('chromeOSCount', $value);
    }
    ...
    */
    public function setLinuxCount(?int $value): void {
        $this->getBackingStore()->set('linuxCount', $value);
    }
