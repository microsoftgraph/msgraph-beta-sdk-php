...
class LoggedOnUser implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'lastLogOnDateTime' => fn(ParseNode $n) => $o->setLastLogOnDateTime($n->getDateTimeValue()),
    ...
    */
    public function getLastLogOnDateTime(): ?DateTime {
        $val = $this->getBackingStore()->get('lastLogOnDateTime');
        if (is_null($val) || $val instanceof DateTime) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'lastLogOnDateTime'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeDateTimeValue('lastLogOnDateTime', $this->getLastLogOnDateTime());
    ...
    */
    public function setLastLogOnDateTime(?DateTime $value): void {
        $this->getBackingStore()->set('lastLogOnDateTime', $value);
    }
