...
class AndroidDeviceOwnerTrustedRootCertificate extends DeviceConfiguration implements Parsable 
{
    /**
    ...
    */
    public function __construct() {
        parent::__construct();
        $this->setOdataType('#microsoft.graph.androidDeviceOwnerTrustedRootCertificate');
    }
