...
class AndroidCertificateProfileBase extends DeviceConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var AndroidTrustedRootCertificate|null $rootCertificate Trusted Root Certificate.
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'rootCertificate' => function (ParseNode $n) use ($o) { $o->setRootCertificate($n->getObjectValue(array(AndroidTrustedRootCertificate::class, 'createFromDiscriminatorValue'))); },
