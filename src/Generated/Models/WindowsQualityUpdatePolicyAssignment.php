...
*/
class WindowsQualityUpdatePolicyAssignment extends Entity implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WindowsQualityUpdatePolicyAssignment {
