...
class SecureSignInSessionControl extends ConditionalAccessSessionControl implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SecureSignInSessionControl {
