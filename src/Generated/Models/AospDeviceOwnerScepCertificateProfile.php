...
class AospDeviceOwnerScepCertificateProfile extends AospDeviceOwnerCertificateProfileBase implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var CertificateStore|null $certificateStore Target store certificate. This collection can contain a maximum of 500 elements. Possible values are: user, machine.
    */
