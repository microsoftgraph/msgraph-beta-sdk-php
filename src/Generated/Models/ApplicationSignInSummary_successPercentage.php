...
*/
class ApplicationSignInSummary_successPercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ApplicationSignInSummary_successPercentage and sets the default values.
    */
     ...
     * @return ApplicationSignInSummary_successPercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApplicationSignInSummary_successPercentage {
        $result = new ApplicationSignInSummary_successPercentage();
