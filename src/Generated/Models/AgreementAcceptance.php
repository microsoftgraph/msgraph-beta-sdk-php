...
class AgreementAcceptance extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var DateTime|null $recordedDateTime The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Supports $filter (eq) and eq for null values.
    */
    ...
    */
    ...
    /**
     * @var string|null $userId ID of the user who accepted the agreement. Supports $filter (eq).
    */
