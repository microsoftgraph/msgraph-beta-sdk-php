...
class SalesOrderLine extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $invoicedQuantity The invoicedQuantity property
    */
    private ?string $invoicedQuantity = null;
    
    /**
     * @var string|null $invoiceQuantity The invoiceQuantity property
    */
    private ?string $invoiceQuantity = null;
    ...
    */
    ...
    /**
     * @var string|null $shippedQuantity The shippedQuantity property
    */
    private ?string $shippedQuantity = null;
    
    /**
     * @var string|null $shipQuantity The shipQuantity property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'invoicedQuantity' => function (ParseNode $n) use ($o) { $o->setInvoicedQuantity($n->getStringValue()); },
            'invoiceQuantity' => function (ParseNode $n) use ($o) { $o->setInvoiceQuantity($n->getStringValue()); },
            ...
            'shippedQuantity' => function (ParseNode $n) use ($o) { $o->setShippedQuantity($n->getStringValue()); },
            'shipQuantity' => function (ParseNode $n) use ($o) { $o->setShipQuantity($n->getStringValue()); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeStringValue('invoicedQuantity', $this->invoicedQuantity);
        $writer->writeStringValue('invoiceQuantity', $this->invoiceQuantity);
        ...
        $writer->writeStringValue('shippedQuantity', $this->shippedQuantity);
        $writer->writeStringValue('shipQuantity', $this->shipQuantity);
