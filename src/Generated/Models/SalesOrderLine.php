...
class SalesOrderLine extends Entity implements Parsable 
{
    ...
    */
    public function getInvoicedQuantity(): ?string {
        $val = $this->getBackingStore()->get('invoicedQuantity');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'invoicedQuantity'");
    }
    ...
    */
    public function getInvoiceQuantity(): ?string {
        $val = $this->getBackingStore()->get('invoiceQuantity');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'invoiceQuantity'");
    }
    ...
    */
    public function getShippedQuantity(): ?string {
        $val = $this->getBackingStore()->get('shippedQuantity');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'shippedQuantity'");
    }
    ...
    */
    public function getShipQuantity(): ?string {
        $val = $this->getBackingStore()->get('shipQuantity');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'shipQuantity'");
    }
