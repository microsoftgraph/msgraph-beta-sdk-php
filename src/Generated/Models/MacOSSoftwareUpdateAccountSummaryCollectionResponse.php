...
class MacOSSoftwareUpdateAccountSummaryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MacOSSoftwareUpdateAccountSummaryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(MacOSSoftwareUpdateAccountSummary::class)); },
        ];
    }
