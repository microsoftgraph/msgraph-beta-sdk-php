...
class RequiredResourceAccess implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'permissions' => fn(ParseNode $n) => $o->setPermissions($n->getCollectionOfObjectValues([ResourcePermission::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function getPermissions(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, ResourcePermission::class);
            /** @var array<ResourcePermission>|null $val */
            return $val;
        }
    ...
    */
     ...
     * @param array<ResourcePermission>|null $value Value to set for the permissions property.
    */
