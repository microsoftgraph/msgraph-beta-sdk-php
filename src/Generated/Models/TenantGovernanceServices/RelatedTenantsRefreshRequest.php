...
class RelatedTenantsRefreshRequest extends Entity implements Parsable 
{
    /**
     * Instantiates a new RelatedTenantsRefreshRequest and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RelatedTenantsRefreshRequest {
