...
class ResourcePermission implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'type' => fn(ParseNode $n) => $o->setType($n->getEnumValue(PermissionType::class)),
        ];
    }
    ...
    */
     ...
     * @param PermissionType|null $value Value to set for the type property.
    */
    public function setType(?PermissionType $value): void {
