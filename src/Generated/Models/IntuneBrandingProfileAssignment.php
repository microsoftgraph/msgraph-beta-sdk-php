...
class IntuneBrandingProfileAssignment extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var DeviceAndAppManagementAssignmentTarget|null $target Assignment target that the branding profile is assigned to.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): IntuneBrandingProfileAssignment {
