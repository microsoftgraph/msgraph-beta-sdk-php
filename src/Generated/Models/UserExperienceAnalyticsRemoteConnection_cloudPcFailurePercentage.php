...
*/
class UserExperienceAnalyticsRemoteConnection_cloudPcFailurePercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsRemoteConnection_cloudPcFailurePercentage and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsRemoteConnection_cloudPcFailurePercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsRemoteConnection_cloudPcFailurePercentage {
        $result = new UserExperienceAnalyticsRemoteConnection_cloudPcFailurePercentage();
