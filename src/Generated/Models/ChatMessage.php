...
class ChatMessage extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'onBehalfOf' => function (ParseNode $n) use ($o) { $o->setOnBehalfOf($n->getObjectValue(array(ChatMessageFromIdentitySet::class, 'createFromDiscriminatorValue'))); },
