...
class UnitOfMeasure implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'internationalStandardCode' => fn(ParseNode $n) => $o->setInternationalStandardCode($n->getStringValue()),
    ...
    */
    public function getInternationalStandardCode(): ?string {
        $val = $this->getBackingStore()->get('internationalStandardCode');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'internationalStandardCode'");
    }
    ...
    */
    public function setInternationalStandardCode(?string $value): void {
        $this->getBackingStore()->set('internationalStandardCode', $value);
    }
