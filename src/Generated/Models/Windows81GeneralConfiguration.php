...
class Windows81GeneralConfiguration extends DeviceConfiguration implements Parsable 
{
    ...
    */
    public function getMinimumAutoInstallClassification(): ?UpdateClassification {
        $val = $this->getBackingStore()->get('minimumAutoInstallClassification');
        if (is_null($val) || $val instanceof UpdateClassification) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'minimumAutoInstallClassification'");
    }
    ...
    */
    public function getUpdatesMinimumAutoInstallClassification(): ?UpdateClassification {
        $val = $this->getBackingStore()->get('updatesMinimumAutoInstallClassification');
        if (is_null($val) || $val instanceof UpdateClassification) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'updatesMinimumAutoInstallClassification'");
    }
    ...
    */
    public function setMinimumAutoInstallClassification(?UpdateClassification $value): void {
        $this->getBackingStore()->set('minimumAutoInstallClassification', $value);
    }
    ...
    */
    public function setUpdatesMinimumAutoInstallClassification(?UpdateClassification $value): void {
        $this->getBackingStore()->set('updatesMinimumAutoInstallClassification', $value);
    }
