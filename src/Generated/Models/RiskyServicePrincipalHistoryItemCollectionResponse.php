...
class RiskyServicePrincipalHistoryItemCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<RiskyServicePrincipalHistoryItem>|null $value The value property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(RiskyServicePrincipalHistoryItem::class, 'createFromDiscriminatorValue'))); },
        ];
    }
