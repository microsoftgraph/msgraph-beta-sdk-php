    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'postOfficeBox' => function (ParseNode $n) use ($o) { $o->setPostOfficeBox($n->getStringValue()); },
            ...
            'type' => function (ParseNode $n) use ($o) { $o->setType($n->getEnumValue(PhysicalAddressType::class)); },
        ];
    }
