...
class SiteExclusionUnit extends ExclusionUnitBase implements Parsable 
{
    /**
     * Instantiates a new SiteExclusionUnit and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SiteExclusionUnit {
