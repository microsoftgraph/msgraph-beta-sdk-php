...
class MdmWindowsInformationProtectionPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MdmWindowsInformationProtectionPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(MdmWindowsInformationProtectionPolicy::class, 'createFromDiscriminatorValue'))); },
        ];
    }
