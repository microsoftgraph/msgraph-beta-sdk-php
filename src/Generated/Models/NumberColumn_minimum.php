...
*/
class NumberColumn_minimum implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new NumberColumn_minimum and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): NumberColumn_minimum {
        $result = new NumberColumn_minimum();
