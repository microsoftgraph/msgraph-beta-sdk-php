...
*/
class IosDdmStoreAppAssignmentSettings extends MobileAppAssignmentSettings implements Parsable 
{
    /**
     * Instantiates a new IosDdmStoreAppAssignmentSettings and sets the default values.
    */
    public function __construct() {
        parent::__construct();
        $this->setOdataType('#microsoft.graph.iosDdmStoreAppAssignmentSettings');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): IosDdmStoreAppAssignmentSettings {
        return new IosDdmStoreAppAssignmentSettings();
    }
    ...
    */
    ...
    /**
     * Gets the version property value. Specifies the version of the Store app to install. When not set, the device installs the latest version. When set, the device installs the specified version. The device never installs an older version of the app over a newer version.
     * @return int|null
    */
    ...
    */
    ...
    /**
     * Sets the version property value. Specifies the version of the Store app to install. When not set, the device installs the latest version. When set, the device installs the specified version. The device never installs an older version of the app over a newer version.
