...
class RedirectUriWildcardConfiguration implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RedirectUriWildcardConfiguration and sets the default values.
    */
     ...
     * @return RedirectUriWildcardConfiguration
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RedirectUriWildcardConfiguration {
        return new RedirectUriWildcardConfiguration();
    }
    ...
    */
    public function getExcludeFormats(): ?RedirectUriWildcardExcludeFormats {
        $val = $this->getBackingStore()->get('excludeFormats');
        if (is_null($val) || $val instanceof RedirectUriWildcardExcludeFormats) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'excludeFormats'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'excludeFormats' => fn(ParseNode $n) => $o->setExcludeFormats($n->getObjectValue([RedirectUriWildcardExcludeFormats::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeObjectValue('excludeFormats', $this->getExcludeFormats());
    ...
    */
    public function setExcludeFormats(?RedirectUriWildcardExcludeFormats $value): void {
        $this->getBackingStore()->set('excludeFormats', $value);
    }
