...
class ManagedDeviceCleanupSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getDeviceInactivityBeforeRetirementInDays(): ?string {
        return $this->getBackingStore()->get('deviceInactivityBeforeRetirementInDays');
    }
