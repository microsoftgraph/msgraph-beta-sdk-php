...
class ComplianceManagementPartner extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'windowsEnrollmentAssignments' => function (ParseNode $n) use ($o) { $o->setWindowsEnrollmentAssignments($n->getCollectionOfObjectValues(array(ComplianceManagementPartnerAssignment::class, 'createFromDiscriminatorValue'))); },
            'windowsOnboarded' => function (ParseNode $n) use ($o) { $o->setWindowsOnboarded($n->getBooleanValue()); },
        ]);
    }
