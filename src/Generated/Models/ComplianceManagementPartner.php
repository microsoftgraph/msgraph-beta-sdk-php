    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'windowsEnrollmentAssignments' => function (self $o, ParseNode $n) { $o->setWindowsEnrollmentAssignments($n->getCollectionOfObjectValues(ComplianceManagementPartnerAssignment::class)); },
            'windowsOnboarded' => function (self $o, ParseNode $n) { $o->setWindowsOnboarded($n->getBooleanValue()); },
        ]);
    }
