...
class WindowsKioskLocalGroup extends WindowsKioskUser implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $groupName The name of the local group that will be locked to this kiosk configuration
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WindowsKioskLocalGroup {
