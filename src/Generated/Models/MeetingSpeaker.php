...
class MeetingSpeaker implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function __construct() {
        ...
        $this->setOdataType('#microsoft.graph.meetingSpeaker');
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'bio' => fn(ParseNode $n) => $o->setBio($n->getStringValue()),
