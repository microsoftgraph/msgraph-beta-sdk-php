...
class DeviceManagementConfigurationDependentOn implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getParentSettingId(): ?string {
        $val = $this->getBackingStore()->get('parentSettingId');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'parentSettingId'");
    }
    ...
    */
    public function setParentSettingId(?string $value): void {
        $this->getBackingStore()->set('parentSettingId', $value);
    }
