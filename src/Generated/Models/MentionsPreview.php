...
class MentionsPreview implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MentionsPreview {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'isMentioned' => fn(ParseNode $n) => $o->setIsMentioned($n->getBooleanValue()),
    ...
    */
    public function getIsMentioned(): ?bool {
        $val = $this->getBackingStore()->get('isMentioned');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isMentioned'");
    }
    ...
    */
    public function setIsMentioned(?bool $value): void {
        $this->getBackingStore()->set('isMentioned', $value);
    }
