...
class UnifiedRoleAssignment extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'principalOrganizationId' => function (ParseNode $n) use ($o) { $o->setPrincipalOrganizationId($n->getStringValue()); },
            'resourceScope' => function (ParseNode $n) use ($o) { $o->setResourceScope($n->getStringValue()); },
