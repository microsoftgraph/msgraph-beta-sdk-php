...
class SensitiveContentEvidence implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getMatch(): ?string {
        $val = $this->getBackingStore()->get('match');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'match'");
    }
    ...
    */
    public function setMatch(?string $value): void {
        $this->getBackingStore()->set('match', $value);
    }
