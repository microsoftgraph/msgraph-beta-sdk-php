...
*/
class Windows10XCustomSubjectAlternativeName implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getSanType(): ?SubjectAlternativeNameType {
        $val = $this->getBackingStore()->get('sanType');
        if (is_null($val) || $val instanceof SubjectAlternativeNameType) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'sanType'");
    }
    ...
    */
    public function setSanType(?SubjectAlternativeNameType $value): void {
        $this->getBackingStore()->set('sanType', $value);
    }
