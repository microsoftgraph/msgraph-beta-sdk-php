...
class DeviceManagementStringSettingInstance extends DeviceManagementSettingInstance implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $value The string value
    */
