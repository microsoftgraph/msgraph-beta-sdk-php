    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'investigationHints' => fn(ParseNode $n) => $o->setInvestigationHints($n->getCollectionOfObjectValues([InvestigationActionStep::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function getInvestigationHints(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, InvestigationActionStep::class);
            /** @var array<InvestigationActionStep>|null $val */
            return $val;
        }
