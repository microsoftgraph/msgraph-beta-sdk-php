...
*/
class BookingService_defaultPrice implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new BookingService_defaultPrice and sets the default values.
    */
     ...
     * @return BookingService_defaultPrice
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): BookingService_defaultPrice {
        $result = new BookingService_defaultPrice();
