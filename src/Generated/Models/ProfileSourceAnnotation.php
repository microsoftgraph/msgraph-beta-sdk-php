...
class ProfileSourceAnnotation implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ProfileSourceAnnotation {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'isDefaultSource' => fn(ParseNode $n) => $o->setIsDefaultSource($n->getBooleanValue()),
            '@odata.type' => fn(ParseNode $n) => $o->setOdataType($n->getStringValue()),
            'properties' => function (ParseNode $n) {
    ...
    */
    public function getIsDefaultSource(): ?bool {
        $val = $this->getBackingStore()->get('isDefaultSource');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isDefaultSource'");
    }
    ...
    */
    public function setIsDefaultSource(?bool $value): void {
        $this->getBackingStore()->set('isDefaultSource', $value);
    }
