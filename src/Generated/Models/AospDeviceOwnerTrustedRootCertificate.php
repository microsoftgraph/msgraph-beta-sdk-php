...
class AospDeviceOwnerTrustedRootCertificate extends DeviceConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AospDeviceOwnerTrustedRootCertificate {
