...
class CheckInClaim implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CheckInClaim and sets the default values.
    */
     ...
     * @return CheckInClaim
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CheckInClaim {
    ...
    */
     ...
     * @return CheckInMethod|null
    */
    public function getCheckInMethod(): ?CheckInMethod {
        $val = $this->getBackingStore()->get('checkInMethod');
        if (is_null($val) || $val instanceof CheckInMethod) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'checkInMethod'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'checkInMethod' => fn(ParseNode $n) => $o->setCheckInMethod($n->getEnumValue(CheckInMethod::class)),
    ...
    */
     ...
     * @param CheckInMethod|null $value Value to set for the checkInMethod property.
    */
    public function setCheckInMethod(?CheckInMethod $value): void {
        $this->getBackingStore()->set('checkInMethod', $value);
    }
