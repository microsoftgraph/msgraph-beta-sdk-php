...
class ResultTemplateOption implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getEnableResultTemplate(): ?bool {
        $val = $this->getBackingStore()->get('enableResultTemplate');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'enableResultTemplate'");
    }
