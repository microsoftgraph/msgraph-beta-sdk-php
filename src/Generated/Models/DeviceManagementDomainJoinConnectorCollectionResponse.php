...
class DeviceManagementDomainJoinConnectorCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementDomainJoinConnectorCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(DeviceManagementDomainJoinConnector::class, 'createFromDiscriminatorValue'))); },
        ];
    }
