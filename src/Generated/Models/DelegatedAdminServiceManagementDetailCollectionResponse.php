    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(DelegatedAdminServiceManagementDetail::class, 'createFromDiscriminatorValue'))); },
        ];
    }
