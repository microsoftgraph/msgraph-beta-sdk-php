    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'customAccountResetCredentialsUrl' => function (self $o, ParseNode $n) { $o->setCustomAccountResetCredentialsUrl($n->getStringValue()); },
            'customCannotAccessYourAccountText' => function (self $o, ParseNode $n) { $o->setCustomCannotAccessYourAccountText($n->getStringValue()); },
            'customCannotAccessYourAccountUrl' => function (self $o, ParseNode $n) { $o->setCustomCannotAccessYourAccountUrl($n->getStringValue()); },
            'customForgotMyPasswordText' => function (self $o, ParseNode $n) { $o->setCustomForgotMyPasswordText($n->getStringValue()); },
            'customPrivacyAndCookiesText' => function (self $o, ParseNode $n) { $o->setCustomPrivacyAndCookiesText($n->getStringValue()); },
            'customPrivacyAndCookiesUrl' => function (self $o, ParseNode $n) { $o->setCustomPrivacyAndCookiesUrl($n->getStringValue()); },
            'customResetItNowText' => function (self $o, ParseNode $n) { $o->setCustomResetItNowText($n->getStringValue()); },
            'customTermsOfUseText' => function (self $o, ParseNode $n) { $o->setCustomTermsOfUseText($n->getStringValue()); },
            'customTermsOfUseUrl' => function (self $o, ParseNode $n) { $o->setCustomTermsOfUseUrl($n->getStringValue()); },
            'favicon' => function (self $o, ParseNode $n) { $o->setFavicon($n->getBinaryContent()); },
            'faviconRelativeUrl' => function (self $o, ParseNode $n) { $o->setFaviconRelativeUrl($n->getStringValue()); },
            'headerBackgroundColor' => function (self $o, ParseNode $n) { $o->setHeaderBackgroundColor($n->getStringValue()); },
            'loginPageTextVisibilitySettings' => function (self $o, ParseNode $n) { $o->setLoginPageTextVisibilitySettings($n->getObjectValue(LoginPageTextVisibilitySettings::class)); },
