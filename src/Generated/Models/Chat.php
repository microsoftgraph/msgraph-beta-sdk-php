    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'lastMessagePreview' => function (self $o, ParseNode $n) { $o->setLastMessagePreview($n->getObjectValue(ChatMessageInfo::class)); },
            ...
            'viewpoint' => function (self $o, ParseNode $n) { $o->setViewpoint($n->getObjectValue(ChatViewpoint::class)); },
