...
*/
class UserExperienceAnalyticsModelScores_endpointAnalyticsScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsModelScores_endpointAnalyticsScore and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsModelScores_endpointAnalyticsScore {
        $result = new UserExperienceAnalyticsModelScores_endpointAnalyticsScore();
