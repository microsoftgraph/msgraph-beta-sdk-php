...
class TranscriptionState implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TranscriptionState and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TranscriptionState {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'state' => fn(ParseNode $n) => $o->setState($n->getEnumValue(MediaState::class)),
        ];
    }
    ...
    */
    public function getState(): ?MediaState {
    ...
    */
     ...
     * @param MediaState|null $value Value to set for the state property.
    */
    public function setState(?MediaState $value): void {
