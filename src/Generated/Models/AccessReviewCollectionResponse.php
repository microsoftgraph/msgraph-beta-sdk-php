...
class AccessReviewCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AccessReview>|null $value The value property */
    ...
    */
     ...
     * @return AccessReviewCollectionResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AccessReviewCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(AccessReview::class)); },
        ];
    }
