...
class AndroidForWorkCompliancePolicy extends DeviceCompliancePolicy implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AndroidForWorkCompliancePolicy {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'securityRequiredAndroidSafetyNetEvaluationType' => function (ParseNode $n) use ($o) { $o->setSecurityRequiredAndroidSafetyNetEvaluationType($n->getEnumValue(AndroidSafetyNetEvaluationType::class)); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeEnumValue('securityRequiredAndroidSafetyNetEvaluationType', $this->securityRequiredAndroidSafetyNetEvaluationType);
