...
class UserExperienceAnalyticsDeviceTimelineEvents extends Entity implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDeviceTimelineEvents {
    ...
    */
     ...
     * @return string|null
    */
    public function getEventAdditionalInformation(): ?string {
        return $this->getBackingStore()->get('eventAdditionalInformation');
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'eventAdditionalInformation' => fn(ParseNode $n) => $o->setEventAdditionalInformation($n->getStringValue()),
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeStringValue('eventAdditionalInformation', $this->getEventAdditionalInformation());
    ...
    */
     ...
     *  @param string|null $value Value to set for the eventAdditionalInformation property.
    */
    public function setEventAdditionalInformation(?string $value): void {
        $this->getBackingStore()->set('eventAdditionalInformation', $value);
    }
