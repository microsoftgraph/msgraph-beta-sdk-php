...
*/
class AssignmentFilterValidationResult implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'isValidRule' => fn(ParseNode $n) => $o->setIsValidRule($n->getBooleanValue()),
    ...
    */
    public function getIsValidRule(): ?bool {
        $val = $this->getBackingStore()->get('isValidRule');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isValidRule'");
    }
    ...
    */
    public function setIsValidRule(?bool $value): void {
        $this->getBackingStore()->set('isValidRule', $value);
    }
