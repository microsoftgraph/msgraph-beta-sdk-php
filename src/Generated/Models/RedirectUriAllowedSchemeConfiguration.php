...
class RedirectUriAllowedSchemeConfiguration implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RedirectUriAllowedSchemeConfiguration and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RedirectUriAllowedSchemeConfiguration {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'publicClient' => fn(ParseNode $n) => $o->setPublicClient($n->getObjectValue([RedirectUriPlatformAllowedSchemeConfiguration::class, 'createFromDiscriminatorValue'])),
            'restrictForAppsCreatedAfterDateTime' => fn(ParseNode $n) => $o->setRestrictForAppsCreatedAfterDateTime($n->getDateTimeValue()),
            'spa' => fn(ParseNode $n) => $o->setSpa($n->getObjectValue([RedirectUriPlatformAllowedSchemeConfiguration::class, 'createFromDiscriminatorValue'])),
            'state' => fn(ParseNode $n) => $o->setState($n->getEnumValue(AppManagementRestrictionState::class)),
            'web' => fn(ParseNode $n) => $o->setWeb($n->getObjectValue([RedirectUriPlatformAllowedSchemeConfiguration::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
    public function getPublicClient(): ?RedirectUriPlatformAllowedSchemeConfiguration {
        ...
        if (is_null($val) || $val instanceof RedirectUriPlatformAllowedSchemeConfiguration) {
            return $val;
        }
