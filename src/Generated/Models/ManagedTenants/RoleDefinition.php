...
class RoleDefinition implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $description The description for the role.
    */
    private ?string $description = null;
    
    /**
     * @var string|null $displayName The display name for the role assignment.
    */
    ...
    */
    ...
    /**
     * @var string|null $templateId The unique identifier for the template.
    */
