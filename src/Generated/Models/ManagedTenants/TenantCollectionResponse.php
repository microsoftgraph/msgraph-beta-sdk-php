...
class TenantCollectionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<Tenant>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TenantCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(Tenant::class, 'createFromDiscriminatorValue'))); },
        ];
    }
    ...
    */
     ...
     *  @param array<Tenant>|null $value Value to set for the value property.
    */
