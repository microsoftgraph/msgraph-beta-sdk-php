...
*/
class DeviceHealthStatus_startupPerformanceScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceHealthStatus_startupPerformanceScore and sets the default values.
    */
     ...
     * @return DeviceHealthStatus_startupPerformanceScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceHealthStatus_startupPerformanceScore {
        $result = new DeviceHealthStatus_startupPerformanceScore();
