...
class AlertRuleDefinitionTemplate implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var AlertSeverity|null $defaultSeverity The defaultSeverity property
    */
    private ?AlertSeverity $defaultSeverity = null;
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AlertRuleDefinitionTemplate {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'defaultSeverity' => function (ParseNode $n) use ($o) { $o->setDefaultSeverity($n->getEnumValue(AlertSeverity::class)); },
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeEnumValue('defaultSeverity', $this->defaultSeverity);
