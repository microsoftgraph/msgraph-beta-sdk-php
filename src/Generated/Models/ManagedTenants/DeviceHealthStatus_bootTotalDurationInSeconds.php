...
*/
class DeviceHealthStatus_bootTotalDurationInSeconds implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeviceHealthStatus_bootTotalDurationInSeconds and sets the default values.
    */
     ...
     * @return DeviceHealthStatus_bootTotalDurationInSeconds
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceHealthStatus_bootTotalDurationInSeconds {
        $result = new DeviceHealthStatus_bootTotalDurationInSeconds();
