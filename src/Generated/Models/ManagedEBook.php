...
class ManagedEBook extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<ManagedEBookCategory>|null $categories The list of categories for this eBook.
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'categories' => function (ParseNode $n) use ($o) { $o->setCategories($n->getCollectionOfObjectValues(array(ManagedEBookCategory::class, 'createFromDiscriminatorValue'))); },
    ...
    */
     ...
     *  @param array<ManagedEBookCategory>|null $value Value to set for the categories property.
    */
