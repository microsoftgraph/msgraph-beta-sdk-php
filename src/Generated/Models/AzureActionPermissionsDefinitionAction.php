...
class AzureActionPermissionsDefinitionAction extends AzurePermissionsDefinitionAction implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AzureActionPermissionsDefinitionAction {
