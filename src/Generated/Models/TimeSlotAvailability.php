...
class TimeSlotAvailability extends TimeSlot implements Parsable 
{
    /**
     * Instantiates a new TimeSlotAvailability and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TimeSlotAvailability {
