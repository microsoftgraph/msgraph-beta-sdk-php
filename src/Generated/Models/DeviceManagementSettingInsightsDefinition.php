 ...
 * Setting Insights
*/
class DeviceManagementSettingInsightsDefinition implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementSettingInsightsDefinition {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'settingInsight' => fn(ParseNode $n) => $o->setSettingInsight($n->getObjectValue([DeviceManagementConfigurationSettingValue::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
     ...
     * @param DeviceManagementConfigurationSettingValue|null $value Value to set for the settingInsight property.
    */
    public function setSettingInsight(?DeviceManagementConfigurationSettingValue $value): void {
        $this->getBackingStore()->set('settingInsight', $value);
    }
