...
*/
class ManagedDeviceMobileAppConfigurationPolicySetItem extends PolicySetItem implements Parsable 
{
    /**
    ...
    */
    public function __construct() {
        parent::__construct();
        $this->setOdataType('#microsoft.graph.managedDeviceMobileAppConfigurationPolicySetItem');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ManagedDeviceMobileAppConfigurationPolicySetItem {
