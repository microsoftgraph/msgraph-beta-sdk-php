...
class UserExperienceAnalyticsModelScoresCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserExperienceAnalyticsModelScores>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsModelScoresCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(UserExperienceAnalyticsModelScores::class)); },
        ];
    }
