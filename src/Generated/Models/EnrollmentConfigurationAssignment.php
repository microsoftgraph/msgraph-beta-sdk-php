...
class EnrollmentConfigurationAssignment extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var DeviceAndAppManagementAssignmentSource|null $source Type of resource used for deployment to a group, direct or policySet. Possible values are: direct, policySets.
    */
