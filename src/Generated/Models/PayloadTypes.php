...
class PayloadTypes implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getVisualContent(): ?VisualProperties {
        $val = $this->getBackingStore()->get('visualContent');
        if (is_null($val) || $val instanceof VisualProperties) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'visualContent'");
    }
    ...
    */
    public function setVisualContent(?VisualProperties $value): void {
        $this->getBackingStore()->set('visualContent', $value);
    }
