...
class IosHomeScreenFolderPage implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getApps(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, IosHomeScreenApp::class);
            /** @var array<IosHomeScreenApp>|null $val */
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'apps' => fn(ParseNode $n) => $o->setApps($n->getCollectionOfObjectValues([IosHomeScreenApp::class, 'createFromDiscriminatorValue'])),
