...
class Group extends DirectoryObject implements Parsable 
{
    ...
    */
    public function getMembershipRuleProcessingStatus(): ?MembershipRuleProcessingStatus {
        $val = $this->getBackingStore()->get('membershipRuleProcessingStatus');
        if (is_null($val) || $val instanceof MembershipRuleProcessingStatus) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'membershipRuleProcessingStatus'");
    }
    ...
    */
    public function getWritebackConfiguration(): ?GroupWritebackConfiguration {
        ...
        if (is_null($val) || $val instanceof GroupWritebackConfiguration) {
            return $val;
        }
