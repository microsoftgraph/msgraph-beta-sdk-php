...
class UserSet implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getIsBackup(): ?bool {
        $val = $this->getBackingStore()->get('isBackup');
        if (is_null($val) || is_bool($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'isBackup'");
    }
    ...
    */
     ...
     * @param bool|null $value Value to set for the isBackup property.
    */
    public function setIsBackup(?bool $value): void {
        $this->getBackingStore()->set('isBackup', $value);
    }
