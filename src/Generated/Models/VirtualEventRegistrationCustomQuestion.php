...
class VirtualEventRegistrationCustomQuestion extends VirtualEventRegistrationQuestionBase implements Parsable 
{
    ...
    */
     ...
     * @return VirtualEventRegistrationCustomQuestion_answerInputType|null
    */
    public function getAnswerInputType(): ?VirtualEventRegistrationCustomQuestion_answerInputType {
        $val = $this->getBackingStore()->get('answerInputType');
        if (is_null($val) || $val instanceof VirtualEventRegistrationCustomQuestion_answerInputType) {
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'answerInputType' => fn(ParseNode $n) => $o->setAnswerInputType($n->getEnumValue(VirtualEventRegistrationCustomQuestion_answerInputType::class)),
        ]);
    }
    ...
    */
     ...
     * @param VirtualEventRegistrationCustomQuestion_answerInputType|null $value Value to set for the answerInputType property.
    */
    public function setAnswerInputType(?VirtualEventRegistrationCustomQuestion_answerInputType $value): void {
