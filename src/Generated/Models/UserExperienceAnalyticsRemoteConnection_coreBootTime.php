...
*/
class UserExperienceAnalyticsRemoteConnection_coreBootTime implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsRemoteConnection_coreBootTime and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsRemoteConnection_coreBootTime
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsRemoteConnection_coreBootTime {
        $result = new UserExperienceAnalyticsRemoteConnection_coreBootTime();
