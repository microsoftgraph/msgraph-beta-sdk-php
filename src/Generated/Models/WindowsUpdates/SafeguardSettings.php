...
class SafeguardSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getDisabledSafeguardProfiles(): ?array {
        $val = $this->getBackingStore()->get('disabledSafeguardProfiles');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, SafeguardProfile::class);
            /** @var array<SafeguardProfile>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'disabledSafeguardProfiles'");
    }
    ...
    */
    public function setDisabledSafeguardProfiles(?array $value): void {
        $this->getBackingStore()->set('disabledSafeguardProfiles', $value);
    }
