...
class QualityUpdateApprovalRule extends ApprovalRule implements Parsable 
{
    /**
     * Instantiates a new QualityUpdateApprovalRule and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): QualityUpdateApprovalRule {
