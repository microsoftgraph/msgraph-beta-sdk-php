...
class SoftwareUpdateCatalogEntry extends CatalogEntry implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SoftwareUpdateCatalogEntry {
