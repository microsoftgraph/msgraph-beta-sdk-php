...
class WindowsUpdateFilter extends SoftwareUpdateFilter implements Parsable 
{
    ...
    */
    public function __construct() {
        parent::__construct();
        $this->setOdataType('#microsoft.graph.windowsUpdates.windowsUpdateFilter');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WindowsUpdateFilter {
