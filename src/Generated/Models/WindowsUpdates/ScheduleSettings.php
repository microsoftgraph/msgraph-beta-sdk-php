...
class ScheduleSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ScheduleSettings {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'gradualRollout' => fn(ParseNode $n) => $o->setGradualRollout($n->getObjectValue([GradualRolloutSettings::class, 'createFromDiscriminatorValue'])),
     ...
     * @return GradualRolloutSettings|null
    */
    public function getGradualRollout(): ?GradualRolloutSettings {
        $val = $this->getBackingStore()->get('gradualRollout');
        if (is_null($val) || $val instanceof GradualRolloutSettings) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'gradualRollout'");
    }
    ...
    */
     ...
     * @param GradualRolloutSettings|null $value Value to set for the gradualRollout property.
    */
    public function setGradualRollout(?GradualRolloutSettings $value): void {
        $this->getBackingStore()->set('gradualRollout', $value);
    }
