...
*/
class QualityUpdateCveSeverityInformation_maxBaseScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new QualityUpdateCveSeverityInformation_maxBaseScore and sets the default values.
    */
     ...
     * @return QualityUpdateCveSeverityInformation_maxBaseScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): QualityUpdateCveSeverityInformation_maxBaseScore {
        $result = new QualityUpdateCveSeverityInformation_maxBaseScore();
