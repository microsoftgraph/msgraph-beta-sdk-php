...
class IncludedGroupAssignment extends GroupAssignment implements Parsable 
{
    /**
     * Instantiates a new IncludedGroupAssignment and sets the default values.
    */
     ...
     * @return IncludedGroupAssignment
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): IncludedGroupAssignment {
