...
class MonitoringSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getMonitoringRules(): ?array {
        $val = $this->getBackingStore()->get('monitoringRules');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, MonitoringRule::class);
            /** @var array<MonitoringRule>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'monitoringRules'");
    }
    ...
    */
    public function setMonitoringRules(?array $value): void {
        $this->getBackingStore()->set('monitoringRules', $value);
    }
