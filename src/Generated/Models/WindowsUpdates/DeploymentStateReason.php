...
class DeploymentStateReason implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeploymentStateReason {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => fn(ParseNode $n) => $o->setValue($n->getEnumValue(DeploymentStateReasonValue::class)),
        ];
    }
    ...
    */
    public function getValue(): ?DeploymentStateReasonValue {
        ...
        if (is_null($val) || $val instanceof DeploymentStateReasonValue) {
            return $val;
        }
