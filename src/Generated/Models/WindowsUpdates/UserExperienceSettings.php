...
class UserExperienceSettings implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var int|null $daysUntilForcedReboot Specifies the number of days after an update is installed, during which the user of the device can control when the device restarts.
    */
