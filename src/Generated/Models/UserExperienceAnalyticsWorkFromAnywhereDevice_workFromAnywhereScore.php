...
*/
class UserExperienceAnalyticsWorkFromAnywhereDevice_workFromAnywhereScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsWorkFromAnywhereDevice_workFromAnywhereScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereDevice_workFromAnywhereScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsWorkFromAnywhereDevice_workFromAnywhereScore {
        $result = new UserExperienceAnalyticsWorkFromAnywhereDevice_workFromAnywhereScore();
