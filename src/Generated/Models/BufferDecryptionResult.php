...
class BufferDecryptionResult implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getDecryptedBuffer(): ?StreamInterface {
        $val = $this->getBackingStore()->get('decryptedBuffer');
        if (is_null($val) || $val instanceof StreamInterface) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'decryptedBuffer'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeBinaryContent('decryptedBuffer', $this->getDecryptedBuffer());
    ...
    */
     ...
     * @param StreamInterface|null $value Value to set for the decryptedBuffer property.
    */
    public function setDecryptedBuffer(?StreamInterface $value): void {
        $this->getBackingStore()->set('decryptedBuffer', $value);
    }
