...
class EscapedPrint implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PrinterShare>|null $printerShares The printerShares property */
    private ?array $printerShares = null;
    
    /** @var ReportRoot|null $reports The reports property */
    private ?ReportRoot $reports = null;
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'printerShares' => function (self $o, ParseNode $n) { $o->setPrinterShares($n->getCollectionOfObjectValues(PrinterShare::class)); },
            'reports' => function (self $o, ParseNode $n) { $o->setReports($n->getObjectValue(ReportRoot::class)); },
