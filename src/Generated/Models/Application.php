...
class Application extends DirectoryObject implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'connectorGroup' => function (ParseNode $n) use ($o) { $o->setConnectorGroup($n->getObjectValue(array(ConnectorGroup::class, 'createFromDiscriminatorValue'))); },
            ...
            'onPremisesPublishing' => function (ParseNode $n) use ($o) { $o->setOnPremisesPublishing($n->getObjectValue(array(OnPremisesPublishing::class, 'createFromDiscriminatorValue'))); },
            ...
            'uniqueName' => function (ParseNode $n) use ($o) { $o->setUniqueName($n->getStringValue()); },
            ...
            'windows' => function (ParseNode $n) use ($o) { $o->setWindows($n->getObjectValue(array(WindowsApplication::class, 'createFromDiscriminatorValue'))); },
        ]);
    }
