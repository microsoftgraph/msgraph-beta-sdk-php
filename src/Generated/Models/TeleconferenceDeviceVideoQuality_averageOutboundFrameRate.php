...
*/
class TeleconferenceDeviceVideoQuality_averageOutboundFrameRate implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TeleconferenceDeviceVideoQuality_averageOutboundFrameRate and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TeleconferenceDeviceVideoQuality_averageOutboundFrameRate {
        $result = new TeleconferenceDeviceVideoQuality_averageOutboundFrameRate();
