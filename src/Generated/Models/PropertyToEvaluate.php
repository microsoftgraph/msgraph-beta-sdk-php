...
class PropertyToEvaluate implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getPropertyValue(): ?string {
        $val = $this->getBackingStore()->get('propertyValue');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'propertyValue'");
    }
    ...
    */
    public function setPropertyValue(?string $value): void {
        $this->getBackingStore()->set('propertyValue', $value);
    }
