...
class AzureADPremiumFeatureUtilization implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AzureADPremiumFeatureUtilization and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AzureADPremiumFeatureUtilization {
