...
class AuthenticationMethodFeatureConfiguration implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var FeatureTarget|null $excludeTarget A single entity that's excluded from using this feature.
    */
    private ?FeatureTarget $excludeTarget = null;
    
    /**
     * @var FeatureTarget|null $includeTarget A single entity that's allowed to use this feature.
    */
