...
class DeviceManagementSettingAbstractImplementationConstraint extends DeviceManagementConstraint implements Parsable 
{
    ...
    */
    public function getAllowedAbstractImplementationDefinitionIds(): ?array {
        $val = $this->getBackingStore()->get('allowedAbstractImplementationDefinitionIds');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, 'string');
            /** @var array<string>|null $val */
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'allowedAbstractImplementationDefinitionIds'");
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'allowedAbstractImplementationDefinitionIds' => function (ParseNode $n) {
                $val = $n->getCollectionOfPrimitiveValues();
                if (is_array($val)) {
                    TypeUtils::validateCollectionValues($val, 'string');
                }
                /** @var array<string>|null $val */
                $this->setAllowedAbstractImplementationDefinitionIds($val);
            },
        ]);
    }
