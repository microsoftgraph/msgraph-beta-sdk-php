...
*/
class UserExperienceAnalyticsDevicePerformance_startupPerformanceScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsDevicePerformance_startupPerformanceScore and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDevicePerformance_startupPerformanceScore {
        $result = new UserExperienceAnalyticsDevicePerformance_startupPerformanceScore();
