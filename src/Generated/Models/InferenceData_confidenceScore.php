...
*/
class InferenceData_confidenceScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new InferenceData_confidenceScore and sets the default values.
    */
     ...
     * @return InferenceData_confidenceScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): InferenceData_confidenceScore {
        $result = new InferenceData_confidenceScore();
