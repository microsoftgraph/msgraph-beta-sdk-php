...
class AuthenticationFlow implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AuthenticationFlow and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AuthenticationFlow {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'transferMethod' => fn(ParseNode $n) => $o->setTransferMethod($n->getEnumValue(ConditionalAccessTransferMethods::class)),
        ];
    }
    ...
    */
    public function getTransferMethod(): ?ConditionalAccessTransferMethods {
        $val = $this->getBackingStore()->get('transferMethod');
        if (is_null($val) || $val instanceof ConditionalAccessTransferMethods) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'transferMethod'");
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeEnumValue('transferMethod', $this->getTransferMethod());
    ...
    */
    public function setTransferMethod(?ConditionalAccessTransferMethods $value): void {
        $this->getBackingStore()->set('transferMethod', $value);
    }
