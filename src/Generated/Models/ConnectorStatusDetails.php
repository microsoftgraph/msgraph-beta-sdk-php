...
*/
class ConnectorStatusDetails implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ConnectorStatusDetails {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'connectorInstanceId' => fn(ParseNode $n) => $o->setConnectorInstanceId($n->getStringValue()),
            'connectorName' => fn(ParseNode $n) => $o->setConnectorName($n->getEnumValue(ConnectorName::class)),
            'eventDateTime' => fn(ParseNode $n) => $o->setEventDateTime($n->getDateTimeValue()),
            '@odata.type' => fn(ParseNode $n) => $o->setOdataType($n->getStringValue()),
            'status' => fn(ParseNode $n) => $o->setStatus($n->getEnumValue(ConnectorHealthState::class)),
        ];
    }
    ...
    */
     ...
     * @param string|null $value Value to set for the connectorInstanceId property.
    */
    public function setConnectorInstanceId(?string $value): void {
        $this->getBackingStore()->set('connectorInstanceId', $value);
    }

    /**
     * Sets the connectorName property value. Connectors name for connector status
     * @param ConnectorName|null $value Value to set for the connectorName property.
    */
    public function setConnectorName(?ConnectorName $value): void {
    ...
    */
     ...
     * @param ConnectorHealthState|null $value Value to set for the status property.
    */
    public function setStatus(?ConnectorHealthState $value): void {
