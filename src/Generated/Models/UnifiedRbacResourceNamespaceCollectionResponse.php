...
class UnifiedRbacResourceNamespaceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<UnifiedRbacResourceNamespace>|null $value The value property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(UnifiedRbacResourceNamespace::class, 'createFromDiscriminatorValue'))); },
        ];
    }
