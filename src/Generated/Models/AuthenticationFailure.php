...
class AuthenticationFailure extends Entity implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AuthenticationFailure {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'reasonCode' => fn(ParseNode $n) => $o->setReasonCode($n->getEnumValue(AuthenticationFailureReasonCode::class)),
        ]);
    }
    ...
    */
     ...
     * @return AuthenticationFailureReasonCode|null
    */
    public function getReasonCode(): ?AuthenticationFailureReasonCode {
        $val = $this->getBackingStore()->get('reasonCode');
        if (is_null($val) || $val instanceof AuthenticationFailureReasonCode) {
            return $val;
        }
    ...
    */
     ...
     * @param AuthenticationFailureReasonCode|null $value Value to set for the reasonCode property.
    */
    public function setReasonCode(?AuthenticationFailureReasonCode $value): void {
