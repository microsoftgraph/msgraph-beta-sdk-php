...
class ValidatingDomains implements AdditionalDataHolder, BackedModel, Parsable 
{
    ...
    */
    public function getRootDomains(): ?RootDomains {
        $val = $this->getBackingStore()->get('rootDomains');
        if (is_null($val) || $val instanceof RootDomains) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'rootDomains'");
    }
