...
*/
class UserExperienceAnalyticsResourcePerformance_totalRamInMB implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsResourcePerformance_totalRamInMB and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsResourcePerformance_totalRamInMB
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsResourcePerformance_totalRamInMB {
        $result = new UserExperienceAnalyticsResourcePerformance_totalRamInMB();
