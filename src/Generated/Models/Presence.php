...
class Presence extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'outOfOfficeSettings' => function (ParseNode $n) use ($o) { $o->setOutOfOfficeSettings($n->getObjectValue(array(OutOfOfficeSettings::class, 'createFromDiscriminatorValue'))); },
        ]);
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeObjectValue('outOfOfficeSettings', $this->outOfOfficeSettings);
