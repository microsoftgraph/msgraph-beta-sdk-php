...
class SalesOrder extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'fullyShipped' => function (ParseNode $n) use ($o) { $o->setFullyShipped($n->getBooleanValue()); },
            'lastModifiedDateTime' => function (ParseNode $n) use ($o) { $o->setLastModifiedDateTime($n->getDateTimeValue()); },
            'number' => function (ParseNode $n) use ($o) { $o->setNumber($n->getStringValue()); },
            'orderDate' => function (ParseNode $n) use ($o) { $o->setOrderDate($n->getDateValue()); },
            'partialShipping' => function (ParseNode $n) use ($o) { $o->setPartialShipping($n->getBooleanValue()); },
            ...
            'requestedDeliveryDate' => function (ParseNode $n) use ($o) { $o->setRequestedDeliveryDate($n->getDateValue()); },
