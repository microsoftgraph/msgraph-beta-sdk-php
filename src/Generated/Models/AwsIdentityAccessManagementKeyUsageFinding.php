...
class AwsIdentityAccessManagementKeyUsageFinding extends Finding implements Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AwsIdentityAccessManagementKeyUsageFinding {
