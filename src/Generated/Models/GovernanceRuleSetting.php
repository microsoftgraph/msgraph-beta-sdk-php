...
class GovernanceRuleSetting implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getRuleIdentifier(): ?string {
        $val = $this->getBackingStore()->get('ruleIdentifier');
        if (is_null($val) || is_string($val)) {
            return $val;
        }
        throw new \UnexpectedValueException("Invalid type found in backing store for 'ruleIdentifier'");
    }
