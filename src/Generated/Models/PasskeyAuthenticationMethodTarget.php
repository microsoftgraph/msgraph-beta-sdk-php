...
{
    /**
     * Instantiates a new PasskeyAuthenticationMethodTarget and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PasskeyAuthenticationMethodTarget {
