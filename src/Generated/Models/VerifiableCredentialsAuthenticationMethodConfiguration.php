    ...
    */
    public function getIncludeTargets(): ?array {
        ...
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, VerifiableCredentialAuthenticationMethodTarget::class);
            /** @var array<VerifiableCredentialAuthenticationMethodTarget>|null $val */
            return $val;
        }
