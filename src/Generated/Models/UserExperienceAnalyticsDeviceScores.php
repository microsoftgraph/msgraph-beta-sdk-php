...
class UserExperienceAnalyticsDeviceScores extends Entity implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'meanResourceSpikeTimeScore' => fn(ParseNode $n) => $o->setMeanResourceSpikeTimeScore($n->getObjectValue([UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @return UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore|null
    */
    public function getMeanResourceSpikeTimeScore(): ?UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore {
        $val = $this->getBackingStore()->get('meanResourceSpikeTimeScore');
        if (is_null($val) || $val instanceof UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore) {
            return $val;
        }
    ...
    */
     ...
     * @param UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore|null $value Value to set for the meanResourceSpikeTimeScore property.
    */
    public function setMeanResourceSpikeTimeScore(?UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore $value): void {
