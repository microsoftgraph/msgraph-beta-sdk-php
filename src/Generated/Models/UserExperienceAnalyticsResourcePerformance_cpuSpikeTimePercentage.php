...
*/
class UserExperienceAnalyticsResourcePerformance_cpuSpikeTimePercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsResourcePerformance_cpuSpikeTimePercentage and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsResourcePerformance_cpuSpikeTimePercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsResourcePerformance_cpuSpikeTimePercentage {
        $result = new UserExperienceAnalyticsResourcePerformance_cpuSpikeTimePercentage();
