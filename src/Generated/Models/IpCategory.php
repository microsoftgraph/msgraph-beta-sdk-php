...
class IpCategory implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return IpCategory
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): IpCategory {
