...
class ChatActivityStatistics extends ActivityStatistics implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var DateInterval|null $afterHours Time spent on chats outside of working hours, which is based on the user's Microsoft Outlook calendar setting for work hours. The value is represented in ISO 8601 format for durations.
    */
