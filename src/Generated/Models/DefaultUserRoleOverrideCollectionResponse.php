...
class DefaultUserRoleOverrideCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<DefaultUserRoleOverride>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DefaultUserRoleOverrideCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(DefaultUserRoleOverride::class, 'createFromDiscriminatorValue'))); },
        ];
    }
