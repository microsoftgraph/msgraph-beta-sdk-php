...
*/
class UserExperienceAnalyticsDeviceScores_startupPerformanceScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsDeviceScores_startupPerformanceScore and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsDeviceScores_startupPerformanceScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsDeviceScores_startupPerformanceScore {
        $result = new UserExperienceAnalyticsDeviceScores_startupPerformanceScore();
