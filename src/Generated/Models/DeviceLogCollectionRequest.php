...
*/
class DeviceLogCollectionRequest implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'templateType' => fn(ParseNode $n) => $o->setTemplateType($n->getEnumValue(DeviceLogCollectionTemplateType::class)),
        ];
    }
    ...
    */
    public function getTemplateType(): ?DeviceLogCollectionTemplateType {
        ...
        if (is_null($val) || $val instanceof DeviceLogCollectionTemplateType) {
            return $val;
        }
