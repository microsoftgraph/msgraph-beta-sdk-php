...
class DeviceManagementIntegerSettingInstance extends DeviceManagementSettingInstance implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var int|null $value The integer value
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementIntegerSettingInstance {
