...
class EngagementAsyncOperation extends LongRunningOperation implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'operationType' => fn(ParseNode $n) => $o->setOperationType($n->getEnumValue(EngagementAsyncOperation_operationType::class)),
     ...
     * @return EngagementAsyncOperation_operationType|null
    */
    public function getOperationType(): ?EngagementAsyncOperation_operationType {
        $val = $this->getBackingStore()->get('operationType');
        if (is_null($val) || $val instanceof EngagementAsyncOperation_operationType) {
            return $val;
        }
    ...
    */
     ...
     * @param EngagementAsyncOperation_operationType|null $value Value to set for the operationType property.
    */
    public function setOperationType(?EngagementAsyncOperation_operationType $value): void {
