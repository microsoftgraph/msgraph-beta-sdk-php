...
class CustomSecurityAttributeDefinition extends Entity 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CustomSecurityAttributeDefinition {
    ...
    */
    public function getFieldDeserializers(): array {
        return array_merge(parent::getFieldDeserializers(), [
            'allowedValues' => function (self $o, ParseNode $n) { $o->setAllowedValues($n->getCollectionOfObjectValues(AllowedValue::class)); },
            'attributeSet' => function (self $o, ParseNode $n) { $o->setAttributeSet($n->getStringValue()); },
            ...
            'usePreDefinedValuesOnly' => function (self $o, ParseNode $n) { $o->setUsePreDefinedValuesOnly($n->getBooleanValue()); },
        ]);
    }
