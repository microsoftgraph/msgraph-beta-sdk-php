...
class Goals extends Entity implements Parsable 
{
    /**
    ...
    */
     ...
     * @return Goals
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Goals {
        return new Goals();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'exportJobs' => fn(ParseNode $n) => $o->setExportJobs($n->getCollectionOfObjectValues([GoalsExportJob::class, 'createFromDiscriminatorValue'])),
        ]);
    }
    ...
    */
     ...
     * @param array<GoalsExportJob>|null $value Value to set for the exportJobs property.
    */
