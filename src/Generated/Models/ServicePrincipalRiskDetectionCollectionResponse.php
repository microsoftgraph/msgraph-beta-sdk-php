...
class ServicePrincipalRiskDetectionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ServicePrincipalRiskDetection>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ServicePrincipalRiskDetectionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            ...
            'value' => function (self $o, ParseNode $n) { $o->setValue($n->getCollectionOfObjectValues(ServicePrincipalRiskDetection::class)); },
        ];
    }
