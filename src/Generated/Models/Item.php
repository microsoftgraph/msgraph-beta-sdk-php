...
class Item extends Entity implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'baseUnitOfMeasureId' => function (ParseNode $n) use ($o) { $o->setBaseUnitOfMeasureId($n->getStringValue()); },
            'blocked' => function (ParseNode $n) use ($o) { $o->setBlocked($n->getBooleanValue()); },
            'displayName' => function (ParseNode $n) use ($o) { $o->setDisplayName($n->getStringValue()); },
            'gtin' => function (ParseNode $n) use ($o) { $o->setGtin($n->getStringValue()); },
            'inventory' => function (ParseNode $n) use ($o) { $o->setInventory($n->getStringValue()); },
            'itemCategory' => function (ParseNode $n) use ($o) { $o->setItemCategory($n->getObjectValue(array(ItemCategory::class, 'createFromDiscriminatorValue'))); },
            'itemCategoryCode' => function (ParseNode $n) use ($o) { $o->setItemCategoryCode($n->getStringValue()); },
            'itemCategoryId' => function (ParseNode $n) use ($o) { $o->setItemCategoryId($n->getStringValue()); },
            ...
            'priceIncludesTax' => function (ParseNode $n) use ($o) { $o->setPriceIncludesTax($n->getBooleanValue()); },
            'taxGroupCode' => function (ParseNode $n) use ($o) { $o->setTaxGroupCode($n->getStringValue()); },
            'taxGroupId' => function (ParseNode $n) use ($o) { $o->setTaxGroupId($n->getStringValue()); },
