...
*/
class ConfigurationManagerAction implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getAction(): ?ConfigurationManagerActionType {
        ...
        if (is_null($val) || $val instanceof ConfigurationManagerActionType) {
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'action' => fn(ParseNode $n) => $o->setAction($n->getEnumValue(ConfigurationManagerActionType::class)),
