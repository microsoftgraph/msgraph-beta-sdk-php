...
*/
class UserExperienceAnalyticsImpactingProcess_impactValue implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsImpactingProcess_impactValue and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsImpactingProcess_impactValue
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsImpactingProcess_impactValue {
        $result = new UserExperienceAnalyticsImpactingProcess_impactValue();
