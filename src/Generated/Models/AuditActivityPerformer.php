...
class AuditActivityPerformer implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AuditActivityPerformer and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AuditActivityPerformer {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'identityType' => fn(ParseNode $n) => $o->setIdentityType($n->getEnumValue(AuditIdentityType::class)),
     ...
     * @return AuditIdentityType|null
    */
    public function getIdentityType(): ?AuditIdentityType {
        $val = $this->getBackingStore()->get('identityType');
        if (is_null($val) || $val instanceof AuditIdentityType) {
            return $val;
        }
    ...
    */
     ...
     * @param AuditIdentityType|null $value Value to set for the identityType property.
    */
    public function setIdentityType(?AuditIdentityType $value): void {
