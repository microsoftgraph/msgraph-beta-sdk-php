...
class ContentModel extends Entity implements Parsable 
{
    /**
    ...
    */
     ...
     * @return ContentModel
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ContentModel {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'modelType' => fn(ParseNode $n) => $o->setModelType($n->getEnumValue(ContentModelType::class)),
    ...
    */
     ...
     * @return ContentModelType|null
    */
    public function getModelType(): ?ContentModelType {
        $val = $this->getBackingStore()->get('modelType');
        if (is_null($val) || $val instanceof ContentModelType) {
            return $val;
        }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeEnumValue('modelType', $this->getModelType());
    ...
    */
     ...
     * @param ContentModelType|null $value Value to set for the modelType property.
    */
    public function setModelType(?ContentModelType $value): void {
