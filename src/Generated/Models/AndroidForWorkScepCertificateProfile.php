...
class AndroidForWorkScepCertificateProfile extends AndroidForWorkCertificateProfileBase implements Parsable 
{
    ...
    */
     ...
     * @return AndroidForWorkScepCertificateProfile_certificateStore|null
    */
    public function getCertificateStore(): ?AndroidForWorkScepCertificateProfile_certificateStore {
        $val = $this->getBackingStore()->get('certificateStore');
        if (is_null($val) || $val instanceof AndroidForWorkScepCertificateProfile_certificateStore) {
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'certificateStore' => fn(ParseNode $n) => $o->setCertificateStore($n->getEnumValue(AndroidForWorkScepCertificateProfile_certificateStore::class)),
    ...
    */
     ...
     * @param AndroidForWorkScepCertificateProfile_certificateStore|null $value Value to set for the certificateStore property.
    */
    public function setCertificateStore(?AndroidForWorkScepCertificateProfile_certificateStore $value): void {
