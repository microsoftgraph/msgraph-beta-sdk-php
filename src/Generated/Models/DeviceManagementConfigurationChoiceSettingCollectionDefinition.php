...
class DeviceManagementConfigurationChoiceSettingCollectionDefinition extends DeviceManagementConfigurationChoiceSettingDefinition implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var int|null $maximumCount Maximum number of choices in the collection. Valid values 1 to 100
    */
    private ?int $maximumCount = null;
    
    /**
     * @var int|null $minimumCount Minimum number of choices in the collection. Valid values 1 to 100
    */
