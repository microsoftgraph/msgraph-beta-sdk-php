...
*/
class RecommendationBase_currentScore implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RecommendationBase_currentScore and sets the default values.
    */
     ...
     * @return RecommendationBase_currentScore
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RecommendationBase_currentScore {
        $result = new RecommendationBase_currentScore();
