...
class ForwardingProfileBase extends Profile implements Parsable 
{
    /**
     * Instantiates a new ForwardingProfileBase and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ForwardingProfileBase {
