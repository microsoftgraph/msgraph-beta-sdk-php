...
class CloudFirewallDestinationFqdnAddress extends CloudFirewallDestinationAddress implements Parsable 
{
    /**
     * Instantiates a new CloudFirewallDestinationFqdnAddress and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CloudFirewallDestinationFqdnAddress {
