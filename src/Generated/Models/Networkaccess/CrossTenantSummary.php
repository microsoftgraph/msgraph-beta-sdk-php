...
class CrossTenantSummary implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CrossTenantSummary {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'authTransactionCount' => fn(ParseNode $n) => $o->setAuthTransactionCount($n->getIntegerValue()),
    ...
    */
    public function setAuthTransactionCount(?int $value): void {
        $this->getBackingStore()->set('authTransactionCount', $value);
    }
    ...
    */
    public function setNewTenantCount(?int $value): void {
        $this->getBackingStore()->set('newTenantCount', $value);
    }
    ...
    */
    public function setTenantCount(?int $value): void {
        $this->getBackingStore()->set('tenantCount', $value);
    }
