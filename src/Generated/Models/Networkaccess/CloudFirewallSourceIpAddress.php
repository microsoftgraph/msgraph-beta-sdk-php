...
class CloudFirewallSourceIpAddress extends CloudFirewallSourceAddress implements Parsable 
{
    /**
     * Instantiates a new CloudFirewallSourceIpAddress and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CloudFirewallSourceIpAddress {
