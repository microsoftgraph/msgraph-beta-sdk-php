...
class RelatedUser extends RelatedResource implements Parsable 
{
    /**
     * Instantiates a new RelatedUser and sets the default values.
    */
     ...
     * @return RelatedUser
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RelatedUser {
