...
class CloudFirewallSourceMatching implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CloudFirewallSourceMatching and sets the default values.
    */
     ...
     * @return CloudFirewallSourceMatching
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CloudFirewallSourceMatching {
    ...
    */
     ...
     * @return array<CloudFirewallSourceAddress>|null
    */
    public function getAddresses(): ?array {
        $val = $this->getBackingStore()->get('addresses');
        if (is_array($val) || is_null($val)) {
            TypeUtils::validateCollectionValues($val, CloudFirewallSourceAddress::class);
            /** @var array<CloudFirewallSourceAddress>|null $val */
            return $val;
        }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'addresses' => fn(ParseNode $n) => $o->setAddresses($n->getCollectionOfObjectValues([CloudFirewallSourceAddress::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<CloudFirewallSourceAddress>|null $value Value to set for the addresses property.
    */
