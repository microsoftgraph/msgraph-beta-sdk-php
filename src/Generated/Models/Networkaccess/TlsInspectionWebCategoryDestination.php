...
class TlsInspectionWebCategoryDestination extends TlsInspectionDestination implements Parsable 
{
    /**
     * Instantiates a new TlsInspectionWebCategoryDestination and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TlsInspectionWebCategoryDestination {
