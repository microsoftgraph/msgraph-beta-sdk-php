...
class CloudFirewallDestinationIpAddress extends CloudFirewallDestinationAddress implements Parsable 
{
    /**
     * Instantiates a new CloudFirewallDestinationIpAddress and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CloudFirewallDestinationIpAddress {
