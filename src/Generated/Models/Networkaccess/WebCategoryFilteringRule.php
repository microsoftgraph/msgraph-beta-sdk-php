...
class WebCategoryFilteringRule extends FilteringRule implements Parsable 
{
    ...
    */
    public function __construct() {
        parent::__construct();
        $this->setOdataType('#microsoft.graph.networkaccess.webCategoryFilteringRule');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WebCategoryFilteringRule {
