...
*/
class EducationGradingSchemeGrade_defaultPercentage implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new EducationGradingSchemeGrade_defaultPercentage and sets the default values.
    */
     ...
     * @return EducationGradingSchemeGrade_defaultPercentage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EducationGradingSchemeGrade_defaultPercentage {
        $result = new EducationGradingSchemeGrade_defaultPercentage();
