...
*/
class UserExperienceAnalyticsMetric_value implements BackedModel, ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UserExperienceAnalyticsMetric_value and sets the default values.
    */
     ...
     * @return UserExperienceAnalyticsMetric_value
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UserExperienceAnalyticsMetric_value {
        $result = new UserExperienceAnalyticsMetric_value();
