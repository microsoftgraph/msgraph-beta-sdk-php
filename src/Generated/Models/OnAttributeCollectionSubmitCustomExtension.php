...
class OnAttributeCollectionSubmitCustomExtension extends CustomAuthenticationExtension implements Parsable 
{
    ...
    */
    public function __construct() {
        parent::__construct();
        $this->setOdataType('#microsoft.graph.onAttributeCollectionSubmitCustomExtension');
    }
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OnAttributeCollectionSubmitCustomExtension {
