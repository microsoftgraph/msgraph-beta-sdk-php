...
/**
 * Configuration for the request such as headers, query parameters, and middleware options. Original name: AuthenticationMethodDeviceItemRequestBuilderGetRequestConfiguration
*/
class AuthenticationMethodDeviceItemRequestBuilderGetRequestC_f43886f9 extends BaseRequestConfiguration 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AuthenticationMethodDeviceItemRequestBuilderGetRequestC_f43886f9 and sets the default values.
