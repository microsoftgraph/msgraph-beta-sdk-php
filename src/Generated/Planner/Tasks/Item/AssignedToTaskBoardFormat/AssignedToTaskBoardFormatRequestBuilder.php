...
class AssignedToTaskBoardFormatRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/plannerassignedtotaskboardtaskformat-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<PlannerAssignedToTaskBoardTaskFormat|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/plannerassignedtotaskboardtaskformat-update?view=graph-rest-beta Find more info here
    */
