...
use Microsoft\Graph\Beta\Generated\Planner\Tasks\Item\Messages\Item\SetReaction\SetReactionRequestBuilder;
use Microsoft\Graph\Beta\Generated\Planner\Tasks\Item\Messages\Item\UnsetReaction\UnsetReactionRequestBuilder;
...
class PlannerTaskChatMessageItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?PlannerTaskChatMessageItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/planner/tasks/{plannerTask%2Did}/messages/{plannerTaskChatMessage%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
