...
class PlannerRosterItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $plannerRosterId key: id of plannerRoster
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $plannerRosterId = null) {
    ...
    */
    public function membersById(string $id): PlannerRosterMemberItemRequestBuilder {
        ...
        return new PlannerRosterMemberItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
