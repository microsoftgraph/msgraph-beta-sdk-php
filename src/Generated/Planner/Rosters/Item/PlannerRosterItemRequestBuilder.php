...
class PlannerRosterItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $plannerRosterId = null) {
        $this->urlTemplate = '{+baseurl}/planner/rosters/{plannerRoster%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['plannerRosterId'] = $plannerRosterId;
