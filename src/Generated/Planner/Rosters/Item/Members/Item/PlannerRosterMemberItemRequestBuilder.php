...
class PlannerRosterMemberItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $plannerRosterMemberId key: id of plannerRosterMember
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $plannerRosterMemberId = null) {
        ...
        $urlTplParams['plannerRosterMemberId'] = $plannerRosterMemberId;
