...
use Microsoft\Graph\Beta\Generated\Planner\Plans\Item\Tasks\Item\Messages\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Planner\Plans\Item\Tasks\Item\Messages\Item\PlannerTaskChatMessageItemRequestBuilder;
...
class MessagesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?MessagesRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/messages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(PlannerTaskChatMessage $body, ?MessagesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/messages';
        $requestInfo->pathParameters = $this->pathParameters;
