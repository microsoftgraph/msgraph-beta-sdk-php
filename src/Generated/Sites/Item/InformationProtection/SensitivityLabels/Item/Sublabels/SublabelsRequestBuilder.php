...
use Microsoft\Graph\Beta\Generated\Sites\Item\InformationProtection\SensitivityLabels\Item\Sublabels\ComputeInheritanceWithLabelIdsWithLocaleWithContentFormats\ComputeInheritanceWithLabelIdsWithLocaleWithContentForm_2b72dc93;
use Microsoft\Graph\Beta\Generated\Sites\Item\InformationProtection\SensitivityLabels\Item\Sublabels\ComputeRightsAndInheritance\ComputeRightsAndInheritanceRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\InformationProtection\SensitivityLabels\Item\Sublabels\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\InformationProtection\SensitivityLabels\Item\Sublabels\Evaluate\EvaluateRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\InformationProtection\SensitivityLabels\Item\Sublabels\Item\SensitivityLabelItemRequestBuilder;
...
class SublabelsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?SublabelsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(SensitivityLabel $body, ?SublabelsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels';
        $requestInfo->pathParameters = $this->pathParameters;
