...
class SensitivityLabelItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $sensitivityLabelId1 key: id of sensitivityLabel
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $sensitivityLabelId1 = null) {
        $this->urlTemplate = '{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/{sensitivityLabel%2Did1}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['sensitivityLabelId1'] = $sensitivityLabelId1;
