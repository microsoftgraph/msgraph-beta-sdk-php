...
namespace Microsoft\Graph\Beta\Generated\Sites\Item\InformationProtection\Bitlocker\RecoveryKeys\Item;
...
class BitlockerRecoveryKeyItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $bitlockerRecoveryKeyId key: id of bitlockerRecoveryKey
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $bitlockerRecoveryKeyId = null) {
        $this->urlTemplate = '{+baseurl}/sites/{site%2Did}/informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['bitlockerRecoveryKeyId'] = $bitlockerRecoveryKeyId;
