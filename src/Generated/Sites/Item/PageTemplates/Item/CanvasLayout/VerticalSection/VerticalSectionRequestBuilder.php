...
use Microsoft\Graph\Beta\Generated\Sites\Item\PageTemplates\Item\CanvasLayout\VerticalSection\Webparts\WebpartsRequestBuilder;
...
class VerticalSectionRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout/verticalSection');
    ...
    */
    public function toGetRequestInformation(?VerticalSectionRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout/verticalSection{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
