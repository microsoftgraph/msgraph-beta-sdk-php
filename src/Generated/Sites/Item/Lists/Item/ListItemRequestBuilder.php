...
namespace Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item;
...
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\Items\Item\ListItemItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\Items\ItemsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\Operations\Item\RichLongRunningOperationItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\Operations\OperationsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\Subscriptions\Item\SubscriptionItemRequestBuilder;
...
class ListItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.lists.item.columns.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.lists.item.contentTypes.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    public function get(?ListItemRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [EscapedList::class, 'createFromDiscriminatorValue'], $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.lists.item.items.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.lists.item.operations.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.lists.item.subscriptions.item collection
     * @param string $id Unique identifier of the item
