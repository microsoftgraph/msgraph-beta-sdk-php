...
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\MicrosoftGraphAssociateWithHubSites\AssociateWithHubSitesRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\MicrosoftGraphCopyToDefaultContentLocation\CopyToDefaultContentLocationRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\MicrosoftGraphIsPublished\IsPublishedRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\MicrosoftGraphPublish\PublishRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\MicrosoftGraphUnpublish\UnpublishRequestBuilder;
...
class ContentTypeItemRequestBuilder 
{
    ...
    */
     ...
     * @return \Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\BaseTypes\Item\ContentTypeItemRequestBuilder
    */
    public function baseTypesById(string $id): \Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\BaseTypes\Item\ContentTypeItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['contentType%2Did1'] = $id;
        return new \Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\BaseTypes\Item\ContentTypeItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
    ...
    */
     ...
     * Provides operations to manage the columnPositions property of the microsoft.graph.contentType entity.
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\ColumnPositions\Item\ColumnDefinitionItemRequestBuilder
    */
    public function columnPositionsById(string $id): \Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\ColumnPositions\Item\ColumnDefinitionItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['columnDefinition%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\ColumnPositions\Item\ColumnDefinitionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }

    /**
     * Provides operations to manage the columns property of the microsoft.graph.contentType entity.
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\Columns\Item\ColumnDefinitionItemRequestBuilder
    */
    public function columnsById(string $id): \Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\Columns\Item\ColumnDefinitionItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['columnDefinition%2Did'] = $id;
        return new \Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\ContentTypes\Item\Columns\Item\ColumnDefinitionItemRequestBuilder($urlTplParams, $this->requestAdapter, $id);
    }
