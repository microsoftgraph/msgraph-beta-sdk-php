...
namespace Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\Permissions;
...
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\Permissions\Count\CountRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Lists\Item\Permissions\Item\PermissionItemRequestBuilder;
...
class PermissionsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function toGetRequestInformation(?PermissionsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/permissions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}';
    ...
    */
    public function toPostRequestInformation(Permission $body, ?PermissionsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/permissions';
        $requestInfo->pathParameters = $this->pathParameters;
