...
namespace Microsoft\Graph\Beta\Generated\Sites\Item\TermStore\Sets\Item;
...
use Microsoft\Graph\Beta\Generated\Sites\Item\TermStore\Sets\Item\Children\ChildrenRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\TermStore\Sets\Item\Children\Item\TermItemRequestBuilder as MicrosoftGraphBetaGeneratedSitesItemTermStoreSetsItemChildrenItemTermItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\TermStore\Sets\Item\ParentGroup\ParentGroupRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\TermStore\Sets\Item\Relations\Item\RelationItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\TermStore\Sets\Item\Relations\RelationsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\TermStore\Sets\Item\Terms\Item\TermItemRequestBuilder as MicrosoftGraphBetaGeneratedSitesItemTermStoreSetsItemTermsItemTermItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\TermStore\Sets\Item\Terms\TermsRequestBuilder;
...
class SetItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.termStore.sets.item.children.item collection
     * @param string $id Unique identifier of the item
     * @return MicrosoftGraphBetaGeneratedSitesItemTermStoreSetsItemChildrenItemTermItemRequestBuilder
    */
    public function childrenById(string $id): MicrosoftGraphBetaGeneratedSitesItemTermStoreSetsItemChildrenItemTermItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['term%2Did'] = $id;
        return new MicrosoftGraphBetaGeneratedSitesItemTermStoreSetsItemChildrenItemTermItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.termStore.sets.item.relations.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.termStore.sets.item.terms.item collection
     * @param string $id Unique identifier of the item
     * @return MicrosoftGraphBetaGeneratedSitesItemTermStoreSetsItemTermsItemTermItemRequestBuilder
    */
    public function termsById(string $id): MicrosoftGraphBetaGeneratedSitesItemTermStoreSetsItemTermsItemTermItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['term%2Did'] = $id;
        return new MicrosoftGraphBetaGeneratedSitesItemTermStoreSetsItemTermsItemTermItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
