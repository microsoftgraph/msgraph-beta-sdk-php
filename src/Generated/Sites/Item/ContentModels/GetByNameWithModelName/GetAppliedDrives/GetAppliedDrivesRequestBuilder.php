...
class GetAppliedDrivesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/contentModels/getByName(modelName=\'{modelName}\')/getAppliedDrives(){?%24count,%24filter,%24search,%24skip,%24top}');
