...
namespace Microsoft\\Graph\\Beta\\Generated\Sites\Item\ContentModels\GetByNameWithModelName\RemoveFromDrive;
...
class RemoveFromDriveRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/contentModels/getByName(modelName=\'{modelName}\')/removeFromDrive');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/contentmodel-removefromdrive?view=graph-rest-beta Find more info here
    */
