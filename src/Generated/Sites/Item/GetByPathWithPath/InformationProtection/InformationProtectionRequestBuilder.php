...
namespace Microsoft\Graph\Beta\Generated\Sites\Item\GetByPathWithPath\InformationProtection;
...
class InformationProtectionRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/getByPath(path=\'{path}\')/informationProtection{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?InformationProtectionRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/informationProtection';
