...
namespace Microsoft\Graph\Beta\Generated\Sites\Item\GetByPathWithPath\RecycleBin;
...
class RecycleBinRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/getByPath(path=\'{path}\')/recycleBin{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?RecycleBinRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/recycleBin';
