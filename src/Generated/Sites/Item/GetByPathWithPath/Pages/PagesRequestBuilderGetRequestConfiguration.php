...
namespace Microsoft\Graph\Beta\Generated\Sites\Item\GetByPathWithPath\Pages;
...
*/
class PagesRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    /**
    ...
    */
    public static function createQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): PagesRequestBuilderGetQueryParameters {
        return new PagesRequestBuilderGetQueryParameters($count, $expand, $filter, $search, $select, $skip, $top);
    }
