...
namespace Microsoft\Graph\Beta\Generated\Sites\Item\GetByPathWithPath\GetByPathWithPath1\Onenote;
...
class OnenoteRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/getByPath(path=\'{path}\')/getByPath(path=\'{path1}\')/onenote{?%24expand,%24select}');
    ...
    */
    public function toDeleteRequestInformation(?OnenoteRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
        ...
        $requestInfo->urlTemplate = '{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')/onenote';
