...
namespace Microsoft\Graph\Beta\Generated\Sites\Item\GetByPathWithPath\GetByPathWithPath1\LastModifiedByUser;
...
class LastModifiedByUserRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/getByPath(path=\'{path}\')/getByPath(path=\'{path1}\')/lastModifiedByUser{?%24expand,%24select}');
