...
class BaseItemItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $baseItemId key: id of baseItem
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $baseItemId = null) {
        $this->urlTemplate = '{+baseurl}/sites/{site%2Did}/items/{baseItem%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['baseItemId'] = $baseItemId;
