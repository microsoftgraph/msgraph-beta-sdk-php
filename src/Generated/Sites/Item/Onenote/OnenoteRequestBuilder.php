...
namespace Microsoft\Graph\Beta\Generated\Sites\Item\Onenote;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Beta\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Beta\Generated\Models\Onenote;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\Notebooks\Item\NotebookItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\Notebooks\NotebooksRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\Operations\Item\OnenoteOperationItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\Operations\OperationsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\Pages\Item\OnenotePageItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\Pages\PagesRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\Resources\Item\OnenoteResourceItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\Resources\ResourcesRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\SectionGroups\Item\SectionGroupItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\SectionGroups\SectionGroupsRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\Sections\Item\OnenoteSectionItemRequestBuilder;
use Microsoft\Graph\Beta\Generated\Sites\Item\Onenote\Sections\SectionsRequestBuilder;
...
class OnenoteRequestBuilder 
{
    ...
    */
    public function get(?OnenoteRequestBuilderGetRequestConfiguration $requestConfiguration = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [Onenote::class, 'createFromDiscriminatorValue'], $responseHandler, $errorMappings);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.onenote.notebooks.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.onenote.operations.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.onenote.pages.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.onenote.resources.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.onenote.sectionGroups.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Beta\Generated.sites.item.onenote.sections.item collection
     * @param string $id Unique identifier of the item
