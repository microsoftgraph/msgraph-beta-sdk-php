...
use Microsoft\Graph\Beta\Generated\Sites\Item\ContentTypes\Item\Base\EscapedBaseRequestBuilder;
...
class ContentTypeItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}');
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/contenttype-delete?view=graph-rest-beta Find more info here
    */
     ...
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/contenttype-get?view=graph-rest-beta Find more info here
    */
     ...
     * @return Promise<ContentType|null>
     * @throws Exception
     * @link https://learn.microsoft.com/graph/api/contenttype-update?view=graph-rest-beta Find more info here
    */
    ...
    */
    public function toGetRequestInformation(?ContentTypeItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}{?%24expand,%24select}';
        $requestInfo->pathParameters = $this->pathParameters;
