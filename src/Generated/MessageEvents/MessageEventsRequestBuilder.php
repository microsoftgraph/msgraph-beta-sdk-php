...
class MessageEventsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/messageEvents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}');
    ...
    */
     ...
     * @return MessageEventsRequestBuilder
    */
    public function withUrl(string $rawUrl): MessageEventsRequestBuilder {
        return new MessageEventsRequestBuilder($rawUrl, $this->requestAdapter);
    }
