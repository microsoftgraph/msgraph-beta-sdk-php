...
use Microsoft\Graph\Beta\Generated\PrivilegedRoles\Item\MicrosoftGraphSelfActivate\SelfActivateRequestBuilder;
use Microsoft\Graph\Beta\Generated\PrivilegedRoles\Item\MicrosoftGraphSelfDeactivate\SelfDeactivateRequestBuilder;
...
class PrivilegedRoleItemRequestBuilder 
{
    ...
    */
     ...
     * @param string|null $privilegedRoleId key: id of privilegedRole
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter, ?string $privilegedRoleId = null) {
        $this->urlTemplate = '{+baseurl}/privilegedRoles/{privilegedRole%2Did}{?%24select,%24expand}';
        $this->requestAdapter = $requestAdapter;
        $this->pathParameters = $pathParameters;
        $urlTplParams = $pathParameters;
        $urlTplParams['privilegedRoleId'] = $privilegedRoleId;
