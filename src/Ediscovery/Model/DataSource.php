...
class DataSource extends \Beta\Microsoft\Graph\Model\Entity
{
    ...
    */
    ...
    {
        if (array_key_exists("holdStatus", $this->_propDict) && !is_null($this->_propDict["holdStatus"])) {
            if (is_a($this->_propDict["holdStatus"], "\Beta\Microsoft\Graph\Ediscovery\Model\DataSourceHoldStatus")) {
